# 命令证据包：ADD CPCGGRP
> 原始命令 md：`output/UNC 20.15.2 产品文档(裸机容器) 05/OM参考/命令/UNC MML命令/业务服务管理/会话管理/计费管理/离线计费/GTPP信令/CG组管理/抄送CG组/增加抄送CG组（ADD CPCGGRP）_09896864.md`
> 用该命令的特性数：1
...
| DESCRIPTION | 抄送CG组描述 | local_planned | optional | 无 | 字符串类型，输入长度范围为1～63。 |
...
## ④ 自动比对
- 命令真相参数（2）：['CPCGGRPID', 'DESCRIPTION']
