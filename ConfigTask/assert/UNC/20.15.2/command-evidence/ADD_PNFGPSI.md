# 命令证据包：ADD PNFGPSI
> 原始命令 md：`output/UNC 20.15.2 产品文档(裸机容器) 05/OM参考/命令/UNC MML命令/业务服务管理/接口管理/服务化接口管理/注册与服务发现/本地NRF功能管理/对端NF实例GPSI信息/增加对端NF的GPSI信息（ADD PNFGPSI）_09652127.md`
> 用该命令的特性数：2
...
| QUERYTYPE | 查询方式 | local_planned | required | 无 | <br>- “START_END（START_END）”：号段 |
...
| PATTERN | 模式 | global_planned | conditional | 无 | 字符串类型，输入长度范围是0~64。 |
