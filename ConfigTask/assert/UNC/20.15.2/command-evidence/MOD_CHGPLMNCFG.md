# 命令证据包：MOD CHGPLMNCFG
> 原始命令 md：`output/UNC 20.15.2 产品文档(裸机容器) 05/OM参考/命令/UNC MML命令/业务服务管理/Pre 5G接入业务管理/计费管理/PLMN计费配置/修改PLMN计费配置(MOD CHGPLMNCFG)_72344993.md`
> 用该命令的特性数：1
...
- 该命令和[**ADD CHGIMSICFG**](../IMSI计费配置/增加IMSI计费配置(ADD CHGIMSICFG)_26145384.md)中各字段默认值都为无效值。若需要使用该命令或[**ADD CHGIMSICFG**](../IMSI计费配置/增加IMSI计费配置(ADD CHGIMSICFG)_2614538
