...
### 0.2 带宽控制场景知识来源
- `cross-topic-analysis.md`（862行，32批次317份源文档综合分析）
- `feature-knowledge/cross-feature-analysis.md`（1119行，24特性横向分析）
- `feature-knowledge/*.md`（24个特性知识文档）
- `topic-knowledge/Batch-*.md`（32个主题知识批次）
...
> **拆分依据**：`cross-topic-analysis.md` §6.2（五大维度）+ §8.4（九场景）归纳合并，结合 `feature-knowledge/cross-feature-analysis.md` §4.4（场景组合链路）。
