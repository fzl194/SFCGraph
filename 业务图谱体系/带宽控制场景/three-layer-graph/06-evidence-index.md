...
|------------|------|---------|---------|
| EV-CA-01 | 跨特性分析 | `feature-knowledge/cross-feature-analysis.md` | §1.1功能层次；§2.3 License链；§4.1-4.2依赖图；附录B MML命令；附录C配置对象；附录D端到端流程；附录G无线优化 |
...
- [x] 所有路径相对本场景目录（`业务图谱体系/带宽控制场景/`）准确
