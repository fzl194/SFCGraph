...
> **作用**：实例化 62 个 MMLCommand + 34 个 ConfigObject + 14 个 CommandRule + ConfigObject间关系边
...
| BFD/隧道/自动部署/验收 | 21 | BFD、GRE/MPLS、自动部署、级联口、核查命令 |
| **合计** | **78条语法项** | 其中主图谱登记核心命令 62 个 |
