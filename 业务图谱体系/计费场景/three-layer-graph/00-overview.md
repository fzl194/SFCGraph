...
│  EvidenceSource(32) ←── source_evidence_ids ── 所有图谱对象        │
...
| | **命令层小计** | **165** | |
| **第5层 跨层映射** | 跨层边 | ~130 | `05-cross-layer-mapping.md` |
| **第6层 证据层** | EvidenceSource | 32（含2协议知识★） | `06-evidence-index.md` |
| **图谱对象总计** | — | **~475** | — |
...
| `06-evidence-index.md` | 第6层：证据层索引（32 EvidenceSource，含2协议知识★） | §10 EvidenceSource |
...
- [x] 证据索引覆盖 15 EV-FK + 4 EV-KB + 2 EV-BS + 2 EV-PK + 5 EV-SK + 1 EV-CFA + 1 EV-FDL + 1 EV-DES + 1 EV-BSA = 32份
...
- [x] **证据索引建立**：32份EvidenceSource注册表（旧版无独立文件）
