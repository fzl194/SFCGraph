...
### 新建（工具层）
- `assets/business/业务层级构建SOP.md` — 业务层构建 SOP（镜像特性 SOP §0-§8，内容来自 spec §0-§8）
- `assets/business/业务层级wiki审视流程.md` — 业务层审视流程（来自 spec §10）
...
- **每批后自审**：按 `assets/business/业务层级wiki审视流程.md` R1 审视，critical 即修，经验回填 SOP。
...
**Files:**
- Create: `assets/business/业务层级构建SOP.md`
...
Run: `grep -n "^## " assets/business/业务层级构建SOP.md`
Expected: 8 段标题（§0-§8）齐全。
Run: `grep -c "业务" assets/business/业务层级构建SOP.md`（非空）

- [ ] **Step 4: Commit**

```bash
git add assets/business/业务层级构建SOP.md
...
**Files:**
- Create: `assets/business/业务层级wiki审视流程.md`
...
Run: `grep -n "^### R1" assets/business/业务层级wiki审视流程.md`
Expected: R1.1-R1.5 五条。

- [ ] **Step 3: Commit**

```bash
git add assets/business/业务层级wiki审视流程.md
...
- [ ] **Step 1: 按 `assets/business/业务层级wiki审视流程.md` R1 审视融合 CS**
...
若 SOP 有缺陷 → 修 `assets/business/业务层级构建SOP.md` + 版本号 +1。
