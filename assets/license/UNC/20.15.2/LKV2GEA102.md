---
id: UNC@20.15.2@License@LKV2GEA102
type: License
name: 支持GPRS加密功能:GEA-1(仅用于Gb模式)
nf: UNC
version: 20.15.2
license_code: LKV2GEA102
control_item_id: '82206546'
applicable_nf:
- SGSN
status: active
---

# 支持GPRS加密功能:GEA-1(仅用于Gb模式)

`LKV2GEA102` · 控制项 82206546 ·  · 域 
...
WSFD-103001 支持GPRS 加密功能：GEA-1（仅用于Gb 模式）
