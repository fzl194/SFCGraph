---
id: UNC@20.15.2@License@LKV3WNBARC11
type: License
name: 基于APN的NB-IoT终端接入速率控制
nf: UNC
version: 20.15.2
license_code: LKV3WNBARC11
control_item_id: '82209409'
applicable_nf:
- PGW-C
status: active
---
...
基于APN的NB-IoT终端接入速率控制在PGW-C上配置速率门限，用于控制该UE的某PDN连接单位时间内上行和下行数据包的数目。
...
- [WSFD-215204](feature/UNC/20.15.2/WSFD-215204.md)  — 控制项 82209409
