---
id: UNC@20.15.2@License@LKV2GEA202
type: License
name: 支持GPRS加密功能:GEA-2(仅用于Gb模式)
nf: UNC
version: 20.15.2
license_code: LKV2GEA202
control_item_id: '82206547'
applicable_nf:
- SGSN
status: active
---

# 支持GPRS加密功能:GEA-2(仅用于Gb模式)

`LKV2GEA202` · 控制项 82206547 ·  · 域 
...
WSFD-103002 支持GPRS 加密功能：GEA-2（仅用于Gb 模式）
