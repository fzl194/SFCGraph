...
本方案编排 3 个 UDG 特性 + UNC/SMF 侧 CTF 角色——UDG [在线计费 2-00004](task/UDG/20.15.2/2-00004.md)（backbone 基准）+ [内容计费 2-00003](task/UDG/20.15.2/2-00003.md)（业务粒度骨架）+ [事件计费 2-00009](task/UDG/20.15.2/2-00009.md)（事件计量增强，可选）：
...
本方案编排 **3 个 UDG 特性**：UDG [2-00004 在线计费](task/UDG/20.15.2/2-00004.md)（backbone）+ [2-00003 内容计费](task/UDG/20.15.2/2-00003.md)（业务粒度）+ [2-00009 事件计费](task/UDG/20.15.2/2-00009.md)（事件计量增强，可选）。UNC/SMF 侧配 Gy/DCC 对接。各特性未变化的配置走其**标准配置方法**（见各 feature task），以下仅说明本方案的**特性级变种/排除项**与**跨网元协同**。
