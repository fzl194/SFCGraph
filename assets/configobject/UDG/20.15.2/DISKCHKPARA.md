...
- [DSP DISKCHKPARA](command/UDG/20.15.2/DSP-DISKCHKPARA.md)
- [SET DISKCHKPARA](command/UDG/20.15.2/SET-DISKCHKPARA.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询存储检测参数（DSP-DISKCHKPARA）_80543422.md`
