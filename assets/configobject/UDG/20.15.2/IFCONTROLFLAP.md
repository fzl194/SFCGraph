---
id: UDG@20.15.2@ConfigObject@IFCONTROLFLAP
type: ConfigObject
...
- [ADD IFCONTROLFLAP](command/UDG/20.15.2/ADD-IFCONTROLFLAP.md)
- [DSP IFCONTROLFLAP](command/UDG/20.15.2/DSP-IFCONTROLFLAP.md)
- [LST IFCONTROLFLAP](command/UDG/20.15.2/LST-IFCONTROLFLAP.md)
- [RMV IFCONTROLFLAP](command/UDG/20.15.2/RMV-IFCONTROLFLAP.md)
- [RTR IFCONTROLFLAP](command/UDG/20.15.2/RTR-IFCONTROLFLAP.md)
