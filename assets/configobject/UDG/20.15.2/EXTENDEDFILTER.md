---
id: UDG@20.15.2@ConfigObject@EXTENDEDFILTER
type: ConfigObject
name: EXTENDEDFILTER（扩展过滤器）
nf: UDG
version: 20.15.2
object_name: EXTENDEDFILTER
object_kind: entity
applicable_nf:
- PGW-U
- UPF
...
- [ADD EXTENDEDFILTER](command/UDG/20.15.2/ADD-EXTENDEDFILTER.md)
- [LST EXTENDEDFILTER](command/UDG/20.15.2/LST-EXTENDEDFILTER.md)
- [MOD EXTENDEDFILTER](command/UDG/20.15.2/MOD-EXTENDEDFILTER.md)
- [RMV EXTENDEDFILTER](command/UDG/20.15.2/RMV-EXTENDEDFILTER.md)
