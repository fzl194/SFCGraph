---
id: UDG@20.15.2@ConfigObject@VPNINSTAF
type: ConfigObject
...
- 原始手册：`evidence/UDG/20.15.2/删除L3VPN实例地址族（RMV-VPNINSTAF）_00440685.md`
- 原始手册：`evidence/UDG/20.15.2/增加L3VPN实例地址族（ADD-VPNINSTAF）_49802178.md`
