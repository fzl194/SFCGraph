...
- [[command/UDG/20.15.2/LST-LSPVGLOBALCFG]] · LST LSPVGLOBALCFG
- [[command/UDG/20.15.2/SET-LSPVGLOBALCFG]] · SET LSPVGLOBALCFG

## 证据

- 原始手册：`evidence/UDG/20.15.2/LSPVGLOBALCFG.md`
- 原始手册：`evidence/UDG/20.15.2/LSPVGLOBALCFG.md`
