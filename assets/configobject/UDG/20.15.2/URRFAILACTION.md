---
id: UDG@20.15.2@ConfigObject@URRFAILACTION
type: ConfigObject
name: URRFAILACTION（计费URR上报失败动作参数）
nf: UDG
version: 20.15.2
object_name: URRFAILACTION
...
- [LST URRFAILACTION](command/UDG/20.15.2/LST-URRFAILACTION.md)
- [SET URRFAILACTION](command/UDG/20.15.2/SET-URRFAILACTION.md)
