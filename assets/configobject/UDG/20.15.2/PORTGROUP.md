---
id: UDG@20.15.2@ConfigObject@PORTGROUP
type: ConfigObject
name: PORTGROUP（端口组）
nf: UDG
version: 20.15.2
...
- 原始手册：`evidence/UDG/20.15.2/删除端口组（RMV-PORTGROUP）_00441253.md`
- 原始手册：`evidence/UDG/20.15.2/增加端口组（ADD-PORTGROUP）_00600409.md`
- 原始手册：`evidence/UDG/20.15.2/查询端口组配置（LST-PORTGROUP）_49962022.md`
