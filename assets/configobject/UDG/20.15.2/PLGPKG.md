---
id: UDG@20.15.2@ConfigObject@PLGPKG
type: ConfigObject
name: PLGPKG（扩展包）
nf: UDG
version: 20.15.2
...
- [ACT PLGPKG](command/UDG/20.15.2/ACT-PLGPKG.md)
- [DSP PLGPKG](command/UDG/20.15.2/DSP-PLGPKG.md)
- [LOD PLGPKG](command/UDG/20.15.2/LOD-PLGPKG.md)
- [LST PLGPKG](command/UDG/20.15.2/LST-PLGPKG.md)
- [RMV PLGPKG](command/UDG/20.15.2/RMV-PLGPKG.md)
