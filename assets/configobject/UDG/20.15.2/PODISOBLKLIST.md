...
- [[command/UDG/20.15.2/ADD-PODISOBLKLIST]] · ADD PODISOBLKLIST
- [[command/UDG/20.15.2/LST-PODISOBLKLIST]] · LST PODISOBLKLIST
- [[command/UDG/20.15.2/RMV-PODISOBLKLIST]] · RMV PODISOBLKLIST

## 证据

- 原始手册：`evidence/UDG/20.15.2/PODISOBLKLIST.md`
- 原始手册：`evidence/UDG/20.15.2/PODISOBLKLIST.md`
- 原始手册：`evidence/UDG/20.15.2/PODISOBLKLIST.md`
