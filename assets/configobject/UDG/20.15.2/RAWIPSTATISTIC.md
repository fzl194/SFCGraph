...
- [[command/UDG/20.15.2/DSP-RAWIPSTATISTIC]] · DSP RAWIPSTATISTIC
- [[command/UDG/20.15.2/RTR-RAWIPSTATISTIC]] · RTR RAWIPSTATISTIC

## 证据

- 原始手册：`evidence/UDG/20.15.2/RAWIPSTATISTIC.md`
- 原始手册：`evidence/UDG/20.15.2/RAWIPSTATISTIC.md`
