---
id: UDG@20.15.2@ConfigObject@UPDIAMRTREALM
type: ConfigObject
name: UPDIAMRTREALM（Diameter路由域名信息）
nf: UDG
version: 20.15.2
object_name: UPDIAMRTREALM
object_kind: entity
applicable_nf:
- UPF
status: active
...
- [ADD UPDIAMRTREALM](command/UDG/20.15.2/ADD-UPDIAMRTREALM.md)
- [LST UPDIAMRTREALM](command/UDG/20.15.2/LST-UPDIAMRTREALM.md)
- [MOD UPDIAMRTREALM](command/UDG/20.15.2/MOD-UPDIAMRTREALM.md)
- [RMV UPDIAMRTREALM](command/UDG/20.15.2/RMV-UPDIAMRTREALM.md)
