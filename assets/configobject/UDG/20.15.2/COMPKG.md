---
id: UDG@20.15.2@ConfigObject@COMPKG
type: ConfigObject
name: COMPKG（扩展包）
nf: UDG
version: 20.15.2
...
- [LOD COMPKG](command/UDG/20.15.2/LOD-COMPKG.md)
- [LST COMPKG](command/UDG/20.15.2/LST-COMPKG.md)
- [RMV COMPKG](command/UDG/20.15.2/RMV-COMPKG.md)
