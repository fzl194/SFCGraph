...
- [[command/UDG/20.15.2/LST-AUTOLOGPOLICY]] · LST AUTOLOGPOLICY
- [[command/UDG/20.15.2/SET-AUTOLOGPOLICY]] · SET AUTOLOGPOLICY

## 证据

- 原始手册：`evidence/UDG/20.15.2/AUTOLOGPOLICY.md`
- 原始手册：`evidence/UDG/20.15.2/AUTOLOGPOLICY.md`
