---
id: UDG@20.15.2@ConfigObject@MMLCFGDOMAIN
type: ConfigObject
name: MMLCFGDOMAIN（批量设置绑定域信息）
nf: UDG
version: 20.15.2
object_name: MMLCFGDOMAIN
...
- [CLR MMLCFGDOMAIN](command/UDG/20.15.2/CLR-MMLCFGDOMAIN.md)
- [SET MMLCFGDOMAIN](command/UDG/20.15.2/SET-MMLCFGDOMAIN.md)
