---
id: UDG@20.15.2@ConfigObject@SRROUTE
type: ConfigObject
...
- 原始手册：`evidence/UDG/20.15.2/修改IPv4静态路由（MOD-SRROUTE）_49962042.md`
- 原始手册：`evidence/UDG/20.15.2/删除IPv4静态路由（RMV-SRROUTE）_00441041.md`
- 原始手册：`evidence/UDG/20.15.2/增加IPv4静态路由（ADD-SRROUTE）_49961498.md`
- 原始手册：`evidence/UDG/20.15.2/查询IPv4静态路由（LST-SRROUTE）_50120606.md`
- 原始手册：`evidence/UDG/20.15.2/显示静态路由（DSP-SRROUTE）_50121418.md`
