---
id: UDG@20.15.2@ConfigObject@ATTACKDEFEND
type: ConfigObject
...
- [LST ATTACKDEFEND](command/UDG/20.15.2/LST-ATTACKDEFEND.md)
- [SET ATTACKDEFEND](command/UDG/20.15.2/SET-ATTACKDEFEND.md)
