...
- [LST DBSOFTPARA](command/UDG/20.15.2/LST-DBSOFTPARA.md)
- [SET DBSOFTPARA](command/UDG/20.15.2/SET-DBSOFTPARA.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询CSDB软件调试参数表(LST-DBSOFTPARA)_80429703.md`
- 原始手册：`evidence/UDG/20.15.2/设置CSDB软件调试参数表(SET-DBSOFTPARA)_80429704.md`
