---
id: UDG@20.15.2@ConfigObject@LBTNIPINIPSWITCH
type: ConfigObject
...
- [LST LBTNIPINIPSWITCH](command/UDG/20.15.2/LST-LBTNIPINIPSWITCH.md)
- [SET LBTNIPINIPSWITCH](command/UDG/20.15.2/SET-LBTNIPINIPSWITCH.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询CSLB隧道IP-in-IP开关（LST-LBTNIPINIPSWITCH）_21904504.md`
- 原始手册：`evidence/UDG/20.15.2/设置CSLB隧道IP-in-IP开关（SET-LBTNIPINIPSWITCH）_21584628.md`
