---
id: UDG@20.15.2@ConfigObject@EXPBASICFUNC
type: ConfigObject
name: EXPBASICFUNC（体验业务基本功能）
nf: UDG
version: 20.15.2
object_name: EXPBASICFUNC
...
- [LST EXPBASICFUNC](command/UDG/20.15.2/LST-EXPBASICFUNC.md)
- [SET EXPBASICFUNC](command/UDG/20.15.2/SET-EXPBASICFUNC.md)
