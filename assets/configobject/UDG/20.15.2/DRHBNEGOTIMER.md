...
- [LST DRHBNEGOTIMER](command/UDG/20.15.2/LST-DRHBNEGOTIMER.md)
- [SET DRHBNEGOTIMER](command/UDG/20.15.2/SET-DRHBNEGOTIMER.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询容灾定时器（LST-DRHBNEGOTIMER）_23235162.md`
