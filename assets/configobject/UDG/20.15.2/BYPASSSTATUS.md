---
id: UDG@20.15.2@ConfigObject@BYPASSSTATUS
type: ConfigObject
...
- [DSP BYPASSSTATUS](command/UDG/20.15.2/DSP-BYPASSSTATUS.md)
- [SET BYPASSSTATUS](command/UDG/20.15.2/SET-BYPASSSTATUS.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询BYPASS状态（DSP-BYPASSSTATUS）_74020102.md`
