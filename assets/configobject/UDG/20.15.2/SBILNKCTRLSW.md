...
- [LST SBILNKCTRLSW](command/UDG/20.15.2/LST-SBILNKCTRLSW.md)
- [SET SBILNKCTRLSW](command/UDG/20.15.2/SET-SBILNKCTRLSW.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询服务化接口链路自动控制功能开关（LST-SBILNKCTRLSW）_83813636.md`
- 原始手册：`evidence/UDG/20.15.2/设置服务化接口链路自动控制功能开关（SET-SBILNKCTRLSW）_28971851.md`
