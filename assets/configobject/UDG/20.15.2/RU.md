---
id: UDG@20.15.2@ConfigObject@RU
type: ConfigObject
name: RU（解闭CSDB RU）
nf: UDG
version: 20.15.2
...
- [BLK RU](command/UDG/20.15.2/BLK-RU.md)
- [DSP RU](command/UDG/20.15.2/DSP-RU.md)
- [RST RU](command/UDG/20.15.2/RST-RU.md)
- [UBLK RU](command/UDG/20.15.2/UBLK-RU.md)
