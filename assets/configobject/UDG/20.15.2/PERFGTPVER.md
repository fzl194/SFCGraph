---
id: UDG@20.15.2@ConfigObject@PERFGTPVER
type: ConfigObject
name: PERFGTPVER（版本粒度的测量对象）
nf: UDG
version: 20.15.2
object_name: PERFGTPVER
object_kind: entity
applicable_nf:
- UPF
status: active
...
- [RMV PERFGTPVER](command/UDG/20.15.2/RMV-PERFGTPVER.md)
