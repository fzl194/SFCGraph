...
- [[command/UDG/20.15.2/DSP-SECPOLICYAPPLNK]] · DSP SECPOLICYAPPLNK
- [[command/UDG/20.15.2/SET-SECPOLICYAPPLNK]] · SET SECPOLICYAPPLNK

## 证据

- 原始手册：`evidence/UDG/20.15.2/SECPOLICYAPPLNK.md`
- 原始手册：`evidence/UDG/20.15.2/SECPOLICYAPPLNK.md`
