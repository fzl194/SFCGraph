---
id: UDG@20.15.2@ConfigObject@SECPOLICYPRIO
type: ConfigObject
...
- [LST SECPOLICYPRIO](command/UDG/20.15.2/LST-SECPOLICYPRIO.md)
- [SET SECPOLICYPRIO](command/UDG/20.15.2/SET-SECPOLICYPRIO.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询报文上送优先级（LST-SECPOLICYPRIO）_49960882.md`
- 原始手册：`evidence/UDG/20.15.2/设置报文上送优先级（SET-SECPOLICYPRIO）_00601093.md`
