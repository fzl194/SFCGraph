---
id: UDG@20.15.2@ConfigObject@TOHVXLANPARA
type: ConfigObject
name: TOHVXLANPARA（家庭网关业务使用VXLAN隧道传输业务参数配置）
nf: UDG
version: 20.15.2
object_name: TOHVXLANPARA
...
# TOHVXLANPARA（家庭网关业务使用VXLAN隧道传输业务参数配置）
...
- [LST TOHVXLANPARA](command/UDG/20.15.2/LST-TOHVXLANPARA.md)
- [SET TOHVXLANPARA](command/UDG/20.15.2/SET-TOHVXLANPARA.md)
