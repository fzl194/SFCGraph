...
- [LST RESCHKSWITCH](command/UDG/20.15.2/LST-RESCHKSWITCH.md)
- [SET RESCHKSWITCH](command/UDG/20.15.2/SET-RESCHKSWITCH.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询RCF核查开关状态（LST-RESCHKSWITCH）_56594041.md`
