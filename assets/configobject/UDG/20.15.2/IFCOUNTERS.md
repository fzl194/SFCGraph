---
id: UDG@20.15.2@ConfigObject@IFCOUNTERS
type: ConfigObject
...
- [DSP IFCOUNTERS](command/UDG/20.15.2/DSP-IFCOUNTERS.md)
- [RTR IFCOUNTERS](command/UDG/20.15.2/RTR-IFCOUNTERS.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询接口统计信息（DSP-IFCOUNTERS）_00841557.md`
- 原始手册：`evidence/UDG/20.15.2/清除接口统计信息（RTR-IFCOUNTERS）_00866745.md`
