---
id: UDG@20.15.2@ConfigObject@FASTRECOVERY
type: ConfigObject
...
- [LST FASTRECOVERY](command/UDG/20.15.2/LST-FASTRECOVERY.md)
- [SET FASTRECOVERY](command/UDG/20.15.2/SET-FASTRECOVERY.md)
