---
id: UDG@20.15.2@ConfigObject@SECCARSTAT
type: ConfigObject
...
- [DSP SECCARSTAT](command/UDG/20.15.2/DSP-SECCARSTAT.md)
- [RTR SECCARSTAT](command/UDG/20.15.2/RTR-SECCARSTAT.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/显示安全CAR功能丢弃上送CPU报文的详细信息（DSP-SECCARSTAT）_00600781.md`
