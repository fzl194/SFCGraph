---
id: UDG@20.15.2@ConfigObject@PAEEXAMINATION
type: ConfigObject
...
- [LST PAEEXAMINATION](command/UDG/20.15.2/LST-PAEEXAMINATION.md)
- [SET PAEEXAMINATION](command/UDG/20.15.2/SET-PAEEXAMINATION.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询PAE故障检测使能配置（LST-PAEEXAMINATION）_92520049.md`
- 原始手册：`evidence/UDG/20.15.2/设置PAE故障检测使能开关（SET-PAEEXAMINATION）_92520039.md`
