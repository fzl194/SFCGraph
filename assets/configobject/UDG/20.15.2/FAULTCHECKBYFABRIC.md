...
- [LST FAULTCHECKBYFABRIC](command/UDG/20.15.2/LST-FAULTCHECKBYFABRIC.md)
- [SET FAULTCHECKBYFABRIC](command/UDG/20.15.2/SET-FAULTCHECKBYFABRIC.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询故障快速检测配置信息（LST-FAULTCHECKBYFABRIC）_76551421.md`
