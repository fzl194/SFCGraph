...
- [ADD RULEBINDING](command/UDG/20.15.2/ADD-RULEBINDING.md)
- [LST RULEBINDING](command/UDG/20.15.2/LST-RULEBINDING.md)
- [RMV RULEBINDING](command/UDG/20.15.2/RMV-RULEBINDING.md)

## 关联对象

- [USERPROFILE](configobject/UDG/20.15.2/USERPROFILE.md)
