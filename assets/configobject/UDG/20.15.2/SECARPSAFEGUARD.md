---
id: UDG@20.15.2@ConfigObject@SECARPSAFEGUARD
type: ConfigObject
...
- [LST SECARPSAFEGUARD](command/UDG/20.15.2/LST-SECARPSAFEGUARD.md)
- [SET SECARPSAFEGUARD](command/UDG/20.15.2/SET-SECARPSAFEGUARD.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询ARP双向分离（LST-SECARPSAFEGUARD）_49961834.md`
- 原始手册：`evidence/UDG/20.15.2/设置ARP双向分离（SET-SECARPSAFEGUARD）_00440345.md`
