---
id: UDG@20.15.2@ConfigObject@BYPASSSWITCH
type: ConfigObject
...
- [[command/UDG/20.15.2/DSP-BYPASSSWITCH]] · DSP BYPASSSWITCH
- [[command/UDG/20.15.2/SET-BYPASSSWITCH]] · SET BYPASSSWITCH

## 证据

- 原始手册：`evidence/UDG/20.15.2/BYPASSSWITCH.md`
- 原始手册：`evidence/UDG/20.15.2/BYPASSSWITCH.md`
