---
id: UDG@20.15.2@ConfigObject@AUTOCONFIG
type: ConfigObject
...
![](设置自动配置开关（SET AUTOCONFIG）_00840833.assets/notice_3.0-zh-cn.png)
...
- [LST AUTOCONFIG](command/UDG/20.15.2/LST-AUTOCONFIG.md)
- [SET AUTOCONFIG](command/UDG/20.15.2/SET-AUTOCONFIG.md)
