---
id: UDG@20.15.2@ConfigObject@UDPSTATISTIC
type: ConfigObject
...
- [DSP UDPSTATISTIC](command/UDG/20.15.2/DSP-UDPSTATISTIC.md)
- [RTR UDPSTATISTIC](command/UDG/20.15.2/RTR-UDPSTATISTIC.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询UDP报文统计（DSP-UDPSTATISTIC）_00841769.md`
