---
id: UDG@20.15.2@ConfigObject@RVKLICINFO
type: ConfigObject
name: RVKLICINFO（License失效信息）
nf: UDG
version: 20.15.2
object_name: RVKLICINFO
object_kind: query_target
status: active
---

# RVKLICINFO（License失效信息）
...
- [DSP RVKLICINFO](command/UDG/20.15.2/DSP-RVKLICINFO.md)
