---
id: UDG@20.15.2@ConfigObject@LDPFECNODE
type: ConfigObject
...
- [ADD LDPFECNODE](command/UDG/20.15.2/ADD-LDPFECNODE.md)
- [LST LDPFECNODE](command/UDG/20.15.2/LST-LDPFECNODE.md)
- [RMV LDPFECNODE](command/UDG/20.15.2/RMV-LDPFECNODE.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/删除FEC节点（RMV-LDPFECNODE）_49961710.md`
- 原始手册：`evidence/UDG/20.15.2/查询FEC节点配置（LST-LDPFECNODE）_49961106.md`
