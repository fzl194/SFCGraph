---
id: UDG@20.15.2@ConfigObject@ICMPOPTSECURITY
type: ConfigObject
...
- [ADD ICMPOPTSECURITY](command/UDG/20.15.2/ADD-ICMPOPTSECURITY.md)
- [LST ICMPOPTSECURITY](command/UDG/20.15.2/LST-ICMPOPTSECURITY.md)
- [RMV ICMPOPTSECURITY](command/UDG/20.15.2/RMV-ICMPOPTSECURITY.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/删除ICMP选项安全配置（RMV-ICMPOPTSECURITY）_00865857.md`
- 原始手册：`evidence/UDG/20.15.2/增加ICMP选项安全配置（ADD-ICMPOPTSECURITY）_49801634.md`
