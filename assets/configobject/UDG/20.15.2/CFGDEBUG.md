...
- [DSP CFGDEBUG](command/UDG/20.15.2/DSP-CFGDEBUG.md)
- [SET CFGDEBUG](command/UDG/20.15.2/SET-CFGDEBUG.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/显示CFG诊断日志（DSP-CFGDEBUG）_59104261.md`
- 原始手册：`evidence/UDG/20.15.2/设置调试配置信息（SET-CFGDEBUG）_83893741.md`
