---
id: UDG@20.15.2@ConfigObject@FAULTDETECT
type: ConfigObject
...
![](设置故障策略配置（SET FAULTDETECT）_59103724.assets/notice_3.0-zh-cn.png)
...
- [LST FAULTDETECT](command/UDG/20.15.2/LST-FAULTDETECT.md)
- [SET FAULTDETECT](command/UDG/20.15.2/SET-FAULTDETECT.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/显示故障策略信息（LST-FAULTDETECT）_59103703.md`
