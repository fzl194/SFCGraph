---
id: UDG@20.15.2@ConfigObject@FABRICSUBHEALTHY
type: ConfigObject
...
- [DSP FABRICSUBHEALTHY](command/UDG/20.15.2/DSP-FABRICSUBHEALTHY.md)
- [LST FABRICSUBHEALTHY](command/UDG/20.15.2/LST-FABRICSUBHEALTHY.md)
- [SET FABRICSUBHEALTHY](command/UDG/20.15.2/SET-FABRICSUBHEALTHY.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/显示FABRIC内联口亚健康信息（DSP-FABRICSUBHEALTHY）_92520048.md`
- 原始手册：`evidence/UDG/20.15.2/查询Fabric亚健康全局配置（LST-FABRICSUBHEALTHY）_92520019.md`
- 原始手册：`evidence/UDG/20.15.2/设置Fabric亚健康全局配置（SET-FABRICSUBHEALTHY）_92520011.md`
