...
- [LST HOSTGLBCONFIG](command/UDG/20.15.2/LST-HOSTGLBCONFIG.md)
- [SET HOSTGLBCONFIG](command/UDG/20.15.2/SET-HOSTGLBCONFIG.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询主机收发全局属性（LST-HOSTGLBCONFIG）_00441209.md`
- 原始手册：`evidence/UDG/20.15.2/设置主机收发全局属性（SET-HOSTGLBCONFIG）_00866597.md`
