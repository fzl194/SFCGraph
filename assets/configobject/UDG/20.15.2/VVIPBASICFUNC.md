---
id: UDG@20.15.2@ConfigObject@VVIPBASICFUNC
type: ConfigObject
name: VVIPBASICFUNC（重点业务保障基本功能）
nf: UDG
version: 20.15.2
object_name: VVIPBASICFUNC
...
- [LST VVIPBASICFUNC](command/UDG/20.15.2/LST-VVIPBASICFUNC.md)
- [SET VVIPBASICFUNC](command/UDG/20.15.2/SET-VVIPBASICFUNC.md)
