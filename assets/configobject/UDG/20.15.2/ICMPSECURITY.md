---
id: UDG@20.15.2@ConfigObject@ICMPSECURITY
type: ConfigObject
...
- [ADD ICMPSECURITY](command/UDG/20.15.2/ADD-ICMPSECURITY.md)
- [LST ICMPSECURITY](command/UDG/20.15.2/LST-ICMPSECURITY.md)
- [MOD ICMPSECURITY](command/UDG/20.15.2/MOD-ICMPSECURITY.md)
- [RMV ICMPSECURITY](command/UDG/20.15.2/RMV-ICMPSECURITY.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/修改ICMP安全配置（MOD-ICMPSECURITY）_00440777.md`
