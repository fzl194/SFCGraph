...
- [ADD SERVICESTAT](command/UDG/20.15.2/ADD-SERVICESTAT.md)
- [LST SERVICESTAT](command/UDG/20.15.2/LST-SERVICESTAT.md)
- [MOD SERVICESTAT](command/UDG/20.15.2/MOD-SERVICESTAT.md)
- [RMV SERVICESTAT](command/UDG/20.15.2/RMV-SERVICESTAT.md)
