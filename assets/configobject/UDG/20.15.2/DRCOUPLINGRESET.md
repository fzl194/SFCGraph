...
- [[command/UDG/20.15.2/LST-DRCOUPLINGRESET]] · LST DRCOUPLINGRESET
- [[command/UDG/20.15.2/SET-DRCOUPLINGRESET]] · SET DRCOUPLINGRESET

## 证据

- 原始手册：`evidence/UDG/20.15.2/DRCOUPLINGRESET.md`
- 原始手册：`evidence/UDG/20.15.2/DRCOUPLINGRESET.md`
