---
id: UDG@20.15.2@ConfigObject@ACSPATCH
type: ConfigObject
name: ACSPATCH（补丁）
nf: UDG
version: 20.15.2
object_name: ACSPATCH
object_kind: entity
status: active
---
...
![](删除补丁（RMV ACSPATCH）_05338959.assets/notice_3.0-zh-cn.png)
...
- [CLB ACSPATCH](command/UDG/20.15.2/CLB-ACSPATCH.md)
- [RMV ACSPATCH](command/UDG/20.15.2/RMV-ACSPATCH.md)
