---
id: UDG@20.15.2@ConfigObject@EXTERNALDB
type: ConfigObject
name: EXTERNALDB（外置规则数据库）
nf: UDG
version: 20.15.2
object_name: EXTERNALDB
object_kind: entity
applicable_nf:
- PGW-U
- UPF
...
- [DSP EXTERNALDB](command/UDG/20.15.2/DSP-EXTERNALDB.md)
- [LOD EXTERNALDB](command/UDG/20.15.2/LOD-EXTERNALDB.md)
- [RMV EXTERNALDB](command/UDG/20.15.2/RMV-EXTERNALDB.md)
