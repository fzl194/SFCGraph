---
id: UDG@20.15.2@ConfigObject@BYPASSMODE
type: ConfigObject
...
![](查询节点BYPASS模式（DSP BYPASSMODE）_47816794.assets/notice_3.0-zh-cn.png)
...
- 原始手册：`evidence/UDG/20.15.2/查询节点BYPASS模式（DSP-BYPASSMODE）_47816794.md`
