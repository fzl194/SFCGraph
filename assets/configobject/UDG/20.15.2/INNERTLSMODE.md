...
- [LST INNERTLSMODE](command/UDG/20.15.2/LST-INNERTLSMODE.md)
- [SET INNERTLSMODE](command/UDG/20.15.2/SET-INNERTLSMODE.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询TLS模式（LST-INNERTLSMODE）_63673348.md`
- 原始手册：`evidence/UDG/20.15.2/设置TLS模式（SET-INNERTLSMODE）_63673351.md`
