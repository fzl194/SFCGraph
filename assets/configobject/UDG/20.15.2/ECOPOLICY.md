---
id: UDG@20.15.2@ConfigObject@ECOPOLICY
type: ConfigObject
...
- [LST ECOPOLICY](command/UDG/20.15.2/LST-ECOPOLICY.md)
- [SET ECOPOLICY](command/UDG/20.15.2/SET-ECOPOLICY.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询全局的CPU调频和休眠策略（LST-ECOPOLICY）_45912120.md`
- 原始手册：`evidence/UDG/20.15.2/设置全局的CPU调频和休眠策略（SET-ECOPOLICY）_97016349.md`
