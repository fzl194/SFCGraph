---
id: UDG@20.15.2@ConfigObject@MSSTBMFILTER
type: ConfigObject
...
- [DSP MSSTBMFILTER](command/UDG/20.15.2/DSP-MSSTBMFILTER.md)
- [SET MSSTBMFILTER](command/UDG/20.15.2/SET-MSSTBMFILTER.md)
