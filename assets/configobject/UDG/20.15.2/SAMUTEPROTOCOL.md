---
id: UDG@20.15.2@ConfigObject@SAMUTEPROTOCOL
type: ConfigObject
name: SAMUTEPROTOCOL（SA EGN规则不启用协议）
nf: UDG
version: 20.15.2
object_name: SAMUTEPROTOCOL
object_kind: entity
applicable_nf:
- PGW-U
- UPF
...
- [ADD SAMUTEPROTOCOL](command/UDG/20.15.2/ADD-SAMUTEPROTOCOL.md)
- [LST SAMUTEPROTOCOL](command/UDG/20.15.2/LST-SAMUTEPROTOCOL.md)
- [RMV SAMUTEPROTOCOL](command/UDG/20.15.2/RMV-SAMUTEPROTOCOL.md)
