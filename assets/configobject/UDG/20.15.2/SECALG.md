...
- [LST SECALG](command/UDG/20.15.2/LST-SECALG.md)
- [SET SECALG](command/UDG/20.15.2/SET-SECALG.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询安全算法（LST-SECALG）_55386938.md`
- 原始手册：`evidence/UDG/20.15.2/设置安全算法（SET-SECALG）_01666249.md`
