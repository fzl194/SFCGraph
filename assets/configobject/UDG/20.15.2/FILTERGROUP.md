---
id: UDG@20.15.2@ConfigObject@FILTERGROUP
type: ConfigObject
name: FILTERGROUP（过滤器组）
nf: UDG
version: 20.15.2
object_name: FILTERGROUP
object_kind: entity
applicable_nf:
- PGW-U
- UPF
...
- [ADD FILTERGROUP](command/UDG/20.15.2/ADD-FILTERGROUP.md)
- [LST FILTERGROUP](command/UDG/20.15.2/LST-FILTERGROUP.md)
- [RMV FILTERGROUP](command/UDG/20.15.2/RMV-FILTERGROUP.md)
