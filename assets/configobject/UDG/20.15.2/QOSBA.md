---
id: UDG@20.15.2@ConfigObject@QOSBA
type: ConfigObject
name: QOSBA（QoS BA）
nf: UDG
version: 20.15.2
...
- [LST QOSBA](command/UDG/20.15.2/LST-QOSBA.md)
- [SET QOSBA](command/UDG/20.15.2/SET-QOSBA.md)

## 证据

- 原始手册：`evidence/UDG/20.15.2/查询QoS-BA（LST-QOSBA）_00441337.md`
