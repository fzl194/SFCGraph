---
id: UDG@20.15.2@ConfigObject@VPNTARGET
type: ConfigObject
...
- [[command/UDG/20.15.2/ADD-VPNTARGET]] · ADD VPNTARGET
- [[command/UDG/20.15.2/LST-VPNTARGET]] · LST VPNTARGET
- [[command/UDG/20.15.2/RMV-VPNTARGET]] · RMV VPNTARGET

## 证据

- 原始手册：`evidence/UDG/20.15.2/VPNTARGET.md`
- 原始手册：`evidence/UDG/20.15.2/VPNTARGET.md`
- 原始手册：`evidence/UDG/20.15.2/VPNTARGET.md`
