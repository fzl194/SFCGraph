---
id: UNC@20.15.2@ConfigObject@HTTPVPNMAP
type: ConfigObject
...
- [ADD HTTPVPNMAP](command/UNC/20.15.2/ADD-HTTPVPNMAP.md)
- [LST HTTPVPNMAP](command/UNC/20.15.2/LST-HTTPVPNMAP.md)
- [RMV HTTPVPNMAP](command/UNC/20.15.2/RMV-HTTPVPNMAP.md)
