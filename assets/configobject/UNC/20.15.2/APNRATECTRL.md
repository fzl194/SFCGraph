---
id: UNC@20.15.2@ConfigObject@APNRATECTRL
type: ConfigObject
name: APNRATECTRL（APN速率控制配置）
nf: UNC
version: 20.15.2
object_name: APNRATECTRL
...
- [LST APNRATECTRL](command/UNC/20.15.2/LST-APNRATECTRL.md)
- [SET APNRATECTRL](command/UNC/20.15.2/SET-APNRATECTRL.md)
