---
id: UNC@20.15.2@ConfigObject@ZCCONVERT
type: ConfigObject
name: ZCCONVERT（区域码转换策略）
nf: UNC
version: 20.15.2
object_name: ZCCONVERT
object_kind: entity
applicable_nf:
- SGSN
- MME
...
- [ADD ZCCONVERT](command/UNC/20.15.2/ADD-ZCCONVERT.md)
- [LST ZCCONVERT](command/UNC/20.15.2/LST-ZCCONVERT.md)
- [MOD ZCCONVERT](command/UNC/20.15.2/MOD-ZCCONVERT.md)
- [RMV ZCCONVERT](command/UNC/20.15.2/RMV-ZCCONVERT.md)
