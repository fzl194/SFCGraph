...
- [LST FAULTDETECT](command/UNC/20.15.2/LST-FAULTDETECT.md)
- [SET FAULTDETECT](command/UNC/20.15.2/SET-FAULTDETECT.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/显示故障策略信息（LST-FAULTDETECT）_59103703.md`
- 原始手册：`evidence/UNC/20.15.2/设置故障策略配置（SET-FAULTDETECT）_59103724.md`
