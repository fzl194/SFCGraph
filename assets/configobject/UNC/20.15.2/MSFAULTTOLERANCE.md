---
id: UNC@20.15.2@ConfigObject@MSFAULTTOLERANCE
type: ConfigObject
...
- [LST MSFAULTTOLERANCE](command/UNC/20.15.2/LST-MSFAULTTOLERANCE.md)
- [SET MSFAULTTOLERANCE](command/UNC/20.15.2/SET-MSFAULTTOLERANCE.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询故障检测参数（LST-MSFAULTTOLERANCE）_09587939.md`
