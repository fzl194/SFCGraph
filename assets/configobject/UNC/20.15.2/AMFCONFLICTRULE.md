---
id: UNC@20.15.2@ConfigObject@AMFCONFLICTRULE
type: ConfigObject
name: AMFCONFLICTRULE（AMF冲突规则）
nf: UNC
version: 20.15.2
object_name: AMFCONFLICTRULE
object_kind: entity
applicable_nf:
- AMF
status: active
...
- [ADD AMFCONFLICTRULE](command/UNC/20.15.2/ADD-AMFCONFLICTRULE.md)
- [DSP AMFCONFLICTRULE](command/UNC/20.15.2/DSP-AMFCONFLICTRULE.md)
- [LST AMFCONFLICTRULE](command/UNC/20.15.2/LST-AMFCONFLICTRULE.md)
- [MOD AMFCONFLICTRULE](command/UNC/20.15.2/MOD-AMFCONFLICTRULE.md)
- [RMV AMFCONFLICTRULE](command/UNC/20.15.2/RMV-AMFCONFLICTRULE.md)
