---
id: UNC@20.15.2@ConfigObject@NBOFFLOADBYMME
type: ConfigObject
name: NBOFFLOADBYMME（NB-IoT用户的MME迁移任务）
nf: UNC
version: 20.15.2
object_name: NBOFFLOADBYMME
object_kind: action
applicable_nf:
- MME
status: active
...
# NBOFFLOADBYMME（NB-IoT用户的MME迁移任务）
...
- [STR NBOFFLOADBYMME](command/UNC/20.15.2/STR-NBOFFLOADBYMME.md)
