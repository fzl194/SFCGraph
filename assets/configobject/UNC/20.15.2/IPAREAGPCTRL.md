---
id: UNC@20.15.2@ConfigObject@IPAREAGPCTRL
type: ConfigObject
name: IPAREAGPCTRL（基于位置分配IP地址策略）
nf: UNC
version: 20.15.2
object_name: IPAREAGPCTRL
...
- [LST IPAREAGPCTRL](command/UNC/20.15.2/LST-IPAREAGPCTRL.md)
- [SET IPAREAGPCTRL](command/UNC/20.15.2/SET-IPAREAGPCTRL.md)
