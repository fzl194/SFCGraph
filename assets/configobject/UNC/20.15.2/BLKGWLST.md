---
id: UNC@20.15.2@ConfigObject@BLKGWLST
type: ConfigObject
name: BLKGWLST（被禁用网关配置）
nf: UNC
version: 20.15.2
object_name: BLKGWLST
object_kind: entity
status: active
---
...
- [ADD BLKGWLST](command/UNC/20.15.2/ADD-BLKGWLST.md)
- [LST BLKGWLST](command/UNC/20.15.2/LST-BLKGWLST.md)
- [RMV BLKGWLST](command/UNC/20.15.2/RMV-BLKGWLST.md)
