---
id: UNC@20.15.2@ConfigObject@VLROFFLOADBYLAI
type: ConfigObject
name: VLROFFLOADBYLAI（IMSI分离4G用户任务）
nf: UNC
version: 20.15.2
object_name: VLROFFLOADBYLAI
object_kind: action
applicable_nf:
- MME
status: active
...
- [DSP VLROFFLOADBYLAI](command/UNC/20.15.2/DSP-VLROFFLOADBYLAI.md)
- [STP VLROFFLOADBYLAI](command/UNC/20.15.2/STP-VLROFFLOADBYLAI.md)
- [STR VLROFFLOADBYLAI](command/UNC/20.15.2/STR-VLROFFLOADBYLAI.md)
