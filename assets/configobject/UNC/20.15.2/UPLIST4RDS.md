---
id: UNC@20.15.2@ConfigObject@UPLIST4RDS
type: ConfigObject
name: UPLIST4RDS（从RADIUS服务器使用的UP列表中删除UP）
nf: UNC
version: 20.15.2
object_name: UPLIST4RDS
object_kind: entity
applicable_nf:
- PGW-C
- SMF
...
# UPLIST4RDS（从RADIUS服务器使用的UP列表中删除UP）
...
- [ADD UPLIST4RDS](command/UNC/20.15.2/ADD-UPLIST4RDS.md)
- [LST UPLIST4RDS](command/UNC/20.15.2/LST-UPLIST4RDS.md)
- [RMV UPLIST4RDS](command/UNC/20.15.2/RMV-UPLIST4RDS.md)
