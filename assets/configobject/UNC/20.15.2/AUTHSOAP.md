---
id: UNC@20.15.2@ConfigObject@AUTHSOAP
type: ConfigObject
...
- [LST AUTHSOAP](command/UNC/20.15.2/LST-AUTHSOAP.md)
- [SET AUTHSOAP](command/UNC/20.15.2/SET-AUTHSOAP.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询网管登录认证策略（LST-AUTHSOAP）_97635699.md`
