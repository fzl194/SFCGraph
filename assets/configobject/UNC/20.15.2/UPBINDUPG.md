---
id: UNC@20.15.2@ConfigObject@UPBINDUPG
type: ConfigObject
name: UPBINDUPG（用户模板组和用户模板的绑定关系）
nf: UNC
version: 20.15.2
object_name: UPBINDUPG
object_kind: binding
applicable_nf:
- PGW-C
- SMF
...
- [[command/UNC/20.15.2/ADD-UPBINDUPG]] · ADD UPBINDUPG
- [[command/UNC/20.15.2/LST-UPBINDUPG]] · LST UPBINDUPG
- [[command/UNC/20.15.2/MOD-UPBINDUPG]] · MOD UPBINDUPG
- [[command/UNC/20.15.2/RMV-UPBINDUPG]] · RMV UPBINDUPG
