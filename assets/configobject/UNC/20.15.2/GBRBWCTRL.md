---
id: UNC@20.15.2@ConfigObject@GBRBWCTRL
type: ConfigObject
name: GBRBWCTRL（GBR承载带宽速率控制配置）
nf: UNC
version: 20.15.2
object_name: GBRBWCTRL
object_kind: entity
applicable_nf:
- GGSN
- PGW-C
...
- [ADD GBRBWCTRL](command/UNC/20.15.2/ADD-GBRBWCTRL.md)
- [LST GBRBWCTRL](command/UNC/20.15.2/LST-GBRBWCTRL.md)
- [MOD GBRBWCTRL](command/UNC/20.15.2/MOD-GBRBWCTRL.md)
- [RMV GBRBWCTRL](command/UNC/20.15.2/RMV-GBRBWCTRL.md)
