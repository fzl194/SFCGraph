---
id: UNC@20.15.2@ConfigObject@CHGIMSICFG
type: ConfigObject
name: CHGIMSICFG（IMSI计费配置）
nf: UNC
version: 20.15.2
object_name: CHGIMSICFG
object_kind: entity
applicable_nf:
- SGSN
status: active
...
- [ADD CHGIMSICFG](command/UNC/20.15.2/ADD-CHGIMSICFG.md)
- [LST CHGIMSICFG](command/UNC/20.15.2/LST-CHGIMSICFG.md)
- [MOD CHGIMSICFG](command/UNC/20.15.2/MOD-CHGIMSICFG.md)
- [RMV CHGIMSICFG](command/UNC/20.15.2/RMV-CHGIMSICFG.md)
