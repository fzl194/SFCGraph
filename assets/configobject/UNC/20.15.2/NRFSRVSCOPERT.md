---
id: UNC@20.15.2@ConfigObject@NRFSRVSCOPERT
type: ConfigObject
name: NRFSRVSCOPERT（ServingScope路由）
nf: UNC
version: 20.15.2
object_name: NRFSRVSCOPERT
object_kind: entity
applicable_nf:
- NRF
status: active
...
- [ADD NRFSRVSCOPERT](command/UNC/20.15.2/ADD-NRFSRVSCOPERT.md)
- [LST NRFSRVSCOPERT](command/UNC/20.15.2/LST-NRFSRVSCOPERT.md)
- [RMV NRFSRVSCOPERT](command/UNC/20.15.2/RMV-NRFSRVSCOPERT.md)
