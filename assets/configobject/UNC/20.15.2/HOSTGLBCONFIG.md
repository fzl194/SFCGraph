---
id: UNC@20.15.2@ConfigObject@HOSTGLBCONFIG
type: ConfigObject
...
- [LST HOSTGLBCONFIG](command/UNC/20.15.2/LST-HOSTGLBCONFIG.md)
- [SET HOSTGLBCONFIG](command/UNC/20.15.2/SET-HOSTGLBCONFIG.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询主机收发全局属性（LST-HOSTGLBCONFIG）_00441209.md`
