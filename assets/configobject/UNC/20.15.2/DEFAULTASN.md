---
id: UNC@20.15.2@ConfigObject@DEFAULTASN
type: ConfigObject
name: DEFAULTASN（缺省ASN值）
nf: UNC
version: 20.15.2
object_name: DEFAULTASN
...
- [LST DEFAULTASN](command/UNC/20.15.2/LST-DEFAULTASN.md)
- [SET DEFAULTASN](command/UNC/20.15.2/SET-DEFAULTASN.md)
