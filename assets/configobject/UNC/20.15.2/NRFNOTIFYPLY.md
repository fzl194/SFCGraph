---
id: UNC@20.15.2@ConfigObject@NRFNOTIFYPLY
type: ConfigObject
name: NRFNOTIFYPLY（NRF通知策略）
nf: UNC
version: 20.15.2
object_name: NRFNOTIFYPLY
...
- [LST NRFNOTIFYPLY](command/UNC/20.15.2/LST-NRFNOTIFYPLY.md)
- [SET NRFNOTIFYPLY](command/UNC/20.15.2/SET-NRFNOTIFYPLY.md)
