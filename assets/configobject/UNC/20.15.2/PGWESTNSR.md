---
id: UNC@20.15.2@ConfigObject@PGWESTNSR
type: ConfigObject
name: PGWESTNSR（E-STN-SR和PGW关系配置表）
nf: UNC
version: 20.15.2
object_name: PGWESTNSR
object_kind: entity
applicable_nf:
- MME
status: active
...
- [ADD PGWESTNSR](command/UNC/20.15.2/ADD-PGWESTNSR.md)
- [LST PGWESTNSR](command/UNC/20.15.2/LST-PGWESTNSR.md)
- [MOD PGWESTNSR](command/UNC/20.15.2/MOD-PGWESTNSR.md)
- [RMV PGWESTNSR](command/UNC/20.15.2/RMV-PGWESTNSR.md)
