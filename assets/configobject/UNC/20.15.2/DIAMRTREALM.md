---
id: UNC@20.15.2@ConfigObject@DIAMRTREALM
type: ConfigObject
name: DIAMRTREALM（Diameter路由域名信息）
nf: UNC
version: 20.15.2
object_name: DIAMRTREALM
object_kind: entity
applicable_nf:
- PGW-C
- SMF
...
- [ADD DIAMRTREALM](command/UNC/20.15.2/ADD-DIAMRTREALM.md)
- [LST DIAMRTREALM](command/UNC/20.15.2/LST-DIAMRTREALM.md)
- [MOD DIAMRTREALM](command/UNC/20.15.2/MOD-DIAMRTREALM.md)
- [RMV DIAMRTREALM](command/UNC/20.15.2/RMV-DIAMRTREALM.md)
