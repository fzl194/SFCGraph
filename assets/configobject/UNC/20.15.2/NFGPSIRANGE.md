---
id: UNC@20.15.2@ConfigObject@NFGPSIRANGE
type: ConfigObject
name: NFGPSIRANGE（NF GPSIRANGE信息）
nf: UNC
version: 20.15.2
object_name: NFGPSIRANGE
object_kind: entity
applicable_nf:
- SMSF
status: active
...
- [ADD NFGPSIRANGE](command/UNC/20.15.2/ADD-NFGPSIRANGE.md)
- [LST NFGPSIRANGE](command/UNC/20.15.2/LST-NFGPSIRANGE.md)
- [RMV NFGPSIRANGE](command/UNC/20.15.2/RMV-NFGPSIRANGE.md)
