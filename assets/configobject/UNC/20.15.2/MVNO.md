---
id: UNC@20.15.2@ConfigObject@MVNO
type: ConfigObject
name: MVNO（MVNO配置信息）
nf: UNC
version: 20.15.2
...
- [ADD MVNO](command/UNC/20.15.2/ADD-MVNO.md)
- [LST MVNO](command/UNC/20.15.2/LST-MVNO.md)
- [MOD MVNO](command/UNC/20.15.2/MOD-MVNO.md)
- [RMV MVNO](command/UNC/20.15.2/RMV-MVNO.md)
