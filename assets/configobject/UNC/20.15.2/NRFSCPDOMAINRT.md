...
- [[command/UNC/20.15.2/ADD-NRFSCPDOMAINRT]] · ADD NRFSCPDOMAINRT
- [[command/UNC/20.15.2/LST-NRFSCPDOMAINRT]] · LST NRFSCPDOMAINRT
- [[command/UNC/20.15.2/RMV-NRFSCPDOMAINRT]] · RMV NRFSCPDOMAINRT

## 证据

- 原始手册：`evidence/UNC/20.15.2/NRFSCPDOMAINRT.md`
- 原始手册：`evidence/UNC/20.15.2/NRFSCPDOMAINRT.md`
- 原始手册：`evidence/UNC/20.15.2/NRFSCPDOMAINRT.md`
