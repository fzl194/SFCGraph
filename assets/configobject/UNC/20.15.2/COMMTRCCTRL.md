---
id: UNC@20.15.2@ConfigObject@COMMTRCCTRL
type: ConfigObject
name: COMMTRCCTRL（通用模块跟踪控制功能）
nf: UNC
version: 20.15.2
object_name: COMMTRCCTRL
...
- [LST COMMTRCCTRL](command/UNC/20.15.2/LST-COMMTRCCTRL.md)
- [SET COMMTRCCTRL](command/UNC/20.15.2/SET-COMMTRCCTRL.md)
