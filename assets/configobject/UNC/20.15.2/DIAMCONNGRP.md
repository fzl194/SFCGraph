---
id: UNC@20.15.2@ConfigObject@DIAMCONNGRP
type: ConfigObject
name: DIAMCONNGRP（Diameter链路组）
nf: UNC
version: 20.15.2
object_name: DIAMCONNGRP
object_kind: entity
applicable_nf:
- PGW-C
- SMF
...
- [ADD DIAMCONNGRP](command/UNC/20.15.2/ADD-DIAMCONNGRP.md)
- [LST DIAMCONNGRP](command/UNC/20.15.2/LST-DIAMCONNGRP.md)
- [MOD DIAMCONNGRP](command/UNC/20.15.2/MOD-DIAMCONNGRP.md)
- [RMV DIAMCONNGRP](command/UNC/20.15.2/RMV-DIAMCONNGRP.md)
- [RST DIAMCONNGRP](command/UNC/20.15.2/RST-DIAMCONNGRP.md)
