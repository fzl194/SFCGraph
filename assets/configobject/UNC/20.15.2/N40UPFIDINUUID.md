---
id: UNC@20.15.2@ConfigObject@N40UPFIDINUUID
type: ConfigObject
name: N40UPFIDINUUID（N40接口非UUID格式与UUID格式的UPF实例标识的映射关系）
nf: UNC
version: 20.15.2
object_name: N40UPFIDINUUID
object_kind: entity
applicable_nf:
- PGW-C
- SMF
...
# N40UPFIDINUUID（N40接口非UUID格式与UUID格式的UPF实例标识的映射关系）
...
- [ADD N40UPFIDINUUID](command/UNC/20.15.2/ADD-N40UPFIDINUUID.md)
- [LST N40UPFIDINUUID](command/UNC/20.15.2/LST-N40UPFIDINUUID.md)
- [MOD N40UPFIDINUUID](command/UNC/20.15.2/MOD-N40UPFIDINUUID.md)
- [RMV N40UPFIDINUUID](command/UNC/20.15.2/RMV-N40UPFIDINUUID.md)
