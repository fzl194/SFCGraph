---
id: UNC@20.15.2@ConfigObject@SECPOLICYAPPLNK
type: ConfigObject
...
- [DSP SECPOLICYAPPLNK](command/UNC/20.15.2/DSP-SECPOLICYAPPLNK.md)
- [SET SECPOLICYAPPLNK](command/UNC/20.15.2/SET-SECPOLICYAPPLNK.md)
