---
id: UNC@20.15.2@ConfigObject@NFGROUPMEM
type: ConfigObject
name: NFGROUPMEM（NF组成员）
nf: UNC
version: 20.15.2
object_name: NFGROUPMEM
object_kind: entity
applicable_nf:
- NRF
status: active
...
- [ADD NFGROUPMEM](command/UNC/20.15.2/ADD-NFGROUPMEM.md)
- [LST NFGROUPMEM](command/UNC/20.15.2/LST-NFGROUPMEM.md)
- [RMV NFGROUPMEM](command/UNC/20.15.2/RMV-NFGROUPMEM.md)
