---
id: UNC@20.15.2@ConfigObject@SMFPRESELBYIMSI
type: ConfigObject
name: SMFPRESELBYIMSI（基于IMSI优选指定SMF配置）
nf: UNC
version: 20.15.2
object_name: SMFPRESELBYIMSI
object_kind: entity
applicable_nf:
- AMF
status: active
...
# SMFPRESELBYIMSI（基于IMSI优选指定SMF配置）
...
- [ADD SMFPRESELBYIMSI](command/UNC/20.15.2/ADD-SMFPRESELBYIMSI.md)
- [LST SMFPRESELBYIMSI](command/UNC/20.15.2/LST-SMFPRESELBYIMSI.md)
- [MOD SMFPRESELBYIMSI](command/UNC/20.15.2/MOD-SMFPRESELBYIMSI.md)
- [RMV SMFPRESELBYIMSI](command/UNC/20.15.2/RMV-SMFPRESELBYIMSI.md)
