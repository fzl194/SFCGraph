...
- [ADD TAIRANGELIST](command/UNC/20.15.2/ADD-TAIRANGELIST.md)
- [LST TAIRANGELIST](command/UNC/20.15.2/LST-TAIRANGELIST.md)
- [RMV TAIRANGELIST](command/UNC/20.15.2/RMV-TAIRANGELIST.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/删除NF-TAI区域信息（RMV-TAIRANGELIST）_09653841.md`
- 原始手册：`evidence/UNC/20.15.2/增加NF-TAI区域信息（ADD-TAIRANGELIST）_09654429.md`
