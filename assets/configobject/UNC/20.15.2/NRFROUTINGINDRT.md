...
- [ADD NRFROUTINGINDRT](command/UNC/20.15.2/ADD-NRFROUTINGINDRT.md)
- [LST NRFROUTINGINDRT](command/UNC/20.15.2/LST-NRFROUTINGINDRT.md)
- [MOD NRFROUTINGINDRT](command/UNC/20.15.2/MOD-NRFROUTINGINDRT.md)
- [RMV NRFROUTINGINDRT](command/UNC/20.15.2/RMV-NRFROUTINGINDRT.md)
