---
id: UNC@20.15.2@ConfigObject@MASALMRPTMODE
type: ConfigObject
...
- [LST MASALMRPTMODE](command/UNC/20.15.2/LST-MASALMRPTMODE.md)
- [SET MASALMRPTMODE](command/UNC/20.15.2/SET-MASALMRPTMODE.md)
