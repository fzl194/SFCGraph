---
id: UNC@20.15.2@ConfigObject@VUPFIDBINDFUNC
type: ConfigObject
name: VUPFIDBINDFUNC（虚拟UPF实例标识的绑定功能）
nf: UNC
version: 20.15.2
object_name: VUPFIDBINDFUNC
object_kind: binding
applicable_nf:
- SMF
status: active
...
- [ADD VUPFIDBINDFUNC](command/UNC/20.15.2/ADD-VUPFIDBINDFUNC.md)
- [LST VUPFIDBINDFUNC](command/UNC/20.15.2/LST-VUPFIDBINDFUNC.md)
- [RMV VUPFIDBINDFUNC](command/UNC/20.15.2/RMV-VUPFIDBINDFUNC.md)
