---
id: UNC@20.15.2@ConfigObject@NSSFCFGSUBSW
type: ConfigObject
name: NSSFCFGSUBSW（按签约NSSAI分配Configed NSSAI的PLMN级别开关）
nf: UNC
version: 20.15.2
object_name: NSSFCFGSUBSW
object_kind: entity
applicable_nf:
- NSSF
status: active
...
# NSSFCFGSUBSW（按签约NSSAI分配Configed NSSAI的PLMN级别开关）
...
- [ADD NSSFCFGSUBSW](command/UNC/20.15.2/ADD-NSSFCFGSUBSW.md)
- [LST NSSFCFGSUBSW](command/UNC/20.15.2/LST-NSSFCFGSUBSW.md)
- [MOD NSSFCFGSUBSW](command/UNC/20.15.2/MOD-NSSFCFGSUBSW.md)
- [RMV NSSFCFGSUBSW](command/UNC/20.15.2/RMV-NSSFCFGSUBSW.md)
