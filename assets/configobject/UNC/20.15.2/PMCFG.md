---
id: UNC@20.15.2@ConfigObject@PMCFG
type: ConfigObject
name: PMCFG（性能统计配置参数）
nf: UNC
version: 20.15.2
...
![](设置性能统计配置参数(SET PMCFG)_11513104.assets/notice_3.0-zh-cn_2.png)
...
- [LST PMCFG](command/UNC/20.15.2/LST-PMCFG.md)
- [SET PMCFG](command/UNC/20.15.2/SET-PMCFG.md)
