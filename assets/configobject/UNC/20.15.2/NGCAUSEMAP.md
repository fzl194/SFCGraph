---
id: UNC@20.15.2@ConfigObject@NGCAUSEMAP
type: ConfigObject
name: NGCAUSEMAP（5G原因值映射配置）
nf: UNC
version: 20.15.2
object_name: NGCAUSEMAP
object_kind: entity
applicable_nf:
- AMF
status: active
...
- [ADD NGCAUSEMAP](command/UNC/20.15.2/ADD-NGCAUSEMAP.md)
- [LST NGCAUSEMAP](command/UNC/20.15.2/LST-NGCAUSEMAP.md)
- [RMV NGCAUSEMAP](command/UNC/20.15.2/RMV-NGCAUSEMAP.md)
