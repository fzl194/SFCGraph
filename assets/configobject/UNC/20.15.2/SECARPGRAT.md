---
id: UNC@20.15.2@ConfigObject@SECARPGRAT
type: ConfigObject
...
- 原始手册：`evidence/UNC/20.15.2/查询免费ARP过滤（LST-SECARPGRAT）_49801814.md`
- 原始手册：`evidence/UNC/20.15.2/设置免费ARP过滤（SET-SECARPGRAT）_50280638.md`
