---
id: UNC@20.15.2@ConfigObject@CPUECOPOLICY
type: ConfigObject
...
- [LST CPUECOPOLICY](command/UNC/20.15.2/LST-CPUECOPOLICY.md)
- [SET CPUECOPOLICY](command/UNC/20.15.2/SET-CPUECOPOLICY.md)
