---
id: UNC@20.15.2@ConfigObject@NRFBINDGRP
type: ConfigObject
name: NRFBINDGRP（对端NRF实例组成员）
nf: UNC
version: 20.15.2
object_name: NRFBINDGRP
object_kind: binding
applicable_nf:
- NRF
status: active
...
- [ADD NRFBINDGRP](command/UNC/20.15.2/ADD-NRFBINDGRP.md)
- [LST NRFBINDGRP](command/UNC/20.15.2/LST-NRFBINDGRP.md)
- [MOD NRFBINDGRP](command/UNC/20.15.2/MOD-NRFBINDGRP.md)
- [RMV NRFBINDGRP](command/UNC/20.15.2/RMV-NRFBINDGRP.md)
