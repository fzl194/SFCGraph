---
id: UNC@20.15.2@ConfigObject@DNNSMARTPLCY
type: ConfigObject
name: DNNSMARTPLCY（DNN智能分流配置）
nf: UNC
version: 20.15.2
object_name: DNNSMARTPLCY
object_kind: entity
applicable_nf:
- AMF
status: active
...
- [ADD DNNSMARTPLCY](command/UNC/20.15.2/ADD-DNNSMARTPLCY.md)
- [LST DNNSMARTPLCY](command/UNC/20.15.2/LST-DNNSMARTPLCY.md)
- [MOD DNNSMARTPLCY](command/UNC/20.15.2/MOD-DNNSMARTPLCY.md)
- [RMV DNNSMARTPLCY](command/UNC/20.15.2/RMV-DNNSMARTPLCY.md)
