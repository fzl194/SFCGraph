---
id: UNC@20.15.2@ConfigObject@PNFSRVNTFSUBS
type: ConfigObject
name: PNFSRVNTFSUBS（对端NF服务实例的回调信息）
nf: UNC
version: 20.15.2
object_name: PNFSRVNTFSUBS
object_kind: entity
applicable_nf:
- AMF
- SMF
...
- [ADD PNFSRVNTFSUBS](command/UNC/20.15.2/ADD-PNFSRVNTFSUBS.md)
- [LST PNFSRVNTFSUBS](command/UNC/20.15.2/LST-PNFSRVNTFSUBS.md)
- [MOD PNFSRVNTFSUBS](command/UNC/20.15.2/MOD-PNFSRVNTFSUBS.md)
- [RMV PNFSRVNTFSUBS](command/UNC/20.15.2/RMV-PNFSRVNTFSUBS.md)
