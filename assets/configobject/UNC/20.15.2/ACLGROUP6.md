...
- [ADD ACLGROUP6](command/UNC/20.15.2/ADD-ACLGROUP6.md)
- [LST ACLGROUP6](command/UNC/20.15.2/LST-ACLGROUP6.md)
- [MOD ACLGROUP6](command/UNC/20.15.2/MOD-ACLGROUP6.md)
- [RMV ACLGROUP6](command/UNC/20.15.2/RMV-ACLGROUP6.md)
- [RTR ACLGROUP6](command/UNC/20.15.2/RTR-ACLGROUP6.md)
...
- 原始手册：`evidence/UNC/20.15.2/删除IPv6-ACL规则组（RMV-ACLGROUP6）_49961250.md`
- 原始手册：`evidence/UNC/20.15.2/增加IPv6-ACL规则组（ADD-ACLGROUP6）_50281822.md`
