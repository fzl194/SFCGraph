---
id: UNC@20.15.2@ConfigObject@ENBNSINDB
type: ConfigObject
name: ENBNSINDB（配置的eNodeB邻接关系）
nf: UNC
version: 20.15.2
object_name: ENBNSINDB
object_kind: entity
applicable_nf:
- MME
status: active
...
- 原始手册：`evidence/UNC/20.15.2/增加eNodeB邻接关系(ADD-ENBNSINDB)_72345859.md`
