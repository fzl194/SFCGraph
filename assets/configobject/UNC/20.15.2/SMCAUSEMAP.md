---
id: UNC@20.15.2@ConfigObject@SMCAUSEMAP
type: ConfigObject
name: SMCAUSEMAP（SM原因值映射配置）
nf: UNC
version: 20.15.2
object_name: SMCAUSEMAP
object_kind: entity
applicable_nf:
- SMF
- PGW-C
...
- [ADD SMCAUSEMAP](command/UNC/20.15.2/ADD-SMCAUSEMAP.md)
- [LST SMCAUSEMAP](command/UNC/20.15.2/LST-SMCAUSEMAP.md)
- [MOD SMCAUSEMAP](command/UNC/20.15.2/MOD-SMCAUSEMAP.md)
- [RMV SMCAUSEMAP](command/UNC/20.15.2/RMV-SMCAUSEMAP.md)
