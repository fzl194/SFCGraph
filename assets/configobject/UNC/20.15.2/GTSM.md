---
id: UNC@20.15.2@ConfigObject@GTSM
type: ConfigObject
...
- [LST GTSM](command/UNC/20.15.2/LST-GTSM.md)
- [SET GTSM](command/UNC/20.15.2/SET-GTSM.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询GTSM全局配置属性（LST-GTSM）_00601001.md`
