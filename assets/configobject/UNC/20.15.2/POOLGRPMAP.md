---
id: UNC@20.15.2@ConfigObject@POOLGRPMAP
type: ConfigObject
...
- [ADD POOLGRPMAP](command/UNC/20.15.2/ADD-POOLGRPMAP.md)
- [LST POOLGRPMAP](command/UNC/20.15.2/LST-POOLGRPMAP.md)
- [RMV POOLGRPMAP](command/UNC/20.15.2/RMV-POOLGRPMAP.md)
