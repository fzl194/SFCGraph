---
id: UNC@20.15.2@ConfigObject@DBTHRESHOLD
type: ConfigObject
name: DBTHRESHOLD（CSDB配置过载门限）
nf: UNC
version: 20.15.2
object_name: DBTHRESHOLD
object_kind: global_setting
status: active
---

# DBTHRESHOLD（CSDB配置过载门限）
...
- 原始手册：`evidence/UNC/20.15.2/查询CSDB配置过载门限(LST-DBTHRESHOLD)_78080691.md`
- 原始手册：`evidence/UNC/20.15.2/设置CSDB配置过载门限(SET-DBTHRESHOLD)_78080690.md`
