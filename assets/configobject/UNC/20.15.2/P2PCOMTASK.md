---
id: UNC@20.15.2@ConfigObject@P2PCOMTASK
type: ConfigObject
...
- [ACT P2PCOMTASK](command/UNC/20.15.2/ACT-P2PCOMTASK.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/激活SDR点对点通信质量检测任务（ACT-P2PCOMTASK）_63673341.md`
