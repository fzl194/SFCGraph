---
id: UNC@20.15.2@ConfigObject@TACSHAREPLMN
type: ConfigObject
name: TACSHAREPLMN（基于区域的PLMN管理）
nf: UNC
version: 20.15.2
object_name: TACSHAREPLMN
object_kind: entity
applicable_nf:
- MME
status: active
...
- [ADD TACSHAREPLMN](command/UNC/20.15.2/ADD-TACSHAREPLMN.md)
- [LST TACSHAREPLMN](command/UNC/20.15.2/LST-TACSHAREPLMN.md)
- [MOD TACSHAREPLMN](command/UNC/20.15.2/MOD-TACSHAREPLMN.md)
- [RMV TACSHAREPLMN](command/UNC/20.15.2/RMV-TACSHAREPLMN.md)
