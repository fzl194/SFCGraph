---
id: UNC@20.15.2@ConfigObject@LDPFECLIST
type: ConfigObject
...
- [ADD LDPFECLIST](command/UNC/20.15.2/ADD-LDPFECLIST.md)
- [LST LDPFECLIST](command/UNC/20.15.2/LST-LDPFECLIST.md)
- [RMV LDPFECLIST](command/UNC/20.15.2/RMV-LDPFECLIST.md)
...
- 原始手册：`evidence/UNC/20.15.2/添加FEC列表（ADD-LDPFECLIST）_00841377.md`
