---
id: UNC@20.15.2@ConfigObject@S1USRSECPARA
type: ConfigObject
name: S1USRSECPARA（S1模式用户安全配置）
nf: UNC
version: 20.15.2
object_name: S1USRSECPARA
object_kind: entity
applicable_nf:
- MME
status: active
...
- [ADD S1USRSECPARA](command/UNC/20.15.2/ADD-S1USRSECPARA.md)
- [LST S1USRSECPARA](command/UNC/20.15.2/LST-S1USRSECPARA.md)
- [MOD S1USRSECPARA](command/UNC/20.15.2/MOD-S1USRSECPARA.md)
- [RMV S1USRSECPARA](command/UNC/20.15.2/RMV-S1USRSECPARA.md)
