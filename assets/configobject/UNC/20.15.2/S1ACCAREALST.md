---
id: UNC@20.15.2@ConfigObject@S1ACCAREALST
type: ConfigObject
name: S1ACCAREALST（S1模式接入控制配置）
nf: UNC
version: 20.15.2
object_name: S1ACCAREALST
object_kind: entity
applicable_nf:
- MME
status: active
...
- [ADD S1ACCAREALST](command/UNC/20.15.2/ADD-S1ACCAREALST.md)
- [LST S1ACCAREALST](command/UNC/20.15.2/LST-S1ACCAREALST.md)
- [MOD S1ACCAREALST](command/UNC/20.15.2/MOD-S1ACCAREALST.md)
- [RMV S1ACCAREALST](command/UNC/20.15.2/RMV-S1ACCAREALST.md)
