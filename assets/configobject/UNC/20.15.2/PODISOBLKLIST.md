---
id: UNC@20.15.2@ConfigObject@PODISOBLKLIST
type: ConfigObject
...
- [ADD PODISOBLKLIST](command/UNC/20.15.2/ADD-PODISOBLKLIST.md)
- [LST PODISOBLKLIST](command/UNC/20.15.2/LST-PODISOBLKLIST.md)
- [RMV PODISOBLKLIST](command/UNC/20.15.2/RMV-PODISOBLKLIST.md)
