...
- [[command/UNC/20.15.2/LST-HTTPFIXEDFCMSG]] · LST HTTPFIXEDFCMSG
- [[command/UNC/20.15.2/SET-HTTPFIXEDFCMSG]] · SET HTTPFIXEDFCMSG

## 证据

- 原始手册：`evidence/UNC/20.15.2/HTTPFIXEDFCMSG.md`
- 原始手册：`evidence/UNC/20.15.2/HTTPFIXEDFCMSG.md`
