---
id: UNC@20.15.2@ConfigObject@MSSCOMMMATCH
type: ConfigObject
...
![](设置通信模块规则匹配开关（SET MSSCOMMMATCH）_49961350.assets/notice_3.0-zh-cn_2.png)
...
- [SET MSSCOMMMATCH](command/UNC/20.15.2/SET-MSSCOMMMATCH.md)
