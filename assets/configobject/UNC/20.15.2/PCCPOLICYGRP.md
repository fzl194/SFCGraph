---
id: UNC@20.15.2@ConfigObject@PCCPOLICYGRP
type: ConfigObject
...
- [ADD PCCPOLICYGRP](command/UNC/20.15.2/ADD-PCCPOLICYGRP.md)
- [LST PCCPOLICYGRP](command/UNC/20.15.2/LST-PCCPOLICYGRP.md)
- [MOD PCCPOLICYGRP](command/UNC/20.15.2/MOD-PCCPOLICYGRP.md)
- [RMV PCCPOLICYGRP](command/UNC/20.15.2/RMV-PCCPOLICYGRP.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询PCC策略组（LST-PCCPOLICYGRP）_09897176.md`
