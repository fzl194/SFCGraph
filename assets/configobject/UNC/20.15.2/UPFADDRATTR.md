...
- [[command/UNC/20.15.2/ADD-UPFADDRATTR]] · ADD UPFADDRATTR
- [[command/UNC/20.15.2/LST-UPFADDRATTR]] · LST UPFADDRATTR
- [[command/UNC/20.15.2/MOD-UPFADDRATTR]] · MOD UPFADDRATTR
- [[command/UNC/20.15.2/RMV-UPFADDRATTR]] · RMV UPFADDRATTR

## 证据

- 原始手册：`evidence/UNC/20.15.2/UPFADDRATTR.md`
- 原始手册：`evidence/UNC/20.15.2/UPFADDRATTR.md`
- 原始手册：`evidence/UNC/20.15.2/UPFADDRATTR.md`
- 原始手册：`evidence/UNC/20.15.2/UPFADDRATTR.md`
