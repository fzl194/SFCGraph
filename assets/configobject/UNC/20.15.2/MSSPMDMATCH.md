---
id: UNC@20.15.2@ConfigObject@MSSPMDMATCH
type: ConfigObject
...
![](设置端口报文统计开关（SET MSSPMDMATCH）_93243681.assets/notice_3.0-zh-cn_2.png)
...
- [DSP MSSPMDMATCH](command/UNC/20.15.2/DSP-MSSPMDMATCH.md)
- [SET MSSPMDMATCH](command/UNC/20.15.2/SET-MSSPMDMATCH.md)
