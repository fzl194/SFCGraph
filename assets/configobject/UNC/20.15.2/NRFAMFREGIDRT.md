---
id: UNC@20.15.2@ConfigObject@NRFAMFREGIDRT
type: ConfigObject
name: NRFAMFREGIDRT（AMF区域标识路由）
nf: UNC
version: 20.15.2
object_name: NRFAMFREGIDRT
object_kind: entity
applicable_nf:
- NRF
status: active
...
- [ADD NRFAMFREGIDRT](command/UNC/20.15.2/ADD-NRFAMFREGIDRT.md)
- [LST NRFAMFREGIDRT](command/UNC/20.15.2/LST-NRFAMFREGIDRT.md)
- [MOD NRFAMFREGIDRT](command/UNC/20.15.2/MOD-NRFAMFREGIDRT.md)
- [RMV NRFAMFREGIDRT](command/UNC/20.15.2/RMV-NRFAMFREGIDRT.md)
