...
- [LST DSCPRMK](command/UNC/20.15.2/LST-DSCPRMK.md)
- [SET DSCPRMK](command/UNC/20.15.2/SET-DSCPRMK.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询重映射对应表(LST-DSCPRMK)_26146210.md`
- 原始手册：`evidence/UNC/20.15.2/设置重映射对应表(SET-DSCPRMK)_72345809.md`
