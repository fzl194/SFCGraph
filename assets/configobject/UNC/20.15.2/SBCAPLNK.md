---
id: UNC@20.15.2@ConfigObject@SBCAPLNK
type: ConfigObject
name: SBCAPLNK（SBc链路）
nf: UNC
version: 20.15.2
object_name: SBCAPLNK
object_kind: entity
applicable_nf:
- MME
- SGSN
...
- [ADD SBCAPLNK](command/UNC/20.15.2/ADD-SBCAPLNK.md)
- [DSP SBCAPLNK](command/UNC/20.15.2/DSP-SBCAPLNK.md)
- [LST SBCAPLNK](command/UNC/20.15.2/LST-SBCAPLNK.md)
- [MOD SBCAPLNK](command/UNC/20.15.2/MOD-SBCAPLNK.md)
- [RMV SBCAPLNK](command/UNC/20.15.2/RMV-SBCAPLNK.md)
