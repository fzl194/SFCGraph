---
id: UNC@20.15.2@ConfigObject@BYPASSMODE
type: ConfigObject
name: BYPASSMODE（节点BYPASS模式）
nf: UNC
version: 20.15.2
object_name: BYPASSMODE
object_kind: action
status: active
---

# BYPASSMODE（节点BYPASS模式）
...
- [ACT BYPASSMODE](command/UNC/20.15.2/ACT-BYPASSMODE.md)
- [DSP BYPASSMODE](command/UNC/20.15.2/DSP-BYPASSMODE.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询节点BYPASS模式（DSP-BYPASSMODE）_47816794.md`
