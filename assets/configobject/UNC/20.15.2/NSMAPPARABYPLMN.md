---
id: UNC@20.15.2@ConfigObject@NSMAPPARABYPLMN
type: ConfigObject
name: NSMAPPARABYPLMN（指定PLMN的网络切片映射参数）
nf: UNC
version: 20.15.2
object_name: NSMAPPARABYPLMN
object_kind: entity
applicable_nf:
- AMF
status: active
...
# NSMAPPARABYPLMN（指定PLMN的网络切片映射参数）
...
- [ADD NSMAPPARABYPLMN](command/UNC/20.15.2/ADD-NSMAPPARABYPLMN.md)
- [LST NSMAPPARABYPLMN](command/UNC/20.15.2/LST-NSMAPPARABYPLMN.md)
- [MOD NSMAPPARABYPLMN](command/UNC/20.15.2/MOD-NSMAPPARABYPLMN.md)
- [RMV NSMAPPARABYPLMN](command/UNC/20.15.2/RMV-NSMAPPARABYPLMN.md)
