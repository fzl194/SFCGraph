---
id: UNC@20.15.2@ConfigObject@DISCADAPTFC
type: ConfigObject
name: DISCADAPTFC（服务发现自适应流控NF级配置）
nf: UNC
version: 20.15.2
object_name: DISCADAPTFC
object_kind: entity
applicable_nf:
- AMF
- SMF
...
- [ADD DISCADAPTFC](command/UNC/20.15.2/ADD-DISCADAPTFC.md)
- [LST DISCADAPTFC](command/UNC/20.15.2/LST-DISCADAPTFC.md)
- [MOD DISCADAPTFC](command/UNC/20.15.2/MOD-DISCADAPTFC.md)
- [RMV DISCADAPTFC](command/UNC/20.15.2/RMV-DISCADAPTFC.md)
