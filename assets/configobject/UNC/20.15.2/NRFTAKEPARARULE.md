---
id: UNC@20.15.2@ConfigObject@NRFTAKEPARARULE
type: ConfigObject
name: NRFTAKEPARARULE（NF携带参数处理规则）
nf: UNC
version: 20.15.2
object_name: NRFTAKEPARARULE
...
- [LST NRFTAKEPARARULE](command/UNC/20.15.2/LST-NRFTAKEPARARULE.md)
- [SET NRFTAKEPARARULE](command/UNC/20.15.2/SET-NRFTAKEPARARULE.md)
