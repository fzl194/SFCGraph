---
id: UNC@20.15.2@ConfigObject@TCPGLOBALCFG
type: ConfigObject
...
- [[command/UNC/20.15.2/LST-TCPGLOBALCFG]] · LST TCPGLOBALCFG
- [[command/UNC/20.15.2/SET-TCPGLOBALCFG]] · SET TCPGLOBALCFG

## 证据

- 原始手册：`evidence/UNC/20.15.2/TCPGLOBALCFG.md`
- 原始手册：`evidence/UNC/20.15.2/TCPGLOBALCFG.md`
