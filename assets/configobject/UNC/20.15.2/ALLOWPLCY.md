---
id: UNC@20.15.2@ConfigObject@ALLOWPLCY
type: ConfigObject
name: ALLOWPLCY（提交允许访问策略配置）
nf: UNC
version: 20.15.2
object_name: ALLOWPLCY
object_kind: action
applicable_nf:
- NRF
status: active
...
- [CMT ALLOWPLCY](command/UNC/20.15.2/CMT-ALLOWPLCY.md)
- [TST ALLOWPLCY](command/UNC/20.15.2/TST-ALLOWPLCY.md)
