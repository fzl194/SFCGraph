---
id: UNC@20.15.2@ConfigObject@RESOMU
type: ConfigObject
...
![](倒换主备操作维护单元（SWP RESOMU）_04480462.assets/notice_3.0-zh-cn_2.png)
...
- [SWP RESOMU](command/UNC/20.15.2/SWP-RESOMU.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/倒换主备操作维护单元（SWP-RESOMU）_04480462.md`
