...
- [LST TOKENDELAY](command/UNC/20.15.2/LST-TOKENDELAY.md)
- [SET TOKENDELAY](command/UNC/20.15.2/SET-TOKENDELAY.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询Token延时迁移时间（LST-TOKENDELAY）_78965049.md`
- 原始手册：`evidence/UNC/20.15.2/设置Token延时迁移时间（SET-TOKENDELAY）_79244269.md`
