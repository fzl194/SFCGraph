---
id: UNC@20.15.2@ConfigObject@UPFGBINDLOCG
type: ConfigObject
name: UPFGBINDLOCG（UPF组与Diameter本端主机组的关联关系）
nf: UNC
version: 20.15.2
object_name: UPFGBINDLOCG
object_kind: binding
applicable_nf:
- PGW-C
- SMF
...
# UPFGBINDLOCG（UPF组与Diameter本端主机组的关联关系）
...
- [ADD UPFGBINDLOCG](command/UNC/20.15.2/ADD-UPFGBINDLOCG.md)
- [LST UPFGBINDLOCG](command/UNC/20.15.2/LST-UPFGBINDLOCG.md)
- [MOD UPFGBINDLOCG](command/UNC/20.15.2/MOD-UPFGBINDLOCG.md)
- [RMV UPFGBINDLOCG](command/UNC/20.15.2/RMV-UPFGBINDLOCG.md)
