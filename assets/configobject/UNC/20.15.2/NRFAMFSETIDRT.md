...
- [[command/UNC/20.15.2/ADD-NRFAMFSETIDRT]] · ADD NRFAMFSETIDRT
- [[command/UNC/20.15.2/LST-NRFAMFSETIDRT]] · LST NRFAMFSETIDRT
- [[command/UNC/20.15.2/MOD-NRFAMFSETIDRT]] · MOD NRFAMFSETIDRT
- [[command/UNC/20.15.2/RMV-NRFAMFSETIDRT]] · RMV NRFAMFSETIDRT

## 证据

- 原始手册：`evidence/UNC/20.15.2/NRFAMFSETIDRT.md`
- 原始手册：`evidence/UNC/20.15.2/NRFAMFSETIDRT.md`
- 原始手册：`evidence/UNC/20.15.2/NRFAMFSETIDRT.md`
- 原始手册：`evidence/UNC/20.15.2/NRFAMFSETIDRT.md`
