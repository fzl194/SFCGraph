...
- [[command/UNC/20.15.2/ADD-WEEKDAY]] · ADD WEEKDAY
- [[command/UNC/20.15.2/LST-WEEKDAY]] · LST WEEKDAY
- [[command/UNC/20.15.2/MOD-WEEKDAY]] · MOD WEEKDAY
- [[command/UNC/20.15.2/RMV-WEEKDAY]] · RMV WEEKDAY

## 证据

- 原始手册：`evidence/UNC/20.15.2/WEEKDAY.md`
- 原始手册：`evidence/UNC/20.15.2/WEEKDAY.md`
- 原始手册：`evidence/UNC/20.15.2/WEEKDAY.md`
- 原始手册：`evidence/UNC/20.15.2/WEEKDAY.md`
