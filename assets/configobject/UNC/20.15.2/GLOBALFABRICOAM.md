---
id: UNC@20.15.2@ConfigObject@GLOBALFABRICOAM
type: ConfigObject
...
![](设置OAM全局配置（SET GLOBALFABRICOAM）_92520017.assets/notice_3.0-zh-cn_2.png)
...
- [LST GLOBALFABRICOAM](command/UNC/20.15.2/LST-GLOBALFABRICOAM.md)
- [SET GLOBALFABRICOAM](command/UNC/20.15.2/SET-GLOBALFABRICOAM.md)
