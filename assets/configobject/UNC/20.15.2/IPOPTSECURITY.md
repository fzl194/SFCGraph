---
id: UNC@20.15.2@ConfigObject@IPOPTSECURITY
type: ConfigObject
...
- [LST IPOPTSECURITY](command/UNC/20.15.2/LST-IPOPTSECURITY.md)
- [SET IPOPTSECURITY](command/UNC/20.15.2/SET-IPOPTSECURITY.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询IP选项安全配置（LST-IPOPTSECURITY）_00440645.md`
- 原始手册：`evidence/UNC/20.15.2/设置IP选项安全配置（SET-IPOPTSECURITY）_00865745.md`
