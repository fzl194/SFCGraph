---
id: UNC@20.15.2@ConfigObject@NODE
type: ConfigObject
name: NODE（节点信息）
nf: UNC
version: 20.15.2
...
- [DSP NODE](command/UNC/20.15.2/DSP-NODE.md)
- [LST NODE](command/UNC/20.15.2/LST-NODE.md)
- [REB NODE](command/UNC/20.15.2/REB-NODE.md)
- [RST NODE](command/UNC/20.15.2/RST-NODE.md)
- [STP NODE](command/UNC/20.15.2/STP-NODE.md)
- [STR NODE](command/UNC/20.15.2/STR-NODE.md)
