---
id: UNC@20.15.2@ConfigObject@SMFSELUDM
type: ConfigObject
name: SMFSELUDM（SMF选择UDM策略）
nf: UNC
version: 20.15.2
object_name: SMFSELUDM
object_kind: entity
applicable_nf:
- SMF
status: active
...
- [ADD SMFSELUDM](command/UNC/20.15.2/ADD-SMFSELUDM.md)
- [LST SMFSELUDM](command/UNC/20.15.2/LST-SMFSELUDM.md)
- [MOD SMFSELUDM](command/UNC/20.15.2/MOD-SMFSELUDM.md)
- [RMV SMFSELUDM](command/UNC/20.15.2/RMV-SMFSELUDM.md)
