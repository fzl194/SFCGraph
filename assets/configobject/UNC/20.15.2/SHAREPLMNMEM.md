---
id: UNC@20.15.2@ConfigObject@SHAREPLMNMEM
type: ConfigObject
name: SHAREPLMNMEM（共享PLMN群组成员）
nf: UNC
version: 20.15.2
object_name: SHAREPLMNMEM
object_kind: entity
applicable_nf:
- MME
status: active
...
- [ADD SHAREPLMNMEM](command/UNC/20.15.2/ADD-SHAREPLMNMEM.md)
- [LST SHAREPLMNMEM](command/UNC/20.15.2/LST-SHAREPLMNMEM.md)
- [RMV SHAREPLMNMEM](command/UNC/20.15.2/RMV-SHAREPLMNMEM.md)
