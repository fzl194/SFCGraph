---
id: UNC@20.15.2@ConfigObject@APNPFCPCMPT
type: ConfigObject
name: APNPFCPCMPT（指定APN的PFCP私有信元携带配置）
nf: UNC
version: 20.15.2
object_name: APNPFCPCMPT
object_kind: entity
applicable_nf:
- SGW-C
- PGW-C
...
# APNPFCPCMPT（指定APN的PFCP私有信元携带配置）
...
- [ADD APNPFCPCMPT](command/UNC/20.15.2/ADD-APNPFCPCMPT.md)
- [LST APNPFCPCMPT](command/UNC/20.15.2/LST-APNPFCPCMPT.md)
- [MOD APNPFCPCMPT](command/UNC/20.15.2/MOD-APNPFCPCMPT.md)
- [RMV APNPFCPCMPT](command/UNC/20.15.2/RMV-APNPFCPCMPT.md)
