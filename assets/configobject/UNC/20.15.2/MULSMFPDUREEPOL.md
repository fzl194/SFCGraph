---
id: UNC@20.15.2@ConfigObject@MULSMFPDUREEPOL
type: ConfigObject
name: MULSMFPDUREEPOL（是否支持多SMFInfo场景下的会话重建功能）
nf: UNC
version: 20.15.2
object_name: MULSMFPDUREEPOL
...
# MULSMFPDUREEPOL（是否支持多SMFInfo场景下的会话重建功能）
...
- [LST MULSMFPDUREEPOL](command/UNC/20.15.2/LST-MULSMFPDUREEPOL.md)
- [SET MULSMFPDUREEPOL](command/UNC/20.15.2/SET-MULSMFPDUREEPOL.md)
