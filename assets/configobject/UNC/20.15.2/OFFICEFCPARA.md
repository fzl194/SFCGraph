---
id: UNC@20.15.2@ConfigObject@OFFICEFCPARA
type: ConfigObject
name: OFFICEFCPARA（指定NF的流控参数）
nf: UNC
version: 20.15.2
object_name: OFFICEFCPARA
object_kind: entity
applicable_nf:
- NRF
status: active
...
- [ADD OFFICEFCPARA](command/UNC/20.15.2/ADD-OFFICEFCPARA.md)
- [LST OFFICEFCPARA](command/UNC/20.15.2/LST-OFFICEFCPARA.md)
- [MOD OFFICEFCPARA](command/UNC/20.15.2/MOD-OFFICEFCPARA.md)
- [RMV OFFICEFCPARA](command/UNC/20.15.2/RMV-OFFICEFCPARA.md)
