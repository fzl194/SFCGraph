---
id: UNC@20.15.2@ConfigObject@APNPLMNRATECTRL
type: ConfigObject
name: APNPLMNRATECTRL（APN Serving PLMN速率控制配置）
nf: UNC
version: 20.15.2
object_name: APNPLMNRATECTRL
...
# APNPLMNRATECTRL（APN Serving PLMN速率控制配置）
...
- [LST APNPLMNRATECTRL](command/UNC/20.15.2/LST-APNPLMNRATECTRL.md)
- [SET APNPLMNRATECTRL](command/UNC/20.15.2/SET-APNPLMNRATECTRL.md)
