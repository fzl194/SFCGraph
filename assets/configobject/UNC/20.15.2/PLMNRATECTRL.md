---
id: UNC@20.15.2@ConfigObject@PLMNRATECTRL
type: ConfigObject
name: PLMNRATECTRL（Serving PLMN速率控制配置）
nf: UNC
version: 20.15.2
object_name: PLMNRATECTRL
...
# PLMNRATECTRL（Serving PLMN速率控制配置）
...
- [LST PLMNRATECTRL](command/UNC/20.15.2/LST-PLMNRATECTRL.md)
- [SET PLMNRATECTRL](command/UNC/20.15.2/SET-PLMNRATECTRL.md)
