---
id: UNC@20.15.2@ConfigObject@DRHBNEGOTIMER
type: ConfigObject
...
- [LST DRHBNEGOTIMER](command/UNC/20.15.2/LST-DRHBNEGOTIMER.md)
- [SET DRHBNEGOTIMER](command/UNC/20.15.2/SET-DRHBNEGOTIMER.md)
