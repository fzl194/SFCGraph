...
- [ADD IFCONTROLFLAP](command/UNC/20.15.2/ADD-IFCONTROLFLAP.md)
- [DSP IFCONTROLFLAP](command/UNC/20.15.2/DSP-IFCONTROLFLAP.md)
- [LST IFCONTROLFLAP](command/UNC/20.15.2/LST-IFCONTROLFLAP.md)
- [RMV IFCONTROLFLAP](command/UNC/20.15.2/RMV-IFCONTROLFLAP.md)
- [RTR IFCONTROLFLAP](command/UNC/20.15.2/RTR-IFCONTROLFLAP.md)
