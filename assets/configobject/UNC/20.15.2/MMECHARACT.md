---
id: UNC@20.15.2@ConfigObject@MMECHARACT
type: ConfigObject
name: MMECHARACT（MME属性配置信息）
nf: UNC
version: 20.15.2
object_name: MMECHARACT
object_kind: entity
applicable_nf:
- MME
status: active
...
- [ADD MMECHARACT](command/UNC/20.15.2/ADD-MMECHARACT.md)
- [LST MMECHARACT](command/UNC/20.15.2/LST-MMECHARACT.md)
- [MOD MMECHARACT](command/UNC/20.15.2/MOD-MMECHARACT.md)
- [RMV MMECHARACT](command/UNC/20.15.2/RMV-MMECHARACT.md)
