---
id: UNC@20.15.2@ConfigObject@NFSRVSCOPE
type: ConfigObject
name: NFSRVSCOPE（NF支持服务区信息）
nf: UNC
version: 20.15.2
object_name: NFSRVSCOPE
object_kind: entity
applicable_nf:
- AMF
- SMF
...
- [ADD NFSRVSCOPE](command/UNC/20.15.2/ADD-NFSRVSCOPE.md)
- [LST NFSRVSCOPE](command/UNC/20.15.2/LST-NFSRVSCOPE.md)
- [RMV NFSRVSCOPE](command/UNC/20.15.2/RMV-NFSRVSCOPE.md)
