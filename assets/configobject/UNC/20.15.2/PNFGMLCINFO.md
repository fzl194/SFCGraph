---
id: UNC@20.15.2@ConfigObject@PNFGMLCINFO
type: ConfigObject
name: PNFGMLCINFO（对端GMLC信息）
nf: UNC
version: 20.15.2
object_name: PNFGMLCINFO
object_kind: entity
applicable_nf:
- AMF
status: active
...
- [ADD PNFGMLCINFO](command/UNC/20.15.2/ADD-PNFGMLCINFO.md)
- [LST PNFGMLCINFO](command/UNC/20.15.2/LST-PNFGMLCINFO.md)
- [MOD PNFGMLCINFO](command/UNC/20.15.2/MOD-PNFGMLCINFO.md)
- [RMV PNFGMLCINFO](command/UNC/20.15.2/RMV-PNFGMLCINFO.md)
