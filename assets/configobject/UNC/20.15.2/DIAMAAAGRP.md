---
id: UNC@20.15.2@ConfigObject@DIAMAAAGRP
type: ConfigObject
name: DIAMAAAGRP（Diameter AAA服务器组）
nf: UNC
version: 20.15.2
object_name: DIAMAAAGRP
object_kind: entity
applicable_nf:
- PGW-C
status: active
...
- [ADD DIAMAAAGRP](command/UNC/20.15.2/ADD-DIAMAAAGRP.md)
- [LST DIAMAAAGRP](command/UNC/20.15.2/LST-DIAMAAAGRP.md)
- [MOD DIAMAAAGRP](command/UNC/20.15.2/MOD-DIAMAAAGRP.md)
- [RMV DIAMAAAGRP](command/UNC/20.15.2/RMV-DIAMAAAGRP.md)
