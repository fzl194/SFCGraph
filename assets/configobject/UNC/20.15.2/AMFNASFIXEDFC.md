---
id: UNC@20.15.2@ConfigObject@AMFNASFIXEDFC
type: ConfigObject
name: AMFNASFIXEDFC（指定消息类型的AMF NAS固定速率流控信息）
nf: UNC
version: 20.15.2
object_name: AMFNASFIXEDFC
...
# AMFNASFIXEDFC（指定消息类型的AMF NAS固定速率流控信息）
...
- [LST AMFNASFIXEDFC](command/UNC/20.15.2/LST-AMFNASFIXEDFC.md)
- [SET AMFNASFIXEDFC](command/UNC/20.15.2/SET-AMFNASFIXEDFC.md)
