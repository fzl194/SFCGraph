...
- [ADD EXEMPTSERVICE](command/UNC/20.15.2/ADD-EXEMPTSERVICE.md)
- [LST EXEMPTSERVICE](command/UNC/20.15.2/LST-EXEMPTSERVICE.md)
- [RMV EXEMPTSERVICE](command/UNC/20.15.2/RMV-EXEMPTSERVICE.md)
