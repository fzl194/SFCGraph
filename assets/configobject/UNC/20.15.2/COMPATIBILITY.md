---
id: UNC@20.15.2@ConfigObject@COMPATIBILITY
type: ConfigObject
name: COMPATIBILITY（QoS兼容性配置）
nf: UNC
version: 20.15.2
object_name: COMPATIBILITY
...
- [LST COMPATIBILITY](command/UNC/20.15.2/LST-COMPATIBILITY.md)
- [SET COMPATIBILITY](command/UNC/20.15.2/SET-COMPATIBILITY.md)
