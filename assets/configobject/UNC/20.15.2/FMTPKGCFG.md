---
id: UNC@20.15.2@ConfigObject@FMTPKGCFG
type: ConfigObject
name: FMTPKGCFG（格式引擎包软参）
nf: UNC
version: 20.15.2
object_name: FMTPKGCFG
object_kind: entity
applicable_nf:
- NCG
status: active
...
- [ADD FMTPKGCFG](command/UNC/20.15.2/ADD-FMTPKGCFG.md)
- [DSP FMTPKGCFG](command/UNC/20.15.2/DSP-FMTPKGCFG.md)
- [LST FMTPKGCFG](command/UNC/20.15.2/LST-FMTPKGCFG.md)
- [RMV FMTPKGCFG](command/UNC/20.15.2/RMV-FMTPKGCFG.md)
