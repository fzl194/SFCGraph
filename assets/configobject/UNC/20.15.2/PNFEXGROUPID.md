---
id: UNC@20.15.2@ConfigObject@PNFEXGROUPID
type: ConfigObject
name: PNFEXGROUPID（对端NF的外部群组信息）
nf: UNC
version: 20.15.2
object_name: PNFEXGROUPID
object_kind: entity
applicable_nf:
- AMF
- SMF
...
- [ADD PNFEXGROUPID](command/UNC/20.15.2/ADD-PNFEXGROUPID.md)
- [LST PNFEXGROUPID](command/UNC/20.15.2/LST-PNFEXGROUPID.md)
- [RMV PNFEXGROUPID](command/UNC/20.15.2/RMV-PNFEXGROUPID.md)
