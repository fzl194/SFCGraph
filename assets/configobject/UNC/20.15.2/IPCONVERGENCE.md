---
id: UNC@20.15.2@ConfigObject@IPCONVERGENCE
type: ConfigObject
name: IPCONVERGENCE（Bi口IPCONVERGENCE开关状态）
nf: UNC
version: 20.15.2
object_name: IPCONVERGENCE
...
# IPCONVERGENCE（Bi口IPCONVERGENCE开关状态）
...
- [LST IPCONVERGENCE](command/UNC/20.15.2/LST-IPCONVERGENCE.md)
- [SET IPCONVERGENCE](command/UNC/20.15.2/SET-IPCONVERGENCE.md)
