---
id: UNC@20.15.2@ConfigObject@RADIUSCLIENTIP
type: ConfigObject
name: RADIUSCLIENTIP（Radius Group Client IP接口）
nf: UNC
version: 20.15.2
object_name: RADIUSCLIENTIP
object_kind: entity
applicable_nf:
- PGW-C
- SMF
...
# RADIUSCLIENTIP（Radius Group Client IP接口）
...
- [ADD RADIUSCLIENTIP](command/UNC/20.15.2/ADD-RADIUSCLIENTIP.md)
- [LST RADIUSCLIENTIP](command/UNC/20.15.2/LST-RADIUSCLIENTIP.md)
- [RMV RADIUSCLIENTIP](command/UNC/20.15.2/RMV-RADIUSCLIENTIP.md)
