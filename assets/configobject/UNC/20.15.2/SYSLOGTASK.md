---
id: UNC@20.15.2@ConfigObject@SYSLOGTASK
type: ConfigObject
...
- [LST SYSLOGTASK](command/UNC/20.15.2/LST-SYSLOGTASK.md)
- [RMV SYSLOGTASK](command/UNC/20.15.2/RMV-SYSLOGTASK.md)
- [SET SYSLOGTASK](command/UNC/20.15.2/SET-SYSLOGTASK.md)
