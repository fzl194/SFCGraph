...
- [LST DNS](command/UNC/20.15.2/LST-DNS.md)
- [SET DNS](command/UNC/20.15.2/SET-DNS.md)
- [TST DNS](command/UNC/20.15.2/TST-DNS.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/查询DNS运行参数(LST-DNS)_26145896.md`
- 原始手册：`evidence/UNC/20.15.2/测试DNS通信(TST-DNS)_72225575.md`
