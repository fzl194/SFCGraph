---
id: UNC@20.15.2@ConfigObject@FABDIAGINFO
type: ConfigObject
...
- [DSP FABDIAGINFO](command/UNC/20.15.2/DSP-FABDIAGINFO.md)

## 证据

- 原始手册：`evidence/UNC/20.15.2/显示Fabric平面亚健康诊断结果（DSP-FABDIAGINFO）_48150369.md`
