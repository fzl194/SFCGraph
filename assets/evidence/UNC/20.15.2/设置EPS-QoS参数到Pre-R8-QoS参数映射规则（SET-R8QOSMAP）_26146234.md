# 设置EPS QoS参数到Pre-R8 QoS参数映射规则（SET R8QOSMAP）

- [命令功能](#ZH-CN_MMLREF_0000001126146234__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146234__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146234__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146234__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146234__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146234__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001126146234__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146234)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126146234)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126146234)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146234)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146234)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146234)
...
#### [参考信息](#ZH-CN_MMLREF_0000001126146234)

*表1 QoS传递时延初始值*

| QoS 级别标识 | 流量等级 | 最大SDU长度 | 发送次序 | 保留BER | 发送错误SDU | SDU误码率 | 发送控制优先级 | 传递时延 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Conversational class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-2 | Priority level 3 | 10 |
| 2 | Conversational class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-3 | Priority level 3 | 15 |
| 3 | Conversational class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-3 | Priority level 3 | 10 |
| 4 | Streaming class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-4 | Priority level 3 | 18 |
| 5 | Interactive class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-4 | Priority level 1 | 10 |
| 6 | Interactive class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-4 | Priority level 1 | 18 |
| 7 | Interactive class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-3 | Priority level 2 | 10 |
| 8 | Interactive class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-4 | Priority level 3 | 18 |
| 9 | Background class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-4 | Priority level 3 | 18 |
| 65 | Conversational class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-2 | Priority level 3 | 10 |
| 66 | Conversational class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-2 | Priority level 3 | 10 |
| 69 | Interactive class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-4 | Priority level 1 | 18 |
| 70 | Interactive class | 150 | NORDER | E_RESIDUAL_BIT_ERR_RATIO_7 | NOT_DETECT | 1*10<br>-4 | Priority level 1 | 18 |
