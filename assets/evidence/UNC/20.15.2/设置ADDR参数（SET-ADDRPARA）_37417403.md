# 设置ADDR参数（SET ADDRPARA）

- [命令功能](#ZH-CN_MMLREF_0000001237417403__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001237417403__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001237417403__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001237417403__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001237417403)

**适用NF：PGW-C、SMF、GGSN**

该命令用于设置ADDR参数，包括核查速率、去活间隔等参数。

## [注意事项](#ZH-CN_MMLREF_0000001237417403)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001237417403)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001237417403)
...
## [使用实例](#ZH-CN_MMLREF_0000001237417403)
