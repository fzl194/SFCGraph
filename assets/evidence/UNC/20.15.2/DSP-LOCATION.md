# 显示用户当前位置(DSP LOCATION)

- [命令功能](#ZH-CN_MMLREF_0000001172225497__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225497__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225497__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225497__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225497__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225497__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225497)

**适用网元：SGSN、MME**

该命令用于在 UNC 的操作维护终端上触发指定用户的LCS定位。LCS的定位结果发送给指定的GMLC和LCS Client。

#### [注意事项](#ZH-CN_MMLREF_0000001172225497)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225497)

manage-ug；system-ug；monitor-ug；visit-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225497)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组；G_4，来宾级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225497)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225497)
