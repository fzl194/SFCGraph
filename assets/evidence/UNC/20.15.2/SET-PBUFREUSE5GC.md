# 设置pbuf重用检测开关（SET PBUFREUSE5GC）

- [命令功能](#ZH-CN_MMLREF_0000001999859361__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001999859361__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001999859361__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001999859361__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001999859361)
...
## [注意事项](#ZH-CN_MMLREF_0000001999859361)

- 该命令执行后立即生效。

- 本命令用于使能PBUF重用检测，开启后会降低性能，关闭后会恢复性能。

#### [操作用户权限](#ZH-CN_MMLREF_0000001999859361)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001999859361)
...
## [使用实例](#ZH-CN_MMLREF_0000001999859361)
