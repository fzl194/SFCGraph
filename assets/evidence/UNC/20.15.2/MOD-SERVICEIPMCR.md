# 修改业务IP(MOD SERVICEIPMCR)

- [命令功能](#ZH-CN_MMLREF_0000001171850997__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001171850997__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001171850997__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001171850997__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001171850997__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001171850997__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001171850997)

**适用网元：MME**

该命令用于修改用户配置的业务IP的描述信息。

#### [注意事项](#ZH-CN_MMLREF_0000001171850997)

- 该命令执行后立即生效。
- 该命令不能修改业务IP与VPN实例的所属关系。当IP版本选择为IPv4时，只能修改业务IP的描述信息，当IP版本选择为IPv6时，只能修改业务IP的描述信息和IPv6 MTU大小。

#### [本地用户权限](#ZH-CN_MMLREF_0000001171850997)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001171850997)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001171850997)
...
#### [使用实例](#ZH-CN_MMLREF_0000001171850997)
