# 增加融合计费Proxy结果码处理动作（ADD CCPRCACT）

- [命令功能](#ZH-CN_MMLREF_0245110908__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0245110908__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0245110908__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0245110908__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0245110908)

**适用NF：NCG**

该命令用于增加融合计费Proxy结果码处理动作的配置。

## [注意事项](#ZH-CN_MMLREF_0245110908)
...
#### [操作用户权限](#ZH-CN_MMLREF_0245110908)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0245110908)
