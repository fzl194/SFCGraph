# 删除计费方式（RMV CHARGEMETHOD）

- [命令功能](#ZH-CN_CONCEPT_0209896797__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896797__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896797__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896797__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896797__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896797)

**适用NF：PGW-C、SMF**

RMV CHARGEMETHOD命令用来删除基于用户计费属性配置在线计费和离线计费方式。

#### [注意事项](#ZH-CN_CONCEPT_0209896797)

- 该命令执行后只对新激活用户生效。
- 已经激活的用户，仍保留原有的在线离线、融合计费方式。
- 不能删除参数CHARGECHARACT的值为DEFAULT类型的记录。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896797)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896797)
