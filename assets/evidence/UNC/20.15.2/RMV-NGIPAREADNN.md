# 删除5G IP区域DNN（RMV NGIPAREADNN）

- [命令功能](#ZH-CN_MMLREF_0296242844__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296242844__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296242844__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296242844__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296242844)

**适用NF：AMF**

该命令用于删除“基于位置的地址分配”功能配置的S-NSSAI和DNN。

## [注意事项](#ZH-CN_MMLREF_0296242844)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0296242844)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296242844)
