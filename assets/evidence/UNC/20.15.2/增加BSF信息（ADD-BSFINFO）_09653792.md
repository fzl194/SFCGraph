...
- [命令功能](#ZH-CN_MMLREF_0209653792__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653792__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653792__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653792__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653792)

**适用NF：SMF**

该命令用于配置BSF（Binding Support Function）实例信息。在SMF内置BSF的场景下，可以通过该命令配置BSF名称等基础信息。在BSF向NRF注册时，会携带该命令的配置数据，用于NF注册和后续的NF发现。

## [注意事项](#ZH-CN_MMLREF_0209653792)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653792)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653792)
