...
- [命令功能](#ZH-CN_CONCEPT_0209897200__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897200__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897200__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897200__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897200__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897200)

**适用NF：PGW-C、SMF**

该命令用于配置业务策略规则，也就是下文提到的Rule。具体包含规则名称、策略类型、以及全局优先级等。SMF通过信令流程从PCRF/PCF获取预定义规则后会和该命令配置的rule进行匹配，如果匹配上会给UPF下发对应的Rule名称。

#### [注意事项](#ZH-CN_CONCEPT_0209897200)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897200)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897200)
