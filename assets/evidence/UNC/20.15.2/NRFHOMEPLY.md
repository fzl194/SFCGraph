# 设置NRF归属地默认策略（SET NRFHOMEPLY）

- [命令功能](#ZH-CN_MMLREF_0000001171436559__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001171436559__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001171436559__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001171436559__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001171436559)

**适用NF：NRF**

此命令用于设置NRF作为归属地NRF时跨PLMN交互的默认策略。

## [注意事项](#ZH-CN_MMLREF_0000001171436559)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001171436559)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001171436559)
...
## [使用实例](#ZH-CN_MMLREF_0000001171436559)
