# 增加以太网隧道自动化多虚拟网卡配置模板（ADD AUTOSCALINGETHTRUNK）

- [命令功能](#ZH-CN_CONCEPT_0000001550121226__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121226__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121226__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121226__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121226__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121226)

该命令用于添加以太网隧道多虚拟网卡自动化配置模板。当该模板被自动化配置接口服务模板引用时，基于模板的参数自动生成以太网隧道虚拟网卡接口下的配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121226)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121226)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121226)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121226)
