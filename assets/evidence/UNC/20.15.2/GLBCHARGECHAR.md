# 设置对本地用户、漫游用户、拜访用户所采用的计费属性（SET GLBCHARGECHAR）

- [命令功能](#ZH-CN_CONCEPT_0209896800__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896800__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896800__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896800__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896800__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896800)

**适用NF：PGW-C、SMF**

该命令用于设置对本地用户、漫游用户、拜访用户所采用的计费属性。

#### [注意事项](#ZH-CN_CONCEPT_0209896800)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896800)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896800)
