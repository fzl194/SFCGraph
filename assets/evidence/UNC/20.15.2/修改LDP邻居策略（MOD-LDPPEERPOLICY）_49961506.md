# 修改LDP邻居策略（MOD LDPPEERPOLICY）

- [命令功能](#ZH-CN_CONCEPT_0000001549961506__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961506__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961506__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961506__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961506__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961506)

该命令用于修改LDP邻居策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961506)

- 该命令执行后立即生效。
- 如果修改认证与邻居配置不同，会使建立成功的LDP会话中断。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961506)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961506)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961506)
