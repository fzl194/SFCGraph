# 增加P-GW特性对接配置（ADD PGWCHARACT）

- [命令功能](#ZH-CN_CONCEPT_0000001126305748__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001126305748__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001126305748__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001126305748__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001126305748__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001126305748__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001126305748)

**适用网元：SGSN、MME**

该命令用于增加需要匹配的对端P-GW的属性信息。MME将此配置作为与对端网元间信令交互时的参考条件。

#### [注意事项](#ZH-CN_CONCEPT_0000001126305748)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0000001126305748)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001126305748)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001126305748)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001126305748)
