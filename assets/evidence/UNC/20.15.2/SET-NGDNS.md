...
- [命令功能](#ZH-CN_MMLREF_0209651853__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651853__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651853__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651853__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651853)

**适用NF：AMF、SMF**

该命令用于设置DNS域名解析流程相关参数。DNS解析器向DNS服务器发送域名解析请求，获取对应的IP地址信息时会根据这些参数进行处理。

## [注意事项](#ZH-CN_MMLREF_0209651853)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651853)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651853)
