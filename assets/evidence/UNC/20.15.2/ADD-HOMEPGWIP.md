# 增加归属地PGW-C IP地址（ADD HOMEPGWIP）

- [命令功能](#ZH-CN_MMLREF_0306399905__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399905__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399905__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399905__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0306399905)

**适用NF：SGW-C**

该命令用于Proxy S-GW特性中指定用户的归属地PGW-C IP地址。如果用户在本配置中指定了归属地PGW-C的IP地址，则不再通过DNS解析来获取归属地PGW-C的IP地址。

## [注意事项](#ZH-CN_MMLREF_0306399905)

- 该命令执行后只对新激活用户生效。

- 同一条IMSI/MSISDN记录最多配置8条IPv4地址和8条IPv6地址。

- 最多可输入70000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0306399905)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399905)
...
## [使用实例](#ZH-CN_MMLREF_0306399905)

添加用户范围为IMSI_PRE，前缀为27602，IP地址类型为IPV4，IPV4地址为10.0.0.0，描述信息为Vodafone的配置，执行如下命令：

```
ADD HOMEPGWIP: SUBRANGE=IMSI_PRE, PREFIX="27602", IPVERSION=IPV4, HOMEIPV4="10.0.0.0", DESC="Vodafone";
```
