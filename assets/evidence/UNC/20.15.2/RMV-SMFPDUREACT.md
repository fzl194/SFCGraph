# 删除跨区域PDU会话重建策略（RMV SMFPDUREACT）

- [命令功能](#ZH-CN_MMLREF_0264343909__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0264343909__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0264343909__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0264343909__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0264343909)

**适用NF：SMF**

该命令用于删除一条跨区域PDU会话重建策略。

## [注意事项](#ZH-CN_MMLREF_0264343909)

- 该命令执行后立即生效。

- 执行删除命令不配置SD时，默认删除SD值为“FFFFFF”的记录。

#### [操作用户权限](#ZH-CN_MMLREF_0264343909)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0264343909)
