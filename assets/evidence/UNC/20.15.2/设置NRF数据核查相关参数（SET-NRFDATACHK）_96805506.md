# 设置NRF数据核查相关参数（SET NRFDATACHK）

- [命令功能](#ZH-CN_MMLREF_0296805506__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296805506__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296805506__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296805506__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296805506)

**适用NF：NRF**

该命令用于设置NRF数据核查相关参数。通过此命令NRF可以对存储的NF Profile数据进行一致性校验。

## [注意事项](#ZH-CN_MMLREF_0296805506)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296805506)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296805506)
