# 增加TAC组内绑定的S1TAC号段（ADD S1TACID）

- [命令功能](#ZH-CN_MMLREF_0209651757__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651757__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651757__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651757__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651757)

**适用NF：PGW-C**

该命令用来在TAC组内绑定TAC号段。当需要在指定TAC组内绑定某个TAC号段时，使用该命令。

## [注意事项](#ZH-CN_MMLREF_0209651757)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651757)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651757)
