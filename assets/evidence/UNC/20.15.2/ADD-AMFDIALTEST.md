# 增加AMF拨测用户配置（ADD AMFDIALTEST）

- [命令功能](#ZH-CN_MMLREF_0000001870462501__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870462501__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870462501__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870462501__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870462501)

**适用NF：MME、AMF**

该命令用于新增拨测用户列表，通过起始IMSI和终止IMSI的方式，配置一组拨测用户。

## [注意事项](#ZH-CN_MMLREF_0000001870462501)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001870462501)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870462501)
...
## [使用实例](#ZH-CN_MMLREF_0000001870462501)
