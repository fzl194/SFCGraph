# 修改基于PDP数的ARP控制（MOD PDPNUMBERARP）

- [命令功能](#ZH-CN_MMLREF_0209651802__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651802__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651802__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651802__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651802)

**适用NF：SGW-C、PGW-C、GGSN**

当需要修改指定用户级别和业务级别对应的拒绝、恢复告警门限时，使用此命令。

## [注意事项](#ZH-CN_MMLREF_0209651802)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209651802)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651802)
