...
- [命令功能](#ZH-CN_MMLREF_0000001126305646__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305646__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305646__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305646__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305646__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305646__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305646)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305646)

- 该命令执行后立即生效。
- MDT任务正常运行时，删除本地的MDT配置参数会导致该任务异常。正常场景下请慎用本功能。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305646)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305646)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305646)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305646)
