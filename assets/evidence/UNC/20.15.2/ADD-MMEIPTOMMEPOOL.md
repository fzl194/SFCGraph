# 增加MME IP（ADD MMEIPTOMMEPOOL）

- [命令功能](#ZH-CN_MMLREF_0231453389__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0231453389__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0231453389__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0231453389__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0231453389)

**适用NF：SGW-C、PGW-C**

该命令用于为已配置的MME POOL绑定地址，并设置该IP的描述、是否为备份和端口号。假设运营商需要在MME/SGW-C故障或者重启场景PGW-C保留会话，并在有下行数据和信令时触发恢复操作，需要执行该操作。

## [注意事项](#ZH-CN_MMLREF_0231453389)
...
#### [操作用户权限](#ZH-CN_MMLREF_0231453389)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0231453389)
