# 查询EPS QoS参数到Pre-R8 QoS参数映射规则（LST R8QOSMAP）

- [命令功能](#ZH-CN_MMLREF_0000001172225913__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225913__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225913__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225913__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225913__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225913__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172225913__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225913)

**适用网元：MME**

此命令用于查看EPS QoS参数到Pre-R8 QoS参数映射规则。

#### [注意事项](#ZH-CN_MMLREF_0000001172225913)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225913)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225913)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225913)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| QCI | QoS 级别标识 | 可选必选说明：可选参数<br>参数含义：待查询映射规则所对应QoS的级别。QoS共分为9级业务服务质量，由QCI的值来标识。<br>取值范围：1～254<br>默认值：无 |

#### [使用实例](#ZH-CN_MMLREF_0000001172225913)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172225913)

参见 [**SET R8QOSMAP**](设置EPS QoS参数到Pre-R8 QoS参数映射规则（SET R8QOSMAP）_26146234.md) 的参数说明。
