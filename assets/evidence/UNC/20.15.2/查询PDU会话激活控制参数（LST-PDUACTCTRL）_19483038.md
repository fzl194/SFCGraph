# 查询PDU会话激活控制参数（LST PDUACTCTRL）

- [命令功能](#ZH-CN_MMLREF_0000002119483038__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002119483038__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002119483038__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002119483038__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000002119483038__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000002119483038)

**适用NF：AMF**

该命令用于查询基于DNN配置PDU会话激活处理策略。

## [注意事项](#ZH-CN_MMLREF_0000002119483038)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000002119483038)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002119483038)
...
## [使用实例](#ZH-CN_MMLREF_0000002119483038)
...
## [输出结果说明](#ZH-CN_MMLREF_0000002119483038)
...
| IMSI | 该参数用于指定IMSI。 |
| DNN类型 | 该参数用于指定请求DNN类型。 |
| 用户请求的DNN | 该参数用于指定用户请求的DNN。 |
| 处理策略 | 该参数用于控制整体策略，是直接拒绝激活，还是在签约数据匹配失败后进行纠正处理。 |
| 拒绝原因值 | 该参数用于控制拒绝PDU会话激活时下发给UE的原因值。 |
