# 删除UPF服务区名称绑定的5G TAI范围（RMV UPAREABINDN2TAI）

- [命令功能](#ZH-CN_MMLREF_0209652246__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652246__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652246__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652246__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652246)

**适用NF：SMF**

该命令用于删除UPF服务区名称绑定的5G TAI范围。

## [注意事项](#ZH-CN_MMLREF_0209652246)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652246)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652246)
