# 增加APN和P-CSCF组关联关系（ADD PCSCFGRPBNDAPN）

- [命令功能](#ZH-CN_MMLREF_0209653091__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653091__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653091__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653091__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653091)

**适用NF：PGW-C、SMF、GGSN**

该命令用于将指定的P-CSCF组绑定到APN上，或在APN视图下的指定号段。

## [注意事项](#ZH-CN_MMLREF_0209653091)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653091)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653091)
