# 删除Diameter路由域名信息（RMV DIAMRTREALM）

- [命令功能](#ZH-CN_CONCEPT_0209897305__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897305__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897305__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897305__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897305__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897305)

**适用NF：PGW-C、SMF**

该命令用于删除指定的Diameter路由的配置信息以及指定的Diameter路由的所有下一跳。

#### [注意事项](#ZH-CN_CONCEPT_0209897305)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897305)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897305)
