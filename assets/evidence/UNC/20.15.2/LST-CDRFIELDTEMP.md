...
- [命令功能](#ZH-CN_CONCEPT_0209896893__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896893__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896893__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896893__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896893__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209896893__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896893)

**适用NF：SGW-C、PGW-C、SMF**

该命令用于查询指定话单字段模板的具体配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0209896893)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896893)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896893)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| TEMPLATENAME | 话单字段模板名 | 可选必选说明：可选参数<br>参数含义：指定话单字段模板的名称。<br>数据来源：本端规划<br>取值范围：字符串类型，输入长度范围为1～63。<br>默认值：无<br>配置原则：无 |

#### [使用实例](#ZH-CN_CONCEPT_0209896893)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209896893)

参见ADD CDRFIELDTEMP的参数说明。
