# 删除用户移动性管理参数（RMV NGMMSUBDATA）

- [命令功能](#ZH-CN_MMLREF_0209652660__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652660__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652660__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652660__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652660)

**适用NF：AMF**

该命令用于删除为指定的用户（群）配置的移动性管理相关参数。

## [注意事项](#ZH-CN_MMLREF_0209652660)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652660)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652660)
