# 添加PIM全局配置（ADD PIMSITE）

- [命令功能](#ZH-CN_CONCEPT_0000001550280906__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280906__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280906__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280906__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280906__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280906)

该命令用于添加全局PIM相关参数。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280906)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280906)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280906)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280906)
