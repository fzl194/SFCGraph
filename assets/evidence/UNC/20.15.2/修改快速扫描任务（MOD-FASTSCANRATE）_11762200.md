# 修改快速扫描任务（MOD FASTSCANRATE）

- [命令功能](#ZH-CN_MMLREF_0000002111762200__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002111762200__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002111762200__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002111762200__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002111762200)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于修改快速扫描任务。

## [注意事项](#ZH-CN_MMLREF_0000002111762200)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000002111762200)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002111762200)
...
## [使用实例](#ZH-CN_MMLREF_0000002111762200)
