# 显示PAE告警信息（DSP PAEALARMINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001089532386__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001089532386__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001089532386__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001089532386__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001089532386__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001089532386__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001089532386)

该命令用于显示PAE告警信息。

PAE告警信息是指本端资源的链路故障数。通过此命令可查看本端资源到所有对端资源的链路故障数。

#### [注意事项](#ZH-CN_CONCEPT_0000001089532386)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001089532386)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001089532386)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001089532386)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001089532386)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 微服务类型 | 用于表示上报告警的微服务类型。 |
| 微服务实例号 | 用于表示上报告警的微服务实例号。 |
| 平面ID | 用于表示上报告警的Fabric平面ID。 |
| 事件名称 | 用于表示上报告警的事件名称。 |
| 端口名称 | 用于表示上报告警的端口名称。 |
| 链接故障数 | 用于表示上报告警的链路故障数量。 |
