# 删除Diameter路由组(RMV DMRTGRP)

- [命令功能](#ZH-CN_MMLREF_0000001172225971__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225971__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225971__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225971__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225971__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225971__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225971)

**适用网元：SGSN、MME**

该命令用于删除一条或多条Diameter路由组配置。

#### [注意事项](#ZH-CN_MMLREF_0000001172225971)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225971)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225971)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225971)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225971)
