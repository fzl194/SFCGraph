# 增加APN DNS域名策略(ADD APNDNS)

- [命令功能](#ZH-CN_MMLREF_0000001126145932__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145932__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145932__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145932__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145932__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145932__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145932)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126145932)

- 该命令执行后立即生效。
- 该命令最大记录数256。
- 当UE的同时具备2/3/4G网络接入能力，但是系统中没有“APN网络标识”和“UE接入能力”匹配的记录时(包括“UE接入能力”设置为“ALL_UE(ALL UE)”的记录)，默认优选合建的GGSN/PGW。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145932)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145932)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145932)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145932)
