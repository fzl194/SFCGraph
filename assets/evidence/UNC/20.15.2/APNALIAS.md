# 锁定APN别名配置（LCK APNALIAS）

- [命令功能](#ZH-CN_MMLREF_0228567625__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0228567625__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0228567625__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0228567625__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0228567625)

**适用NF：PGW-C、SMF、GGSN**

该命令用来配置对指定别名APN进行锁定操作。当别名APN锁定后，后续使用该别名APN激活的用户激活失败，已经在线的用户无影响。缺省情况下别名APN未锁定。

## [注意事项](#ZH-CN_MMLREF_0228567625)
...
#### [操作用户权限](#ZH-CN_MMLREF_0228567625)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0228567625)
