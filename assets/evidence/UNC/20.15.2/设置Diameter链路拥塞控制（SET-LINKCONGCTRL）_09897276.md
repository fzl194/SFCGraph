# 设置Diameter链路拥塞控制（SET LINKCONGCTRL）

- [命令功能](#ZH-CN_CONCEPT_0209897276__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897276__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897276__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897276__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897276__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897276)

**适用NF：PGW-C、SMF**

此命令用于设置Diameter链路拥塞触发告警和链路重建的相关参数。

#### [注意事项](#ZH-CN_CONCEPT_0209897276)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897276)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897276)
