# 修改命令层异常返回码处理动作（MOD CMDRCACT）

- [命令功能](#ZH-CN_CONCEPT_0209896946__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896946__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896946__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896946__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896946__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896946)

**适用NF：PGW-C、SMF**

该命令用于修改命令层异常返回码的处理动作配置。

#### [注意事项](#ZH-CN_CONCEPT_0209896946)

- 该命令执行后立即生效。
- 当命令层异常返回码处理动作配置为重定向时，CMDRDVIRTIP和CMDRDVIRTIPV6之间至少配置一个参数。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896946)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896946)
