# 查询AMF区域GUTI选网控制策略（LST NGGUTISELPLCY）

- [命令功能](#ZH-CN_MMLREF_0000002013939881__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002013939881__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002013939881__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002013939881__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000002013939881__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000002013939881)

**适用NF：AMF**

该命令用于查询AMF区域GUTI选网功能控制策略。

## [注意事项](#ZH-CN_MMLREF_0000002013939881)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000002013939881)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002013939881)
...
## [使用实例](#ZH-CN_MMLREF_0000002013939881)
...
## [输出结果说明](#ZH-CN_MMLREF_0000002013939881)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 区域范围 | 该参数用于设置GUTI选网功能的区域范围。 |
| GUTI选网功能区域编码 | 该参数用于指定应用GUTI选网功能的某个区域。 |
| 控制对象 | 该参数用于指定应用指定区域GUTI选网功能的用户的识别对象。 |
| 用户群组标识 | 该参数用于指定应用GUTI选网功能的用户群组。 |
| 切片业务类型 | 该参数表示切片的业务类型，如eMBB（1）、URLLC（2）、MIoT（3）等协议定义的标准SST，或者运营商自定义的SST。 |
| 切片细分标识 | 该参数表示根据网络切片所提供的服务特点、所服务的对象差异，对某种网络切片的进一步细分。 |
| UE USAGE TYPE | 该参数用于指定应用GUTI选网功能的UE Usage Type。 |
| 目标AMF集合标识 | 该参数用于设置GUTI选网的目标AMF集合的标识。 |
| 目标AMF指示符 | 该参数用于设置GUTI选网的目标AMF指示符信息。 |
