# 增加接口ACL规则（ADD ACLRULEIF）

- [命令功能](#ZH-CN_CONCEPT_0000001549961886__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961886__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961886__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961886__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961886__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961886)

该命令用于增加接口ACL规则。接口ACL规则支持按照接口进行匹配。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961886)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961886)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961886)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961886)
