# 增加DNAI服务区名称绑定的5G Cell ID范围（ADD DNAREABINDN2CID）

- [命令功能](#ZH-CN_MMLREF_0000001171436521__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001171436521__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001171436521__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001171436521__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001171436521)

**适用NF：SGW-C、GGSN、SMF、PGW-C**

该命令用于增加DNAI服务区名称绑定的5G Cell ID范围。

## [注意事项](#ZH-CN_MMLREF_0000001171436521)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001171436521)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001171436521)
...
## [使用实例](#ZH-CN_MMLREF_0000001171436521)
