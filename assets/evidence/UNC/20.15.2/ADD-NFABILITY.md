# 增加配置NF的能力信息（ADD NFABILITY）

- [命令功能](#ZH-CN_MMLREF_0244006431__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244006431__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244006431__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244006431__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244006431)

**适用NF：NRF**

该命令用于新增配置NF的能力信息。NRF可以根据NF能力的不同，做一些差异化的控制。

## [注意事项](#ZH-CN_MMLREF_0244006431)
...
#### [操作用户权限](#ZH-CN_MMLREF_0244006431)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244006431)
