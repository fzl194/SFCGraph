# 设置SMSF网元定时器（SET SMSFTIMERPARA）

- [命令功能](#ZH-CN_MMLREF_0296243227__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243227__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243227__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243227__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243227)

**适用NF：SMSF**

该命令用于设置SMSF相关的业务定时器。

## [注意事项](#ZH-CN_MMLREF_0296243227)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243227)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243227)
