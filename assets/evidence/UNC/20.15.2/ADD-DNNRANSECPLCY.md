# 增加DNN RAN侧安全策略（ADD DNNRANSECPLCY）

- [命令功能](#ZH-CN_MMLREF_0296805377__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296805377__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296805377__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296805377__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296805377)

**适用NF：SMF**

该命令用来增加基于DNN的RAN侧用户面安全策略。策略用于明确是否需要对RAN侧用户面进行完整性保护和加密保护。

## [注意事项](#ZH-CN_MMLREF_0296805377)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296805377)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296805377)
