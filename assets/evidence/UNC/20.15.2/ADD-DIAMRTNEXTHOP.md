# 增加Diameter路由下一跳（ADD DIAMRTNEXTHOP）

- [命令功能](#ZH-CN_CONCEPT_0209897310__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897310__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897310__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897310__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897310__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897310)

**适用NF：PGW-C、SMF**

此命令用于添加指定Diameter应用和realm的Diameter路由的下一跳。

#### [注意事项](#ZH-CN_CONCEPT_0209897310)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897310)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897310)
