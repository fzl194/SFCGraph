# 设置语音PCF/PCRF故障Bypass场景功能（SET IMSBYPASSFUNC）

- [命令功能](#ZH-CN_MMLREF_0000002149496669__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002149496669__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002149496669__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002149496669__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002149496669)

**适用NF：PGW-C、SMF**

该命令用于设置语音PCF/PCRF故障Bypass场景功能。

## [注意事项](#ZH-CN_MMLREF_0000002149496669)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000002149496669)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002149496669)
...
## [使用实例](#ZH-CN_MMLREF_0000002149496669)
