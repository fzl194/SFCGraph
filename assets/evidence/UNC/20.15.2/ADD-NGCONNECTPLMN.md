# 增加5G Connect PLMN（ADD NGCONNECTPLMN）

- [命令功能](#ZH-CN_MMLREF_0209651402__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651402__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651402__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651402__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651402)

**适用NF：AMF**

该命令用于增加可接入到本运营商的Connect PLMN。所谓Connect PLMN是指与本运营商签定了漫游协议的其它运营商的PLMN。

## [注意事项](#ZH-CN_MMLREF_0209651402)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651402)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651402)
