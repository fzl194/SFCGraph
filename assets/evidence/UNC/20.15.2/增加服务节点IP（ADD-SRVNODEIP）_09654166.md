# 增加服务节点IP（ADD SRVNODEIP）

- [命令功能](#ZH-CN_MMLREF_0209654166__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654166__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654166__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654166__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654166)

**适用NF：PGW-C、GGSN**

该命令用来增加一个新的服务节点IP。当需要用SGSN IP、SGW IP、PCF IP进行虚拟APN映射时，在不同的场景下需要使用该命令增加SGSN/SGW/PCF的服务节点组绑定的服务节点IP地址段。

## [注意事项](#ZH-CN_MMLREF_0209654166)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209654166)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654166)
