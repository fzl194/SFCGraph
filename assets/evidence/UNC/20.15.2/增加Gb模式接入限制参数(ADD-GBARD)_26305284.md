# 增加Gb模式接入限制参数(ADD GBARD)

- [命令功能](#ZH-CN_MMLREF_0000001126305284__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305284__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305284__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305284__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305284__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305284__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001126305284__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305284)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305284)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305284)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305284)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305284)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305284)
...
#### [参考信息](#ZH-CN_MMLREF_0000001126305284)

- 输入的起始IMSI必须小于或者等于终止IMSI。判断起始IMSI和终止IMSI大小的原则是：对于输入IMSI的长度小于系统规定IMSI长度时， 将该IMSI补足0到规定长度后进行大小比较，且起始IMSI必须小于终止IMSI。只有输入IMSI长度等于系统规定长度时，起始IMSI才能等于终止IMSI。对于系统规定IMSI长度为15的情况，如[表1](#ZH-CN_MMLREF_0000001126305284__tab1)所示：
  *表1 IMSI限定范围*
