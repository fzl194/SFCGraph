# 删除M2M策略参数(RMV M2MPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001126305574__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305574__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305574__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305574__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305574__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305574__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305574)

**适用网元：SGSN、MME**

该命令用于删除M2M的策略参数。

#### [注意事项](#ZH-CN_MMLREF_0000001126305574)

该命令执行后对已经附着的用户不立即生效。用户下次RAU/TAU流程再生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305574)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305574)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305574)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305574)
