# 查询Gb模式用户安全参数(LST GBAUTHCIPH)

- [命令功能](#ZH-CN_MMLREF_0000001172345241__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345241__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345241__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345241__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345241__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345241__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172345241__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345241)

**适用网元：SGSN**

该命令用于查看2G鉴权加密信息表记录。

#### [注意事项](#ZH-CN_MMLREF_0000001172345241)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345241)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345241)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345241)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345241)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172345241)

参见命令 [**ADD GBAUTHCIPH**](增加Gb模式用户安全参数（ADD GBAUTHCIPH）_26145642.md) 参数说明。
