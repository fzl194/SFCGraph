# 设置NSA用户的RAT值（SET NSARATVALUE）

- [命令功能](#ZH-CN_MMLREF_0000001135273635__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001135273635__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001135273635__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001135273635__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001135273635)

**适用NF：SGW-C、PGW-C**

该命令用于设置终端作为NSA用户时，UNC给周边网元发送消息中RAT信元携带的值。

## [注意事项](#ZH-CN_MMLREF_0000001135273635)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001135273635)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001135273635)
...
## [使用实例](#ZH-CN_MMLREF_0000001135273635)
