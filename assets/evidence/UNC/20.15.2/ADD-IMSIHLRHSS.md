# 增加IMSI对应的HLR/HSS接口(ADD IMSIHLRHSS)

- [命令功能](#ZH-CN_MMLREF_0000001126145752__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145752__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145752__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145752__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145752__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145752__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145752)

**适用网元：SGSN、MME**

此命令用于增加IMSI对应的HLR/HSS接口。该配置用于用户在接入时SGSN/MME和HLR/HSS使用的是Gr、S6d还是S6a口。

#### [注意事项](#ZH-CN_MMLREF_0000001126145752)

- 此命令最大记录数8192。
- 此命令执行后立即生效。
- 当启用单注册可能会导致Gr接口、S6d接口、S6a接口信令消息增多。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145752)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145752)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145752)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145752)
