# 删除对端NF实例概述信息（RMV PNFPROFILE）

- [命令功能](#ZH-CN_MMLREF_0209653775__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653775__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653775__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653775__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653775)

**适用NF：AMF、SMF、NSSF、SMSF、NCG、NRF、SGW-C、PGW-C、GGSN**

该命令用于删除本地配置的对端NF实例的概述信息。

## [注意事项](#ZH-CN_MMLREF_0209653775)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653775)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653775)
