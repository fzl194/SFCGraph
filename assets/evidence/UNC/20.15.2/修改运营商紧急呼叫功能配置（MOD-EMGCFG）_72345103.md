# 修改运营商紧急呼叫功能配置（MOD EMGCFG）

- [命令功能](#ZH-CN_MMLREF_0000001172345103__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345103__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345103__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345103__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345103__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345103__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345103)

**适用网元：MME**

该命令用于修改指定MNO/MVNO对应的紧急呼叫配置数据。运营商需要使用紧急呼叫业务时，通过此命令配置对应MNO或MVNO下的紧急呼叫的策略、紧急业务的APN和QoS相关配置。

#### [注意事项](#ZH-CN_MMLREF_0000001172345103)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345103)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345103)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345103)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345103)
