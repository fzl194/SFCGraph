# 删除AGF的计费上下文信息（RMV AGFCHGINFO）

- [命令功能](#ZH-CN_MMLREF_0277825285__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0277825285__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0277825285__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0277825285__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0277825285)
...
## [注意事项](#ZH-CN_MMLREF_0277825285)

- 该命令执行后立即生效。

- 删除AGF的计费上下文信息可能会影响生成话单的正确性，请慎重使用此命令。

#### [操作用户权限](#ZH-CN_MMLREF_0277825285)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0277825285)
