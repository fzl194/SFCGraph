# 修改SGSN/SGW IP与RAT类型间的映射关系（MOD SRVNODERAT）

- [命令功能](#ZH-CN_MMLREF_0209652673__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652673__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652673__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652673__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652673)

**适用NF：GGSN**

该命令用来修改SGSN的IP与RAT类型间的映射关系表。当运营商需要改变一SGSN的IP地址段对应的RAT类型时，使用此命令。修改RAT类型用于从虚拟APN映射到真实APN、匹配UserProfile进行业务、计费控制。

## [注意事项](#ZH-CN_MMLREF_0209652673)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652673)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652673)
