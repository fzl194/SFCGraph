# 显示PAE内联口亚健康统计信息（DSP FABRICSUBHEALTHYSTAT）

- [命令功能](#ZH-CN_CONCEPT_0000001103213622__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001103213622__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001103213622__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001103213622__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001103213622__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001103213622__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001103213622)

该命令用于显示Fabric平面亚健康30个周期的统计信息，包括发包数、收包数、丢包数、错包数。

#### [注意事项](#ZH-CN_CONCEPT_0000001103213622)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001103213622)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001103213622)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001103213622)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001103213622)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 周期索引 | 用于表示周期索引。 |
| 本端节点TB | 用于表示本端节点的资源ID。 |
| 远端节点TB | 用于表示远端节点的资源ID。 |
| 本端端口名称 | 用于表示本端端口名称。 |
| 远端端口名称 | 用于表示远端端口名称。 |
| 报文类型 | 用于表示报文类型，包括OAM报文和用户报文。 |
| 发送报文数目 | 用于表示发送报文数目。 |
| 远端接收报文数目 | 用于表示远端接收报文数目。 |
| 丢失报文数目 | 用于表示丢失报文数目。 |
| 错误报文数目 | 用于表示错误报文数目。 |
