...
- [命令功能](#ZH-CN_MMLREF_0209652456__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652456__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652456__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652456__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209652456__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209652456)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于查询本地配置的对端NF实例支持的服务实例回调信息。

## [注意事项](#ZH-CN_MMLREF_0209652456)

无

#### [操作用户权限](#ZH-CN_MMLREF_0209652456)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652456)
...
## [输出结果说明](#ZH-CN_MMLREF_0209652456)
