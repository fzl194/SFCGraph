# 设置运行备整系统复位开关（SET DRSTBYRSTCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001400921394__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001400921394__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001400921394__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001400921394__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001400921394)

该命令用于设置容灾实例在检测到关键服务异常或者周边网元故障时是否需要复位。

## [注意事项](#ZH-CN_MMLREF_0000001400921394)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001400921394)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001400921394)
...
## [使用实例](#ZH-CN_MMLREF_0000001400921394)
