# 设置5G接入用户的RAT填写值（SET NRRATVALUE）

- [命令功能](#ZH-CN_MMLREF_0252071376__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0252071376__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0252071376__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0252071376__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0252071376)

**适用NF：SMF、PGW-C**

设置5G用户接入时携带真实RAT（RAT参数取值为REALVALUE）时，RAT的真实取值根据SET/LST NRRATVALUE设置的命令进行携带。

## [注意事项](#ZH-CN_MMLREF_0252071376)
...
#### [操作用户权限](#ZH-CN_MMLREF_0252071376)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0252071376)
