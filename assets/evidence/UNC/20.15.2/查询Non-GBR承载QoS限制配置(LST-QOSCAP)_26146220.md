# 查询Non-GBR承载QoS限制配置(LST QOSCAP)

- [命令功能](#ZH-CN_MMLREF_0000001126146220__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146220__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146220__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146220__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146220__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146220__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126146220__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146220)

**适用网元：MME**

该命令用于查询QoS限制配置信息。

#### [注意事项](#ZH-CN_MMLREF_0000001126146220)

无。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146220)

manage-ug；system-ug；monitor-ug。

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146220)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组。

#### [参数说明](#ZH-CN_MMLREF_0000001126146220)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146220)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126146220)

请参考 [**ADD QOSCAP**](增加Non-GBR承载QoS限制配置(ADD QOSCAP)_72225897.md) 命令的参数标识。
