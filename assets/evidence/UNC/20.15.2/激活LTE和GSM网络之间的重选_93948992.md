...
- [操作场景](#ZH-CN_OPI_0193948992__1.3.1)
- [必备事项](#ZH-CN_OPI_0193948992__1.3.2)
- [操作流程](#ZH-CN_OPI_0193948992__1.3.3)
- [操作步骤](#ZH-CN_OPI_0193948992__1.3.4)
- [任务示例](#ZH-CN_OPI_0193948992__1.3.5)

## [操作场景](#ZH-CN_OPI_0193948992)

本操作指导介绍在运行网络中激活LTE和GSM网络之间的重选特性的操作过程。
...
## [必备事项](#ZH-CN_OPI_0193948992)

前提条件

- 请仔细阅读[WSFD-104502 LTE和GSM 网络之间的重选特性概述](特性概述_95236967.md)。
- 完成加载License。
...
| [**ADD DNSS**](../../../../../OM参考/命令/UNC MML命令/业务服务管理/Pre 5G接入业务管理/控制面管理/GTP-C接口管理/DNS/DNS服务器管理/增加DNS服务器(ADD DNSS)_72345497.md) | IP地址（IP） | 172.28.1.33、172.28.2.33、172.29.3.10 | 全网规划 | DNS服务器数据 |
...
| [**ADD IPV4DNSH**](../../../../../OM参考/命令/UNC MML命令/业务服务管理/Pre 5G接入业务管理/控制面管理/GTP-C接口管理/DNS/DNS Hostfile管理/增加IPV4 DNS Hostfile记录(ADD IPV4DNSH)_26145884.md) | 主机名索引（HSINDEX） | 1 | 全网规划 | A解析数据 |
| [**ADD IPV4DNSH**](../../../../../OM参考/命令/UNC MML命令/业务服务管理/Pre 5G接入业务管理/控制面管理/GTP-C接口管理/DNS/DNS Hostfile管理/增加IPV4 DNS Hostfile记录(ADD IPV4DNSH)_26145884.md) | 主机名（HOSTNAME） | RAC0000.LAC2302.MNC0000.MCC0123GPRS | 全网规划 | A解析数据 |
...
| [**SET S1SMPROCTRL**](../../../../../OM参考/命令/UNC MML命令/业务服务管理/Pre 5G接入业务管理/控制面管理/业务安全管理/会话管理/SM流程管理/S1模式SM流程控制参数/设置S1模式SM流程控制参数(SET S1SMPROCTRL)_26305504.md) | 流程类型（PROT） | HSS_INIT_SUB_QOS_MOD_PROC | 全网规划 | Inter RAT的TAU流程中是否要发生Oos修改流程 |
| [**SET S1SMPROCTRL**](../../../../../OM参考/命令/UNC MML命令/业务服务管理/Pre 5G接入业务管理/控制面管理/业务安全管理/会话管理/SM流程管理/S1模式SM流程控制参数/设置S1模式SM流程控制参数(SET S1SMPROCTRL)_26305504.md) | ECM-IDLE状态立即发起修改流程（ECMIDLE） | YES | 全网规划 | Inter RAT的TAU流程中是否要发生Oos修改流程 |
...
## [操作流程](#ZH-CN_OPI_0193948992)

激活LTE和GSM网络之间的重选操作流程如 [图1](#ZH-CN_OPI_0193948992__zh-cn_opi_0130428800_fig_01) 所示。

**图1** 激活LTE和GSM网络之间的重选操作流程

<br>

![](激活LTE和GSM网络之间的重选_93948992.assets/zh-cn_image_0193953441_2.png)

## [操作步骤](#ZH-CN_OPI_0193948992)
...
6. **可选：**设置Inter RAT的TAU流程中是否要发生Oos修改流程。
...
## [任务示例](#ZH-CN_OPI_0193948992)

任务描述

激活LTE和GSM网络之间的重选特性，进行如下配置：
...
```
ADD IPV4DNSH: HSINDEX=1, HOSTNAME="RAC0000.LAC2302.MNC0000.MCC0123GPRS", ADDRSECTION=SECTION1, IPV4ADDR1="172.25.6.53", PRIORITY1=1, WEIGHT1=50, IPV4ADDR2="172.25.6.54", PRIORITY2=1, WEIGHT2=50;
```
