# 增加基于ARP的DDN消息优先级配置（ADD DDNPRIORITYARP）

- [命令功能](#ZH-CN_MMLREF_0304284707__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0304284707__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0304284707__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0304284707__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0304284707)

**适用NF：SGW-C、SMF**

该命令用于增加基于ARP的DDN消息优先级。

## [注意事项](#ZH-CN_MMLREF_0304284707)
...
#### [操作用户权限](#ZH-CN_MMLREF_0304284707)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0304284707)
