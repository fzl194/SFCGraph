# 设置Proxy SGW功能参数（SET PROXYSGWFUNC）

- [命令功能](#ZH-CN_MMLREF_0306399930__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399930__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399930__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399930__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0306399930)

**适用NF：SGW-C**

该命令用于设置Proxy S-GW特性的功能参数。

## [注意事项](#ZH-CN_MMLREF_0306399930)
...
#### [操作用户权限](#ZH-CN_MMLREF_0306399930)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399930)
