# 设置2B2C漫游双DNN特性相关的功能控制（SET MULTIDNNCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001339800065__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001339800065__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001339800065__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001339800065__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001339800065)

**适用NF：PGW-C、SMF**

该命令用于设置2B2C漫游双DNN特性相关的功能控制，如IdleTime功能、IP地址冲突检测、地址冲突时是否保留大网业务等参数。

## [注意事项](#ZH-CN_MMLREF_0000001339800065)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001339800065)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001339800065)
...
## [使用实例](#ZH-CN_MMLREF_0000001339800065)
