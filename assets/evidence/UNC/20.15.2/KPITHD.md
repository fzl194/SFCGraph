...
- [命令功能](#ZH-CN_MMLREF_0000001172225879__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225879__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225879__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225879__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225879__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225879__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001172225879__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225879)

**适用网元：SGSN、MME**

该命令用于设置KPI监控功能的KPI门限值。

#### [注意事项](#ZH-CN_MMLREF_0000001172225879)

- 请谨慎执行该命令。修改初始设置时，请依据具体情况设置对应指标名称的门限值和最小业务量。
- 该命令设置成功后1分钟内生效。
- 设置KPI门限值前，请先通过命令开启KPI监控功能。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225879)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225879)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225879)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225879)
...
#### [参考信息](#ZH-CN_MMLREF_0000001172225879)

系统默认配置如下：

```
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=2G_ATTACH_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=2G_SGSN_RAU_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=2G_ACTIVE_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=3G_ATTACH_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=3G_SGSN_RAU_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=3G_ACTIVE_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=3G_SERVICE_REQUEST_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_ATTACH_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_COMBINE_ATTACH_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_MME_TAU_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_MME_X2_HANDOVER_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_MME_S1_HANDOVER_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_SERVICE_REQUEST_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_DEDICATED_BEARER_BY_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
SET KPITHD: MONGRANULARITY=PROCESS, KPINAME=4G_EXTENDED_SRV_REQUEST_PROC, MONTY=RELATIVE_VALUE, MINTRAFFIC=100, RELATHD=40;
```
