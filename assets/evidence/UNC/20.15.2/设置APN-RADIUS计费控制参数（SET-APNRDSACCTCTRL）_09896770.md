# 设置APN RADIUS计费控制参数（SET APNRDSACCTCTRL）

- [命令功能](#ZH-CN_CONCEPT_0209896770__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896770__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896770__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896770__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896770__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896770)

**适用NF：PGW-C、SMF**

该命令用于配置基于APN的RADIUS客户端计费信令控制属性，用来控制RADIUS客户端计费信令处理流程。

#### [注意事项](#ZH-CN_CONCEPT_0209896770)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896770)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896770)
