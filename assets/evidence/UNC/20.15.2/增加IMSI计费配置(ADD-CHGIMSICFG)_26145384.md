...
- [命令功能](#ZH-CN_MMLREF_0000001126145384__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145384__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145384__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145384__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145384__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145384__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145384)

**适用网元：SGSN**

该命令用于配置基于 “IMSI前缀” 、 “APNNI” 、 “用户拜访类型” 和 “计费属性” 的计费配置信息，可以用该命令根据 “IMSI前缀” 、 “APNNI” 、 “用户拜访属性” 和 “计费属性” 配置生成话单的触发条件。

#### [注意事项](#ZH-CN_MMLREF_0000001126145384)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126145384)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145384)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145384)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145384)
