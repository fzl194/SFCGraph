# 删除DNN中数据网络访问标识最长后缀匹配转发路由（RMV NRFDNNDNAIRT）

- [命令功能](#ZH-CN_MMLREF_0000001492900874__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001492900874__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001492900874__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001492900874__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001492900874)

**适用NF：NRF**

该命令用于删除DNN中数据网络访问标识最长后缀匹配转发路由。该命令功能暂不生效。

## [注意事项](#ZH-CN_MMLREF_0000001492900874)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001492900874)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001492900874)
...
## [使用实例](#ZH-CN_MMLREF_0000001492900874)
