# 删除BGP对等体组（RMV BGPPEERGROUP）

- [命令功能](#ZH-CN_CONCEPT_0000001600440821__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440821__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440821__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440821__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440821__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440821)

该命令用于删除IPv4或IPv6地址族下的对等体组。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440821)

- 该命令执行后立即生效。
- 删除对等体组会删除该对等体组下的所有对等体。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440821)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440821)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440821)
