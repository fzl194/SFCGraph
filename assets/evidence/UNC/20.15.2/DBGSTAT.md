...
- [命令功能](#ZH-CN_CONCEPT_0129627109__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0129627109__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0129627109__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0129627109__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0129627109__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0129627109__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0129627109)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0129627109)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0129627109)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0129627109)

| 输出项名称 | 输出项解释 |
| --- | --- |
| RU名称 | 查询命令所输入RU名称<br>取值范围：0~63字符 |
| 进程类型 | 查询命令所输入的进程类型<br>取值范围：<br>- “PROC_TYPE_MPEP(PROC_MPEP) ”<br>- “PROC_TYPE_MOMP(PROC_MOMP) ”<br>- “PROC_TYPE_MNCP(PROC_MNCP) ”<br>- “PROC_TYPE_MLBP(PROC_MLBP) ”<br>- “PROC_TYPE_MPCP(PROC_MPCP) ” |
| 进程号 | 查询命令所输入的进程序号<br>取值范围：0~63 |
| 第一个参数 | 查询命令所输入的第一个参数<br>取值范围：0~63字符 |
| 第二个参数 | 查询命令所输入的第二个参数<br>取值范围：0~63字符 |
| 第三个参数 | 查询命令所输入的第三个参数<br>取值范围：0~63字符 |
| 第四个参数 | 查询命令所输入的第四个参数<br>取值范围：0~63字符 |
| 第五个参数 | 查询命令所输入的第五个参数<br>取值范围：0~63字符 |
| 第六个参数 | 查询命令所输入的第六个参数<br>取值范围：0~63字符 |
| 结果字符串 | 查询结果输出 |
