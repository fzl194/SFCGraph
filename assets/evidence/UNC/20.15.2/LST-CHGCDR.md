# 查询计费CDR参数（LST CHGCDR）

- [命令功能](#ZH-CN_MMLREF_0000001172225053__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225053__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225053__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225053__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225053__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225053__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172225053__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225053)

**适用网元：SGSN**

该命令用于查询计费CDR参数的配置，包括各种话单内容配置选项、SGSN节点标识等。

#### [注意事项](#ZH-CN_MMLREF_0000001172225053)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225053)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225053)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225053)

无。

#### [使用实例](#ZH-CN_MMLREF_0000001172225053)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172225053)

请参考 [**SET CHGCDR**](设置计费CDR参数（SET CHGCDR）_26145372.md) 命令参数说明。
