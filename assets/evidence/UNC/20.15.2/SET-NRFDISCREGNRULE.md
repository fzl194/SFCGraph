# 设置服务发现区域识别规则（SET NRFDISCREGNRULE）

- [命令功能](#ZH-CN_MMLREF_0000001124956654__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001124956654__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001124956654__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001124956654__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001124956654)

**适用NF：NRF**

该命令用于设置NRF服务发现区域识别规则，通过该规则可以提取NF的区域信息，以便进行区域相关的服务发现逻辑决策。

## [注意事项](#ZH-CN_MMLREF_0000001124956654)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001124956654)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001124956654)
...
## [使用实例](#ZH-CN_MMLREF_0000001124956654)
