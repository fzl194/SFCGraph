# 增加5GC签约QoS配置（ADD 5GCSUBQOS）

- [命令功能](#ZH-CN_MMLREF_0209652601__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652601__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652601__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652601__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652601)

**适用NF：SMF**

该命令用来增加5G用户的签约QoS属性。

## [注意事项](#ZH-CN_MMLREF_0209652601)

- 命令执行后只对新接入用户生效。

- 最多可输入100条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209652601)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652601)
