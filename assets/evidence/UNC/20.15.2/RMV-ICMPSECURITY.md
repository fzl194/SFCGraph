# 删除ICMP安全配置（RMV ICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001600441301__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441301__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441301__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441301__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441301__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441301)

该命令用于删除ICMP安全配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441301)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441301)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441301)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441301)
