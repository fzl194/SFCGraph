# 查询本地公钥（LST LOCALKEYPAIR）

- [命令功能](#ZH-CN_CONCEPT_0259036289__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259036289__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259036289__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259036289__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259036289__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259036289__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259036289)

该命令用于查询本地公钥。

#### [注意事项](#ZH-CN_CONCEPT_0259036289)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0259036289)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259036289)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| KEYTYPE | 公钥类型 | 可选必选说明：必选参数<br>参数含义：公钥类型。<br>数据来源：本端规划<br>取值范围：枚举类型。<br>RSA：RSA公钥。<br>默认值：无 |

#### [使用实例](#ZH-CN_CONCEPT_0259036289)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259036289)
...
| 公钥指纹 | 公钥的指纹。 |
| 公钥编码 | 公钥的编码。 |
| PEM格式的公钥编码 | PEM格式的公钥编码。 |
| OpenSSH格式的公钥编码 | OpenSSH格式的公钥编码。 |
| 公钥类型 | 本地公钥类型。 |
| 公钥长度 | 本地公钥长度。 |
