...
- [命令功能](#ZH-CN_CONCEPT_0136508137__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0136508137__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0136508137__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0136508137__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0136508137__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0136508137)

该命令用于解闭已闭塞的CSDB RU，使其他RU上的数据迁回到RU上。在分批升级之后，执行本命令，将数据迁移回RU上。

#### [注意事项](#ZH-CN_CONCEPT_0136508137)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0136508137)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0136508137)
