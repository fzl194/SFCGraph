# 增加预埋命令1(ADD USNRSVCMD1)

- [命令功能](#ZH-CN_CONCEPT_0000001223033092__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001223033092__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001223033092__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001223033092__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001223033092__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001223033092__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001223033092)

**适用网元：MME**

该命令用于添加实现指定的功能所需要的命令名称以及对应的参数信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001223033092)

无

#### [本地用户权限](#ZH-CN_CONCEPT_0000001223033092)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001223033092)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001223033092)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001223033092)
