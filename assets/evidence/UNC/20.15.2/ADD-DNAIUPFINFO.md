# 增加指定DNAI的UPF节点信息（ADD DNAIUPFINFO）

- [命令功能](#ZH-CN_MMLREF_0000001269277824__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001269277824__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001269277824__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001269277824__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001269277824)

**适用NF：SMF、PGW-C**

该命令用于增加指定DNAI的UPF节点信息。

## [注意事项](#ZH-CN_MMLREF_0000001269277824)

- 该命令执行后立即生效。

- 最多可输入16000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001269277824)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001269277824)
...
## [使用实例](#ZH-CN_MMLREF_0000001269277824)
