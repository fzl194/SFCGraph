# 增加Ocs绑定关系（ADD OCSBINDING）

- [命令功能](#ZH-CN_CONCEPT_0209896963__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896963__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896963__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896963__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896963__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896963)

**适用NF：PGW-C、SMF**

该命令用来增加OCS绑定关系。

#### [注意事项](#ZH-CN_CONCEPT_0209896963)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896963)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896963)
