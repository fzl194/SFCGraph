# 修改GBR承载带宽速率控制配置（MOD GBRBWCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001340119813__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001340119813__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001340119813__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001340119813__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001340119813)

**适用NF：GGSN、PGW-C、SMF**

该命令用来修改GBR承载带宽速率控制配置。

## [注意事项](#ZH-CN_MMLREF_0000001340119813)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001340119813)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001340119813)
...
## [使用实例](#ZH-CN_MMLREF_0000001340119813)
