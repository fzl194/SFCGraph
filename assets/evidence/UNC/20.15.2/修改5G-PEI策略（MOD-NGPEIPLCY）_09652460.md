# 修改5G PEI策略（MOD NGPEIPLCY）

- [命令功能](#ZH-CN_MMLREF_0209652460__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652460__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652460__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652460__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652460)

**适用NF：AMF**

该命令用于为指定的用户修改PEI控制策略，如是否从UE获取PEI、是否检查PEI的合法性等。

## [注意事项](#ZH-CN_MMLREF_0209652460)

- 该命令执行后立即生效。

- 此命令修改所有5G用户的默认IMEI配置，以及指定号段用户的IMEI配置。

#### [操作用户权限](#ZH-CN_MMLREF_0209652460)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652460)
