# 修改振荡抑制路由（MOD DAMPROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001550120910__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550120910__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550120910__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550120910__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550120910__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550120910)

该命令用于修改路由振荡抑制的配置参数。

#### [注意事项](#ZH-CN_CONCEPT_0000001550120910)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550120910)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550120910)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550120910)
