# 查询UPF服务区名称绑定的LAI范围（LST UPAREABINDLAI）

- [命令功能](#ZH-CN_MMLREF_0209653838__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653838__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653838__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653838__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209653838__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209653838)

**适用NF：GGSN**

该命令用于查询UPF服务区名称绑定的LAI范围。

## [注意事项](#ZH-CN_MMLREF_0209653838)

无

#### [操作用户权限](#ZH-CN_MMLREF_0209653838)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653838)
...
## [输出结果说明](#ZH-CN_MMLREF_0209653838)

| 输出项名称 | 输出项解释 |
| --- | --- |
| UPF服务区名称 | 该参数用于配置UPF服务区的名称。 |
| UPF服务区名称绑定的LAI范围的起始值 | 该参数用于标识UPF服务区名称绑定的LAI范围的起始值。 |
| UPF服务区名称绑定的LAI范围的结束值 | 该参数用于标识UPF服务区名称绑定的LAI范围的结束值。 |
