# 增加基于区域的网络名称 (ADD AREAMMINFO)

- [命令功能](#ZH-CN_CONCEPT_0000001442831705__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001442831705__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001442831705__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001442831705__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001442831705__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001442831705__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001442831705)

**适用网元：MME**

此命令用于增加基于区域的网络名称，可以控制不同区域，不同用户范围分别向用户下发不同运营商标识。

#### [注意事项](#ZH-CN_CONCEPT_0000001442831705)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0000001442831705)

manage-ug；system-ug；

#### [网管用户权限](#ZH-CN_CONCEPT_0000001442831705)

G_1，管理员级别命令组；G_2，操作员级别命令组；

#### [参数说明](#ZH-CN_CONCEPT_0000001442831705)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001442831705)
