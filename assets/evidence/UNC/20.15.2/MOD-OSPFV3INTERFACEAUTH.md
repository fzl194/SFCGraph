# 修改OSPFv3接口认证配置（MOD OSPFV3INTERFACEAUTH）

- [命令功能](#ZH-CN_CONCEPT_0000001600440325__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440325__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440325__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440325__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440325__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440325)

该命令用于修改OSPFv3接口上所使用的验证模式及验证口令。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440325)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440325)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440325)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440325)
