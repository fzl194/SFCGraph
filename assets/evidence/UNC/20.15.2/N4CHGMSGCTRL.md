# 设置N4接口计费消息相关控制参数（SET N4CHGMSGCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001258680359__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001258680359__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001258680359__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001258680359__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001258680359)

**适用NF：SMF、PGW-C、GGSN**

该命令用于配置N4接口计费消息相关控制参数。

## [注意事项](#ZH-CN_MMLREF_0000001258680359)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001258680359)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001258680359)
...
## [使用实例](#ZH-CN_MMLREF_0000001258680359)
