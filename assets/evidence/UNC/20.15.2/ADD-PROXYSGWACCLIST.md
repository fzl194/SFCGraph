# 增加Proxy SGW-C接入控制列表（ADD PROXYSGWACCLIST）

- [命令功能](#ZH-CN_MMLREF_0306399907__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399907__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399907__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399907__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0306399907)

**适用NF：SGW-C**

该命令用于Proxy S-GW特性中控制是否允许用户接入。

## [注意事项](#ZH-CN_MMLREF_0306399907)
...
#### [操作用户权限](#ZH-CN_MMLREF_0306399907)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399907)
...
## [使用实例](#ZH-CN_MMLREF_0306399907)

添加用户范围为IMSI_PRE，前缀为27602，控制类型为ALLOW，描述信息为Vodafone的Proxy SGW-C接入列表记录，执行如下命令：

```
ADD PROXYSGWACCLIST: SUBRANGE=IMSI_PRE, PREFIX="27602", CTRLTYPE=ALLOW, DESC="Vodafone";
```
