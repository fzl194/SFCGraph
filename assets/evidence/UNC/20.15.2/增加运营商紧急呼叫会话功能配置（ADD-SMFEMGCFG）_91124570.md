# 增加运营商紧急呼叫会话功能配置（ADD SMFEMGCFG）

- [命令功能](#ZH-CN_MMLREF_0000001091124570__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001091124570__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001091124570__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001091124570__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001091124570)

**适用NF：SMF**

该命令用于增加运营商紧急呼叫会话相关功能配置。运营商需要使用紧急呼叫业务时，通过此命令配置对应MNO或MVNO下的紧急呼叫会话的ARP、5QI等信息。

## [注意事项](#ZH-CN_MMLREF_0000001091124570)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001091124570)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001091124570)
...
## [使用实例](#ZH-CN_MMLREF_0000001091124570)
