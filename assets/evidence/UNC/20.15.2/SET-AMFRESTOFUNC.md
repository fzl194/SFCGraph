# 设置AMF热备容灾（SET AMFRESTOFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001088248958__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001088248958__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001088248958__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001088248958__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001088248958)

**适用NF：AMF**

该命令用于设置AMF热备容灾功能的运行模式及相关参数。

## [注意事项](#ZH-CN_MMLREF_0000001088248958)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001088248958)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001088248958)
...
## [使用实例](#ZH-CN_MMLREF_0000001088248958)
