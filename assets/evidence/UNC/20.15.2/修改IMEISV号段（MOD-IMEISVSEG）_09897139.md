# 修改IMEISV号段（MOD IMEISVSEG）

- [命令功能](#ZH-CN_CONCEPT_0209897139__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897139__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897139__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897139__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897139__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897139)

**适用NF：PGW-C、SMF**

该命令用于修改指定号段名称的IMEISVSEG号码段，修改之后原来的绑定关系继续存在。

#### [注意事项](#ZH-CN_CONCEPT_0209897139)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897139)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897139)
