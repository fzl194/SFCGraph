# 删除SGW IP（RMV SGWIPTOSGWPOOL）

- [命令功能](#ZH-CN_MMLREF_0231453523__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0231453523__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0231453523__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0231453523__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0231453523)

**适用NF：PGW-C、SGW-C**

该命令用于删除SGW POOL下绑定的SGW IP。假设运营商需要重新规划网络或者不再使用某个SGW IP时，使用该命令。

## [注意事项](#ZH-CN_MMLREF_0231453523)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0231453523)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0231453523)
