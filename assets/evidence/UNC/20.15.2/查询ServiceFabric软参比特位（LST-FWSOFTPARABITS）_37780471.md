# 查询ServiceFabric软参比特位（LST FWSOFTPARABITS）

- [命令功能](#ZH-CN_MMLREF_0000001237780471__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001237780471__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001237780471__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001237780471__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001237780471__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001237780471)

该命令用于查询软件参数，查询结果以二进制形式输出。同时，该命令也支持查询指定软件参数中某个比特位的值。

## [注意事项](#ZH-CN_MMLREF_0000001237780471)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001237780471)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001237780471)
...
## [使用实例](#ZH-CN_MMLREF_0000001237780471)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001237780471)
