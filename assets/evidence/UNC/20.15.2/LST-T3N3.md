# 查询GTP-C T3/N3参数配置(LST T3N3)

- [命令功能](#ZH-CN_MMLREF_0000001172345521__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345521__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345521__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345521__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345521__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345521__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172345521__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345521)

**适用网元：SGSN、MME、AMF**

该命令用来查询GTP路径的T3和N3参数。

#### [注意事项](#ZH-CN_MMLREF_0000001172345521)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345521)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345521)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345521)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345521)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172345521)

请参考 [**SET T3N3**](设置GTP-C T3_N3参数配置(SET T3N3)_26305730.md) 命令的参数标识。
