...
- [命令功能](#ZH-CN_MMLREF_0209652640__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652640__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652640__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652640__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652640)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用来配置对指定APN进行锁定操作。当APN锁定后，后续使用该APN激活的用户激活失败，已经在线的用户无影响。缺省情况下APN未锁定。

## [注意事项](#ZH-CN_MMLREF_0209652640)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652640)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652640)
