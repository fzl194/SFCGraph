# 发送CSDB的软件调试命令(STR DBSFTD)

- [命令功能](#ZH-CN_CONCEPT_0180429701__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0180429701__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0180429701__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0180429701__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0180429701__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0180429701)

该命令为专家维护命令，用于向主机发送软件调试命令。

#### [注意事项](#ZH-CN_CONCEPT_0180429701)

- 该命令需要慎重使用，必须在华为技术支持人员的指导下操作。
- 不同的模块有不同的软调名称，不同的软调名称也有不同的参数，如果软调名称和参数输入不准确，不会出现错误提示。

#### [操作用户权限](#ZH-CN_CONCEPT_0180429701)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0180429701)
