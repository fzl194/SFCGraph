# 查询SDAP本地实体(LST SDAPLE)

- [命令功能](#ZH-CN_MMLREF_0000001172346893__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172346893__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172346893__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172346893__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172346893__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172346893__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172346893__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172346893)

**适用网元：MME**

本命令用于查询SDAP链路本地实体配置数据。

#### [注意事项](#ZH-CN_MMLREF_0000001172346893)

无

#### [本地用户权限](#ZH-CN_MMLREF_0000001172346893)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172346893)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172346893)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172346893)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172346893)

参见 [**ADD SDAPLE**](增加SDAP本地实体(ADD SDAPLE)_26147290.md) 的参数说明。
