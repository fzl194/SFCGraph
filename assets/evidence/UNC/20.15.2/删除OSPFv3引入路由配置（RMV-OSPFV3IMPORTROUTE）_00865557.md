# 删除OSPFv3引入路由配置（RMV OSPFV3IMPORTROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001600865557__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600865557__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600865557__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600865557__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600865557__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600865557)

该命令用来删除引入到OSPFv3域中的外部路由。

#### [注意事项](#ZH-CN_CONCEPT_0000001600865557)

- 该命令执行后立即生效。
- 只有配置了OSPFv3进程和引入外部路由后才能使用该命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600865557)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600865557)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600865557)
