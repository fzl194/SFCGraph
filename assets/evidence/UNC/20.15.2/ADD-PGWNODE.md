# 增加P-GW局向(ADD PGWNODE)

- [命令功能](#ZH-CN_MMLREF_0000001172225387__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225387__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225387__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225387__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225387__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225387__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225387)

**适用网元：SGSN、MME**

该命令用于增加P-GW局向。配置PGW Node Name后缀的列表，只有在列表中的才能开启MME支持基于P-GW Back-off timer的APN级流控功能。

#### [注意事项](#ZH-CN_MMLREF_0000001172225387)

- 该命令执行后立即生效。
- 该命令最大记录数为100。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225387)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225387)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225387)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225387)
