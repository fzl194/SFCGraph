# 查询预留IP资源（LST RESERVEDIP）

- [命令功能](#ZH-CN_CONCEPT_0000001280309656__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001280309656__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001280309656__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001280309656__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001280309656__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001280309656__1.3.6.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001280309656__1.3.7.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001280309656)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001280309656)

- 无。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001280309656)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001280309656)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001280309656)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001280309656)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001280309656)

参见 [**ADD RESERVEDIP**](../../业务配置管理/IP资源/增加IP资源（ADD IPRESOURCE）_51174282.md) 的参数说明。
