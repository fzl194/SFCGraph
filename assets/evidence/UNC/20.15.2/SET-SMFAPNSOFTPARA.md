# 设置SMF的APN软参记录（SET SMFAPNSOFTPARA）

- [命令功能](#ZH-CN_MMLREF_0225121213__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0225121213__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0225121213__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0225121213__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0225121213)

**适用NF：SMF**

该命令用于设置APN下软件参数。

## [注意事项](#ZH-CN_MMLREF_0225121213)

- 该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0225121213)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0225121213)
