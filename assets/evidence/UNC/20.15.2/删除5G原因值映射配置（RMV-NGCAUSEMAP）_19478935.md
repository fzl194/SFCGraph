# 删除5G原因值映射配置（RMV NGCAUSEMAP）

- [命令功能](#ZH-CN_MMLREF_0319478935__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0319478935__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0319478935__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0319478935__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0319478935)

**适用NF：AMF**

该命令用于删除5G原因值映射配置。

## [注意事项](#ZH-CN_MMLREF_0319478935)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0319478935)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0319478935)
...
## [使用实例](#ZH-CN_MMLREF_0319478935)

删除流程类型为初始注册，原始原因值为27的5G原因值映射配置，执行如下命令：

```
RMV NGCAUSEMAP: PROT=INIT_REG, SCAUSE=27;
```
