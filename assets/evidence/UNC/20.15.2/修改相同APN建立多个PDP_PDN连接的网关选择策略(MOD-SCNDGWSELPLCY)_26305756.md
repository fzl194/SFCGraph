# 修改相同APN建立多个PDP/PDN连接的网关选择策略(MOD SCNDGWSELPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001126305756__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305756__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305756__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305756__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305756__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305756__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305756)

**适用网元：SGSN、MME**

该命令用于修改指定用户使用相同APN建立多个PDP/PDN连接场景下，系统选择GGSN/P-GW的策略。

#### [注意事项](#ZH-CN_MMLREF_0000001126305756)

- 该命令执行后只对新激活PDN生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305756)

manage-ug; system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305756)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305756)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305756)
