# 配置ARP系统信息（SET ARPSYS）

- [命令功能](#ZH-CN_CONCEPT_0000001549801498__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801498__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801498__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801498__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801498__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801498)

该命令用于配置系统老化时间、全局ARP严格学习使能、ARP日志告警上报时间间隔和免费ARP发送类型。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801498)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801498)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801498)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801498)
