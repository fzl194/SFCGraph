# 修改NF实例概述信息（MOD NFPROFILE）

- [命令功能](#ZH-CN_MMLREF_0209652236__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652236__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652236__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652236__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652236)

**适用NF：AMF、SMF、NSSF、NRF、NCG、SMSF**

该命令用于修改NF实例的概述信息。对于已向NRF注册过的NF实例，使用该命令修改NF实例的概述信息后，将会触发其向NRF发起更新流程。

## [注意事项](#ZH-CN_MMLREF_0209652236)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652236)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652236)
