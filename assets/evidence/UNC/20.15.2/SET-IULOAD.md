# 设置SGP负荷配置(SET IULOAD)

- [命令功能](#ZH-CN_MMLREF_0000001126305846__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305846__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305846__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305846__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305846__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305846__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305846)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305846)

- 系统初次运行时，会执行系统初始设置值。
- 每个定时器的计量单位是不一样的，包括“分钟”和“秒”两种。
- “IUSHSPT”和“NTMR”需要复位SGP才能生效，其中“IUSHSPT”影响比较大，决定RANAP层是否负荷分担。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305846)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305846)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305846)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305846)
