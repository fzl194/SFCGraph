# 修改虚拟通道映射（MOD VIRTUALCHL）

- [命令功能](#ZH-CN_CONCEPT_0000001985382982__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001985382982__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001985382982__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001985382982__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001985382982__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001985382982__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001985382982)

**适用NF：NCG**

该命令用于修改虚拟通道映射。

#### [注意事项](#ZH-CN_CONCEPT_0000001985382982)

- 该命令执行后立即生效。
- 修改虚拟通道后，本地备份和本地分发的目的路径的旧虚拟通道目录下如果存在文件，不会自动删除，会占用NCG的磁盘空间。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001985382982)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001985382982)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001985382982)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001985382982)
