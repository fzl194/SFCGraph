# 删除本地HSS(RMV LOCALHSS)

- [命令功能](#ZH-CN_MMLREF_0000001172345679__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345679__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345679__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345679__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345679__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345679__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345679)

**适用网元：MME**

该命令用于删除一条本地HSS配置记录，HSS用主机名唯一标识。

#### [注意事项](#ZH-CN_MMLREF_0000001172345679)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345679)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345679)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345679)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345679)
