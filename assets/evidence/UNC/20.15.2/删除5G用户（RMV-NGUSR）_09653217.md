...
- [命令功能](#ZH-CN_MMLREF_0209653217__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653217__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653217__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653217__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653217)

**适用NF：AMF**

该命令用于删除用户的所有信息。需要主动删除用户时，使用此命令删除用户信息。

## [注意事项](#ZH-CN_MMLREF_0209653217)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653217)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653217)
