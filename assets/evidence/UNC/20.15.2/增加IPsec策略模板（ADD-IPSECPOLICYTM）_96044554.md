# 增加IPsec策略模板（ADD IPSECPOLICYTM）

- [命令功能](#ZH-CN_MMLREF_0000001896044554__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001896044554__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001896044554__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001896044554__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001896044554)

![](增加IPsec策略模板（ADD IPSECPOLICYTM）_96044554.assets/notice_3.0-zh-cn_2.png)

增加配置，影响协商及加解密性能。

该命令用于增加IPsec策略模板。

## [注意事项](#ZH-CN_MMLREF_0000001896044554)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001896044554)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001896044554)
...
## [使用实例](#ZH-CN_MMLREF_0000001896044554)
