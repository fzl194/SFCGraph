# 设置P-CSCF组选择模式（SET PCSCFGRPSELECT）

- [命令功能](#ZH-CN_MMLREF_0209651601__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651601__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651601__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651601__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651601)

**适用NF：PGW-C、SMF、GGSN**

该命令用于配置apn或全局绑定的两个p-cscf-group的选择模式。

## [注意事项](#ZH-CN_MMLREF_0209651601)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651601)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651601)
