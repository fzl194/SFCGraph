...
- [命令功能](#ZH-CN_CONCEPT_0129627121__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0129627121__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0129627121__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0129627121__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0129627121__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0129627121__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0129627121)

此命令用于运维人员判断在CSLB转发路径上是否有完整的转发策略。转发路径分为上行和下行，其中上行指数据流从VNRS发往CSLB方向，下行指数据流从服务侧发往CSLB方向。

#### [注意事项](#ZH-CN_CONCEPT_0129627121)

- 该命令执行后立即生效。
- 该命令批量下发可能导致执行超时。

#### [操作用户权限](#ZH-CN_CONCEPT_0129627121)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0129627121)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0129627121)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 服务VNFC ID | CSLB服务的VNFC ID<br>取值范围：0~4294967296 |
| 服务实例ID | 服务实例ID<br>取值范围：0~4294967296 |
| 报文方向 | 报文发送的方向<br>取值范围：<br>- “from Server to CSLB_VNFC ”<br>- “from VNRS to CSLB_VNFC ” |
| IP类型 | IP地址类型<br>取值范围：<br>- “IPV4(IPV4) ”<br>- “IPV6(IPV6) ” |
| 源IPv4 | 源IPv4的地址 |
| 源IPv6 | 源IPv6的地址 |
| 源端口 | 源端口<br>取值范围：0~65536 |
| 目的IPv4 | 目的IPv4地址 |
| 目的IPv6 | 目的IPv6地址 |
| 目的端口号 | 目的端口<br>取值范围：0~65536 |
| 协议类型 | 协议类型 |
| VPN名称 | VPN名称 |
| LB索引 | CSLB的索引号 |
| 结果字符串 | 返回的查询结果 |
