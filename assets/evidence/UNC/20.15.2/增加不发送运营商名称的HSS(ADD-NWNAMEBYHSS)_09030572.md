# 增加不发送运营商名称的HSS(ADD NWNAMEBYHSS)

- [命令功能](#ZH-CN_TOPIC_0000002009030572__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000002009030572__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000002009030572__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000002009030572__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000002009030572__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000002009030572__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000002009030572)

**适用NF：MME**

本命令用于增加不发送运营商名称的HSS。该命令对应的业务功能暂未实现。

#### [注意事项](#ZH-CN_TOPIC_0000002009030572)

- 该命令执行后立即生效。
- 此命令最大记录数为1000。
- 参数LABEL、HOST和REALM不区分大小写，统一转大写存储。

#### [本地用户权限](#ZH-CN_TOPIC_0000002009030572)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_TOPIC_0000002009030572)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000002009030572)
...
#### [使用实例](#ZH-CN_TOPIC_0000002009030572)
