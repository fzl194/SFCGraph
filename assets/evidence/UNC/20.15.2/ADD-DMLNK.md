# 增加Diameter链路配置(ADD DMLNK)

- [命令功能](#ZH-CN_MMLREF_0000001172225953__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225953__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225953__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225953__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225953__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225953__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225953)

**适用网元：SGSN、MME**

该命令用于增加一条Diameter链路。Diameter链路是MME与HSS、EIR或DRA之间的链路。

#### [注意事项](#ZH-CN_MMLREF_0000001172225953)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225953)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225953)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225953)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225953)
