# 查询归属地PGW-C IP地址（LST HOMEPGWIP）

- [命令功能](#ZH-CN_MMLREF_0306399912__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399912__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399912__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399912__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0306399912__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0306399912)

**适用NF：SGW-C**

该命令用于Proxy S-GW特性中查询用户指定的归属地PGW-C的IP地址。

## [注意事项](#ZH-CN_MMLREF_0306399912)

无

#### [操作用户权限](#ZH-CN_MMLREF_0306399912)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399912)
...
## [输出结果说明](#ZH-CN_MMLREF_0306399912)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 用户范围 | 该参数用于指定用户范围。 |
| 前缀 | 该参数用于指定用户号码前缀。当参数SUBRANGE为"IMSI_PRE"时，本参数表示IMSI号码前缀，当参数SUBRANGE为"MSISDN_PRE"时，本参数表示MSISDN号码前缀。使用时按照最长匹配进行查询。 |
| IP地址版本类型 | 该参数用于指定归属地PGW的IP地址类型。 |
| IPv4地址 | 该参数用于指定归属地PGW的IPv4地址。 |
| IPv6地址 | 该参数用于指定归属地PGW的IPv6地址。 |
| 描述信息 | 该参数用于指定本记录的描述信息。 |
