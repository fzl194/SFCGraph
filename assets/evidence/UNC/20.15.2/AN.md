...
- [命令功能](#ZH-CN_MMLREF_0209653159__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653159__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653159__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653159__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653159)
...
## [注意事项](#ZH-CN_MMLREF_0209653159)

- 该命令执行后立即生效。

- NG-RAN收到AMF的RESET消息后将立即释放相关UE的NG连接和UU连接资源，造成用户业务中断，故本命令应在充分评估影响后执行。

#### [操作用户权限](#ZH-CN_MMLREF_0209653159)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653159)
