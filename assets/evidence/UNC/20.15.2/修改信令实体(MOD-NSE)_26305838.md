...
- [命令功能](#ZH-CN_MMLREF_0000001126305838__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305838__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305838__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305838__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305838__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305838__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305838)

**适用网元：SGSN**

该命令用于修改NSE网络服务实体参数。信令实体分别位于BSS侧和SGSN侧，用于提供GB接口操作所需的网络管理功能。请参考3GPP TS 48.016。

#### [注意事项](#ZH-CN_MMLREF_0000001126305838)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305838)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305838)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305838)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305838)
