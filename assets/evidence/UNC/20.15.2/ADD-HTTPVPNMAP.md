# 增加HTTP VPN映射关系（ADD HTTPVPNMAP）

- [命令功能](#ZH-CN_MMLREF_0000001846111673__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001846111673__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001846111673__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001846111673__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001846111673)

该命令用于增加HTTP对端地址与本端VPN的映射关系。当使用多VPN组网，基于对端地址选择本端VPN和IP地址时，需要使用该命令配置对端地址与本端VPN的映射关系。

## [注意事项](#ZH-CN_MMLREF_0000001846111673)

- 该命令执行后立即生效。

- 最多可输入512条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001846111673)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001846111673)
...
## [使用实例](#ZH-CN_MMLREF_0000001846111673)
