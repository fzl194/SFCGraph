# 增加AMF集与切片的关系（ADD AMFSETID）

- [命令功能](#ZH-CN_MMLREF_0209651530__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651530__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651530__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651530__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651530)

**适用NF：NSSF**

该命令用于增加指定AMF集所支持的S-NSSAI。AMF向NSSF发送请求，要求返回一个目标AMF集，而候选AMF是通过在本地查询S-NSSAI支持的AMF集合配置表获取到的。运营商通过该命令，可以增加AMF集所支持的S-NSSAI。

## [注意事项](#ZH-CN_MMLREF_0209651530)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651530)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651530)
