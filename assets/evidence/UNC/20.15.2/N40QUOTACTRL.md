# 设置N40接口配额的控制参数（SET N40QUOTACTRL）

- [命令功能](#ZH-CN_MMLREF_0296805505__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296805505__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296805505__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296805505__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296805505)

**适用NF：PGW-C、SMF**

该命令用来控制N40接口配额的控制参数。

## [注意事项](#ZH-CN_MMLREF_0296805505)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296805505)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296805505)
