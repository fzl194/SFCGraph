# 设置NRF日志流控参数（SET NRFLOGFCPARA）

- [命令功能](#ZH-CN_MMLREF_0000001238302735__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001238302735__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001238302735__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001238302735__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001238302735)

**适用NF：NRF**

该命令用于设置是否对NRF打印的日志进行流控以及对应的流控参数。

## [注意事项](#ZH-CN_MMLREF_0000001238302735)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001238302735)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001238302735)
...
## [使用实例](#ZH-CN_MMLREF_0000001238302735)
