...
- [命令功能](#ZH-CN_CONCEPT_0000001549961222__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961222__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961222__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961222__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961222__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961222)

该命令用于手工配置接口的IPv6地址。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961222)

- 该命令执行后立即生效。
- 该命令最大记录数为65535。
- 该命令可以在VNRS_VNFC的Ethernet接口，Ethernet子接口，Eth-Trunk接口，Eth-Trunk子接口以及Loopback口，Tunnel口上配置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961222)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961222)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961222)
