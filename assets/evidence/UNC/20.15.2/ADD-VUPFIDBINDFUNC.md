# 增加虚拟UPF实例标识绑定的功能（ADD VUPFIDBINDFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001308199834__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001308199834__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001308199834__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001308199834__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001308199834)
...
## [注意事项](#ZH-CN_MMLREF_0000001308199834)

- 该命令执行后立即生效。

- 最多可输入20480条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001308199834)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001308199834)
...
## [使用实例](#ZH-CN_MMLREF_0000001308199834)
