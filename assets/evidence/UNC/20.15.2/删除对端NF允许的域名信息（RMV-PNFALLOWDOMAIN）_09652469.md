# 删除对端NF允许的域名信息（RMV PNFALLOWDOMAIN）

- [命令功能](#ZH-CN_MMLREF_0209652469__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652469__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652469__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652469__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652469)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于删除对端NF服务支持的允许访问的域名。

## [注意事项](#ZH-CN_MMLREF_0209652469)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652469)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652469)
...
## [使用实例](#ZH-CN_MMLREF_0209652469)

删除对端NF支持的域名信息，NF实例标识为SMF_Instance_0，服务实例标识为Service_Instance_0，NFDOMAIN为huawei.com。

```
RMV PNFALLOWDOMAIN: NFINSTANCEID="SMF_Instance_0", SRVINSTANCEID="Service_Instance_0", NFDOMAIN="huawei.com";
```
