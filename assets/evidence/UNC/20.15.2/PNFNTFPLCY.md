# 设置对端网元的通知抑制时间（SET PNFNTFPLCY）

- [命令功能](#ZH-CN_MMLREF_0296243197__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243197__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243197__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243197__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243197)

**适用NF：AMF、SMF、SMSF**

对端NF状态频繁变更时，本端NF不需要频繁感知并处理，本命令用于抑制向本端NF通知对端NF状态变化的频率，配置通知对端NF状态变化的抑制时间。

## [注意事项](#ZH-CN_MMLREF_0296243197)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243197)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243197)
