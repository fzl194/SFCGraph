# 创建OSPF引入路由配置（ADD OSPFIMPORTROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001600601057__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600601057__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600601057__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600601057__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600601057__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600601057)

该命令用来将外部路由引入到OSPF域中，并在OSPF域中发布引入的路由信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600601057)

- 该命令执行后立即生效。
- 该命令最大记录数为8000。
- 只有执行ADD OSPF配置了OSPF进程才能使用此命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600601057)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600601057)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600601057)
