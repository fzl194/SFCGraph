# 删除对端端点配置(RMV GBIPRMTENDPT)

- [命令功能](#ZH-CN_MMLREF_0000001172345613__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345613__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345613__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345613__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345613__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345613__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345613)

**适用网元：SGSN**

该命令用来删除一条Gb接口对端IP端点权重记录或者一个NSE下所有的对端端点记录。对端端点表用来配置对端IP端点的数据权重和信令权重，在IP网络NSVC链路负荷分担时根据数据权重或者信令权重来选择对端IP端点。

#### [注意事项](#ZH-CN_MMLREF_0000001172345613)

- 该命令执行立即生效。
- 删除对端端点配置后该对端端点对应的链路也自动删除，业务会切换到其它可用的链路上，对业务无影响，但会增加其它链路的负担，请谨慎操作。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345613)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345613)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345613)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345613)
