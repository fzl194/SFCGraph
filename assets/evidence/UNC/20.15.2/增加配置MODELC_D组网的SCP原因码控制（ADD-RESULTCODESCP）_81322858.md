# 增加配置MODELC/D组网的SCP原因码控制（ADD RESULTCODESCP）

- [命令功能](#ZH-CN_MMLREF_0000002181322858__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002181322858__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002181322858__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002181322858__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002181322858)

**适用NF：SMF、PGW-C、GGSN**

此命令用来配置当UNC收到指定组网场景结果码信息后执行何种操作。例如关闭PCC功能、执行缺省动作、执行宕机备份等。

## [注意事项](#ZH-CN_MMLREF_0000002181322858)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000002181322858)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002181322858)
...
## [使用实例](#ZH-CN_MMLREF_0000002181322858)
