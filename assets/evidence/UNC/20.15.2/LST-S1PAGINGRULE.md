# 查询S1寻呼规则(LST S1PAGINGRULE)

- [命令功能](#ZH-CN_MMLREF_0000001172225927__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225927__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225927__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225927__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225927__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225927__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172225927__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225927)

**适用网元：MME**

此命令用于查询系统中全部或者指定条件的S1寻呼规则。查询结果按 “匹配优先级” 排序后显示。

#### [注意事项](#ZH-CN_MMLREF_0000001172225927)

- 此命令执行后立即生效。
- 当不指定任何条件时，表示查询系统中所有的S1寻呼规则；否则按照输入的条件查询指定的S1寻呼规则。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225927)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225927)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225927)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225927)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172225927)

请参考 [**ADD S1PAGINGRULE**](增加S1寻呼规则(ADD S1PAGINGRULE)_26306058.md) 命令的参数标识。
