# 设置RADIUS计费服务器组的私有扩展属性（SET RDSACCTREQVSA）

- [命令功能](#ZH-CN_CONCEPT_0209896787__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896787__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896787__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896787__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896787__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896787)

**适用NF：PGW-C、SMF**

该命令用来新增指定RADIUS服务器组的RADIUS计费3gpp和3gpp2私有扩展属性的配置，用来控制RADIUS计费消息中携带哪些3gpp和3gpp2私有扩展属性的字段。

#### [注意事项](#ZH-CN_CONCEPT_0209896787)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896787)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896787)
