# 增加MME POOL（ADD MMEPOOL）

- [命令功能](#ZH-CN_MMLREF_0231453510__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0231453510__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0231453510__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0231453510__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0231453510)

**适用NF：SGW-C、PGW-C**

该命令用于添加MME POOL。当SGWPOOLNAME参数有输入时，表示添加MME POOL，并把该SGW POOL绑定至添加的MME POOL下。

## [注意事项](#ZH-CN_MMLREF_0231453510)

- 该命令执行后立即生效。

- 最多可输入20条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0231453510)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0231453510)
