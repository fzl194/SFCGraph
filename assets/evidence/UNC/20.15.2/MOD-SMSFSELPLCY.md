# 修改SMSF选择策略（MOD SMSFSELPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001291819425__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001291819425__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001291819425__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001291819425__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001291819425)

**适用NF：AMF**

该命令用于对指定的用户（群）修改SMSF的选择策略。

## [注意事项](#ZH-CN_MMLREF_0000001291819425)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001291819425)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001291819425)
...
## [使用实例](#ZH-CN_MMLREF_0000001291819425)
