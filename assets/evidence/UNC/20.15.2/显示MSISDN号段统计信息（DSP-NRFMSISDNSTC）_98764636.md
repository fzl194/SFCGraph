# 显示MSISDN号段统计信息（DSP NRFMSISDNSTC）

- [命令功能](#ZH-CN_MMLREF_0000001098764636__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001098764636__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001098764636__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001098764636__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001098764636__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001098764636)

**适用NF：NRF**

该命令用于显示MSISDN号段统计信息。若查询NF类型对应号段总数，请选择查询类型为“TOTALNUM”；若查询“NF组标识”细分的号段数统计，请选择查询类型为“NFGROUPNUM”。

## [注意事项](#ZH-CN_MMLREF_0000001098764636)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001098764636)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001098764636)
...
## [使用实例](#ZH-CN_MMLREF_0000001098764636)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001098764636)

| 输出项名称 | 输出项解释 |
| --- | --- |
| NF类型 | 该参数用于表示待查询MSISDN号段统计信息的NF类型。<br>取值说明：<br>- PCF（PCF）<br>- UDM（UDM）<br>- UDR（UDR）<br>- CHF（CHF）<br>- CUSTOM_OCS（CUSTOM_OCS） |
| 号段数 | 该参数用于表示MSISDN号段的个数。 |
| NF组标识 | 该参数用于表示MSISDN号段配置的NF组标识，可以通过LST NFGROUP进行查询，支持MSISDN号段配置的NF类型仅包含PCF、UDM、UDR、CHF、CUSTOM_OCS。 |
