# 设置基于位置区地址分配的开关（SET IPALLOCBYLOCSW）

- [命令功能](#ZH-CN_MMLREF_0249644934__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0249644934__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0249644934__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0249644934__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0249644934)

**适用NF：PGW-C、GGSN、SMF**

该命令用于设置基于位置区地址分配开关。

## [注意事项](#ZH-CN_MMLREF_0249644934)

- 该命令执行后立即生效。

- “开关”为“INHERIT”时，按照基于位置区组地址分配的全局开关的配置进行地址分配，不为“INHERIT”时，按照基于位置区组地址分配的开关配置进行地址分配。

#### [操作用户权限](#ZH-CN_MMLREF_0249644934)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0249644934)
