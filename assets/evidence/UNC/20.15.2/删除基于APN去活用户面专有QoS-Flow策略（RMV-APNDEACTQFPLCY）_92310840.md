# 删除基于APN去活用户面专有QoS Flow策略（RMV APNDEACTQFPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001092310840__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001092310840__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001092310840__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001092310840__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001092310840)

**适用NF：SMF**

该命令用于删除基于APN去活用户面专有GBR类型QoS Flow策略。

## [注意事项](#ZH-CN_MMLREF_0000001092310840)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001092310840)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001092310840)
...
## [使用实例](#ZH-CN_MMLREF_0000001092310840)

当需要删除ims APN的SMF收到AMF发起的用户面去活请求携带原因值“radio-connection-with-ue-lost”时能够延迟释放专有QoS Flow规则时，执行如下命令：

```
RMV APNDEACTQFPLCY: APN="ims", NGAPCAUSEGROUP=RADIO_NETWORK, NGAPCAUSEVALUE=21;
```
