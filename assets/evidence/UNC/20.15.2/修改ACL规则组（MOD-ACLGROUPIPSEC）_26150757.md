# 修改ACL规则组（MOD ACLGROUPIPSEC）

- [命令功能](#ZH-CN_MMLREF_0000001226150757__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001226150757__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001226150757__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001226150757__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001226150757)

该命令用于修改ACL规则组的配置，可以修改规则组的步长，以及规则组描述信息。

## [注意事项](#ZH-CN_MMLREF_0000001226150757)

- 该命令执行后立即生效。

- 执行该命令前，需要提前配置[**ADD ACLGROUPIPSEC**](增加ACL规则组（ADD ACLGROUPIPSEC）_26150747.md)命令添加ACL规则组。

#### [操作用户权限](#ZH-CN_MMLREF_0000001226150757)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001226150757)
...
## [使用实例](#ZH-CN_MMLREF_0000001226150757)
