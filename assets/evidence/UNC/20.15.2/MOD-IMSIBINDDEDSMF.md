# 修改拨测用户和专网SMF的绑定关系（MOD IMSIBINDDEDSMF）

- [命令功能](#ZH-CN_MMLREF_0000001625477038__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001625477038__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001625477038__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001625477038__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001625477038)

**适用NF：SMF、PGW-C**

该命令用于修改用户和专网SMF的绑定关系，该命令执行后，如果用户未激活，用户激活后会选择该绑定的SMF，如果用户已激活，则继续使用原SMF，如果想要选择该绑定的SMF，需要将该用户去激活以后重新激活。

## [注意事项](#ZH-CN_MMLREF_0000001625477038)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001625477038)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001625477038)
...
## [使用实例](#ZH-CN_MMLREF_0000001625477038)
