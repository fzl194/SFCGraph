# 删除eNodeB群组成员(RMV ENBGPMEM)

- [命令功能](#ZH-CN_MMLREF_0000001126305420__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305420__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305420__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305420__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305420__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305420__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305420)

**适用网元：MME**

该命令用于删除eNodeB群组成员记录。

#### [注意事项](#ZH-CN_MMLREF_0000001126305420)

- 此命令执行后立即生效。
- 此命令执行后起始eNodeB标识对应的一组记录都将被删除。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305420)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305420)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305420)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305420)
