# 增加SBC MME实体(ADD SBCMME)

- [命令功能](#ZH-CN_CONCEPT_0000002148075261__1.4.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000002148075261__1.4.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000002148075261__1.4.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000002148075261__1.4.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000002148075261__1.4.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000002148075261__1.4.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000002148075261)

**适用网元：CBCF**

此命令用于增加SBC MME实体配置。

#### [注意事项](#ZH-CN_CONCEPT_0000002148075261)

- 该命令执行后立即生效。
- 该表最大记录数为128。
- 每个SBC MME最多可以配置8个IP。

#### [本地用户权限](#ZH-CN_CONCEPT_0000002148075261)

manage-ug;system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000002148075261)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000002148075261)
...
#### [使用实例](#ZH-CN_CONCEPT_0000002148075261)
