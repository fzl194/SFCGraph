# 修改5QI到QCI的映射（MOD QOS5QI2QCIMAP）

- [命令功能](#ZH-CN_MMLREF_0000001339800061__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001339800061__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001339800061__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001339800061__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001339800061)

**适用NF：PGW-C、SMF、GGSN**

该命令用来修改5QI到标准QCI的映射关系。

## [注意事项](#ZH-CN_MMLREF_0000001339800061)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001339800061)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001339800061)
...
## [使用实例](#ZH-CN_MMLREF_0000001339800061)
