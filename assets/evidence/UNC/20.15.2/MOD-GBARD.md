# 修改Gb模式接入限制参数(MOD GBARD)

- [命令功能](#ZH-CN_MMLREF_0000001126145474__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145474__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145474__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145474__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145474__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145474__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145474)

**适用网元：SGSN**

该命令用于修改Gb模式接入限制参数。该命令先根据IMSI号段将用户进行分类，再对每一类用户按照用户使用的卡类型（SIM/USIM）、签约的ARD信息、签约的APN信息进行区分而控制用户接入GERAN网络。

#### [注意事项](#ZH-CN_MMLREF_0000001126145474)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126145474)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145474)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145474)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145474)
