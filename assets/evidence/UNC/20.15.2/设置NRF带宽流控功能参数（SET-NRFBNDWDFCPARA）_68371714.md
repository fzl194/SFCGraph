# 设置NRF带宽流控功能参数（SET NRFBNDWDFCPARA）

- [命令功能](#ZH-CN_MMLREF_0000001568371714__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001568371714__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001568371714__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001568371714__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001568371714)

**适用NF：NRF**

该命令用于设置NRF带宽流控功能开关和相关阈值配置，在SCP&NRF融合部署场景下，当NRF收到SCP服务发现请求过多导致带宽不足时，可配置此命令防止网络带宽不足引起的业务失败。

## [注意事项](#ZH-CN_MMLREF_0000001568371714)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001568371714)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001568371714)
...
## [使用实例](#ZH-CN_MMLREF_0000001568371714)
