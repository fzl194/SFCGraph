# 修改Diameter链路集配置(MOD DMLKS)

- [命令功能](#ZH-CN_MMLREF_0000001172345879__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345879__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345879__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345879__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345879__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345879__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345879)

**适用网元：SGSN、MME**

该命令用于修改一条Diameter链路集配置。当需要修改Diameter链路集的 “本地实体索引” ， “对端实体索引” ， “选路模式” 和 “链路集名称” 的全部或部分信息时，用此命令进行修改。

#### [注意事项](#ZH-CN_MMLREF_0000001172345879)

- 该命令执行后立即生效。
- 该命令不能修改Diameter链路集索引。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345879)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345879)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345879)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345879)
