# 增加对鉴权信元用户名和密码的控制（ADD AUTHNAMEPWDCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001823622902__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001823622902__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001823622902__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001823622902__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001823622902)

**适用NF：PGW-C、SMF、GGSN**

该命令用于增加对鉴权信元用户名和密码的控制。

## [注意事项](#ZH-CN_MMLREF_0000001823622902)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001823622902)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001823622902)
...
## [使用实例](#ZH-CN_MMLREF_0000001823622902)
