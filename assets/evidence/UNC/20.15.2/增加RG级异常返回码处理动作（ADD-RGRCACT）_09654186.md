...
- [命令功能](#ZH-CN_MMLREF_0209654186__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654186__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654186__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654186__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654186)

**适用NF：PGW-C、SMF**

该命令用于增加RG级异常返回码的处理动作配置。当CHF返回的Charging Data Response消息携带RG级异常返回码时，根据此配置进行处理。

## [注意事项](#ZH-CN_MMLREF_0209654186)
...
| CCTMPLTNAME | RCCODE | RCACT | BLKTIMER | RDVIRTIP | RDVIRTIPV6 | REACTREQ | HOLDINGTIME |
| --- | --- | --- | --- | --- | --- | --- | --- |
| global | DEFAULT | BLCK_TRG_RPT | 0 | 0.0.0.0 | 0000:0000:0000:0000:0000:0000:0000:0000 | DISABLE | 0 |

#### [操作用户权限](#ZH-CN_MMLREF_0209654186)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654186)
...
## [使用实例](#ZH-CN_MMLREF_0209654186)

如果希望CHF返回RG级异常返回码“SERVICEDENIED”时，去活PDU会话，可以在全局融合计费模板中配置RG级异常返回码“SERVICEDENIED”的动作为TERMINATE：
