# 修改IMSI和MSISDN号段（MOD IMSIMSISDNSEG）

- [命令功能](#ZH-CN_CONCEPT_0209897129__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897129__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897129__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897129__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897129__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897129)

**适用NF：PGW-C、SMF**

该命令用于修改配置IMSI/MSISDN号码段。

#### [注意事项](#ZH-CN_CONCEPT_0209897129)

- 该命令执行后立即生效。
- 如果记录已被ADD L2RULEGRPBIND命令引用，则不允许将SegmentType修改为MSISDN和MSISDNWILDCARD，否则修改失败。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897129)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897129)
