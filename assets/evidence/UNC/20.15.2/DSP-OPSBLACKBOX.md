# 显示开放可编程系统的维护信息（DSP OPSBLACKBOX）

- [命令功能](#ZH-CN_CONCEPT_0000001550281102__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281102__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281102__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281102__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281102__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001550281102__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281102)

该命令用于显示开放编程系统的维护信息。当python脚本执行失败时，可以通该命令查询系统维护信息。

维护信息包含python虚拟机、助手状态机、脚本状态机和开放可编程接口的信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281102)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281102)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281102)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281102)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001550281102)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 输出字符串 | OPS记录的python虚拟机、助手状态机、脚本状态机和开放可编程接口的维护信息。 |
