# 增加APNNI Direct Tunnel配置(ADD APNNIDT)

- [命令功能](#ZH-CN_MMLREF_0000001172345645__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345645__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345645__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345645__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345645__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345645__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345645)

**适用网元：SGSN**

此命令用于增加APNNI DT属性信息表中的某个APNNI的DT属性记录，用于设置指定APNNI的用户或所有用户是否支持DT。

#### [注意事项](#ZH-CN_MMLREF_0000001172345645)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345645)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345645)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345645)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345645)
