# 激活静态链路（ACT SBISTATICLINK）

- [命令功能](#ZH-CN_MMLREF_0000001228971833__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001228971833__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001228971833__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001228971833__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001228971833)

该命令用于激活指定本端和对端实例之间的全部静态链路。执行本命令时，指定的本端和对端实例之间的静态链路已预先配置。

## [注意事项](#ZH-CN_MMLREF_0000001228971833)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001228971833)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001228971833)
...
## [使用实例](#ZH-CN_MMLREF_0000001228971833)
