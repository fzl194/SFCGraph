# 查询Gb模式用户漫游限制列表(LST GBSUBRRLST)

- [命令功能](#ZH-CN_MMLREF_0000001126145548__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145548__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145548__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145548__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145548__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145548__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126145548__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145548)

**适用网元：SGSN**

该命令用于查询Gb模式用户漫游限制列表。

#### [注意事项](#ZH-CN_MMLREF_0000001126145548)

无。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145548)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145548)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145548)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145548)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126145548)

参见 [**ADD GBSUBRRLST**](增加Gb模式用户漫游限制列表(ADD GBSUBRRLST)_72225227.md) 的参数说明。
