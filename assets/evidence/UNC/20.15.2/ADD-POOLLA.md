# 增加POOL LA配置信息（ADD POOLLA）

- [命令功能](#ZH-CN_MMLREF_0000001172225783__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225783__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225783__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225783__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225783__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225783__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225783)

**适用网元：SGSN、MME**

此命令用于增加Pool区域LAC值，或TAI与LAC的对应关系。

#### [注意事项](#ZH-CN_MMLREF_0000001172225783)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225783)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225783)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225783)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225783)
