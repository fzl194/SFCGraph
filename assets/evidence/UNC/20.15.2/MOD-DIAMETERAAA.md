# 修改Diameter AAA服务器（MOD DIAMETERAAA）

- [命令功能](#ZH-CN_MMLREF_0264343897__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0264343897__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0264343897__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0264343897__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0264343897)

**适用NF：PGW-C**

此命令用于修改Diameter AAA服务器信息，包括VPN实例。当网络重新规划，需要修改Diameter AAA的VPN信息时，需要执行该命令。

## [注意事项](#ZH-CN_MMLREF_0264343897)
...
#### [操作用户权限](#ZH-CN_MMLREF_0264343897)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0264343897)
