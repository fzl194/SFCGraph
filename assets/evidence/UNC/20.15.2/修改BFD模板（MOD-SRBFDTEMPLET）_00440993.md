# 修改BFD模板（MOD SRBFDTEMPLET）

- [命令功能](#ZH-CN_CONCEPT_0000001600440993__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440993__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440993__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440993__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440993__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440993)

该命令用于修改BFD模板。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440993)

- 该命令执行后立即生效。
- 修改该BFD模板时，要保证该模板添加过。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440993)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440993)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440993)
