# 修改对端NF的TAI范围（MOD PNFTAIRANGE）

- [命令功能](#ZH-CN_MMLREF_0209651786__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651786__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651786__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651786__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651786)

**适用NF：AMF、SMF、NSSF、SMSF、NCG、PGW-C、SGW-C**

该命令用于修改本地配置的对端NF实例支持的TAI范围信息。

## [注意事项](#ZH-CN_MMLREF_0209651786)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209651786)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651786)
