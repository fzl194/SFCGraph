# 修改NF订阅条件（MOD SUBCONDITION）

- [命令功能](#ZH-CN_MMLREF_0209652286__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652286__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652286__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652286__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652286)

**适用NF：AMF、SMF、NRF、NSSF、SMSF、NCG**

该命令用于修改订阅的目标NF类型的订阅条件等信息。

## [注意事项](#ZH-CN_MMLREF_0209652286)

- 该命令执行后立即生效。

- 该命令只修改订阅条件，对于已经生成的订阅无法生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652286)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652286)
