# 设置MSS表项开关过滤规则（SET MSSTBMFILTER）

- [命令功能](#ZH-CN_CONCEPT_0000001550281626__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281626__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281626__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281626__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281626__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281626)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001550281626)

- 该命令执行后立即生效。
- 本命令用于开启TBM过滤规则开关，开启后会降低性能。开关将在2小时后自动关闭。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281626)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281626)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281626)
