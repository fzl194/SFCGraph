# 修改FQDN端口策略（MOD SBIFQDNPORTPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001378027902__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001378027902__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001378027902__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001378027902__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001378027902)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于修改FQDN使用端口号的策略。

## [注意事项](#ZH-CN_MMLREF_0000001378027902)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001378027902)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001378027902)
...
## [使用实例](#ZH-CN_MMLREF_0000001378027902)
