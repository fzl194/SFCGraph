# 修改代理IMSI/MSISDN号段（MOD PRIMSIMSISDNSEG）

- [命令功能](#ZH-CN_MMLREF_0000001188613385__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001188613385__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001188613385__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001188613385__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001188613385)

**适用NF：PGW-C、GGSN、SGW-C、SMF**

该命令用于修改代理IMSI/MSISDN号段。

## [注意事项](#ZH-CN_MMLREF_0000001188613385)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001188613385)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001188613385)
...
## [使用实例](#ZH-CN_MMLREF_0000001188613385)

修改“IMSI/MSISDN号段名称”为“imsi1”的代理IMSI/MSISDN号段配置的“号段结束字符串”为“470000000000000”：

```
MOD PRIMSIMSISDNSEG: SEGMENTNAME="imsi1", SEGMENTTYPE=IMSI, SEGSTART="460000000000000", SEGEND="470000000000000";
```
