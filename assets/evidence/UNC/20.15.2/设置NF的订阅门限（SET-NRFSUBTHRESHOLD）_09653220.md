# 设置NF的订阅门限（SET NRFSUBTHRESHOLD）

- [命令功能](#ZH-CN_MMLREF_0209653220__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653220__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653220__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653220__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653220)

**适用NF：NRF**

该命令用于设置NF的订阅个数上限，通过IP区分订阅者，每个订阅者同时订阅的个数不能超过设置的个数上限。

## [注意事项](#ZH-CN_MMLREF_0209653220)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653220)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653220)
