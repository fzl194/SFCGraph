# 修改TA List寻呼策略配置(MOD TALSTPAGINGPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001172345863__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345863__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345863__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345863__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345863__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345863__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345863)

**适用网元：MME**

该命令用于修改基于TA List的寻呼策略配置数据。

#### [注意事项](#ZH-CN_MMLREF_0000001172345863)

- 该命令执行后立即生效。
- 通过该命令关闭指定TA List的LTE精准寻呼后，扩大了寻呼范围，可能增加eNodeB的寻呼负荷。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345863)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345863)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345863)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345863)
