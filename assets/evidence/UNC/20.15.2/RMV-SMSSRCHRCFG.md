# 删除SMS小范围CHR上报规则配置（RMV SMSSRCHRCFG）

- [命令功能](#ZH-CN_MMLREF_0000001404041277__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001404041277__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001404041277__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001404041277__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001404041277)

**适用NF：SMSF**

该命令用于删除SMS小范围CHR上报规则配置。

## [注意事项](#ZH-CN_MMLREF_0000001404041277)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001404041277)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001404041277)
...
## [使用实例](#ZH-CN_MMLREF_0000001404041277)
