# 修改基于apn的Gy接口重用字段的填写方式（MOD APNGY5GREUSEAVP）

- [命令功能](#ZH-CN_MMLREF_0000001823622970__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001823622970__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001823622970__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001823622970__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001823622970)

**适用NF：PGW-C**

该命令用于修改指定APN 5G用户接入时，Gy接口重用字段的填写方式。

## [注意事项](#ZH-CN_MMLREF_0000001823622970)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001823622970)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001823622970)
...
## [使用实例](#ZH-CN_MMLREF_0000001823622970)
