# 修改引入路由聚合配置（MOD OSPFASBRSUMMARY）

- [命令功能](#ZH-CN_CONCEPT_0000001550281810__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281810__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281810__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281810__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281810__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281810)

该命令用于修改自治系统边界路由器ASBR对OSPF引入的路由进行路由聚合配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281810)

- 该命令执行后立即生效。
- 只有在配置了OSPF进程后才能使用此命令。
- 当有大量聚合路由时，可以配置DISTRDELAYINTV 参数设置延迟发布聚合路由的时间，使每次发布的聚合路由信息中包含更多的有效路由，避免网络振荡而出现路由信息不准确的现象。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281810)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281810)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281810)
