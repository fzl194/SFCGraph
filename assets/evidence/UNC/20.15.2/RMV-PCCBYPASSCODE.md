# 删除PCC故障场景维持BYPASS状态码配置（RMV PCCBYPASSCODE）

- [命令功能](#ZH-CN_MMLREF_0000002218689757__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002218689757__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002218689757__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002218689757__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002218689757)

**适用NF：PGW-C、SMF、GGSN**

该命令用于删除PCRF/PCF Bypass故障状态码配置。

## [注意事项](#ZH-CN_MMLREF_0000002218689757)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000002218689757)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002218689757)
...
## [使用实例](#ZH-CN_MMLREF_0000002218689757)
