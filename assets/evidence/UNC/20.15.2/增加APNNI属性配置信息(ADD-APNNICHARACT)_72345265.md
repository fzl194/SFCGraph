# 增加APNNI属性配置信息(ADD APNNICHARACT)

- [命令功能](#ZH-CN_MMLREF_0000001172345265__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345265__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345265__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345265__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345265__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345265__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345265)

**适用网元：SGSN、MME**

该命令用于配置在非活动用户（指已附着，但不进行业务活动的用户）分离流程中需要进行特殊处理的APN。它主要实现了在非活动用户分离流程中，“基于APN的保护”与“基于APN配置定时器”的功能。

#### [注意事项](#ZH-CN_MMLREF_0000001172345265)

- 该命令执行后立即生效。
- 该命令最大记录数为100。
- 每条记录中的APN NI字段不能重复。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345265)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345265)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345265)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345265)
