...
- [命令功能](#ZH-CN_MMLREF_0000001126145446__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145446__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145446__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145446__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145446__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145446__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145446)

**适用网元：MME**

该命令用于增加系统的预留功能策略，配置允许哪些用户和终端使用预留功能。

#### [注意事项](#ZH-CN_MMLREF_0000001126145446)

- 此命令最大记录数为1024。
- 该命令相关的预留功能系统还未实现，请勿配置，避免系统升级支持预留功能后，造成非预期结果。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145446)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145446)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145446)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145446)
