# 增加对端GMLC的信息（ADD PNFGMLCINFO）

- [命令功能](#ZH-CN_MMLREF_0000001102910210__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001102910210__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001102910210__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001102910210__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001102910210)

**适用NF：AMF**

该命令用于增加本地配置的对端GMLC支持的外部客户端类型。该命令用于在网络中没有部署NRF，或对端NF没有注册到NRF，或网络中存在NRF但需基于运营商策略本地配置周边NF的场景下，配置对端NF实例相关的信息。

## [注意事项](#ZH-CN_MMLREF_0000001102910210)

- 该命令执行后立即生效。

- 最多可输入100条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001102910210)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001102910210)
...
## [使用实例](#ZH-CN_MMLREF_0000001102910210)
