# 设置智能用户功能（SET SMARTCFG）

- [命令功能](#ZH-CN_MMLREF_0000001126145750__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145750__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145750__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145750__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145750__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145750__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145750)

**适用网元：SGSN**

此命令可以设置SMART用户功能，包括是否开启智能用户识别功能、设置识别SMART用户的Service Request门限、SMART用户是否禁止启用Direct Tunnel功能和SMART用户是否禁止启用去活非活动PDP功能。

#### [注意事项](#ZH-CN_MMLREF_0000001126145750)

- 系统初次运行时，会执行系统初始设置值。
- 此命令执行后立即生效。
- "WSFD-206005Smartphone控制基础功能"为可选特性，需要加载支持该特性的License，对应的License项为“Smartphone控制基础功能”。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145750)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145750)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145750)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145750)
