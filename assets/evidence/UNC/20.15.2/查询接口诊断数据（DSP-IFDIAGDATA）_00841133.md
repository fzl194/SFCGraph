# 查询接口诊断数据（DSP IFDIAGDATA）

- [命令功能](#ZH-CN_CONCEPT_0000001600841133__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841133__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841133__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841133__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841133__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600841133__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841133)

该命令用于查询IFM诊断数据信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841133)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841133)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841133)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841133)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600841133)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 查询结果数据 | 用来显示IFM的查询结果数据。 |
