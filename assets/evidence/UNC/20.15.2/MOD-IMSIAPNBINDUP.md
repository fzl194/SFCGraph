# 修改APN下用户和UPF的绑定关系配置（MOD IMSIAPNBINDUP）

- [命令功能](#ZH-CN_MMLREF_0000001921861977__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001921861977__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001921861977__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001921861977__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001921861977)

**适用NF：SMF、PGW-C、SGW-C、GGSN**

该命令用于修改APN下用户和UPF的绑定关系配置，支持修改APN下一个用户和UPF的绑定。

## [注意事项](#ZH-CN_MMLREF_0000001921861977)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001921861977)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001921861977)
...
## [使用实例](#ZH-CN_MMLREF_0000001921861977)
