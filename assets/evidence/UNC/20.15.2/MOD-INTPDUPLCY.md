# 修改异网漫游PDU会话重建策略（MOD INTPDUPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001663626149__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001663626149__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001663626149__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001663626149__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001663626149)

**适用NF：AMF**

该命令用于修改异网漫游用户的PDU会话重建策略。

## [注意事项](#ZH-CN_MMLREF_0000001663626149)

下一次移动性流程生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001663626149)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001663626149)
...
## [使用实例](#ZH-CN_MMLREF_0000001663626149)

修改对所有异网漫游用户生效的PDU会话重建策略，数据会话立即重建，语音会话等进入空闲态后再重建，执行如下命令：

```
MOD INTPDUPLCY:SUBRANGE=INTERNAT_ROAM_USER,IMSPDUPLCY=REACT_ENTER_CMIDLE,NONIMSPDUPLCY=IMMEDIATE_REACT;
```
