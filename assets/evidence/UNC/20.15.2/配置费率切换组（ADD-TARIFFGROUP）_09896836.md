# 配置费率切换组（ADD TARIFFGROUP）

- [命令功能](#ZH-CN_CONCEPT_0209896836__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896836__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896836__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896836__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896836__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896836)

**适用NF：SGW-C、PGW-C、SMF**

该命令用来配置费率切换点。如果费率切换点所在的费率切换组不存在，则新建一个费率切换组。

#### [注意事项](#ZH-CN_CONCEPT_0209896836)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896836)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896836)
