# 删除费率切换组（RMV TARIFFGROUP）

- [命令功能](#ZH-CN_CONCEPT_0209896837__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896837__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896837__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896837__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896837__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896837)

**适用NF：SGW-C、PGW-C、SMF**

该命令用来删除指定的费率切换组记录。

#### [注意事项](#ZH-CN_CONCEPT_0209896837)

- 该命令执行后立即生效。
- 删除前，需要先通过命令LST APNCHARGECTRL、LST USRPROFCHARGE和LST GLBTARIFFGROUP查看本命令是否被这些命令绑定了。如果被绑定，则不允许删除。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896837)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896837)
