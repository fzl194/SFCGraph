# 查询IMSI号段路由（LST NRFIMSIRT）

- [命令功能](#ZH-CN_MMLREF_0209653131__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653131__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653131__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653131__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209653131__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209653131)
...
## [注意事项](#ZH-CN_MMLREF_0209653131)

无

#### [操作用户权限](#ZH-CN_MMLREF_0209653131)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653131)
...
## [输出结果说明](#ZH-CN_MMLREF_0209653131)

| 输出项名称 | 输出项解释 |
| --- | --- |
| NF类型 | 该参数用于表示支持IMSI号段路由寻址的NF类型。 |
| 号段起始字符 | 该参数用于表示IMSI号段配置的号段起始字符串。 |
| 号段结束字符 | 该参数用于表示IMSI号段配置的号段结束字符串。 |
