# 修改5G算法优先级属性（MOD NGALGPRIORITY）

- [命令功能](#ZH-CN_MMLREF_0209653199__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653199__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653199__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653199__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653199)
...
## [注意事项](#ZH-CN_MMLREF_0209653199)

- 该命令执行后立即生效。

- 通过ADD NGUSRSECPARA命令打开加密或者完整性功能开关，本命令配置的算法优先级才会生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209653199)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653199)
