# 设置SCTP全局参数（SET GLBSCTPPARA）

- [命令功能](#ZH-CN_CONCEPT_0209897326__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897326__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897326__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897326__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897326__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897326)

**适用NF：PGW-C、SMF**

此命令用于设置SCTP全局参数。

#### [注意事项](#ZH-CN_CONCEPT_0209897326)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897326)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897326)
...
#### [使用实例](#ZH-CN_CONCEPT_0209897326)

根据网络规划，需要修改SCTP全局参数，则可以按如下配置：

```
SET GLBSCTPPARA: PATHSELECTMODE=PARALLEL;
```
