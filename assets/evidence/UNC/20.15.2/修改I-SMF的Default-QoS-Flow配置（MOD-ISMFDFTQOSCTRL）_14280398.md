# 修改I-SMF的Default QoS Flow配置（MOD ISMFDFTQOSCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001214280398__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001214280398__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001214280398__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001214280398__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001214280398)

**适用NF：SMF**

该命令用来修改I-SMF的Default QoS Flow配置。

## [注意事项](#ZH-CN_MMLREF_0000001214280398)

命令执行后只对新接入用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001214280398)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001214280398)
...
## [使用实例](#ZH-CN_MMLREF_0000001214280398)
