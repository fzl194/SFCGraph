# 设置RU CPU占用率告警上报门限和告警恢复门限(SET RUCPUTHRESH)

- [命令功能](#ZH-CN_CONCEPT_0129626959__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0129626959__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0129626959__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0129626959__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0129626959__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0129626959)

该命令用于配置“ALM-82802 RU CPU过载”的CPU过载告警上报门限和告警恢复门限。

#### [注意事项](#ZH-CN_CONCEPT_0129626959)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0129626959)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0129626959)
