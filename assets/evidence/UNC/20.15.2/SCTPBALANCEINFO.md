# 查询SCTP均衡信息(DSP SCTPBALANCEINFO)

- [命令功能](#ZH-CN_CONCEPT_0000001216196710__1.4.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001216196710__1.4.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001216196710__1.4.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001216196710__1.4.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001216196710__1.4.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001216196710__1.4.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001216196710)

**适用NF：SGSN、MME、AMF**

此命令用于查询系统中指定SGP进程上的eNodeB和gNodeB数目。

#### [注意事项](#ZH-CN_CONCEPT_0000001216196710)

- 此命令执行后立即生效。
- 此命令查询的是汇总结果，基站迁移过程中汇总结果可能存在偏差，需要在系统稳定30s后才能查到准确信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001216196710)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001216196710)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001216196710)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001216196710)

| 输出项名称 | 输出项解释 |
| --- | --- |
| RU名称 | 当“查询方式”为“DISTRIBUTED(分布查询)”时，用于描述SGP进程所在的RU名称。 |
| 进程号 | 当“查询方式”为“DISTRIBUTED(分布查询)”时，用于描述SGP进程的进程号。 |
| eNodeB个数 | 当“查询方式”为“DISTRIBUTED(分布查询)”时，用于描述当前查询的SGP进程上的eNodeB数目。 |
| gNodeB个数 | 当“查询方式”为“DISTRIBUTED(分布查询)”时，用于描述当前查询的SGP进程上的gNodeB数目。 |
| 单进程基站总个数 | 当“查询方式”为“DISTRIBUTED(分布查询)”时，用于描述当前查询的SGP进程上的eNodeB和gNodeB总数。 |
| eNodeB总个数 | 用于描述当前命令查询出来的eNodeB总数。 |
| gNodeB总个数 | 用于描述当前命令查询出来的gNodeB总数。 |
| 基站总个数 | 用于描述当前命令查询出来的eNodeB和gNodeB总数。 |
