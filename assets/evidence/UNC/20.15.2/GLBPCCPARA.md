# 查询全局PCC参数（LST GLBPCCPARA）

- [命令功能](#ZH-CN_CONCEPT_0209897032__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897032__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897032__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897032__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897032__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209897032__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897032)

**适用NF：PGW-C、SMF**

该命令用于查询全局PCC配置参数。

#### [注意事项](#ZH-CN_CONCEPT_0209897032)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897032)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897032)

无。

#### [使用实例](#ZH-CN_CONCEPT_0209897032)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209897032)

参见SET PCCFUNC、SET PCCFAILACTION、SET PCCFLOWCONTROL的参数说明。
