# 设置LTE-M用户的RAT值（SET LTEMRATVALUE）

- [命令功能](#ZH-CN_MMLREF_0304284725__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0304284725__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0304284725__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0304284725__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0304284725)

**适用NF：PGW-C、SGW-C、SMF**

该命令用于设置终端通过LTE-M接入方式时UNC给周边网元发送消息时RAT信元中携带的值。

## [注意事项](#ZH-CN_MMLREF_0304284725)
...
#### [操作用户权限](#ZH-CN_MMLREF_0304284725)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0304284725)
