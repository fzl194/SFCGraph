# 删除归属地PGW-C IP地址（RMV HOMEPGWIP）

- [命令功能](#ZH-CN_MMLREF_0306399925__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399925__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399925__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399925__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0306399925)

**适用NF：SGW-C**

该命令用于Proxy S-GW特性中删除用户指定的归属地PGW-C的IP地址记录。

## [注意事项](#ZH-CN_MMLREF_0306399925)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0306399925)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399925)
