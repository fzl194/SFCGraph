# 设置QoS兼容性配置(SET COMPATIBILITY)

- [命令功能](#ZH-CN_MMLREF_0000001172345835__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345835__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345835__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345835__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345835__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345835__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001172345835__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345835)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345835)

- 此命令执行后立即生效。
- 此命令与[**SET R8QOSMAP**](../EPS QoS参数到Pre-R8 QoS参数映射/设置EPS QoS参数到Pre-R8 QoS参数映射规则（SET R8QOSMAP）_26146234.md)结合使用，配置出QoS的相关映射参数。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345835)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345835)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345835)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345835)
...
#### [参考信息](#ZH-CN_MMLREF_0000001172345835)

- 本系统提供的从R99到R97/98的QoS自定义映射规则：
  *表1 R99到R97/98 QoS自定义映射规则*

  | R99特性 | R99特性 | R97/R98特性 | R97/R98特性 |
  | --- | --- | --- | --- |
  | 名称 | 值 | 值 | 名称 |
  | 流量等级 | Conversational | 1 | 延迟等级 |
  | 流量等级 | Streaming | 2 | 延迟等级 |
  | 流量等级 | Interactive | 3 | 延迟等级 |
  | 流量等级 | Background | 4 | 延迟等级 |
- 本系统提供的从R97/98到R99的QoS自定义映射规则：
  *表2 R97/98到R99 QoS自定义映射规则*

  | R97/R98特性 | R97/R98特性 | R99特性 | R99特性 |
  | --- | --- | --- | --- |
  | 名称 | 值 | 值 | 名称 |
  | 延迟等级 | 1 | Conversational | 流量等级 |
  | 延迟等级 | 2 | Streaming | 流量等级 |
  | 延迟等级 | 3 | Interactive | 流量等级 |
  | 延迟等级 | 4 | Background | 流量等级 |
- 本系统提供的从EPS ARP到Pre-R8 ARP的映射规则：
  *表3 EPS ARP到Pre-R8 ARP映射规则*

  | EPS特性 | EPS特性 | Pre-R8特性 | Pre-R8特性 |
  | --- | --- | --- | --- |
  | 名称 | 值 | 值 | 名称 |
  | Priority Level | 1~H | 1 | Allocation/Retention Priority |
  | Priority Level | H+1~M | 2 | Allocation/Retention Priority |
  | Priority Level | M+1~15 | 3 | Allocation/Retention Priority |
- 本系统提供的从Pre-R8 ARP到EPS ARP的映射规则：
  *表4 Pre-R8 ARP到EPS ARP映射规则*

  | Pre-R8特性 | Pre-R8特性 | EPS特性 | EPS特性 |
  | --- | --- | --- | --- |
  | 名称 | 值 | 值 | 名称 |
  | Allocation/Retention Priority | 1 | 1 | Priority Level |
  | Allocation/Retention Priority | 2 | H+1 | Priority Level |
  | Allocation/Retention Priority | 3 | M+1 | Priority Level |
