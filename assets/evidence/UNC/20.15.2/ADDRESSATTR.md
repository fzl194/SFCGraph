# 设置UE IP地址属性（SET ADDRESSATTR）

- [命令功能](#ZH-CN_MMLREF_0209653185__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653185__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653185__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653185__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653185)

**适用NF：PGW-C、SMF、GGSN**

该命令用于设置UE IP动态地址分配的全局属性。

## [注意事项](#ZH-CN_MMLREF_0209653185)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653185)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653185)
