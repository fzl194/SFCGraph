...
- [操作场景](#ZH-CN_OPI_0277825710__1.3.1)
- [必备事项](#ZH-CN_OPI_0277825710__1.3.2)
- [操作步骤](#ZH-CN_OPI_0277825710__1.3.3)
- [任务示例](#ZH-CN_OPI_0277825710__1.3.4)
...
![](配置计费和策略模式_77825710.assets/zh-cn_image_0000001743352724_2.png)
...
![](配置计费和策略模式_77825710.assets/zh-cn_image_0000001761585289_2.png)
...
## [任务示例](#ZH-CN_OPI_0277825710)

任务描述

任务一：配置全局指定5G终端4G接入的计费接口为Nchf，策略接口为Npcf。

任务二：配置基于APN/DNN的指定5G终端4G接入的计费接口为Nchf，策略接口为Npcf。

任务三：配置基于漫游属性的漫游5G终端4G接入的计费接口为Nchf，策略接口为Npcf。

任务四：配置国漫5G用户在漫游地接入5G核心网时计费接口选择为GaGy模式。

脚本

任务一：

//配置指定5G终端4G接入的计费接口为Nchf。
...
//（可选）配置PCF实例标识为pcf1的计费接口类型为N40，策略接口类型为Npcf。
