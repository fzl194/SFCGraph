# 设置状态核查参数（SET STATUSCHECK）

- [命令功能](#ZH-CN_MMLREF_0000001150456771__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001150456771__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001150456771__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001150456771__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001150456771)

当前版本配置此命令不生效。

该命令用于设置状态核查开关和核查周期。

## [注意事项](#ZH-CN_MMLREF_0000001150456771)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001150456771)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001150456771)
...
## [使用实例](#ZH-CN_MMLREF_0000001150456771)
