# 增加离线业务模板（ADD OFCSRVTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0209896899__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896899__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896899__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896899__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896899__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896899)

**适用NF：PGW-C、SMF**

该命令用来新增离线业务模板的配置，用于设置离线业务计费相关配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0209896899)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896899)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896899)
