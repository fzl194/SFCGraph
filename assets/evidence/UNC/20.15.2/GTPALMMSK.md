# 查询GTP路径断告警屏蔽记录(LST GTPALMMSK)

- [命令功能](#ZH-CN_MMLREF_0000001126145910__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145910__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145910__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145910__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145910__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145910__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126145910__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145910)

**适用网元：SGSN、MME**

该命令用于查看需要屏蔽的GTP路径断告警配置。

#### [注意事项](#ZH-CN_MMLREF_0000001126145910)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145910)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145910)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145910)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145910)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126145910)

参数说明参考 [**ADD GTPALMMSK**](增加GTP路径断告警屏蔽记录(ADD GTPALMMSK)_72225587.md) 命令。
