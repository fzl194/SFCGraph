# 设置N7接收信元处理控制（SET N7RCVATTRCTRL）

- [命令功能](#ZH-CN_MMLREF_0209653677__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653677__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653677__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653677__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653677)

**适用NF：SMF**

该命令用于设置对接收到的N7接口消息中部分信元的处理方式。

## [注意事项](#ZH-CN_MMLREF_0209653677)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653677)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653677)
