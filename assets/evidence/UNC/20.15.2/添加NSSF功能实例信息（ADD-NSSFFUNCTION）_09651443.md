# 添加NSSF功能实例信息（ADD NSSFFUNCTION）

- [命令功能](#ZH-CN_MMLREF_0209651443__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651443__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651443__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651443__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651443)

**适用NF：NSSF**

本命令用于添加NSSF功能实例信息。

## [注意事项](#ZH-CN_MMLREF_0209651443)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651443)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651443)
