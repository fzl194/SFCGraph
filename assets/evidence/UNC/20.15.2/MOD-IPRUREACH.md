# 修改RU到网关的可达性检测配置（MOD IPRUREACH）

- [命令功能](#ZH-CN_CONCEPT_0000001600865657__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600865657__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600865657__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600865657__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600865657__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600865657)

该命令用于修改RU到网关可达性的检测配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001600865657)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600865657)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600865657)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600865657)
