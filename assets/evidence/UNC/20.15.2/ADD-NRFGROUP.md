# 增加对端NRF实例组（ADD NRFGROUP）

- [命令功能](#ZH-CN_MMLREF_0209653179__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653179__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653179__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653179__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653179)

**适用NF：NRF**

运营商希望新增对端NRF实例组时可使用此命令。需要多个NRF互通时，NRF之间要配置各自的对端NRF实例组信息，对端NRF实例组是一个或多个对端NRF实例的集合，用于容灾或负荷分担。

## [注意事项](#ZH-CN_MMLREF_0209653179)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653179)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653179)
