# 删除对端NF的SMF服务区域信息（RMV PNFSMFSERAREA）

- [命令功能](#ZH-CN_MMLREF_0209653186__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653186__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653186__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653186__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653186)

**适用NF：SMF、NCG、SGW-C、GGSN、PGW-C**

该命令用于删除本地配置的对端NF实例支持的为SMF提供服务区域的信息。

## [注意事项](#ZH-CN_MMLREF_0209653186)

- 该命令执行后立即生效。

- 当删除一条PNFNSINDEX为0的记录时，必须满足记录中不存在与将删除记录的NFINSTANCEID和SMFSERVINGAREA一样且PNFNSINDEX不为0的记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209653186)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653186)
