# 修改APN粒度的智家随行会话控制（MOD APNTOHCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001921742353__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001921742353__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001921742353__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001921742353__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001921742353)

该命令用于修改APN粒度的智家随行会话控制。

## [注意事项](#ZH-CN_MMLREF_0000001921742353)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001921742353)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001921742353)
...
## [使用实例](#ZH-CN_MMLREF_0000001921742353)
