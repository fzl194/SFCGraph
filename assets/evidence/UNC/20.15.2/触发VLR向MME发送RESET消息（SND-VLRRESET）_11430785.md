# 触发VLR向MME发送RESET消息（SND VLRRESET）

- [命令功能](#ZH-CN_MMLREF_0000001411430785__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001411430785__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001411430785__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001411430785__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001411430785)
...
## [注意事项](#ZH-CN_MMLREF_0000001411430785)

- 该命令执行后立即生效。

- 该命令只能对指定的单个MME发送SGsAP-RESET-INDICATION消息。

#### [操作用户权限](#ZH-CN_MMLREF_0000001411430785)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001411430785)
...
## [使用实例](#ZH-CN_MMLREF_0000001411430785)
