# 设置PCRF策略 (SET PCRFPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001809374666__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001809374666__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001809374666__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001809374666__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001809374666__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001809374666__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001809374666)

**适用网元：MME**

该命令用于在PCRF签约NI和RFSP时，开启动态NI功能或灵活选频功能并设置相关策略。

#### [注意事项](#ZH-CN_MMLREF_0000001809374666)

- 此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001809374666)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001809374666)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001809374666)
...
#### [使用实例](#ZH-CN_MMLREF_0000001809374666)
