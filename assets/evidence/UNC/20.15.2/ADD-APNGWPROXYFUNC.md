# 增加APN网关Proxy功能配置（ADD APNGWPROXYFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001142853254__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001142853254__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001142853254__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001142853254__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001142853254)

**适用NF：PGW-C、GGSN**

此命令用于增加指定APN的网关Proxy功能配置。

## [注意事项](#ZH-CN_MMLREF_0000001142853254)

- 该命令执行后立即生效。

- 最多可输入20000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001142853254)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001142853254)
...
## [使用实例](#ZH-CN_MMLREF_0000001142853254)
