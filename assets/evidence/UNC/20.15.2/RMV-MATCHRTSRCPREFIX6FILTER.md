# 删除匹配IPv6路由源前缀列表（RMV MATCHRTSRCPREFIX6FILTER）

- [命令功能](#ZH-CN_CONCEPT_0000001549961674__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961674__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961674__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961674__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961674__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961674)

该命令用来删除基于发布路由的源地址IPv6信息的匹配规则。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961674)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961674)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961674)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961674)
