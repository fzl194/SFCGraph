# 增加接口（ADD INTERFACEIPSEC）

- [命令功能](#ZH-CN_MMLREF_0000001226150749__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001226150749__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001226150749__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001226150749__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001226150749)

该命令用于增加逻辑接口并初始化该接口的相关配置，逻辑接口是指能够实现数据交换功能但物理上不存在、需要通过配置建立的接口。

## [注意事项](#ZH-CN_MMLREF_0000001226150749)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001226150749)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001226150749)
...
## [使用实例](#ZH-CN_MMLREF_0000001226150749)
