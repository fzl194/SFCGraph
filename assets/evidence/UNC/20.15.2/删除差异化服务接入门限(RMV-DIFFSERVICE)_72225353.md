# 删除差异化服务接入门限(RMV DIFFSERVICE)

- [命令功能](#ZH-CN_MMLREF_0000001172225353__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225353__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225353__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225353__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225353__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225353__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225353)

**适用网元：SGSN**

该命令用于删除差异化服务配置信息，差异化服务是指针对不同优先级的用户，提供不同的接入控制策略，保证优先级别高的用户具有优先使用网络资源的权力。

#### [注意事项](#ZH-CN_MMLREF_0000001172225353)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225353)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225353)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225353)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225353)
