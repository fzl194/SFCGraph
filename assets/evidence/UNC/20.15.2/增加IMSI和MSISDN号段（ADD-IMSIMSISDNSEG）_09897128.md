# 增加IMSI和MSISDN号段（ADD IMSIMSISDNSEG）

- [命令功能](#ZH-CN_CONCEPT_0209897128__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897128__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897128__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897128__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897128__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897128)
...
#### [注意事项](#ZH-CN_CONCEPT_0209897128)

- 该命令执行后立即生效。
- 该命令最大记录数为12000。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897128)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897128)
...
#### [使用实例](#ZH-CN_CONCEPT_0209897128)

增加IMSI和MSISDN号段: SEGMENTNAME为huawei，SEGMENTTYPE为IMSI，SEGSTART为130，SEGEND为139：

```
ADD IMSIMSISDNSEG:SEGMENTNAME="huawei",SEGMENTTYPE=IMSI,SEGSTART="130",SEGEND="139";
```
