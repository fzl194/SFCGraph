# 删除S1模式接入限制参数(RMV S1ARD)

- [命令功能](#ZH-CN_MMLREF_0000001172225159__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225159__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225159__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225159__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225159__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225159__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225159)

**适用网元：MME**

该命令用于删除S1模式接入限制参数。该命令先根据IMSI号段将用户进行分类，再对每一类用户按照用户签约的ARD信息、签约的APN信息进行区分而控制用户接入E-UTRAN网络。

#### [注意事项](#ZH-CN_MMLREF_0000001172225159)

无。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225159)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225159)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225159)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225159)
