# 修改区域码转换策略(MOD ZCCONVERT)

- [命令功能](#ZH-CN_MMLREF_0000001172345165__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345165__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345165__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345165__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345165__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345165__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345165)

**适用网元：SGSN、MME**

此命令用于修改区域码转换策略。

#### [注意事项](#ZH-CN_MMLREF_0000001172345165)

- 此命令执行后立即生效。
- 区域码转换策略仅在[**SET MMFUNC**](../../MM扩展功能管理/设置移动性管理扩展功能(SET MMFUNC)_26145512.md)的参数“区域码”设置为“YES（是）”时，才能生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345165)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345165)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345165)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345165)
