# 修改指定用户优选网关（MOD GWPRESELBYIMSI）

- [命令功能](#ZH-CN_TOPIC_0000002095841541__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000002095841541__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000002095841541__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000002095841541__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000002095841541__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000002095841541__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000002095841541)

**适用网元：MME**

该命令用于修改指定用户优选网关记录。

#### [注意事项](#ZH-CN_TOPIC_0000002095841541)

无。

#### [本地用户权限](#ZH-CN_TOPIC_0000002095841541)

manage-ug；system-ug；

#### [网管用户权限](#ZH-CN_TOPIC_0000002095841541)

G_1，管理员级别命令组；G_2，操作员级别命令组；

#### [参数说明](#ZH-CN_TOPIC_0000002095841541)
...
#### [使用实例](#ZH-CN_TOPIC_0000002095841541)
