# 增加网关容灾APN(ADD GWRESTORAPN)

- [命令功能](#ZH-CN_MMLREF_0000001172225761__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225761__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225761__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225761__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225761__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225761__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225761)

**适用网元：MME**

本命令用于增加在S-GW或P-GW故障场景下需要恢复的业务的APN网络标识，即APNNI。启用“S-GW/P-GW故障下的业务恢复”特性后，若受影响的业务所对应的APN网络标识与本命令增加的APN网络标识相同，则恢复此类业务的PDN连接。

#### [注意事项](#ZH-CN_MMLREF_0000001172225761)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225761)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225761)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225761)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225761)
