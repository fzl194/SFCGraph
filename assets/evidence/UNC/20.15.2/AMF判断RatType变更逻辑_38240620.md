...
AMF会结合以上三种原因，对RaTtype是否发生变化进行判断。具体判断逻辑如 [表1 AMF判断RatType是否变化场景](#ZH-CN_TOPIC_0000001538240620__table928154213598) 所示。对于连接态会话，AMF随流程消息通知SMF；对于空闲态会话，AMF通知SMF策略受 [**SET AMFREDCAPFUNC**](../../../../../../../OM参考/命令/UNC MML命令/业务服务管理/5G M2M管理/RedCap功能管理/设置AMF RedCap功能（SET AMFREDCAPFUNC）_17306402.md) 的参数 **NTYSMFPLCY** 控制，与RedCap功能开关无关。
