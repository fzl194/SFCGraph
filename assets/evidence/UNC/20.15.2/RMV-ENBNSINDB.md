# 删除配置的eNodeB邻接关系(RMV ENBNSINDB)

- [命令功能](#ZH-CN_MMLREF_0000001126146260__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146260__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146260__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146260__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146260__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146260__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146260)

**适用网元：MME**

此命令用于删除手动添加的eNodeB邻接关系。

#### [注意事项](#ZH-CN_MMLREF_0000001126146260)

此命令执行后立即生效，并将导致整网所有eNodeB邻接关系的学习时间变长。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146260)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146260)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146260)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146260)
