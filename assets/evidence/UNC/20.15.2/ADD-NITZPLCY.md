# 增加NITZ策略（ADD NITZPLCY）

- [命令功能](#ZH-CN_MMLREF_0209652255__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652255__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652255__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652255__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652255)

**适用NF：AMF**

该命令用于为指定区域和指定用户群配置NITZ（Network Identity and Time Zone）策略。所谓NITZ策略是指AMF根据配置向UE下发系统时间、本地时区、夏令时及网络标识等信息。

## [注意事项](#ZH-CN_MMLREF_0209652255)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652255)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652255)
