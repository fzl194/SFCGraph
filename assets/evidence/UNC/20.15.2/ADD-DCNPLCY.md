# 增加DCN配置策略(ADD DCNPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001126305642__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305642__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305642__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305642__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305642__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305642__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305642)

**适用网元：MME**

该命令用于增加DCN的策略参数，即为用户配置DCN业务相关参数，以满足运营商灵活部署网络的需求。

#### [注意事项](#ZH-CN_MMLREF_0000001126305642)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305642)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305642)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305642)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305642)
