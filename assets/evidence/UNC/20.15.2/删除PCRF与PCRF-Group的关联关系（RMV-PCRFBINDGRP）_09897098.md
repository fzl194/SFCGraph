# 删除PCRF与PCRF Group的关联关系（RMV PCRFBINDGRP）

- [命令功能](#ZH-CN_CONCEPT_0209897098__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897098__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897098__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897098__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897098__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897098)

**适用NF：PGW-C、GGSN**

此命令用于从PCRF分组中删除指定的PCRF。

#### [注意事项](#ZH-CN_CONCEPT_0209897098)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897098)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897098)
