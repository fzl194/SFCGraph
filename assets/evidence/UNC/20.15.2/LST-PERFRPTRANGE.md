# 查询性能指标上报范围（LST PERFRPTRANGE）

- [命令功能](#ZH-CN_MMLREF_0000001215399534__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001215399534__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001215399534__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001215399534__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001215399534__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001215399534)

**适用NF：SMF、PGW-C、GGSN、AMF**

该命令用于查询AMF或SMF性能统计指标的上报范围。

## [注意事项](#ZH-CN_MMLREF_0000001215399534)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001215399534)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001215399534)
...
## [使用实例](#ZH-CN_MMLREF_0000001215399534)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001215399534)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 测量对象类型 | 该参数用于指定测量对象类型。 |
| 规则生效范围 | 该参数用于指定本记录生效的范围。 |
| 测量单元ID | 该参数用于指定测量单元的网管ID。 |
| 测量对象实例ID | 该参数用于指定测量对象实例。 |
| 上报范围 | 该参数用于指定支持上报的指标范围。 |
