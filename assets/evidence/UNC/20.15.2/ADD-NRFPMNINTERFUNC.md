# 增加基于对端PLMN国际漫游功能参数（ADD NRFPMNINTERFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001179850554__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001179850554__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001179850554__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001179850554__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001179850554)

**适用NF：NRF**

此命令用于新增基于对端PLMN的国际漫游功能参数。

## [注意事项](#ZH-CN_MMLREF_0000001179850554)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001179850554)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001179850554)
...
## [使用实例](#ZH-CN_MMLREF_0000001179850554)
