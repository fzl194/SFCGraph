# 修改SCCP全局翻译码(MOD SCCPGT)

- [命令功能](#ZH-CN_MMLREF_0000001126146326__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146326__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146326__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146326__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146326__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146326__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146326)

**适用网元：SGSN、MME、SMSF**

此命令用来修改SCCP全局码翻译表中指定的GT记录的信息。

#### [注意事项](#ZH-CN_MMLREF_0000001126146326)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126146326)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146326)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146326)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146326)
