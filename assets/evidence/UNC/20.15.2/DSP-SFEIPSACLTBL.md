# 查询软转发SFE IPSEC-ACL表项信息（DSP SFEIPSACLTBL）

- [命令功能](#ZH-CN_CONCEPT_0000001549802474__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802474__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802474__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802474__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802474__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001549802474__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802474)

该命令查询软转发SFE IPSEC-ACL表项信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001549802474)

该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802474)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802474)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802474)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001549802474)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 动作索引号 | 用于表示查询到的动作索引号。 |
| RE索引 | 用于表示查询到的RE索引。 |
| IPSEC出接口索引 | 用于表示查询到的IPSEC出接口索引。 |
| IPSEC Tunnel口绑定的Vpn | 用于表示查询到的IPSEC Tunnel口绑定的Vpn。 |
| 匹配动作 | 用于表示查询到的匹配动作。 |
| 目的RU号 | 用于表示查询到的目的RU号。 |
| 引擎口索引 | 用于表示查询到的对应IPSECNLS的引擎口索引。 |
| 与对端建立的隧道编号 | 用于表示查询到的与对端建立的隧道编号。 |
