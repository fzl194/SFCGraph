# 设置基于APN的地址分配规则（SET APNIPALLOCRULE）

- [命令功能](#ZH-CN_MMLREF_0249644932__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0249644932__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0249644932__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0249644932__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0249644932)

**适用NF：PGW-C、GGSN、SMF**

该命令用于配置基于APN的地址分配规则。

## [注意事项](#ZH-CN_MMLREF_0249644932)
...
#### [操作用户权限](#ZH-CN_MMLREF_0249644932)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0249644932)
