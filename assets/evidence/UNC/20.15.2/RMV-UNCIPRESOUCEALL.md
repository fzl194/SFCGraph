# 删除UNC所有接口的IP地址（RMV UNCIPRESOUCEALL）

- [命令功能](#ZH-CN_MMLREF_0000001623324806__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001623324806__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001623324806__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001623324806__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001623324806)
...
## [注意事项](#ZH-CN_MMLREF_0000001623324806)

- 该命令执行后立即生效。

- 如果需要执行此命令，删除所有上报给网管北向的IP资源信息，在“INTFTYPE”参数处配置全大写字符串“ALL”即可。

#### [操作用户权限](#ZH-CN_MMLREF_0000001623324806)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001623324806)
...
## [使用实例](#ZH-CN_MMLREF_0000001623324806)
