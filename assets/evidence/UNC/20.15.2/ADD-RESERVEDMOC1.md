# 新增补丁预留MOC1（ADD RESERVEDMOC1）

- [命令功能](#ZH-CN_MMLREF_0250558739__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0250558739__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0250558739__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0250558739__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0250558739)

**适用NF：AMF、SMF、NRF、SGSN、MME、SGW-C、PGW-C、GGSN、SMSF、NCG、NSSF**

新增补丁预留MOC1。

## [注意事项](#ZH-CN_MMLREF_0250558739)

- 该命令执行后立即生效。

- 最多可输入50条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0250558739)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0250558739)
...
## [使用实例](#ZH-CN_MMLREF_0250558739)

新增补丁预留MOC1，其中PARAIDX为32，PARAMETER1为parameter1，PARAMETER2为parameter2，PARAMETER3为parameter3，PARAMETER4为parameter4，PARAMETER5为parameter5，请运行以下命令：

```
ADD RESERVEDMOC1: PARAIDX=32, PARAMETER1="parameter1", PARAMETER2="parameter2", PARAMETER3="parameter3", PARAMETER4="parameter4", PARAMETER5="parameter5";
```
