# 删除5G TAI组性能统计对象成员（RMV NGTAIGRPMEM）

- [命令功能](#ZH-CN_MMLREF_0296242860__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296242860__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296242860__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296242860__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296242860)

**适用NF：AMF**

该命令用于为基于5G TAI组的性能统计对象删除TAI成员。

## [注意事项](#ZH-CN_MMLREF_0296242860)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0296242860)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296242860)
