# 修改Diameter字典加载路径（MOD DIAMDICTPATH）

- [命令功能](#ZH-CN_CONCEPT_0209897248__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897248__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897248__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897248__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897248__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897248)

**适用NF：PGW-C、SMF**

该命令用于修改Diameter字典加载路径。

#### [注意事项](#ZH-CN_CONCEPT_0209897248)

- 该命令执行后立即生效。
- 目前只有GY应用支持设置第二套字典加载路径。
- 该命令执行后，再执行加载字典命令（LOD DIAMDICT）。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897248)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897248)
