# 增加本地APNNI组(ADD LOCALAPNNIGP)

- [命令功能](#ZH-CN_TOPIC_0000002216438089__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000002216438089__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000002216438089__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000002216438089__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000002216438089__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000002216438089__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000002216438089)
...
#### [注意事项](#ZH-CN_TOPIC_0000002216438089)

- 该命令执行后立即生效。
- 该命令最大记录数为128。

#### [本地用户权限](#ZH-CN_TOPIC_0000002216438089)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_TOPIC_0000002216438089)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000002216438089)
...
#### [使用实例](#ZH-CN_TOPIC_0000002216438089)
