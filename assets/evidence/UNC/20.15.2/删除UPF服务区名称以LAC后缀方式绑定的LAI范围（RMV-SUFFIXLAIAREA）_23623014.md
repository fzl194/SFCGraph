# 删除UPF服务区名称以LAC后缀方式绑定的LAI范围（RMV SUFFIXLAIAREA）

- [命令功能](#ZH-CN_MMLREF_0000001823623014__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001823623014__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001823623014__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001823623014__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001823623014)

**适用NF：GGSN**

该命令用于删除UPF服务区名称以LAC后缀方式绑定的LAI范围。

## [注意事项](#ZH-CN_MMLREF_0000001823623014)

- 该命令执行后立即生效。

- 当执行命令时不输入BEGINLAI参数时，会删除相同AREANAME、MCC、MNC、AREACODE下绑定的所有LAI范围。

#### [操作用户权限](#ZH-CN_MMLREF_0000001823623014)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001823623014)
...
## [使用实例](#ZH-CN_MMLREF_0000001823623014)
