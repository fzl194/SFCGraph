# 设置HTTP是否支持FQDN（SET HTTPFQDNSW）

- [命令功能](#ZH-CN_MMLREF_0000001454530882__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001454530882__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001454530882__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001454530882__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001454530882)

该命令用于设置HTTP是否支持FQDN。

- 当前应用场景：控制HTTP是否使用响应报文中Location字段携带的FQDN。

## [注意事项](#ZH-CN_MMLREF_0000001454530882)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001454530882)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001454530882)
...
## [使用实例](#ZH-CN_MMLREF_0000001454530882)
