...
- [命令功能](#ZH-CN_MMLREF_0209652165__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652165__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652165__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652165__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652165)

**适用NF：PGW-C、SMF**

该命令用于增加PDU异常返回码动作。

## [注意事项](#ZH-CN_MMLREF_0209652165)

- 该命令执行后立即生效。

- 最多可输入2000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209652165)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652165)
...
## [使用实例](#ZH-CN_MMLREF_0209652165)

增加PDU异常返回码动作配置CCT名称为“test”，指定异常返回码为300，动作为block，阻塞时长30分钟：
