# 设置离线计费阈值（SET OFCTHRESHOLD）

- [命令功能](#ZH-CN_CONCEPT_0209896910__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896910__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896910__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896910__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896910__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896910)

**适用NF：SGW-C、PGW-C、SMF**

该命令用来配置控制话单生成条件中的计费阈值，包括时间阈值、流量阈值、计费条件改变次数、话单最多携带的容器数、MME/SGSN/SGW/ePDG地址改变次数等。

#### [注意事项](#ZH-CN_CONCEPT_0209896910)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896910)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896910)
