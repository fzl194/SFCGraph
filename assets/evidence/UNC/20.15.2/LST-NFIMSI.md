...
- [命令功能](#ZH-CN_MMLREF_0209651705__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651705__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651705__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651705__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209651705__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209651705)
...
## [注意事项](#ZH-CN_MMLREF_0209651705)

无

#### [操作用户权限](#ZH-CN_MMLREF_0209651705)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651705)
...
## [输出结果说明](#ZH-CN_MMLREF_0209651705)

| 输出项名称 | 输出项解释 |
| --- | --- |
| NF组标识 | 该参数用于表示支持IMSI号段的NF组标识，可以通过LST NFGROUP进行查询，支持IMSI号段配置的NF类型仅包含AUSF、PCF、UDM、 UDR、CHF、CUSTOM_OCS。 |
| 号段起始字符串 | 该参数用于表示IMSI号段配置的号段起始字符串。 |
| 号段结束字符串 | 该参数用于表示IMSI号段配置的号段结束字符串。 |
