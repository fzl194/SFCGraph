# 修改指定群组的5G LAN会话扩展参数（MOD GRPNGLANFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001990298740__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001990298740__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001990298740__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001990298740__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001990298740)

**适用NF：SMF**

该命令用于修改指定会话组NGLAN扩展功能。

## [注意事项](#ZH-CN_MMLREF_0000001990298740)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001990298740)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001990298740)
...
## [使用实例](#ZH-CN_MMLREF_0000001990298740)
