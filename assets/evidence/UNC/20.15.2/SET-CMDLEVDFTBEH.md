# 设置DCC模板命令层缺省返回码动作（SET CMDLEVDFTBEH）

- [命令功能](#ZH-CN_CONCEPT_0209896928__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896928__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896928__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896928__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896928__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896928)

**适用NF：PGW-C、SMF**

该命令用于设置DCC在线计费模板命令层缺省返回码动作。

#### [注意事项](#ZH-CN_CONCEPT_0209896928)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896928)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896928)
