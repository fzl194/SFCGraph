# 增加RADIUS服务器的UP列表中指定UP的功能属性（ADD RDSUPFCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001135803148__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001135803148__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001135803148__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001135803148__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001135803148)

**适用NF：SMF、PGW-C、GGSN**

该命令用来增加RADIUS服务器使用的UP列表中指定UPF的功能属性。

## [注意事项](#ZH-CN_MMLREF_0000001135803148)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001135803148)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001135803148)
...
## [使用实例](#ZH-CN_MMLREF_0000001135803148)
