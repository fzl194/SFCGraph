# 增加SCCP子系统(ADD SCCPSSN)

- [命令功能](#ZH-CN_MMLREF_0000001126306144__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126306144__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126306144__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126306144__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126306144__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126306144__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126306144)

**适用网元：SGSN、MME、SMSF**

此命令用于增加SCCP子系统表中指定的记录，子系统SSN是SCCP使用的本地寻址信息，用于识别一个节点中的各个SCCP用户。

#### [注意事项](#ZH-CN_MMLREF_0000001126306144)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126306144)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126306144)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126306144)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126306144)
