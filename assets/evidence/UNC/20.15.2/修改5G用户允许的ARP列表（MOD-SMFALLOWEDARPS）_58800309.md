# 修改5G用户允许的ARP列表（MOD SMFALLOWEDARPS）

- [命令功能](#ZH-CN_MMLREF_0000001258800309__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001258800309__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001258800309__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001258800309__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001258800309)

**适用NF：SMF**

该命令用于修改5G用户允许的ARP列表。

## [注意事项](#ZH-CN_MMLREF_0000001258800309)

命令执行后只对新接入用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001258800309)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001258800309)
...
## [使用实例](#ZH-CN_MMLREF_0000001258800309)
