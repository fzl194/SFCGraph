# 设置NRF区域优选策略（SET NRFRGNPREFPLY）

- [命令功能](#ZH-CN_MMLREF_0000001492741002__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001492741002__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001492741002__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001492741002__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001492741002)

**适用NF：NRF**

该命令用于设置NRF区域优选策略。该命令功能暂不生效。

## [注意事项](#ZH-CN_MMLREF_0000001492741002)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001492741002)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001492741002)
...
## [使用实例](#ZH-CN_MMLREF_0000001492741002)
