# 设置PAE关键资源不足告警参数（SET PAERESOVLDTRHD）

- [命令功能](#ZH-CN_MMLREF_0000001953828096__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001953828096__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001953828096__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001953828096__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001953828096)

该命令用于修改PAE关键资源不足告警的参数。

## [注意事项](#ZH-CN_MMLREF_0000001953828096)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001953828096)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001953828096)
...
## [使用实例](#ZH-CN_MMLREF_0000001953828096)
