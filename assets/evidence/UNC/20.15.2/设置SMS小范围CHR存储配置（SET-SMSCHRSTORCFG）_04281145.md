# 设置SMS小范围CHR存储配置（SET SMSCHRSTORCFG）

- [命令功能](#ZH-CN_MMLREF_0000001404281145__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001404281145__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001404281145__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001404281145__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001404281145)

**适用NF：SMSF**

该命令用于设置SMS小范围CHR存储配置。

## [注意事项](#ZH-CN_MMLREF_0000001404281145)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001404281145)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001404281145)
...
## [使用实例](#ZH-CN_MMLREF_0000001404281145)
