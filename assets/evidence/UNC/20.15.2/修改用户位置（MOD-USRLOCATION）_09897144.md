# 修改用户位置（MOD USRLOCATION）

- [命令功能](#ZH-CN_CONCEPT_0209897144__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897144__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897144__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897144__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897144__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897144)

**适用NF：PGW-C、SMF**

该命令用于修改用户位置信息，实现基于位置的带宽管理或TCP小区拥塞检测功能。

#### [注意事项](#ZH-CN_CONCEPT_0209897144)

- 该命令执行后立即生效。
- 用户修改位置信息时，如果已经被绑定到位置信息组，可以不解除绑定关系直接修改。改动对用户激活及更新生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897144)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897144)
