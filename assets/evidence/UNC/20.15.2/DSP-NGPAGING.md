# 显示5G寻呼表（DSP NGPAGING）

- [命令功能](#ZH-CN_MMLREF_0209651526__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651526__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651526__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651526__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209651526__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209651526)
...
## [输出结果说明](#ZH-CN_MMLREF_0209651526)

| 输出项名称 | 输出项解释 |
| --- | --- |
| PLMN | 该参数用于指定NG接入网中基站的PLMN信息。 |
| NG-RAN基站类型 | 该参数表示gNodeB类型，包含Global gNB或者Global N3IWF，以及Macro ng-eNB、Short Macro ng-eNB、Long Macro ng-eNB等五种细分类型。<br>取值说明：<br>- “GNB（Global gNB）”：Global gNB<br>- “MACRONGENB（Macro ng-eNB）”：Macro ng-eNB<br>- “SHORTNGENB（Short Macro ng-eNB）”：Short Macro ng-eNB<br>- “LONGNGENB（Long Macro ng-eNB）”：Long Macro ng-eNB<br>- “N3IWF（Global N3IWF）”：Global N3IWF |
| NG-RAN基站标识 | 该参数用于指定NG接入网中基站的标识。 |
| gNB标识长度(比特) | 该参数表示gNB标识的长度（比特）。 |
| 跟踪区标识 | 该参数表示NG-RAN基站支持的跟踪区信息。TAI由PLMN ID和TAC组成。 |
