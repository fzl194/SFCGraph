# 增加UPF和DNS关联的UPF组的绑定关系（ADD UEDNSUPFBINDGRP）

- [命令功能](#ZH-CN_MMLREF_0273321230__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0273321230__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0273321230__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0273321230__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0273321230)

**适用NF：PGW-C、SMF、GGSN**

该命令用于添加UPF和DNS关联的UPF组的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0273321230)
...
#### [操作用户权限](#ZH-CN_MMLREF_0273321230)

G_1，管理员级别命令组

## [参数说明](#ZH-CN_MMLREF_0273321230)
