# 修改5G M2M策略参数（MOD NGM2MPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001534732060__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001534732060__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001534732060__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001534732060__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001534732060)

**适用NF：AMF**

该命令用于修改5G M2M的策略参数。

## [注意事项](#ZH-CN_MMLREF_0000001534732060)

下次注册流程生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001534732060)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001534732060)
...
## [使用实例](#ZH-CN_MMLREF_0000001534732060)
