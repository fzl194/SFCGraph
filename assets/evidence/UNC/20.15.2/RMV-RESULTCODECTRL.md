# 删除返回码控制（RMV RESULTCODECTRL）

- [命令功能](#ZH-CN_CONCEPT_0209897086__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897086__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897086__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897086__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897086__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897086)
...
#### [注意事项](#ZH-CN_CONCEPT_0209897086)

- 该命令执行后立即生效。
- 该命令属于高危命令，不允许批量删除操作。如果需要执行此类操作，应将BYTE976的值设置为169。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897086)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897086)
