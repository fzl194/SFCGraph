# 增加匹配RD过滤器（ADD MATCHRDFILTER）

- [命令功能](#ZH-CN_CONCEPT_0000001550280566__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280566__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280566__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280566__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280566__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280566)

该命令用来增加基于RD属性过滤器的匹配规则。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280566)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280566)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280566)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280566)
