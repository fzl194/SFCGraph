# 增加NF路由策略（ADD NFROUTEPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001293718713__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001293718713__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001293718713__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001293718713__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001293718713)

**适用NF：SMF、AMF、SMSF、NCG、NSSF**

该命令用于增加对端NF路由策略。

## [注意事项](#ZH-CN_MMLREF_0000001293718713)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001293718713)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001293718713)
...
## [使用实例](#ZH-CN_MMLREF_0000001293718713)
