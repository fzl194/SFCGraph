# 增加流行为CAR配置（ADD SQOSCAR）

- [命令功能](#ZH-CN_CONCEPT_0000001550280710__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280710__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280710__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280710__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280710__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280710)

该命令用来增加流行为CAR配置。

该命令配置的重标记报文服务等级和颜色对简单流分类映射有效QoS调度只使用服务等级不关心颜色。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280710)

- 该命令最大记录数为65535。
- 需要使用ADD MQCBEHAVIOR命令先配置流行为。
- 该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280710)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280710)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280710)
