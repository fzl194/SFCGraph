# 修改APN与Diameter Realm关联关系（MOD REALMBINDAPN）

- [命令功能](#ZH-CN_CONCEPT_0209897286__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897286__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897286__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897286__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897286__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897286)

**适用NF：PGW-C、SMF**

该命令用于修改APN对应的Diameter域信息，或指定根据IMSI构造Diameter域信息。

#### [注意事项](#ZH-CN_CONCEPT_0209897286)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897286)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897286)
