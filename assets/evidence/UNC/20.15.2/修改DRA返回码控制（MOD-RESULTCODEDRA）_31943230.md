# 修改DRA返回码控制（MOD RESULTCODEDRA）

- [命令功能](#ZH-CN_MMLREF_0000002131943230__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002131943230__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002131943230__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002131943230__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002131943230)

**适用NF：PGW-C、GGSN**

此命令用来修改当UNC收到DRA回复的指定结果码信息后执行何种操作。例如关闭PCC功能、执行缺省动作、执行宕机备份等。

## [注意事项](#ZH-CN_MMLREF_0000002131943230)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000002131943230)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002131943230)
...
## [使用实例](#ZH-CN_MMLREF_0000002131943230)
