# 修改NRF的FQDN（MOD NRFFQDN）

- [命令功能](#ZH-CN_MMLREF_0209652626__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652626__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652626__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652626__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652626)

**适用NF：NSSF**

该命令用于修改NRF的FQDN。

## [注意事项](#ZH-CN_MMLREF_0209652626)

- 该命令执行后立即生效。

- 该命令会修改NRF的FQDN。

#### [操作用户权限](#ZH-CN_MMLREF_0209652626)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652626)
