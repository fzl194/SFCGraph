# 增加DNAI区域优选规则（ADD NRFDNAIRGNPREF）

- [命令功能](#ZH-CN_MMLREF_0000001543780673__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001543780673__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001543780673__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001543780673__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001543780673)

**适用NF：NRF**

该命令用于增加DNAI区域优选规则。该命令功能暂不生效。

## [注意事项](#ZH-CN_MMLREF_0000001543780673)

- 该命令执行后立即生效。

- 最多可输入1024条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001543780673)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001543780673)
...
## [使用实例](#ZH-CN_MMLREF_0000001543780673)
