...
- [命令功能](#ZH-CN_MMLREF_0209653768__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653768__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653768__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653768__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653768)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于删除SM上下文。

## [注意事项](#ZH-CN_MMLREF_0209653768)

- 该命令执行后立即生效。

- 该命令仅用于内部调测，不对外使用。

#### [操作用户权限](#ZH-CN_MMLREF_0209653768)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653768)
