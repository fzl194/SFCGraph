# 增加PCRF组（ADD PCRFGROUP）

- [命令功能](#ZH-CN_CONCEPT_0209897090__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897090__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897090__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897090__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897090__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897090)

**适用NF：PGW-C、GGSN**

该命令用于添加PCRF Group，设置是否Gx的failover功能以及设置工作模式。

#### [注意事项](#ZH-CN_CONCEPT_0209897090)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897090)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897090)
