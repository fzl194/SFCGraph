# 设置PFCP T1N1参数配置（SET T1N1PARA）

- [命令功能](#ZH-CN_MMLREF_0209651332__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651332__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651332__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651332__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651332)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于设置指定消息类型的超时间隔和发送次数阈值。

## [注意事项](#ZH-CN_MMLREF_0209651332)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651332)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651332)
