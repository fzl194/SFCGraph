# 查询PCC消息属性（LST PCCMSGATTR）

- [命令功能](#ZH-CN_CONCEPT_0209897080__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897080__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897080__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897080__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897080__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209897080__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897080)

**适用NF：PGW-C、SMF**

该命令用于查询配置在Gx接口上CCR-I、CCR-U、CCR-T和RAA消息中可选AVP的携带方式。

#### [注意事项](#ZH-CN_CONCEPT_0209897080)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897080)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897080)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209897080)

参见SET PCCMSGATTR的参数说明。
