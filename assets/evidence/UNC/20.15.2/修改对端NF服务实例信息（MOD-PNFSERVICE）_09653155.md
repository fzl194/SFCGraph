# 修改对端NF服务实例信息（MOD PNFSERVICE）

- [命令功能](#ZH-CN_MMLREF_0209653155__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653155__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653155__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653155__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653155)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于修改本地配置的对端NF实例支持的服务实例信息。

## [注意事项](#ZH-CN_MMLREF_0209653155)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209653155)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653155)
...
| CAPACITY | 容量 | 可选必选说明：可选参数<br>参数含义：本参数用于指定NFS的相对权重（与其他同类型NF实例的NFS相比）。特别地，如果NFS容量的绝对值不超过本参数的取值范围，那么本参数可以直接取用容量绝对值。例如AMF可接入的用户数是50000，那么该AMF的容量就可以用50000表示。<br>数据来源：全网规划<br>取值范围：整数类型，取值范围是0~65535。值越大表示容量越大。<br>默认值：无<br>配置原则：无 |
...
## [使用实例](#ZH-CN_MMLREF_0209653155)

修改对端NF的服务实例信息，NF实例标识为SMF_Instance_0，服务实例标识为Service_Instance_0，服务名为NsmfPduSes，支持的协议为http。

```
MOD PNFSERVICE: NFINSTANCEID="SMF_Instance_0", SRVINSTANCEID="Service_Instance_0", SERVICENAME=NsmfPduSes, SCHEMA=http, NFSERVICESTATUS=REGISTERED;
```
