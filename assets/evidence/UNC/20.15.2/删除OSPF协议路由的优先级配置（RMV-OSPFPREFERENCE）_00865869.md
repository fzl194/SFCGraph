# 删除OSPF协议路由的优先级配置（RMV OSPFPREFERENCE）

- [命令功能](#ZH-CN_CONCEPT_0000001600865869__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600865869__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600865869__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600865869__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600865869__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600865869)

该命令用于恢复OSPF协议路由的优先级默认配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001600865869)

- 该命令执行后立即生效。
- 当前OSPF路由优先级的两种路由类型ASE和default不支持删除操作。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600865869)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600865869)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600865869)
