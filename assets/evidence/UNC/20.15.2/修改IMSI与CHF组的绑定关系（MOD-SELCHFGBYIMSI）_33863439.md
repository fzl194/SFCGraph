# 修改IMSI与CHF组的绑定关系（MOD SELCHFGBYIMSI）

- [命令功能](#ZH-CN_MMLREF_0000001233863439__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001233863439__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001233863439__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001233863439__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001233863439)

**适用NF：SMF、PGW-C、GGSN**

该命令用于修改IMSI与CHF组的绑定关系。如果用户已经激活，执行该命令后，用户不会立即选择修改后的CHF发送计费信息，需要将该用户去激活以后重新激活，才能将该用户的计费信息发送到修改以后的CHF上。

## [注意事项](#ZH-CN_MMLREF_0000001233863439)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001233863439)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001233863439)
...
## [使用实例](#ZH-CN_MMLREF_0000001233863439)
