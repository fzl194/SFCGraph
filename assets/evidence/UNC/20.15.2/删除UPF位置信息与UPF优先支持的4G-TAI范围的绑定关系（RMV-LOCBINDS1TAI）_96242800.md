# 删除UPF位置信息与UPF优先支持的4G TAI范围的绑定关系（RMV LOCBINDS1TAI）

- [命令功能](#ZH-CN_MMLREF_0296242800__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296242800__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296242800__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296242800__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296242800)

**适用NF：SGW-C**

该命令用于删除UPF位置信息与UPF优先支持的TAI范围的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0296242800)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0296242800)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296242800)
