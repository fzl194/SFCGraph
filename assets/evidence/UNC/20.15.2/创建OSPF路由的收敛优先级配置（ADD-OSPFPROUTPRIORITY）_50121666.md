# 创建OSPF路由的收敛优先级配置（ADD OSPFPROUTPRIORITY）

- [命令功能](#ZH-CN_CONCEPT_0000001550121666__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121666__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121666__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121666__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121666__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121666)

该命令用于配置OSPF路由的收敛优先级。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121666)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121666)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121666)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121666)
