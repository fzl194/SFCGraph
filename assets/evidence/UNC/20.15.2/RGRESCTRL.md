# 设置RG资源控制配置（SET RGRESCTRL）

- [命令功能](#ZH-CN_MMLREF_0296243210__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243210__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243210__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243210__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243210)

**适用NF：PGW-C、SMF**

该命令用于设置RG老化功能以及RG超出规格后的处理动作。

## [注意事项](#ZH-CN_MMLREF_0296243210)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243210)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243210)
