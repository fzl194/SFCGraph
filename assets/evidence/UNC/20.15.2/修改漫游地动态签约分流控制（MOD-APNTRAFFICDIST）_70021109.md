# 修改漫游地动态签约分流控制（MOD APNTRAFFICDIST）

- [命令功能](#ZH-CN_MMLREF_0000001570021109__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001570021109__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001570021109__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001570021109__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001570021109)

**适用NF：SMF**

该命令用于修改指定的Selected DNN的漫游地动态签约分流控制。改变SMF发给CHF的消息中的Sponsor Identity、访地策略对应的计费用户模板名称，控制是否需要上报辅锚点UPF的用量以及控制园区内主锚点流量是否进行计费。

## [注意事项](#ZH-CN_MMLREF_0000001570021109)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001570021109)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001570021109)
...
## [使用实例](#ZH-CN_MMLREF_0000001570021109)
