# 修改5G语音部署配置（MOD NGVOICEDEPLOY）

- [命令功能](#ZH-CN_MMLREF_0000001231658511__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001231658511__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001231658511__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001231658511__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001231658511)

**适用NF：AMF**

该命令用于修改指定的5G网络接入时的IMS VoPS语音部署策略。

## [注意事项](#ZH-CN_MMLREF_0000001231658511)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001231658511)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001231658511)
...
## [使用实例](#ZH-CN_MMLREF_0000001231658511)
