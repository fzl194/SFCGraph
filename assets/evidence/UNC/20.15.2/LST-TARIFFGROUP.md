# 查询费率切换组（LST TARIFFGROUP）

- [命令功能](#ZH-CN_CONCEPT_0209896838__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896838__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896838__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896838__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896838__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209896838__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896838)

**适用NF：SGW-C、PGW-C、SMF**

该命令用于查询计费属性的已配置的费率切换组信息。如果不指定可选参数，该命令将显示所有配置的费率切换组信息。

#### [注意事项](#ZH-CN_CONCEPT_0209896838)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896838)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896838)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209896838)

参见ADD TARIFFGROUP的参数说明。
