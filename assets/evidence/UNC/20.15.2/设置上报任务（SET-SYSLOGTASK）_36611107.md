# 设置上报任务（SET SYSLOGTASK）

- [命令功能](#ZH-CN_MMLREF_0000001136611107__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001136611107__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001136611107__1.3.3)
- [使用实例](#ZH-CN_MMLREF_0000001136611107__1.3.4)
- [输出结果说明](#ZH-CN_MMLREF_0000001136611107__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001136611107)

![](设置上报任务（SET SYSLOGTASK）_36611107.assets/notice_3.0-zh-cn_2.png)
...
## [注意事项](#ZH-CN_MMLREF_0000001136611107)
...
## [参数说明](#ZH-CN_MMLREF_0000001136611107)
...
## [使用实例](#ZH-CN_MMLREF_0000001136611107)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001136611107)

该命令执行正常，会返回命令执行成功的提示信息。

该命令执行异常，会返回对应的错误码。常见的错误码如 [表1](#ZH-CN_MMLREF_0000001136611107__table0350152692312) 所示。
...
| 101111 | 查询时有多任务 | 停用上报任务时，任务处理异常，导致查询出多个任务。 | 请联系华为技术支持。 |
| 101113 | 请至少选择一种日志类型 | 启用上报任务时，未选择日志类型。 | 启用上报任务时，至少选择一种日志类型。 |
| 101114 | 当前选择的参数中存在不支持的日志类型 | 仅在Full-stack虚机场景下支持收集OS日志、OS安全日志、系统日志。 | 请取消勾选日志类型中的OS日志、OS安全日志、系统日志。 |
| 101115 | 任务数量达到上限3个 | 配置的第三方Syslog上报日志任务个数达到上限。 | 可删除一条第三方Syslog上报日志任务后再新增。 |
| 101117 | 不支持编辑网管Syslog任务，请在网管页面修改 | 不允许使用<br>[**SET SYSLOGTASK**](设置上报任务（SET SYSLOGTASK）_36611107.md)<br>命令编辑网管Syslog任务。 | 请在网管页面进行修改网管Syslog任务。 |
| 101118 | 描述超过最大长度 | 描述超过最大长度。 | 请重新输入描述信息。 |
