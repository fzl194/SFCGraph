# 增加指定归属地PLMN的拜访地策略（ADD NRFPLMNVISITPLY）

- [命令功能](#ZH-CN_MMLREF_0000001124956620__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001124956620__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001124956620__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001124956620__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001124956620)

**适用NF：NRF**

该命令用于增加NRF作为拜访地NRF时对指定归属地PLMN的跨PLMN交互处理策略。

## [注意事项](#ZH-CN_MMLREF_0000001124956620)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001124956620)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001124956620)
...
## [使用实例](#ZH-CN_MMLREF_0000001124956620)
