# 操作手动发送订阅通知（OPR NRFMANUSENDNTY）

- [命令功能](#ZH-CN_MMLREF_0000001171436549__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001171436549__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001171436549__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001171436549__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001171436549)

**适用NF：NRF**

此命令用于手动向NF发送订阅通知。

## [注意事项](#ZH-CN_MMLREF_0000001171436549)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001171436549)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001171436549)
...
## [使用实例](#ZH-CN_MMLREF_0000001171436549)
