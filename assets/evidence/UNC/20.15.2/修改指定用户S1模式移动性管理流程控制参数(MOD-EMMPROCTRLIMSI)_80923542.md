# 修改指定用户S1模式移动性管理流程控制参数(MOD EMMPROCTRLIMSI)

- [命令功能](#ZH-CN_TOPIC_0000002080923542__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000002080923542__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000002080923542__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000002080923542__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000002080923542__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000002080923542__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000002080923542)

**适用网元：MME**

此命令用于修改指定用户S1模式移动性管理流程控制参数。

#### [注意事项](#ZH-CN_TOPIC_0000002080923542)
...
#### [本地用户权限](#ZH-CN_TOPIC_0000002080923542)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_TOPIC_0000002080923542)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000002080923542)
...
#### [使用实例](#ZH-CN_TOPIC_0000002080923542)
