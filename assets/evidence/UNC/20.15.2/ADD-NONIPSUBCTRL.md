# 增加Non-IP APNNI配置(ADD NONIPSUBCTRL)

- [命令功能](#ZH-CN_MMLREF_0000001172225451__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225451__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225451__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225451__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225451__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225451__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225451)

**适用网元：MME**

此命令用于配置支持激活Non-IP类型PDN的APNNI。当HSS中未给用户签约Non-IP签约数据且需要使用Non-IP业务时，需要执行此命令。

#### [注意事项](#ZH-CN_MMLREF_0000001172225451)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225451)

manage-ug;system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225451)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225451)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225451)
