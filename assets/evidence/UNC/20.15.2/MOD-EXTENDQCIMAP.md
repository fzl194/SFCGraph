# 修改扩展QCI和标准QCI的映射关系（MOD EXTENDQCIMAP）

- [命令功能](#ZH-CN_MMLREF_0209653202__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653202__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653202__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653202__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653202)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于修改扩展QCI和标准QCI的映射关系，并用于指定扩展QCI的优先级。

## [注意事项](#ZH-CN_MMLREF_0209653202)

- 该命令执行后立即生效。

- 当使用MOD EXTENDQCIMAP命令修改扩展QCI的STANDARDQCI参数时，如果对应QCI属性用户在线，则可能导致带宽残留。EXTENDQCI的取值要与STDQOSID中配置的QOSIDSV-QOSIDEV的取值范围互斥。

#### [操作用户权限](#ZH-CN_MMLREF_0209653202)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653202)
