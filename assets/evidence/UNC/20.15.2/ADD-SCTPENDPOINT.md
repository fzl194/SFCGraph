# 增加SCTP端点（ADD SCTPENDPOINT）

- [命令功能](#ZH-CN_CONCEPT_0209897321__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897321__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897321__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897321__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897321__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897321)

**适用NF：PGW-C、SMF**

此命令用于增加SCTP端点信息。

#### [注意事项](#ZH-CN_CONCEPT_0209897321)

- 该命令执行后立即生效。
- 该命令最大记录数为60。
- 同一个Port下不能配置相同IP。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897321)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897321)
