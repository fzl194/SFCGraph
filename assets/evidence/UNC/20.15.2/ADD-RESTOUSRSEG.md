# 增加容灾用户号段参数 (ADD RESTOUSRSEG)

- [命令功能](#ZH-CN_CONCEPT_0000001310674069__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001310674069__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001310674069__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001310674069__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001310674069__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001310674069__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001310674069)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001310674069)

- 此命令的最大记录数为3000。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001310674069)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001310674069)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001310674069)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001310674069)
