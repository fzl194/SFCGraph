# 删除Proxy SMF接入控制列表（RMV PROXYSMFACCLIST）

- [命令功能](#ZH-CN_MMLREF_0000001870382381__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870382381__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870382381__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870382381__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870382381)

**适用NF：SMF**

该命令用于Proxy SMF特性中删除接入控制列表记录。

## [注意事项](#ZH-CN_MMLREF_0000001870382381)

- 该命令执行后只对新激活用户生效。

- SUBRANGE为ALL_USER的记录为默认记录，不允许删除。

#### [操作用户权限](#ZH-CN_MMLREF_0000001870382381)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870382381)
...
## [使用实例](#ZH-CN_MMLREF_0000001870382381)

删除用户范围为IMSI_PRE，前缀为27602的Proxy SMF接入列表记录，执行如下命令：

```
RMV PROXYSMFACCLIST: SUBRANGE=IMSI_PRE, PREFIX="27602";
```
