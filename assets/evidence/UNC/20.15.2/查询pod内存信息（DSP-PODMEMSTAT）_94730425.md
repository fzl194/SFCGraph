# 查询pod内存信息（DSP PODMEMSTAT）

- [命令功能](#ZH-CN_MMLREF_0294730425__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0294730425__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0294730425__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0294730425__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0294730425__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0294730425)

该命令用于查询所有被资源管理器管理的pod或指定pod内存信息。

## [注意事项](#ZH-CN_MMLREF_0294730425)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0294730425)

G_1，管理员级别命令组

## [参数说明](#ZH-CN_MMLREF_0294730425)
...
## [输出结果说明](#ZH-CN_MMLREF_0294730425)
...
| 网元ID | 该参数用于指定网元来查询pod的内存信息。 |
| 内存使用量(MB) | 本参数用于指定内存使用量。 |
| 内存使用率(%) | 本参数用于指定内存使用率。 |
| 内存总量(MB) | 本参数用于指定内存总量。 |
| 最大内存使用率(%) | 本参数用于指定进程启动以来最大内存使用率。 |
