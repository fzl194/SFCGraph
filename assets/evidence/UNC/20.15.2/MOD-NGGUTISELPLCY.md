# 修改AMF区域GUTI选网控制策略（MOD NGGUTISELPLCY）

- [命令功能](#ZH-CN_MMLREF_0000002013939889__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002013939889__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002013939889__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002013939889__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002013939889)

**适用NF：AMF**

该命令用于修改AMF区域GUTI选网功能控制策略。

## [注意事项](#ZH-CN_MMLREF_0000002013939889)

- 该命令执行后立即生效。

- 该命令增加、修改或者删除后，针对新接入的用户立即生效，对于已经接入的用户不会立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000002013939889)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002013939889)
...
## [使用实例](#ZH-CN_MMLREF_0000002013939889)
