# 增加服务发现NF Service负载均衡开关（ADD NFDISCSRVLBSW）

- [命令功能](#ZH-CN_MMLREF_0000001304217452__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001304217452__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001304217452__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001304217452__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001304217452)
...
## [注意事项](#ZH-CN_MMLREF_0000001304217452)

- 该命令执行后立即生效。

- 最多可输入30条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001304217452)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001304217452)
...
## [使用实例](#ZH-CN_MMLREF_0000001304217452)
