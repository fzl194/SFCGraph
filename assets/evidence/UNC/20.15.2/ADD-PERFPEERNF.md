# 增加NF局向性能统计对象（ADD PERFPEERNF）

- [命令功能](#ZH-CN_MMLREF_0209654373__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654373__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654373__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654373__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654373)

**适用NF：AMF、SMF、SMSF、NCG**

该命令用于增加NF局向性能统计对象。

## [注意事项](#ZH-CN_MMLREF_0209654373)

- 该命令执行后立即生效。

- 最多可输入1000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209654373)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654373)
