# 增加RADIUS NAS IP（ADD RADIUSNASIP）

- [命令功能](#ZH-CN_CONCEPT_0209896751__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896751__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896751__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896751__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896751__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896751)

**适用NF：SGW-C、PGW-C、SMF**

该命令用来基于APN实例增加RADIUS NAS IP配置。

#### [注意事项](#ZH-CN_CONCEPT_0209896751)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896751)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896751)
