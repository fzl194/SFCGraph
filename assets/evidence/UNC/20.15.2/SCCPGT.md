# 测试SCCP全局翻译码(TST SCCPGT)

- [命令功能](#ZH-CN_MMLREF_0000001126306138__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126306138__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126306138__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126306138__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126306138__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126306138__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126306138__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126306138)

**适用网元：SGSN、MME、SMSF**

此命令用于测试SCCP GT码是否能被正确解析，对匹配的GT码输出翻译结果。

#### [注意事项](#ZH-CN_MMLREF_0000001126306138)

- 系统会自行选取可用的信令进程（SPP/SGP），因此，执行该操作的时候要确保系统中有可用的信令进程。否则，操作将不能正常执行。
- 系统对输入的GT码进行最大匹配，匹配成功的输出翻译结果。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126306138)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126306138)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126306138)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126306138)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126306138)
