# 显示异常信息（DSP RESEXCEPTIONINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001151042757__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001151042757__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001151042757__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001151042757__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001151042757__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001151042757__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001151042757)

该命令用于显示当前系统中存在的异常信息。

当业务处理异常时，可执行该命令查看当前系统中是否存在异常信息，方便定位问题。

#### [注意事项](#ZH-CN_CONCEPT_0000001151042757)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001151042757)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001151042757)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001151042757)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001151042757)
...
| 异常子类型ID | 用于表示信号子类型号。 |
| 异常名称 | 用于表示异常名称。 |
| 资源名称 | 用于表示资源名称。通过<br>[**DSP RES**](../../../系统管理/资源管理/资源实例管理/显示资源信息（DSP RES）_59036939.md)<br>命令可以查询资源信息。 |
| 进程ID | 用于表示进程ID。 |
| 进程名称 | 用于表示进程名称。 |
| 异常发生时间 | 用于表示异常发生的时间。 |
