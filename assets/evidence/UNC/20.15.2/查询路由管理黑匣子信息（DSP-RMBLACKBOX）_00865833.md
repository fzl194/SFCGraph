# 查询路由管理黑匣子信息（DSP RMBLACKBOX）

- [命令功能](#ZH-CN_CONCEPT_0000001600865833__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600865833__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600865833__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600865833__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600865833__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600865833__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600865833)

该命令用来查询路由管理模块的黑匣子信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600865833)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600865833)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600865833)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600865833)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600865833)
