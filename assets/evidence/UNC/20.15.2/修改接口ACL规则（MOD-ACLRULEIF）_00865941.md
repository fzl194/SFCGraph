# 修改接口ACL规则（MOD ACLRULEIF）

- [命令功能](#ZH-CN_CONCEPT_0000001600865941__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600865941__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600865941__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600865941__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600865941__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600865941)

该命令用于修改接口ACL规则，可以修改要过滤报文的接口。

#### [注意事项](#ZH-CN_CONCEPT_0000001600865941)

- 该命令执行后立即生效。
- 修改ACL规则前必须先执行ADD ACLRULEIF创建相应规则。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600865941)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600865941)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600865941)
