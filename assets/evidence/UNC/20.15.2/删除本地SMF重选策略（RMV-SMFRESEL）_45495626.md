# 删除本地SMF重选策略（RMV SMFRESEL）

- [命令功能](#ZH-CN_MMLREF_0245495626__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0245495626__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0245495626__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0245495626__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0245495626)

**适用NF：AMF**

该命令用于删除一条本地SMF重选策略的配置记录。

## [注意事项](#ZH-CN_MMLREF_0245495626)

- 该命令执行后立即生效。

- 执行删除命令不配置SD时，默认删除SD值为“FFFFFF”的记录。

#### [操作用户权限](#ZH-CN_MMLREF_0245495626)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0245495626)
