# 修改本地服务区域限制（MOD SRVAREARES）

- [命令功能](#ZH-CN_MMLREF_0000001111935726__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001111935726__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001111935726__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001111935726__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001111935726)

**适用NF：AMF**

该命令用于修改本地配置的服务区域限制。

## [注意事项](#ZH-CN_MMLREF_0000001111935726)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001111935726)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001111935726)
...
| RESTYPE | 区域群属性 | 可选必选说明：可选参数<br>参数含义：该参数用于指定区域群属性。<br>数据来源：全网规划<br>取值范围：<br>- ALLOWED_AREAS（允许接入区域）<br>- NOT_ALLOWED_AREAS（不允许接入区域）<br>默认值：无<br>配置原则：无 |
...
## [使用实例](#ZH-CN_MMLREF_0000001111935726)

针对所有用户，修改本地服务区域限制策略，执行如下命令：

```
MOD SRVAREARES: SUBRANGE=ALL_USER;
```
