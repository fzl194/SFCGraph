# 增加UPF服务区名称绑定的5G TAI范围（ADD UPAREABINDN2TAI）

- [命令功能](#ZH-CN_MMLREF_0209653098__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653098__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653098__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653098__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653098)

**适用NF：SMF**

该命令用于增加UP服务区名称绑定的5G TAI范围。

## [注意事项](#ZH-CN_MMLREF_0209653098)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653098)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653098)
