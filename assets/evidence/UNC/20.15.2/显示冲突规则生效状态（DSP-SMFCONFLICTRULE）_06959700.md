# 显示冲突规则生效状态（DSP SMFCONFLICTRULE）

- [命令功能](#ZH-CN_MMLREF_0000001306959700__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001306959700__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001306959700__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001306959700__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001306959700__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001306959700)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于显示冲突规则生效状态。

## [注意事项](#ZH-CN_MMLREF_0000001306959700)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001306959700)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001306959700)
...
## [使用实例](#ZH-CN_MMLREF_0000001306959700)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001306959700)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 冲突流程生效规则 | 该参数用于显示冲突流程生效规则结果。 |
