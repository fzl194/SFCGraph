# 设置通信模块规则匹配开关（SET MSSCOMMMATCH）

- [命令功能](#ZH-CN_CONCEPT_0000001549961350__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961350__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961350__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961350__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961350__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961350)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001549961350)

- 该命令执行后立即生效。
- 本命令用于使能通信过滤规则开关，使能后会降低性能且在用户指定的时间之后会自动去使能，关闭后会恢复性能。默认时间是300秒。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961350)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961350)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961350)
