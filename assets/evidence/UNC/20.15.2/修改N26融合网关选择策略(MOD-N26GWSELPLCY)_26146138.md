# 修改N26融合网关选择策略(MOD N26GWSELPLCY)

- [命令功能](#ZH-CN_CONCEPT_0000001126146138__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001126146138__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001126146138__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001126146138__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001126146138__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001126146138__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001126146138)

**适用网元：MME**

该命令用于LTE和5G互通组网部署时，修改5G用户的融合PGW-C/SMF选择策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001126146138)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0000001126146138)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001126146138)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001126146138)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001126146138)
