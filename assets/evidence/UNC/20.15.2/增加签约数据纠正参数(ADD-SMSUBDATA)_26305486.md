# 增加签约数据纠正参数(ADD SMSUBDATA)

- [命令功能](#ZH-CN_MMLREF_0000001126305486__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305486__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305486__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305486__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305486__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305486__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305486)

**适用网元：SGSN、MME**

该命令用于增加一条签约数据修改的记录，修改IMSI号段、PDP TYPE、APN匹配的用户群的签约数据类型。使用该命令时建议设置软参DWORD_EX26 BIT13的值为1。

#### [注意事项](#ZH-CN_MMLREF_0000001126305486)

- 该命令执行后立即生效。
- 该表最大记录数为1024。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305486)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305486)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305486)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305486)
