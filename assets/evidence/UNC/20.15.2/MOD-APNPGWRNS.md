# 修改PGW重定向功能设置（MOD APNPGWRNS）

- [命令功能](#ZH-CN_MMLREF_0000001650919533__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001650919533__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001650919533__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001650919533__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001650919533)

**适用NF：PGW-C**

该命令用于修改PGW重定向功能设置。

## [注意事项](#ZH-CN_MMLREF_0000001650919533)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001650919533)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001650919533)
...
## [使用实例](#ZH-CN_MMLREF_0000001650919533)
