# 删除UPF与Gx UPF组的关联关系（RMV UPFBINDGXUPFGRP）

- [命令功能](#ZH-CN_CONCEPT_0000201616858409__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201616858409__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201616858409__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201616858409__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201616858409__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201616858409)

**适用NF：SGW-C、PGW-C、SMF**

此命令用于从Gx UPF组中删除指定的UPF。

#### [注意事项](#ZH-CN_CONCEPT_0000201616858409)

- 该命令执行后立即生效。
- 当不指定UPF时，是删除指定Gx UPF组中的所有UPF。当指定UPF时，是从指定组中移除该UPF。

#### [操作用户权限](#ZH-CN_CONCEPT_0000201616858409)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201616858409)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201616858409)
