# 修改NRF实例地址信息（MOD NRFADDR）

- [命令功能](#ZH-CN_MMLREF_0209651463__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651463__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651463__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651463__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651463)

**适用NF：AMF、SMF、NRF、NSSF、SMSF、NCG、CBCF**

该命令用于修改NRF实例地址信息。

## [注意事项](#ZH-CN_MMLREF_0209651463)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209651463)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651463)
...
| PORT | 端口 | 可选必选说明：该参数在"IPADDRESSTYPE"配置为"IPTypeV4"、"IPTypeV6"、"NoneIP"时为条件必选参数。<br>参数含义：该参数用于指定NRF的端口号。<br>数据来源：全网规划<br>取值范围：整数类型，取值范围是0~65535。<br>默认值：无<br>配置原则：<br>取值为0或不填时，如果关联的ADD NRF配置中TLS字段为TRUE，则使用443端口，反之则使用80端口。 |

## [使用实例](#ZH-CN_MMLREF_0209651463)

修改NRF地址信息，NRF实例名称为NRF_Instance_0，IP地址类型为IPV4类型，IPV4地址为192.168.0.1，端口号为8081。

```
MOD NRFADDR: NRFINSTANCENAME="NRF_Instance_0", IPADDRESSTYPE=IPTypeV4, IPV4ADDRESS="192.168.0.1", PORT=8081;
```
