# 修改语音承载保活(MOD VOLTEHOLDON)

- [命令功能](#ZH-CN_MMLREF_0000001126145724__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145724__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145724__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145724__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145724__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145724__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145724)

**适用网元：SGSN、MME**

该命令用于修改语音承载保活策略。

#### [注意事项](#ZH-CN_MMLREF_0000001126145724)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145724)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145724)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145724)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145724)

修改一条语音承载保活配置， “用户范围” 为 “HOME_USER” ， “运营商标识” 为 “1” ：

MOD VOLTEHOLDON: SUBRANGE=HOME_USER, NOID=1;
