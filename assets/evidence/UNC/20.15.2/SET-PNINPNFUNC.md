# 设置公网集成非公网络管理功能（SET PNINPNFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001222678343__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001222678343__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001222678343__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001222678343__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001222678343)

**适用NF：AMF**

此命令用于设置公网集成非公网络（PNI-NPN）管理功能。

## [注意事项](#ZH-CN_MMLREF_0000001222678343)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001222678343)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001222678343)
...
## [使用实例](#ZH-CN_MMLREF_0000001222678343)
