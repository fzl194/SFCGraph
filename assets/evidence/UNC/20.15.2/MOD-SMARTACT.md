# 修改激活抑制规则（MOD SMARTACT）

- [命令功能](#ZH-CN_MMLREF_0000001172345343__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345343__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345343__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345343__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345343__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345343__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345343)

**适用网元：SGSN**

此命令用于对用户终端已配置的激活抑制规则进行修改。

#### [注意事项](#ZH-CN_MMLREF_0000001172345343)

- 此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345343)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345343)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345343)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345343)
