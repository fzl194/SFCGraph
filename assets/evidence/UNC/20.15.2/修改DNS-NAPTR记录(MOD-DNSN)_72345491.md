# 修改DNS NAPTR记录(MOD DNSN)

- [命令功能](#ZH-CN_MMLREF_0000001172345491__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345491__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345491__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345491__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345491__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345491__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345491)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345491)

- 该命令执行后立即生效。
- 本次修改可能会更新本主机名的其他关联记录。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345491)

manage-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345491)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345491)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345491)
