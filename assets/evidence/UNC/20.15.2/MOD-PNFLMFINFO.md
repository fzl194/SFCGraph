# 修改对端LMF信息（MOD PNFLMFINFO）

- [命令功能](#ZH-CN_MMLREF_0000001102470584__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001102470584__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001102470584__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001102470584__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001102470584)

**适用NF：AMF**

该命令用于修改本地配置的对端LMF的信息。

## [注意事项](#ZH-CN_MMLREF_0000001102470584)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001102470584)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001102470584)
...
## [使用实例](#ZH-CN_MMLREF_0000001102470584)
