# 增加RRC Inactive生效的TAI范围（ADD RRCINACTTAI）

- [命令功能](#ZH-CN_MMLREF_0000001823782738__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001823782738__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001823782738__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001823782738__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001823782738)

**适用NF：AMF**

本命令用于增加RRC Inactive生效的TAI范围。

## [注意事项](#ZH-CN_MMLREF_0000001823782738)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001823782738)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001823782738)
...
## [使用实例](#ZH-CN_MMLREF_0000001823782738)
