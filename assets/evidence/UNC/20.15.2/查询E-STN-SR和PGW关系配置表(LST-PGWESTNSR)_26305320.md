# 查询E-STN-SR和PGW关系配置表(LST PGWESTNSR)

- [命令功能](#ZH-CN_MMLREF_0000001126305320__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305320__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305320__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305320__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305320__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305320__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126305320__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305320)

**适用网元：MME**

该命令用于查询SRVCC的紧急会话转移号码和P-GW关系配置表。 UNC 通过本命令查询出来的PGW IP来找到P-GW对应的“SRVCC的紧急会话转移号码”。与华为MSC设备对接需要配置本命令。

#### [注意事项](#ZH-CN_MMLREF_0000001126305320)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305320)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305320)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305320)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305320)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126305320)

请参考 [**ADD PGWESTNSR**](增加E-STN-SR和PGW关系配置表(ADD PGWESTNSR)_72345105.md) 命令参数说明。
