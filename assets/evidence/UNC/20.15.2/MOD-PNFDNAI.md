# 修改对端NF的DNAI信息（MOD PNFDNAI）

- [命令功能](#ZH-CN_MMLREF_0209653103__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653103__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653103__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653103__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653103)

**适用NF：AMF、SMF、NSSF、SMSF、NCG、PGW-C**

该命令用于修改本地配置的对端NF实例支持的数据网络接入标识信息。

## [注意事项](#ZH-CN_MMLREF_0209653103)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209653103)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653103)
