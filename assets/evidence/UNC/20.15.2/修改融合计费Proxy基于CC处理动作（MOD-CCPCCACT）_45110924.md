# 修改融合计费Proxy基于CC处理动作（MOD CCPCCACT）

- [命令功能](#ZH-CN_MMLREF_0245110924__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0245110924__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0245110924__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0245110924__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0245110924)

**适用NF：NCG**

该命令用于修改融合计费Proxy基于CC处理动作。

## [注意事项](#ZH-CN_MMLREF_0245110924)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0245110924)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0245110924)
