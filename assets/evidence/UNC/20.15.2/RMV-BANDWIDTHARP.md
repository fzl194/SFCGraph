# 删除基于带宽的ARP控制配置（RMV BANDWIDTHARP）

- [命令功能](#ZH-CN_MMLREF_0209653157__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653157__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653157__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653157__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653157)

**适用NF：SGW-C、PGW-C**

该命令用于删除当前APN配置带宽比例差异化服务配置。当需要取消指定用户级别和业务级别对应的拒绝、恢复告警门限时，使用此命令。此命令支持批量删除。

## [注意事项](#ZH-CN_MMLREF_0209653157)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209653157)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653157)
