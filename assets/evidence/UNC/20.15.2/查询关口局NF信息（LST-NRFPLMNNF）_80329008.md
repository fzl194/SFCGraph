# 查询关口局NF信息（LST NRFPLMNNF）

- [命令功能](#ZH-CN_MMLREF_0000001180329008__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001180329008__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001180329008__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001180329008__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001180329008__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001180329008)

**适用NF：NRF**

该命令用于查询本NRF管理的关口局NF。

## [注意事项](#ZH-CN_MMLREF_0000001180329008)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001180329008)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001180329008)
...
## [使用实例](#ZH-CN_MMLREF_0000001180329008)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001180329008)

| 输出项名称 | 输出项解释 |
| --- | --- |
| NF类型 | 该参数用于表示目的NF类型。 |
| NF实例标识 | 该参数用于表示本NRF管理的关口局NF实例标识。 |
| NF名称 | 该参数用于表示本NRF管理的关口局NF名称。 |
