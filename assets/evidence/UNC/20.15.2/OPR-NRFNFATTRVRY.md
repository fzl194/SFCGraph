# 操作执行NF属性冲突核验（OPR NRFNFATTRVRY）

- [命令功能](#ZH-CN_MMLREF_0000001135636461__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001135636461__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001135636461__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001135636461__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001135636461)

**适用NF：NRF**

该命令用于触发某个NF的属性冲突核验，核验参数可通过SET NRFVERIFYPARA命令设置。

## [注意事项](#ZH-CN_MMLREF_0000001135636461)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001135636461)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001135636461)
...
## [使用实例](#ZH-CN_MMLREF_0000001135636461)
