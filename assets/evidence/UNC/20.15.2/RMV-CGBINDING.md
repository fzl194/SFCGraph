# 删除CG绑定关系（RMV CGBINDING）

- [命令功能](#ZH-CN_CONCEPT_0209896876__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896876__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896876__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896876__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896876__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896876)

**适用NF：SGW-C、PGW-C、SMF**

该命令用来删除CG绑定关系。支持批量删除，给CGGRPID字段赋值，删除指定CGGRPID的记录；给CGGRPID和CGIPADDR/CGPORT字段赋值，删除满足条件的记录。

#### [注意事项](#ZH-CN_CONCEPT_0209896876)

- 该命令执行后立即生效。
- 删除CG绑定关系后，CG Group内无对应话单版本的CG可用时，将导致该版本的话单被本地缓存。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896876)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896876)
