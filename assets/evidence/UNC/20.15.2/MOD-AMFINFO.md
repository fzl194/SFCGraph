...
- [命令功能](#ZH-CN_MMLREF_0209651393__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651393__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651393__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651393__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651393)

**适用NF：AMF**

该命令用于修改AMF实例信息，如AMF实例的名称、相对容量等。

## [注意事项](#ZH-CN_MMLREF_0209651393)

- 该命令执行后立即生效。

- 非必要场景下，INTERPLMNFQDN参数不建议配置包含“_”字符的取值。

#### [操作用户权限](#ZH-CN_MMLREF_0209651393)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651393)
