# 修改OSPFv3区域配置（MOD OSPFV3AREA）

- [命令功能](#ZH-CN_CONCEPT_0000001600440849__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440849__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440849__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440849__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440849__1.3.5.1)
- [参考信息](#ZH-CN_CONCEPT_0000001600440849__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440849)

该命令用于修改OSPFv3进程下区域配置。

![](修改OSPFv3区域配置（MOD OSPFV3AREA）_00440849.assets/notice_3.0-zh-cn_2.png)

本命令属于高危命令，如果修改区域类型或者修改IPsec SA名称可能会使此区域的OSPFv3邻接关系中断。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440849)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440849)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440849)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440849)
...
#### [参考信息](#ZH-CN_CONCEPT_0000001600440849)
