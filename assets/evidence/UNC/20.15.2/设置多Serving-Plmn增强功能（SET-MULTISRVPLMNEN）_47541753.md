# 设置多Serving Plmn增强功能（SET MULTISRVPLMNEN）

- [命令功能](#ZH-CN_MMLREF_0000001447541753__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001447541753__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001447541753__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001447541753__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001447541753)

**适用NF：AMF**

该命令用于控制AMF在多Serving Plmn组网场景下支持移动性管理流程增强处理。

## [注意事项](#ZH-CN_MMLREF_0000001447541753)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001447541753)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001447541753)
...
## [使用实例](#ZH-CN_MMLREF_0000001447541753)
