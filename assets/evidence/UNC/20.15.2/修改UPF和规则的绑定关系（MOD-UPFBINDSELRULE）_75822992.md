# 修改UPF和规则的绑定关系（MOD UPFBINDSELRULE）

- [命令功能](#ZH-CN_MMLREF_0000001875822992__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001875822992__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001875822992__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001875822992__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001875822992)

**适用NF：SMF、PGW-C、SGW-C**

该命令用于修改UPF和规则的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0000001875822992)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001875822992)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001875822992)
...
## [使用实例](#ZH-CN_MMLREF_0000001875822992)
