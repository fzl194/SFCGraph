# 修改S1模式接入限制参数(MOD S1ARD)

- [命令功能](#ZH-CN_MMLREF_0000001126305290__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305290__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305290__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305290__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305290__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305290__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305290)

**适用网元：MME**

该命令用于修改S1模式接入限制参数。该命令先根据IMSI号段将用户进行分类，再对每一类用户按照用户签约的ARD信息、签约的APN信息进行区分而控制用户接入E-UTRAN网络。

#### [注意事项](#ZH-CN_MMLREF_0000001126305290)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305290)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305290)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305290)
...
| IMSIPRE | IMSI前缀 | 可选必选说明：条件必选参数<br>参数含义：该参数用于指定IMSI前缀。使用时按照IMSI完全匹配进行查询。<br>前提条件：该参数在<br>“SUBRANGE（用户范围）”<br>设置为<br>“SPECIAL_IMSIPRE(指定IMSI前缀)”<br>时生效。<br>数据来源：整网规划<br>取值范围：1～15位数字<br>默认值：无 |
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305290)

1. 修改所有用户的Iu模式接入限制记录，将控制类型修改为“允许”：
  MOD S1ARD: SUBRANGE=ALL_USER, CTRLTYPE=ALLOW;
2. 修改IMSI前缀为123456的Iu模式接入限制记录，将控制类型修改为“允许”：
  MOD S1ARD: SUBRANGE=SPECIAL_IMSIPRE, IMSIPRE="123456", CTRLTYPE=ALLOW;
