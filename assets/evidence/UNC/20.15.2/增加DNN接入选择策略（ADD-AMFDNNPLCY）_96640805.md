# 增加DNN接入选择策略（ADD AMFDNNPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001596640805__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001596640805__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001596640805__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001596640805__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001596640805)

**适用NF：AMF**

该命令用于AMF服务发现锚点SMF时增加DNN接入选择策略。

## [注意事项](#ZH-CN_MMLREF_0000001596640805)

- 该命令执行后立即生效。

- 最多可输入2048条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001596640805)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001596640805)
...
## [使用实例](#ZH-CN_MMLREF_0000001596640805)
