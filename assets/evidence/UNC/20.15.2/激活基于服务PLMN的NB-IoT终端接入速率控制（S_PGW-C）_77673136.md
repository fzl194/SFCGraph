# 激活基于服务PLMN的NB-IoT终端接入速率控制（S/PGW-C）

- [操作场景](#ZH-CN_OPI_0277673136__1.3.1)
- [必备事项](#ZH-CN_OPI_0277673136__1.3.2)
- [操作步骤](#ZH-CN_OPI_0277673136__1.3.3)
- [任务示例](#ZH-CN_OPI_0277673136__1.3.4)

## [操作场景](#ZH-CN_OPI_0277673136)

在 UNC 上激活基于服务PLMN的NB-IoT终端接入速率控制，SGW-C/PGW-C根据MME发来的速率控制信息，产生数据包的控制速率，对于超过门限的数据包，SGW-C/PGW-C进行丢包处理，未超过门限的数据包进行正常的转发处理。

> **说明**
> SGW-C、PGW-C

## [必备事项](#ZH-CN_OPI_0277673136)
