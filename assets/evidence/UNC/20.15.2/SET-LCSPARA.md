# 设置LCS参数表记录(SET LCSPARA)

- [命令功能](#ZH-CN_MMLREF_0000001172225477__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225477__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225477__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225477__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225477__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225477__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225477)

**适用网元：SGSN、MME**

此命令用于设置LCS参数，包括定时器时长等。

#### [注意事项](#ZH-CN_MMLREF_0000001172225477)

- 系统初次运行时，会执行系统初始设置值。
- 此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225477)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225477)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225477)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225477)
