...
- [命令功能](#ZH-CN_CONCEPT_0000001377595448__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001377595448__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001377595448__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001377595448__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001377595448__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001377595448__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001377595448)

**适用NF：SMSF**

该命令用于增加MSC信令点配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001377595448)

此命令的最大记录数为2。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001377595448)

manage-ug；system-ug;

#### [网管用户权限](#ZH-CN_CONCEPT_0000001377595448)

G_1，管理员级别命令组；G_2，操作员级别命令组;

#### [参数说明](#ZH-CN_CONCEPT_0000001377595448)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001377595448)
