# 删除用户的SMS上下文（RMV SMSCTX）

- [命令功能](#ZH-CN_MMLREF_0296243010__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243010__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243010__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243010__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243010)
...
## [注意事项](#ZH-CN_MMLREF_0296243010)

- 该命令执行后立即生效。

- 删除SMS上下文将影响用户正在进行的短消息业务，请慎重使用此命令。

#### [操作用户权限](#ZH-CN_MMLREF_0296243010)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243010)
