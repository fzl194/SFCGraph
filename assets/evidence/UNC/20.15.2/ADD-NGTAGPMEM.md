# 增加5G TA群组成员（ADD NGTAGPMEM）

- [命令功能](#ZH-CN_MMLREF_0000001609572742__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001609572742__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001609572742__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001609572742__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001609572742)

**适用NF：AMF**

该命令用于为ADD NGTAGP增加的跟踪区群组添加一条成员记录。

## [注意事项](#ZH-CN_MMLREF_0000001609572742)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001609572742)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001609572742)
...
## [使用实例](#ZH-CN_MMLREF_0000001609572742)
