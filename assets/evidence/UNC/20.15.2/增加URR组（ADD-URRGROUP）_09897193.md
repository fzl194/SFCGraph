...
- [命令功能](#ZH-CN_CONCEPT_0209897193__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897193__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897193__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897193__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897193__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897193)

**适用NF：PGW-C、SMF**

该命令用于新增使用量上报规则组，通过该命令可以指定上下行发起使用的URR名称，配置给用户使用该组规则，指定上下行报文如何进行PCC策略及计费。

#### [注意事项](#ZH-CN_CONCEPT_0209897193)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897193)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897193)
