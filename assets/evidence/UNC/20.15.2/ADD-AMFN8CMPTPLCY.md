# 增加AMF N8接口兼容性策略（ADD AMFN8CMPTPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001538983042__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001538983042__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001538983042__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001538983042__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001538983042)

**适用NF：AMF**

该命令用于对指定的用户（群）增加AMF N8接口兼容性策略，以满足运营商实现对现网UDM设备兼容性特殊控制的需求。

## [注意事项](#ZH-CN_MMLREF_0000001538983042)

- 下一次移动性流程生效。

- 最多可输入4096条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001538983042)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001538983042)
...
## [使用实例](#ZH-CN_MMLREF_0000001538983042)

设置外网用户和UDM交互时，不支持携带NR_REDCAP作为RatType，执行如下命令：

```
ADD AMFN8CMPTPLCY:SUBRANGE=FOREIGN_USER,REDCAPRAT=NO;
```
