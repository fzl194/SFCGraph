# 设置服务化接口链路集属性（SET SBILINKSETCFG）

- [命令功能](#ZH-CN_MMLREF_0000001183653668__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001183653668__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001183653668__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001183653668__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001183653668)

该命令用于设置服务化接口链路集的属性配置信息，该属性设置后整系统生效。

## [注意事项](#ZH-CN_MMLREF_0000001183653668)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001183653668)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001183653668)
...
## [使用实例](#ZH-CN_MMLREF_0000001183653668)
