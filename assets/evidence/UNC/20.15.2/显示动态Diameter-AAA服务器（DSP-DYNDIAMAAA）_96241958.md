# 显示动态Diameter AAA服务器（DSP DYNDIAMAAA）

- [命令功能](#ZH-CN_MMLREF_0296241958__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296241958__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296241958__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296241958__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0296241958__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0296241958)
...
## [注意事项](#ZH-CN_MMLREF_0296241958)

相同的动态Diameter AAA主机列表如果在多个Pod上都有，只会显示一条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0296241958)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0296241958)
...
## [输出结果说明](#ZH-CN_MMLREF_0296241958)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 主机名 | 该参数用于指定动态Diameter AAA的主机名。 |
| 域名 | 该参数用于指定Diameter服务器的realm名。 |
| POD名称 | 该参数用于指定POD名称。 |
