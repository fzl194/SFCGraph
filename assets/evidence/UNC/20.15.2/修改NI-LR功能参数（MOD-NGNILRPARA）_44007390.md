# 修改NI-LR功能参数（MOD NGNILRPARA）

- [命令功能](#ZH-CN_MMLREF_0244007390__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244007390__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244007390__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244007390__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244007390)

**适用NF：AMF**

该命令用于基于运营商修改NI-LR功能的参数。

## [注意事项](#ZH-CN_MMLREF_0244007390)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0244007390)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244007390)
