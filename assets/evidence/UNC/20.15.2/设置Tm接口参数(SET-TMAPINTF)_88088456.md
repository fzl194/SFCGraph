# 设置Tm接口参数(SET TMAPINTF)

- [命令功能](#ZH-CN_CONCEPT_0000001288088456__1.4.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001288088456__1.4.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001288088456__1.4.3.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001288088456__1.4.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001288088456__1.4.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001288088456__1.4.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001288088456)

**适用NF：MME**

本命令用于控制Tm接口的管理参数。

#### [注意事项](#ZH-CN_CONCEPT_0000001288088456)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001288088456)

manage-ug；system-ug

#### [操作用户权限](#ZH-CN_CONCEPT_0000001288088456)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001288088456)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001288088456)
