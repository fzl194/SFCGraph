# 显示用户IMSI信息（DSP NGIMSI）

- [命令功能](#ZH-CN_MMLREF_0000001609803702__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001609803702__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001609803702__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001609803702__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001609803702__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001609803702)

**适用NF：AMF**

该命令用于查询用户的IMSI信息。

## [注意事项](#ZH-CN_MMLREF_0000001609803702)

此功能用于快速定位问题和解决故障，在使用过程中不可避免的使用到用户的某些个人数据，如IMSI、INNERUSRID。建议您遵从国家的相关法律执行该任务，并采取足够的措施以确保用户的个人数据受到充分的保护。

#### [操作用户权限](#ZH-CN_MMLREF_0000001609803702)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001609803702)
...
## [使用实例](#ZH-CN_MMLREF_0000001609803702)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001609803702)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 内部用户标识 | 该参数用于表示5G用户的内部用户标识，内部用户标识的格式是<AMF Pointer><5G-TMSI>，其中AMF Pointer是2个十六进制数字，5G-TMSI是8个十六进制数字。 |
| AMF UE NGAP ID | 该参数用于表示AMF侧的终端NGAP连接标识，该标识由AMF分配，在同一个AMF Set内唯一。 |
