# 设置融合计费话单缓存告警上报的控制参数（SET STGALARMCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001088248962__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001088248962__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001088248962__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001088248962__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001088248962)

**适用NF：SMF、PGW-C**

该命令可通过配置告警产生门限、告警监控时长，对融合计费话单缓存告警（ALM-81025）的上报方式进行控制。

## [注意事项](#ZH-CN_MMLREF_0000001088248962)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001088248962)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001088248962)
...
## [使用实例](#ZH-CN_MMLREF_0000001088248962)
