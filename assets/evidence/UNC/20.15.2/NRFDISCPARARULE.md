# 设置NF服务发现参数处理规则（SET NRFDISCPARARULE）

- [命令功能](#ZH-CN_MMLREF_0000001135273633__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001135273633__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001135273633__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001135273633__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001135273633)

**适用NF：NRF**

该命令用于增加NRF发现参数处理规则。

## [注意事项](#ZH-CN_MMLREF_0000001135273633)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001135273633)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001135273633)
...
## [使用实例](#ZH-CN_MMLREF_0000001135273633)
