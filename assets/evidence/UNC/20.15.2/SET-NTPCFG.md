# 配置NTP时间同步参数(SET NTPCFG)

- [命令功能](#ZH-CN_MMLREF_0267679933__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0267679933__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0267679933__1.3.3)
- [使用实例](#ZH-CN_MMLREF_0267679933__1.3.4)
- [输出结果说明](#ZH-CN_MMLREF_0267679933__1.3.5)
- [参考信息](#ZH-CN_MMLREF_0267679933__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0267679933)
...
## [输出结果说明](#ZH-CN_MMLREF_0267679933)

命令执行正常，会返回命令执行成功的提示信息。

命令执行异常，请联系华为技术支持处理。输出结果说明如 [表1](#ZH-CN_MMLREF_0267679933__table1110753814403) 所示。

*表1 错误码说明*

| 错误码 | 错误码解释 | 原因分析 | 处理建议 |
| --- | --- | --- | --- |
| 130026 | 设置参数失败。 | 出现异常或者内部错误。 | 请联系华为技术支持。 |

## [参考信息](#ZH-CN_MMLREF_0267679933)
