# 查询组播组引流信息（DSP MCASTPAEGROUP）

- [命令功能](#ZH-CN_CONCEPT_0000001549801894__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801894__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801894__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801894__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801894__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001549801894__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801894)

该命令用于显示组播组引流信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801894)

该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801894)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801894)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801894)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001549801894)

| 输出项名称 | 输出项解释 |
| --- | --- |
| PAE Group索引 | 用来表示PAE Group索引。 |
| 组地址 | 用来表示组地址。 |
| 过滤模式 | 用来表示过滤模式，包括：<br>- Include模式。<br>- Exclude模式。 |
| 源数量 | 用来表示源数量。 |
| 表项建立时间 | 用来表示表项建立时间。 |
| 超时时间 | 用来表示超时时间。 |
