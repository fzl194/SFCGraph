# 删除离线计费模板或者属性（RMV OFCTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0209896913__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896913__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896913__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896913__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896913__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896913)

**适用NF：SGW-C、PGW-C、SMF**

此命令用于删除离线计费模板或恢复参数的默认值。当指定ATTRIBUTE参数时，则恢复对应参数的默认值，当不指定ATTRIBUTE时，则删除离线计费模板。

#### [注意事项](#ZH-CN_CONCEPT_0209896913)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896913)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896913)
