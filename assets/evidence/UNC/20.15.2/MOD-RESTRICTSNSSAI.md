# 修改受限的S-NSSAI（MOD RESTRICTSNSSAI）

- [命令功能](#ZH-CN_MMLREF_0209654388__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654388__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654388__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654388__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654388)

**适用NF：NSSF**

该命令用于修改受限的S-NSSAI列表。

## [注意事项](#ZH-CN_MMLREF_0209654388)

- 该命令执行后立即生效。

- 主备或双活组网的场景下，如果需要配置此命令，则两个NSSF上均需执行此命令，且配置参数一致。

#### [操作用户权限](#ZH-CN_MMLREF_0209654388)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654388)
