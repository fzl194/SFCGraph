# 修改基于带宽的ARP控制配置（MOD BANDWIDTHARP）

- [命令功能](#ZH-CN_MMLREF_0209652360__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652360__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652360__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652360__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652360)

**适用NF：SGW-C、PGW-C**

该命令用于修改指定APN配置带宽比例差异化服务。当需要为指定的用户级别、业务级别配置不同的拒绝、恢复告警门限时，使用此命令。

## [注意事项](#ZH-CN_MMLREF_0209652360)

- 该命令执行后立即生效。

- 参数RESTORELIMIT的值必须小于参数REJECTLIMIT的值。

#### [操作用户权限](#ZH-CN_MMLREF_0209652360)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652360)
