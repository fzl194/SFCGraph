# 设置APN粒度的UP选择策略（SET APNUPSELPLY）

- [命令功能](#ZH-CN_MMLREF_0296243087__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243087__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243087__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243087__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243087)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于控制APN粒度的UP选择策略。

## [注意事项](#ZH-CN_MMLREF_0296243087)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243087)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243087)
