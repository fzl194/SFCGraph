# 设置VoPS配置（SET NGIMSVOPS）

- [命令功能](#ZH-CN_MMLREF_0209653214__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653214__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653214__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653214__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653214)

**适用NF：AMF**

该命令用于设置AMF是否支持PS域IMS语音。

## [注意事项](#ZH-CN_MMLREF_0209653214)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653214)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653214)
