...
- [命令功能](#ZH-CN_TOPIC_0000001388832402__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001388832402__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000001388832402__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000001388832402__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000001388832402__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000001388832402__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000001388832402)

**适用网元：MME**

该命令用于增加一条QoS策略配置，制定特定用户群基于APN的QoS策略。

#### [注意事项](#ZH-CN_TOPIC_0000001388832402)
...
#### [本地用户权限](#ZH-CN_TOPIC_0000001388832402)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_TOPIC_0000001388832402)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001388832402)
...
#### [使用实例](#ZH-CN_TOPIC_0000001388832402)
