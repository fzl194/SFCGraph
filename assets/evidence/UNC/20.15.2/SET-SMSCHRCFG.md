# 设置SMS CHR单据上报策略（SET SMSCHRCFG）

- [命令功能](#ZH-CN_MMLREF_0000001353801290__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001353801290__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001353801290__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001353801290__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001353801290)

**适用NF：SMSF**

该命令用于设置SMS CHR单据上报策略。

## [注意事项](#ZH-CN_MMLREF_0000001353801290)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001353801290)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001353801290)
...
## [使用实例](#ZH-CN_MMLREF_0000001353801290)
