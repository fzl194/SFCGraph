# 删除智能分流专网DNN支持的服务区域（RMV MULDNNBINDAREA）

- [命令功能](#ZH-CN_MMLREF_0000001647819741__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001647819741__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001647819741__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001647819741__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001647819741)

**适用NF：SMF**

删除指定智能分流专网DNN支持的服务区域。

## [注意事项](#ZH-CN_MMLREF_0000001647819741)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001647819741)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001647819741)
...
## [使用实例](#ZH-CN_MMLREF_0000001647819741)
