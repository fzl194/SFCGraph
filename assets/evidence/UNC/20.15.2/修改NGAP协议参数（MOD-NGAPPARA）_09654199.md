# 修改NGAP协议参数（MOD NGAPPARA）

- [命令功能](#ZH-CN_MMLREF_0209654199__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654199__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654199__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654199__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654199)

**适用NF：AMF**

该命令用于修改NGAP的协议参数。

## [注意事项](#ZH-CN_MMLREF_0209654199)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209654199)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654199)
