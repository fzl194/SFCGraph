# 删除S1模式信令抑制规则(RMV S1SMARTRULE)

- [命令功能](#ZH-CN_MMLREF_0000001126305556__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305556__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305556__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305556__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305556__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305556__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305556)

**适用网元：MME**

该命令用于删除基于用户终端类型的信令抑制规则。当不需要对某种终端进行信令抑制时，需要执行此命令。

#### [注意事项](#ZH-CN_MMLREF_0000001126305556)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305556)

manage-ug; system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305556)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305556)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305556)
