# 增加IPv6 MPAC策略（ADD MPACV6POLICY）

- [命令功能](#ZH-CN_CONCEPT_0000001550281454__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281454__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281454__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281454__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281454__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281454)

该命令用于在设备上创建管理平面接入控制策略（IPv6）。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281454)

- 该命令执行后立即生效。
- 该命令最大记录数为16。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281454)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281454)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281454)
