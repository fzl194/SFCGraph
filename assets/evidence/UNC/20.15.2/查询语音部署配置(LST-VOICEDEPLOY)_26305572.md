# 查询语音部署配置(LST VOICEDEPLOY)

- [命令功能](#ZH-CN_MMLREF_0000001126305572__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305572__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305572__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305572__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305572__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305572__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126305572__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305572)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305572)

无

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305572)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305572)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305572)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305572)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126305572)

参见 [**ADD VOICEDEPLOY**](增加语音部署配置(ADD VOICEDEPLOY)_72345361.md) 的参数说明。
