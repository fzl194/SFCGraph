# 删除服务发现Service负载均衡功能（RMV NFDISCSRVLBSW）

- [命令功能](#ZH-CN_MMLREF_0000001304217460__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001304217460__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001304217460__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001304217460__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001304217460)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于删除服务发现时的NF Service负载均衡功能记录。

## [注意事项](#ZH-CN_MMLREF_0000001304217460)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001304217460)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001304217460)
...
## [使用实例](#ZH-CN_MMLREF_0000001304217460)

删除服务发现UDM时的NF Service负载均衡功能记录。

```
RMV NFDISCSRVLBSW: TARGETNFTYPE=NfUDM;
```
