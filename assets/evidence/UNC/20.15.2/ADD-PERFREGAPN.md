# 增加区域和APN性能统计对象（ADD PERFREGAPN）

- [命令功能](#ZH-CN_MMLREF_0244529798__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244529798__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244529798__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244529798__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244529798)

**适用NF：SGW-C、PGW-C**

该命令用于增加指定区域和APN的性能统计对象。

## [注意事项](#ZH-CN_MMLREF_0244529798)

- 该命令执行后立即生效。

- 最多可输入20000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0244529798)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244529798)
