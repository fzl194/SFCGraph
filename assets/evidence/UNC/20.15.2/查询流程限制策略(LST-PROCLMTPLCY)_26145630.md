# 查询流程限制策略(LST PROCLMTPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001126145630__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145630__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145630__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145630__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145630__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145630__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126145630__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145630)

**适用网元：SGSN、MME**

该命令用于查询流程限制策略。

#### [注意事项](#ZH-CN_MMLREF_0000001126145630)

此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145630)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145630)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145630)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145630)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126145630)

参见 [**ADD PROCLMTPLCY**](增加流程限制策略(ADD PROCLMTPLCY)_72225309.md) 命令的参数说明。
