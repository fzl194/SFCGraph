# 设置NF私有信息格式（SET NRFNFINFOFMT）

- [命令功能](#ZH-CN_MMLREF_0000001098288628__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001098288628__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001098288628__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001098288628__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001098288628)

**适用NF：NRF**

该命令用于设置服务发现、检索响应及通知请求中NF的私有信息字段格式。

## [注意事项](#ZH-CN_MMLREF_0000001098288628)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001098288628)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001098288628)
...
## [使用实例](#ZH-CN_MMLREF_0000001098288628)
