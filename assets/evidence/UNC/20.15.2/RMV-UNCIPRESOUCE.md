# 删除UNC接口IP地址（RMV UNCIPRESOUCE）

- [命令功能](#ZH-CN_MMLREF_0000001568625989__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001568625989__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001568625989__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001568625989__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001568625989)

**适用NF：SGSN、MME、SGW-C、PGW-C、AMF、SMF、NRF、NSSF、GGSN、SMSF、NCG**

该命令用于删除已经上报至网管北向的UNC网元业务或者管理接口的IP地址。

## [注意事项](#ZH-CN_MMLREF_0000001568625989)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001568625989)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001568625989)
...
## [使用实例](#ZH-CN_MMLREF_0000001568625989)
