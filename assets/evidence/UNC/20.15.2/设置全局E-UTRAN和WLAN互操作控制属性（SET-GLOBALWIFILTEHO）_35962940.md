# 设置全局E-UTRAN和WLAN互操作控制属性（SET GLOBALWIFILTEHO）

- [命令功能](#ZH-CN_MMLREF_0000001135962940__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001135962940__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001135962940__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001135962940__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001135962940)

**适用NF：PGW-C**

该命令用于控制全局E-UTRAN和WLAN互操作属性。

## [注意事项](#ZH-CN_MMLREF_0000001135962940)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001135962940)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001135962940)
...
## [使用实例](#ZH-CN_MMLREF_0000001135962940)
