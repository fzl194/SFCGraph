# 查询命令层异常返回码处理动作（LST CMDRCACT）

- [命令功能](#ZH-CN_CONCEPT_0209896948__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896948__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896948__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896948__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896948__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209896948__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896948)

**适用NF：PGW-C、SMF**

该命令用于查询命令层异常返回码的处理动作配置。

#### [注意事项](#ZH-CN_CONCEPT_0209896948)

仅输入在线计费模板名称参数，查询结果为该在线计费模板下的所有命令层异常返回码处理动作。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896948)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896948)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209896948)
