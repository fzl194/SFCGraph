# 增加NF支持的网络切片（ADD NFNS）

- [命令功能](#ZH-CN_MMLREF_0209651407__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651407__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651407__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651407__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651407)

**适用NF：AMF、SMF、NSSF**

该命令用以给指定的NF增加其所支持的网络切片。

## [注意事项](#ZH-CN_MMLREF_0209651407)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651407)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651407)
