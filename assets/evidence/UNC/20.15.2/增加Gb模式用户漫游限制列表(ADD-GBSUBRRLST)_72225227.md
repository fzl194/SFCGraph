# 增加Gb模式用户漫游限制列表(ADD GBSUBRRLST)

- [命令功能](#ZH-CN_MMLREF_0000001172225227__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225227__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225227__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225227__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225227__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225227__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225227)

**适用网元：SGSN**

该命令用于增加Gb模式用户漫游限制列表，此命令可基于“用户范围”配置禁止或允许某用户范围接入的“黑名单”、“白名单”区域，控制用户是否允许接入当前所在的区域。

#### [注意事项](#ZH-CN_MMLREF_0000001172225227)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225227)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225227)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225227)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225227)
