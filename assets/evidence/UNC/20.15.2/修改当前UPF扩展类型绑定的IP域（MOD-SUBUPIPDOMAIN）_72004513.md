# 修改当前UPF扩展类型绑定的IP域（MOD SUBUPIPDOMAIN）

- [命令功能](#ZH-CN_MMLREF_0000001672004513__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001672004513__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001672004513__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001672004513__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001672004513)

**适用NF：PGW-C、SMF**

该命令用于修改当前UPF扩展类型绑定IPDomain。

## [注意事项](#ZH-CN_MMLREF_0000001672004513)

- 该命令执行后立即生效。

- IPDOMAIN参数为大小写敏感，需要确保本端IPDOMAIN配置大小写与对端网元请求的IPDOMAIN保持一致。

#### [操作用户权限](#ZH-CN_MMLREF_0000001672004513)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001672004513)
...
## [使用实例](#ZH-CN_MMLREF_0000001672004513)

修改UPNODE为"upf_instance_1"的UPF与IPDomain的绑定关系:

```
MOD SUBUPIPDOMAIN: UPNODE="upf_instance_1", IPDOMAIN="Domain_1", BINDINGTYPE=VpnInstance, VPNINSTANCE="vpn1";
```
