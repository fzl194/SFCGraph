# 增加融合计费Proxy Failover模板（ADD CCPFOT）

- [命令功能](#ZH-CN_MMLREF_0245110907__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0245110907__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0245110907__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0245110907__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0245110907)

**适用NF：NCG**

该命令用于增加融合计费Proxy Failover模板。

## [注意事项](#ZH-CN_MMLREF_0245110907)
...
#### [操作用户权限](#ZH-CN_MMLREF_0245110907)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0245110907)
