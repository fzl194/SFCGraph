# 设置SMF扩展功能（SET SMFFUNC）

- [命令功能](#ZH-CN_MMLREF_0209653731__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653731__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653731__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653731__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653731)

**适用NF：SMF**

该命令用于修改会话管理相关的功能控制，如是否支持兴趣区（AOI）、是否支持本地数据网络、支持哪种业务和会话连续性模式等参数。

## [注意事项](#ZH-CN_MMLREF_0209653731)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653731)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653731)
