# 设置GTP-C T3/N3参数配置(SET T3N3)

- [命令功能](#ZH-CN_MMLREF_0000001126305730__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305730__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305730__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305730__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305730__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305730__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001126305730__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305730)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305730)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305730)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305730)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305730)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305730)
...
#### [参考信息](#ZH-CN_MMLREF_0000001126305730)

*表1 GTP路径的T3和N3系统初始设置值*

| GTP版本 | 消息分类 | 消息类型 | T3-RESPONSE(s) | 多跳消息T3增量 | N3-REQUEST(times) | 多跳消息N3增量 |
| --- | --- | --- | --- | --- | --- | --- |
| GTPv0 | 路径管理 | Echo Request | 5 | 0 | 3 | 0 |
| GTPv0 | 隧道管理 | 生成PDP上下文请求 | 8 | 0 | 2 | 0 |
| GTPv0 | 隧道管理 | 更新PDP上下文请求 | 7 | 0 | 2 | 0 |
| GTPv0 | 隧道管理 | 删除PDP上下文请求 | 7 | 0 | 2 | 0 |
| GTPv0 | 隧道管理 | 生成AA PDP上下文请求 | 7 | 0 | 2 | 0 |
| GTPv0 | 隧道管理 | 删除AA PDP上下文请求 | 7 | 0 | 2 | 0 |
| GTPv0 | 隧道管理 | PDU Notification拒绝请求 | 7 | 0 | 2 | 0 |
| GTPv0 | 位置管理 | Send Routeing Information for GPRS Request | 7 | 0 | 2 | 0 |
| GTPv0 | 位置管理 | Failure Report Request | 7 | 0 | 2 | 0 |
| GTPv0 | 位置管理 | Note MS GPRS Present Request | 7 | 0 | 2 | 0 |
| GTPv0 | 移动管理 | Identification Request | 7 | 0 | 2 | 0 |
| GTPv0 | 移动管理 | SGSN Context Request | 8 | 0 | 2 | 0 |
| GTPv0 | 移动管理 | SGSN Context Response | 3 | 0 | 2 | 0 |
| GTPv1 | 路径管理 | Echo Request | 5 | 0 | 3 | 0 |
| GTPv1 | 隧道管理 | 生成PDP上下文请求 | 8 | 0 | 2 | 0 |
| GTPv1 | 隧道管理 | 更新PDP上下文请求 | 7 | 0 | 2 | 0 |
| GTPv1 | 隧道管理 | 删除PDP上下文请求 | 7 | 0 | 2 | 0 |
| GTPv1 | 隧道管理 | PDU Notification拒绝请求 | 7 | 0 | 2 | 0 |
| GTPv1 | 位置管理 | Send Routeing Information for GPRS Request | 7 | 0 | 2 | 0 |
| GTPv1 | 位置管理 | Failure Report Request | 7 | 0 | 2 | 0 |
| GTPv1 | 位置管理 | Note MS GPRS Present Request | 7 | 0 | 2 | 0 |
| GTPv1 | 移动管理 | Identification Request | 3 | 0 | 2 | 0 |
| GTPv1 | 移动管理 | SGSN Context Request | 3 | 0 | 2 | 0 |
| GTPv1 | 移动管理 | SGSN Context Response | 3 | 0 | 2 | 0 |
| GTPv1 | 移动管理 | Forward Relocation Request | 3 | 0 | 2 | 0 |
| GTPv1 | 移动管理 | Forward Relocation Complete | 7 | 0 | 2 | 0 |
| GTPv1 | 移动管理 | Relocation Cancel Request | 7 | 0 | 2 | 0 |
| GTPv1 | 移动管理 | Forward SRNS Context | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | MBMS Session Start Response | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | MBMS Notification Reject Request | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | Create MBMS Context Request | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | Update MBMS Context Request | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | Delete MBMS Context Request | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | MBMS Registration Request | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | MBMS De-Registration Request | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | MBMS Session Stop Response | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | MBMS Session Update Response | 7 | 0 | 2 | 0 |
| GTPv1 | 多媒体广播和多播业务 | MS Info Change Notification Request | 7 | 0 | 2 | 0 |
| GTPv2 | 路径管理 | Echo Request | 5 | 0 | 3 | 0 |
| GTPv2 | 隧道管理 | Create Session Request | 3 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Update User Plane Request | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Modify Bearer Request | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Delete Session Request | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Modify Bearer Command | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Delete Bearer Command | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Bearer Resource Command | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Create Indirect Data Forwarding Tunnel Request | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Delete Indirect Data Forwarding Tunnel Request | 7 | 0 | 2 | 0 |
| GTPv2 | 隧道管理 | Release Access Bearers Request | 7 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | SRVCC PS to CS Request | 3 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | SRVCC PS to CS Complete Notification | 3 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | SRVCC PS to CS Cancel Notification | 3 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Change Notification Request | 7 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Identification Request | 3 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Context Request | 3 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Context Response | 3 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Forward Relocation Request | 3 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Forward Relocation Complete Notification | 7 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Forward SRNS Context Notification | 7 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Relocation Cancel Request | 7 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Detach Notification | 7 | 0 | 2 | 0 |
| GTPv2 | 移动管理 | Context Request Extended | 3 | 0 | 2 | 0 |
| GTPv2 | CS Fallback相关 | GMT暂停通知 | 3 | 0 | 2 | 0 |
| GTPv2 | CS Fallback相关 | GMT重新开始 | 7 | 0 | 2 | 0 |
| GTPv2 | Non-3GPP access相关 | GMT创建转发隧道 | 7 | 0 | 2 | 0 |
| GTPv2 | AMF移动管理 | Identification Request(NG) | 3 | 0 | 2 | 0 |
| GTPv2 | AMF移动管理 | Context Request(NG) | 3 | 0 | 2 | 0 |
| GTPv2 | AMF移动管理 | Context Response(NG) | 3 | 0 | 2 | 0 |
| GTPv2 | AMF移动管理 | Forward Relocation Request(NG) | 3 | 0 | 2 | 0 |
| GTPv2 | AMF移动管理 | Forward Relocation Complete Notification(NG) | 3 | 0 | 2 | 0 |
| GTPv2 | AMF移动管理 | Relocation Cancel Request(NG) | 3 | 0 | 2 | 0 |
