# 查询跟踪区域码分组记录（LST TACGROUPINNSSF）

- [命令功能](#ZH-CN_MMLREF_0218715634__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0218715634__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0218715634__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0218715634__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0218715634__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0218715634)

**适用NF：NSSF**

该命令用于查询跟踪区域码分组记录。

## [注意事项](#ZH-CN_MMLREF_0218715634)

无

#### [操作用户权限](#ZH-CN_MMLREF_0218715634)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0218715634)
...
## [输出结果说明](#ZH-CN_MMLREF_0218715634)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 索引 | 该参数用于描述命令的索引值。 |
| 跟踪区域码分组名称 | 该参数用于描述跟踪区代码分组的名称。 |
