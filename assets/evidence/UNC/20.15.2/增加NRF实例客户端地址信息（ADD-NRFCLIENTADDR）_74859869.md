# 增加NRF实例客户端地址信息（ADD NRFCLIENTADDR）

- [命令功能](#ZH-CN_MMLREF_0274859869__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0274859869__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0274859869__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0274859869__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0274859869)

**适用NF：NRF**

该命令用于添加NRF实例客户端地址信息。在对接真实NRF的场景下，如果下一跳NRF client和server地址不同时，需要增加配置client地址。

## [注意事项](#ZH-CN_MMLREF_0274859869)
...
#### [操作用户权限](#ZH-CN_MMLREF_0274859869)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0274859869)
