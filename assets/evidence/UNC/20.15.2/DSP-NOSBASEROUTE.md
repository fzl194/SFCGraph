# 查询NOS Base平面网络的路由信息（DSP NOSBASEROUTE）

- [命令功能](#ZH-CN_TOPIC_0000001299020492__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001299020492__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000001299020492__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000001299020492__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000001299020492__1.3.5.1)
- [输出结果说明](#ZH-CN_TOPIC_0000001299020492__1.3.7.1)

#### [命令功能](#ZH-CN_TOPIC_0000001299020492)

该命令用于查询NOS Base平面网络的路由信息。

#### [注意事项](#ZH-CN_TOPIC_0000001299020492)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_TOPIC_0000001299020492)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001299020492)
...
#### [使用实例](#ZH-CN_TOPIC_0000001299020492)
...
#### [输出结果说明](#ZH-CN_TOPIC_0000001299020492)
