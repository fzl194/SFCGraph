# 显示Gresm资源信息（DSP GRESMRESINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001600441029__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441029__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441029__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441029__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441029__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600441029__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441029)

该命令用于显示本设备上APP使用的Gresm资源信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441029)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441029)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441029)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441029)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600441029)

| 输出项名称 | 输出项解释 |
| --- | --- |
| APP ID | 用于表示APP ID。 |
| 资源类型 | 用于表示资源类型包括label、iid。 |
| 资源状态 | 用于表示资源状态包括normal、once-error、twice-error。 |
| 资源ID | 用于表示资源ID。 |
