# 修改服务发现自适应流控NF级配置（MOD DISCADAPTFC）

- [命令功能](#ZH-CN_MMLREF_0000001310850094__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001310850094__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001310850094__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001310850094__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001310850094)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于修改服务发现自适应流控NF级配置。

## [注意事项](#ZH-CN_MMLREF_0000001310850094)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001310850094)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001310850094)
...
## [使用实例](#ZH-CN_MMLREF_0000001310850094)
