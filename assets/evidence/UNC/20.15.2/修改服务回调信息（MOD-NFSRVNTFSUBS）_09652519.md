# 修改服务回调信息（MOD NFSRVNTFSUBS）

- [命令功能](#ZH-CN_MMLREF_0209652519__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652519__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652519__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652519__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652519)

**适用NF：AMF、SMF、NRF、NSSF、NCG**

该命令用于修改服务实例的回调信息。

## [注意事项](#ZH-CN_MMLREF_0209652519)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652519)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652519)
...
## [使用实例](#ZH-CN_MMLREF_0209652519)

运营商A需要修改NFINSTANCENAME为AMF_Instance_0，SRVINSTANCEID为Service_Instance_0的服务实例的回调信息，通知类型为N1Msg，回调URI为http://192.168.0.2:8080/newCallbackFunc。

```
MOD NFSRVNTFSUBS: NFINSTANCENAME="AMF_Instance_0", SRVINSTANCEID="Service_Instance_0", NTFICATIONTYPE=N1Msg, CALLBACKURI="http://192.168.0.2:8080/newCallbackFunc";
```
