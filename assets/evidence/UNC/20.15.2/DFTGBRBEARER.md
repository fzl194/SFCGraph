# 设置缺省GBR承载参数（SET DFTGBRBEARER）

- [命令功能](#ZH-CN_CONCEPT_0209897061__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897061__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897061__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897061__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897061__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897061)

**适用NF：PGW-C、SMF**

该命令用于配置SMF是否支持创建default-gbr承载（提供最低带宽保障的any to any GBR专有承载），该承载可由PCF/PCRF发起创建，也可以由SMF发起创建。

#### [注意事项](#ZH-CN_CONCEPT_0209897061)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897061)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897061)
