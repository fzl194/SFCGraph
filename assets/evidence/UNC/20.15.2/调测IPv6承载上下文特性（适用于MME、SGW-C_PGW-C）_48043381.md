# 调测IPv6承载上下文特性（适用于MME、SGW-C/PGW-C）

- [操作场景](#ZH-CN_OPI_0248043381__1.3.1)
- [必备事项](#ZH-CN_OPI_0248043381__1.3.2)
- [操作步骤](#ZH-CN_OPI_0248043381__1.3.3)

## [操作场景](#ZH-CN_OPI_0248043381)
...
## [必备事项](#ZH-CN_OPI_0248043381)

前提条件

- 请仔细阅读[WSFD-104001 IPv6承载上下文特性概述（MME、SGW-C/PGW-C）](特性概述_48043369.md)。

- 完成[激活IPv6承载上下文特性（适用于MME、SGW-C/PGW-C）](激活IPv6承载上下文特性（适用于MME、SGW-C_PGW-C）_48043351.md)。
