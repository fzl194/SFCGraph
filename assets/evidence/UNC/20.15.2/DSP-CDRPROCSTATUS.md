# 显示话单处理状态（DSP CDRPROCSTATUS）

- [命令功能](#ZH-CN_CONCEPT_0251174315__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0251174315__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0251174315__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0251174315__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0251174315__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0251174315__1.3.6.1)
- [输出结果说明](#ZH-CN_CONCEPT_0251174315__1.3.7.1)

#### [命令功能](#ZH-CN_CONCEPT_0251174315)
...
#### [注意事项](#ZH-CN_CONCEPT_0251174315)

无。

#### [本地用户权限](#ZH-CN_CONCEPT_0251174315)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0251174315)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0251174315)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0251174315)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 接入网元分组标识 | 用于区分不同域的接入网元。 |
| 模块名 | 用于表示一个业务模块对象，全局唯一。 |
| 当前处理的原始话单文件名 | 用于返回当前处理的原始话单文件名。 |
| 上次处理的原始话单包ID | 用于返回上次处理的原始话单包ID。 |
| 上次处理的话单包大小 | 用于返回上次处理的话单包大小。单位为Byte。 |
| 上次处理的话单包的话单数量 | 用于返回上次处理的话单包的话单数量。单位为张。 |
| 待合并的话单大小 | 用于返回待合并的话单大小。单位为Byte。 |
| 待合并的话单数量 | 用于返回待合并的话单数量。单位为张。 |
| 原始话单缓冲区话单数量 | 用于返回原始话单缓冲区话单数量。单位为张。 |
| 最终话单缓冲区话单数量 | 用于返回最终话单缓冲区话单数量。单位为张。 |
