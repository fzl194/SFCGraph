# 设置AMF服务化接口兼容性参数（SET AMFSBICMPT）

- [命令功能](#ZH-CN_MMLREF_0000001398011756__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001398011756__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001398011756__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001398011756__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001398011756)

**适用NF：AMF**

该命令用于设置AMF服务化接口兼容性参数，以满足运营商实现对现网设备兼容性特殊控制的需求。

## [注意事项](#ZH-CN_MMLREF_0000001398011756)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001398011756)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001398011756)
...
## [使用实例](#ZH-CN_MMLREF_0000001398011756)
