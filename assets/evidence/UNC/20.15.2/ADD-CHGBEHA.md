# 增加计费行为参数(ADD CHGBEHA)

- [命令功能](#ZH-CN_MMLREF_0000001126145366__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145366__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145366__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145366__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145366__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145366__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145366)

**适用网元：SGSN**

该命令用于增加计费行为参数。计费行为是指对特定费率的用户计费时的特殊处理，例如向指定的CG发送话单。

#### [注意事项](#ZH-CN_MMLREF_0000001126145366)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126145366)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145366)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145366)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145366)
