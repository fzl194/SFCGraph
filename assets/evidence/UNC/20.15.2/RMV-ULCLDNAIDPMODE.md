# 删除指定DNAI的ULCL部署模式（RMV ULCLDNAIDPMODE）

- [命令功能](#ZH-CN_MMLREF_0000001362084041__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001362084041__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001362084041__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001362084041__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001362084041)

**适用NF：SMF**

该命令用于删除指定DNAI的ULCL部署模式。

## [注意事项](#ZH-CN_MMLREF_0000001362084041)

- 该命令执行后立即生效。

- 删除本配置后，如果没有更细粒度的配置，在此DNAI内的ULCL部署模式由更粗粒度的配置(ULCLAPNDPMODE)控制。

#### [操作用户权限](#ZH-CN_MMLREF_0000001362084041)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001362084041)
...
## [使用实例](#ZH-CN_MMLREF_0000001362084041)
