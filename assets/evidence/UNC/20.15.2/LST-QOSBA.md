...
- [命令功能](#ZH-CN_CONCEPT_0000001600441337__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441337__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441337__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441337__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441337__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600441337__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441337)

该命令用来查询当前域的上行IP报文的DSCP值或者上行VLAN报文的802.1p的值对应路由器内部的服务等级，还有相应的报文着色策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441337)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441337)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441337)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441337)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600441337)
...
| ba值 | 该参数用于表示优先级。 |
| 服务分类 | 该参数用来表示服务等级。 |
| 颜色分类 | 该参数用来表示报文着色的颜色，缺省情况下为green。 |
