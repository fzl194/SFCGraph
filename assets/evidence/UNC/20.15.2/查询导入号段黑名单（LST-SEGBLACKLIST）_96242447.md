# 查询导入号段黑名单（LST SEGBLACKLIST）

- [命令功能](#ZH-CN_MMLREF_0296242447__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296242447__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296242447__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296242447__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0296242447__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0296242447)
...
## [注意事项](#ZH-CN_MMLREF_0296242447)

无

#### [操作用户权限](#ZH-CN_MMLREF_0296242447)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0296242447)
...
## [输出结果说明](#ZH-CN_MMLREF_0296242447)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 号段类型 | 该参数用于表示号段黑名单作用的号段类型。 |
| NF类型 | 该参数用于表示号段黑名单作用的NF类型，即哪些NF类型支持号段文件中给出的号段信息。 |
| 号段起始字符串 | 该参数用于表示号段黑名单起始字符串。 |
| 号段结束字符串 | 该参数用于表示号段黑名单结束字符串。 |
| 组标识 | 该参数用于表示待配置IMSI/MSISDN号段黑名单的NF组标识或配置IMSIRT/MSISDNRT路由转发号段黑名单的下一跳NRF组标识。 |
