# 查询SOCK黑匣子诊断信息（DSP SOCKBLACKBOX）

- [命令功能](#ZH-CN_CONCEPT_0000001550280726__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280726__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280726__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280726__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280726__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001550280726__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280726)

该命令用于查询SOCK黑匣子诊断信息。

不指定CID参数时，查询所有SOCK的诊断信息，当指定CID参数时，查询指定SOCK诊断信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280726)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280726)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280726)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280726)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001550280726)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 查询结果信息 | 用来显示SOCK的查询结果数据。 |
