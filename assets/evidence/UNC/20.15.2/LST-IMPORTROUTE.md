# 查询指定协议中的入口路由配置（LST IMPORTROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001600440661__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440661__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440661__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440661__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440661__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600440661__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440661)

该命令用于查询设备上BGP VPN实例下通过Import方式引入其他协议路由的配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440661)

- 该命令执行后立即生效。
- 如果未指定引入路由协议类型，将查询指定BGP VPN实例下所有通过Import方式引入其他协议路由的配置信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440661)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440661)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440661)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600440661)

参见ADD IMPORTROUTE的参数说明。
