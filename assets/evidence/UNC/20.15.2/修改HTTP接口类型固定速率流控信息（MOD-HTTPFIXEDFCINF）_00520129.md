# 修改HTTP接口类型固定速率流控信息（MOD HTTPFIXEDFCINF）

- [命令功能](#ZH-CN_MMLREF_0000001700520129__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001700520129__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001700520129__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001700520129__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001700520129)

该命令用于修改HTTP接口类型固定速率流控门限值信息。

## [注意事项](#ZH-CN_MMLREF_0000001700520129)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001700520129)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001700520129)
...
## [使用实例](#ZH-CN_MMLREF_0000001700520129)
