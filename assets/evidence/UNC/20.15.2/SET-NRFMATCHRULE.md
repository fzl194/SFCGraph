# 设置服务发现最长匹配处理规则（SET NRFMATCHRULE）

- [命令功能](#ZH-CN_MMLREF_0000001088248960__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001088248960__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001088248960__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001088248960__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001088248960)

**适用NF：NRF**

该命令用于设置服务发现时是否开启最长匹配规则。

## [注意事项](#ZH-CN_MMLREF_0000001088248960)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001088248960)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001088248960)
...
## [使用实例](#ZH-CN_MMLREF_0000001088248960)
