# 增加CG绑定关系（ADD CGBINDING）

- [命令功能](#ZH-CN_CONCEPT_0209896874__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896874__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896874__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896874__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896874__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896874)

**适用NF：SGW-C、PGW-C、SMF**

该命令用来增加CG绑定关系。

#### [注意事项](#ZH-CN_CONCEPT_0209896874)

- 该命令执行后立即生效。
- 该命令最大记录数为1024。
- 用户选定CG Group后，CG优先级使用绑定CG到CG Group时指定的优先级，不使用配置CG时指定的优先级。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896874)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896874)
