# 增加虚拟APN映射策略配置（ADD VIRTUALAPNRULE）

- [命令功能](#ZH-CN_MMLREF_0209652380__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652380__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652380__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652380__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652380)

**适用NF：SMF、PGW-C、GGSN**

该命令用于配置指定虚拟APN的映射规则。虚拟APN功能是指多个用户访问不同的PDN时，可携带相同的APN，此APN作为虚拟APN，通过本命令配置的虚拟APN映射规则，匹配到用户的真实APN，从而接入不同的PDN。

## [注意事项](#ZH-CN_MMLREF_0209652380)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652380)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652380)
