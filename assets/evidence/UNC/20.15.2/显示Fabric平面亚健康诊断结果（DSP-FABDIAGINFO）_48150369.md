# 显示Fabric平面亚健康诊断结果（DSP FABDIAGINFO）

- [命令功能](#ZH-CN_MMLREF_0000002148150369__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002148150369__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002148150369__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002148150369__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000002148150369__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000002148150369)
...
## [注意事项](#ZH-CN_MMLREF_0000002148150369)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000002148150369)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002148150369)
...
## [使用实例](#ZH-CN_MMLREF_0000002148150369)
...
## [输出结果说明](#ZH-CN_MMLREF_0000002148150369)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 进程名称 | 该参数用于表示Fabric亚健康的进程名称。 |
| Pod名称 | 该参数用于表示Fabric亚健康的Pod的名称。 |
| 节点名称 | 该参数用于表示Fabric亚健康的节点名称。 |
| 主机名称 | 该参数用于表示Fabric亚健康的主机名称。 |
| 平面组ID | 该参数用于表示Fabric亚健康的平面组ID。 |
| 平面ID | 该参数用于表示Fabric亚健康的平面ID。 |
| 端口名称 | 该参数用于表示Fabric亚健康的端口名称。 |
| 端口通信方向 | 该参数用于表示Fabric亚健康的端口通信方向。 |
| 亚健康链路数 | 该参数用于表示Fabric亚健康的链路数量。 |
| 亚健康链路占比(%) | 该参数用于表示Fabric亚健康的链路数和总链路的比重。 |
| 亚健康诊断时间 | 该参数用于表示Fabric亚健康的诊断时间。 |
