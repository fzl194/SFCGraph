# 修改S1寻呼规则(MOD S1PAGINGRULE)

- [命令功能](#ZH-CN_MMLREF_0000001126146248__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146248__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146248__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146248__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146248__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146248__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146248)

**适用网元：MME**

此命令用于修改S1寻呼规则。通过此命令可以修改指定S1寻呼规则的 “匹配优先级” 、 “寻呼动作组合” 和 “规则描述” 。

#### [注意事项](#ZH-CN_MMLREF_0000001126146248)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126146248)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146248)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146248)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146248)
