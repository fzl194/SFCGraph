# 设置SMF的UDM全故障Bypass相关功能（SET SMFUDMBYPASS）

- [命令功能](#ZH-CN_MMLREF_0000001177037100__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001177037100__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001177037100__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001177037100__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001177037100)

**适用NF：SMF**

该命令用于设置SMF的UDM全故障Bypass功能。当用户要求UDM全故障时业务能惯性运行，需要设置该功能。

## [注意事项](#ZH-CN_MMLREF_0000001177037100)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001177037100)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001177037100)
...
## [使用实例](#ZH-CN_MMLREF_0000001177037100)
