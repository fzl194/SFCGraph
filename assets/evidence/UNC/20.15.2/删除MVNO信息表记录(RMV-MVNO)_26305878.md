# 删除MVNO信息表记录(RMV MVNO)

- [命令功能](#ZH-CN_MMLREF_0000001126305878__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305878__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305878__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305878__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305878__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305878__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305878)

**适用网元：SGSN、MME**

该命令用于删除MNO的配置信息。

#### [注意事项](#ZH-CN_MMLREF_0000001126305878)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305878)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305878)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305878)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| MVNOID | MVNO标识 | 可选必选说明：必选参数<br>参数含义：该参数用于指定MVNO的标识。<br>取值范围：1～64<br>默认值：无 |

#### [使用实例](#ZH-CN_MMLREF_0000001126305878)
