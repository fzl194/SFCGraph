# 增加BGP路由首选值设置（ADD APPLYPREFVALUE）

- [命令功能](#ZH-CN_CONCEPT_0000001549961906__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961906__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961906__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961906__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961906__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961906)

该命令用于增加BGP路由首选值设置。使用ADD APPLYPREFVALUE命令配置优先级后，在不同协议发现到达同一目的地的不同路由时，优先级高的路由协议发现的路由将作为当前的有效路由。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961906)

- 该命令执行后立即生效。
- 该命令最大记录数为1。
- 配置该命令前，必须首先配置ADD ROUTEPOLICYNODE命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961906)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961906)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961906)
