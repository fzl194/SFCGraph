# 设置SMSF/VLR选择SMSC的相关参数（SET ROUTSMSCPARA）

- [命令功能](#ZH-CN_MMLREF_0000001403961141__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001403961141__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001403961141__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001403961141__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001403961141)

**适用NF：SMSF**

该命令用于设置SMSF/VLR选择SMSC的相关参数。

## [注意事项](#ZH-CN_MMLREF_0000001403961141)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001403961141)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001403961141)
...
## [使用实例](#ZH-CN_MMLREF_0000001403961141)
