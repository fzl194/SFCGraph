# 查询IMSI对应的Diameter兼容性(LST DMCMPTBYIMSI)

- [命令功能](#ZH-CN_MMLREF_0000001126146300__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146300__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146300__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146300__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146300__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146300__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126146300__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146300)

**适用网元：SGSN、MME**

该命令用于查询Diameter兼容性参数策略。

#### [注意事项](#ZH-CN_MMLREF_0000001126146300)

无

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146300)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146300)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146300)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146300)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126146300)

参见 [**ADD DMCMPTBYIMSI**](增加IMSI对应的Diameter兼容性(ADD DMCMPTBYIMSI)_72225977.md) 的参数说明。
