# 修改UDM Bypass最小签约数据配置（MOD UDMBYPASSSUB）

- [命令功能](#ZH-CN_MMLREF_0000001232414327__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001232414327__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001232414327__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001232414327__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001232414327)

**适用NF：AMF**

该命令用于对指定的用户（群）修改UDM Bypass最小签约数据配置。

## [注意事项](#ZH-CN_MMLREF_0000001232414327)

执行本命令后，仅针对用户新流程生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001232414327)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001232414327)
...
## [使用实例](#ZH-CN_MMLREF_0000001232414327)
