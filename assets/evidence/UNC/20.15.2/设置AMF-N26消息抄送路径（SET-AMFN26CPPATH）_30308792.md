# 设置AMF N26消息抄送路径（SET AMFN26CPPATH）

- [命令功能](#ZH-CN_CONCEPT_0000001630308792__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001630308792__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001630308792__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001630308792__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001630308792__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001630308792__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001630308792)

**适用网元：MME、AMF**

该命令用于4/5G融合部署时，对于AMF/MME内部的4/5G互操作流程，AMF/MME支持通过该命令配置的路径，抄送一条重复N26消息报文。

#### [注意事项](#ZH-CN_CONCEPT_0000001630308792)

- 该命令执行后立即生效。
- 该功能只在特定局点生效，请联系华为技术支持确认是否可以使用。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001630308792)

manage-ug；system-ug。

#### [网管用户权限](#ZH-CN_CONCEPT_0000001630308792)

G_1，管理员级别命令组；G_2，操作员级别命令组。

#### [参数说明](#ZH-CN_CONCEPT_0000001630308792)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001630308792)
