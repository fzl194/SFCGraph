# 增加删除团体属性过滤器设置（ADD APPLYCOMMUNITYFILTERDELETE）

- [命令功能](#ZH-CN_CONCEPT_0000001549802186__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802186__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802186__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802186__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802186__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802186)

该命令用来根据团体属性过滤器中指定的值删除BGP路由团体属性。

#### [注意事项](#ZH-CN_CONCEPT_0000001549802186)

- 该命令执行后立即生效。
- 该命令最大记录数为65535。
- 配置该命令前，必须已经通过ADD ROUTEPOLICY配置了指定路由策略的名字以及通过ADD ROUTEPOLICYNODE配置了该策略下的节点。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802186)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802186)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802186)
