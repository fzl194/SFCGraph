# 修改接口IPv6地址（MOD IFIPV6ADDRESS）

- [命令功能](#ZH-CN_CONCEPT_0000001600841693__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841693__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841693__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841693__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841693__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841693)

该命令用于修改接口的IPv6地址前缀。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841693)

- 该命令执行后立即生效。
- 该命令可以在VNRS_VNFC的Ethernet接口，Ethernet子接口，Eth-Trunk接口，Eth-Trunk子接口以及Loopback口，Tunnel口上配置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841693)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841693)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841693)
