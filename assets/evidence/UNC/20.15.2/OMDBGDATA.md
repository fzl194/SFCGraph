# 显示OM模块的调试信息（DSP OMDBGDATA）

- [命令功能](#ZH-CN_MMLREF_0000001463666972__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001463666972__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001463666972__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001463666972__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001463666972__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001463666972)

此命令用于查询当前网元OM服务或组件的调试信息。

该命令的使用场景：在OM服务或组件日常维护场景下，进行维护调试。

## [注意事项](#ZH-CN_MMLREF_0000001463666972)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001463666972)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001463666972)
...
## [使用实例](#ZH-CN_MMLREF_0000001463666972)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001463666972)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 进程ID | 该参数用于指定进程ID。可以通过DSP MSPROCESS命令查询。 |
| 进程类型名称 | 该参数用于指定进程类型名称。可以通过DSP MSPROCTYPE命令查询获取。 |
| 调试输出 | 该参数用于表示对应模块返回的调试结果。 |
