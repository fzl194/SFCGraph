# 设置Diameter兼容性(SET DMCMPT)

- [命令功能](#ZH-CN_MMLREF_0000001126306080__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126306080__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126306080__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126306080__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126306080__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126306080__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126306080)

**适用网元：SGSN、MME**

该命令用于设置Diameter兼容性参数，用于保证网元间支持信元的兼容性。

#### [注意事项](#ZH-CN_MMLREF_0000001126306080)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126306080)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126306080)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126306080)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126306080)
