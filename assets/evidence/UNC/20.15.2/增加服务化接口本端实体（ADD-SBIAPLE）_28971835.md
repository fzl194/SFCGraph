...
- [命令功能](#ZH-CN_MMLREF_0000001228971835__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001228971835__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001228971835__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001228971835__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001228971835)

该命令用于增加本端服务化接口接入点信息，即本端服务化接口实体，供基于服务化接口的业务使用。当本端NF需要和目的NF之间建立服务化连接时，需要添加本配置。

## [注意事项](#ZH-CN_MMLREF_0000001228971835)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001228971835)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001228971835)
...
## [使用实例](#ZH-CN_MMLREF_0000001228971835)
