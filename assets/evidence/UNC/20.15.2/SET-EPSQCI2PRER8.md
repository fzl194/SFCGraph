# 设置EPS QCI到Pre-R8 QoS映射规则（SET EPSQCI2PRER8）

- [命令功能](#ZH-CN_MMLREF_0209651491__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651491__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651491__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651491__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651491)

**适用NF：PGW-C、GGSN**

该命令用来配置在SAE架构下，Rel-8 QoS参数和Pre Rel-8 (R99/R98) QoS参数的映射规则。关于本命令所配置参数的具体含义参见协议3GPP TS 23.107。

## [注意事项](#ZH-CN_MMLREF_0209651491)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651491)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651491)
