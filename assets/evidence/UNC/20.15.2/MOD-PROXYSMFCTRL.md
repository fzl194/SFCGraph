# 修改proxy SMF控制（MOD PROXYSMFCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001591763225__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001591763225__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001591763225__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001591763225__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001591763225)

**适用NF：SMF**

该命令用于修改PROXYSMFCTRL配置。

## [注意事项](#ZH-CN_MMLREF_0000001591763225)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001591763225)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001591763225)
...
## [使用实例](#ZH-CN_MMLREF_0000001591763225)
