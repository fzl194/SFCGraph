# 删除Radius Group Client IP接口（RMV RADIUSCLIENTIP）

- [命令功能](#ZH-CN_CONCEPT_0209896741__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896741__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896741__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896741__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896741__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896741)
...
#### [注意事项](#ZH-CN_CONCEPT_0209896741)

- 该命令执行后立即生效。
- 当未指定接口名称时，禁止执行该命令。若需要执行，需将软参BYTE976的值设置为169。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896741)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896741)
