# 显示GTP-U路径(DSP GTPUPATH)

- [命令功能](#ZH-CN_MMLREF_0000001126305650__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305650__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305650__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305650__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305650__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305650__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126305650__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305650)

**适用网元：SGSN、MME**

该命令用于查询GTP-U路径信息，如果输入的路径在系统中已经存在则输出这条路径的信息。

#### [注意事项](#ZH-CN_MMLREF_0000001126305650)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305650)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305650)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305650)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305650)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126305650)
...
| 进程序号 | GTP-U路径所在进程的序号。 |
| GTP路径数目 | 按照输入条件查询出来的GTP-U路径数量。 |
| GTP版本 | 说明本路径的GTP版本，目前是GTPv0或GTPv1。<br>取值说明：<br>- GTPv0<br>- GTPv1 |
| 本端IP地址 | 无。 |
| 对端IP地址 | 无。 |
| GTP路径状态 | 描述该路径是处于正常状态或是路径断的状态。<br>取值说明：<br>- 正常<br>- 故障 |
| GTP路径属性 | 路径种类，说明此路径的属性。<br>取值说明：<br>- 空<br>- 到GGSN的路径说明：当<br>“PLMN网元间的接口”<br>为<br>“S4接口”<br>时，GGSN代表SGW设备。<br>- 到SGSN的路径<br>- 到RNC的路径<br>- 到SGW的路径<br>- 路径管理 |
| GTP路径上PDP数 | 描述该路径上的PDP上下文数量。 |
| 剩余生存时间（秒） | 描述该路径在系统中还能存在多久。 |
| PLMN网元间的接口 | 说明<br>UNC<br>与对端网元间的接口类型。<br>取值说明：<br>- 未确定接口<br>- Gn接口<br>- Gp接口<br>- S4接口<br>- S16接口<br>- Iu接口<br>- S11接口 |
