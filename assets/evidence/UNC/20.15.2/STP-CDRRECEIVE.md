# 停止接收话单（STP CDRRECEIVE）

- [命令功能](#ZH-CN_CONCEPT_0251174326__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0251174326__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0251174326__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0251174326__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0251174326__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0251174326__1.3.6.1)
- [输出结果说明](#ZH-CN_CONCEPT_0251174326__1.3.7.1)

#### [命令功能](#ZH-CN_CONCEPT_0251174326)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0251174326)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0251174326)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0251174326)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0251174326)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 接入网元分组标识 | 用于区分不同域的接入网元。 |
| RU的ID | RU的ID。 |
| 模块名 | 用于标识一个业务模块对象，全局唯一。 |
| 执行结果 | 停止话单接收命令执行结果。 |
