# 设置AMF的UDM故障BYPASS功能（SET AMFUDMBYPASS）

- [命令功能](#ZH-CN_MMLREF_0000001226366865__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001226366865__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001226366865__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001226366865__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001226366865)

**适用NF：AMF**

该命令用于设置AMF的UDM全故障BYPASS功能。

## [注意事项](#ZH-CN_MMLREF_0000001226366865)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001226366865)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001226366865)
...
## [使用实例](#ZH-CN_MMLREF_0000001226366865)
