# 删除对端UPF信息（RMV PNFUPFINFO）

- [命令功能](#ZH-CN_MMLREF_0209654161__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654161__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654161__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654161__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654161)

**适用NF：SMF、PGW-C、SGW-C、GGSN**

该命令用于删除本地配置的对端UPF实例的相关信息。

## [注意事项](#ZH-CN_MMLREF_0209654161)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209654161)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654161)
