# 增加LAIVLR黑名单(ADD LAIVLRBLACKLIST)

- [命令功能](#ZH-CN_CONCEPT_0000001126305238__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001126305238__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001126305238__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001126305238__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001126305238__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001126305238__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001126305238)

**适用网元：MME**

该命令用于MSC POOL场景下，当BSC与某个或多个MSC连接中断但与其它MSC连接正常时，增加LAI与MSC/VLR的黑名单对应关系。 UNC 选择黑名单以外MSC POOL内的其它正常MSC/VLR进行服务。

#### [注意事项](#ZH-CN_CONCEPT_0000001126305238)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0000001126305238)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001126305238)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001126305238)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001126305238)
