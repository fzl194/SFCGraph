# 增加代理IMSI/MSISDN号段（ADD PRIMSIMSISDNSEG）

- [命令功能](#ZH-CN_MMLREF_0000001142853258__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001142853258__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001142853258__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001142853258__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001142853258)

**适用NF：PGW-C、GGSN、SGW-C、SMF**

该命令用于增加代理IMSI/MSISDN号段。

## [注意事项](#ZH-CN_MMLREF_0000001142853258)

- 该命令执行后立即生效。

- 最多可输入12000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001142853258)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001142853258)
...
## [使用实例](#ZH-CN_MMLREF_0000001142853258)
