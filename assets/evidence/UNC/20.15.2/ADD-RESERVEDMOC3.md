# 新增补丁预留MOC3（ADD RESERVEDMOC3）

- [命令功能](#ZH-CN_MMLREF_0250558741__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0250558741__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0250558741__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0250558741__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0250558741)

**适用NF：AMF、SMF、NRF、SMSF、SGSN、MME、SGW-C、PGW-C、GGSN、NCG、NSSF**

新增补丁预留MOC3。

## [注意事项](#ZH-CN_MMLREF_0250558741)

- 该命令执行后立即生效。

- 最多可输入500条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0250558741)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0250558741)
