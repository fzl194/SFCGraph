# 增加对应PODTYPE下CPU的阈值配置（ADD PODHEALCPUTHR）

- [命令功能](#ZH-CN_MMLREF_0000002160073345__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002160073345__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002160073345__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002160073345__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002160073345)

当前版本此命令可正常下发，但配置不生效。

该命令用于增加对应PODTYPE下CPU的阈值配置。

## [注意事项](#ZH-CN_MMLREF_0000002160073345)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000002160073345)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002160073345)
...
## [使用实例](#ZH-CN_MMLREF_0000002160073345)
