# 增加UPF位置信息与该UPF优先支持的服务区的绑定关系（ADD LOCBINDAREA）

- [命令功能](#ZH-CN_MMLREF_0209653286__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653286__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653286__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653286__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653286)
...
## [注意事项](#ZH-CN_MMLREF_0209653286)

- 使用命令SET UPSELECTFLAG将LOCALITY开关置为ENABLE时生效。

- 最多可输入8192条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209653286)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653286)
