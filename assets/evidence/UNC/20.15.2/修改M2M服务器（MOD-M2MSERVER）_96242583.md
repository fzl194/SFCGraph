# 修改M2M服务器（MOD M2MSERVER）

- [命令功能](#ZH-CN_MMLREF_0296242583__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296242583__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296242583__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296242583__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296242583)

**适用NF：PGW-C、SMF**

该命令用来修改M2M服务器组下的M2M服务器的相关属性。

## [注意事项](#ZH-CN_MMLREF_0296242583)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0296242583)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296242583)
