# 设置本地地址池使用率告警参数（SET POOLALMPARA）

- [命令功能](#ZH-CN_MMLREF_0000001192057522__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001192057522__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001192057522__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001192057522__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001192057522)

**适用NF：PGW-C、SMF、GGSN**

为了即时监控地址池使用率，UNC提供了“地址池使用率超阈值”告警。该命令用于设置地址池使用率告警的产生阈值和恢复阈值。

## [注意事项](#ZH-CN_MMLREF_0000001192057522)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001192057522)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001192057522)
...
## [使用实例](#ZH-CN_MMLREF_0000001192057522)
