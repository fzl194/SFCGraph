# 删除EPS QoS控制动作配置（RMV EPSQOSACTION）

- [命令功能](#ZH-CN_MMLREF_0209652277__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652277__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652277__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652277__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652277)

**适用NF：PGW-C**

该命令用于删除4G用户QoS上下行保证带宽门限、最高带宽门限以及带宽超过门限值时对QoS用户的处理动作。

## [注意事项](#ZH-CN_MMLREF_0209652277)

命令执行后只对新接入用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652277)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652277)
