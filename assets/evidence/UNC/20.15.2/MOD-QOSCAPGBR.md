# 修改GBR承载QoS限制配置(MOD QOSCAPGBR)

- [命令功能](#ZH-CN_MMLREF_0000001126306028__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126306028__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126306028__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126306028__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126306028__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126306028__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126306028)

**适用网元：MME**

该命令用于修改一条GBR承载QoS限制配置记录，限制特定用户群GBR承载的EPS QoS。当运营商希望对漫游用户等特殊群体的GBR承载应用特殊的QoS策略时，可以使用该命令对指定用户的GBR承载EPS QoS进行限制。

#### [注意事项](#ZH-CN_MMLREF_0000001126306028)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126306028)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126306028)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126306028)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126306028)
