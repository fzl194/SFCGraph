# 删除UPF与用户漫游类型的绑定关系（RMV ROAMTYPEBINDUP）

- [命令功能](#ZH-CN_MMLREF_0000001451465242__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001451465242__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001451465242__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001451465242__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001451465242)

**适用NF：GGSN、SGW-C、PGW-C、SMF**

该命令用于删除UPF与用户漫游类型的绑定关系，对非ULCL场景生效。

## [注意事项](#ZH-CN_MMLREF_0000001451465242)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001451465242)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001451465242)
...
## [使用实例](#ZH-CN_MMLREF_0000001451465242)
