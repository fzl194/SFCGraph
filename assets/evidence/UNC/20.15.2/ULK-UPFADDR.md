...
- [命令功能](#ZH-CN_MMLREF_0000001450361721__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001450361721__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001450361721__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001450361721__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001450361721)

**适用NF：SGW-C、GGSN、PGW-C、SMF**

该命令用于解锁UPF地址。解锁后新激活的用户可以选择该UPF地址建立PFCP会话。

## [注意事项](#ZH-CN_MMLREF_0000001450361721)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001450361721)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001450361721)
...
## [使用实例](#ZH-CN_MMLREF_0000001450361721)
