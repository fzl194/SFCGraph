# 增加APN和DNS关联的APN组的绑定关系（ADD SMFAPNGRPMEM）

- [命令功能](#ZH-CN_MMLREF_0000001088248942__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001088248942__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001088248942__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001088248942__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001088248942)

**适用NF：PGW-C、SMF、GGSN**

该命令用于添加APN和DNS关联的APN组的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0000001088248942)

- 该命令执行后立即生效。

- 最多可输入3000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001088248942)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001088248942)
...
## [使用实例](#ZH-CN_MMLREF_0000001088248942)
