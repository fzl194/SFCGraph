...
- [命令功能](#ZH-CN_MMLREF_0209653118__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653118__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653118__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653118__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653118)

**适用NF：GGSN**

该命令用来删除指定的LAC组。当LAC组下绑定LAC号段时，同时可以删除该LAC组下的所有绑定的LAC号段。

## [注意事项](#ZH-CN_MMLREF_0209653118)

- 该命令执行后立即生效。

- 当LAC组被作为映射规则在ADD VIRTUALAPNRULE命令中配置的时候，如果需要删除这个LAC组，需要先使用RMV VIRTUALAPNRULE命令解除该LAC组对应的所有虚拟APN映射关系，再删除该LAC组，否则删除命令执行失败。

#### [操作用户权限](#ZH-CN_MMLREF_0209653118)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653118)
