# 创建OSPF区域配置（ADD OSPFAREA）

- [命令功能](#ZH-CN_CONCEPT_0000001550120650__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550120650__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550120650__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550120650__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550120650__1.3.5.1)
- [参考信息](#ZH-CN_CONCEPT_0000001550120650__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550120650)

该命令用于在OSPF进程下创建区域。

#### [注意事项](#ZH-CN_CONCEPT_0000001550120650)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550120650)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550120650)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550120650)
...
#### [参考信息](#ZH-CN_CONCEPT_0000001550120650)
