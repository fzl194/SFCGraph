# 修改GTP-C V2协议兼容性(MOD GTPCV2CMPT)

- [命令功能](#ZH-CN_MMLREF_0000001126145926__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145926__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145926__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145926__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145926__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145926__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145926)

**适用网元：SGSN、MME**

该命令用于修改GTP-C V2协议的兼容性配置。当 UNC 产品协议升级时，或与对端产生协议兼容性问题时，可以通过此命令修改GTP-C V2消息的配置信息。

#### [注意事项](#ZH-CN_MMLREF_0000001126145926)

- 此命令执行后立即生效。
- “消息分类”、“消息类型”和“信元类型”三个参数唯一确定一条记录。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145926)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145926)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145926)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145926)
