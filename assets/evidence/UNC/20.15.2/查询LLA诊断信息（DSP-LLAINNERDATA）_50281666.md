# 查询LLA诊断信息（DSP LLAINNERDATA）

- [命令功能](#ZH-CN_CONCEPT_0000001550281666__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281666__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281666__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281666__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281666__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001550281666__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281666)

该命令用于查询LLA诊断信息。不指定CID参数时，查询所有LLA的诊断信息，当指定CID参数时，查询指定LLA诊断信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281666)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281666)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281666)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281666)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001550281666)
