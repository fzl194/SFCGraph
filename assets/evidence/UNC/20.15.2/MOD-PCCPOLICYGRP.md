...
- [命令功能](#ZH-CN_CONCEPT_0209897174__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897174__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897174__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897174__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897174__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897174)

**适用NF：PGW-C、SMF**

此命令用于修改PccPolicyGrp配置，只有已经添加成功的PccPolicyGrp才能够修改。可以通过此命令，修改PCC策略组，包括计费属性、Qos属性、扩展属性等构成策略集，同时支持基于ServiceProp选择不同的非默认策略集。

#### [注意事项](#ZH-CN_CONCEPT_0209897174)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897174)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897174)
