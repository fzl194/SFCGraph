# 设置裸机BYPASS状态（SET BMBYPASSSTATUS）

- [命令功能](#ZH-CN_MMLREF_0000001558599098__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001558599098__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001558599098__1.3.3)
- [使用实例](#ZH-CN_MMLREF_0000001558599098__1.3.4)
- [输出结果说明](#ZH-CN_MMLREF_0000001558599098__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001558599098)
...
## [注意事项](#ZH-CN_MMLREF_0000001558599098)
...
## [参数说明](#ZH-CN_MMLREF_0000001558599098)
...
## [使用实例](#ZH-CN_MMLREF_0000001558599098)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001558599098)

命令执行正常，会返回命令执行成功的提示信息。输出结果说明如 [表1](#ZH-CN_MMLREF_0000001558599098__table149221250144917) 所示。

命令执行异常，会返回提示对应的失败信息。错误码列表如 [表2](#ZH-CN_MMLREF_0000001558599098__table698716490471) 所示。
...
| 20027 | 操作太频繁，请稍后重试 | 当前环境一分钟内手动进入过ByPass，不允许手动退出ByPass。手动退出ByPass和手动进入ByPass必须间隔1分钟以上。 | 等待1分钟后再进行设置。 |
