# 增加基于APN的E-UTRAN和WLAN互操作控制属性（ADD APNWIFILTEHO）

- [命令功能](#ZH-CN_MMLREF_0000001182122523__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001182122523__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001182122523__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001182122523__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001182122523)

**适用NF：PGW-C**

该命令用于增加基于APN的E-UTRAN和WLAN互操作控制属性。

## [注意事项](#ZH-CN_MMLREF_0000001182122523)

- 该命令执行后立即生效。

- 最多可输入20000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001182122523)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001182122523)
...
## [使用实例](#ZH-CN_MMLREF_0000001182122523)
