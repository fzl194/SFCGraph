# 修改区域内路由聚合配置（MOD OSPFABRSUMMARY）

- [命令功能](#ZH-CN_CONCEPT_0000001550120894__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550120894__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550120894__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550120894__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550120894__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550120894)

该命令用于修改区域边界路由器ABR对区域内路由进行路由聚合配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001550120894)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550120894)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550120894)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550120894)
