# 增加DNAI服务区名称绑定的5G TAI范围（ADD DNAREABINDN2TAI）

- [命令功能](#ZH-CN_MMLREF_0000001124796802__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001124796802__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001124796802__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001124796802__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001124796802)

**适用NF：SGW-C、SMF、GGSN、PGW-C**

该命令用于增加DNAI服务区名称绑定的5G TAI范围。

## [注意事项](#ZH-CN_MMLREF_0000001124796802)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001124796802)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001124796802)
...
## [使用实例](#ZH-CN_MMLREF_0000001124796802)
