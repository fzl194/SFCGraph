# 修改S1模式信令抑制规则(MOD S1SMARTRULE)

- [命令功能](#ZH-CN_MMLREF_0000001172225425__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225425__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225425__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225425__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225425__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225425__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001172225425__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225425)

**适用网元：MME**

该命令用于修改已配置的基于终端类型的S1模式信令抑制规则。

#### [注意事项](#ZH-CN_MMLREF_0000001172225425)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225425)

manage-ug; system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225425)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225425)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225425)
...
#### [参考信息](#ZH-CN_MMLREF_0000001172225425)

*表1 原因值对终端的影响*

| **原因值** | **对终端的影响** |
| --- | --- |
| - #2 (IMSI unknown in HSS) | UE不主动选网到GPRS/UMST网络，所有到LTE和GU网络的CS主被叫业务都会失败。 |
| - #3 (Illegal UE)<br>- #6 (Illegal ME)<br>- #8 (EPS services and non-EPS services not allowed) | USIM卡或手机终端被认为是非法的，PS和CS业务不可用。 |
| - #7 (EPS services not allowed)<br>- #14 (EPS services not allowed in this PLMN) | 用户PS业务不可用。 |
| - #11 (PLMN not allowed)<br>- #12 (Tracking area not allowed) | PS和CS业务不可用。 |
| - #13 (Roaming not allowed in this tracking area)<br>- #15 (No suitable cells in tracking area) | UE不尝试重新附着LTE网络，主动附着到GPRS/UMTS网络，CS呼叫成功。不会主动返回LTE网络 |
| - #10 (Implicitly detached)<br>- #22 (Congestion) | UE重新尝试附着到LTE。如果连续重新尝试4次后仍不成功，主动附着到GPRS/UMTS网络，CS呼叫成功。过一段时间可以重新尝试回LTE网络。 |
| - #111 (protocol error unspecified) | UE不尝试重新附着LTE网络，主动附着到GPRS/UMTS网络，CS呼叫成功。过一段时间可以重新尝试回LTE网络。 |
