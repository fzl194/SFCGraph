...
- [命令功能](#ZH-CN_MMLREF_0000001870462577__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870462577__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870462577__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870462577__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870462577)

**适用NF：SMF**

该命令用于修改层二规则。

## [注意事项](#ZH-CN_MMLREF_0000001870462577)

该命令执行后只对新接入的会话生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001870462577)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870462577)
...
## [使用实例](#ZH-CN_MMLREF_0000001870462577)
