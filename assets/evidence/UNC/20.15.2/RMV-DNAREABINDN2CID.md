# 删除DNAI服务区名称绑定的5G Cell ID范围（RMV DNAREABINDN2CID）

- [命令功能](#ZH-CN_MMLREF_0000001171436551__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001171436551__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001171436551__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001171436551__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001171436551)

**适用NF：SGW-C、GGSN、SMF、PGW-C**

该命令用于删除DNAI服务区名称绑定的5G Cell ID范围。

## [注意事项](#ZH-CN_MMLREF_0000001171436551)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001171436551)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001171436551)
...
## [使用实例](#ZH-CN_MMLREF_0000001171436551)
