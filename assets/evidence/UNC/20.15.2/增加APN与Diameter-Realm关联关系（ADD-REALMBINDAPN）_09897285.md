# 增加APN与Diameter Realm关联关系（ADD REALMBINDAPN）

- [命令功能](#ZH-CN_CONCEPT_0209897285__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897285__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897285__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897285__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897285__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897285)
...
#### [注意事项](#ZH-CN_CONCEPT_0209897285)

- 该命令执行后只对新激活用户生效。
- 该命令最大记录数为30000。
- 每个APN针对特定应用类型仅能配置唯一的Diameter域信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897285)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897285)
