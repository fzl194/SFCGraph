...
[图1](#ZH-CN_CONCEPT_0000001745033532__zh-cn_concept_0134578943_fig_dc_vrp_mpls-l3vpn-v4_feature_001001) 为BGP/MPLS IPv6 VPN扩展模型，扩展后的网络PE和CE之间运行的是IPv6的路由协议，可以选择以下IPv6路由协议为用户提供IPv6的VPN服务。
...
![](BGP_MPLS IPv6 VPN_45033532.assets/zh-cn_image_0000001792192773_2.png)
...
BGP/MPLS IPv6 VPN除PE和CE之间运行的路由协议与IPv4 VPN不同外，其它所有特性原理都与IPv4相同，见 [**MPLS VPN**](../WSFD-104411 MPLS VPN_45033524.md) 。
