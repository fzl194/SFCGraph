# WSFD-109001 Gy/Diameter在线计费参考信息

- [命令](#ZH-CN_TOPIC_0229035079__1.3.1.1)
- [告警](#ZH-CN_TOPIC_0229035079__1.3.2.1)
- [软参](#ZH-CN_TOPIC_0229035079__1.3.3.1)
- [测量指标](#ZH-CN_TOPIC_0229035079__1.3.4.1)

#### [命令](#ZH-CN_TOPIC_0229035079)
...
#### [软参](#ZH-CN_TOPIC_0229035079)

本特性相关的软参如下：

- [BIT744 控制向OCS上报changeinlocation-mcc与changeinlocation-mnc trigger的条件](../../../../../OM参考/软件参数/UNC软件参数/业务软件参数/软件参数（SMF_GGSN_SGW-C_PGW-C）/接入控制管理/BIT744 控制向OCS上报changeinlocation-mcc与changeinlocatio_c92a41c3_10634656.md)
- [BYTE319 控制Gy接口CCR消息流控时CCR消息数的统计周期](../../../../../OM参考/软件参数/UNC软件参数/业务软件参数/软件参数（SMF_GGSN_SGW-C_PGW-C）/在线计费管理/BYTE319 控制Gy接口CCR消息流控时CCR消息数的统计周期_10873946.md)

#### [测量指标](#ZH-CN_TOPIC_0229035079)
