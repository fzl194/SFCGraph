# 查询GTP-C V2协议兼容性(LST GTPCV2CMPT)

- [命令功能](#ZH-CN_MMLREF_0000001172225605__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225605__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225605__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225605__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225605__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225605__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172225605__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225605)

**适用网元：SGSN、MME**

该命令用于查询GTP-C V2协议兼容性配置，相关配置可以控制 UNC 发送的GTPCv2消息是否携带特定信元以及定义相关信元的格式。

#### [注意事项](#ZH-CN_MMLREF_0000001172225605)

此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225605)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225605)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225605)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225605)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172225605)

参见 [**ADD GTPCV2CMPT**](增加GTP-C V2协议兼容性(ADD GTPCV2CMPT)_26305734.md) 命令的参数说明。
