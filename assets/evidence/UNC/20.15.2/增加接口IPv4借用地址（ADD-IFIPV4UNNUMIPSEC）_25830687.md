# 增加接口IPv4借用地址（ADD IFIPV4UNNUMIPSEC）

- [命令功能](#ZH-CN_MMLREF_0000001225830687__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001225830687__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001225830687__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001225830687__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001225830687)

该命令用于配置接口的借用IPv4地址。当IP地址资源紧张（不能为每一个接口分配一个IP地址）或接口只是偶尔使用不需要长期独占一个IP地址时，配置接口借用其他接口的IP地址，以节约地址资源。

## [注意事项](#ZH-CN_MMLREF_0000001225830687)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001225830687)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001225830687)
...
## [使用实例](#ZH-CN_MMLREF_0000001225830687)
