# 删除BYPASS故障状态码（RMV BYPASSFAULTCODE）

- [命令功能](#ZH-CN_MMLREF_0000001259000293__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001259000293__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001259000293__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001259000293__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001259000293)

**适用NF：AMF、SMF**

该命令用于删除BYPASS故障状态码。若全部删除后，主备对端网元返回500以上的状态码，用户或会话均进入Bypass状态。

## [注意事项](#ZH-CN_MMLREF_0000001259000293)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001259000293)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001259000293)
...
## [使用实例](#ZH-CN_MMLREF_0000001259000293)
