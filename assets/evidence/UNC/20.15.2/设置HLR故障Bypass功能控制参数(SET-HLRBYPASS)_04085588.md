# 设置HLR故障Bypass功能控制参数(SET HLRBYPASS)

- [命令功能](#ZH-CN_CONCEPT_0000001404085588__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001404085588__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001404085588__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001404085588__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001404085588__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001404085588__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001404085588)

**适用网元：SGSN**

该命令用于设置HLR故障Bypass功能控制参数。开启HLR全故障智能业务逃生功能开关后，在HLR全故障状态下业务可以惯性运行。

#### [注意事项](#ZH-CN_CONCEPT_0000001404085588)

- 该命令执行后立即生效。

- 此命令的最大记录数为1。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001404085588)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001404085588)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001404085588)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001404085588)
