# 增加SGS MME实体(ADD SGSMME)

- [命令功能](#ZH-CN_CONCEPT_0000001293164005__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001293164005__1.3.2.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001293164005__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001293164005__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001293164005__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001293164005)

**适用NF：SMSF**

该命令用于增加SGS MME实体配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001293164005)

- 此命令的最大记录数为2000。

#### [网管用户权限](#ZH-CN_CONCEPT_0000001293164005)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001293164005)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001293164005)
