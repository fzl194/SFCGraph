# 修改5G接入限制区域列表（MOD NGACCAREALST）

- [命令功能](#ZH-CN_MMLREF_0244007375__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244007375__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244007375__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244007375__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244007375)

**适用NF：AMF**

该命令用于修改5G接入限制区域信息。

## [注意事项](#ZH-CN_MMLREF_0244007375)
...
#### [操作用户权限](#ZH-CN_MMLREF_0244007375)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244007375)
