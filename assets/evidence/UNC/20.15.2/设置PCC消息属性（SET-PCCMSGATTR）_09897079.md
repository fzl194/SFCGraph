# 设置PCC消息属性（SET PCCMSGATTR）

- [命令功能](#ZH-CN_CONCEPT_0209897079__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897079__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897079__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897079__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897079__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897079)

**适用NF：PGW-C、SMF**

该命令用于配置Gx接口上CCR-I、CCR-U、CCR-T和RAA消息中可选AVP的携带方式。

#### [注意事项](#ZH-CN_CONCEPT_0209897079)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897079)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897079)
