# 增加可按携带智能分流关键词进行处理的APN（ADD INTELAPN）

- [命令功能](#ZH-CN_MMLREF_0000001287680052__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001287680052__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001287680052__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001287680052__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001287680052)

**适用NF：PGW-C**

该命令用于增加APN名称中未携带智能分流关键词，但仍然可以按携带智能分流关键词进行处理的APN。APN配置智能分流关键词对应命令为ADD APNINTELSHUNT。

## [注意事项](#ZH-CN_MMLREF_0000001287680052)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001287680052)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001287680052)
...
## [使用实例](#ZH-CN_MMLREF_0000001287680052)
