...
- [命令功能](#ZH-CN_MMLREF_0209587930__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209587930__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209587930__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209587930__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209587930)

该命令用于排查网元间业务IP是否可以PING通。NGPING是最常见的用于检测网络设备可访问性的调试工具，它使用ICMP报文来检测远程设备是否可用、远程主机通信的来回旅程包的丢失情况，无法应用于链路时延的精确判断。

## [注意事项](#ZH-CN_MMLREF_0209587930)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209587930)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209587930)
