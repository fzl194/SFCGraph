# 添加SMSF功能实体配置（ADD SMSFFUNCTION）

- [命令功能](#ZH-CN_MMLREF_0235083980__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0235083980__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0235083980__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0235083980__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0235083980)

**适用NF：SMSF**

该命令用于添加SMSF功能实体配置。

## [注意事项](#ZH-CN_MMLREF_0235083980)
...
#### [操作用户权限](#ZH-CN_MMLREF_0235083980)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0235083980)
