# 增加中转UPF与Radius客户端的绑定关系（ADD UPFRDSCLIENTIP）

- [命令功能](#ZH-CN_MMLREF_0000001090026962__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001090026962__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001090026962__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001090026962__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001090026962)

**适用NF：PGW-C、SMF、GGSN**

该命令用于增加中转UPF与Radius客户端的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0000001090026962)

- 该命令执行后立即生效。

- 最多可输入6000条记录。当配置记录数大于规格的98%时，会上报“ALM-135602215 配置数量超阈值”告警。当配置记录数小于等于配置规格95%时，恢复“ALM-135602215 配置数量超阈值”告警。

#### [操作用户权限](#ZH-CN_MMLREF_0000001090026962)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001090026962)
...
## [使用实例](#ZH-CN_MMLREF_0000001090026962)
