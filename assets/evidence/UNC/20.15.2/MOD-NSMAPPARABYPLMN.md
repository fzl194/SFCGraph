# 修改指定PLMN的网络切片映射参数（MOD NSMAPPARABYPLMN）

- [命令功能](#ZH-CN_MMLREF_0000001875822988__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001875822988__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001875822988__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001875822988__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001875822988)

**适用NF：AMF**

该命令用于修改指定PLMN用户的网络切片映射相关参数。

## [注意事项](#ZH-CN_MMLREF_0000001875822988)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001875822988)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001875822988)
...
## [使用实例](#ZH-CN_MMLREF_0000001875822988)
