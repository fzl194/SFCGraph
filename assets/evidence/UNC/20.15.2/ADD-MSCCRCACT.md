# 增加MSCC层异常返回码处理动作（ADD MSCCRCACT）

- [命令功能](#ZH-CN_CONCEPT_0209896940__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896940__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896940__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896940__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896940__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896940)

**适用NF：PGW-C、SMF**

该命令用于增加MSCC层异常返回码的处理动作配置。当OCS返回的CCA消息携带MSCC层异常返回码时，根据此配置进行处理。

#### [注意事项](#ZH-CN_CONCEPT_0209896940)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896940)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896940)
