# 查询DCC模板（LST DCCTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0209896933__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896933__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896933__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896933__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896933__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209896933__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896933)

**适用NF：PGW-C、SMF**

该命令用于显示DCC在线计费模板，输入DCC Template Name显示指定DCC在线计费模板内容，不输入显示全部在线计费模板内容。

#### [注意事项](#ZH-CN_CONCEPT_0209896933)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896933)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896933)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209896933)

参见ADD DCCTEMPLATE、SET HOLDINGTIME、SET TXTIMER、SET OCSDOWNACTION、SET OCSINIT、SET CMDLEVDFTBEH、SET MSCCLEVDFTBEH的参数说明。
