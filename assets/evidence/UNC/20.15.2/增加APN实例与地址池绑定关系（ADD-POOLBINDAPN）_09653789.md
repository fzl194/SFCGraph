# 增加APN实例与地址池绑定关系（ADD POOLBINDAPN）

- [命令功能](#ZH-CN_MMLREF_0209653789__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653789__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653789__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653789__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653789)

**适用NF：SMF**

该命令用来配置指定APN实例与地址池的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0209653789)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653789)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653789)
