# 创建OSPFv3接口配置（ADD OSPFV3INTERFACE）

- [命令功能](#ZH-CN_CONCEPT_0000001549801710__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801710__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801710__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801710__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801710__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801710)

该命令用于在使能一个新的接口到OSPFv3进程的区域下。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801710)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801710)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801710)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801710)
