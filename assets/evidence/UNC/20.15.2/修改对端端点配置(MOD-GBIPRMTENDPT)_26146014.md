# 修改对端端点配置(MOD GBIPRMTENDPT)

- [命令功能](#ZH-CN_MMLREF_0000001126146014__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146014__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146014__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146014__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146014__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146014__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146014)

**适用网元：SGSN**

该命令用于修改一条Gb接口对端端点记录。对端端点权重表用来配置对端IP端点的数据权重和信令权重，在IP网络NSVC链路负荷分担时根据数据权重或者信令权重来选择对端IP端点。

#### [注意事项](#ZH-CN_MMLREF_0000001126146014)

- 该命令执行后立即生效。
- 该命令只能修改对端端点权重记录和“描述”

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146014)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146014)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146014)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146014)
