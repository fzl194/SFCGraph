# 查询漫游切片默认映射配置（LST NSSFDFTNSMAP）

- [命令功能](#ZH-CN_MMLREF_0000001225136383__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001225136383__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001225136383__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001225136383__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001225136383__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001225136383)
...
## [注意事项](#ZH-CN_MMLREF_0000001225136383)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001225136383)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001225136383)
...
## [使用实例](#ZH-CN_MMLREF_0000001225136383)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001225136383)
...
| 拜访地默认切片服务类型 | 该参数用于描述拜访地切片服务类型。 |
| 拜访地默认切片细分标识 | 该参数用于表示拜访地默认切片细分标识。 |
