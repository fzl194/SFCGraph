# 设置LDP BFD配置（SET LDPBFD）

- [命令功能](#ZH-CN_CONCEPT_0000001550281538__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281538__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281538__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281538__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281538__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281538)

该命令用于设置LDP BFD配置。使能LDP BFD功能后，可以对LDP Tunnel进行快速的故障检测，提高整网可靠性。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281538)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281538)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281538)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281538)
