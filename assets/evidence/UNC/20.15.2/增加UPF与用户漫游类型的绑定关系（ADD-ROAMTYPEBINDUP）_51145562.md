# 增加UPF与用户漫游类型的绑定关系（ADD ROAMTYPEBINDUP）

- [命令功能](#ZH-CN_MMLREF_0000001451145562__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001451145562__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001451145562__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001451145562__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001451145562)

**适用NF：GGSN、SGW-C、PGW-C、SMF**

该命令用于增加UPF与用户漫游类型的绑定关系，对非ULCL场景生效。

## [注意事项](#ZH-CN_MMLREF_0000001451145562)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001451145562)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001451145562)
...
## [使用实例](#ZH-CN_MMLREF_0000001451145562)
