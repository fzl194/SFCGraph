# 使能外联口报文调测功能（OPR FEIEXTPORTPKTDEBUG）

- [命令功能](#ZH-CN_CONCEPT_0000001549802038__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802038__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802038__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802038__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802038__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802038)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001549802038)

- 该命令仅适用于非NP卡场景和NP卡非加速模式场景。
- 资源单元全部使用EthTrunk子接口场景，无外联子接口，不能自适配VLAN匹配，下发命令时需要添加VLANID。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802038)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802038)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802038)
