# 修改S1模式接入控制配置（MOD S1ACCAREALST）

- [命令功能](#ZH-CN_MMLREF_0000001126145556__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145556__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145556__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145556__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145556__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145556__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001126145556__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145556)

**适用网元：MME**

此命令用于修改S1模式区域漫游限制参数。

#### [注意事项](#ZH-CN_MMLREF_0000001126145556)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126145556)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145556)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145556)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145556)
...
#### [参考信息](#ZH-CN_MMLREF_0000001126145556)
...
| 限制区域接入控制判断结果 | 签约RFSP | SPID |
| --- | --- | --- |
| 拒绝 | 未签约 | Start RFSP |
| 拒绝 | < Start RFSP | Min(Subscribed RFSP + Start RFSP - 1,End RFSP) |
| 拒绝 | [Start RFSP, End RFSP] | Subscribed RFSP |
| 拒绝 | > End RFSP | End RFSP |
| 允许 | 未签约 | 1 |
| 允许 | < Start RFSP | Subscribed RFSP |
| 允许 | [Start RFSP, End RFSP] | Min(Subscribed RFSP - Start RFSP + 1,Start RFSP - 1) |
| 允许 | > End RFSP | Subscribed RFSP |

**图1** CSFB用户判断规则

<br>

![](修改S1模式接入控制配置（MOD S1ACCAREALST）_26145556.assets/zh-cn_image_0000001172346151_2.png)
