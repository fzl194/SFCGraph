# 删除性能指标上报范围（RMV PERFRPTRANGE）

- [命令功能](#ZH-CN_MMLREF_0000001259999367__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001259999367__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001259999367__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001259999367__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001259999367)

**适用NF：SMF、PGW-C、GGSN、AMF**

该命令用于删除AMF或SMF性能统计指标的上报范围。

## [注意事项](#ZH-CN_MMLREF_0000001259999367)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001259999367)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001259999367)
...
## [使用实例](#ZH-CN_MMLREF_0000001259999367)
