# 增加5G跟踪区列表（ADD NGTALST）

- [命令功能](#ZH-CN_MMLREF_0209651355__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651355__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651355__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651355__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651355)

**适用NF：AMF**

该命令用于增加跟踪区列表。在初始注册或移动性注册更新流程中，如果UE当前驻留的跟踪区已经配置在系统的某个跟踪区列表中，那么AMF将在Registration Accept消息中将该跟踪区列表下发给UE。

## [注意事项](#ZH-CN_MMLREF_0209651355)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651355)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651355)
