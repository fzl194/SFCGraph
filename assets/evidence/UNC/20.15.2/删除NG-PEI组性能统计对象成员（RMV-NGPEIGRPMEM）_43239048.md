# 删除NG PEI组性能统计对象成员（RMV NGPEIGRPMEM）

- [命令功能](#ZH-CN_MMLREF_0000001143239048__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001143239048__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001143239048__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001143239048__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001143239048)

**适用NF：AMF**

该命令用于删除5G PEI组性能统计对象下的PEI成员。

## [注意事项](#ZH-CN_MMLREF_0000001143239048)

- 该命令执行后立即生效。

- 支持按NG PEI群组名称批量删除一个NG PEI群组下的所有成员，也支持按照NG PEI群组名称和设备型号核准号码（PEITAC）删除单条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001143239048)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001143239048)
...
## [使用实例](#ZH-CN_MMLREF_0000001143239048)
