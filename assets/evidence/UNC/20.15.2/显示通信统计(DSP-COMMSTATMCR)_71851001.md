# 显示通信统计(DSP COMMSTATMCR)

- [命令功能](#ZH-CN_MMLREF_0000001171851001__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001171851001__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001171851001__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001171851001__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001171851001__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001171851001__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001171851001__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001171851001)

**适用网元：MME**

该命令用于遇到系统内部通信消息处理有问题时，查询通信统计。

#### [注意事项](#ZH-CN_MMLREF_0000001171851001)

当只输入必选参数时，由于输出结果内容过多，会导致在结果输出区域的“通用维护”页签中无法显示全部内容，建议在结果输出区单击右键选用“重定向”输出。该命令为调测命令，用于华为技术支持定位问题，如需使用，请联系华为技术支持。

#### [本地用户权限](#ZH-CN_MMLREF_0000001171851001)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001171851001)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001171851001)
...
#### [使用实例](#ZH-CN_MMLREF_0000001171851001)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001171851001)
