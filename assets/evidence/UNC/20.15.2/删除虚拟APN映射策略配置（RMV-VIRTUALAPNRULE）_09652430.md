# 删除虚拟APN映射策略配置（RMV VIRTUALAPNRULE）

- [命令功能](#ZH-CN_MMLREF_0209652430__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652430__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652430__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652430__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652430)

**适用NF：SMF、PGW-C、GGSN**

该命令用于删除指定虚拟APN和真实APN的映射规则。

## [注意事项](#ZH-CN_MMLREF_0209652430)

- 该命令执行后立即生效。

- 当删除一条映射规则时，可能会导致部分用户激活失败。

#### [操作用户权限](#ZH-CN_MMLREF_0209652430)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652430)
