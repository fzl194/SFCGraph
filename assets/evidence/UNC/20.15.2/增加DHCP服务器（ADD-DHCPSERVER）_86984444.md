# 增加DHCP服务器（ADD DHCPSERVER）

- [命令功能](#ZH-CN_MMLREF_0000001186984444__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001186984444__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001186984444__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001186984444__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001186984444)

**适用NF：PGW-C、SMF、GGSN**

该命令用于配置DHCP服务器的IP地址。

## [注意事项](#ZH-CN_MMLREF_0000001186984444)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001186984444)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001186984444)
...
## [使用实例](#ZH-CN_MMLREF_0000001186984444)
