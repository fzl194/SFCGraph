# 增加GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系（ADD UPBINDGNGP）

- [命令功能](#ZH-CN_MMLREF_0278029307__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0278029307__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0278029307__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0278029307__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0278029307)
...
## [注意事项](#ZH-CN_MMLREF_0278029307)

- 该命令执行后立即生效。

- 最多可输入2048条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0278029307)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0278029307)
...
## [使用实例](#ZH-CN_MMLREF_0278029307)

新增GGSN与Gn/Gp口的绑定关系，其中GGSN唯一标识为"UPF1"，Gn/Gp口地址类型为IPv4，IPv4地址为“192.168.1.2”。

```
ADD UPBINDGNGP: NFINSTANCENAME="UPF1",GNGPIPTYPE=IPv4,GNGPIPV4="192.168.1.2";
```
