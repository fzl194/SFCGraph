# 删除基于APN的QoS策略(RMV QOSPLCYBYAPN)

- [命令功能](#ZH-CN_TOPIC_0000001438832489__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001438832489__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000001438832489__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000001438832489__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000001438832489__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000001438832489__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000001438832489)

**适用网元：MME**

该命令用于删除一条或多条基于APN的QoS策略配置。

#### [注意事项](#ZH-CN_TOPIC_0000001438832489)

该命令执行后对于新接入的EPS承载立即生效。如果当前用户已经激活了EPS承载，该命令的限制会在用户下一次会话管理业务流程中生效。

#### [本地用户权限](#ZH-CN_TOPIC_0000001438832489)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_TOPIC_0000001438832489)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001438832489)
...
#### [使用实例](#ZH-CN_TOPIC_0000001438832489)
