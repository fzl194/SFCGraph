# 修改IPV6 DNS Hostfile记录(MOD IPV6DNSH)

- [命令功能](#ZH-CN_MMLREF_0000001126305696__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305696__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305696__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305696__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305696__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305696__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305696)

**适用网元：SGSN、MME**

该命令用于修改网元接口所对应的IPv6地址信息。

#### [注意事项](#ZH-CN_MMLREF_0000001126305696)

- 该命令执行后立即生效。
- 一个主机名最多能对应64个IP地址，且64个地址中至少有一个有效的单播地址，不能为::、FFFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF、环回地址（::1）、链路本地地址（FE80::/10）和组播地址（FF00::/8）。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305696)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305696)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305696)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305696)
