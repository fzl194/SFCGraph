# 设置V-SMF的计费模式和CHF选择参数（SET VSMFCHGCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001225690223__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001225690223__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001225690223__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001225690223__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001225690223)

**适用NF：SMF**

该命令用于控制UNC作为V-SMF时的计费模式和CHF选择参数。

## [注意事项](#ZH-CN_MMLREF_0000001225690223)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001225690223)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001225690223)
...
## [使用实例](#ZH-CN_MMLREF_0000001225690223)
