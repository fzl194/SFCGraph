...
- [命令功能](#ZH-CN_MMLREF_0209652571__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652571__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652571__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652571__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652571)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于增加指定实例名称的UPF节点特征。

## [注意事项](#ZH-CN_MMLREF_0209652571)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652571)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652571)
