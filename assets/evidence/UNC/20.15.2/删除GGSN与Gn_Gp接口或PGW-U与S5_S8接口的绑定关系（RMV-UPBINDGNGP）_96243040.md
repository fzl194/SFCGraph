# 删除GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系（RMV UPBINDGNGP）

- [命令功能](#ZH-CN_MMLREF_0296243040__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243040__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243040__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243040__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243040)

**适用NF：GGSN、PGW-C**

该命令用于删除GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0296243040)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0296243040)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243040)
...
## [使用实例](#ZH-CN_MMLREF_0296243040)

删除GGSN与Gn/Gp接口的绑定关系，其中GGSN唯一标识"UPF1"，Gn/Gp口地址类型为IPv4，IPv4地址为“192.168.1.2”。

```
RMV UPBINDGNGP: NFINSTANCENAME="UPF1",GNGPIPTYPE=IPv4,GNGPIPV4="192.168.1.2";
```
