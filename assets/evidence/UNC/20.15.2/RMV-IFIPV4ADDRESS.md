# 删除接口IPv4地址（RMV IFIPV4ADDRESS）

- [命令功能](#ZH-CN_CONCEPT_0000001600841397__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841397__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841397__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841397__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841397__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841397)

该命令用于删除接口的IP地址，包括逻辑接口及物理接口。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841397)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841397)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841397)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841397)
