# 增加GTP-U路径管理自定义策略(ADD GTPUPATHDP)

- [命令功能](#ZH-CN_MMLREF_0000001172225521__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225521__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225521__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225521__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225521__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225521__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225521)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172225521)

- 该命令目前只支持配置“路径范围”为“ROAMING（漫游路径）”的记录，且支持配置一条。
- 该命令执行后，“故障判定钝化系数”对新的故障判定生效，“漫游路径告警ID控制”对新产生的告警生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225521)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225521)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225521)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225521)
