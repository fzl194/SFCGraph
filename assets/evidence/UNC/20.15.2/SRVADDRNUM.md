# 查询服务实例地址数（DSP SRVADDRNUM）

- [命令功能](#ZH-CN_CONCEPT_0129627069__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0129627069__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0129627069__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0129627069__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0129627069__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0129627069__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0129627069)

查询业务VNFC服务实例地址数量。用于核对业务VNFC的服务实例地址数量、CSLB的服务实例地址数量以及VNRS的路由数量是否一致。 CSLB查询到的一条服务实例地址对应VNRS上查询到的一条路由。

#### [注意事项](#ZH-CN_CONCEPT_0129627069)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0129627069)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0129627069)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0129627069)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 服务VNFC ID | 参数含义：业务VNFC的唯一标识。<br>取值范围：整数类型，取值范围为0~4294967295。 |
| 服务实例ID | 参数含义：业务VNFC定义的服务实例ID。<br>取值范围：整数类型，取值范围为0~4294967295。 |
| 服务实例地址数 | 参数含义：指定业务VNFC的服务实例地址数量。<br>取值范围：整数类型，取值范围为0~4294967295。 |
