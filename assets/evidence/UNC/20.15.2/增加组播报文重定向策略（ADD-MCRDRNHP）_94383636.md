# 增加组播报文重定向策略（ADD MCRDRNHP）

- [命令功能](#ZH-CN_CONCEPT_0000001794383636__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001794383636__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001794383636__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001794383636__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001794383636__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001794383636)

该命令用来创建组播报文重定向策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001794383636)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001794383636)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001794383636)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001794383636)
