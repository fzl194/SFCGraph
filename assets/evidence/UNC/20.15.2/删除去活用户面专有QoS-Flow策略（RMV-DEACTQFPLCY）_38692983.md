# 删除去活用户面专有QoS Flow策略（RMV DEACTQFPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001138692983__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001138692983__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001138692983__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001138692983__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001138692983)

**适用NF：SMF**

该命令用于删除当SMF接收到AMF发送的去激活用户面请求时，专有QoS Flow的处理策略。

## [注意事项](#ZH-CN_MMLREF_0000001138692983)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001138692983)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001138692983)
...
## [使用实例](#ZH-CN_MMLREF_0000001138692983)

当需要删除SMF收到无线侧发起的用户面去活请求携带原因值“radio-connection-with-ue-lost”时能够延迟释放专有QoS Flow规则时，执行如下命令：

```
RMV DEACTQFPLCY: NGAPCAUSEGROUP=RADIO_NETWORK, NGAPCAUSEVALUE=21;
```
