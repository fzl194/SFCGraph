# 删除对端PCF信息（RMV PNFPCFINFO）

- [命令功能](#ZH-CN_MMLREF_0209654343__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654343__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654343__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654343__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654343)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于删除本地配置的对端PCF实例信息。

## [注意事项](#ZH-CN_MMLREF_0209654343)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209654343)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654343)
