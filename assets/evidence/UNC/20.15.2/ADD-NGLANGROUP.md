# 增加5G LAN群组（ADD NGLANGROUP）

- [命令功能](#ZH-CN_MMLREF_0304284708__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0304284708__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0304284708__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0304284708__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0304284708)

**适用NF：SMF**

该命令用于增加5G LAN群组。在PDU激活流程中，SMF会根据DNN、切片和PDUSessionType等信息，判断该会话是否属于一个5G LAN群组。如果是，按5G LAN PDU激活流程进行处理；如果否，按正常PDU会话流程进行处理。

## [注意事项](#ZH-CN_MMLREF_0304284708)
...
#### [操作用户权限](#ZH-CN_MMLREF_0304284708)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0304284708)
