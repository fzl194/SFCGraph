# 显示PAE各链路OAM报文统计结果（DSP FABRICOAMPORT）

- [命令功能](#ZH-CN_CONCEPT_0192520009__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0192520009__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0192520009__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0192520009__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0192520009__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0192520009__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0192520009)

该命令用于显示Fabric OAM报文统计信息。

#### [注意事项](#ZH-CN_CONCEPT_0192520009)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0192520009)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0192520009)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0192520009)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 微服务类型 | 用于指定微服务类型。 |
| 微服务实例号 | 用于指定微服务实例号。 |
| 本端节点TB | 用于指定本端的端点的资源ID。 |
...
| 接收报文总数 | 用于表示接收报文总数。 |
| 链路中断次数 | 用于表示链路中断次数。 |
| 首次链路中断时间 | 用于表示首次链路中断时间。 |
| 最近链路中断时间 | 用于表示最近链路中断时间。 |
| 最近链路中断持续时间 | 用于表示最近链路中断持续时间。 |
| 链路中断原因 | 用于表示链路中断原因。 |
