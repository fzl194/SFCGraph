# 修改RG级异常返回码处理动作（MOD RGRCACT）

- [命令功能](#ZH-CN_MMLREF_0209651367__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651367__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651367__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651367__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651367)

**适用NF：PGW-C、SMF**

该命令用于修改RG级异常返回码的处理动作配置。

## [注意事项](#ZH-CN_MMLREF_0209651367)

- 该命令执行后立即生效。

- 当异常返回码处理动作配置为重定向时，RDVIRTIP和RDVIRTIPV6之间至少配置一个参数。

#### [操作用户权限](#ZH-CN_MMLREF_0209651367)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651367)
