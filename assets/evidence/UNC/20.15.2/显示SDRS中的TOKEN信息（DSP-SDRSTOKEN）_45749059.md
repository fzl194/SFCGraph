# 显示SDRS中的TOKEN信息（DSP SDRSTOKEN）

- [命令功能](#ZH-CN_MMLREF_0000001145749059__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001145749059__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001145749059__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001145749059__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001145749059__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001145749059)

该命令用于查询SDRS中指定APP的TOKEN策略信息。

## [注意事项](#ZH-CN_MMLREF_0000001145749059)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001145749059)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001145749059)
...
## [使用实例](#ZH-CN_MMLREF_0000001145749059)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001145749059)

| 输出项名称 | 输出项解释 |
| --- | --- |
| app类型 | 参数标识下发APP路由策略的APP类型，可以使用<br>[**DSP SDRSAPPTYPE**](显示SDRS中的APPTYPE信息（DSP SDRSAPPTYPE）_05545720.md)<br>命令获取。 |
...
| 根令牌 | 该参数用于表示根令牌。 |
| 主链路链路实例是否故障 | 该参数用于表示主链路链路实例是否故障，其中0表示正常 ，1表示故障。 |
| 主实例ID | 该参数用于表示TOKEN策略的主实例ID。 |
| 新主实例ID | 该参数用于表示TOKEN策略的新主实例ID。 |
| 版本号 | 该参数用于表示token策略资源的版本号。 |
| 推送状态 | 该参数用于表示推送状态，其中0表示已推送，1表示未推送。 |
