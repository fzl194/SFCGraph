# 设置PCC流控配置（SET PCCFLOWCONTROL）

- [命令功能](#ZH-CN_CONCEPT_0209897059__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897059__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897059__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897059__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897059__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897059)

**适用NF：PGW-C、SMF**

此命令用于配置UNC重授权请求的消息发送速率和SMF接收PCF的Npcf_SMPolicyControl_UpdateNotify消息的速率。

#### [注意事项](#ZH-CN_CONCEPT_0209897059)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897059)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897059)
