# 修改DNS查询控制参数(MOD DNSQ)

- [命令功能](#ZH-CN_MMLREF_0000001126145894__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145894__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145894__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145894__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145894__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145894__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145894)

**适用网元：SGSN、MME**

该命令用于修改DNS查询控制参数，包括查询方式，以及DNS服务器组ID等。

#### [注意事项](#ZH-CN_MMLREF_0000001126145894)

- 该命令执行后立即生效。
- 该命令执行后，需要执行[**CLR DNSC**](../../../系统管理/DNS维护管理/清除DNS Cache/清除DNS缓存(CLR DNSC)_72345945.md)来清除L1，L2 缓存，以保证本地缓存和DNS服务器中数据的一致性。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145894)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145894)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145894)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145894)
