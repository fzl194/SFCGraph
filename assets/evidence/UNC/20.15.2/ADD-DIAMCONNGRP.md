# 增加Diameter链路组（ADD DIAMCONNGRP）

- [命令功能](#ZH-CN_CONCEPT_0209897261__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897261__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897261__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897261__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897261__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897261)

**适用NF：PGW-C、SMF**

该命令用于指定本端主机名与指定对端服务器之间建立一组Diameter链路。本端主机名，对端主机名唯一确定了一组Diameter链路。

#### [注意事项](#ZH-CN_CONCEPT_0209897261)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897261)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897261)
