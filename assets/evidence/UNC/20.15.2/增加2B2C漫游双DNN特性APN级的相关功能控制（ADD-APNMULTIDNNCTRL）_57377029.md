# 增加2B2C漫游双DNN特性APN级的相关功能控制（ADD APNMULTIDNNCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001357377029__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001357377029__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001357377029__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001357377029__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001357377029)

**适用NF：PGW-C、SMF**

该命令用于增加2B2C漫游双DNN特性APN级的相关功能控制。该命令优先级高于SET MULTIDNNCTRL。

## [注意事项](#ZH-CN_MMLREF_0000001357377029)

- 该命令执行后立即生效。

- 最多可输入20000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001357377029)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001357377029)
...
## [使用实例](#ZH-CN_MMLREF_0000001357377029)

增加“APN名称”为“HUAWEI.COM”的2B2C漫游双DNN特性相关功能控制，在EPS中先获取策略。

```
ADD APNMULTIDNNCTRL: APN="HUAWEI.COM",GETPOLICYFIRST=ENABLE;
```
