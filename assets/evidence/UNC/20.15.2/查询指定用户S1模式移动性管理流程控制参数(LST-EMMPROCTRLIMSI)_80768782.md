# 查询指定用户S1模式移动性管理流程控制参数(LST EMMPROCTRLIMSI)

- [命令功能](#ZH-CN_TOPIC_0000002080768782__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000002080768782__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000002080768782__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000002080768782__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000002080768782__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000002080768782__1.3.6.1)
- [输出结果说明](#ZH-CN_TOPIC_0000002080768782__1.3.7.1)

#### [命令功能](#ZH-CN_TOPIC_0000002080768782)

**适用网元：MME**

此命令用于查询指定用户S1模式移动性管理流程控制参数。

#### [注意事项](#ZH-CN_TOPIC_0000002080768782)

- 此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_TOPIC_0000002080768782)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_TOPIC_0000002080768782)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000002080768782)
...
#### [使用实例](#ZH-CN_TOPIC_0000002080768782)
...
#### [输出结果说明](#ZH-CN_TOPIC_0000002080768782)

参见 **[ADD EMMPROCTRLIMSI](增加指定用户S1模式移动性管理流程控制参数(ADD EMMPROCTRLIMSI)_16407797.md)** 的参数说明。
