# 查询Diameter路由域名信息（LST DIAMRTREALM）

- [命令功能](#ZH-CN_CONCEPT_0209897306__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897306__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897306__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897306__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897306__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209897306__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897306)

**适用NF：PGW-C、SMF**

该命令用于查看已配置的Diameter路由相关参数。

#### [注意事项](#ZH-CN_CONCEPT_0209897306)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897306)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897306)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209897306)

参见ADD DIAMRTREALM的参数说明。
