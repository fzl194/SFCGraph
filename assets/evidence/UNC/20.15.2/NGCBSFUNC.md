# 设置小区广播功能（SET NGCBSFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001151856024__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001151856024__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001151856024__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001151856024__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001151856024)

**适用NF：AMF**

该命令用于设置5G小区广播功能参数。

## [注意事项](#ZH-CN_MMLREF_0000001151856024)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001151856024)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001151856024)
...
## [使用实例](#ZH-CN_MMLREF_0000001151856024)
