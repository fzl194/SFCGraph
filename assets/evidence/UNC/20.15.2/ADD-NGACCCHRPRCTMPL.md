# 增加NG接入CHR流程控制模板（ADD NGACCCHRPRCTMPL）

- [命令功能](#ZH-CN_MMLREF_0234945602__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0234945602__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0234945602__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0234945602__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0234945602)

**适用NF：AMF**

该命令用于增加NG接入CHR流程控制模板，用以控制CHR的采集流程。

## [注意事项](#ZH-CN_MMLREF_0234945602)
...
#### [操作用户权限](#ZH-CN_MMLREF_0234945602)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0234945602)
