# 查询引入路由指定前缀和掩码长度（LST NETWORKROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001549961058__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961058__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961058__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961058__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961058__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001549961058__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961058)

该命令用于查询设备上BGP VPN实例下所引入的network路由信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961058)

- 该命令执行后立即生效。
- 如果未指定具体路由信息，将查询指定BGP VPN实例下所引入的network路由信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961058)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961058)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961058)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001549961058)

参见ADD NETWORKROUTE的参数说明。
