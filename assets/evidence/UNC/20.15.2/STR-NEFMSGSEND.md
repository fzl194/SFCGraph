# 启动向NEF发送消息（STR NEFMSGSEND）

- [命令功能](#ZH-CN_MMLREF_0000001870382405__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870382405__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870382405__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870382405__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870382405)

**适用NF：SMF**

该命令用于启动向NEF发送消息。

## [注意事项](#ZH-CN_MMLREF_0000001870382405)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001870382405)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870382405)
...
## [使用实例](#ZH-CN_MMLREF_0000001870382405)
