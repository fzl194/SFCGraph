# 删除自动上报的NSE下的本端端点(RMV AUTOLOCEP)

- [命令功能](#ZH-CN_MMLREF_0000001126145994__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145994__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145994__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145994__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145994__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145994__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145994)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126145994)

- 此命令执行后立即生效。
- 此命令会导致删除端点的IPNSVC链路无法再承载业务。
- 删除NSE下唯一的本端端点会导致NSE相关业务不可用。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145994)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145994)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145994)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145994)
