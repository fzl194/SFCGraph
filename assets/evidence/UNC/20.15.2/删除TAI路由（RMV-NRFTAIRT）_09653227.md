# 删除TAI路由（RMV NRFTAIRT）

- [命令功能](#ZH-CN_MMLREF_0209653227__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653227__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653227__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653227__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653227)

**适用NF：NRF**

该命令用于删除指定NF类型的TAI信息对应的某条路由或所有路由路由信息。

## [注意事项](#ZH-CN_MMLREF_0209653227)

- 该命令执行后立即生效。

- 主备或双活组网的场景下，如果需要配置此命令，则两个NRF上均需执行此命令，且配置参数一致。

#### [操作用户权限](#ZH-CN_MMLREF_0209653227)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653227)
