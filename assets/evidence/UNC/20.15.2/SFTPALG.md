# 设置SFTP协议算法(SET SFTPALG)

- [命令功能](#ZH-CN_MMLREF_0000001718542196__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001718542196__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001718542196__1.3.3)
- [使用实例](#ZH-CN_MMLREF_0000001718542196__1.3.4)
- [输出结果说明](#ZH-CN_MMLREF_0000001718542196__1.3.5)
- [参考信息](#ZH-CN_MMLREF_0000001718542196__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001718542196)

设置SFTP协议是否使用兼容性算法。

![](设置SFTP协议算法(SET SFTPALG)_18542196.assets/notice_3.0-zh-cn_2.png)

如果将 “SFTP协议算法开关” 设置为 “ON（开启兼容算法）” ，系统会使用兼容算法，请谨慎处理。

## [注意事项](#ZH-CN_MMLREF_0000001718542196)

使用 [**SET SFTPALG**](设置SFTP协议算法(SET SFTPALG)_18542196.md) 关闭兼容算法后为保证业务连续性，不会将之前建立的SFTP链接关闭，建议用户重新建立SFTP链接，保证系统安全。
...
## [输出结果说明](#ZH-CN_MMLREF_0000001718542196)

该命令执行正常，会返回命令执行成功的提示信息。

命令执行失败则返回相应的错误，参见 [表2 错误码列表](#ZH-CN_MMLREF_0000001718542196__table16427175513333) ；命令执行异常，请联系技术支持处理。
...
## [参考信息](#ZH-CN_MMLREF_0000001718542196)
