# 增加接口上ND RA路由配置信息（ADD NDIFRAROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001600841429__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841429__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841429__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841429__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841429__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841429)

该命令用于增加IPv6接口上RA路由配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841429)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841429)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841429)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841429)
