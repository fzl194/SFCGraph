# 设置CHR存储配置（SET SESSNCHRSTORECFG）

- [命令功能](#ZH-CN_MMLREF_0000001089190590__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001089190590__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001089190590__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001089190590__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001089190590)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于设置CHR存储配置。

## [注意事项](#ZH-CN_MMLREF_0000001089190590)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001089190590)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001089190590)
...
## [使用实例](#ZH-CN_MMLREF_0000001089190590)
