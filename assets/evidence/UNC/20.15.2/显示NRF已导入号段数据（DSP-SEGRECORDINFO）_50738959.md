# 显示NRF已导入号段数据（DSP SEGRECORDINFO）

- [命令功能](#ZH-CN_MMLREF_0250738959__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0250738959__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0250738959__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0250738959__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0250738959__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0250738959)
...
## [注意事项](#ZH-CN_MMLREF_0250738959)

该命令支持查询的最大记录数为1000。

#### [操作用户权限](#ZH-CN_MMLREF_0250738959)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0250738959)
...
## [输出结果说明](#ZH-CN_MMLREF_0250738959)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 号段类型 | 该参数用于表示号段类型。其中ALL代表IMSI、MSISDN、IMSIRT、MSISDNRT。<br>取值说明：<br>- IMSI（IMSI）<br>- MSISDN（MSISDN）<br>- IMSIRT（IMSIRT）<br>- MSISDNRT（MSISDNRT）<br>- ALL（ALL） |
| NF类型 | 该参数用于表示IMSI、MSISDN、IMSIRT和MSISDNRT号段作用的NF类型，即哪些NF类型支持号段文件中给出的所有号段信息。 |
| 号段表类型 | 该参数用于表示号段的号段表类型，用于区分主、备两个表。<br>取值说明：<br>- ATABLE（A表）<br>- BTABLE（B表） |
| 号段起始字符串 | 该参数用于表示号段起始字符串。 |
| 号段结束字符串 | 该参数用于表示号段结束字符串。 |
| NF组标识1 | 该参数用于表示特定号段配置的NF组标识，可以通过LST NFGROUP进行查询。 |
| NF组标识2 | 该参数用于表示特定号段配置的NF组标识，可以通过LST NFGROUP进行查询。 |
