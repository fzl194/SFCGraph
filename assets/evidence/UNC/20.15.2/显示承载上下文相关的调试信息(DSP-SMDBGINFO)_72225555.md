# 显示承载上下文相关的调试信息(DSP SMDBGINFO)

- [命令功能](#ZH-CN_MMLREF_0000001172225555__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225555__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225555__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225555__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225555__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225555__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172225555__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225555)

**适用网元：SGSN、MME**

该命令用于查询和承载上下文相关的一些调试信息。

#### [注意事项](#ZH-CN_MMLREF_0000001172225555)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225555)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225555)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225555)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225555)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172225555)
