# 删除5G Connect PLMN（RMV NGCONNECTPLMN）

- [命令功能](#ZH-CN_MMLREF_0209653618__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653618__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653618__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653618__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653618)

**适用NF：AMF**

该命令用于删除可接入到本运营商的某个Connect PLMN。

## [注意事项](#ZH-CN_MMLREF_0209653618)

- 该命令执行后立即生效。

- 当删除记录时，则归属该记录里的PLMN的，且满足配置中的IMSI范围的所有用户将无法接入到本运营商网络。

#### [操作用户权限](#ZH-CN_MMLREF_0209653618)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653618)
