# 设置SMSF核查注册中心状态功能（SET SMSFRCDATACHECK）

- [命令功能](#ZH-CN_MMLREF_0000001404041281__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001404041281__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001404041281__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001404041281__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001404041281)

**适用NF：SMSF**

该命令用于设置SMSF核查注册中心状态功能，运营商可以根据需要设置核查功能的开关，每秒核查条目，核查周期等信息。

## [注意事项](#ZH-CN_MMLREF_0000001404041281)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001404041281)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001404041281)
...
## [使用实例](#ZH-CN_MMLREF_0000001404041281)
