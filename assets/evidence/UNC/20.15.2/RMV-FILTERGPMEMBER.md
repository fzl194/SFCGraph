# 删除过滤器组成员（RMV FILTERGPMEMBER）

- [命令功能](#ZH-CN_MMLREF_0209653634__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653634__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653634__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653634__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653634)

**适用NF：SMF**

当UP不需要使用指定过滤规则时，使用该命令删除一个过滤器。

## [注意事项](#ZH-CN_MMLREF_0209653634)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209653634)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653634)
