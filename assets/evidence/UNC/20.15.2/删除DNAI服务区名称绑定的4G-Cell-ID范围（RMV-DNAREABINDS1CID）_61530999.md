# 删除DNAI服务区名称绑定的4G Cell ID范围（RMV DNAREABINDS1CID）

- [命令功能](#ZH-CN_MMLREF_0000001261530999__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001261530999__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001261530999__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001261530999__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001261530999)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于删除DNAI服务区名称绑定的4G Cell ID范围。

## [注意事项](#ZH-CN_MMLREF_0000001261530999)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001261530999)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001261530999)
...
## [使用实例](#ZH-CN_MMLREF_0000001261530999)
