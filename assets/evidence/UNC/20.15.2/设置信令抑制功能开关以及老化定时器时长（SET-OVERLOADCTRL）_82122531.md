# 设置信令抑制功能开关以及老化定时器时长（SET OVERLOADCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001182122531__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001182122531__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001182122531__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001182122531__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001182122531)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用来配置GiGn联动信令抑制功能的开关以及老化定时器时长。配置针对业务触发的信令导致的用户去活场景是否开启信令抑制功能。

## [注意事项](#ZH-CN_MMLREF_0000001182122531)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001182122531)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001182122531)
...
## [使用实例](#ZH-CN_MMLREF_0000001182122531)
