# 删除HTTP流控消息类型（RMV HTTPFCMSG）

- [命令功能](#ZH-CN_MMLREF_0000001354503221__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001354503221__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001354503221__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001354503221__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001354503221)

该命令用于删除HTTP流控消息类型。

## [注意事项](#ZH-CN_MMLREF_0000001354503221)

- 该命令执行后立即生效。

- 参数FCTYPE取值为TCPBPFC时，执行该命令会导致TCP CPU反压流控暂时停止。

#### [操作用户权限](#ZH-CN_MMLREF_0000001354503221)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001354503221)
...
## [使用实例](#ZH-CN_MMLREF_0000001354503221)

删除AMF网元所有流控方式下的全部流控消息。

```
RMV HTTPFCMSG: NFTYPE=NFTypeAMF;
```
