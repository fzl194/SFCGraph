...
- [命令功能](#ZH-CN_CONCEPT_0000001246234740__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001246234740__1.3.2.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001246234740__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001246234740__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001246234740__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001246234740)

**适用NF：SMSF**

该命令用于增加VLR信令点配置。该信令点用于对接HLR。

#### [注意事项](#ZH-CN_CONCEPT_0000001246234740)

- 此命令的最大记录数为1。
- 该命令中的NI+OPC+VLRN需要先通过ADD SCCPOPC创建。

#### [网管用户权限](#ZH-CN_CONCEPT_0000001246234740)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001246234740)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001246234740)
