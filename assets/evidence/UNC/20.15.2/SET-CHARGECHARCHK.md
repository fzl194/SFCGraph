# 设置是否检查Serving Node携带的CC（SET CHARGECHARCHK）

- [命令功能](#ZH-CN_CONCEPT_0209896802__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896802__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896802__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896802__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896802__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896802)

**适用NF：PGW-C、SMF**

该命令用于设置是否检查Serving Node携带的charge-characteristic。

#### [注意事项](#ZH-CN_CONCEPT_0209896802)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896802)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896802)
