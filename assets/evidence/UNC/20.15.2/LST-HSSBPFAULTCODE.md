# 查询HSS BYPASS故障状态码(LST HSSBPFAULTCODE)

- [命令功能](#ZH-CN_CONCEPT_0000001262934708__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001262934708__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001262934708__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001262934708__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001262934708__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001262934708__1.3.6.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001262934708__1.3.7.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001262934708)

**适用网元：MME**

该命令用于查询配置的HSS BYPASS故障状态码信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001262934708)

无。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001262934708)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001262934708)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001262934708)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001262934708)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001262934708)

参见 [ADD HSSBPFAULTCODE](增加HSS BYPASS故障状态码(ADD HSSBPFAULTCODE)_62774744.md) 的参数说明。
