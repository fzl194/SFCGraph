# 设置用户面控制参数(SET GTPUCTRL)

- [命令功能](#ZH-CN_MMLREF_0000001126305648__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305648__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305648__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305648__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305648__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305648__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305648)

**适用网元：SGSN、MME**

该命令用于设置用户面控制参数。用户面控制参数包括GTPU协议参数表定时器参数、流量更新时是否上报PDP信息到用户跟踪的开关。

#### [注意事项](#ZH-CN_MMLREF_0000001126305648)

- 系统初次运行时，会执行系统初始设置值。
- 该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305648)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305648)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305648)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305648)
