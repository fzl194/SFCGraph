# 删除TA级限制切片（RMV AMFRSTRNSSAI）

- [命令功能](#ZH-CN_MMLREF_0000001124796830__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001124796830__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001124796830__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001124796830__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001124796830)

**适用NF：AMF**

该命令用于删除TA级限制切片。

## [注意事项](#ZH-CN_MMLREF_0000001124796830)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001124796830)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001124796830)
...
## [使用实例](#ZH-CN_MMLREF_0000001124796830)
