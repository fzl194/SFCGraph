# 查询CSDB数据特征（DSP DBDATAFEATURE）

- [命令功能](#ZH-CN_CONCEPT_0129626996__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0129626996__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0129626996__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0129626996__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0129626996__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0129626996__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0129626996)

该命令用于查询CSDB的数据特征信息，包括数据特征值、数据特征在记录的偏移和数据特征的角色。

#### [注意事项](#ZH-CN_CONCEPT_0129626996)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0129626996)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0129626996)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0129626996)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 子实例标识 | 唯一标识一个子实例。<br>取值范围：1～100。 |
| 数据表标识 | 唯一标识一张数据表。<br>取值范围：0～1023。 |
| 数据特征 | 数据特征。<br>取值范围：0～4294967295。 |
| 数据特征偏移 | 数据特征在记录的偏移。<br>取值范围：0～4294967295。 |
| 数据特征角色 | 数据特征角色。<br>取值范围：<br>- 生产者。<br>- 消费者。 |
