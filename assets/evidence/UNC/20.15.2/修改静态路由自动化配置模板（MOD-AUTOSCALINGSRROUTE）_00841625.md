# 修改静态路由自动化配置模板（MOD AUTOSCALINGSRROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001600841625__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841625__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841625__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841625__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841625__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841625)

该命令用于修改静态路由自动化配置模板。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841625)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841625)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841625)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841625)
