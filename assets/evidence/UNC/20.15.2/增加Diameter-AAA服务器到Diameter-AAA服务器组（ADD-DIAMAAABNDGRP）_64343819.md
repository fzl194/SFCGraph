# 增加Diameter AAA服务器到Diameter AAA服务器组（ADD DIAMAAABNDGRP）

- [命令功能](#ZH-CN_MMLREF_0264343819__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0264343819__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0264343819__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0264343819__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0264343819)

**适用NF：PGW-C**

此命令用于绑定指定的Diameter AAA到Diameter AAA组。当新建立的non-3GPP会话需要到某个Diameter AAA鉴权时，操作员可以执行此命令增加该绑定关系。

## [注意事项](#ZH-CN_MMLREF_0264343819)
...
#### [操作用户权限](#ZH-CN_MMLREF_0264343819)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0264343819)
