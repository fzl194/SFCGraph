# 增加NWDAF扩展信息（ADD NWDAFINFOEXT）

- [命令功能](#ZH-CN_MMLREF_0000001977579548__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001977579548__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001977579548__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001977579548__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001977579548)

该命令用于增加NWDAF实例扩展信息，即向NRF注册时携带的NwdafInfoList。

## [注意事项](#ZH-CN_MMLREF_0000001977579548)

- 该命令执行后立即生效。

- 最多可输入32条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001977579548)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001977579548)
...
## [使用实例](#ZH-CN_MMLREF_0000001977579548)
