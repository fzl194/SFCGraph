# 增加LLC协商参数(ADD LLCXID)

- [命令功能](#ZH-CN_MMLREF_0000001172345615__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345615__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345615__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345615__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345615__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345615__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345615)

**适用网元：SGSN**

该命令用于增加GB接口LLC层XID协商参数配置。

#### [注意事项](#ZH-CN_MMLREF_0000001172345615)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345615)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345615)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345615)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345615)
