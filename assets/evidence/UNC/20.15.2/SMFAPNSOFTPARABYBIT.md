# 设置SMF APN软件参数比特位（SET SMFAPNSOFTPARABYBIT）

- [命令功能](#ZH-CN_MMLREF_0225121214__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0225121214__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0225121214__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0225121214__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0225121214)

**适用NF：SMF**

该命令用于设置SMF APN软件参数比特位。

## [注意事项](#ZH-CN_MMLREF_0225121214)

- 该命令执行后立即生效。

- 需要使用SET SMFAPNSOFTPARA命令来添加相应记录。

#### [操作用户权限](#ZH-CN_MMLREF_0225121214)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0225121214)
