...
- [命令功能](#ZH-CN_MMLREF_0000001126305190__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305190__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305190__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305190__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305190__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305190__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305190)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305190)

- 该命令执行后立即生效。
- 如果删除正在发送话单的CG，可能会引起少量话单丢失。
- “GTP承载协议（PRO）”、“CG的IP地址（IP）”、“CG接收端口号(SPN)”唯一确定需要删除的CG配置记录。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305190)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305190)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305190)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305190)
