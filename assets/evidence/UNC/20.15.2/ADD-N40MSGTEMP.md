# 增加N40消息属性模板（ADD N40MSGTEMP）

- [命令功能](#ZH-CN_MMLREF_0000001148957459__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001148957459__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001148957459__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001148957459__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001148957459)

**适用NF：PGW-C、SMF**

该命令用于增加N40消息属性模板，用于控制N40消息中是否携带对应字段。

## [注意事项](#ZH-CN_MMLREF_0000001148957459)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001148957459)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001148957459)
...
## [使用实例](#ZH-CN_MMLREF_0000001148957459)
