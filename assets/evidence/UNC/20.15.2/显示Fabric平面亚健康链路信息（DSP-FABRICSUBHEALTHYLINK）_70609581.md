# 显示Fabric平面亚健康链路信息（DSP FABRICSUBHEALTHYLINK）

- [命令功能](#ZH-CN_MMLREF_0000001670609581__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001670609581__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001670609581__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001670609581__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001670609581__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001670609581)

该命令用于显示Fabric平面亚健康链路信息。

当系统上报“ALM-100339 Fabric链路出现亚健康”告警后，可使用该命令查询告警的详细信息。

## [注意事项](#ZH-CN_MMLREF_0000001670609581)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001670609581)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001670609581)
...
## [使用实例](#ZH-CN_MMLREF_0000001670609581)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001670609581)
...
| 目的端TB | 该参数用于表示目的端TB。 |
| 平面ID | 该参数用于表示平面ID。 |
| 告警上报时间 | 该参数用于表示“ALM-100339 Fabric链路出现亚健康”告警的上报时间。 |
