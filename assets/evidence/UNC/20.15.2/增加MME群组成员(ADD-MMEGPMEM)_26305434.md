# 增加MME群组成员(ADD MMEGPMEM)

- [命令功能](#ZH-CN_MMLREF_0000001126305434__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305434__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305434__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305434__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305434__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305434__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305434)

**适用网元：MME**

此命令用于为 [**ADD MMEGP**](../MME群组配置/增加MME群组(ADD MMEGP)_72225301.md) 增加的MME群组添加一条成员记录。

#### [注意事项](#ZH-CN_MMLREF_0000001126305434)

- 该命令执行后立即生效。
- 此命令最大记录数为1024。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305434)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305434)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305434)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305434)
