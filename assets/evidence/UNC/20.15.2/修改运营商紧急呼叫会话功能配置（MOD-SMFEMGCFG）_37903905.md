# 修改运营商紧急呼叫会话功能配置（MOD SMFEMGCFG）

- [命令功能](#ZH-CN_MMLREF_0000001137903905__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001137903905__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001137903905__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001137903905__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001137903905)

**适用NF：SMF**

该命令用于修改指定MNO或MVNO对应的紧急呼叫会话功能配置数据。

## [注意事项](#ZH-CN_MMLREF_0000001137903905)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001137903905)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001137903905)
...
## [使用实例](#ZH-CN_MMLREF_0000001137903905)
