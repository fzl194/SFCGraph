# 修改地址池组（MOD ADDRPOOLGRP）

- [命令功能](#ZH-CN_MMLREF_0264343894__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0264343894__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0264343894__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0264343894__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0264343894)

**适用NF：PGW-C、SMF、GGSN**

该命令用于修改指定地址池组的信息。

## [注意事项](#ZH-CN_MMLREF_0264343894)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0264343894)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0264343894)
