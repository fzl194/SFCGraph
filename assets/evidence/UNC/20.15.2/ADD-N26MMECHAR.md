# 增加N26接口MME属性（ADD N26MMECHAR）

- [命令功能](#ZH-CN_MMLREF_0209652516__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652516__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652516__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652516__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652516)

**适用NF：AMF**

该命令用于增加N26接口对端MME的属性信息。

## [注意事项](#ZH-CN_MMLREF_0209652516)
...
| RANGE | IPTYPE | IPV4 | MASKV4 | IPV6 | MASKV6 | MMECAP | PCFRFSPSW | PCFNISW | ITFTYPE |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ALL_MME | INVALID | 255.255.255.255 | 0.0.0.0 | 0000:0000:0000:0000:0000:0000:0000:0000 | 0 | NONIPPDN-1 | NO | NO | S10/N26MME |

#### [操作用户权限](#ZH-CN_MMLREF_0209652516)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652516)
...
## [使用实例](#ZH-CN_MMLREF_0209652516)

假设IP地址为192.168.0.1的MME支持non-IP功能，执行如下命令：

```
ADD N26MMECHAR: RANGE=SPECIAL_MME, IPTYPE=IPV4, IPV4="192.168.0.1", MASKV4="255.255.255.255", MMECAP=NONIPPDN-1;
```
