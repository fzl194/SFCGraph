# 修改Non-GBR承载QoS限制配置(MOD QOSCAP)

- [命令功能](#ZH-CN_MMLREF_0000001172345819__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345819__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345819__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345819__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345819__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345819__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345819)

**适用网元：MME**

该命令用于修改一条QoS限制配置记录。

#### [注意事项](#ZH-CN_MMLREF_0000001172345819)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345819)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345819)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345819)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345819)
