# 添加接口下安全配置（ADD IPV6IFICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001549802470__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802470__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802470__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802470__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802470__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802470)

该命令用于添加接口下安全配置。接口名称可以通过LST INTERFACE命令获取。

#### [注意事项](#ZH-CN_CONCEPT_0000001549802470)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802470)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802470)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802470)

添加接口下安全配置：

```
ADD IPV6IFICMPSECURITY:IFNAME="Ethernet65/0/8",ACTION=sndPkt,CONFIGTYPE=PKTTYPE,PKTTYPE=HOST_UNREATCHABLE,SWITCHOP=enable;
```
