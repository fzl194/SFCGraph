# 恢复可用的GGSN地址(RES USRCTLGGSN)

- [命令功能](#ZH-CN_MMLREF_0000001172345507__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345507__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345507__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345507__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345507__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345507__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345507)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345507)

可以通过 [**DSP USRCTLGGSN**](显示手工恢复GGSN地址状态(DSP USRCTLGGSN)_26305716.md) 命令查询需要手工恢复的GGSN列表。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345507)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345507)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345507)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345507)
