# 增加I-UPF在特定园区专用APN下的部署模式配置（ADD IUPFAPNDPMODE）

- [命令功能](#ZH-CN_MMLREF_0000001376930386__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001376930386__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001376930386__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001376930386__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001376930386)

![](增加I-UPF在特定园区专用APN下的部署模式配置（ADD IUPFAPNDPMODE）_76930386.assets/notice_3.0-zh-cn_2.png)

该配置参数若设置为NOIUPF，会导致终端移动到园区外时拒绝接入。

**适用NF：SMF**

该命令用于增加I-UPF在特定园区专用APN下的部署模式配置，对非ULCL场景生效。

## [注意事项](#ZH-CN_MMLREF_0000001376930386)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001376930386)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001376930386)
