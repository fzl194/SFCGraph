# 删除IMEI库记录（RMV IMEILIB）

- [命令功能](#ZH-CN_MMLREF_0000001172225413__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225413__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225413__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225413__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225413__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225413__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225413)

**适用网元：SGSN、MME**

此命令用于删除IMEI库记录。IMEI库为IMEI TAC和终端类型的对应关系表，用于按照IMEI识别智能终端。

#### [注意事项](#ZH-CN_MMLREF_0000001172225413)

此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225413)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225413)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225413)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225413)
