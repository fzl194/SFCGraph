# 增加算法优先级配置信息（ADD ALGPRIORITY）

- [命令功能](#ZH-CN_MMLREF_0000001172225325__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225325__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225325__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225325__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225325__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225325__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225325)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172225325)

- 该命令执行后立即生效。
- 该表最多可以增加5条记录。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225325)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225325)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225325)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225325)
