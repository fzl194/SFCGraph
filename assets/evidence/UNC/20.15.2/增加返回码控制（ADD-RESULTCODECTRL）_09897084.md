...
- [命令功能](#ZH-CN_CONCEPT_0209897084__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897084__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897084__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897084__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897084__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897084)

**适用NF：PGW-C、SMF**

此命令用来配置当UNC收到指定结果码信息后执行何种操作。例如关闭动态PCC功能、执行缺省动作、执行宕机备份等。

#### [注意事项](#ZH-CN_CONCEPT_0209897084)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897084)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897084)
