# 清除RADIUS相关消息发送接收个数的统计信息（CLR RDSSVRCOUNTER）

- [命令功能](#ZH-CN_CONCEPT_0209896764__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896764__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896764__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896764__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896764__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896764)

**适用NF：PGW-C、SMF**

该命令用于清除基于RADIUS服务器的RADIUS相关消息发送接收个数的统计信息。

#### [注意事项](#ZH-CN_CONCEPT_0209896764)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896764)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896764)
