# 设置NSSF数据源以及切片选择流程返回信元（SET NSSFFUNCPARA）

- [命令功能](#ZH-CN_MMLREF_0244007995__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244007995__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244007995__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244007995__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244007995)

**适用NF：NSSF**

该命令用于设置NSSF在业务流程中所使用的数据源与切片选择流程中返回的信元。

## [注意事项](#ZH-CN_MMLREF_0244007995)
...
#### [操作用户权限](#ZH-CN_MMLREF_0244007995)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244007995)
