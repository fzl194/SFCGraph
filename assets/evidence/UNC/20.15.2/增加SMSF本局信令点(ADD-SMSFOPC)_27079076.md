# 增加SMSF本局信令点(ADD SMSFOPC)

- [命令功能](#ZH-CN_CONCEPT_0227079076__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0227079076__1.3.2.1)
- [网管用户权限](#ZH-CN_CONCEPT_0227079076__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0227079076__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0227079076__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0227079076)

**适用NF：SMSF**

该命令用于在5G短消息微服务SMSF对接短消息中心时，识别是否为5G短消息，用来区分传统2、3G网络业务和5G业务。

#### [注意事项](#ZH-CN_CONCEPT_0227079076)
...
#### [网管用户权限](#ZH-CN_CONCEPT_0227079076)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0227079076)
