# 删除IPv6安全配置（RMV IPV6ICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001549961142__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961142__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961142__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961142__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961142__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961142)

该命令用于删除IPv6安全配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961142)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961142)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961142)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961142)

删除IPv6安全配置：

```
RMV IPV6ICMPSECURITY:ACTION=sndPkt,CONFIGTYPE=USER,ICMPTYPE=0,ICMPCODE=0;
```
