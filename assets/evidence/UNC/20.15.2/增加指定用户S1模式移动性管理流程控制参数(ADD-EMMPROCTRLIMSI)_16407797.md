# 增加指定用户S1模式移动性管理流程控制参数(ADD EMMPROCTRLIMSI)

- [命令功能](#ZH-CN_TOPIC_0000002116407797__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000002116407797__1.3.2.1)
- [本地用户权限](#ZH-CN_TOPIC_0000002116407797__1.3.3.1)
- [网管用户权限](#ZH-CN_TOPIC_0000002116407797__1.3.4.1)
- [参数说明](#ZH-CN_TOPIC_0000002116407797__1.3.5.1)
- [使用实例](#ZH-CN_TOPIC_0000002116407797__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000002116407797)

**适用网元：MME**

在用户接入S1模式时， UNC 可通过此命令控制MM流程进行特殊处理以及特殊场景下指定的原因值下发，以满足运营商实现对现网设备兼容性特殊控制的需求。

#### [注意事项](#ZH-CN_TOPIC_0000002116407797)
...
#### [本地用户权限](#ZH-CN_TOPIC_0000002116407797)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_TOPIC_0000002116407797)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000002116407797)
...
#### [使用实例](#ZH-CN_TOPIC_0000002116407797)
