# 新增ICMP安全配置（ADD ICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001549960994__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549960994__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549960994__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549960994__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549960994__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549960994)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001549960994)

- 该命令执行后立即生效。
- 该命令最大记录数为65535。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549960994)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549960994)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549960994)

- 指定ICMP报文名称去使能系统发送ICMP Echo报文功能的ICMP安全配置实例：
  ```
  ADD ICMPSECURITY: ACTION=sndPkt, SWITCHOP=disable, CONFIGTYPE=PKTTYPE, PKTTYPE=echo;
  ```
- 指定ICMP报文编码去使能系统发送ICMP Echo报文功能的ICMP安全配置实例：
  ```
  ADD ICMPSECURITY: ACTION=sndPkt, SWITCHOP=disable, CONFIGTYPE=USER, ICMPTYPE=8, ICMPCODE=0;
  ```
