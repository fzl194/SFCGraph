# 修改S-GW特性对接配置(MOD SGWCHARACT)

- [命令功能](#ZH-CN_MMLREF_0000001126145970__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145970__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145970__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145970__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145970__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145970__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145970)

**适用网元：SGSN、MME**

该命令用于修改MME与S-GW支持特性的能力交互配置策略。

#### [注意事项](#ZH-CN_MMLREF_0000001126145970)

- 该命令执行后立即生效。
- “对端设备范围”、“IP地址类型”、“IPv4地址”、“IPV4地址掩码”、“IPv6地址”、“IPV4地址掩码”这几个参数不能通过该命令修改。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145970)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145970)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145970)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145970)
