# 增加SMS CHR流程控制模板（ADD SMSCHRPRCTMPL）

- [命令功能](#ZH-CN_MMLREF_0000001353481530__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001353481530__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001353481530__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001353481530__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001353481530)

**适用NF：SMSF**

该命令用于SMS CHR流程控制模板，用以控制CHR的采集流程。

## [注意事项](#ZH-CN_MMLREF_0000001353481530)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001353481530)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001353481530)
...
## [使用实例](#ZH-CN_MMLREF_0000001353481530)
