# 增加间接路由拨测用户配置（ADD SBIDIALTEST）

- [命令功能](#ZH-CN_MMLREF_0000001206510925__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001206510925__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001206510925__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001206510925__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001206510925)

**适用NF：SMF、AMF**

该命令暂未生效。

## [注意事项](#ZH-CN_MMLREF_0000001206510925)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001206510925)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001206510925)
...
## [使用实例](#ZH-CN_MMLREF_0000001206510925)
