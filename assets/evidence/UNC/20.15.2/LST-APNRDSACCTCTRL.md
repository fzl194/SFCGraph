# 查询APN RADIUS计费控制参数（LST APNRDSACCTCTRL）

- [命令功能](#ZH-CN_CONCEPT_0209896771__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896771__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896771__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896771__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896771__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209896771__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896771)

**适用NF：PGW-C、SMF**

该命令用来显示指定APN的RADIUS客户端计费信令控制属性的配置。

#### [注意事项](#ZH-CN_CONCEPT_0209896771)

如果不输入参数，则查询全部APN的RADIUS客户端计费信令控制属性的配置。如果输入参数，则查询指定APN的RADIUS客户端计费信令控制属性的配置信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896771)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896771)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| APN | APN名称 | 可选必选说明：可选参数<br>参数含义：基于该APN配置RADIUS计费控制参数。<br>数据来源：本端规划<br>取值范围：字符串类型，输入长度范围为1～63。<br>默认值：无<br>配置原则：无 |

#### [使用实例](#ZH-CN_CONCEPT_0209896771)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209896771)

参见SET APNRDSACCTCTRL的参数说明。
