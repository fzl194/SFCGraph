# 增加TAI与LAI对应关系(ADD TAILAI)

- [命令功能](#ZH-CN_MMLREF_0000001172345017__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345017__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345017__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345017__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345017__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345017__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345017)

**适用网元：MME**

该命令用于增加TAI与LAI的对应关系。在启用CSFB功能时，MME可以根据TAI获得对应的LAI。

#### [注意事项](#ZH-CN_MMLREF_0000001172345017)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345017)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345017)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345017)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345017)
