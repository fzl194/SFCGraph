# 修改Qos Profile缺省承载QoS属性（MOD EPSQOS4DEFBER）

- [命令功能](#ZH-CN_MMLREF_0000001124796826__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001124796826__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001124796826__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001124796826__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001124796826)

**适用NF：SGW-C、PGW-C**

该命令用来修改Qos Profile缺省承载QoS属性。

## [注意事项](#ZH-CN_MMLREF_0000001124796826)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001124796826)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001124796826)
...
## [使用实例](#ZH-CN_MMLREF_0000001124796826)
