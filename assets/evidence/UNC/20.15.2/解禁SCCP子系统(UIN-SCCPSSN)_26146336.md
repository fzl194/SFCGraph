# 解禁SCCP子系统(UIN SCCPSSN)

- [命令功能](#ZH-CN_MMLREF_0000001126146336__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146336__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146336__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146336__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146336__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146336__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146336)

**适用网元：SGSN、MME、SMSF**

此命令用于解禁SCCP子系统。

#### [注意事项](#ZH-CN_MMLREF_0000001126146336)

- 系统会自行选取可用的信令进程，因此，执行该操作的时候要确保系统中有可用的信令进程。否则，操作将不能正常执行。
- 只有处于禁止状态的SCCP子系统才能执行解禁操作。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146336)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146336)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146336)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146336)
