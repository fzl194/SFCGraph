# 增加SCTP模板（ADD SCTPTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0209897332__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897332__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897332__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897332__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897332__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897332)

**适用NF：PGW-C、SMF**

此命令用于创建SCTP模板，根据现网规划，当UNC需要使用SCTP承载逻辑接口信令时，可以使用此命令创建SCTP模板并配置SCTP协议参数。

#### [注意事项](#ZH-CN_CONCEPT_0209897332)

- 该命令执行后立即生效。
- 该命令最大记录数为20。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897332)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897332)
