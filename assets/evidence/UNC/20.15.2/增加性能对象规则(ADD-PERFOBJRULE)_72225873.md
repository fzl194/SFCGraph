# 增加性能对象规则(ADD PERFOBJRULE)

- [命令功能](#ZH-CN_MMLREF_0000001172225873__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225873__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225873__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225873__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225873__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225873__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225873)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172225873)

- 该命令执行后立即生效。
- 最大可配TAI组规则数为1500条。
- 每个TAI组可以有多个规则，但是同一个TAI只能包含在一个TAI组内。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225873)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225873)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225873)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225873)
