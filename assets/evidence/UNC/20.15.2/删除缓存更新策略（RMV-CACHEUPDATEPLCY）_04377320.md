# 删除缓存更新策略（RMV CACHEUPDATEPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001304377320__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001304377320__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001304377320__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001304377320__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001304377320)

**适用NF：AMF、SMF、NRF、NSSF、SMSF、NCG**

该命令用于删除缓存更新策略。

## [注意事项](#ZH-CN_MMLREF_0000001304377320)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001304377320)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001304377320)
...
## [使用实例](#ZH-CN_MMLREF_0000001304377320)

运营商A需要删除缓存更新策略，对端NF类型为OCS。

```
RMV CACHEUPDATEPLCY: PEERTYPE=NfCUSTOM_OCS;
```
