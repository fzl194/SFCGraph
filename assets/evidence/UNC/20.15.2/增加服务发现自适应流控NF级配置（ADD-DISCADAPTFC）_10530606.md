# 增加服务发现自适应流控NF级配置（ADD DISCADAPTFC）

- [命令功能](#ZH-CN_MMLREF_0000001310530606__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001310530606__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001310530606__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001310530606__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001310530606)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于增加服务发现自适应流控NF级配置。如果启用了固定速率流控功能但流控一直无法恢复，可增加该配置进一步限制服务发现速率，该自适应流控功能可根据NRF的返回码等统计信息自动调整阈值。

## [注意事项](#ZH-CN_MMLREF_0000001310530606)

- 该命令执行后立即生效。

- 最多可输入100条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001310530606)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001310530606)
...
## [使用实例](#ZH-CN_MMLREF_0000001310530606)
