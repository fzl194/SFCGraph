# 修改AMF冲突规则（MOD AMFCONFLICTRULE）

- [命令功能](#ZH-CN_MMLREF_0000001461102349__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001461102349__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001461102349__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001461102349__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001461102349)

![](修改AMF冲突规则（MOD AMFCONFLICTRULE）_61102349.assets/notice_3.0-zh-cn_2.png)
...
## [注意事项](#ZH-CN_MMLREF_0000001461102349)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001461102349)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001461102349)
...
## [使用实例](#ZH-CN_MMLREF_0000001461102349)

在IntraAmfHandover流程中，收到了NG-RAN的“RRC Inactive Transition Report”消息，如果希望将当前的处理策略修改为抢占策略，则执行如下命令。

```
MOD AMFCONFLICTRULE: CSTYPE=UEAM, PROCTYPE="IntraAmfHandover", INITEVENTID="InitN2NotifyEvent", RULE="{\"Name\":\"When\",\"Children\":[{\"Name\":\"ResultPreempt\"}]}";
```
