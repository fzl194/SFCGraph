...
- [命令功能](#ZH-CN_MMLREF_0211712043__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0211712043__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0211712043__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0211712043__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0211712043__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0211712043)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于查询PFCP私有信元携带配置。

## [注意事项](#ZH-CN_MMLREF_0211712043)

无

#### [操作用户权限](#ZH-CN_MMLREF_0211712043)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0211712043)
...
## [输出结果说明](#ZH-CN_MMLREF_0211712043)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 特性名称 | 该参数用于指定特性名称。 |
| 私有信元携带开关 | 该参数用于控制在UNC发送的PFCP消息中，是否允许携带指定特性相关的私有信元。 |
