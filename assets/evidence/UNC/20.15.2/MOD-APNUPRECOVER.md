# 修改指定UPF的APN级别链路故障恢复处理（MOD APNUPRECOVER）

- [命令功能](#ZH-CN_MMLREF_0000001875822984__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001875822984__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001875822984__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001875822984__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001875822984)

**适用NF：SMF**

该命令用于在UPF主备容灾场景下，修改指定UPF的APN级别链路故障恢复处理。

## [注意事项](#ZH-CN_MMLREF_0000001875822984)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001875822984)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001875822984)
...
## [使用实例](#ZH-CN_MMLREF_0000001875822984)
