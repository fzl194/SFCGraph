# 删除强制分离策略(RMV IMEIFORFD)

- [命令功能](#ZH-CN_MMLREF_0000001172345085__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345085__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345085__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345085__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345085__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345085__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345085)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345085)

在分离非活动用户定时器超时后， UNC 强制分离在 [**ADD IMEIFORFD**](增加强制分离策略(ADD IMEIFORFD)_26305298.md) 中没有配置的（包括未配置和先配置后通过此命令删除的）用户。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345085)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345085)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345085)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345085)
