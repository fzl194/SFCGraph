...
- [命令功能](#ZH-CN_MMLREF_0267551556__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0267551556__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0267551556__1.3.3)
- [使用实例](#ZH-CN_MMLREF_0267551556__1.3.4)
- [输出结果说明](#ZH-CN_MMLREF_0267551556__1.3.5)
- [参考信息](#ZH-CN_MMLREF_0267551556__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0267551556)
...
## [输出结果说明](#ZH-CN_MMLREF_0267551556)

命令执行异常，请联系华为技术支持处理。输出结果说明如 [表1](#ZH-CN_MMLREF_0267551556__table1110753814403) 所示。
...
| 130024 | 修改NTP服务器参数失败。 | 出现异常或者内部错误。 | 请联系华为技术支持。 |
| 130028 | 该NTP的服务器密钥串不合法。 | 该服务器密钥串不符合规范。 | 请检查输入的服务器密钥是否符合规范。 |
| 130029 | 该NTP服务器不存在。 | 该NTP服务器不存在。 | 请输入正确的NTP服务器名。 |
| 130030 | 协议版本为NTPV3时不支持身份验证。 | 协议版本为NTPV3时不支持身份验证。 | 请检查服务器协议版本是否为NTPV3。 |
