# 修改接口IPv4地址（MOD IFIPV4ADDRESSIPSEC）

- [命令功能](#ZH-CN_MMLREF_0000001225912251__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001225912251__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001225912251__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001225912251__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001225912251)

该命令用于修改接口上已经配置的IP地址和掩码，包括逻辑接口及物理接口。

## [注意事项](#ZH-CN_MMLREF_0000001225912251)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001225912251)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001225912251)
...
## [使用实例](#ZH-CN_MMLREF_0000001225912251)
