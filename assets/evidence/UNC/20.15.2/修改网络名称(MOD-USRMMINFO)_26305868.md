# 修改网络名称(MOD USRMMINFO)

- [命令功能](#ZH-CN_MMLREF_0000001126305868__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305868__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305868__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305868__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305868__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305868__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305868)

**适用网元：SGSN、MME**

该命令用于修改运营商网络名称。在UE接入 UNC 时，如果需要给UE下发网络名称， UNC 判断UE在本命令配置的用户范围，则优选下发本命令配置的网络名称。

#### [注意事项](#ZH-CN_MMLREF_0000001126305868)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305868)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305868)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305868)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305868)
