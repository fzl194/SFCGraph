# 增加5G MEC区域信息（ADD MECAREA）

- [命令功能](#ZH-CN_MMLREF_0000001534412856__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001534412856__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001534412856__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001534412856__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001534412856)

**适用NF：AMF**

该命令用于增加5G MEC区域信息，位于特定区域的用户可以访问本地特色业务。

## [注意事项](#ZH-CN_MMLREF_0000001534412856)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001534412856)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001534412856)
...
## [使用实例](#ZH-CN_MMLREF_0000001534412856)
