# 修改对端NF的服务发现策略（MOD PNFDISCPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001921861981__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001921861981__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001921861981__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001921861981__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001921861981)

**适用NF：AMF、SMF、NRF、NSSF、NCG**

该命令用于修改对端NF的服务发现策略。

## [注意事项](#ZH-CN_MMLREF_0000001921861981)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001921861981)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001921861981)
...
## [使用实例](#ZH-CN_MMLREF_0000001921861981)
