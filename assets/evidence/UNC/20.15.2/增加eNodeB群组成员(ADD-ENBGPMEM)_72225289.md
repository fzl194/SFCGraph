# 增加eNodeB群组成员(ADD ENBGPMEM)

- [命令功能](#ZH-CN_MMLREF_0000001172225289__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225289__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225289__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225289__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225289__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225289__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225289)

**适用网元：MME**

此命令用于为 [**ADD ENBGP**](../eNodeB群组管理/增加eNodeB群组(ADD ENBGP)_26145606.md) 增加的eNodeB群组添加一条成员记录。

#### [注意事项](#ZH-CN_MMLREF_0000001172225289)

- 此命令最大记录数为10000。
- 此命令执行后立即生效。
- 各个eNodeB群组下的eNodeB不能有重叠。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225289)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225289)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225289)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225289)
