# 显示指定VM上转发使用的所有或指定队列的详细信息（DSP SFE_QUEUE）

- [命令功能](#ZH-CN_CONCEPT_0000001600866065__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600866065__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600866065__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600866065__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600866065__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600866065__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600866065)

该命令用于显示指定资源单元上的所有或指定队列的详细信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600866065)

该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600866065)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600866065)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600866065)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600866065)
...
| 写入队列失败个数 | 写入队列失败个数。 |
| 队列名称 | 队列名称。 |
| 是否过载 | 队列是否过载：<br>- TRUE：是。<br>- FALSE：否。 |
| RU名称 | 指定资源单元名称。 |
