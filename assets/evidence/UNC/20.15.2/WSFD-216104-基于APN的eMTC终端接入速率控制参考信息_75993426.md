# WSFD-216104 基于APN的eMTC终端接入速率控制参考信息

- [命令](#ZH-CN_TOPIC_0275993426__1.3.1.1)
- [告警](#ZH-CN_TOPIC_0275993426__1.3.2.1)
- [软参](#ZH-CN_TOPIC_0275993426__1.3.3.1)
- [测量指标](#ZH-CN_TOPIC_0275993426__1.3.4.1)

#### [命令](#ZH-CN_TOPIC_0275993426)

本特性相关MML命令如下：

- [**SET GLBAPNRATECTRL**](../../../../../OM参考/命令/UNC MML命令/业务服务管理/会话管理/接入管理/速率控制/APN速率控制/全局APN速率控制配置/设置全局APN速率控制配置（SET GLBAPNRATECTRL）_64343915.md)
- [**LST GLBAPNRATECTRL**](../../../../../OM参考/命令/UNC MML命令/业务服务管理/会话管理/接入管理/速率控制/APN速率控制/全局APN速率控制配置/查询全局APN速率控制配置（LST GLBAPNRATECTRL）_64343885.md)
...
#### [软参](#ZH-CN_TOPIC_0275993426)

本特性无相关软参。

#### [测量指标](#ZH-CN_TOPIC_0275993426)
