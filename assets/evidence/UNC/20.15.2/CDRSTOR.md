...
- [命令功能](#ZH-CN_CONCEPT_0251174280__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0251174280__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0251174280__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0251174280__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0251174280__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0251174280__1.3.6.1)
- [输出结果说明](#ZH-CN_CONCEPT_0251174280__1.3.7.1)

#### [命令功能](#ZH-CN_CONCEPT_0251174280)

**适用NF：NCG**

该命令用于查询当前系统已配置的话单存储信息。

#### [注意事项](#ZH-CN_CONCEPT_0251174280)

当前版本不支持Bi口SingleIP功能，请勿开启。

#### [本地用户权限](#ZH-CN_CONCEPT_0251174280)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0251174280)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0251174280)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0251174280)

参见 [**ADD CDRSTOR**](增加话单存储（ADD CDRSTOR）_51174277.md) 的参数说明。
