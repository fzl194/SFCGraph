# 修改Diameter链路配置(MOD DMLNK)

- [命令功能](#ZH-CN_MMLREF_0000001172345875__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345875__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345875__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345875__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345875__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345875__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345875)

**适用网元：SGSN、MME**

该命令用于修改一条Diameter链路配置。

#### [注意事项](#ZH-CN_MMLREF_0000001172345875)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345875)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345875)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345875)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345875)
