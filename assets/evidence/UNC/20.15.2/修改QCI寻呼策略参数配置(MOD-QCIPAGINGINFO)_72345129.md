# 修改QCI寻呼策略参数配置(MOD QCIPAGINGINFO)

- [命令功能](#ZH-CN_MMLREF_0000001172345129__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345129__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345129__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345129__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345129__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345129__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345129)

**适用网元：MME**

该命令用于修改QCI（QoS Class Identifier）寻呼策略配置。系统可以通过对特性QCI的寻呼策略参数配置来决定寻呼的等待间隔和次数。

#### [注意事项](#ZH-CN_MMLREF_0000001172345129)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345129)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345129)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345129)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345129)
