...
- [命令功能](#ZH-CN_MMLREF_0000001172225065__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225065__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225065__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225065__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225065__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225065__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225065)

**适用网元：SGSN**

该命令用来删除 “IMSI前缀” 计费配置表中某条 “IMSI前缀” 的配置。

#### [注意事项](#ZH-CN_MMLREF_0000001172225065)

- 该命令执行后立即生效，影响新激活用户的话单生成策略，但该配置只对之后激活的用户有效。
- 当没有指定“计费属性”、“拜访类型”字段时，如果输入的必选参数“用户范围”、“IMSI前缀”、“APNNI”能够同时匹配到多条记录，则此操作会将所有的匹配记录删除。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225065)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225065)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225065)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225065)
