# 增加基于APN的PGW计费暂停功能配置（ADD APNPGWCHGPAUSE）

- [命令功能](#ZH-CN_MMLREF_0000001142693464__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001142693464__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001142693464__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001142693464__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001142693464)

**适用NF：PGW-C**

该命令用于开启或关闭基于APN的PGW计费暂停功能。

## [注意事项](#ZH-CN_MMLREF_0000001142693464)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001142693464)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001142693464)
...
## [使用实例](#ZH-CN_MMLREF_0000001142693464)
