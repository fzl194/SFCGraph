# 查询指定DNAI的UPF节点信息（LST DNAIUPFINFO）

- [命令功能](#ZH-CN_MMLREF_0000001268798040__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001268798040__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001268798040__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001268798040__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001268798040__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001268798040)

**适用NF：SMF、PGW-C**

该命令用于查询指定DNAI的UPF节点信息。

## [注意事项](#ZH-CN_MMLREF_0000001268798040)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001268798040)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001268798040)
...
## [使用实例](#ZH-CN_MMLREF_0000001268798040)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001268798040)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 数据网络访问标识 | 该参数用于指定数据网络访问标识。 |
| UPF实例标识 | 该参数用于指定UPF实例名称。 |
| UPF共享开关 | 该参数用于表示该DNAI下UPF是否支持作为共享UPF使用。 |
