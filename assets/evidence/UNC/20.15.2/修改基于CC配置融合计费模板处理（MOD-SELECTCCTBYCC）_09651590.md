# 修改基于CC配置融合计费模板处理（MOD SELECTCCTBYCC）

- [命令功能](#ZH-CN_MMLREF_0209651590__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651590__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651590__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651590__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651590)

**适用NF：PGW-C、SMF、SGW-C**

该命令用于修改基于CC配置融合计费模板处理。

## [注意事项](#ZH-CN_MMLREF_0209651590)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209651590)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651590)
...
## [使用实例](#ZH-CN_MMLREF_0209651590)

修改基于CC值为1234配置融合计费模板global处理：

```
MOD SELECTCCTBYCC: CCTYPE=VALUE, CCVALUE="1234", CCTMPLTNAME="global";
```
