# 设置RAN侧拥塞检测功能参数(SET SCTPCCTRLPARA)

- [命令功能](#ZH-CN_MMLREF_0000001556488512__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001556488512__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001556488512__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001556488512__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001556488512__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001556488512__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001556488512)

**适用网元：MME、AMF**

该命令用于配置SCTP链路拥塞控制相关参数信息。

#### [注意事项](#ZH-CN_MMLREF_0000001556488512)

- 该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001556488512)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001556488512)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001556488512)
...
#### [使用实例](#ZH-CN_MMLREF_0000001556488512)
