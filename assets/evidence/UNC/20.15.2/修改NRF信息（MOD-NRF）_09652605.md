...
- [命令功能](#ZH-CN_MMLREF_0209652605__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652605__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652605__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652605__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652605)

**适用NF：AMF、SMF、NRF、NSSF、SMSF、NCG、CBCF**

该命令用于在NF（可以是NRF）上修改需要对接的对端NRF实例信息。

## [注意事项](#ZH-CN_MMLREF_0209652605)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652605)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652605)
