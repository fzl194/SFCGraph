# 设置MAP功能配置(SET MAPFUNC)

- [命令功能](#ZH-CN_MMLREF_0000001126145466__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145466__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145466__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145466__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145466__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145466__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145466)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126145466)

- 系统初次运行时，会执行系统初始设置值。
- 该命令执行后立即生效。
- 修改MAP的功能表会导致部分附着的用户属性与SGSN的配置不一致。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145466)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145466)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145466)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145466)
