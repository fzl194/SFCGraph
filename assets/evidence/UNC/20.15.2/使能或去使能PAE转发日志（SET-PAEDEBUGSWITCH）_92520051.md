# 使能或去使能PAE转发日志（SET PAEDEBUGSWITCH）

- [命令功能](#ZH-CN_CONCEPT_0192520051__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0192520051__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0192520051__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0192520051__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0192520051__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0192520051)
...
#### [注意事项](#ZH-CN_CONCEPT_0192520051)

1. 该命令执行后立即生效。
2. 在需要定位转发异常时，打开该开关可以辅助定位，但打开开关后，对转发性能有一定的影响。建议保持该开关为默认的关闭状态。

#### [操作用户权限](#ZH-CN_CONCEPT_0192520051)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0192520051)
