# 增加PGW重定向配置(ADD PGWRNSI)

- [命令功能](#ZH-CN_CONCEPT_0000001618730832__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001618730832__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001618730832__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001618730832__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001618730832__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001618730832__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001618730832)

**适用网元：SGSN、MME**

该命令用于MME在选择网关时开启PGW重定向功能，当用户在4G切换到5G场景下，需要保证业务连续性时开启该功能。

#### [注意事项](#ZH-CN_CONCEPT_0000001618730832)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0000001618730832)

manage-ug；system-ug；

#### [网管用户权限](#ZH-CN_CONCEPT_0000001618730832)

G_1，管理员级别命令组；G_2，操作员级别命令组；

#### [参数说明](#ZH-CN_CONCEPT_0000001618730832)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001618730832)
