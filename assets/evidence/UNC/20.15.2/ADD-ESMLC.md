# 增加E-SMLC配置(ADD ESMLC)

- [命令功能](#ZH-CN_MMLREF_0000001126145800__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145800__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145800__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145800__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145800__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145800__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145800)

**适用网元：MME**

此命令用于增加E-SMLC配置。在MME系统中配置E-SMLC信息，用于MME进行负荷分担选择E-SMLC。

#### [注意事项](#ZH-CN_MMLREF_0000001126145800)

- 该命令执行后立即生效。
- 此命令最大记录数为6。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145800)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145800)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145800)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145800)
