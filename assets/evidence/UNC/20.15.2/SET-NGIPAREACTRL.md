# 设置基于位置的地址分配控制参数（SET NGIPAREACTRL）

- [命令功能](#ZH-CN_MMLREF_0296243157__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243157__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243157__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243157__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243157)

**适用NF：AMF**

该命令用于设置“基于位置的地址分配”的策略。

## [注意事项](#ZH-CN_MMLREF_0296243157)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243157)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243157)
