# 设置通知流控参数配置（SET NSSFNTFYFCPARA）

- [命令功能](#ZH-CN_MMLREF_0000001097258366__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001097258366__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001097258366__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001097258366__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001097258366)

**适用NF：NSSF**

该命令用于配置NSSF订阅通知流程流控参数信息。

## [注意事项](#ZH-CN_MMLREF_0000001097258366)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001097258366)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001097258366)
...
## [使用实例](#ZH-CN_MMLREF_0000001097258366)
