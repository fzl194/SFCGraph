# 查询过滤器组成员（LST FILTERGPMEMBER）

- [命令功能](#ZH-CN_MMLREF_0209651746__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651746__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651746__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651746__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209651746__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209651746)

**适用NF：SMF**

该命令用于查询系统中已有的过滤器信息。

## [注意事项](#ZH-CN_MMLREF_0209651746)

无

#### [操作用户权限](#ZH-CN_MMLREF_0209651746)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651746)
...
## [输出结果说明](#ZH-CN_MMLREF_0209651746)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 过滤组ID | 该参数用于指定过滤器从属过滤组的ID。 |
| 方向 | 该参数用于指定此过滤器的过滤方向。 |
| 过滤器类型 | 该参数用于指定过滤器类型。 |
| 远端IPv4 | 该参数用于指定远端IPv4地址。 |
| 远端IPv6 | 该参数用于指定远端IPv6地址。 |
| UE IPv4 | 该参数用于指定UE的IPv4地址。 |
| UE IPv6 | 该参数用于指定UE的IPv6地址。 |
