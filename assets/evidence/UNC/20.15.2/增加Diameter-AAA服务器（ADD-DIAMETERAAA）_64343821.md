# 增加Diameter AAA服务器（ADD DIAMETERAAA）

- [命令功能](#ZH-CN_MMLREF_0264343821__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0264343821__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0264343821__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0264343821__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0264343821)

**适用NF：PGW-C**

此命令用于添加Diameter AAA服务器，配置Diameter AAA服务器主机名、域名和VPN实例。如果PGW-C需要向Diameter AAA服务器请求授权，需要执行该命令。

## [注意事项](#ZH-CN_MMLREF_0264343821)

- 该命令执行后对新接入的non-3GPP会话生效。

- 最多可输入10条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0264343821)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0264343821)
