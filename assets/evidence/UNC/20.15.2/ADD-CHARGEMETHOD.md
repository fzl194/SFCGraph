# 增加计费方式（ADD CHARGEMETHOD）

- [命令功能](#ZH-CN_CONCEPT_0209896795__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896795__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896795__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896795__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896795__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896795)

**适用NF：PGW-C、SMF**

ADD CHARGEMETHOD命令用来基于用户计费属性配置在线计费、离线计费和融合计费方式。

#### [注意事项](#ZH-CN_CONCEPT_0209896795)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896795)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896795)
