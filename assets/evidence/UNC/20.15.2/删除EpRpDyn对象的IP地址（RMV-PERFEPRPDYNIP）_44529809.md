# 删除EpRpDyn对象的IP地址（RMV PERFEPRPDYNIP）

- [命令功能](#ZH-CN_MMLREF_0244529809__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244529809__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244529809__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244529809__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244529809)

**适用NF：SGW-C、PGW-C、GGSN**

该命令用于删除EpRpDyn对象的本端IP地址或者对端IP地址段。

## [注意事项](#ZH-CN_MMLREF_0244529809)
...
#### [操作用户权限](#ZH-CN_MMLREF_0244529809)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244529809)
