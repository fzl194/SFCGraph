# 修改接口下ICMP安全配置（MOD IFICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001550280786__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280786__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280786__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280786__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280786__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280786)

该命令用于修改接口下ICMP安全配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280786)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280786)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280786)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280786)

修改LoopBack0接口上的ICMP安全配置实例，该安全配置与发送ICMP Echo类型报文的能力相关：

```
MOD IFICMPSECURITY: IFNAME="LoopBack0", ACTION=sndPkt, CONFIGTYPE=PKTTYPE, PKTTYPE=echo, SWITCHOP=disable;
```
