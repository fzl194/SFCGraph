# 增加基于APN的反向分流配置（ADD APNREVERSESHUNT）

- [命令功能](#ZH-CN_MMLREF_0000001151696222__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001151696222__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001151696222__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001151696222__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001151696222)

**适用NF：SMF**

该命令用于开启或关闭基于APN的反向分流功能。

## [注意事项](#ZH-CN_MMLREF_0000001151696222)

- 该命令执行后只对新激活用户生效。

- 最多可输入20000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001151696222)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001151696222)
...
## [使用实例](#ZH-CN_MMLREF_0000001151696222)
