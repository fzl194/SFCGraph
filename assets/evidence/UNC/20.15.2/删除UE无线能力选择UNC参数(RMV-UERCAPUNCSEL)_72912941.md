# 删除UE无线能力选择UNC参数(RMV UERCAPUNCSEL)

- [命令功能](#ZH-CN_CONCEPT_0000001772912941__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001772912941__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001772912941__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001772912941__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001772912941__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001772912941__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001772912941)

**适用网元：MME**

该命令用于删除指定用户范围用户UE无线能力选择UNC的参数。

#### [注意事项](#ZH-CN_CONCEPT_0000001772912941)

- 该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001772912941)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001772912941)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001772912941)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001772912941)
