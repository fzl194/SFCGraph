# 增加TALIST寻呼不重发TAC区间(ADD TALISTPAGINGCFG)

- [命令功能](#ZH-CN_MMLREF_0000001126146386__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146386__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146386__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146386__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146386__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146386__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146386)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126146386)

- 此命令最大记录数为128。
- 此命令只控制寻呼范围为TALIST的场景；如果匹配到精确寻呼或智能寻呼，只控制TALIST的寻呼是否重发。
- 该命令执行后立即生效，对命令配置后发起寻呼的4G、NSA和NBIOT用户生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146386)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146386)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146386)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146386)
