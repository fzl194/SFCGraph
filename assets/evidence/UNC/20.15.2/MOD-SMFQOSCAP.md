# 修改QosFlow QoS限制的配置（MOD SMFQOSCAP）

- [命令功能](#ZH-CN_MMLREF_0000001376239568__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001376239568__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001376239568__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001376239568__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001376239568)

**适用NF：SMF**

该命令用于修改QosFlow QoS限制的相关配置。

## [注意事项](#ZH-CN_MMLREF_0000001376239568)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001376239568)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001376239568)
...
## [使用实例](#ZH-CN_MMLREF_0000001376239568)
