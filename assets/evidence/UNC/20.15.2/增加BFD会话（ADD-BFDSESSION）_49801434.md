# 增加BFD会话（ADD BFDSESSION）

- [命令功能](#ZH-CN_CONCEPT_0000001549801434__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801434__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801434__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801434__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801434__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801434)

该命令用于增加BFD静态会话。静态会话已明确被检测链路的链路信息，其中静态非自协商会话两端已提前规划好描述符ID。静态会话方式相较于动态会话方式，配置更加灵活。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801434)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801434)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801434)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801434)
