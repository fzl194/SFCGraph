# 修改PCRF组（MOD PCRFGROUP）

- [命令功能](#ZH-CN_CONCEPT_0209897091__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897091__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897091__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897091__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897091__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897091)

**适用NF：PGW-C、GGSN**

此命令用于修改指定的PCRF组是否支持Gx的failover功能以及修改PCRF组的工作模式。

#### [注意事项](#ZH-CN_CONCEPT_0209897091)

- 该命令执行后立即生效。
- UNC使用PCC策略和计费控制，为PCRF组设置宕机备份功能时，要求此PCRF组必须是有效的（即此PCRF组下至少已绑定了一个有效的PCRF）。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897091)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897091)
