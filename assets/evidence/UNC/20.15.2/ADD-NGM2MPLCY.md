# 增加5G M2M策略参数（ADD NGM2MPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001585251937__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001585251937__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001585251937__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001585251937__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001585251937)

**适用NF：AMF**

该命令用于增加5G M2M的策略参数，即为不同范围的用户、不同的DNN和切片业务配置M2M业务相关参数，以满足运营商灵活部署网络的需求。

## [注意事项](#ZH-CN_MMLREF_0000001585251937)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001585251937)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001585251937)
...
## [使用实例](#ZH-CN_MMLREF_0000001585251937)
