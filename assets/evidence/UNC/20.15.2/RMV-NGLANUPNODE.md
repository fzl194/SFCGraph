# 删除指定实例名称的UPF节点特征（RMV NGLANUPNODE）

- [命令功能](#ZH-CN_MMLREF_0000001252149912__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001252149912__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001252149912__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001252149912__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001252149912)

**适用NF：SMF**

该命令用于5G LAN场景中删除指定UPF实例对应的UPF节点特征参数。

## [注意事项](#ZH-CN_MMLREF_0000001252149912)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001252149912)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001252149912)
...
## [使用实例](#ZH-CN_MMLREF_0000001252149912)
