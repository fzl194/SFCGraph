# 设置DDN信令抑制参数(SET DDNTHROTPARA)

- [命令功能](#ZH-CN_MMLREF_0000001126305980__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305980__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305980__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305980__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305980__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305980__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305980)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305980)

- 参数“DDN信令抑制时长（秒）”和“策略发送时长（秒）”在下一次抑制比例（Throttling Factor）改变时生效。其他参数，在命令执行完后立即生效。
- 请仔细阅读本命令的注意事项，确保开启本功能对网络中的S-GW不造成预期外的影响。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305980)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305980)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305980)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305980)
