# 修改Iu模式用户安全参数(MOD IUAUTHCIPH)

- [命令功能](#ZH-CN_MMLREF_0000001172345245__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345245__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345245__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345245__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345245__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345245__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345245)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345245)

- 此命令对于当前系统内已存在签约数据的用户不立即生效，在用户再次触发安全流程后生效。
- Uplink NAS类型的Detach不会鉴权。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345245)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345245)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345245)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345245)
