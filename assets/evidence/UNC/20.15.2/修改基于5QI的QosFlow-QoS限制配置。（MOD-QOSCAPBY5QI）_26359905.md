# 修改基于5QI的QosFlow QoS限制配置。（MOD QOSCAPBY5QI）

- [命令功能](#ZH-CN_MMLREF_0000001426359905__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001426359905__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001426359905__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001426359905__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001426359905)

**适用NF：SMF**

该命令用于修改基于5QI的QosFlow QoS限制的相关配置参数。

## [注意事项](#ZH-CN_MMLREF_0000001426359905)

命令执行后只对新接入用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001426359905)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001426359905)
...
## [使用实例](#ZH-CN_MMLREF_0000001426359905)

修改“用户范围”为“IMSI_PREFIX”，“IMSI前缀”为“3080107000”，“QOS5QI”为“9”的QOSCAPBY5QI配置，修改“ARP的优先级别”为“5”，“ARP的抢占能力”为“Preempt”,“ARP的被抢占能力”为“Not Preemptable”：

```
MOD QOSCAPBY5QI:SUBRANGE=IMSI_PREFIX,IMSIPRE="3080107000",QOS5QI=9,ARPPRL=5,ARPPCI=MAY_PREEMPT,ARPPVI=NOT_PREEMPTABLE;
```
