# 删除GUTI选网功能区域成员（RMV GUTISELAREAMEM）

- [命令功能](#ZH-CN_MMLREF_0000002014059369__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002014059369__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002014059369__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002014059369__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002014059369)

**适用NF：AMF**

该命令用于从GUTI选网功能指定的区域删除跟踪区成员。

## [注意事项](#ZH-CN_MMLREF_0000002014059369)

- 该命令执行后立即生效。

- 该命令用于从GUTI选网功能指定的区域删除跟踪区成员。

#### [操作用户权限](#ZH-CN_MMLREF_0000002014059369)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002014059369)
...
## [使用实例](#ZH-CN_MMLREF_0000002014059369)
