# 删除NRF实例地址信息（RMV NRFADDR）

- [命令功能](#ZH-CN_MMLREF_0209654178__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654178__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654178__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654178__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654178)

**适用NF：AMF、SMF、NRF、NSSF、SMSF、NCG、CBCF**

该命令用于删除NRF实例地址信息。

## [注意事项](#ZH-CN_MMLREF_0209654178)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209654178)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654178)
...
## [使用实例](#ZH-CN_MMLREF_0209654178)

删除NRF地址信息，NRF实例名称为NRF_Instance_0，IP地址类型为IPV4类型，IPV4地址为192.168.0.1，端口号为8081。

```
RMV NRFADDR: NRFINSTANCENAME="NRF_Instance_0", IPADDRESSTYPE=IPTypeV4, IPV4ADDRESS="192.168.0.1";
```
