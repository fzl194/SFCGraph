# 设置数据核查扫描参数（SET SMSDATACHECK）

- [命令功能](#ZH-CN_MMLREF_0264343919__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0264343919__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0264343919__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0264343919__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0264343919)

**适用NF：SMSF**

该命令用于设置SMSF数据核查时的扫描速率和周期，以及SMSF数据有效时长。

## [注意事项](#ZH-CN_MMLREF_0264343919)
...
#### [操作用户权限](#ZH-CN_MMLREF_0264343919)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0264343919)
