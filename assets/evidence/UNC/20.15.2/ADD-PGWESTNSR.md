# 增加E-STN-SR和PGW关系配置表(ADD PGWESTNSR)

- [命令功能](#ZH-CN_MMLREF_0000001172345105__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345105__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345105__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345105__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345105__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345105__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345105)

**适用网元：MME**

该命令用于增加SRVCC的紧急会话转移号码和P-GW关系配置表。通过本命令配置的PGW IP来找到P-GW对应的“SRVCC的紧急会话转移号码”。与华为MSC设备对接需要配置本命令。

#### [注意事项](#ZH-CN_MMLREF_0000001172345105)

- 此命令执行后立即生效。
- 此命令最大记录数为256。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345105)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345105)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345105)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345105)
