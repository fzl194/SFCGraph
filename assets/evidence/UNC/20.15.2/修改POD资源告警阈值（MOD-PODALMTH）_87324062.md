# 修改POD资源告警阈值（MOD PODALMTH）

- [命令功能](#ZH-CN_MMLREF_0000001687324062__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001687324062__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001687324062__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001687324062__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001687324062)

该命令用于修改POD资源告警阈值。

## [注意事项](#ZH-CN_MMLREF_0000001687324062)

- 该命令执行后立即生效。

- 该命令仅在FusionStage裸机场景下生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001687324062)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001687324062)
...
## [使用实例](#ZH-CN_MMLREF_0000001687324062)
