# 增加指定群组的5G LAN会话扩展参数（ADD GRPNGLANFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001990458520__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001990458520__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001990458520__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001990458520__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001990458520)

**适用NF：SMF**

该命令用于添加指定会话组NGLAN扩展功能。

## [注意事项](#ZH-CN_MMLREF_0000001990458520)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001990458520)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001990458520)
...
## [使用实例](#ZH-CN_MMLREF_0000001990458520)
