# 设置H-SFN参考时间(SET HSFNTIME)

- [命令功能](#ZH-CN_MMLREF_0000001126305580__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305580__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305580__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305580__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305580__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305580__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305580)

**适用网元：MME、AMF**

此命令用于设置eDRX特性中H-SFN=0的参考时间，该参考时间用于与eNodeB/gNodeB对齐H-SFN为0的起始时间。

#### [注意事项](#ZH-CN_MMLREF_0000001126305580)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305580)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305580)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305580)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305580)
