# 增加融合计费Proxy基于RG处理动作（ADD CCPRGACT）

- [命令功能](#ZH-CN_MMLREF_0000001092852764__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001092852764__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001092852764__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001092852764__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001092852764)

**适用NF：NCG**

该命令用于增加融合计费Proxy基于RG的处理动作。

## [注意事项](#ZH-CN_MMLREF_0000001092852764)

- 该命令执行后立即生效。

- 最多可输入1010条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001092852764)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001092852764)
...
## [使用实例](#ZH-CN_MMLREF_0000001092852764)
