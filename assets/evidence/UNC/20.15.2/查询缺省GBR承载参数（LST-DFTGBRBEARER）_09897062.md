# 查询缺省GBR承载参数（LST DFTGBRBEARER）

- [命令功能](#ZH-CN_CONCEPT_0209897062__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897062__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897062__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897062__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897062__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209897062__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897062)

**适用NF：PGW-C、SMF**

该命令用于查询SMF是否支持创建default-gbr承载（提供最低带宽保障的any to any GBR专有承载）、本地触发创建default-gbr承载时的承载QoS、以及删除default-gbr承载时SMF是否去活整个PDU会话。

#### [注意事项](#ZH-CN_CONCEPT_0209897062)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897062)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897062)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209897062)

参见SET DFTGBRBEARER的参数说明。
