# 查询去活用户面专有QoS Flow策略（LST DEACTQFPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001092022694__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001092022694__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001092022694__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001092022694__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001092022694__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001092022694)

**适用NF：SMF**

该命令用于查询去活用户面专有QoS Flow策略。

## [注意事项](#ZH-CN_MMLREF_0000001092022694)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001092022694)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001092022694)
...
## [使用实例](#ZH-CN_MMLREF_0000001092022694)
