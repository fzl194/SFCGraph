...
- [操作场景](#ZH-CN_OPI_0315408914__1.3.1)
- [必备事项](#ZH-CN_OPI_0315408914__1.3.2)
- [操作步骤](#ZH-CN_OPI_0315408914__1.3.3)
- [任务示例](#ZH-CN_OPI_0315408914__1.3.4)

## [操作场景](#ZH-CN_OPI_0315408914)

用户进行在线/离线计费的方式可以通过其他对接网元下发，也可以在GGSN/PGW-C本地配置，本文描述在GGSN/PGW-C上如何配置在线/离线计费的开关。

- GGSN/PGW-C的离线计费方式选择有PCRF下发、本地配置，本地配置有三种粒度：UserProfile、APN和计费属性CC，这些方式的优先级依次降低。如[图1](#ZH-CN_OPI_0315408914__zh-cn_opi_0295923455_fig517555792110)所示为GGSN/PGW-C的离线计费方式选择图。
  **图1** 离线计费方式选择图

  <br>

  ![](配置离线_在线计费方式（GGSN_PGW-C）_15408914.assets/zh-cn_image_0292153500_2.png)
- GGSN/PGW-C的在线计费方式选择有PCRF下发、RADIUS Server下发、本地配置，本地配置有三种粒度：UserProfile、APN和计费属性CC，如[图2](#ZH-CN_OPI_0315408914__zh-cn_opi_0295923455_fig188082038205017)所示为GGSN/PGW-C的在线计费方式选择图。
  **图2** 在线计费方式选择图

  <br>

  ![](配置离线_在线计费方式（GGSN_PGW-C）_15408914.assets/zh-cn_image_0292153501_2.png)
...
## [必备事项](#ZH-CN_OPI_0315408914)

前提条件

- 请仔细阅读[Ga/Gy接口离线/在线计费](../../../../../业务专题/5G Core 计费解决方案/计费解决方案概述/计费原理/Ga_Gy接口离线_在线计费_87165686.md)。
- 完成[配置到CG的数据（GGSN/SGW-C/PGW-C）](../../WSFD-011201 支持离线计费/激活离线计费/配置到CG的数据（GGSN_SGW-C_PGW-C）_95923479.md)。
