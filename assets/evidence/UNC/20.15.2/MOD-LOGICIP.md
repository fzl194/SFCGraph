# 修改逻辑IP地址信息（MOD LOGICIP）

- [命令功能](#ZH-CN_MMLREF_0209587870__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209587870__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209587870__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209587870__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209587870)

该命令用于修改逻辑IP配置。

## [注意事项](#ZH-CN_MMLREF_0209587870)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209587870)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209587870)
