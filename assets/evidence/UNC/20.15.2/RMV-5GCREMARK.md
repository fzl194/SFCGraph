# 删除5GC QoS到TOS/DSCP的映射规则（RMV 5GCREMARK）

- [命令功能](#ZH-CN_MMLREF_0209652352__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652352__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652352__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652352__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652352)

**适用NF：SMF**

该命令用来删除5G用户QoS参数到IP DSCP（区别服务编码点）/TOS（服务类型）的映射配置。输入必选参数Qos Profile名时，支持批量删除。

## [注意事项](#ZH-CN_MMLREF_0209652352)

命令执行后只对新接入用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652352)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652352)
