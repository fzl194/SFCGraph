# 修改计费属性与在线计费模板绑定关系（MOD GLBDCCTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0209896936__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896936__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896936__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896936__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896936__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896936)

**适用NF：PGW-C、SMF**

该命令用于修改计费属性与在线计费模板的配置绑定关系。

#### [注意事项](#ZH-CN_CONCEPT_0209896936)

- 该命令执行后立即生效。
- 该命令不可以修改计费属性值和计费属性的掩码，可以修改绑定的在线计费模板名称。
- 全局在线模板（DccTemplate名称为global）不允许绑定在计费属性下。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896936)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896936)
