# 增加Proxy SMF接入控制列表（ADD PROXYSMFACCLIST）

- [命令功能](#ZH-CN_MMLREF_0000001870462517__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870462517__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870462517__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870462517__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870462517)

**适用NF：SMF**

该命令用于Proxy SMF特性中增加接入控制列表记录。

## [注意事项](#ZH-CN_MMLREF_0000001870462517)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001870462517)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870462517)
...
## [使用实例](#ZH-CN_MMLREF_0000001870462517)
