# 删除VSMF的Default QoS Flow配置（RMV VSMFDFTQOSCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001182104340__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001182104340__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001182104340__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001182104340__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001182104340)

**适用NF：SMF**

该命令用来删除VSMF的Default QoS Flow配置。

## [注意事项](#ZH-CN_MMLREF_0000001182104340)

命令执行后只对新接入用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001182104340)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001182104340)
...
## [使用实例](#ZH-CN_MMLREF_0000001182104340)
