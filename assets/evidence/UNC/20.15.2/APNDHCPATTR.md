# 设置APN DHCP属性配置（SET APNDHCPATTR）

- [命令功能](#ZH-CN_MMLREF_0296243072__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243072__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243072__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243072__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243072)

**适用NF：GGSN、PGW-C、SMF**

该命令用于设置APN的DHCP相关信息，当用户需要修改APN下配置的DHCP信息时，可以使用该命令。

## [注意事项](#ZH-CN_MMLREF_0296243072)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243072)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243072)
