# 删除PDU会话激活控制参数（RMV PDUACTCTRL）

- [命令功能](#ZH-CN_MMLREF_0000002119641134__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002119641134__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002119641134__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002119641134__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002119641134)

**适用NF：AMF**

该命令用于删除基于DNN配置PDU会话激活处理策略。

## [注意事项](#ZH-CN_MMLREF_0000002119641134)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000002119641134)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002119641134)
...
## [使用实例](#ZH-CN_MMLREF_0000002119641134)
