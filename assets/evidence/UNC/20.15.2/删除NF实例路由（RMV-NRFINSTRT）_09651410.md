# 删除NF实例路由（RMV NRFINSTRT）

- [命令功能](#ZH-CN_MMLREF_0209651410__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651410__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651410__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651410__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651410)

**适用NF：NRF**

该命令用于删除目标NF的实例标识路由信息。

## [注意事项](#ZH-CN_MMLREF_0209651410)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651410)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651410)
