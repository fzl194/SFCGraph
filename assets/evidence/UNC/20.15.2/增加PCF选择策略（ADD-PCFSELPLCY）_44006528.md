# 增加PCF选择策略（ADD PCFSELPLCY）

- [命令功能](#ZH-CN_MMLREF_0244006528__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244006528__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244006528__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244006528__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244006528)

**适用NF：AMF**

该命令用于对指定的用户群增加PCF的选择策略。通过本配置，AMF可以对不同用户群使用差异化的条件选择到不同的PCF，以满足运营商灵活部署网络的要求。

## [注意事项](#ZH-CN_MMLREF_0244006528)
...
#### [操作用户权限](#ZH-CN_MMLREF_0244006528)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244006528)
