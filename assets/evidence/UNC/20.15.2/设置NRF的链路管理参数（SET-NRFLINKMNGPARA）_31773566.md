# 设置NRF的链路管理参数（SET NRFLINKMNGPARA）

- [命令功能](#ZH-CN_MMLREF_0231773566__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0231773566__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0231773566__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0231773566__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0231773566)

**适用NF：NRF**

该命令用于配置NRF的链路管理参数。

## [注意事项](#ZH-CN_MMLREF_0231773566)
...
#### [操作用户权限](#ZH-CN_MMLREF_0231773566)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0231773566)
