# 删除对端NF的服务区信息（RMV PNFSRVSCOPE）

- [命令功能](#ZH-CN_MMLREF_0000001555745520__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001555745520__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001555745520__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001555745520__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001555745520)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于删除本地配置的对端NF实例支持的服务区信息。

## [注意事项](#ZH-CN_MMLREF_0000001555745520)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001555745520)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001555745520)
...
## [使用实例](#ZH-CN_MMLREF_0000001555745520)
