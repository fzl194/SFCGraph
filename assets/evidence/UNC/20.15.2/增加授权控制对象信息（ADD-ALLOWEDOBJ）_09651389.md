# 增加授权控制对象信息（ADD ALLOWEDOBJ）

- [命令功能](#ZH-CN_MMLREF_0209651389__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651389__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651389__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651389__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651389)

**适用NF：NRF**

该命令用于新增授权控制对象信息中的FQDN信息。

## [注意事项](#ZH-CN_MMLREF_0209651389)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651389)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651389)
