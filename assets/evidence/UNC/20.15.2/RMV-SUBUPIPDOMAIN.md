# 删除当前UPF扩展类型绑定的IP域（RMV SUBUPIPDOMAIN）

- [命令功能](#ZH-CN_MMLREF_0000001623804526__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001623804526__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001623804526__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001623804526__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001623804526)

**适用NF：PGW-C、SMF**

该命令用于删除当前UPF扩展类型绑定的IPDomain。

## [注意事项](#ZH-CN_MMLREF_0000001623804526)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001623804526)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001623804526)
...
## [使用实例](#ZH-CN_MMLREF_0000001623804526)
