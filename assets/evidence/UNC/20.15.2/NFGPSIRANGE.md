# 查询NF GPSIRANGE信息（LST NFGPSIRANGE）

- [命令功能](#ZH-CN_MMLREF_0000001291699945__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001291699945__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001291699945__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001291699945__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001291699945__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001291699945)

**适用NF：SMSF**

该命令用于显示NF实例支持的GPSIRANGE信息。

## [注意事项](#ZH-CN_MMLREF_0000001291699945)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001291699945)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001291699945)
...
## [使用实例](#ZH-CN_MMLREF_0000001291699945)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001291699945)

| 输出项名称 | 输出项解释 |
| --- | --- |
| NF实例名称 | 该参数用于指定GPSIRANGE对应的NF实例名称。 |
| 起始号段 | 该参数用于指定GPSI的起始号段。 |
| 终止号段 | 该参数用于指定GPSI的终止号段。 |
