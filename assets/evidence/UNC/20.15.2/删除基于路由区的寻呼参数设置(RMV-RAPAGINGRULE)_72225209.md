# 删除基于路由区的寻呼参数设置(RMV RAPAGINGRULE)

- [命令功能](#ZH-CN_MMLREF_0000001172225209__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225209__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225209__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225209__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225209__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225209__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225209)

**适用网元：SGSN**

该命令用于删除特定路由区对应的寻呼策略配置。

#### [注意事项](#ZH-CN_MMLREF_0000001172225209)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225209)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225209)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225209)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225209)
