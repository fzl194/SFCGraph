...
- [命令功能](#ZH-CN_CONCEPT_0209896955__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896955__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896955__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896955__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896955__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896955)
...
#### [注意事项](#ZH-CN_CONCEPT_0209896955)

- 该命令执行后立即生效。
- 如果OCS被绑定DiamConnGrp下，则无法修改其VPNINSTANCE信息。
- 修改特定的OCS时，一定要输入指定OCS主机名称。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896955)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896955)
