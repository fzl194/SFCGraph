# 显示SCTP统计信息(DSP SCTPAS)

- [命令功能](#ZH-CN_MMLREF_0000001172225535__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225535__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225535__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225535__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225535__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225535__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225535)

**适用网元：SGSN、MME**

此命令用于查询SCTP偶联统计信息。

#### [注意事项](#ZH-CN_MMLREF_0000001172225535)

无。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225535)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225535)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225535)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225535)
