...
- [命令功能](#ZH-CN_MMLREF_0209651749__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651749__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651749__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651749__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651749)

**适用NF：PGW-C、SMF**

该命令用来添加TAC组，当需要使用本地配置的TAC组时，使用此命令。

## [注意事项](#ZH-CN_MMLREF_0209651749)

- 该命令执行后立即生效。

- 最多可输入3000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209651749)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651749)
