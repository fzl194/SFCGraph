# 删除预定义规则关联的DNAI（RMV RULEBINDDNAI）

- [命令功能](#ZH-CN_MMLREF_0000001226931973__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001226931973__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001226931973__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001226931973__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001226931973)

**适用NF：SMF、PGW-C、GGSN**

该命令用于删除预定义规则关联的DNAI。

## [注意事项](#ZH-CN_MMLREF_0000001226931973)

- 该命令执行后立即生效。

- 如果DNAI为空， 删除预定义规则关联的所有DNAI。

#### [操作用户权限](#ZH-CN_MMLREF_0000001226931973)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001226931973)
...
## [使用实例](#ZH-CN_MMLREF_0000001226931973)
