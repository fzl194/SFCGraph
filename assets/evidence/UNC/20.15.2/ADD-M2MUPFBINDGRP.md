# 增加UPF和M2M关联的UPF组的绑定关系（ADD M2MUPFBINDGRP）

- [命令功能](#ZH-CN_MMLREF_0296241689__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296241689__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296241689__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296241689__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296241689)

**适用NF：PGW-C、SMF**

该命令用于添加UPF和M2M关联的UPF组的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0296241689)

- 该命令执行后立即生效。

- 最多可输入3000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0296241689)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296241689)
