# 增加GTP-C T3N3参数（ADD GTPCT3N3）

- [命令功能](#ZH-CN_MMLREF_0209651701__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651701__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651701__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651701__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651701)

**适用NF：SGW-C、PGW-C、AMF、GGSN**

该命令用于增加GTP-C T3N3参数配置，T3用于指定等待一条请求消息的响应消息的最大时长。N3用于指定发送一条请求消息的最大尝试次数。

## [注意事项](#ZH-CN_MMLREF_0209651701)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651701)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651701)
