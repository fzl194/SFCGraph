# 增加GTP-C V0/V1协议兼容性配置(ADD GTPCCMPT)

- [命令功能](#ZH-CN_MMLREF_0000001172225601__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225601__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225601__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225601__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225601__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225601__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225601)

**适用网元：SGSN、MME**

- 此命令用于增加GTP-C V0/V1协议兼容性配置，用于控制在SGSN或者MME发送的GTP消息中，是否允许携带特定的可选信元。

#### [注意事项](#ZH-CN_MMLREF_0000001172225601)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225601)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225601)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225601)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225601)
