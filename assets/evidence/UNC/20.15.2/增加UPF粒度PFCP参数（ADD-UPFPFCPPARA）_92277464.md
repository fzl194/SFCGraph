# 增加UPF粒度PFCP参数（ADD UPFPFCPPARA）

- [命令功能](#ZH-CN_MMLREF_0000001192277464__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001192277464__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001192277464__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001192277464__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001192277464)

**适用NF：SGW-C、PGW-C、GGSN、SMF**

该命令用于增加UPF粒度的PFCP参数，包括SMF主动发起的N4心跳间隔和心跳阈值等参数。

## [注意事项](#ZH-CN_MMLREF_0000001192277464)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001192277464)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001192277464)
...
## [使用实例](#ZH-CN_MMLREF_0000001192277464)
