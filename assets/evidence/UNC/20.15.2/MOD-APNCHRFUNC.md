# 修改APN CHR功能配置（MOD APNCHRFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001135932755__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001135932755__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001135932755__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001135932755__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001135932755)

**适用NF：GGSN、SGW-C、PGW-C、SMF**

该命令用于修改基于APN的CHR功能配置。

## [注意事项](#ZH-CN_MMLREF_0000001135932755)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001135932755)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001135932755)
...
## [使用实例](#ZH-CN_MMLREF_0000001135932755)
