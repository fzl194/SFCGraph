# 增加NF GPSIRANGE信息（ADD NFGPSIRANGE）

- [命令功能](#ZH-CN_MMLREF_0000001291819421__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001291819421__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001291819421__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001291819421__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001291819421)

**适用NF：SMSF**

该命令用于添加NF实例支持的GPSIRANGE信息。当NF实例向NRF注册时，将实例的GPSIRANGE信息带给NRF，为业务流程中其他NF发现该NF时提供选择信息。

## [注意事项](#ZH-CN_MMLREF_0000001291819421)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001291819421)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001291819421)
...
## [使用实例](#ZH-CN_MMLREF_0000001291819421)
