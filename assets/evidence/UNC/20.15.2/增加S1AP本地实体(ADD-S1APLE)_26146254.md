# 增加S1AP本地实体(ADD S1APLE)

- [命令功能](#ZH-CN_MMLREF_0000001126146254__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146254__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146254__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146254__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146254__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146254__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146254)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126146254)

- 此命令执行后立即生效。
- 此命令最大记录数为64。
- IP地址和vpn名称必须在SERVICEIP表中已经配置，可以用[**LST SERVICEIP**](../../业务IP管理/业务IP/查询业务IP(LST SERVICEIP)_72226047.md)查询。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146254)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146254)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146254)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146254)
