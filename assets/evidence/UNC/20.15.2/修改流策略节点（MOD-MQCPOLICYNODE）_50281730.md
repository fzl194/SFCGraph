# 修改流策略节点（MOD MQCPOLICYNODE）

- [命令功能](#ZH-CN_CONCEPT_0000001550281730__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281730__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281730__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281730__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281730__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281730)

该命令用于修改在流策略中为流分类指定流行为；当对接口上符合某种规则的流量执行特定的流行为时，需要在接口上应用流策略。在应用流策略之前必须使用该命令在流策略视图下将流分类和流行为进行绑定。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281730)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281730)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281730)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281730)
