# 增加容灾APN特征参数(ADD RESTOAPN)

- [命令功能](#ZH-CN_MMLREF_0000001126305924__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305924__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305924__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305924__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305924__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305924__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305924)

**适用网元：MME**

本命令用于增加支持容灾备份的APN，即APNNI。启用“MME链式备份特性”后，若用户激活的PDN连接的APNNI与本命令配置的APNNI匹配，此用户支持容灾备份功能；反之，用户不支持容灾备份功能。

#### [注意事项](#ZH-CN_MMLREF_0000001126305924)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305924)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305924)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305924)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305924)
