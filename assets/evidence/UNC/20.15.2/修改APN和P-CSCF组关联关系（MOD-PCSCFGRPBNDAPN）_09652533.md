# 修改APN和P-CSCF组关联关系（MOD PCSCFGRPBNDAPN）

- [命令功能](#ZH-CN_MMLREF_0209652533__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652533__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652533__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652533__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652533)

**适用NF：PGW-C、SMF、GGSN**

此命令用来修改APN和P-CSCF组关联关系。

## [注意事项](#ZH-CN_MMLREF_0209652533)

- 该命令执行后立即生效。

- 可以修改已经配置的优先级的数值，但是必须保持唯一。

#### [操作用户权限](#ZH-CN_MMLREF_0209652533)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652533)
