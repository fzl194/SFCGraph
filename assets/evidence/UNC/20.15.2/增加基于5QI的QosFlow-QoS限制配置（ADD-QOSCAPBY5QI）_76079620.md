# 增加基于5QI的QosFlow QoS限制配置（ADD QOSCAPBY5QI）

- [命令功能](#ZH-CN_MMLREF_0000001376079620__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001376079620__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001376079620__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001376079620__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001376079620)

**适用NF：SMF**

该命令用于增加基于5QI的QosFlow QoS限制的相关配置参数。

## [注意事项](#ZH-CN_MMLREF_0000001376079620)

- 命令执行后只对新接入用户生效。

- 最多可输入2048条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001376079620)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001376079620)
...
## [使用实例](#ZH-CN_MMLREF_0000001376079620)
