# 增加基于APN的一键通功能配置（ADD APNPTTFUNC）

- [命令功能](#ZH-CN_MMLREF_0306399904__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399904__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399904__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399904__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0306399904)

**适用NF：PGW-C、SGW-C**

该命令用于开启或关闭指定APN的一键通功能。

## [注意事项](#ZH-CN_MMLREF_0306399904)

- 该命令执行后只对新激活用户生效。

- 最多可输入20000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0306399904)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399904)
