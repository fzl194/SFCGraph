# 修改EPS QoS到TOS/DSCP的映射规则（MOD EPSREMARK）

- [命令功能](#ZH-CN_MMLREF_0209652198__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652198__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652198__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652198__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652198)

**适用NF：SGW-C、PGW-C**

该命令用来修改在SAE架构下，QoS参数到IP报头中的DSCP（区别服务编码点）/TOS（服务类型）的映射规则，用户的数据将根据映射得到的DSCP（区别服务编码点）/TOS（服务类型）中的参数值进行转发。

## [注意事项](#ZH-CN_MMLREF_0209652198)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652198)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652198)
