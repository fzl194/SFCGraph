# 删除当前UPF绑定的IP域（RMV UPIPDOMAIN）

- [命令功能](#ZH-CN_MMLREF_0209652498__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652498__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652498__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652498__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652498)

**适用NF：PGW-C、SMF、GGSN**

该命令用于删除当前UPF绑定的IPDomain。

## [注意事项](#ZH-CN_MMLREF_0209652498)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652498)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652498)
