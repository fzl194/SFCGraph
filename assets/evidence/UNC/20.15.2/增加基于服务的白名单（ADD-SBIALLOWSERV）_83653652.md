# 增加基于服务的白名单（ADD SBIALLOWSERV）

- [命令功能](#ZH-CN_MMLREF_0000001183653652__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001183653652__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001183653652__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001183653652__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001183653652)

该命令用于增加基于服务类型的白名单，当系统作为服务端时，添加到白名单的服务只允许白名单中指定的网元类型的对端访问。未添加到白名单的服务则允许所有对端访问。

## [注意事项](#ZH-CN_MMLREF_0000001183653652)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001183653652)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001183653652)
...
## [使用实例](#ZH-CN_MMLREF_0000001183653652)
