# 增加GMLC选择策略(ADD GMLCSELPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001172225491__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225491__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225491__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225491__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225491__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225491__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225491)

**适用网元：MME**

该命令用于增加GMLC选择策略。产品可以根据LCS客户端类型和位置信息来选择Diameter路由组和GMLC域名，从而选择GMLC。

#### [注意事项](#ZH-CN_MMLREF_0000001172225491)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225491)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225491)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225491)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225491)
