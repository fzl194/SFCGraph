# 修改PLMN-CG配置参数(MOD CHGPLMNCG)

- [命令功能](#ZH-CN_MMLREF_0000001172344989__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172344989__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172344989__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172344989__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172344989__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172344989__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172344989)

**适用网元：SGSN**

该命令用于修改为PLMN配置CG IP的地址。该PLMN上产生的话单会优先发往这些已配置过的CG。

#### [注意事项](#ZH-CN_MMLREF_0000001172344989)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172344989)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172344989)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172344989)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172344989)
