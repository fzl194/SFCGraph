# 增加RG级的trigger参数（ADD RGTRIGGER）

- [命令功能](#ZH-CN_MMLREF_0209653787__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653787__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653787__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653787__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653787)

**适用NF：PGW-C、SMF**

该命令用于增加RG级的trigger参数。

## [注意事项](#ZH-CN_MMLREF_0209653787)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653787)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653787)
