# 删除流程限制策略(RMV PROCLMTPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001172345227__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345227__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345227__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345227__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345227__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345227__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345227)

**适用网元：SGSN、MME**

该命令用于删除流程限制策略。为特定用户设置的流程限制策略被删除后，系统将会允许此类用户执行对应流程。

#### [注意事项](#ZH-CN_MMLREF_0000001172345227)

此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345227)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345227)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345227)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345227)
