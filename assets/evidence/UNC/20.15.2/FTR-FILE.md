...
- [命令功能](#ZH-CN_CONCEPT_0259103901__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103901__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103901__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103901__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103901__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103901)

该命令用于使用SFTP协议进行文件传输操作。

#### [注意事项](#ZH-CN_CONCEPT_0259103901)

- SFTP异步传输文件可通过事件日志确认结果。
- 本地文件路径为用户目录下的相对路径或用户设置的路径。
- 该命令仅提供文件传输的通用能力，不提供其他能力（如服务器端文件的类型、大小校验等）。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103901)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103901)
