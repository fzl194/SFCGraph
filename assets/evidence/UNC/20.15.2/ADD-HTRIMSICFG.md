# 增加HTR号段(ADD HTRIMSICFG)

- [命令功能](#ZH-CN_MMLREF_0000001126305960__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305960__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305960__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305960__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305960__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305960__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305960)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305960)

- 该命令执行后立即生效。
- 该表的最大记录数为5000。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305960)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305960)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305960)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305960)
