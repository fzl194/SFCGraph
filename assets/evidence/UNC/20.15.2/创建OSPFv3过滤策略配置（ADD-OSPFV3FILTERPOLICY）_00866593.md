# 创建OSPFv3过滤策略配置（ADD OSPFV3FILTERPOLICY）

- [命令功能](#ZH-CN_CONCEPT_0000001600866593__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600866593__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600866593__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600866593__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600866593__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600866593)

该命令用于创建OSPFv3过滤策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001600866593)

- 该命令执行后立即生效。
- 该命令最大记录数为8016。
- 只有在执行ADD OSPFV3配置了OSPFv3进程后才能使用此命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600866593)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600866593)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600866593)
