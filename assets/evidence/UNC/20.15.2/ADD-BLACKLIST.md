# 增加黑名单地址列表（ADD BLACKLIST）

- [命令功能](#ZH-CN_MMLREF_0244006355__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244006355__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244006355__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244006355__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244006355)

**适用NF：PGW-C、SMF、GGSN**

该命令用于将指定的IP地址段设置为黑名单，禁止携带该地址段内IP地址的用户入网。

## [注意事项](#ZH-CN_MMLREF_0244006355)
...
#### [操作用户权限](#ZH-CN_MMLREF_0244006355)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244006355)
