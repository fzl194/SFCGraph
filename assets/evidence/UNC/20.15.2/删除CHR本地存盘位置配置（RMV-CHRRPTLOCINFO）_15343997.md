# 删除CHR本地存盘位置配置（RMV CHRRPTLOCINFO）

- [命令功能](#ZH-CN_MMLREF_0000002115343997__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002115343997__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002115343997__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002115343997__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002115343997)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于删除本地存储CHR的用户的位置过滤条件，包括N2TAC、S1TAC、LACRAC、eNodeB、gNodeB。

## [注意事项](#ZH-CN_MMLREF_0000002115343997)

该命令执行后只对之后发生承载更新的用户或者新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000002115343997)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002115343997)
...
## [使用实例](#ZH-CN_MMLREF_0000002115343997)
