# 设置融合计费消息缓存期间融合计费消息生成的trigger（SET STGTRIGGER）

- [命令功能](#ZH-CN_MMLREF_0234667406__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0234667406__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0234667406__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0234667406__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0234667406)

**适用NF：SMF**

该命令用于设置融合计费消息缓存期间融合计费消息生成的trigger。

## [注意事项](#ZH-CN_MMLREF_0234667406)
...
#### [操作用户权限](#ZH-CN_MMLREF_0234667406)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0234667406)
