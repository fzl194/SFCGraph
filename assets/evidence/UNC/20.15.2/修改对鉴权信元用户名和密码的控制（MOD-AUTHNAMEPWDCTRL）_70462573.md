# 修改对鉴权信元用户名和密码的控制（MOD AUTHNAMEPWDCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001870462573__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870462573__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870462573__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870462573__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870462573)

**适用NF：PGW-C、SMF、GGSN**

该命令用于修改对鉴权信元用户名和密码的控制。

## [注意事项](#ZH-CN_MMLREF_0000001870462573)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001870462573)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870462573)
...
## [使用实例](#ZH-CN_MMLREF_0000001870462573)

如果需要修改某鉴权信元内用户名和密码的填写方式，如在透明鉴权下，所有APN下，通过读取配置填入鉴权的用户名，通过配置中的CommonUserPass填充密码信元，可以使用该实例：

```
MOD AUTHNAMEPWDCTRL: EFFECTIVESCOPE=GLOBAL, PCONAME=PCO_NAME_UNLIMITED, PCOPWD=PCO_PWD_UNLIMITED, ACCESSMODE=TRANS_AUTH, AUTHMODE=AUTH_MODE_UNLIMITED, PCOPRIORITY=UNLIMITED, PWDUSEPCO=UNLIMITED, NAMESOURCE=FROM_CFG, PWDSOURCE=FROM_CFG_COMMONUSERPASS;
```
