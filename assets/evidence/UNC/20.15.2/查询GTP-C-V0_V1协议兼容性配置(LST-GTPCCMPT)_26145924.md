# 查询GTP-C V0/V1协议兼容性配置(LST GTPCCMPT)

- [命令功能](#ZH-CN_MMLREF_0000001126145924__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145924__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145924__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145924__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145924__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145924__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126145924__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145924)

**适用网元：SGSN、MME**

此命令用于查询GTP-C V0/V1协议兼容性配置。

#### [注意事项](#ZH-CN_MMLREF_0000001126145924)

此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145924)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145924)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145924)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145924)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126145924)

参见 [**ADD GTPCCMPT**](增加GTP-C V0_V1协议兼容性配置(ADD GTPCCMPT)_72225601.md) 命令的参数说明。
