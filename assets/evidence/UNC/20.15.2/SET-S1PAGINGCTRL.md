# 设置S1寻呼策略控制表(SET S1PAGINGCTRL)

- [命令功能](#ZH-CN_MMLREF_0000001172345845__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345845__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345845__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345845__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345845__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345845__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345845)

**适用网元：MME**

此命令用于设置S1寻呼策略，比如可基于最近访问eNodeB、邻接eNodeB、TA、TA List进行分级寻呼，可设置eNodeB的学习开关，可设置移动性检查开关等。

#### [注意事项](#ZH-CN_MMLREF_0000001172345845)

- 系统初次运行时，会执行系统初始设置值。
- 此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345845)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345845)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345845)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345845)
