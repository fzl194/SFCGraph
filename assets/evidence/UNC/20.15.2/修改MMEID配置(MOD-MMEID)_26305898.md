...
- [命令功能](#ZH-CN_MMLREF_0000001126305898__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305898__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305898__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305898__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305898__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305898__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305898)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305898)

- 此命令执行后立即生效。
- 填入前请先用[**LST MMEID**](查询MMEID配置(LST MMEID)_72345689.md)查看当前的移动国家码。
- 可能造成InterTAU成功率指标大幅下降。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305898)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305898)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305898)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305898)
