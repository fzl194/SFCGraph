# 增加AMF热备容灾控制参数（ADD AMFDRBKCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001309027349__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001309027349__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001309027349__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001309027349__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001309027349)

**适用NF：AMF**

该命令用于增加AMF热备容灾的控制参数。

## [注意事项](#ZH-CN_MMLREF_0000001309027349)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001309027349)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001309027349)
...
## [使用实例](#ZH-CN_MMLREF_0000001309027349)
