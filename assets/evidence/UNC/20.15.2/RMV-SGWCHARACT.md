# 删除S-GW特性对接配置(RMV SGWCHARACT)

- [命令功能](#ZH-CN_MMLREF_0000001172345569__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345569__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345569__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345569__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345569__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345569__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345569)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345569)

- 该命令执行后立即生效。
- “ALL(所有S-GW)”为系统的缺省记录，不允许增加，也不允许删除。
- 该命令将删除指定网段内MME与S-GW支持特性的能力交互配置策略。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345569)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345569)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345569)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345569)
