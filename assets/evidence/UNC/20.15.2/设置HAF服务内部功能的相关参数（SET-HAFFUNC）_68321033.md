# 设置HAF服务内部功能的相关参数（SET HAFFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001168321033__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001168321033__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001168321033__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001168321033__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001168321033)

当前版本配置此命令不生效。

该命令用于设置HAF服务内部功能的相关参数。

## [注意事项](#ZH-CN_MMLREF_0000001168321033)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001168321033)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001168321033)
...
## [使用实例](#ZH-CN_MMLREF_0000001168321033)
