# 显示所有进程的协商状态信息（DSP NEGOSTATE）

- [命令功能](#ZH-CN_CONCEPT_0259103655__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103655__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103655__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103655__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103655__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259103655__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103655)

该命令用于显示所有运行进程的协商状态信息。

#### [注意事项](#ZH-CN_CONCEPT_0259103655)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103655)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103655)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259103655)
...
| 协商状态 | 表示目的端进程协商状态。 |
| 协商序列号 | 表示目的端进程协商序列号。 |
| Semagt组件状态 | 表示订阅目标端进程的Semagt组件状态。 |
| Semagt组件开工序列号 | 表示目标端进程的Semagt组件的开工序列号。 |
| 协商联调结果 | 表示源与目标端进程协商联调结果。 |
| 协商过程事件 | 表示协商过程事件。 |
| 时间 | 表示协商过程事件发生的时间。 |
