# 修改用户和UPF的绑定关系（MOD IMSIBINDUP）

- [命令功能](#ZH-CN_MMLREF_0209651498__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651498__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651498__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651498__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651498)

**适用NF：SMF、PGW-C、SGW-C、GGSN**

该命令用于修改用户和UPF的绑定关系，支持修改一个用户和UPF的绑定。

## [注意事项](#ZH-CN_MMLREF_0209651498)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651498)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651498)
