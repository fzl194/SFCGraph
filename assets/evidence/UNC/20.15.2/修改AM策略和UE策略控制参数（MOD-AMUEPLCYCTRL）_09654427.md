# 修改AM策略和UE策略控制参数（MOD AMUEPLCYCTRL）

- [命令功能](#ZH-CN_MMLREF_0209654427__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654427__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654427__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654427__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654427)

**适用NF：AMF**

该命令用于修改指定的AM策略和UE策略的控制参数。

## [注意事项](#ZH-CN_MMLREF_0209654427)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209654427)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654427)
