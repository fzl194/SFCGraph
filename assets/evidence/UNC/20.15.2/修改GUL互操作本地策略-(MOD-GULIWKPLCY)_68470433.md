# 修改GUL互操作本地策略 (MOD GULIWKPLCY)

- [命令功能](#ZH-CN_CONCEPT_0000001368470433__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001368470433__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001368470433__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001368470433__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001368470433__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001368470433__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001368470433)

**适用网元：MME**

此命令用于修改GUL互操作本地策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001368470433)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001368470433)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001368470433)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001368470433)
...
| GULCTRLCOND | GUL互操作定制处理条件 | 可选必选说明：可选参数<br>参数含义：该参数用于指定GU到LTE互操作定制策略生效时，用户需要满足的条件。<br>数据来源：整网规划<br>取值范围： 位域类型，取值范围如下：<br>- N1CAP（N1能力）<br>- CNR（签约CNR）<br>- ARD（签约ARD）<br>默认值：“N1CAP-1&CNR-1&ARD-1”<br>配置原则：本参数至少要选择一个选项，否则配置将失效。 |
...
#### [使用实例](#ZH-CN_CONCEPT_0000001368470433)

修改GUL互操作本地策略的用户范围为所有用户，GUL TAU处理策略为是，可以用如下命令：

```
MOD GULIWKPLCY: SUBRANGE=ALL_USER, GULTAUPLCY=YES, TAUREJCAUSE=10;
```
