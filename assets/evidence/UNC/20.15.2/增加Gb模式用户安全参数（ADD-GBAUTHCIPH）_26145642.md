# 增加Gb模式用户安全参数（ADD GBAUTHCIPH）

- [命令功能](#ZH-CN_MMLREF_0000001126145642__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145642__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145642__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145642__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145642__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145642__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145642)

**适用网元：SGSN**

该命令用于增加2G鉴权加密的配置。 UNC 可以结合运营商的配置要求和协议规范决定是否使用鉴权加密。针对SGSN节点可能遇到的所有需要鉴权的流程， UNC 均设置了开关加以控制，运营商可以通过配置决定这些流程是否需要鉴权。

#### [注意事项](#ZH-CN_MMLREF_0000001126145642)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126145642)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145642)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145642)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145642)
