# 增加APN计费属性(ADD CHGAPN)

- [命令功能](#ZH-CN_MMLREF_0000001172344965__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172344965__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172344965__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172344965__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172344965__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172344965__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172344965)

**适用网元：SGSN**

该命令用于当要求忽略HLR签约的APN计费属性时（通过命令 [**SET CHGCDR**](../计费控制/设置计费CDR参数（SET CHGCDR）_26145372.md) 设置参数 “IGNOREFLG” 的取值），配置基于APN的计费属性信息。

#### [注意事项](#ZH-CN_MMLREF_0000001172344965)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172344965)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172344965)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172344965)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172344965)
