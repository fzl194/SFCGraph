...
- [命令功能](#ZH-CN_MMLREF_0209652261__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652261__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652261__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652261__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652261)

**适用NF：SMF、PGW-C、GGSN**

该命令用于删除用户APN与消息交互使用APN的映射关系。在用户需要删除已有的用户APN与消息交互使用APN的映射关系时使用该命令。

## [注意事项](#ZH-CN_MMLREF_0209652261)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652261)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652261)
