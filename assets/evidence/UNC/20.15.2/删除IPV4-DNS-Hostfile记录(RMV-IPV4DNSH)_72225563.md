# 删除IPV4 DNS Hostfile记录(RMV IPV4DNSH)

- [命令功能](#ZH-CN_MMLREF_0000001172225563__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225563__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225563__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225563__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225563__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225563__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225563)

**适用网元：SGSN、MME**

该命令用于删除网元接口所对应的IP地址信息。

#### [注意事项](#ZH-CN_MMLREF_0000001172225563)

- 该命令执行后立即生效。
- 如果一个主机名对应的所有IP地址都被删除，以Hostfile方式进行DNS查询时，该主机名将不能被解析。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225563)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225563)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225563)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225563)
