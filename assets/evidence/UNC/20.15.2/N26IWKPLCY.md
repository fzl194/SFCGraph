# 查询EPS与5GS互操作本地策略(LST N26IWKPLCY)

- [命令功能](#ZH-CN_CONCEPT_0000001172225815__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001172225815__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001172225815__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001172225815__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001172225815__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001172225815__1.3.6.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001172225815__1.3.7.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001172225815)

**适用网元：MME**

该命令用于5GS部署时，查询用户的EPS与5GS互操作本地策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001172225815)

- 无

#### [本地用户权限](#ZH-CN_CONCEPT_0000001172225815)

manage-ug；system-ug；monitor-ug；

#### [网管用户权限](#ZH-CN_CONCEPT_0000001172225815)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组。

#### [参数说明](#ZH-CN_CONCEPT_0000001172225815)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001172225815)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001172225815)

参见 [**ADD N26IWKPLCY**](增加EPS与5GS互操作本地策略(ADD N26IWKPLCY)_26305944.md) 的参数说明。
