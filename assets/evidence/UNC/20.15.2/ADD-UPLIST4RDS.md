# 向RADIUS服务器使用的UP列表中增加UP（ADD UPLIST4RDS）

- [命令功能](#ZH-CN_CONCEPT_0252749060__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0252749060__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0252749060__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0252749060__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0252749060__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0252749060)

**适用NF：PGW-C、SMF**

该命令用来增加UP到RADIUS服务器使用的UP列表，该UP列表用于根据UP选择RADIUS服务器，并向其发送RADIUS消息。

#### [注意事项](#ZH-CN_CONCEPT_0252749060)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0252749060)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0252749060)
