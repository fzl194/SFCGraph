...
- [命令功能](#ZH-CN_MMLREF_0231453525__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0231453525__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0231453525__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0231453525__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0231453525)

**适用NF：SGW-C、PGW-C**

该命令主要用于配置快速恢复功能。如果配置成功，当网络侧、MME、SGW发生故障或重启时可以快速恢复业务。

## [注意事项](#ZH-CN_MMLREF_0231453525)
...
#### [操作用户权限](#ZH-CN_MMLREF_0231453525)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0231453525)
