# 修改Pre-R8 QoS控制动作配置（MOD PRER8QOSACTION）

- [命令功能](#ZH-CN_MMLREF_0209653107__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653107__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653107__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653107__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653107)

**适用NF：GGSN**

该命令用于修改QoS上下行保证带宽门限、最高带宽门限以及带宽超过门限值时对QoS用户的处理动作。

## [注意事项](#ZH-CN_MMLREF_0209653107)

- 该命令执行后只对新激活用户生效。

- 带宽取值为4294967295时，表示无效值。

#### [操作用户权限](#ZH-CN_MMLREF_0209653107)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653107)
