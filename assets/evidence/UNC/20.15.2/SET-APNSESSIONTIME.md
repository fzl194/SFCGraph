# 设置APN会话上下文定时器配置（SET APNSESSIONTIME）

- [命令功能](#ZH-CN_MMLREF_0296243086__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243086__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243086__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243086__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243086)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于配置指定APN最大会话时长。

## [注意事项](#ZH-CN_MMLREF_0296243086)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243086)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243086)
