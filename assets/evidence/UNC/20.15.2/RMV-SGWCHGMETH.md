# 删除SGW Charge Method（RMV SGWCHGMETH）

- [命令功能](#ZH-CN_CONCEPT_0209896986__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896986__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896986__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896986__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896986__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896986)

**适用NF：SGW-C**

该命令用于删除SGW计费方式。

#### [注意事项](#ZH-CN_CONCEPT_0209896986)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896986)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896986)
