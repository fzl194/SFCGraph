# 设置基于UPF地址分配的全局开关（SET IPALLOCBYUPFGLBSW）

- [命令功能](#ZH-CN_MMLREF_0249644935__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0249644935__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0249644935__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0249644935__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0249644935)

**适用NF：PGW-C、SMF、GGSN**

该命令用于配置基于UPF地址分配的全局开关。

## [注意事项](#ZH-CN_MMLREF_0249644935)
...
#### [操作用户权限](#ZH-CN_MMLREF_0249644935)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0249644935)
