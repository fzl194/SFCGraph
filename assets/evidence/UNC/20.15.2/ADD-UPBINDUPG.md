# 增加用户模板组和用户模板的绑定关系（ADD UPBINDUPG）

- [命令功能](#ZH-CN_CONCEPT_0209897229__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897229__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897229__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897229__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897229__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897229)

**适用NF：PGW-C、SMF**

本命令用于将用户模板绑定到用户模板组下，可以配置用户模板优先级和选择用户模板条件，即IMSI/MSISDN号码段名称、IMEISV号码段名称、RAT、漫游属性、计费属性及位置组名称。

#### [注意事项](#ZH-CN_CONCEPT_0209897229)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209897229)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897229)
