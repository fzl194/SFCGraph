# 增加DNN的TAI和ServingScope映射（ADD DNNTAISSP）

- [命令功能](#ZH-CN_MMLREF_0000001546041326__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001546041326__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001546041326__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001546041326__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001546041326)

**适用NF：AMF**

该命令用于增加DNN的TAI和ServingScope映射关系。通过本配置，AMF服务发现锚点SMF时可以根据用户所在TAI查询Serving Scope取值。

## [注意事项](#ZH-CN_MMLREF_0000001546041326)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001546041326)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001546041326)
...
## [使用实例](#ZH-CN_MMLREF_0000001546041326)
