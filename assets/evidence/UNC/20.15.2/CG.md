...
- [命令功能](#ZH-CN_CONCEPT_0209896845__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896845__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896845__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896845__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896845__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896845)

**适用NF：SGW-C、PGW-C、SMF**

ADD CG命令用来添加一条CG配置信息。当用户进行离线计费时，需要配置CG接收离线计费生成的话单。

#### [注意事项](#ZH-CN_CONCEPT_0209896845)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896845)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896845)
