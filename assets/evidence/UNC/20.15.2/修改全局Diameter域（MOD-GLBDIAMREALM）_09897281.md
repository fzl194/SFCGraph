# 修改全局Diameter域（MOD GLBDIAMREALM）

- [命令功能](#ZH-CN_CONCEPT_0209897281__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897281__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897281__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897281__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897281__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897281)

**适用NF：PGW-C、SMF**

该命令用于修改IMSI/MSISDN号段到Diameter域信息的映射关系，或者修改系统缺省的Diameter域。

#### [注意事项](#ZH-CN_CONCEPT_0209897281)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897281)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897281)
