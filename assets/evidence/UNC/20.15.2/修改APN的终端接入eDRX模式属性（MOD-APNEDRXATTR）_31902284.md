# 修改APN的终端接入eDRX模式属性（MOD APNEDRXATTR）

- [命令功能](#ZH-CN_MMLREF_0000001531902284__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001531902284__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001531902284__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001531902284__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001531902284)

**适用NF：SMF**

该命令用于修改指定APN的终端接入的eDRX模式。

## [注意事项](#ZH-CN_MMLREF_0000001531902284)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001531902284)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001531902284)
...
## [使用实例](#ZH-CN_MMLREF_0000001531902284)
