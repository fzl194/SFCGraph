# 显示HTTP统计信息（DSP HTTPSTATS）

- [命令功能](#ZH-CN_MMLREF_0000001183972184__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001183972184__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001183972184__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001183972184__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001183972184__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001183972184)

该命令用于显示HTTP相关的统计信息。HTTP相关模块包括了SBILINK、HTTPLINK。

## [注意事项](#ZH-CN_MMLREF_0000001183972184)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001183972184)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001183972184)
...
## [使用实例](#ZH-CN_MMLREF_0000001183972184)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001183972184)
