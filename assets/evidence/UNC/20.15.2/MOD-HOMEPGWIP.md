# 修改归属地PGW-C IP地址（MOD HOMEPGWIP）

- [命令功能](#ZH-CN_MMLREF_0306399920__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399920__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399920__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399920__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0306399920)

**适用NF：SGW-C**

该命令用于Proxy S-GW特性中修改归属地PGW-C IP地址记录的描述信息。

## [注意事项](#ZH-CN_MMLREF_0306399920)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0306399920)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399920)
