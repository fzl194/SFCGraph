# 设置ResourceBox自愈策略控制参数（SET RSCBOXHEALCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001400601674__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001400601674__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001400601674__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001400601674__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001400601674)

该命令用于设置ResourceBox自愈策略控制参数。

## [注意事项](#ZH-CN_MMLREF_0000001400601674)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001400601674)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001400601674)
...
## [使用实例](#ZH-CN_MMLREF_0000001400601674)
