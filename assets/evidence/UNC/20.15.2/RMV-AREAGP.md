...
- [命令功能](#ZH-CN_MMLREF_0000001172225223__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225223__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225223__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225223__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225223__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225223__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225223)

**适用网元：SGSN、MME**

此命令用于删除区域群记录。

#### [注意事项](#ZH-CN_MMLREF_0000001172225223)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225223)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225223)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225223)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| AREAID | 区域群标识 | 可选必选说明：必选参数<br>参数含义：待删除的区域群标识。<br>数据来源：整网规划<br>取值范围：1~50<br>默认值：无 |

#### [使用实例](#ZH-CN_MMLREF_0000001172225223)
