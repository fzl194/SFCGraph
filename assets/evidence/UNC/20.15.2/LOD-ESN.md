...
- [命令功能](#ZH-CN_MMLREF_0209653138__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653138__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653138__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653138__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653138)

该命令用于自动化部署网元场景中为网元加载用户指定的设备序列号（ESN）。

## [注意事项](#ZH-CN_MMLREF_0209653138)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653138)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653138)
