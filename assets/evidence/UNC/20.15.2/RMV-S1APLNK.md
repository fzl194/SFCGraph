# 删除S1AP连接(RMV S1APLNK)

- [命令功能](#ZH-CN_MMLREF_0000001126306064__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126306064__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126306064__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126306064__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126306064__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126306064__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126306064)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126306064)

- 此命令执行后立即生效。
- 此命令在版本升级过程中禁止执行。
- 删除链路可能影响正在进行的业务。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126306064)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126306064)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126306064)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126306064)
