# 查询对端NF的SUPI信息（LST PNFSUPI）

- [命令功能](#ZH-CN_MMLREF_0209652497__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652497__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652497__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652497__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209652497__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209652497)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于查询本地配置的对端NF实例支持的SUPI的信息。

## [注意事项](#ZH-CN_MMLREF_0209652497)

当输出类型指定为DETAIL时，可以指定RANGESTART与RANGEEND，输出包含该区间内任一号段的所有SUPI信息。

#### [操作用户权限](#ZH-CN_MMLREF_0209652497)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652497)
...
## [输出结果说明](#ZH-CN_MMLREF_0209652497)
...
| 索引 | 该参数用于指定索引。 |
| 查询方式 | 该参数用于指定SUPI号段配置的方式。 |
| 起始号段 | 该参数用于指定SUPI的起始号段。当QUERYTYPE参数设置为START_END模式时有效。 |
| 终止号段 | 该参数用于指定SUPI的终止号段。当QUERYTYPE参数设置为START_END模式时有效。 |
| 模式 | 该参数用于指定SUPI的具体的号段匹配正则表达式。当QUERYTYPE参数设置为PATTERN模式时有效。 |
