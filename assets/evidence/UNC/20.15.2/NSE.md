...
- [命令功能](#ZH-CN_MMLREF_0000001172345629__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345629__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345629__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345629__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345629__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345629__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172345629__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345629)

**适用网元：SGSN**

该命令用于查询信令实体参数（Network service Entity，NSE）。信令实体分别位于BSS侧和SGSN侧，用于提供GB接口操作所需的网络管理功能。请参考 3GPP TS 48.016。

#### [注意事项](#ZH-CN_MMLREF_0000001172345629)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345629)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345629)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345629)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345629)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172345629)

参见 [**ADD NSE**](增加信令实体(ADD NSE)_26146028.md) 的参数说明。
