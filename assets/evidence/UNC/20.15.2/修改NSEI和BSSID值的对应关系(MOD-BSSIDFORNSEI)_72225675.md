# 修改NSEI和BSSID值的对应关系(MOD BSSIDFORNSEI)

- [命令功能](#ZH-CN_MMLREF_0000001172225675__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225675__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225675__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225675__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225675__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225675__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225675)

**适用网元：SGSN**

此命令用于修改一个或一组NSEI和BSSID值的对应关系来指定BSSID的值。只适用于Gb over IP自动配置的场景。

#### [注意事项](#ZH-CN_MMLREF_0000001172225675)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225675)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225675)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225675)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225675)
