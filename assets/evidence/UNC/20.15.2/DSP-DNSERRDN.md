# 查询失败的DNS记录(DSP DNSERRDN)

- [命令功能](#ZH-CN_MMLREF_0000001126305692__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305692__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305692__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305692__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305692__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305692__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126305692__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305692)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305692)

- 该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305692)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305692)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305692)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305692)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126305692)

| 输出项名称 | 输出项解释 |
| --- | --- |
| DNS域名 | 标识查询出现错误的DNS域名字符串。 |
| 查询类型 | 标识向DNS服务器查询的类型。<br>取值说明：<br>- “A类型查询”<br>- “SRV查询”<br>- “NAPTR类型查询”<br>- “无效查询类型” |
| 错误类型 | 标识查询错误的类型。<br>取值说明：<br>- “服务器响应失败”<br>- “服务名称缺失” |
| 域名信息来源 | 标识域名信息的来源。<br>取值说明：<br>- “本地配置”<br>- “DNS 服务器”<br>- “NULL” |
| 失败参考信息 | 标识查询失败的域名的参考信息，不同的错误类型，参考信息代表不同的含义。<br>说明：如果错误类型为“服务器响应失败”，则表示查询失败的域名的关联初始查询域名。<br>如果错误类型为“服务名称缺失”，则表示未配置的网元类型、接口类型、S5/S8接口协议类型。 |
| 第一次查询失败的时间 | 标识第一次检查出DNS查询失败的时间。 |
| 最近一次查询失败的时间 | 标识最近一次检查出DNS查询失败的时间。 |
| 查询失败次数 | 标识检查出DNS查询失败的次数。 |
