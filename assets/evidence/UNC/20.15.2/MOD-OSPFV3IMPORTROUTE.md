# 修改OSPFv3引入路由配置（MOD OSPFV3IMPORTROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001600440581__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440581__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440581__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440581__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440581__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440581)

该命令用来修改引入到OSPFv3域中的外部路由的配置，并在OSPFv3域中发布引入的路由信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440581)

- 该命令执行后立即生效。
- 只有配置了OSPFv3进程和设置了外部引入路由后才能使用该命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440581)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440581)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440581)
