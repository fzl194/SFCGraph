# 修改位置区域DNS域名(MOD AREADNS)

- [命令功能](#ZH-CN_MMLREF_0000001172225639__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225639__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225639__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225639__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225639__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225639__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225639)

**适用网元：SGSN、MME**

该命令用于修改位置区域DNS域名。

#### [注意事项](#ZH-CN_MMLREF_0000001172225639)

该命令执行后立即生效。

区域名称的构成字符对大小写字母敏感。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225639)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225639)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225639)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225639)
