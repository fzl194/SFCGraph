# 启动S1接口过载控制(STR S1OVERLOAD)

- [命令功能](#ZH-CN_MMLREF_0000001172225929__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225929__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225929__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225929__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225929__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225929__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225929)

**适用网元：MME**

此命令用于启动S1接口过载控制。

#### [注意事项](#ZH-CN_MMLREF_0000001172225929)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225929)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225929)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225929)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225929)
