# 设置NRF订阅参数（SET NRFSUBPARA）

- [命令功能](#ZH-CN_MMLREF_0304284726__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0304284726__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0304284726__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0304284726__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0304284726)

**适用NF：NRF**

该命令用于设置NRF订阅参数。用于控制订阅记录的删除和通知发送。

## [注意事项](#ZH-CN_MMLREF_0304284726)
...
#### [操作用户权限](#ZH-CN_MMLREF_0304284726)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0304284726)
