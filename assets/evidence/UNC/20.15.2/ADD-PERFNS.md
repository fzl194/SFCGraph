# 增加切片性能统计对象（ADD PERFNS）

- [命令功能](#ZH-CN_MMLREF_0000001137024655__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001137024655__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001137024655__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001137024655__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001137024655)

**适用NF：AMF、SMF**

该命令用于手工增加切片性能统计对象的配置。

## [注意事项](#ZH-CN_MMLREF_0000001137024655)

- 该命令执行后立即生效。

- 最多可输入1000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001137024655)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001137024655)
...
## [使用实例](#ZH-CN_MMLREF_0000001137024655)
