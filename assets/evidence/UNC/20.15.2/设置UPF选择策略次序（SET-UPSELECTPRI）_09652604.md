# 设置UPF选择策略次序（SET UPSELECTPRI）

- [命令功能](#ZH-CN_MMLREF_0209652604__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652604__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652604__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652604__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652604)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于设置SMF选择UPF场景下的UPF选择策略次序。

## [注意事项](#ZH-CN_MMLREF_0209652604)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652604)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652604)
