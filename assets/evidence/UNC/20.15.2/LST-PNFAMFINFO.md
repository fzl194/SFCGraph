# 查询对端AMF信息（LST PNFAMFINFO）

- [命令功能](#ZH-CN_MMLREF_0209652470__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652470__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652470__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652470__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209652470__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209652470)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于查询本地配置的对端AMF的信息。

## [注意事项](#ZH-CN_MMLREF_0209652470)

无

#### [操作用户权限](#ZH-CN_MMLREF_0209652470)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652470)
...
## [输出结果说明](#ZH-CN_MMLREF_0209652470)

| 输出项名称 | 输出项解释 |
| --- | --- |
| NF实例标识 | 该参数用于指定对端AMF的NF实例标识。 |
| AMF区域标识 | 该参数用于指定对端AMF所在区域的标识。 |
| AMF组标识 | 该参数用于指定对端AMF所在集合（即Pool）的标识。 |
