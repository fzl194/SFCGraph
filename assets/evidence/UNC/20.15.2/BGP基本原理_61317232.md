...
BGP在 UNC 上以下列两种方式运行，如 [图1](#ZH-CN_CONCEPT_0161317232__fig_dc_fenix_feature_bgp_000401) 所示：
...
![](BGP基本原理_61317232.assets/fig_dc_fenix_feature_bgp_000401_2.png)
...
> **说明**
> UNC 支持多个接口处理单元上同网段的IP地址与远端的BGP Speaker建立多个Peer关系。
