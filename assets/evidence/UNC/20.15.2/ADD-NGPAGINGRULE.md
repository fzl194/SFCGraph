# 增加5G寻呼规则（ADD NGPAGINGRULE）

- [命令功能](#ZH-CN_MMLREF_0209652969__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652969__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652969__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652969__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652969)

**适用NF：AMF**

此命令用于增加5G寻呼规则。通过此命令配置AMF精准寻呼的规则集，比如指定使用精准寻呼的用户群、业务类型、使用的寻呼动作组合等。通过部署精准寻呼，缩小寻呼范围，减少RAN的寻呼负荷，节省网络资源。

## [注意事项](#ZH-CN_MMLREF_0209652969)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652969)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652969)
