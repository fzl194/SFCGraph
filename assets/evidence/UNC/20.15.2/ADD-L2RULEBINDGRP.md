# 增加层二规则与层二规则组的绑定关系（ADD L2RULEBINDGRP）

- [命令功能](#ZH-CN_MMLREF_0000001870462509__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870462509__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870462509__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870462509__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870462509)

**适用NF：SMF**

该命令用于增加层二规则与层二规则组的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0000001870462509)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001870462509)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870462509)
...
## [使用实例](#ZH-CN_MMLREF_0000001870462509)
