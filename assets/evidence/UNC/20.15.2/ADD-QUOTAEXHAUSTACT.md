...
- [命令功能](#ZH-CN_MMLREF_0000001095129686__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001095129686__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001095129686__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001095129686__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001095129686)

**适用NF：PGW-C、SMF**

该命令用于增加在线RG配额耗尽后的动作。

## [注意事项](#ZH-CN_MMLREF_0000001095129686)

- 该命令执行后只对新激活用户生效。

- 最多可输入101条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001095129686)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001095129686)
...
## [使用实例](#ZH-CN_MMLREF_0000001095129686)
