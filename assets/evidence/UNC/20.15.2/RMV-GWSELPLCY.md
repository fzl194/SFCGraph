# 删除GGSN/P-GW选择策略（RMV GWSELPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001172225623__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225623__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225623__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225623__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225623__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225623__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225623)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172225623)

- 该命令执行后对已经激活PDP用户不立即生效，其他用户立即生效。
- 当“用户范围”为“IMSI_RANGE（指定IMSI范围）”，且输入的IMSI为所对应记录的“BEGIMSI（起始IMSI）”时，将对该号段配置记录进行删除。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225623)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225623)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225623)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225623)
