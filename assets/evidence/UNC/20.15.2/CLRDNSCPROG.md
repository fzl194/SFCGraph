# 查询离散清缓存进度(DSP CLRDNSCPROG)

- [命令功能](#ZH-CN_MMLREF_0000001772246921__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001772246921__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001772246921__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001772246921__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001772246921__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001772246921__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001772246921__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001772246921)
...
#### [注意事项](#ZH-CN_MMLREF_0000001772246921)

- 该命令执行后立即生效。
- OMU虚机复位后一级Cache离散清除进度会清空。

#### [本地用户权限](#ZH-CN_MMLREF_0000001772246921)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001772246921)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001772246921)
...
#### [使用实例](#ZH-CN_MMLREF_0000001772246921)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001772246921)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 离散清缓存状态 | 该参数用描述离散清缓存总体状态。<br>取值说明：<br>- “Discrete cache clearing is not enabled(未启用离散清缓存功能)”：当前未启用离散清缓存功能。<br>- “Performing discrete cache clearing (正在执行离散清缓存)”：当前正在执行离散清缓存，无法继续执行CLR DNSC命令。<br>- “Discrete cache clearing can be performed (可以执行离散清缓存)”：当前可以执行CLR DNSC命令进行离散清缓存。 |
| 离散清缓存开始时间 | 该参数用于显示执行离散清缓存的时间。 |
| 需要离散清缓存总进程个数 | 该参数用于显示需要进行离散清缓存的SPP进程个数。 |
| 已完成离散清缓存进程个数 | 该参数用于显示已完成离散清缓存的SPP进程个数。 |
| 离散清缓存进度百分比 | 该参数用于显示离散清缓存进度百分比。 |
| 离散清缓存剩余时间 | 该参数用于显示离散清缓存剩余时间。 |
