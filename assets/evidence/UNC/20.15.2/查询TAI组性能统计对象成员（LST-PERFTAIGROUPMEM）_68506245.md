# 查询TAI组性能统计对象成员（LST PERFTAIGROUPMEM）

- [命令功能](#ZH-CN_MMLREF_0000001568506245__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001568506245__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001568506245__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001568506245__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001568506245__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001568506245)

**适用NF：SGW-C、PGW-C、SMF**

该命令用于查询指定TAI组性能统计对象内的TAI成员。

## [注意事项](#ZH-CN_MMLREF_0000001568506245)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001568506245)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001568506245)
...
## [使用实例](#ZH-CN_MMLREF_0000001568506245)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001568506245)

| 输出项名称 | 输出项解释 |
| --- | --- |
| TAI组名 | 该参数用于标识基于TAI组的性能统计对象名称。 |
| TAI组类型 | 该参数用于指定TAI组类型。 |
