# 增加锁定白名单记录（ADD LCKWHITELST）

- [命令功能](#ZH-CN_MMLREF_0000002229991961__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002229991961__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002229991961__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002229991961__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002229991961)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于增加锁定白名单记录。符合该白名单的用户不受LCK APN和LCK SESSIONACT命令的影响，能够创建会话或专载。

## [注意事项](#ZH-CN_MMLREF_0000002229991961)

- 该命令执行后立即生效。

- 最多可输入1000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000002229991961)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002229991961)
...
## [使用实例](#ZH-CN_MMLREF_0000002229991961)
