# 设置QoS控制配置（SET QOSCTRL）

- [命令功能](#ZH-CN_MMLREF_0209653269__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653269__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653269__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653269__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653269)

**适用NF：SMF、SGW-C、PGW-C**

该命令用于为指定漫游属性和无线接入类型的用户配置带宽控制的全局开关。当配置该功能后，UNC会对指定的漫游属性和接入类型的用户进行带宽控制，向UPF下发用户签约以及SMF本地配置协商的QoS带宽控制参数。

## [注意事项](#ZH-CN_MMLREF_0209653269)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653269)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653269)
