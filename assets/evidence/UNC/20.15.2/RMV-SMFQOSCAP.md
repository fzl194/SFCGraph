# 删除QosFlow QoS限制的配置（RMV SMFQOSCAP）

- [命令功能](#ZH-CN_MMLREF_0000001426279741__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001426279741__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001426279741__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001426279741__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001426279741)

**适用NF：SMF**

该命令用来删除QosFlow QoS限制的相关配置。

## [注意事项](#ZH-CN_MMLREF_0000001426279741)

命令执行后只对新接入用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001426279741)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001426279741)
...
## [使用实例](#ZH-CN_MMLREF_0000001426279741)

删除“用户范围”为“IMSI_PREFIX”，“IMSI前缀”为“308010700”，“QoS资源类型”为“NONGBR”的QosFlow QoS限制配置：

```
RMV SMFQOSCAP:SUBRANGE=IMSI_PREFIX,IMSIPRE="308010700",QOSIDTYPE=NONGBR;
```
