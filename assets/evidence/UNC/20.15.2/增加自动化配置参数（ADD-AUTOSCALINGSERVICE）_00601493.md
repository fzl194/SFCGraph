# 增加自动化配置参数（ADD AUTOSCALINGSERVICE）

- [命令功能](#ZH-CN_CONCEPT_0000001600601493__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600601493__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600601493__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600601493__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600601493__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600601493)

该命令用于增加接口自动化配置模板，基于模板的参数自动生成以太接口下的配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001600601493)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600601493)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600601493)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600601493)
