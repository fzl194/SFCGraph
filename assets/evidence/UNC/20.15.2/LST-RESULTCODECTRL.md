# 查询返回码控制（LST RESULTCODECTRL）

- [命令功能](#ZH-CN_CONCEPT_0209897087__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897087__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897087__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897087__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897087__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209897087__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897087)

**适用NF：PGW-C、SMF**

此命令用来查询指定返回码控制信息或所有返回码控制信息。

#### [注意事项](#ZH-CN_CONCEPT_0209897087)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897087)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897087)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209897087)

参见ADD RESULTCODECTRL的参数说明。
