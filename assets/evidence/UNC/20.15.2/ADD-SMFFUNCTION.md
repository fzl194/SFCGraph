# 添加SMF功能实例信息（ADD SMFFUNCTION）

- [命令功能](#ZH-CN_MMLREF_0209653246__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653246__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653246__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653246__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653246)

**适用NF：SMF**

该命令用于添加SMF功能实例信息。

## [注意事项](#ZH-CN_MMLREF_0209653246)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653246)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653246)
