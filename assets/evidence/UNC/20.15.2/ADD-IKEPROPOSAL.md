# 增加IKE提议（ADD IKEPROPOSAL）

- [命令功能](#ZH-CN_MMLREF_0000001226032189__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001226032189__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001226032189__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001226032189__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001226032189)

![](增加IKE提议（ADD IKEPROPOSAL）_26032189.assets/notice_3.0-zh-cn_2.png)

该配置中部分参数含有不安全算法，影响加解密安全性。

该命令用于增加IKE安全提议。

## [注意事项](#ZH-CN_MMLREF_0000001226032189)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001226032189)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001226032189)
...
## [使用实例](#ZH-CN_MMLREF_0000001226032189)
