...
- [操作场景](#ZH-CN_OPI_0315408915__1.3.1)
- [必备事项](#ZH-CN_OPI_0315408915__1.3.2)
- [操作步骤](#ZH-CN_OPI_0315408915__1.3.3)
- [任务示例](#ZH-CN_OPI_0315408915__1.3.4)

## [操作场景](#ZH-CN_OPI_0315408915)
...
![](配置计费属性CC（GGSN_SGW-C_PGW-C）_15408915.assets/zh-cn_image_0000001842359565_2.png)
...
## [必备事项](#ZH-CN_OPI_0315408915)

前提条件

- 请仔细阅读[Ga/Gy接口离线/在线计费](../../../../../业务专题/5G Core 计费解决方案/计费解决方案概述/计费原理/Ga_Gy接口离线_在线计费_87165686.md)。
- 完成[配置到CG的数据（GGSN/SGW-C/PGW-C）](../../WSFD-011201 支持离线计费/激活离线计费/配置到CG的数据（GGSN_SGW-C_PGW-C）_95923479.md)或[配置到OCS的数据(静态路由+BFD组网)](配置到OCS的数据(静态路由+BFD组网)_95923542.md)。
