# 查询小范围CHR生成规则（LST SRANGECHRCFG）

- [命令功能](#ZH-CN_MMLREF_0000001126305430__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305430__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305430__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305430__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305430__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305430__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126305430__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305430)

**适用网元：SGSN、MME**

该命令用于查询小范围CHR单据的生成规则。

#### [注意事项](#ZH-CN_MMLREF_0000001126305430)

- 该命令执行后立即生效。
- 如果不输入任何参数，执行该命令会显示所有记录。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305430)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305430)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305430)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305430)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126305430)

参见 [**ADD SRANGECHRCFG**](增加小范围CHR生成规则（ADD SRANGECHRCFG）_72345215.md) 的参数说明。
