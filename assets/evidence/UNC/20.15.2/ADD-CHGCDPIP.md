# 增加计费相关的IP配置参数(ADD CHGCDPIP)

- [命令功能](#ZH-CN_MMLREF_0000001172344961__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172344961__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172344961__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172344961__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172344961__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172344961__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172344961)

**适用网元：SGSN**

该命令用于对资源池内所有CDP进程配IP地址和端口号的组合，系统从该资源池中为每个CDP进程分配一个IP地址与端口号，作为向CG发送话单时的本端IP地址、端口号。

#### [注意事项](#ZH-CN_MMLREF_0000001172344961)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172344961)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172344961)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172344961)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172344961)
