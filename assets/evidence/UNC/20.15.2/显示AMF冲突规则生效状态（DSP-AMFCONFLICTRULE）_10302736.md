# 显示AMF冲突规则生效状态（DSP AMFCONFLICTRULE）

- [命令功能](#ZH-CN_MMLREF_0000001410302736__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001410302736__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001410302736__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001410302736__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001410302736__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001410302736)

**适用NF：AMF**

该命令用于显示AMF冲突规则生效状态。

## [注意事项](#ZH-CN_MMLREF_0000001410302736)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001410302736)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001410302736)
...
## [使用实例](#ZH-CN_MMLREF_0000001410302736)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001410302736)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 冲突流程规则 | 该参数用于指定冲突流程规则。 |
| 冲突规则是否生效 | 该参数用于显示AMF配置的冲突规则是否生效，如果生效，则显示YES；如果未生效，则显示NO和未生效原因。 |
