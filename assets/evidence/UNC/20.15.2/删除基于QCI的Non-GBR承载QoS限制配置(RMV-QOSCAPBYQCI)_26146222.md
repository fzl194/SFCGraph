# 删除基于QCI的Non-GBR承载QoS限制配置(RMV QOSCAPBYQCI)

- [命令功能](#ZH-CN_MMLREF_0000001126146222__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146222__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146222__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146222__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146222__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146222__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146222)

**适用网元：MME**

该命令用于根据用户范围及承载的QCI删除Non-GBR承载QoS限制配置记录。

#### [注意事项](#ZH-CN_MMLREF_0000001126146222)

- 该命令执行后对于新接入的EPS承载立即生效。如果当前用户已经激活了EPS承载，该命令的限制会在用户下一次会话管理业务流程中生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146222)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146222)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146222)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146222)
