...
- [命令功能](#ZH-CN_CONCEPT_0251174273__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0251174273__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0251174273__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0251174273__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0251174273__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0251174273__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0251174273)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0251174273)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0251174273)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0251174273)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| AGID | 接入网元分组标识 | 可选必选说明：必选参数<br>参数含义：用于区分不同域的接入网元。<br>数据来源：本端规划<br>取值范围：字符串类型，输入长度范围为1～32。<br>默认值：无<br>配置原则：无 |

#### [使用实例](#ZH-CN_CONCEPT_0251174273)
