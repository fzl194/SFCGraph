# 修改APN的NBNS属性（MOD APNNBNS）

- [命令功能](#ZH-CN_MMLREF_0000001222438293__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001222438293__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001222438293__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001222438293__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001222438293)

**适用NF：PGW-C、GGSN、SMF**

该命令用来修改APN实例的NBNS属性。

## [注意事项](#ZH-CN_MMLREF_0000001222438293)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001222438293)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001222438293)
...
## [使用实例](#ZH-CN_MMLREF_0000001222438293)
