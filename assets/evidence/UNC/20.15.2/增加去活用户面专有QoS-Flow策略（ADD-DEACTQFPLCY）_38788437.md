# 增加去活用户面专有QoS Flow策略（ADD DEACTQFPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001138788437__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001138788437__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001138788437__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001138788437__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001138788437)

**适用NF：SMF**

该命令用于增加当SMF接收到AMF发送的去激活用户面请求时，专有GBR类型QoS Flow的处理策略。

## [注意事项](#ZH-CN_MMLREF_0000001138788437)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001138788437)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001138788437)
...
## [使用实例](#ZH-CN_MMLREF_0000001138788437)
