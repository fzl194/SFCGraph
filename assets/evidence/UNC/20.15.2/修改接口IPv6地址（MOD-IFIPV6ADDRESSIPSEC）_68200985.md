# 修改接口IPv6地址（MOD IFIPV6ADDRESSIPSEC）

- [命令功能](#ZH-CN_MMLREF_0000001168200985__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001168200985__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001168200985__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001168200985__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001168200985)

该命令用于修改接口的IPv6地址前缀。

## [注意事项](#ZH-CN_MMLREF_0000001168200985)

- 该命令执行后立即生效。

- 该命令可以在VNRS_VNFC的Ethernet接口，Ethernet子接口，Eth-Trunk接口，Eth-Trunk子接口以及Loopback口，Tunnel口上配置。

#### [操作用户权限](#ZH-CN_MMLREF_0000001168200985)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001168200985)
...
## [使用实例](#ZH-CN_MMLREF_0000001168200985)
