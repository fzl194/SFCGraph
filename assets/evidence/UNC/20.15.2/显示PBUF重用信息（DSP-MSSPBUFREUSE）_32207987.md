# 显示PBUF重用信息（DSP MSSPBUFREUSE）

- [命令功能](#ZH-CN_CONCEPT_0000001132207987__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001132207987__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001132207987__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001132207987__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001132207987__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001132207987__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001132207987)

该命令用于显示MSS的PBUF重用信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001132207987)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001132207987)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001132207987)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001132207987)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001132207987)
...
| 进程号 | 用于表示进程号。 |
| 缓存数目 | 用于表示PBUF缓存数目。 |
| 缓存索引 | 用于表示PBUF缓存索引。<br>当出现PBUF重用时有值。 |
