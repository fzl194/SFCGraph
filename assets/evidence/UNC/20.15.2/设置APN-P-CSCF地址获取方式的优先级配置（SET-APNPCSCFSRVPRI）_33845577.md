# 设置APN P-CSCF地址获取方式的优先级配置（SET APNPCSCFSRVPRI）

- [命令功能](#ZH-CN_MMLREF_0233845577__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0233845577__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0233845577__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0233845577__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0233845577)

**适用NF：PGW-C**

该命令用来配置获取P-CSCF方式的优先级，当用户既从DHCP服务器获取了P-CSCF地址，本地也配置了P-CSCF地址时，通过此命令配置本地P-CSCF地址优先或DHCP P-CSCF地址优先。

## [注意事项](#ZH-CN_MMLREF_0233845577)

- 该命令执行后立即生效。

- 在每次执行ADD APN命令时会自动为本命令增加一条记录，记录中参数的初始设置值如下：FIRMODEV4：DHCP，SECMODEV4：LOCAL，FIRMODEV6：DHCP，SECMODEV6：LOCAL。

#### [操作用户权限](#ZH-CN_MMLREF_0233845577)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0233845577)
