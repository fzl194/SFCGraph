# 删除5G接入限制区域列表（RMV NGACCAREALST）

- [命令功能](#ZH-CN_MMLREF_0244007640__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244007640__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244007640__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244007640__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244007640)

**适用NF：AMF**

该命令用于删除5G接入限制区域信息配置。

## [注意事项](#ZH-CN_MMLREF_0244007640)

- 该命令执行后立即生效。

- 若指定的区域除一条非特殊用户的配置记录之外其他配置均为特殊用户配置，则该配置不能删除。若要删除，请先删除该区域的特殊用户配置记录。

#### [操作用户权限](#ZH-CN_MMLREF_0244007640)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244007640)
