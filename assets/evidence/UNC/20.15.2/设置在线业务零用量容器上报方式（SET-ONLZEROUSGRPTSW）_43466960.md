# 设置在线业务零用量容器上报方式（SET ONLZEROUSGRPTSW）

- [命令功能](#ZH-CN_MMLREF_0000001143466960__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001143466960__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001143466960__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001143466960__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001143466960)

**适用NF：PGW-C、SMF**

该命令用于设置在线业务零用量容器上报方式。

## [注意事项](#ZH-CN_MMLREF_0000001143466960)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001143466960)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001143466960)
...
## [使用实例](#ZH-CN_MMLREF_0000001143466960)
