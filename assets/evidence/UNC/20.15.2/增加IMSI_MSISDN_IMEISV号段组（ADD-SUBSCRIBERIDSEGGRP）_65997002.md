# 增加IMSI/MSISDN/IMEISV号段组（ADD SUBSCRIBERIDSEGGRP）

- [命令功能](#ZH-CN_CONCEPT_0265997002__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0265997002__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0265997002__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0265997002__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0265997002__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0265997002)

**适用NF：PGW-C、SMF**

该命令用来配置IMSI/MSISDN/IMEISV号码段组，用于根据号段组选择USERPROFILE作为本地策略、根据号段选择OCS、用户根据号段选择OCS组以及在线计费模板、根据号段选择CG组、根据号段选择SGW离线计费方式等。

#### [注意事项](#ZH-CN_CONCEPT_0265997002)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0265997002)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0265997002)
