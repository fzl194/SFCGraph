# 增加NF Set ID最长匹配后缀转发路由（ADD NRFSETIDRT）

- [命令功能](#ZH-CN_MMLREF_0000001172598769__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001172598769__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001172598769__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001172598769__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001172598769)

**适用NF：NRF**

该命令用于增加基于NF Set ID的最长匹配后缀的转发路由。

## [注意事项](#ZH-CN_MMLREF_0000001172598769)

- 该命令执行后立即生效。

- 最多可输入1024条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001172598769)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001172598769)
...
## [使用实例](#ZH-CN_MMLREF_0000001172598769)
