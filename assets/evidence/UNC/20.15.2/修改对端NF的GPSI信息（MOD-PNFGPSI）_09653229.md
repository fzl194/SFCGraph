# 修改对端NF的GPSI信息（MOD PNFGPSI）

- [命令功能](#ZH-CN_MMLREF_0209653229__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653229__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653229__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653229__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653229)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于修改本地配置的对端NF实例支持的GPSI信息。

## [注意事项](#ZH-CN_MMLREF_0209653229)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209653229)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653229)
