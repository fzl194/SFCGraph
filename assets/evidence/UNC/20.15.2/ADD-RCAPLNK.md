# 增加注册中心链路 (ADD RCAPLNK)

- [命令功能](#ZH-CN_CONCEPT_0000001292188105__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001292188105__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001292188105__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001292188105__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001292188105__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001292188105__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001292188105)

**适用NF：SMSF**

此命令用于新增注册中心链路配置。注册中心的链路固定作为CLINET端。

#### [注意事项](#ZH-CN_CONCEPT_0000001292188105)
...
#### [本地用户权限](#ZH-CN_CONCEPT_0000001292188105)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001292188105)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001292188105)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001292188105)
