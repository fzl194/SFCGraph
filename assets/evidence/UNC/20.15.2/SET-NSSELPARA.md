# 设置网络切片选择相关参数（SET NSSELPARA）

- [命令功能](#ZH-CN_MMLREF_0209652484__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652484__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652484__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652484__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652484)

**适用NF：AMF**

该命令用于设置网络切片选择的相关参数，包括是否支持AMF到NSSF的网络切片可用性信息的自动同步、同步间隔、支持的最大TAI切片数量等。

## [注意事项](#ZH-CN_MMLREF_0209652484)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652484)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652484)
