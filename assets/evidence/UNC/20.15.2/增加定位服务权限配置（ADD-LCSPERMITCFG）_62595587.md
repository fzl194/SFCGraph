# 增加定位服务权限配置（ADD LCSPERMITCFG）

- [命令功能](#ZH-CN_MMLREF_0000001262595587__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001262595587__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001262595587__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001262595587__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001262595587)
...
## [注意事项](#ZH-CN_MMLREF_0000001262595587)

- 该命令执行后立即生效。

- 最多可输入1024条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001262595587)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001262595587)
...
## [使用实例](#ZH-CN_MMLREF_0000001262595587)

增加定位服务操作为Namf_Location_ProvidePositioningInfo，IPV4地址为“10.10.10.10”，用户群组标识为1的权限配置，符合以上条件的对应用户的服务操作才能被接受，执行如下命令：

```
ADD LCSPERMITCFG: OPTYPE=Namf_Location_ProvidePositioningInfo, IPTYPE=IPTypeV4, IPV4ADDRESS="10.10.10.10", USRGRPID=1;
```
