# 设置QoS PHB（SET QOSPHB）

- [命令功能](#ZH-CN_CONCEPT_0000001600840685__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600840685__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600840685__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600840685__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600840685__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600840685)

当接口上使能简单流分类，并且报文在接口下行转发检查PHB时，可以使用该命令配置当前域的下行IP报文的服务等级和颜色映射成对应的DSCP值，或者下行VLAN报文在路由器内部的服务等级和报文颜色对应路由器外部的802.1p的值。

#### [注意事项](#ZH-CN_CONCEPT_0000001600840685)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600840685)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600840685)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600840685)
