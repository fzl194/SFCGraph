...
- [命令功能](#ZH-CN_MMLREF_0000001180592498__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001180592498__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001180592498__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001180592498__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001180592498)

该命令用于增加IKE对等体。

## [注意事项](#ZH-CN_MMLREF_0000001180592498)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001180592498)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001180592498)
...
| LOCALIDTYPE | 本地ID类型 | 可选必选说明：可选参数<br>参数含义：本地ID的类型。<br>数据来源：本端规划<br>取值范围：<br>- “Ip（IP）”：IP<br>- “Fqdn（FQDN）”：FQDN<br>- “User_fqdn（User-FQDN）”：User-FQDN<br>- “Dn（DN）”：DN<br>- “Ip_disable（IP-disable）”：关闭local ip的IP校验<br>默认值：Ip<br>配置原则：无 |
| REMOTEID | 远程ID | 可选必选说明：可选参数<br>参数含义：远程ID。<br>数据来源：对端协商<br>取值范围：字符串类型，输入长度范围是1~255。<br>默认值：无<br>配置原则：无 |
| VERSION1 | 版本1 | 可选必选说明：可选参数<br>参数含义：IKE版本1。<br>数据来源：对端协商<br>取值范围：<br>- TRUE(TRUE)<br>- FALSE(FALSE)<br>默认值：TRUE<br>配置原则：无 |
| VERSION2 | 版本2 | 可选必选说明：可选参数<br>参数含义：版本2。<br>数据来源：对端协商<br>取值范围：<br>- TRUE(TRUE)<br>- FALSE(FALSE)<br>默认值：TRUE<br>配置原则：无 |
...
## [使用实例](#ZH-CN_MMLREF_0000001180592498)

增加名称为“peer1”的IKE对等体，同时指定交换模式为main模式：

```
ADD IKEPEER:PEERNAME="peer1",EXCHANGEMODE=Main;
```
