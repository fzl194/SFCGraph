# 查询DNS NAPTR记录(LST DNSN)

- [命令功能](#ZH-CN_MMLREF_0000001126145892__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145892__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145892__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145892__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145892__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145892__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126145892__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145892)

**适用网元：SGSN、MME**

该命令用于查询 “FQDN” （全称标准规范域名）与网元接口的对应关系。

#### [注意事项](#ZH-CN_MMLREF_0000001126145892)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145892)

manage-ug；system-ug；monitor-ug；visit-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145892)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组；G_4，来宾级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145892)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145892)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126145892)

参考 [**ADD DNSN**](增加DNS NAPTR记录(ADD DNSN)_72225569.md) 命令的参数标识。
