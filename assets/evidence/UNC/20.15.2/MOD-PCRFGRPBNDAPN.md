# 修改APN和Pcrf组关联关系（MOD PCRFGRPBNDAPN）

- [命令功能](#ZH-CN_CONCEPT_0209897107__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897107__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897107__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897107__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897107__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897107)

**适用NF：PGW-C、GGSN**

此命令用来修改APN和Pcrf组关联关系。当修改APN与PCRF组的绑定关系时，已经建立的IP-CAN Session状态不受影响，但新建立的IP-CAN Session会按更新后的绑定关系进行关联PCRF的选取。

#### [注意事项](#ZH-CN_CONCEPT_0209897107)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897107)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897107)
