# 启动NB-IoT用户的MME迁移任务（STR NBOFFLOADBYMME）

- [命令功能](#ZH-CN_MMLREF_0000001126146094__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146094__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146094__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146094__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146094__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146094__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146094)

**适用网元：MME**

此命令用于启动NB-IoT接入类型接入 UNC 的用户迁移任务。在单个MME出现过载、MME需要进行迁移或升级、网络负载出现不均衡的情况下，可以启动用户迁移任务，能够及时调整网络运行状况，实现资源合理利用，并有效减少用户接入损耗和业务中断。

#### [注意事项](#ZH-CN_MMLREF_0000001126146094)

- 启动迁移前必须确保已通过[**SET SYS**](../../系统管理/系统参数管理/设置系统参数(SET SYS)_72345947.md)命令将MME的“设备能力”设置为0，否则将无法启动迁移任务。
- [**SET SYS**](../../系统管理/系统参数管理/设置系统参数(SET SYS)_72345947.md)命令将MME的“设备能力”设置为0后，会影响WB和NB新用户的接入。
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126146094)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146094)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146094)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146094)
