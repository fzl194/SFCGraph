# 修改5G接入用户数控制参数（MOD NGUSERNUMCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001310097229__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001310097229__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001310097229__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001310097229__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001310097229)
...
## [注意事项](#ZH-CN_MMLREF_0000001310097229)

修改接入用户数相关控制参数，仅对新接入用户生效，已接入用户不受影响。

#### [操作用户权限](#ZH-CN_MMLREF_0000001310097229)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001310097229)
...
## [使用实例](#ZH-CN_MMLREF_0000001310097229)
