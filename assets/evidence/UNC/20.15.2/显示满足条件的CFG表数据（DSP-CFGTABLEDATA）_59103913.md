# 显示满足条件的CFG表数据（DSP CFGTABLEDATA）

- [命令功能](#ZH-CN_CONCEPT_0259103913__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103913__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103913__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103913__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103913__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259103913__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103913)

该命令用于显示满足条件的CFG表数据。

#### [注意事项](#ZH-CN_CONCEPT_0259103913)

该命令仅用于研发问题定位。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103913)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103913)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259103913)
