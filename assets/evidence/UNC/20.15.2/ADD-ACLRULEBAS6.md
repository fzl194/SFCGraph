# 增加基本IPv6 ACL规则（ADD ACLRULEBAS6）

- [命令功能](#ZH-CN_CONCEPT_0000001600601037__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600601037__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600601037__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600601037__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600601037__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600601037)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001600601037)

- 该命令执行后立即生效。
- 该命令最大记录数为65535。
- 增加ACL规则前必须先执行ADD ACLGROUP6指定所在规则组，单个ACL规则组下最多支持16384条ACL规则。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600601037)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600601037)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600601037)
