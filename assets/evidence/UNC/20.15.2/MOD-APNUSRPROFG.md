# 修改APN用户模板组绑定关系（MOD APNUSRPROFG）

- [命令功能](#ZH-CN_CONCEPT_0209897225__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897225__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897225__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897225__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897225__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897225)

**适用NF：PGW-C、SMF**

本命令用于修改一组APN实例与UsrProfGroup的绑定关系。

#### [注意事项](#ZH-CN_CONCEPT_0209897225)

- 该命令执行后立即生效。
- 每个APN只能绑定一个UsrProfGroup。
- 要配置此命令，需要首先配置ADD APN和ADD USRPROFGROUP。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897225)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897225)
