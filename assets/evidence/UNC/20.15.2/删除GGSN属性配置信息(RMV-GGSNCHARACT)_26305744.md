# 删除GGSN属性配置信息(RMV GGSNCHARACT)

- [命令功能](#ZH-CN_MMLREF_0000001126305744__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305744__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305744__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305744__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305744__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305744__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305744)

**适用网元：SGSN**

该命令用于删除GGSN属性配置信息表中GGSN属性的记录。

#### [注意事项](#ZH-CN_MMLREF_0000001126305744)

- 该命令执行后立即生效。
- 删除记录后，系统会继续查找最匹配的记录，采用最匹配的记录的配置值。
- 删除记录前需要确认指定GGSN网元的功能，以免因与实际设备不兼容而导致流程失败。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305744)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305744)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305744)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305744)
