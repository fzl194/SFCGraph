# 增加原因值映射配置(ADD CAUSEMAP)

- [命令功能](#ZH-CN_MMLREF_0000001126145490__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145490__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145490__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145490__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145490__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145490__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145490)

**适用网元：SGSN、MME**

此命令用于增加一个原因值映射配置记录。原因值映射就是将原接口消息中的原因值直接映射到目标接口消息中下发的原因值。

#### [注意事项](#ZH-CN_MMLREF_0000001126145490)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126145490)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145490)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145490)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145490)
