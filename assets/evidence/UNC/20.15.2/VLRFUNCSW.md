# 设置VLR功能开关（SET VLRFUNCSW）

- [命令功能](#ZH-CN_MMLREF_0000001353641466__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001353641466__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001353641466__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001353641466__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001353641466)

**适用NF：SMSF**

该命令用于设置VLR短信业务功能开关。运营商可以根据需要设置VLR的不同功能。

## [注意事项](#ZH-CN_MMLREF_0000001353641466)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001353641466)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001353641466)
...
## [使用实例](#ZH-CN_MMLREF_0000001353641466)
