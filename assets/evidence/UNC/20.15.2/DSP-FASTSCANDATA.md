# 显示快速扫描任务信息（DSP FASTSCANDATA）

- [命令功能](#ZH-CN_MMLREF_0000002147441357__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002147441357__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002147441357__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002147441357__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000002147441357__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000002147441357)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于显示快速扫描任务信息。

## [注意事项](#ZH-CN_MMLREF_0000002147441357)

最多输出100个DS的快速扫描任务详细信息，最后一行输出所有DS的汇总记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000002147441357)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002147441357)
...
## [使用实例](#ZH-CN_MMLREF_0000002147441357)
...
## [输出结果说明](#ZH-CN_MMLREF_0000002147441357)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 扫描任务类型 | 该参数用于指定扫描任务类型。<br>取值说明：<br>- UPF_DEACTIVE（UPF去活扫描任务）<br>- SBC_FAULT（SBC故障扫描任务） |
| 查询条件 | 该参数用于表示扫描任务数据查询条件。 |
| Token编号 | 该参数用于标识Token的编号。最后一行输出的Token参数含义为汇总所得的Token数量。 |
| 扫描任务数据个数 | 该参数用于标识扫描任务数据个数，例如会话数等。 |
