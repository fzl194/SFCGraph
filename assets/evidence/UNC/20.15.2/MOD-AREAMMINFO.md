# 修改基于区域的网络名称 (MOD AREAMMINFO)

- [命令功能](#ZH-CN_CONCEPT_0000001392632080__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001392632080__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001392632080__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001392632080__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001392632080__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001392632080__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001392632080)

**适用网元：MME**

此命令用于修改基于区域的网络名称。

#### [注意事项](#ZH-CN_CONCEPT_0000001392632080)

该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001392632080)

manage-ug；system-ug；

#### [网管用户权限](#ZH-CN_CONCEPT_0000001392632080)

G_1，管理员级别命令组；G_2，操作员级别命令组；

#### [参数说明](#ZH-CN_CONCEPT_0000001392632080)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001392632080)
