# 增加服务节点组（ADD SRVNODEGROUP）

- [命令功能](#ZH-CN_MMLREF_0209651376__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651376__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651376__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651376__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651376)

**适用NF：PGW-C、GGSN**

该命令用来添加一个新的服务节点组。当需要用SGSN IP、SGW IP、PCF IP进行虚拟APN映射时，在不同的场景下需要使用该命令添加SGSN/SGW/PCF新的服务节点组，可以在该服务节点组下绑定服务节点IP地址。

## [注意事项](#ZH-CN_MMLREF_0209651376)

- 该命令执行后立即生效。

- 最多可输入3000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209651376)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651376)
