# 设置MPLS全局配置（SET MPLSSITE）

- [命令功能](#ZH-CN_CONCEPT_0000001600600993__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600600993__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600600993__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600600993__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600600993__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600600993)

![](设置MPLS全局配置（SET MPLSSITE）_00600993.assets/notice_3.0-zh-cn_2.png)

本命令属于高危命令，操作不当会去使能MPLS或LDP，导致MPLS或LDP功能不可用，并且所有历史MPLS或LDP配置全部删除，请谨慎使用并联系华为技术支持协助操作。

该命令用于设置MPLS全局配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001600600993)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600600993)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600600993)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600600993)
