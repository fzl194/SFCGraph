# 删除指定归属地SMF实例标识（RMV HOMESMFINSTID）

- [命令功能](#ZH-CN_MMLREF_0000001823782810__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001823782810__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001823782810__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001823782810__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001823782810)

**适用NF：SMF**

该命令用于在对接归属地SMF时，删除指定用户接入的SMF实例标识。

## [注意事项](#ZH-CN_MMLREF_0000001823782810)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001823782810)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001823782810)
...
## [使用实例](#ZH-CN_MMLREF_0000001823782810)

假设运营商需要删除一个SUBRANGE为“IMSI_PRE”、PREFIX为“3080107000”、HSMF实例标识为"bdc3f6f6-69ac-4c06-bfe5-030101000001"的HOMESMFINSTID配置。

```
RMV HOMESMFINSTID:SUBRANGE=IMSI_PRE,PREFIX="3080107000",HSMFINSTID="bdc3f6f6-69ac-4c06-bfe5-030101000001";
```
