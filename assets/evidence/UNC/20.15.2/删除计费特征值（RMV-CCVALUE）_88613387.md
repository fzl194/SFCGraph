...
- [命令功能](#ZH-CN_MMLREF_0000001188613387__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001188613387__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001188613387__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001188613387__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001188613387)

**适用NF：PGW-C、GGSN**

该命令用于删除指定计费属性组下的一个计费特征值或者所有计费特征值。

## [注意事项](#ZH-CN_MMLREF_0000001188613387)

- 该命令执行后立即生效。

- CCVALUE参数不输入时，表示删除该组内的所有记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001188613387)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001188613387)
...
## [使用实例](#ZH-CN_MMLREF_0000001188613387)
