# 增加服务类型在POD实例下的静态权重（ADD STATICWTPOLICY）

- [命令功能](#ZH-CN_MMLREF_0000001951175613__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001951175613__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001951175613__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001951175613__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001951175613)
...
## [注意事项](#ZH-CN_MMLREF_0000001951175613)

- 该命令执行后立即生效。

- 最多可输入4096条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001951175613)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001951175613)
...
## [使用实例](#ZH-CN_MMLREF_0000001951175613)
