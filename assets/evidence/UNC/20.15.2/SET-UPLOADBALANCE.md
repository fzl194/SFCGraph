# 设置UP负载均衡功能（SET UPLOADBALANCE）

- [命令功能](#ZH-CN_MMLREF_0000001097782146__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001097782146__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001097782146__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001097782146__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001097782146)

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于配置UP负载均衡功能。

## [注意事项](#ZH-CN_MMLREF_0000001097782146)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001097782146)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001097782146)
...
## [使用实例](#ZH-CN_MMLREF_0000001097782146)
