# 设置目标NF选择策略（SET NFSELPLCY）

- [命令功能](#ZH-CN_MMLREF_0253103373__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0253103373__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0253103373__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0253103373__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0253103373)

**适用NF：AMF**

该命令用于设置AMF在发现和选择其它目标NF时的设备级可选参数控制策略。

## [注意事项](#ZH-CN_MMLREF_0253103373)
...
#### [操作用户权限](#ZH-CN_MMLREF_0253103373)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0253103373)
