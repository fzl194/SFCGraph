# 设置容灾功能(SET RESTOFUNC)

- [命令功能](#ZH-CN_MMLREF_0000001172345713__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345713__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345713__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345713__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345713__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345713__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345713)

**适用网元：MME**

本命令用于控制设备容灾功能的运行方式，以及业务恢复流程的方式。

#### [注意事项](#ZH-CN_MMLREF_0000001172345713)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345713)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345713)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345713)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345713)
