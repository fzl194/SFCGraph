# 查询对等PLMN配置(LST PEERPLMN)

- [命令功能](#ZH-CN_MMLREF_0000001126146098__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146098__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146098__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146098__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146098__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146098__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126146098__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146098)

**适用网元：SGSN、MME**

此命令用于查询对等PLMN配置记录。

#### [注意事项](#ZH-CN_MMLREF_0000001126146098)

此命令执行后立即生效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126146098)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146098)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146098)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146098)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126146098)

参见 [**ADD PEERPLMN**](增加对等PLMN配置(ADD PEERPLMN)_26305906.md) 的参数说明。
