# 增加5GC QoS到TOS/DSCP的映射规则（ADD 5GCREMARK）

- [命令功能](#ZH-CN_MMLREF_0209653051__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653051__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653051__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653051__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653051)

**适用NF：SMF**

该命令用来增加5G用户QoS参数到IP报头中的DSCP（区别服务编码点）/TOS（服务类型）的映射规则，用户的数据将根据映射得到的DSCP（区别服务编码点）/TOS（服务类型）中的参数值进行转发。

## [注意事项](#ZH-CN_MMLREF_0209653051)

- 命令执行后只对新接入用户生效。

- 最多可输入1000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0209653051)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653051)
