# 修改RRC Inactive策略（MOD RRCINACTPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001870462585__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870462585__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870462585__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870462585__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870462585)

**适用NF：AMF**

该命令用于修改RRC Inactive功能的开启策略，通过此命令修改支持RRC Inactive功能的用户范围和TAI区域。

## [注意事项](#ZH-CN_MMLREF_0000001870462585)

- 该命令执行后立即生效。

- 修改后的号段不能和已有号段区间交叉重叠。

#### [操作用户权限](#ZH-CN_MMLREF_0000001870462585)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870462585)
...
## [使用实例](#ZH-CN_MMLREF_0000001870462585)
