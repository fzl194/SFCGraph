# 修改指定APN的UPF节点信息（MOD APNUPFINFO）

- [命令功能](#ZH-CN_MMLREF_0296242549__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296242549__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296242549__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296242549__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296242549)

**适用NF：SMF、PGW-C、SGW-C、GGSN**

该命令用户修改指定APN的UPF节点信息。

## [注意事项](#ZH-CN_MMLREF_0296242549)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0296242549)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296242549)
