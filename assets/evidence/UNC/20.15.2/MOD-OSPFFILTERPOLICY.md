# 修改OSPF过滤策略配置（MOD OSPFFILTERPOLICY）

- [命令功能](#ZH-CN_CONCEPT_0000001600600465__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600600465__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600600465__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600600465__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600600465__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600600465)

该命令用于修改OSPF过滤策略。

#### [注意事项](#ZH-CN_CONCEPT_0000001600600465)

- 该命令执行后立即生效。
- 只有配置了OSPF进程后才能使用该命令。
- 若待修改的FilterPolicy不存在，则会执行失败。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600600465)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600600465)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600600465)
