# 增加性能对象信息(ADD PERFOBJ)

- [命令功能](#ZH-CN_MMLREF_0000001126305998__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305998__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305998__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305998__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305998__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305998__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305998)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305998)

- 该命令执行后立即生效。
- 不同的性能统计对象，支持的配置对象数存在差异，具体请参考对象对应的参数描述。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305998)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305998)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305998)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305998)
