# 显示属性值信息（DSP DEVATTRCACHE）

- [命令功能](#ZH-CN_CONCEPT_0259104152__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259104152__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259104152__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259104152__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259104152__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259104152__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259104152)

该命令用于显示资源单元上指定组件的设备属性信息。

#### [注意事项](#ZH-CN_CONCEPT_0259104152)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0259104152)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259104152)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259104152)
...
| 属性ID | 表示属性ID。 |
| 属性长度 | 表示属性长度。 |
| 超时次数 | 表示订阅属性无法同步时的重传超时次数。 |
| 属性源PID | 表示属性来源组件的PID。 |
| 同步状态 | 表示属性的同步状态。<br>- SYN：同步态。<br>- NOT_SYN：非同步态。 |
| 属性值 | 表示属性值。 |
