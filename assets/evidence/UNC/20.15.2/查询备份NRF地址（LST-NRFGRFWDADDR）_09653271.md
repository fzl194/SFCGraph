# 查询备份NRF地址（LST NRFGRFWDADDR）

- [命令功能](#ZH-CN_MMLREF_0209653271__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653271__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653271__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653271__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209653271__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209653271)

**适用NF：NRF**

查询备份NRF地址。

## [注意事项](#ZH-CN_MMLREF_0209653271)

仅供调测使用。

#### [操作用户权限](#ZH-CN_MMLREF_0209653271)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653271)
...
## [输出结果说明](#ZH-CN_MMLREF_0209653271)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 备份NRF名称 | 该参数表示对端NRF名称。 |
| IP类型 | 该参数表示对端NRF地址的IP类型。 |
| IPV4地址 | 该参数表示对端NRF的IPv4地址。 |
| IPV6地址 | 该参数表示对端NRF的IPv6地址。 |
| 端口 | 该参数表示对端NRF地址所对应的端口号。 |
| 备份NRF实例标识 | 该参数表示备份NRF实例标识。 |
| 是否支持TLS | 该参数用于指定NRF是否支持TLS。 |
