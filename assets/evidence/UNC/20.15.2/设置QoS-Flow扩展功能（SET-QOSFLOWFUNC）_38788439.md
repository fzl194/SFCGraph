# 设置QoS Flow扩展功能（SET QOSFLOWFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001138788439__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001138788439__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001138788439__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001138788439__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001138788439)

**适用NF：SMF**

该命令用于设置QoS Flow相关扩展功能。

## [注意事项](#ZH-CN_MMLREF_0000001138788439)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001138788439)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001138788439)
...
## [使用实例](#ZH-CN_MMLREF_0000001138788439)
