# 设置NG接入CHR上报策略（SET NGACCCHRCFG）

- [命令功能](#ZH-CN_MMLREF_0234945607__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0234945607__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0234945607__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0234945607__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0234945607)

**适用NF：AMF**

该命令用于系统上报NG接入CHR单据时，配置NG接入CHR单据采集及订阅流程。

## [注意事项](#ZH-CN_MMLREF_0234945607)
...
#### [操作用户权限](#ZH-CN_MMLREF_0234945607)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0234945607)
