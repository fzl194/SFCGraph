# 设置域名前后缀分隔符（SET DOMAINSEPARATOR）

- [命令功能](#ZH-CN_MMLREF_0209654169__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654169__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654169__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654169__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654169)

**适用NF：SMF、GGSN、PGW-C**

该命令用于设置域名前缀和后缀的分隔符。

## [注意事项](#ZH-CN_MMLREF_0209654169)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209654169)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654169)
