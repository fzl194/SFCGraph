...
- [命令功能](#ZH-CN_MMLREF_0000001126145980__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126145980__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126145980__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126145980__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126145980__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126145980__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126145980__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126145980)

**适用网元：MME**

此命令用于查询MSC IP地址和MSC-Number之间的映射关系。

#### [注意事项](#ZH-CN_MMLREF_0000001126145980)

无。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126145980)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126145980)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126145980)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126145980)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126145980)

请参考 [**ADD MSCPARA**](增加MSC参数(ADD MSCPARA)_72225657.md) 命令的参数标识。
