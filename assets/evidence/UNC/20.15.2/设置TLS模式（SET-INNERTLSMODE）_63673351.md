# 设置TLS模式（SET INNERTLSMODE）

- [命令功能](#ZH-CN_MMLREF_0263673351__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0263673351__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0263673351__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0263673351__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0263673351)

![](设置TLS模式（SET INNERTLSMODE）_63673351.assets/notice_3.0-zh-cn_2.png)

SERVICETYPE选择HAFETCD后，执行该命令会导致整系统复位。

该命令用于根据服务类型设置TLS模式。

## [注意事项](#ZH-CN_MMLREF_0263673351)
...
#### [操作用户权限](#ZH-CN_MMLREF_0263673351)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0263673351)
