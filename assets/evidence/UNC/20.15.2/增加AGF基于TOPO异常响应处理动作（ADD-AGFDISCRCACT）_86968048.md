# 增加AGF基于TOPO异常响应处理动作（ADD AGFDISCRCACT）

- [命令功能](#ZH-CN_MMLREF_0000001186968048__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001186968048__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001186968048__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001186968048__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001186968048)

**适用NF：NCG**

该命令用于增加AGF基于TOPO异常响应处理动作。

## [注意事项](#ZH-CN_MMLREF_0000001186968048)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001186968048)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001186968048)
...
## [使用实例](#ZH-CN_MMLREF_0000001186968048)
