# 增加紧急号码配置信息（ADD NGEMGCNUM）

- [命令功能](#ZH-CN_MMLREF_0209652453__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652453__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652453__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652453__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652453)

**适用NF：AMF**

此命令用于配置紧急呼叫号码。系统在给UE发送Registration Accept消息时，会将配置的MCC的紧急呼叫号码携带在消息中发送给UE。

## [注意事项](#ZH-CN_MMLREF_0209652453)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652453)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652453)
