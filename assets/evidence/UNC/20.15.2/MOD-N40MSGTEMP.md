# 修改N40消息属性模板（MOD N40MSGTEMP）

- [命令功能](#ZH-CN_MMLREF_0000001148877301__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001148877301__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001148877301__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001148877301__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001148877301)

**适用NF：PGW-C、SMF**

该命令用于修改N40消息属性模板，用于控制N40消息中是否携带对应字段。

## [注意事项](#ZH-CN_MMLREF_0000001148877301)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001148877301)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001148877301)
...
## [使用实例](#ZH-CN_MMLREF_0000001148877301)
