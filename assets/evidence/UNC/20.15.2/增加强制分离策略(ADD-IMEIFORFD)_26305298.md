# 增加强制分离策略(ADD IMEIFORFD)

- [命令功能](#ZH-CN_MMLREF_0000001126305298__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305298__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305298__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305298__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305298__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305298__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305298)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305298)

- 该表最大记录数为200。
- 该命令执行后立即生效。
- 如果需要匹配IMEI（International Mobile Subscriber Identity）而不是IMEISV，也可以使用此命令。使用任意0~9的数字将IMEI补足到16位，并在掩码的相应位上置0，使补充的该数字位无效。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305298)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305298)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305298)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305298)
