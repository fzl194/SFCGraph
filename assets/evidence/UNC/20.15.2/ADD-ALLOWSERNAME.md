# 增加基于地址的白名单（ADD ALLOWSERNAME）

- [命令功能](#ZH-CN_MMLREF_0000001183813626__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001183813626__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001183813626__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001183813626__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001183813626)

该命令用于增加基于IP地址过滤的允许访问的服务白名单，当系统作为服务端时，添加到白名单中的指定IP地址的服务，只允许白名单中指定的对端地址的服务访问。未添加到白名单的服务则允许所有对端访问。

## [注意事项](#ZH-CN_MMLREF_0000001183813626)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001183813626)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001183813626)
...
## [使用实例](#ZH-CN_MMLREF_0000001183813626)
