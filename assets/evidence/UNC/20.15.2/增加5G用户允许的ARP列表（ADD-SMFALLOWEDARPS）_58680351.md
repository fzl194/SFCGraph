# 增加5G用户允许的ARP列表（ADD SMFALLOWEDARPS）

- [命令功能](#ZH-CN_MMLREF_0000001258680351__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001258680351__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001258680351__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001258680351__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001258680351)

**适用NF：SMF**

该命令用于配置5G用户允许接入的ARP列表。当产品作为V-SMF/I-SMF形态时，通过该配置可以实现QoS管控功能。

## [注意事项](#ZH-CN_MMLREF_0000001258680351)

- 命令执行后只对新接入用户生效。

- 最多可输入2048条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001258680351)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001258680351)
...
## [使用实例](#ZH-CN_MMLREF_0000001258680351)
