# 增加对端NF的通配策略（ADD PNFWILDCARD）

- [命令功能](#ZH-CN_MMLREF_0000001135374733__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001135374733__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001135374733__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001135374733__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001135374733)

**适用NF：AMF、SMF、NRF、NSSF、SMSF、NCG**

该命令用于增加对端NF的通配策略。用于指示当本地配置中没有配置或缓存中不包含对端NF支持的特定属性信息时，用户携带该属性查询，此对端NF是否允许被服务发现。

## [注意事项](#ZH-CN_MMLREF_0000001135374733)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001135374733)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001135374733)
...
## [使用实例](#ZH-CN_MMLREF_0000001135374733)
