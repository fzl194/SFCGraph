# 修改EPS签约QoS配置（MOD EPSSUBQOS）

- [命令功能](#ZH-CN_MMLREF_0209654145__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654145__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654145__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654145__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654145)
...
## [注意事项](#ZH-CN_MMLREF_0209654145)

- 该命令执行后只对新激活用户生效。

- 该配置必须和网络规划一致，否则会导致用户的带宽和业务级别等控制出现问题。

#### [操作用户权限](#ZH-CN_MMLREF_0209654145)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654145)
