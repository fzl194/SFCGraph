# 设置MB-SMF组播广播功能参数（SET SMFMBSFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001382612542__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001382612542__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001382612542__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001382612542__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001382612542)

**适用NF：SMF**

该命令用于设置MB-SMF组播广播功能参数。

## [注意事项](#ZH-CN_MMLREF_0000001382612542)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001382612542)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001382612542)
...
## [使用实例](#ZH-CN_MMLREF_0000001382612542)
