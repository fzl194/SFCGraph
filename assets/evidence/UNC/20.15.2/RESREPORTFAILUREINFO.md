# 显示组件上报的故障信息（DSP RESREPORTFAILUREINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001151002633__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001151002633__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001151002633__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001151002633__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001151002633__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001151002633__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001151002633)

该命令用于显示当前系统中存在的组件上报故障信息。

当组件异常时，可执行该命令查看当前系统中是否存在组件上报故障信息，方便定位问题。

#### [注意事项](#ZH-CN_CONCEPT_0000001151002633)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001151002633)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001151002633)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001151002633)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001151002633)
