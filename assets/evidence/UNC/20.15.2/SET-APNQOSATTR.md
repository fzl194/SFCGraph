# 设置指定APN的QoS属性配置信息（SET APNQOSATTR）

- [命令功能](#ZH-CN_MMLREF_0209651825__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651825__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651825__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651825__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651825)

**适用NF：PGW-C、SGW-C、SMF、GGSN**

该命令用于设置指定APN的QoS属性配置信息。

## [注意事项](#ZH-CN_MMLREF_0209651825)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651825)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651825)
