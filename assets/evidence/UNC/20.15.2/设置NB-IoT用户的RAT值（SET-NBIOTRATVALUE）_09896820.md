# 设置NB-IoT用户的RAT值（SET NBIOTRATVALUE）

- [命令功能](#ZH-CN_CONCEPT_0209896820__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896820__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896820__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896820__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896820__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896820)

**适用NF：SGW-C、PGW-C、SMF**

该命令用于设置NB-IoT终端接入时UNC给周边网元发送消息时RAT信元中填写的值。

#### [注意事项](#ZH-CN_CONCEPT_0209896820)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896820)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896820)
