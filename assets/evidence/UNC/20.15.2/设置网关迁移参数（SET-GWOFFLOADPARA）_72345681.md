# 设置网关迁移参数（SET GWOFFLOADPARA）

- [命令功能](#ZH-CN_MMLREF_0000001172345681__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345681__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345681__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345681__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345681__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345681__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345681)

**适用网元：MME**

该命令用于设置S-GW或P-GW故障场景下，对用户业务进行迁移的控制参数，包含迁移任务的启动时延、迁移速率以及S11/S5接口故障迁移控制开关。

#### [注意事项](#ZH-CN_MMLREF_0000001172345681)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345681)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345681)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345681)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345681)
