# 设置RAN侧安全策略（SET RANSECPLCY）

- [命令功能](#ZH-CN_MMLREF_0209652638__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652638__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652638__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652638__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652638)

**适用NF：SMF**

该命令用来配置RAN侧用户面安全策略。策略用于明确是否需要对RAN侧用户面进行完整性保护和加密保护。

## [注意事项](#ZH-CN_MMLREF_0209652638)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652638)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652638)
