# 删除支持DHCP服务的GGSN IP地址（RMV DHCPGIP）

- [命令功能](#ZH-CN_MMLREF_0000001172225629__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225629__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225629__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225629__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225629__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225629__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225629)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172225629)

- 该命令执行后立即生效。
- 删除后如果本表记录为空，则不能采用DHCP方式激活PDP。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172225629)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225629)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225629)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225629)
