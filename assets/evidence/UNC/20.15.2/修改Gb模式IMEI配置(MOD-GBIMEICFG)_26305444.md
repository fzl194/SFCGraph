# 修改Gb模式IMEI配置(MOD GBIMEICFG)

- [命令功能](#ZH-CN_MMLREF_0000001126305444__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305444__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305444__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305444__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305444__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305444__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305444)

**适用网元：SGSN**

该命令用于修改GERAN用户获取和检查IMEI的策略。

#### [注意事项](#ZH-CN_MMLREF_0000001126305444)

- 该命令执行后立即生效。
- 此命令可修改GERAN所有用户的默认IMEI配置，也可修改指定号段用户的IMEI配置。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305444)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305444)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305444)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305444)
