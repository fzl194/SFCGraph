# 设置NF管理模块的定时器配置（SET NFMGMTTIMER）

- [命令功能](#ZH-CN_MMLREF_0000001601126445__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001601126445__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001601126445__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001601126445__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001601126445)

**适用NF：NRF、SMF、AMF、NSSF、NCG、SMSF**

该命令用于设置NF管理模块的定时器配置。

## [注意事项](#ZH-CN_MMLREF_0000001601126445)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001601126445)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001601126445)
...
## [使用实例](#ZH-CN_MMLREF_0000001601126445)
