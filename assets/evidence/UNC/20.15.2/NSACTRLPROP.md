# 设置NSA控制处理配置（SET NSACTRLPROP）

- [命令功能](#ZH-CN_MMLREF_0296243179__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296243179__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296243179__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296243179__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0296243179)

**适用NF：SGW-C、PGW-C**

该命令用于设置NSA相关的控制处理配置。

## [注意事项](#ZH-CN_MMLREF_0296243179)
...
#### [操作用户权限](#ZH-CN_MMLREF_0296243179)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0296243179)
