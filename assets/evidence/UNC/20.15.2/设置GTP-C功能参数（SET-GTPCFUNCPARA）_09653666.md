# 设置GTP-C功能参数（SET GTPCFUNCPARA）

- [命令功能](#ZH-CN_MMLREF_0209653666__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653666__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653666__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653666__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653666)

**适用NF：SGW-C、PGW-C、AMF、GGSN**

该命令用于设置协议定义的GTP-C相关功能参数。

## [注意事项](#ZH-CN_MMLREF_0209653666)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209653666)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653666)
