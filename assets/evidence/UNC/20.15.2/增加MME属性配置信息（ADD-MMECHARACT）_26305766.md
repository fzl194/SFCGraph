# 增加MME属性配置信息（ADD MMECHARACT）

- [命令功能](#ZH-CN_MMLREF_0000001126305766__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305766__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305766__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305766__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305766__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305766__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305766)

**适用网元：MME**

该命令用于配置对端MME的属性信息。MME将此属性配置作为与对等网元间信令交互时，携带某些可选信元的一个参考条件。

#### [注意事项](#ZH-CN_MMLREF_0000001126305766)

- 该命令执行后立即生效。
- 该表的最大元组数为100。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305766)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305766)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305766)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305766)
