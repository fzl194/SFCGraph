# 增加P-CSCF组和IMSI/MSISDN号段的绑定关系（ADD PCSCFGRPBINDIMSI）

- [命令功能](#ZH-CN_MMLREF_0209654389__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654389__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654389__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654389__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654389)

**适用NF：SMF、GGSN、PGW-C**

该命令用于将指定的p-cscf组绑定到指定的号段。在网络中规划IMS业务时，该命令可以把指定的号段和p-cscf组绑定。

## [注意事项](#ZH-CN_MMLREF_0209654389)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209654389)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654389)
