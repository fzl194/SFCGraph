...
- [命令功能](#ZH-CN_MMLREF_0209651377__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651377__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651377__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651377__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0209651377__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0209651377)

**适用NF：AMF**

该命令用于查询本地数据网络的配置信息。

## [注意事项](#ZH-CN_MMLREF_0209651377)

无

#### [操作用户权限](#ZH-CN_MMLREF_0209651377)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651377)
...
## [输出结果说明](#ZH-CN_MMLREF_0209651377)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 数据网络名称 | 该参数用于指定本地数据网络。 |
| 跟踪区标识起始值 | 该参数用于指定本地数据网络（LADN）的生效区域范围。 |
| 跟踪区标识结束值 | 该参数用于指定本地数据网络的生效区域范围。 |
| 描述信息 | 该参数表示对本地数据网络的描述信息，在运维中起到助记的作用。 |
