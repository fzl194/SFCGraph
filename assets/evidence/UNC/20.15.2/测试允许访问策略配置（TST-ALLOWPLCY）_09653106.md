# 测试允许访问策略配置（TST ALLOWPLCY）

- [命令功能](#ZH-CN_MMLREF_0209653106__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209653106__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209653106__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209653106__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209653106)

**适用NF：NRF**

该命令用于测试配置的访问授权控制策略。

## [注意事项](#ZH-CN_MMLREF_0209653106)

- 输入参数中源NF类型，源NF实例标识，源FQDN至少输入一个。
- 输入参数中目标NF类型，目标NF实例标识，目标FQDN至少输入一个。
- 主备或双活组网的场景下，如果需要配置此命令，则两个NRF上均需执行此命令，且配置参数一致。

#### [操作用户权限](#ZH-CN_MMLREF_0209653106)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0209653106)
