# 操作远端NF缓存同步（OPR NFCACHESYNC）

- [命令功能](#ZH-CN_MMLREF_0000001124956644__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001124956644__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001124956644__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001124956644__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001124956644)
...
## [注意事项](#ZH-CN_MMLREF_0000001124956644)

- 该命令执行后立即生效。

- 该命令执行结果可利用DSP NFCACHE命令核查，若执行5分钟后未查询到结果，则该目标NF的缓存同步失败。

#### [操作用户权限](#ZH-CN_MMLREF_0000001124956644)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001124956644)
...
## [使用实例](#ZH-CN_MMLREF_0000001124956644)
