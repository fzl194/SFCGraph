# 设置AMF上报NFPROFILE策略（SET AMFPROFILEPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001095375142__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001095375142__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001095375142__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001095375142__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001095375142)

**适用NF：AMF**

该命令用于设置AMF向NRF上报NFPROFILE信息的策略。

## [注意事项](#ZH-CN_MMLREF_0000001095375142)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001095375142)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001095375142)
...
## [使用实例](#ZH-CN_MMLREF_0000001095375142)
