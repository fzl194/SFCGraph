# 修改园区策略（MOD NGPARKPLCY）

- [命令功能](#ZH-CN_MMLREF_0306399921__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0306399921__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0306399921__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0306399921__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0306399921)

**适用NF：AMF**

该命令用于修改园区策略。

## [注意事项](#ZH-CN_MMLREF_0306399921)

- 该命令执行后立即生效。

- 不同园区策略中的区域编码不能重复，且不能包含重叠的跟踪区。

#### [操作用户权限](#ZH-CN_MMLREF_0306399921)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0306399921)
