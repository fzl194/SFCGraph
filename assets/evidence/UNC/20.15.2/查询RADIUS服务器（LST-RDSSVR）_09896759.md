# 查询RADIUS服务器（LST RDSSVR）

- [命令功能](#ZH-CN_CONCEPT_0209896759__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896759__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896759__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896759__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896759__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209896759__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896759)

**适用NF：PGW-C、SMF**

该命令用来查询RADIUS服务器组下的RADIUS服务器的相关信息。如果不指定可选参数，该命令将显示所有RADIUS服务器组下的RADIUS服务器配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0209896759)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896759)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896759)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209896759)
