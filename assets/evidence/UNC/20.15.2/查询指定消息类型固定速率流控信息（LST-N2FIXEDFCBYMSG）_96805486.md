# 查询指定消息类型固定速率流控信息（LST N2FIXEDFCBYMSG）

- [命令功能](#ZH-CN_MMLREF_0296805486__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0296805486__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0296805486__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0296805486__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0296805486__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0296805486)

**适用NF：AMF**

该命令用于查询指定消息类型的固定速率流控信息。

## [注意事项](#ZH-CN_MMLREF_0296805486)

无

#### [操作用户权限](#ZH-CN_MMLREF_0296805486)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0296805486)
...
## [输出结果说明](#ZH-CN_MMLREF_0296805486)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 流控消息类型 | 该参数用于设置N2接口被流控的消息类型。 |
| 固定速率流控开关 | 该参数用于控制N2接口指定消息类型固定速率流控功能。 |
| 流控速率门限(个/秒) | 该参数用于设置N2接口指定消息的接收/发送流控速率上限。该参数针对单Pod指定消息类型进行流控。 |
