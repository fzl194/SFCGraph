# 配置接口下ARP信息（SET ARPINTERFACE）

- [命令功能](#ZH-CN_CONCEPT_0000001550281002__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281002__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281002__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281002__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281002__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281002)

该命令用于配置接口下的ARP表项老化时间、探测间隔、探测次数、是否动态学习、严格学习和路由代理等功能。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281002)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281002)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281002)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281002)
