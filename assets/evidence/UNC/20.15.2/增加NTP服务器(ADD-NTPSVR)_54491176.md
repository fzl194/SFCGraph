...
- [命令功能](#ZH-CN_MMLREF_0254491176__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0254491176__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0254491176__1.3.3)
- [使用实例](#ZH-CN_MMLREF_0254491176__1.3.4)
- [输出结果说明](#ZH-CN_MMLREF_0254491176__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0254491176)
...
## [输出结果说明](#ZH-CN_MMLREF_0254491176)

命令执行异常，请联系华为技术支持处理。输出结果说明如 [表1](#ZH-CN_MMLREF_0254491176__table07211417203410) 所示。
...
| 130018 | 该NTP服务器名已经存在。 | 该服务器名已经存在。 | 请检查该服务器名是否已经存在。 |
| 130019 | 内部错误。 | 内部错误。 | 请联系华为技术支持。 |
| 130020 | NTP服务器个数已达上限。 | 服务器个数已经达到上限。 | 请检查服务器个数是否已经达到上限。 |
| 130021 | 该NTP服务器IP地址已经存在。 | 该服务器IP地址已经存在。 | 请检查服务器IP地址是否已经存在。 |
| 130028 | 该NTP的服务器密钥串不合法。 | 该服务器密钥串不符合规范。 | 请检查输入的服务器密钥是否符合规范。 |
| 130034 | 相同身份验证密钥号必须对应同一密钥串。 | 该服务器的身份验证密钥号记录已存在，且对应不同的密钥串值。 | 请检查服务器的身份验证密钥号记录是否已对应其他密钥串值。 |
| 130035 | 该NTP的服务器名称不合法。 | 该服务器名称不符合规范。 | 请检查输入的服务器名称是否符合规范。 |
