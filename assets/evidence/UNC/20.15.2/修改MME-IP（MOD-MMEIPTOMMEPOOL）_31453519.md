# 修改MME IP（MOD MMEIPTOMMEPOOL）

- [命令功能](#ZH-CN_MMLREF_0231453519__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0231453519__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0231453519__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0231453519__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0231453519)

**适用NF：SGW-C、PGW-C**

该命令用于修改MME IP的描述、是否为备份和端口号。当对端的MME信息发生变化，同步修改本端配置时需要使用此命令。此命令只能修改MME是否为备份的MME、MME的描述信息、MME的端口号。

## [注意事项](#ZH-CN_MMLREF_0231453519)

- 该命令执行后立即生效。

- DESCRIPTION字段为单空格时，表示清空DESCRIPTION。

#### [操作用户权限](#ZH-CN_MMLREF_0231453519)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0231453519)
