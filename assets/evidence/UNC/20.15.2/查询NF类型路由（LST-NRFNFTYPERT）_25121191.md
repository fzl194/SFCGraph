# 查询NF类型路由（LST NRFNFTYPERT）

- [命令功能](#ZH-CN_MMLREF_0225121191__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0225121191__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0225121191__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0225121191__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0225121191__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0225121191)

**适用NF：NRF**

该命令用于查询已配置的NF类型路由信息。

## [注意事项](#ZH-CN_MMLREF_0225121191)

无

#### [操作用户权限](#ZH-CN_MMLREF_0225121191)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0225121191)
...
## [输出结果说明](#ZH-CN_MMLREF_0225121191)

| 输出项名称 | 输出项解释 |
| --- | --- |
| NF类型 | 该参数用于表示NF类型路由寻址的NF类型。 |
| 归属NRF组名称 | 该参数用于表示当前NRF基于NFTYPE路由寻址NF时的下一跳NRF实例组名称，被寻址的NF归属于该NRF实例组。 |
