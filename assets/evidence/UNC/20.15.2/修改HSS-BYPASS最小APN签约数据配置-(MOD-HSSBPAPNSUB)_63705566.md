# 修改HSS BYPASS最小APN签约数据配置 (MOD HSSBPAPNSUB)

- [命令功能](#ZH-CN_CONCEPT_0000001263705566__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001263705566__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000001263705566__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000001263705566__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000001263705566__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000001263705566__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001263705566)

**适用网元：MME**

此命令用于修改最小APN签约数据群组对应的最小APN签约数据。

#### [注意事项](#ZH-CN_CONCEPT_0000001263705566)

- 该命令执行后立即生效。

#### [本地用户权限](#ZH-CN_CONCEPT_0000001263705566)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000001263705566)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001263705566)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001263705566)
