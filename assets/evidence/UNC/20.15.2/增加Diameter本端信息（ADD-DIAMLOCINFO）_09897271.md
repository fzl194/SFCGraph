# 增加Diameter本端信息（ADD DIAMLOCINFO）

- [命令功能](#ZH-CN_CONCEPT_0209897271__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209897271__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209897271__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209897271__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209897271__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209897271)

**适用NF：PGW-C、SMF**

该命令用来增加Diameter本端信息。

#### [注意事项](#ZH-CN_CONCEPT_0209897271)

- 该命令执行后立即生效。
- 该命令最大记录数为128。

#### [操作用户权限](#ZH-CN_CONCEPT_0209897271)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209897271)
...
```
ADD DIAMLOCINFO: HOSTNAME="test", REALMNAME="test", PRODUCTNAME="product", VENDORID=10415, ORIGINSTATEID=DISABLE, SUPPORTVENDORID=DISABLE;
```
