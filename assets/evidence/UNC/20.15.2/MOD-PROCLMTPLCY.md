# 修改流程限制策略(MOD PROCLMTPLCY)

- [命令功能](#ZH-CN_MMLREF_0000001126305440__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305440__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305440__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305440__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305440__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305440__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305440)

**适用网元：SGSN、MME**

该命令用于修改流程限制策略。为特定用户设置流程限制策略后，系统将会拒绝此类用户执行对应流程。

#### [注意事项](#ZH-CN_MMLREF_0000001126305440)

- 该命令执行后立即生效。
- 执行该命令后，设置的相关业务流程会被限制而失败，同时影响对应流程的性能指标统计。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305440)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305440)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305440)
