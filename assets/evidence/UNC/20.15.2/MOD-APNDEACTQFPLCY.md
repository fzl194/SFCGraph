# 修改基于APN去活用户面专有QoS Flow策略（MOD APNDEACTQFPLCY）

- [命令功能](#ZH-CN_MMLREF_0000001092151170__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001092151170__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001092151170__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001092151170__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001092151170)

**适用NF：SMF**

该命令用于修改基于APN去活用户面专有GBR类型QoS Flow策略。

## [注意事项](#ZH-CN_MMLREF_0000001092151170)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001092151170)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001092151170)
...
## [使用实例](#ZH-CN_MMLREF_0000001092151170)
