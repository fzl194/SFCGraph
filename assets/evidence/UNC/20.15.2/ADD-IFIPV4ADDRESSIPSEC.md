# 增加接口IPv4地址（ADD IFIPV4ADDRESSIPSEC）

- [命令功能](#ZH-CN_MMLREF_0000001180432522__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001180432522__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001180432522__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001180432522__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001180432522)

该命令用于配置接口的IP地址，包括逻辑接口及物理接口。物理接口是真实存在的接口。逻辑接口是指能够实现数据交换功能但物理上不存在、需要通过配置建立的接口。

## [注意事项](#ZH-CN_MMLREF_0000001180432522)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001180432522)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001180432522)
...
## [使用实例](#ZH-CN_MMLREF_0000001180432522)
