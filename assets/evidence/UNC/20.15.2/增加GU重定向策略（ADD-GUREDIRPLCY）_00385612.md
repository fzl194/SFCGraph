# 增加GU重定向策略（ADD GUREDIRPLCY）

- [命令功能](#ZH-CN_CONCEPT_0000002100385612__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000002100385612__1.3.2.1)
- [本地用户权限](#ZH-CN_CONCEPT_0000002100385612__1.3.3.1)
- [网管用户权限](#ZH-CN_CONCEPT_0000002100385612__1.3.4.1)
- [参数说明](#ZH-CN_CONCEPT_0000002100385612__1.3.5.1)
- [使用实例](#ZH-CN_CONCEPT_0000002100385612__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000002100385612)

**适用网元：MME**

此命令用于增加GU重定向策略。

#### [注意事项](#ZH-CN_CONCEPT_0000002100385612)

- 此命令执行后立即生效。
- 此命令最大记录数为512条。

#### [本地用户权限](#ZH-CN_CONCEPT_0000002100385612)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_CONCEPT_0000002100385612)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000002100385612)
...
#### [使用实例](#ZH-CN_CONCEPT_0000002100385612)
