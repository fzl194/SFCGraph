# 查询BSF索引和IPv4的关联关系（LST NRFBSFIPV4REL）

- [命令功能](#ZH-CN_MMLREF_0245612432__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0245612432__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0245612432__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0245612432__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0245612432__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0245612432)

**适用NF：NRF**

该命令用于查询BSF索引和IPv4的关联关系。

## [注意事项](#ZH-CN_MMLREF_0245612432)

无

#### [操作用户权限](#ZH-CN_MMLREF_0245612432)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0245612432)
...
## [输出结果说明](#ZH-CN_MMLREF_0245612432)

| 输出项名称 | 输出项解释 |
| --- | --- |
| BSF索引 | 该参数用于描述BSF路由实例信息的索引值。 |
| IP起始地址 | 该参数用于表示下一跳路由组支持的IPv4起始地址。 |
| IP结束地址 | 该参数用于表示下一跳路由组支持的IPv4结束地址。 |
