# 增加S-GW DNS域名策略（ADD SGWDNS）

- [命令功能](#ZH-CN_MMLREF_0000001172345571__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345571__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345571__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345571__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345571__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345571__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345571)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345571)

- 该命令执行后立即生效。
- 该表最大记录数为1024。

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345571)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345571)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345571)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345571)
