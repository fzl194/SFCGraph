# 增加当前UPF扩展类型绑定的IP域（ADD SUBUPIPDOMAIN）

- [命令功能](#ZH-CN_MMLREF_0000001671924421__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001671924421__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001671924421__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001671924421__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001671924421)

**适用NF：PGW-C、SMF**

该命令用于将指定UPF通过扩展类型绑定到特定的IPDomain，当该UPF作为会话主锚点UPF时，SMF内部会在UE IP前加上该IPDomain前缀，并带给PCF，用于扩展地址池。

## [注意事项](#ZH-CN_MMLREF_0000001671924421)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001671924421)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001671924421)
...
## [使用实例](#ZH-CN_MMLREF_0000001671924421)
