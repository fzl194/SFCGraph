# 修改OSPFv3路由优先级配置（MOD OSPFV3PREFERENCE）

- [命令功能](#ZH-CN_CONCEPT_0000001550280990__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280990__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280990__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280990__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280990__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280990)

该命令用于修改OSPFv3协议路由的优先级。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280990)

- 该命令执行后立即生效。
- 只有配置了OSPFv3进程后才能使用该命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280990)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280990)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280990)
