# 显示会话UDM Bypass信息（DSP SMUDMBYPASS）

- [命令功能](#ZH-CN_MMLREF_0000001230087429__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001230087429__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001230087429__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001230087429__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001230087429__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001230087429)

**适用NF：SMF**

该命令用于查询5G会话上下文UDM Bypass信息。

## [注意事项](#ZH-CN_MMLREF_0000001230087429)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001230087429)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001230087429)
...
## [使用实例](#ZH-CN_MMLREF_0000001230087429)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001230087429)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 国际移动用户标识 | 该参数用于指定用户永久标识或者国际移动用户标识。 |
| 移动台国际 ISDN 号码 | 该参数用于指定一般公共订阅标识或移动台国际 ISDN 号码。 |
| 国际移动设备标识 | 该参数用于指定永久设备标识或国际移动设备标识。 |
| PDU会话标识 | 该参数用于指定 PDU 会话 ID。 |
| 会话UDM Bypass状态 | 该参数用于显示会话的UDM Bypass状态。<br>取值说明：<br>- TRUE(TRUE)<br>- FALSE(FALSE) |
| 进入UDM Bypass状态时间 | 该参数用于显示会话进入UDM Bypass状态的时间，UDMBYPASS为False时不显示，UDMBYPASS为True时显示进入UDM Bypass状态的时间。 |
