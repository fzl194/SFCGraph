# 设置DDN定时器超时参数（SET DDNTIMEOUTCTRL）

- [命令功能](#ZH-CN_MMLREF_0246314493__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0246314493__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0246314493__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0246314493__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0246314493)

**适用NF：SGW-C**

该命令用于设置DDN消息无响应时是否进行用户延时删除处理以及延时删除用户的随机定时器时长。

## [注意事项](#ZH-CN_MMLREF_0246314493)
...
#### [操作用户权限](#ZH-CN_MMLREF_0246314493)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0246314493)
