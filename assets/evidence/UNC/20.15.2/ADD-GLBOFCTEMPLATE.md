# 增加全局离线计费模板（ADD GLBOFCTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0209896916__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896916__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896916__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896916__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896916__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896916)

**适用NF：SGW-C、PGW-C、SMF**

此命令用来配置全局离线计费配置，分GLOBAL类型和Charge Characteristic类型的全局离线模板。

#### [注意事项](#ZH-CN_CONCEPT_0209896916)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896916)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896916)
