...
- [命令功能](#ZH-CN_MMLREF_0228567655__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0228567655__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0228567655__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0228567655__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0228567655)

**适用NF：PGW-C、SMF、GGSN**

该命令用于删除别名APN配置。当运营商不希望用户使用指定APN别名的时候，需要删除配置的APN别名，该命令可以实现此功能。

## [注意事项](#ZH-CN_MMLREF_0228567655)

- 该命令执行后立即生效。

- 当别名APN下有承载时，不允许删除该别名APN。为了删除有承载的别名APN，可以先执行LCK APNALIAS锁定该别名APN，再执行DEA SMCTX去激活该别名APN下的承载，最后删除别名APN。

#### [操作用户权限](#ZH-CN_MMLREF_0228567655)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0228567655)
