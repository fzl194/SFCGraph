# 删除订阅信息（DEL REGNFSUBINFO）

- [命令功能](#ZH-CN_MMLREF_0209652587__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652587__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652587__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652587__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652587)
...
## [注意事项](#ZH-CN_MMLREF_0209652587)

- 该命令执行后立即生效。

- 主备场景下，只需在主NRF上执行；双活场景下，只需在其中一个NRF上执行即可。

#### [操作用户权限](#ZH-CN_MMLREF_0209652587)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652587)
