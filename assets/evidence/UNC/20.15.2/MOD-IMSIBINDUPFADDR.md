# 修改用户和UPF地址的绑定关系（MOD IMSIBINDUPFADDR）

- [命令功能](#ZH-CN_MMLREF_0000001399921812__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001399921812__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001399921812__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001399921812__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001399921812)

**适用NF：GGSN、SGW-C、PGW-C、SMF**

该命令用于修改用户和UPF地址的绑定关系。

## [注意事项](#ZH-CN_MMLREF_0000001399921812)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001399921812)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001399921812)
...
## [使用实例](#ZH-CN_MMLREF_0000001399921812)
