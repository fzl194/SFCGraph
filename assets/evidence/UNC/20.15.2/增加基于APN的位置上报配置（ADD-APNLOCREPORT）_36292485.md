# 增加基于APN的位置上报配置（ADD APNLOCREPORT）

- [命令功能](#ZH-CN_MMLREF_0000001436292485__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001436292485__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001436292485__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001436292485__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001436292485)
...
## [注意事项](#ZH-CN_MMLREF_0000001436292485)

- 该命令执行后只对新激活用户生效。

- 最多可输入20000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000001436292485)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001436292485)
...
## [使用实例](#ZH-CN_MMLREF_0000001436292485)
