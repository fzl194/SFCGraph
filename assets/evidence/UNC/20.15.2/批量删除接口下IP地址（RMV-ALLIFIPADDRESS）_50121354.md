# 批量删除接口下IP地址（RMV ALLIFIPADDRESS）

- [命令功能](#ZH-CN_CONCEPT_0000001550121354__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121354__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121354__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121354__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121354__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121354)

该命令用于批量删除接口下地址。

![](批量删除接口下IP地址（RMV ALLIFIPADDRESS）_50121354.assets/notice_3.0-zh-cn_2.png)

本命令属于高危命令，该操作将清除该接口下的所有IPv4或IPv6配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121354)

- 该命令执行后立即生效。
- 该操作可能会导致业务流量中断。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121354)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121354)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121354)
