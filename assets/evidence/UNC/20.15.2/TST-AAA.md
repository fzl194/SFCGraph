...
- [命令功能](#ZH-CN_CONCEPT_0209896762__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896762__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896762__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896762__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896762__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0209896762__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896762)

**适用NF：PGW-C、SMF**

该命令用于向AAA服务器发送探测消息，根据回显来推断UNC和AAA服务器之间的连接是否正常。

#### [注意事项](#ZH-CN_CONCEPT_0209896762)

- 该命令执行后立即生效。
- 在执行该命令前需要先使用ADD RDSSVR命令配置要探测的鉴权服务器或者计费服务器，否则探测命令会执行失败。
- 该命令执行的过程中不能执行其他命令，等待该命令执行完成后才能执行其他命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0209896762)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896762)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0209896762)
