# 设置激活抑制参数（SET SMARTACTPARA）

- [命令功能](#ZH-CN_MMLREF_0000001126305550__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305550__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305550__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305550__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305550__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305550__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305550)

**适用网元：SGSN**

此命令用于设置异常激活抑制参数，包括设置识别异常激活行为的门限，抑制唤醒定时器，假激活的Packing APNNI，分离异常用户的门限。

#### [注意事项](#ZH-CN_MMLREF_0000001126305550)

- 系统初次运行时，会执行系统初始设置值。
- 此命令执行后立即生效。
- "WSFD-206006Smartphone异常信令节省"需要加载支持该特性的License，对应的License项为“Smartphone异常信令节省”。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305550)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305550)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305550)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305550)
