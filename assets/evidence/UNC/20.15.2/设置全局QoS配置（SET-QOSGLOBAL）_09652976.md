# 设置全局QoS配置（SET QOSGLOBAL）

- [命令功能](#ZH-CN_MMLREF_0209652976__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652976__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652976__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652976__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652976)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用来设置全局的QoS信息，当不需要基于APN粒度设置QoS信息时，所有APN都关联到该QoS信息。

## [注意事项](#ZH-CN_MMLREF_0209652976)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209652976)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652976)
