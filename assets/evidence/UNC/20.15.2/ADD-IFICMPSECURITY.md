# 新增接口下ICMP安全配置（ADD IFICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001600441149__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441149__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441149__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441149__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441149__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441149)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001600441149)

- 该命令执行后立即生效。
- 该命令最大记录数为65535。
- 接口下ICMP安全配置的优先级要高于系统的ICMP安全配置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441149)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441149)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441149)
