# 增加AMF的N2接口信息（ADD N2INFAMFINFO）

- [命令功能](#ZH-CN_MMLREF_0209651796__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651796__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651796__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651796__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651796)

**适用NF：AMF**

该命令用于添加AMF的N2接口信息。当前NF类型为AMF时，需要配置N2接口信息。

## [注意事项](#ZH-CN_MMLREF_0209651796)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209651796)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651796)
