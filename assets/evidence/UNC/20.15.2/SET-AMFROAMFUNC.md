# 设置AMF漫游功能管理参数（SET AMFROAMFUNC）

- [命令功能](#ZH-CN_MMLREF_0000001269587620__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001269587620__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001269587620__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001269587620__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001269587620)

**适用NF：AMF**

此命令用于设置AMF漫游功能管理参数。

## [注意事项](#ZH-CN_MMLREF_0000001269587620)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001269587620)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001269587620)
...
## [使用实例](#ZH-CN_MMLREF_0000001269587620)
