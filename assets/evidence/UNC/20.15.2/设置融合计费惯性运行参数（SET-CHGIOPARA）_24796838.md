# 设置融合计费惯性运行参数（SET CHGIOPARA）

- [命令功能](#ZH-CN_MMLREF_0000001124796838__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001124796838__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001124796838__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001124796838__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001124796838)

**适用NF：PGW-C、SMF**

该命令用于控制融合计费惯性运行参数。

## [注意事项](#ZH-CN_MMLREF_0000001124796838)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001124796838)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001124796838)
...
## [使用实例](#ZH-CN_MMLREF_0000001124796838)
