# 修改GTP-C T3N3参数（MOD GTPCT3N3）

- [命令功能](#ZH-CN_MMLREF_0209651568__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209651568__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209651568__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209651568__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209651568)

**适用NF：SGW-C、PGW-C、AMF、GGSN**

该命令用于修改GTP-C T3N3参数配置。

## [注意事项](#ZH-CN_MMLREF_0209651568)

- 该命令执行后立即生效。

- 当SET AMFN26PLCY命令中N26ITFMODE取值为“COMBINE”时，当前命令无效，请使用命令SET T3N3配置。

#### [操作用户权限](#ZH-CN_MMLREF_0209651568)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209651568)
