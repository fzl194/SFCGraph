# 增加服务发现Scheme优选策略（ADD NFDISCSCHEMEPLY）

- [命令功能](#ZH-CN_MMLREF_0000001357337225__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001357337225__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001357337225__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001357337225__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001357337225)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于增加服务发现时的Scheme优选策略。当服务发现对端NF后，配置的Scheme优选策略用于选择同一NF相同服务名称的不同NF Service，无法用于选择不同的NF。

## [注意事项](#ZH-CN_MMLREF_0000001357337225)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001357337225)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001357337225)
...
## [使用实例](#ZH-CN_MMLREF_0000001357337225)
