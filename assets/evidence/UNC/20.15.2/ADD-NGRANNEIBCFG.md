# 增加NG-RAN基站邻接关系配置（ADD NGRANNEIBCFG）

- [命令功能](#ZH-CN_MMLREF_0209654363__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209654363__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209654363__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209654363__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209654363)

**适用NF：AMF**

此命令用于手动添加NG-RAN基站的邻接关系。当激活“精准寻呼”特性时，整网所有NG-RAN基站邻接关系的学习是一个漫长的过程，往往需要一周以上的时间，通过此命令可以避免等待系统自动学习邻接关系的大量时间消耗和切换流程的触发。

## [注意事项](#ZH-CN_MMLREF_0209654363)
...
#### [操作用户权限](#ZH-CN_MMLREF_0209654363)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209654363)
