# 显示GTP-C路径(DSP GTPCPATH)

- [命令功能](#ZH-CN_MMLREF_0000001172225591__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172225591__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172225591__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172225591__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172225591__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172225591__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172225591__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172225591)

**适用网元：SGSN、MME**

该命令用于查询GTP-C路径状态，如果输入路径在系统中已经存在则输出这条路径的状态。

#### [注意事项](#ZH-CN_MMLREF_0000001172225591)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172225591)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172225591)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172225591)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172225591)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172225591)

| 输出项名称 | 输出项解释 |
| --- | --- |
| RU名称 | 资源单元名称。 |
| 进程类型 | GTP-C路径所在进程的类型。<br>取值说明：<br>- “SPP”<br>- “UPP” |
| 进程号 | GTP-C路径所在进程的序号。 |
| GTP路径数目 | 按照输入条件查询出来的GTP-C路径数量。 |
| GTP版本 | 描述本路径的GTP版本，目前是未知、GTPv0、GTPv1或GTPv2。<br>取值说明：<br>- “未知”<br>- “GTPv0”<br>- “GTPv1”<br>- “GTPv2” |
| 本端IP地址 | 无。 |
| 对端IP地址 | 无。 |
| GTP路径接口类型 | 描述GTP-C路径所处的网络类型。<br>取值说明：<br>- 2G或3G网络<br>- 4G网络 |
| PLMN网元间的接口 | 与对端网元间的接口类型。<br>取值说明：<br>- “未配置接口”<br>- “Gn接口”<br>- “Gp接口”<br>- “S3接口”<br>- “S4接口”<br>- “S10接口”<br>- “S11接口”<br>- “S16接口”<br>- “Sv接口” |
| GTP路径状态 | 描述该路径的状态。<br>取值说明：<br>- “正常”<br>- “故障”<br>- “探测” |
| GTP路径属性 | 描述该路径的属性。<br>取值说明：<br>- “空”<br>- “隧道管理”<br>- “移动性管理”<br>- “位置管理”<br>- “GTPC测试”<br>- “路径管理” |
| 对端Recovery值 | 描述该路径对应的对端网元的Recovery值。 |
| 是否发送Echo Request | 描述该GTP-C路径是否发送Echo Request，<br>“是”<br>表示该GTP-C路径发送Echo Request，<br>“否”<br>表示该GTP-C路径不发送Echo Request。<br>取值说明：<br>- “是”<br>- “否” |
