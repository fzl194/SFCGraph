# 设置漫游用户在归属地的计费方式和漫游参数的协商方式（SET HSMFCHGCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001180169070__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001180169070__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001180169070__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001180169070__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001180169070)

**适用NF：SMF、PGW-C、GGSN**

该命令用于控制漫游用户在归属地的计费方式和Roaming Charging Profile的协商方式。

## [注意事项](#ZH-CN_MMLREF_0000001180169070)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001180169070)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001180169070)
...
## [使用实例](#ZH-CN_MMLREF_0000001180169070)
