# 修改SMSC转换配置记录(MOD SMSCCONVERT)

- [命令功能](#ZH-CN_MMLREF_0000001172345325__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345325__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345325__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345325__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345325__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345325__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345325)

**适用网元：SGSN**

此命令用于修改一条SMSC转换记录。用于短消息通信中纠正短消息中心的功能。

#### [注意事项](#ZH-CN_MMLREF_0000001172345325)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345325)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345325)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345325)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345325)
