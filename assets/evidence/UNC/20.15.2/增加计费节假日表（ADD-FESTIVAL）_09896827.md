# 增加计费节假日表（ADD FESTIVAL）

- [命令功能](#ZH-CN_CONCEPT_0209896827__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896827__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896827__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896827__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896827__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896827)

**适用NF：SGW-C、PGW-C、SMF**

该命令用于根据计费属性配置节假日信息，即配置指定日期的费率类型为节假日。

#### [注意事项](#ZH-CN_CONCEPT_0209896827)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896827)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896827)
