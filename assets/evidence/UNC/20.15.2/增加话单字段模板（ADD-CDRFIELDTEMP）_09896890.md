# 增加话单字段模板（ADD CDRFIELDTEMP）

- [命令功能](#ZH-CN_CONCEPT_0209896890__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896890__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896890__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896890__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896890__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896890)

**适用NF：SGW-C、PGW-C、SMF**

该命令用来新增话单字段模板的配置，用于控制话单中是否携带对应字段。

#### [注意事项](#ZH-CN_CONCEPT_0209896890)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896890)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896890)
