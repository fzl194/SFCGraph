# 删除Pre-R8 QoS到TOS/DSCP的映射规则（RMV PRER8REMARK）

- [命令功能](#ZH-CN_MMLREF_0209652655__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0209652655__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0209652655__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0209652655__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0209652655)

**适用NF：GGSN**

该命令用于删除QoS参数映射到IP报文头中的TOS（服务类型）或者DSCP（区别服务编码点）的映射配置。

## [注意事项](#ZH-CN_MMLREF_0209652655)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_MMLREF_0209652655)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0209652655)
