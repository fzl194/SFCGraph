# 查询用于性能统计的5G LAN群组（LST PERFNGLANGRP）

- [命令功能](#ZH-CN_MMLREF_0000001179256716__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001179256716__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001179256716__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001179256716__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001179256716__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001179256716)

**适用NF：SMF**

该命令用于查询可用于性能统计的5G LAN群组。

## [注意事项](#ZH-CN_MMLREF_0000001179256716)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001179256716)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001179256716)
...
## [使用实例](#ZH-CN_MMLREF_0000001179256716)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001179256716)
