# 显示GTP-C路径个数(DSP GTPCPATHNUM)

- [命令功能](#ZH-CN_MMLREF_0000001126305720__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305720__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305720__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305720__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305720__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305720__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001126305720__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305720)

**适用网元：SGSN、MME**

该命令用于查询指定节点的GTP-C路径数目。

#### [注意事项](#ZH-CN_MMLREF_0000001126305720)

- 该命令执行后立即生效。
- 该命令可用于SPP进程/UPP进程。
- 当“进程类型”未输入时，默认查询UPP进程上的路径数目信息。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305720)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305720)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305720)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305720)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001126305720)
