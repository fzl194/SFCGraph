# 增加HTTP流控消息类型（ADD HTTPFCMSG）

- [命令功能](#ZH-CN_MMLREF_0000001301544142__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001301544142__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001301544142__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001301544142__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001301544142)

![](增加HTTP流控消息类型（ADD HTTPFCMSG）_01544142.assets/notice_3.0-zh-cn_2.png)

新增流控消息需谨慎，建议只针对业务流程首消息开启流控，避免影响E2E业务成功率。

该命令用于增加HTTP流控消息类型。

## [注意事项](#ZH-CN_MMLREF_0000001301544142)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001301544142)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001301544142)
...
## [使用实例](#ZH-CN_MMLREF_0000001301544142)
