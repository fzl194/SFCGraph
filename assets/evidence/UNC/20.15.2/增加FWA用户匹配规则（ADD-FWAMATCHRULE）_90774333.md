# 增加FWA用户匹配规则（ADD FWAMATCHRULE）

- [命令功能](#ZH-CN_MMLREF_0000002090774333__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002090774333__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002090774333__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002090774333__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002090774333)

该命令用于增加FWA用户匹配规则。SMF根据匹配方式和匹配类型判断当前用户是否是FWA用户。

## [注意事项](#ZH-CN_MMLREF_0000002090774333)

- 该命令执行后立即生效。

- 最多可输入1000条记录。

#### [操作用户权限](#ZH-CN_MMLREF_0000002090774333)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002090774333)
...
## [使用实例](#ZH-CN_MMLREF_0000002090774333)
