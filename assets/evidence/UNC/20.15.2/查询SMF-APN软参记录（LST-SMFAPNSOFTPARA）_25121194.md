# 查询SMF APN软参记录（LST SMFAPNSOFTPARA）

- [命令功能](#ZH-CN_MMLREF_0225121194__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0225121194__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0225121194__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0225121194__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0225121194__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0225121194)

**适用NF：SMF**

该命令用于查询APN下软件参数信息。

## [注意事项](#ZH-CN_MMLREF_0225121194)

无

#### [操作用户权限](#ZH-CN_MMLREF_0225121194)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0225121194)
...
## [输出结果说明](#ZH-CN_MMLREF_0225121194)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 软参记录数据类型 | 该参数用于指定APN下软件参数的数据类型。 |
| 软参记录索引 | 该参数表示软件参数的索引。 |
| 软参记录值 | 该参数表示软件参数的值。 |
