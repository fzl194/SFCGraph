# 增加TAI组性能统计对象成员（ADD PERFTAIGROUPMEM）

- [命令功能](#ZH-CN_MMLREF_0000001517625954__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001517625954__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001517625954__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001517625954__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001517625954)

**适用NF：SGW-C、PGW-C、SMF**

该命令用于为基于TAI组的性能统计对象增加TAI成员。

## [注意事项](#ZH-CN_MMLREF_0000001517625954)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001517625954)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001517625954)
...
## [使用实例](#ZH-CN_MMLREF_0000001517625954)
