# 激活 基于APN的eMTC终端接入速率控制

- [操作场景](#ZH-CN_OPI_0277396887__1.3.1)
- [必备事项](#ZH-CN_OPI_0277396887__1.3.2)
- [操作步骤](#ZH-CN_OPI_0277396887__1.3.3)
- [任务示例](#ZH-CN_OPI_0277396887__1.3.4)

## [操作场景](#ZH-CN_OPI_0277396887)

在 UNC 上激活 基于APN的eMTC终端接入速率控制 ，用于控制该UE的某PDN连接单位时间内上行和下行数据包的数目。

> **说明**
> 适用于PGW-C。

## [必备事项](#ZH-CN_OPI_0277396887)
