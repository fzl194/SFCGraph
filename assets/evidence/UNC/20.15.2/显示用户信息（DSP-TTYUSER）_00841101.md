...
- [命令功能](#ZH-CN_CONCEPT_0000001600841101__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841101__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841101__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841101__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841101__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600841101__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841101)

该命令用于显示用户信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841101)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841101)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841101)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841101)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600841101)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 激活状态 | 表示用户界面当前的激活状态：未激活状态、激活状态、激活并工作在异步模式。 |
| 接口编号 | 用于表示用户界面的接口编号。接口编号0到1为Console使用，接口编号34到54为VTY使用，接口编号100到119为SNetconf使用，接口编号200到229为MML使用。 |
| 接口类型 | 用于表示接口类型。 |
| 速率 | 用于表示速率。 |
| MODEM类型 | 用于表示MODEM类型。 |
| 认证模式 | 表示认证模式： Password：密码认证 AAA：AAA认证 NONE：无认证。 |
| 物理编号 | 用于表示物理编号。 |
| 当前使用 | 表示用户界面当前是否在使用： Yes:在使用 No:未使用。 |
| 空闲时间 | 用于表示空闲时间。 |
| 连接类型 | 用于表示服务类型。 |
| 网络地址 | 用于表示网络地址。 |
| 认证状态 | 用于表示认证状态。 |
