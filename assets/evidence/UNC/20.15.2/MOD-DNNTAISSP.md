# 修改DNN的TAI和ServingScope映射（MOD DNNTAISSP）

- [命令功能](#ZH-CN_MMLREF_0000001546201086__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001546201086__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001546201086__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001546201086__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001546201086)

**适用NF：AMF**

该命令用于修改DNN的TAI和ServingScope映射。

## [注意事项](#ZH-CN_MMLREF_0000001546201086)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001546201086)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001546201086)
...
## [使用实例](#ZH-CN_MMLREF_0000001546201086)
