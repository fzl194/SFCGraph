# 增加匹配IPv6路由源前缀列表（ADD MATCHRTSRCPREFIX6FILTER）

- [命令功能](#ZH-CN_CONCEPT_0000001600865841__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600865841__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600865841__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600865841__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600865841__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600865841)

该命令用来增加基于发布路由的源地址IPv6信息的匹配规则。

#### [注意事项](#ZH-CN_CONCEPT_0000001600865841)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600865841)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600865841)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600865841)
