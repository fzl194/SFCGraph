# 查询N2接口的DTLS参数(LST N2DTLSPARA)

- [命令功能](#ZH-CN_CONCEPT_0254302475__1.4.1.1)
- [注意事项](#ZH-CN_CONCEPT_0254302475__1.4.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0254302475__1.4.3.1)
- [参数说明](#ZH-CN_CONCEPT_0254302475__1.4.4.1)
- [使用实例](#ZH-CN_CONCEPT_0254302475__1.4.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0254302475__1.4.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0254302475)

**适用NF：AMF**

开启N2接口的DTLS连接时，需要配置详细的DTLS上下文参数，该命令用于查询N2接口DTLS连接参数。

#### [注意事项](#ZH-CN_CONCEPT_0254302475)

无

#### [操作用户权限](#ZH-CN_CONCEPT_0254302475)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0254302475)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0254302475)

参见 [SET N2DTLSPARA](设置N2接口的DTLS参数(SET N2DTLSPARA)_54302474.md) 的参数说明。
