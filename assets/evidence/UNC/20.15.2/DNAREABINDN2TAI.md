# 查询DNAI服务区名称绑定的5G TAI范围（LST DNAREABINDN2TAI）

- [命令功能](#ZH-CN_MMLREF_0000001171436537__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001171436537__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001171436537__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001171436537__1.3.5)
- [输出结果说明](#ZH-CN_MMLREF_0000001171436537__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001171436537)

**适用NF：SGW-C、SMF、GGSN、PGW-C**

该命令用于查询DNAI服务区名称绑定的5G TAI范围。

## [注意事项](#ZH-CN_MMLREF_0000001171436537)

无

#### [操作用户权限](#ZH-CN_MMLREF_0000001171436537)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001171436537)
...
## [使用实例](#ZH-CN_MMLREF_0000001171436537)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001171436537)

| 输出项名称 | 输出项解释 |
| --- | --- |
| DNAI服务区域名称 | 该参数用于标识DNAI服务区域名称。 |
| DNAI服务区名称支持5G TAI范围的起始值 | 该参数用于标识DNAI服务区名称支持5G TAI范围的起始值，TAI = MCC+ MNC + TAC。 |
| DNAI服务区名称支持5G TAI范围的结束值 | 该参数用于标识DNAI服务区名称支持5G TAI范围的结束值，TAI = MCC+ MNC + TAC。 |
