# 修改PCF选择策略（MOD PCFSELPLCY）

- [命令功能](#ZH-CN_MMLREF_0244007430__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0244007430__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0244007430__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0244007430__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0244007430)

**适用NF：AMF**

该命令用于对指定的用户群修改PCF的选择策略。

## [注意事项](#ZH-CN_MMLREF_0244007430)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0244007430)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0244007430)
