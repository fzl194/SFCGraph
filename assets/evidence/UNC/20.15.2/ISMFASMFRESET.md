# 设置I-SMF对A-SMF的故障恢复策略（SET ISMFASMFRESET）

- [命令功能](#ZH-CN_MMLREF_0000001870382397__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001870382397__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001870382397__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001870382397__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001870382397)

**适用NF：SMF**

该命令用于设置I-SMF的A-SMF故障恢复功能。

## [注意事项](#ZH-CN_MMLREF_0000001870382397)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001870382397)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001870382397)
...
## [使用实例](#ZH-CN_MMLREF_0000001870382397)
