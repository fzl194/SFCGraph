# 增加本局NRI配置信息(ADD LOCALNRI)

- [命令功能](#ZH-CN_MMLREF_0000001172345699__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345699__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345699__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345699__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345699__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345699__1.3.6.1)
- [参考信息](#ZH-CN_MMLREF_0000001172345699__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345699)
...
#### [注意事项](#ZH-CN_MMLREF_0000001172345699)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001172345699)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345699)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345699)
...
> **说明**
> 当 [**SET SYS**](../../../系统管理/系统参数管理/设置系统参数(SET SYS)_72345947.md) 的参数 “NRICLFLAG” 设置为 “ON” 时，系统所支持的最大容量指的是系统所支持的2G、3G、4G最大用户数；当 [**SET SYS**](../../../系统管理/系统参数管理/设置系统参数(SET SYS)_72345947.md) 的参数 “NRICLFLAG” 设置为 “OFF” 时，系统所支持的最大容量指的是系统所支持的2G、3G最大用户数。
