# 设置用户面PDP规格表(SET USRPDPCAP)

- [命令功能](#ZH-CN_MMLREF_0000001126305662__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305662__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305662__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305662__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305662__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305662__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305662)
...
#### [注意事项](#ZH-CN_MMLREF_0000001126305662)

- 系统初次运行时，会执行系统初始设置值。
- 该命令执行后立即生效。
- 本命令参数设置不当可能造成PDP无法激活，请谨慎修改。建议使用系统初始值。

#### [本地用户权限](#ZH-CN_MMLREF_0000001126305662)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305662)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305662)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305662)
