# 修改SEPP绑定组关系（MOD SEPPBINDGRP）

- [命令功能](#ZH-CN_MMLREF_0000001581080357__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001581080357__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001581080357__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001581080357__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001581080357)

**适用NF：AMF、SMF**

该命令用于修改SEPP绑定组关系。

## [注意事项](#ZH-CN_MMLREF_0000001581080357)

- 该命令执行后立即生效。

- 同一个组号最多绑定32个SEPP。

#### [操作用户权限](#ZH-CN_MMLREF_0000001581080357)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001581080357)
...
## [使用实例](#ZH-CN_MMLREF_0000001581080357)
