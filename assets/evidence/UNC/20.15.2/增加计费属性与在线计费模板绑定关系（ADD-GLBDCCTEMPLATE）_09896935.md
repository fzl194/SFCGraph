# 增加计费属性与在线计费模板绑定关系（ADD GLBDCCTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0209896935__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0209896935__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0209896935__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0209896935__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0209896935__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0209896935)

**适用NF：PGW-C、SMF**

该命令用于增加计费属性与在线计费模板的配置绑定关系。在线计费用户激活时会根据计费属性与在线计费模板绑定关系选择在线计费模板。

#### [注意事项](#ZH-CN_CONCEPT_0209896935)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0209896935)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0209896935)
