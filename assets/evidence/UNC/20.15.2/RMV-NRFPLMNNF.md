# 删除关口局NF信息（RMV NRFPLMNNF）

- [命令功能](#ZH-CN_MMLREF_0000001180010524__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001180010524__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001180010524__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001180010524__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001180010524)

**适用NF：NRF**

该命令用于删除本NRF管理的关口局NF。

## [注意事项](#ZH-CN_MMLREF_0000001180010524)

- 该命令执行后立即生效。

- 当删除关口局NF配置时，漫游场景下该NF将不能被发现。

#### [操作用户权限](#ZH-CN_MMLREF_0000001180010524)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001180010524)
...
## [使用实例](#ZH-CN_MMLREF_0000001180010524)

使用如下命令删除NF类型为NRF，NF实例标识为123e4567-e89b-12d3-a456-426655440000的关口局信息。

```
RMV NRFPLMNNF: NFTYPE=SMF, NFINSTANCEID="123e4567-e89b-12d3-a456-426655440000";
```
