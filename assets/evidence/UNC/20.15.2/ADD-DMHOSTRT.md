# 增加Diameter主机路由(ADD DMHOSTRT)

- [命令功能](#ZH-CN_MMLREF_0000001126146272__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126146272__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126146272__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126146272__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126146272__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126146272__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126146272)

**适用网元：SGSN、MME**

该命令用于新增一条Diameter主机路由。主机路由是指通过请求消息中的destination-host信元来选择对端。

#### [注意事项](#ZH-CN_MMLREF_0000001126146272)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126146272)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126146272)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126146272)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126146272)
