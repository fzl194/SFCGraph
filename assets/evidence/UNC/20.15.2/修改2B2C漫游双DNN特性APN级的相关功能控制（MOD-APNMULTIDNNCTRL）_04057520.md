# 修改2B2C漫游双DNN特性APN级的相关功能控制（MOD APNMULTIDNNCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001304057520__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001304057520__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001304057520__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001304057520__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001304057520)

**适用NF：PGW-C、SMF**

该命令用于修改2B2C漫游双DNN特性APN级的相关功能控制。

## [注意事项](#ZH-CN_MMLREF_0000001304057520)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001304057520)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001304057520)
...
## [使用实例](#ZH-CN_MMLREF_0000001304057520)
