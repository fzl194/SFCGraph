# 设置GTPU参数（SET CPGTPUPARA）

- [命令功能](#ZH-CN_MMLREF_0000001213800472__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001213800472__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001213800472__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001213800472__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001213800472)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于设置协议定义的GTPU相关功能参数。

## [注意事项](#ZH-CN_MMLREF_0000001213800472)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001213800472)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001213800472)
...
## [使用实例](#ZH-CN_MMLREF_0000001213800472)
