# 删除授权控制对象（RMV ALLOWEDOBJNAME）

- [命令功能](#ZH-CN_MMLREF_0000001140906679__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001140906679__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001140906679__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001140906679__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001140906679)

**适用NF：NRF**

该命令用于删除授权控制对象。当运营商不希望在NRF上配置特定NF对象的访问授权控制时使用。

## [注意事项](#ZH-CN_MMLREF_0000001140906679)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001140906679)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001140906679)
...
## [使用实例](#ZH-CN_MMLREF_0000001140906679)
