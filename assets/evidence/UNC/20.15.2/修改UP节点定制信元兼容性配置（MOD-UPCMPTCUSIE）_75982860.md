# 修改UP节点定制信元兼容性配置（MOD UPCMPTCUSIE）

- [命令功能](#ZH-CN_MMLREF_0000001875982860__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001875982860__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001875982860__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001875982860__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001875982860)

**适用NF：SMF、SGW-C、PGW-C、GGSN**

该命令用于修改UP节点定制信元兼容性配置。

## [注意事项](#ZH-CN_MMLREF_0000001875982860)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001875982860)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001875982860)
...
## [使用实例](#ZH-CN_MMLREF_0000001875982860)
