# 修改对端NWDAF信息（MOD PNFNWDAFEVENT）

- [命令功能](#ZH-CN_MMLREF_0000002056105694__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000002056105694__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000002056105694__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000002056105694__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000002056105694)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于修改本地配置的对端NWDAF的信息。

## [注意事项](#ZH-CN_MMLREF_0000002056105694)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000002056105694)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000002056105694)
...
## [使用实例](#ZH-CN_MMLREF_0000002056105694)
