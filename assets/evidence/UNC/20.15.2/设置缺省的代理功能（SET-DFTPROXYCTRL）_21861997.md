# 设置缺省的代理功能（SET DFTPROXYCTRL）

- [命令功能](#ZH-CN_MMLREF_0000001921861997__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001921861997__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001921861997__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001921861997__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001921861997)

**适用NF：SGW-C、PGW-C、SMF**

该命令用于配置缺省的代理功能。

## [注意事项](#ZH-CN_MMLREF_0000001921861997)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001921861997)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001921861997)
...
## [使用实例](#ZH-CN_MMLREF_0000001921861997)
