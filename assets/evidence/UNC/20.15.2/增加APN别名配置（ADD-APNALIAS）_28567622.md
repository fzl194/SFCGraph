# 增加APN别名配置（ADD APNALIAS）

- [命令功能](#ZH-CN_MMLREF_0228567622__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0228567622__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0228567622__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0228567622__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0228567622)

**适用NF：PGW-C、SMF、GGSN**

该命令用于增加别名APN配置。为了兼容多个APN使用完全相同资源的情况，使用该命令配置APN的转换关系，在用户激活时，将用户请求的APN（称为别名APN）转换为新的APN（称为转换APN）。

## [注意事项](#ZH-CN_MMLREF_0228567622)
...
#### [操作用户权限](#ZH-CN_MMLREF_0228567622)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0228567622)
