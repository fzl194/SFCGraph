# 增加LCS扩展参数(ADD LCSPARAEX)

- [命令功能](#ZH-CN_MMLREF_0000001126305624__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001126305624__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001126305624__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001126305624__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001126305624__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001126305624__1.3.6.1)

#### [命令功能](#ZH-CN_MMLREF_0000001126305624)

**适用网元：MME**

该命令用于基于运营商设置LCS扩展参数。包括VoLTE紧急呼叫触发的NI-LR流程的一些参数。

#### [注意事项](#ZH-CN_MMLREF_0000001126305624)
...
#### [本地用户权限](#ZH-CN_MMLREF_0000001126305624)

manage-ug；system-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001126305624)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001126305624)
...
#### [使用实例](#ZH-CN_MMLREF_0000001126305624)
