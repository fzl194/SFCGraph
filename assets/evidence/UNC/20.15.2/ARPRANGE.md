# 查询ARP策略范围配置(LST ARPRANGE)

- [命令功能](#ZH-CN_MMLREF_0000001172345269__1.3.1.1)
- [注意事项](#ZH-CN_MMLREF_0000001172345269__1.3.2.1)
- [本地用户权限](#ZH-CN_MMLREF_0000001172345269__1.3.3.1)
- [网管用户权限](#ZH-CN_MMLREF_0000001172345269__1.3.4.1)
- [参数说明](#ZH-CN_MMLREF_0000001172345269__1.3.5.1)
- [使用实例](#ZH-CN_MMLREF_0000001172345269__1.3.6.1)
- [输出结果说明](#ZH-CN_MMLREF_0000001172345269__1.3.7.1)

#### [命令功能](#ZH-CN_MMLREF_0000001172345269)

**适用网元：SGSN**

该命令用于查询ARP策略范围配置。

#### [注意事项](#ZH-CN_MMLREF_0000001172345269)

- 无

#### [本地用户权限](#ZH-CN_MMLREF_0000001172345269)

manage-ug；system-ug；monitor-ug

#### [网管用户权限](#ZH-CN_MMLREF_0000001172345269)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_MMLREF_0000001172345269)
...
#### [使用实例](#ZH-CN_MMLREF_0000001172345269)
...
#### [输出结果说明](#ZH-CN_MMLREF_0000001172345269)

参见 [**ADD ARPRANGE**](增加ARP策略范围配置(ADD ARPRANGE)_26145672.md) 的参数说明。
