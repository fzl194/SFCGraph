# 删除服务发现Scheme优选策略（RMV NFDISCSCHEMEPLY）

- [命令功能](#ZH-CN_MMLREF_0000001357337233__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001357337233__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001357337233__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001357337233__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001357337233)

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于删除服务发现时的Scheme优选策略。

## [注意事项](#ZH-CN_MMLREF_0000001357337233)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_MMLREF_0000001357337233)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001357337233)
...
## [使用实例](#ZH-CN_MMLREF_0000001357337233)

- 删除NF类型为UDM，服务名称为NudmSdm的Scheme优选策略记录。
  ```
  %%RMV NFDISCSCHEMEPLY: INFOTYPE=BYNFTYPE, NFTYPE=NfUDM, SERVICENAME=NudmSdm;%%
  RETCODE = 0  操作成功

  ---    END
  ```
- 删除NF实例标识为smf_Instance_0，服务名称为NsmfPduSes的Scheme优选策略记录。
  ```
  %%RMV NFDISCSCHEMEPLY: INFOTYPE=BYNFID, NFINSTANCEID="smf_instance_0", SERVICENAME=NsmfPduSes;%%
  RETCODE = 0  操作成功
