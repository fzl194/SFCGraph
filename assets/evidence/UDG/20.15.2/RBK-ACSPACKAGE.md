# 回退升级操作（RBK ACSPACKAGE）

- [命令功能](#ZH-CN_CONCEPT_0205338965__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0205338965__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0205338965__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0205338965__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0205338965__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0205338965)

![](回退升级操作（RBK ACSPACKAGE）_05338965.assets/notice_3.0-zh-cn.png)
...
#### [注意事项](#ZH-CN_CONCEPT_0205338965)

- 该命令执行后立即生效。
- 系统只有升级过，才能执行该命令。
- 可以通过**DSP ACSRBKVER**，查询可回退版本。

#### [操作用户权限](#ZH-CN_CONCEPT_0205338965)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0205338965)
