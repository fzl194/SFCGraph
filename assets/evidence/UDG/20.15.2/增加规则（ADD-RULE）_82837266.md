...
- [命令功能](#ZH-CN_CONCEPT_0182837266__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837266__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837266__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837266__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837266__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837266)

**适用NF：PGW-U、UPF**

该命令用于在配置业务策略的时候增加规则，其中包含策略类型、流过滤器、流过滤器组、策略信息、生效时间段以及优先级等。通过运营商的报文匹配流过滤器获取相应规则的策略信息。

#### [注意事项](#ZH-CN_CONCEPT_0182837266)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837266)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837266)
