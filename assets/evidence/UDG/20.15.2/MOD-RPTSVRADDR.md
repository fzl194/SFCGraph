# 修改报表服务器接入点配置（MOD RPTSVRADDR）

- [命令功能](#ZH-CN_CONCEPT_0000201293531889__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201293531889__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201293531889__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201293531889__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201293531889__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201293531889)

**适用NF：PGW-U、UPF**

该命令修改报表服务器接入点。在配置好报表服务器后，修改接入点时执行该命令。

#### [注意事项](#ZH-CN_CONCEPT_0000201293531889)

- 该命令执行后立即生效。
- 一个报表服务器最多配置10个接入点。
- 当报表消息类型为EXP时，无需本端规划报表服务器地址。

#### [操作用户权限](#ZH-CN_CONCEPT_0000201293531889)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201293531889)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201293531889)
