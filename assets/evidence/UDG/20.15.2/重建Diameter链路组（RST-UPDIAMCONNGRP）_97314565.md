# 重建Diameter链路组（RST UPDIAMCONNGRP）

- [命令功能](#ZH-CN_CONCEPT_0000206297314565__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206297314565__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206297314565__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206297314565__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206297314565__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206297314565)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206297314565)

- 该命令执行后立即生效。
- 本命令属于高危命令，操作不当，会影响用户业务使用，请谨慎使用并联系华为技术支持协助操作。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206297314565)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206297314565)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206297314565)
