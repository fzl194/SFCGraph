...
- [命令功能](#ZH-CN_CONCEPT_0182837529__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837529__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837529__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837529__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837529__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837529)

**适用NF：PGW-U、UPF**

此命令用于运营商修改已经配置的URL重定向策略，可以修改重定向携带信息的名称。

#### [注意事项](#ZH-CN_CONCEPT_0182837529)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837529)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837529)
