# 查询IGMP静态组配置（LST MGMDSTATICGROUP）

- [命令功能](#ZH-CN_CONCEPT_0000001549961718__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961718__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961718__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961718__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961718__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001549961718__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961718)

该命令用来查询IGMP静态组配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961718)

该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961718)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961718)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961718)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001549961718)

参见ADD MGMDSTATICGROUP的参数说明。
