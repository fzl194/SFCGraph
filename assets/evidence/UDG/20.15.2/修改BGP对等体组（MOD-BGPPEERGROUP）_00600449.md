# 修改BGP对等体组（MOD BGPPEERGROUP）

- [命令功能](#ZH-CN_CONCEPT_0000001600600449__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600600449__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600600449__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600600449__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600600449__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600600449)

该命令用于设置及更新IPv4或IPv6地址族下的对等体组的参数。

#### [注意事项](#ZH-CN_CONCEPT_0000001600600449)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600600449)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600600449)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600600449)
