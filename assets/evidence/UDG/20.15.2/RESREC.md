...
- [命令功能](#ZH-CN_CONCEPT_0000206964299170__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206964299170__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206964299170__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206964299170__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206964299170__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000206964299170__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206964299170)

**适用NF：CloudEPSN**

本命令实现查询A、AAAA、NS、SRV、NAPTR记录的功能。

#### [注意事项](#ZH-CN_CONCEPT_0000206964299170)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000206964299170)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206964299170)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206964299170)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000206964299170)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 绝对域名 | 资源记录的绝对域名。 |
| IP地址 | IP地址。 |
| 优先级 | SRV记录的优先级。当查询结果为多条记录时，客户端选择优先级高的记录。当优先级相同时，客户端根据“权重”值选择一条记录。 |
| 权重 | SRV记录的权重。当几条记录的“优先级”值相同时，客户端根据此参数值选择一条记录。 |
| 端口号 | 用于SRV记录，服务器上提供该种服务的端口号。 |
| 目标 | 用于SRV记录，提供该种服务的服务器域名。 |
| 顺序 | NAPTR记录的优先级。当查询结果为多条记录时，客户端选择优先级高的记录。当优先级相同时，客户端根据“偏爱”值选择一条记录。 |
| 偏好 | NAPTR记录的优先级。当查询结果为多条记录时，客户端选择优先级高的记录。当优先级相同时，客户端根据“偏爱”值选择一条记录。 |
| 标志 | 用于NAPTR记录，表示下一次查询的类型。 |
| 服务 | 用于NAPTR记录，新目标上的服务，以及该服务交互使用的协议。 |
| 正则表达式 | NAPTR记录的正则表达式。 |
| 替换域名 | NAPTR记录的替换域名。 |
| 域名服务器 | NS记录的域名服务器参数。 |
| TTL | 非本域DNS保留授权域资源记录的时间，即资源记录的生存周期。 |
| 区域名称 | 资源记录的区域名。 |
