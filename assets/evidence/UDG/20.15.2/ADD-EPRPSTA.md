# 添加EPRPSTA对象（ADD EPRPSTA）

- [命令功能](#ZH-CN_CONCEPT_0295919471__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0295919471__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0295919471__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0295919471__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0295919471__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0295919471)

**适用NF：SGW-U、PGW-U**

该命令用于添加一个新的EpRpSta对象，用于系统基于EpRpSta的性能统计。

#### [注意事项](#ZH-CN_CONCEPT_0295919471)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0295919471)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0295919471)
