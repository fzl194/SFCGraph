# 查询ApnAlias配置（LST APNALIAS）

- [命令功能](#ZH-CN_CONCEPT_0182837025__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837025__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837025__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837025__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837025__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837025__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837025)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于查看APN别名，当需要查看配置的APN别名和APN名称的对应关系时，使用该命令。

#### [注意事项](#ZH-CN_CONCEPT_0182837025)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837025)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837025)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837025)
