# 增加APN绑定的L2TP接口（ADD L2TPRDSCLIENT）

- [命令功能](#ZH-CN_CONCEPT_0235373540__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0235373540__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0235373540__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0235373540__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0235373540__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0235373540)

**适用NF：PGW-U、UPF**

该命令用于在APN上指定的源端Gi接口绑定关系。在AAA返回L2TP属性启动L2TP业务场景，该接口可用做系统与LNS进行交互时的源端接口。

#### [注意事项](#ZH-CN_CONCEPT_0235373540)

- 该命令执行后立即生效。
- 系统最多支持配置10000条L2tpRdsClient。
- 每个APN可以绑定1个源端接口。

#### [操作用户权限](#ZH-CN_CONCEPT_0235373540)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0235373540)
