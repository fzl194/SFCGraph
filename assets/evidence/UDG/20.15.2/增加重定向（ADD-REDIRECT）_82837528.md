...
- [命令功能](#ZH-CN_CONCEPT_0182837528__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837528__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837528__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837528__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837528__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837528)

**适用NF：PGW-U、UPF**

此命令用于运营商配置新的URL重定向策略。当运营商需要对HTTP/WAP（包括WAP1.X和WAP2.0版本）等协议的业务流做重定向处理则应用该命令。可以选择在URL重定向的报文中是否包含重定向携带信息名称。

#### [注意事项](#ZH-CN_CONCEPT_0182837528)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837528)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837528)
