# 修改重定向携带信息（MOD REDIRAPPENDINFO）

- [命令功能](#ZH-CN_CONCEPT_0182837562__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837562__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837562__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837562__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837562__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837562)

**适用NF：PGW-U、UPF**

此命令用于运营商修改已经配置的重定向携带信息。可以修改原始URL、MSISDN、IMSI、IMEI、MSIP、时间戳信息的携带配置以及对携带MSISDN、IMSI、IMEI、MSIP、时间戳信息的加密算法等。

#### [注意事项](#ZH-CN_CONCEPT_0182837562)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837562)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837562)
