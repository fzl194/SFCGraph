# NOS Base平面网络Ping功能（ACT RESNOSBASEPING）

- [命令功能](#ZH-CN_TOPIC_0000001359135269__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001359135269__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000001359135269__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000001359135269__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000001359135269__1.3.5.1)

#### [命令功能](#ZH-CN_TOPIC_0000001359135269)
...
#### [注意事项](#ZH-CN_TOPIC_0000001359135269)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_TOPIC_0000001359135269)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001359135269)
...
#### [使用实例](#ZH-CN_TOPIC_0000001359135269)
