# 添加整机Trunk Remark配置（ADD GLBTRUNKREMARK）

- [命令功能](#ZH-CN_CONCEPT_0000202968602073__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202968602073__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202968602073__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202968602073__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202968602073__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202968602073)

**适用NF：SGW-U、PGW-U**

该命令用于添加整机的Trunk Remark配置。

#### [注意事项](#ZH-CN_CONCEPT_0000202968602073)

- 该命令执行后立即生效。
- 系统最多支持配置500条GLBTRUNKREMARK。

#### [操作用户权限](#ZH-CN_CONCEPT_0000202968602073)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202968602073)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202968602073)
