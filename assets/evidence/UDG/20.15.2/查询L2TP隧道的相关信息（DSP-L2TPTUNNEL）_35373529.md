# 查询L2TP隧道的相关信息（DSP L2TPTUNNEL）

- [命令功能](#ZH-CN_CONCEPT_0235373529__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0235373529__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0235373529__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0235373529__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0235373529__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0235373529__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0235373529)

**适用NF：PGW-U、UPF**

该命令用于查看L2TP隧道相关的信息。运营商可以分别根据APN名字、接口名字等信息查询L2TP的隧道信息。

#### [注意事项](#ZH-CN_CONCEPT_0235373529)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0235373529)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0235373529)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0235373529)
...
| 发送窗口大小 | 发送窗口大小。 |
| IP类型 | 用于指定IP地址类型。 |
| Giif接口IPv4地址 | 用于表示隧道绑定的Giif接口IP地址。 |
