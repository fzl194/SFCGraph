# 删除业务统计协议绑定配置（RMV PROTBINDSRVS）

- [命令功能](#ZH-CN_CONCEPT_0182837389__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837389__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837389__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837389__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837389__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837389)
...
#### [注意事项](#ZH-CN_CONCEPT_0182837389)

- 该命令执行后对新数据流生效。
- 该命令支持批量删除。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837389)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837389)
