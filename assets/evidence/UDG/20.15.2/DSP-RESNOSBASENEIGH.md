# 查询NOS Base平面网络的邻居信息（DSP RESNOSBASENEIGH）

- [命令功能](#ZH-CN_TOPIC_0000001352116461__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001352116461__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000001352116461__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000001352116461__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000001352116461__1.3.5.1)
- [输出结果说明](#ZH-CN_TOPIC_0000001352116461__1.3.7.1)

#### [命令功能](#ZH-CN_TOPIC_0000001352116461)

该命令用于查询NOS Base平面网络的邻居信息。

#### [注意事项](#ZH-CN_TOPIC_0000001352116461)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_TOPIC_0000001352116461)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001352116461)
...
#### [使用实例](#ZH-CN_TOPIC_0000001352116461)
...
#### [输出结果说明](#ZH-CN_TOPIC_0000001352116461)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 资源名称 | 表示资源名称。 |
| IP地址 | 表示IP地址。 |
| 接口名称 | 表示NOS Base平面的接口名称。 |
| MAC地址 | 表示NOS Base平面网络邻居的MAC地址。 |
| 表项状态 | 表示NOS Base平面网络邻居的表项状态。 |
