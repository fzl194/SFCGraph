# 增加BGP对等体BFD检测（ADD BGPPEERBFD）

- [命令功能](#ZH-CN_CONCEPT_0000001549801582__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801582__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801582__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801582__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801582__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801582)

该命令用于增加IPv4或IPv6对等体BFD的相关参数。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801582)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801582)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801582)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801582)
