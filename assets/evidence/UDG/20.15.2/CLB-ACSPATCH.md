...
- [命令功能](#ZH-CN_CONCEPT_0231115871__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0231115871__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0231115871__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0231115871__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0231115871__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0231115871)
...
#### [注意事项](#ZH-CN_CONCEPT_0231115871)

- 该命令执行后立即生效。
- 该命令执行后，涉及重启的，需要在重启后参数RBKTIMER所设置的时间内立即登录，并通过DSP PATCHDETAILINFO或者DSP PATCHINFO查询该操作是否成功。

#### [操作用户权限](#ZH-CN_CONCEPT_0231115871)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0231115871)
