# 修改OSPFv3默认路由宣告配置（MOD OSPFV3DEFAULTROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001549801658__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801658__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801658__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801658__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801658__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801658)

该命令用于修改OSPFv3默认路由宣告。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801658)

- 该命令执行后立即生效。
- OSPFv3缺省路由发布的方式取决于引入缺省路由的区域类型，该命令仅用于发布缺省路由到普通OSPFv3区域。
- 对于Stub区域、Totally Stub区域，缺省路由自动发布。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801658)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801658)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801658)
