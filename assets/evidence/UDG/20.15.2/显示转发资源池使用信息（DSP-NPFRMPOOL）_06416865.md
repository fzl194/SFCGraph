# 显示转发资源池使用信息（DSP NPFRMPOOL）

- [命令功能](#ZH-CN_TOPIC_0000001506416865__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001506416865__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000001506416865__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000001506416865__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000001506416865__1.3.5.1)
- [输出结果说明](#ZH-CN_TOPIC_0000001506416865__1.3.6.1)

#### [命令功能](#ZH-CN_TOPIC_0000001506416865)

该命令用于查询转发资源池使用信息。

#### [注意事项](#ZH-CN_TOPIC_0000001506416865)

- 该命令执行后立即生效。
- 该命令仅适用于NP卡加速模式场景。

#### [操作用户权限](#ZH-CN_TOPIC_0000001506416865)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001506416865)
...
#### [使用实例](#ZH-CN_TOPIC_0000001506416865)
...
#### [输出结果说明](#ZH-CN_TOPIC_0000001506416865)
