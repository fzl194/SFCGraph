# 设置VoNR语音质量监控功能开关（SET APNVONRMONFUNC）

- [命令功能](#ZH-CN_CONCEPT_0000203091056082__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203091056082__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203091056082__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203091056082__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203091056082__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203091056082)

**适用NF：UPF**

该命令用于设置VoNR语音质量监控功能开关。

#### [注意事项](#ZH-CN_CONCEPT_0000203091056082)

- 该命令执行后立即生效。
- 系统最多支持配置10000条。初始值均为DISABLE。
- 对应apn开启了VoNR语音质量监控功能，会导致性能下降，重新进行性能评估后再配置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000203091056082)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203091056082)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203091056082)
