...
- [命令功能](#ZH-CN_MMLREF_0000001780253905__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001780253905__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001780253905__1.3.3)
- [使用实例](#ZH-CN_MMLREF_0000001780253905__1.3.4)
- [输出结果说明](#ZH-CN_MMLREF_0000001780253905__1.3.5)
- [参考信息](#ZH-CN_MMLREF_0000001780253905__1.3.6)

## [命令功能](#ZH-CN_MMLREF_0000001780253905)
...
## [参数说明](#ZH-CN_MMLREF_0000001780253905)

无。

## [使用实例](#ZH-CN_MMLREF_0000001780253905)
...
## [输出结果说明](#ZH-CN_MMLREF_0000001780253905)

命令执行正常，会返回命令执行成功的提示信息。输出结果说明如 [表2](#ZH-CN_MMLREF_0000001780253905__zh-cn_mmlref_0000001718398712_table21251658132718) 所示。

命令执行失败则返回相应的错误，参见 [表3 错误码列表](#ZH-CN_MMLREF_0000001780253905__zh-cn_mmlref_0000001718398712_table16427175513333) ；命令执行异常，请联系技术支持处理。
...
## [参考信息](#ZH-CN_MMLREF_0000001780253905)
