# 显示PAE队列统计信息（DSP PAEQUEUE）

- [命令功能](#ZH-CN_CONCEPT_0192520046__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0192520046__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0192520046__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0192520046__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0192520046__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0192520046__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0192520046)

该命令用于显示PAE队列统计信息。

通过该命令可查看指定资源上队列的状态和统计信息，可了解通信是否正常，并进行故障诊断。

#### [注意事项](#ZH-CN_CONCEPT_0192520046)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0192520046)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0192520046)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0192520046)
...
| 接收报文数目 | 接收的报文数目。 |
| 发送报文数目 | 发送的报文数目。 |
| 接收报文速率（pps） | 接收报文速率，单位为pps。 |
| 发送报文速率（pps） | 发送报文速率，单位为pps。 |
| 重发次数 | 重发次数。 |
| 丢包统计 | 丢包统计。 |
