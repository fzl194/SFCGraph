# 显示当前安全CAR信息（DSP SECCARINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001549961714__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961714__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961714__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961714__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961714__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001549961714__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961714)

该命令用来显示防攻击策略中的CAR信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961714)

- 该命令执行后立即生效。
- 该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961714)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961714)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961714)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001549961714)

| 输出项名称 | 输出项解释 |
| --- | --- |
| RU名称 | 该参数表示资源单元。 |
| 安全CAR系统ID | 该参数表示安全CAR系统ID。 |
| 安全策略编号 | 该参数表示安全策略号。 |
| 承诺信息速率 | 该参数表示承诺信息速率。 |
| 承诺突发尺寸 | 该参数表示承诺突发尺寸。 |
| 缺省承诺信息速率 | 该参数表示默认承诺信息速率。 |
| 缺省承诺突发尺寸 | 该参数表示默认承诺突尺寸。 |
| 优先级 | 该参数表示优先级，可指定为高/中/低。 |
| 最小包补偿长度 | 该参数表示最小包补偿长度。 |
| 缺省优先级 | 该参数表示默认优先级。 |
| 缺省最小包补偿长度 | 该参数表示默认最小包长。 |
| 安全策略描述 | 该参数表示描述信息。 |
