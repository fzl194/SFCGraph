# 设置IPv6 ND接口配置（SET NDIFCONFIG）

- [命令功能](#ZH-CN_CONCEPT_0000001550281614__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281614__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281614__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281614__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281614__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281614)

该命令用于IPv6接口下的ND配置。

邻居发现ND是确定邻居节点之间关系的一组消息和进程。邻居发现协议替代了IPv4的ARP和ICMP路由器发现，并提供了其他功能。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281614)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281614)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281614)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281614)
