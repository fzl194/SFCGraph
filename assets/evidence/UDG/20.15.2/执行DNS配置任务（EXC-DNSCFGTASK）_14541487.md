# 执行DNS配置任务（EXC DNSCFGTASK）

- [命令功能](#ZH-CN_CONCEPT_0000207114541487__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207114541487__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207114541487__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207114541487__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207114541487__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207114541487)

**适用NF：CloudEPSN**

该命令用于进行部署任务、创建缓存、清除缓存等操作。

#### [注意事项](#ZH-CN_CONCEPT_0000207114541487)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000207114541487)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207114541487)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207114541487)
