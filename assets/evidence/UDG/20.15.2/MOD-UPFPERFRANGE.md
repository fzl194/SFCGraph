# 更新UPF上报性能指标范围配置（MOD UPFPERFRANGE）

- [命令功能](#ZH-CN_CONCEPT_0000202487359209__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202487359209__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202487359209__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202487359209__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202487359209__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202487359209)

**适用NF：SGW-U、PGW-U、UPF**

该命令用来修改UPF上报性能指标范围配置。

#### [注意事项](#ZH-CN_CONCEPT_0000202487359209)

该命令执行后需要重新下发测量对象才能生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000202487359209)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202487359209)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202487359209)
