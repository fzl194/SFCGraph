...
- [命令功能](#ZH-CN_CONCEPT_0182837268__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837268__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837268__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837268__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837268__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837268)

**适用NF：PGW-U、UPF**

该命令用于修改规则，其中包含策略类型、流过滤器、流过滤器组、策略信息、生效时间段以及优先级等。只有已经添加成功的规则才能够修改。

#### [注意事项](#ZH-CN_CONCEPT_0182837268)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837268)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837268)
