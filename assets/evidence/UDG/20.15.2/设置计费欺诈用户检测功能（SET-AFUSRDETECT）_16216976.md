# 设置计费欺诈用户检测功能（SET AFUSRDETECT）

- [命令功能](#ZH-CN_CONCEPT_0216216976__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0216216976__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0216216976__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0216216976__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0216216976__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0216216976)

**适用NF：UPF**

此命令用于配置用户欺诈流量检测功能开关，及相关控制参数，对可疑的计费欺诈用户进行监控。

#### [注意事项](#ZH-CN_CONCEPT_0216216976)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0216216976)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0216216976)
