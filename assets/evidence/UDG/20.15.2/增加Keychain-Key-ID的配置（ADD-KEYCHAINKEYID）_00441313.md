# 增加Keychain Key ID的配置（ADD KEYCHAINKEYID）

- [命令功能](#ZH-CN_CONCEPT_0000001600441313__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441313__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441313__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441313__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441313__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441313)

该命令用于设置Keychain Key ID的各种属性。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441313)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441313)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441313)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441313)
