...
- [命令功能](#ZH-CN_CONCEPT_0182837051__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837051__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837051__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837051__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837051__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837051)

**适用NF：PGW-U、UPF**

该命令可以修改已经创建的IP farm的虚拟IP地址、心跳检测接口、心跳检测开关、VPN等相关参数。

#### [注意事项](#ZH-CN_CONCEPT_0182837051)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837051)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837051)
