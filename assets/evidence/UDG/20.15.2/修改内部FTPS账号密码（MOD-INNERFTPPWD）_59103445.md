# 修改内部FTPS账号密码（MOD INNERFTPPWD）

- [命令功能](#ZH-CN_CONCEPT_0259103445__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103445__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103445__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103445__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103445__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103445)
...
#### [注意事项](#ZH-CN_CONCEPT_0259103445)

- 该命令执行后立即生效。
- 执行该操作后，内部FTPS账号的密码将被修改。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103445)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103445)
