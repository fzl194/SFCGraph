# 删除BFD模板（RMV SRBFDTEMPLET）

- [命令功能](#ZH-CN_CONCEPT_0000001549801730__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801730__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801730__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801730__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801730__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801730)

该命令用于删除BFD模板。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801730)

- 该命令执行后立即生效。
- 删除该BFD模板时，要保证该模板添加过。
- 可能有静态路由正在使用该模板，删除会导致静态路由与BFD取消关联，进而无法感知链路状态。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801730)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801730)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801730)
