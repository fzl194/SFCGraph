...
- [命令功能](#ZH-CN_CONCEPT_0182837518__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837518__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837518__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837518__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837518__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837518)

**适用NF：PGW-U、UPF**

该命令用来删除头增强的相关配置。用于取消用户相应的头增强配置。

#### [注意事项](#ZH-CN_CONCEPT_0182837518)

- 该命令执行后立即生效。
- 已经被绑定到RULE命令中的头增强不能删除，若需要删除该头增强的信息，需要先执行RMV RULE命令解除绑定关系后，再删除。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837518)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837518)
...
#### [使用实例](#ZH-CN_CONCEPT_0182837518)

假如运营商想删除名称为“headen1”，加密为“MSISDN1”的头增强记录：

```
RMV HEADEN:HEADERENNAME="headen1",DATATYPE=MSISDN1;
```
