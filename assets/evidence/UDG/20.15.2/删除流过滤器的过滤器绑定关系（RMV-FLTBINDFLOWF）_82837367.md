# 删除流过滤器的过滤器绑定关系（RMV FLTBINDFLOWF）

- [命令功能](#ZH-CN_CONCEPT_0182837367__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837367__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837367__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837367__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837367__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837367)
...
#### [注意事项](#ZH-CN_CONCEPT_0182837367)

- 该命令执行后60s生效。
- 如果不输入FilterName，则代表删除该FlowFilterName对应的流过滤器下所有的过滤器与流过滤器绑定关系。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837367)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837367)
