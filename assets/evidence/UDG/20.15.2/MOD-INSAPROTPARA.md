# 修改单协议推理配置（MOD INSAPROTPARA）

- [命令功能](#ZH-CN_CONCEPT_0000206906764053__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206906764053__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206906764053__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206906764053__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206906764053__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206906764053)

**适用NF：PGW-U、UPF**

修改单协议推理配置。

#### [注意事项](#ZH-CN_CONCEPT_0000206906764053)

参数INFERSWITCH对新流生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206906764053)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206906764053)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206906764053)
