# 删除周期时间段（RMV PERITIMERANGE）

- [命令功能](#ZH-CN_CONCEPT_0182837430__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837430__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837430__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837430__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837430__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837430)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于删除配置的周期时间段信息。当系统的业务不再需要在特定的周期时间段内生效时，使用此命令进行删除周期时间段配置。

#### [注意事项](#ZH-CN_CONCEPT_0182837430)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837430)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837430)
