# 修改VXLAN组（MOD VXLANGRP）

- [命令功能](#ZH-CN_CONCEPT_0000201281234588__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201281234588__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201281234588__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201281234588__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201281234588__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201281234588)

**适用NF：PGW-U、UPF**

该命令用于修改VXLAN隧道组。

#### [注意事项](#ZH-CN_CONCEPT_0000201281234588)

- 该命令执行后立即生效。
- 在5G LAN业务中，心跳检测开关建议关闭，否则可能影响报文正常转发。

#### [操作用户权限](#ZH-CN_CONCEPT_0000201281234588)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201281234588)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201281234588)
