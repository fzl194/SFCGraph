# 增加流过滤器协议绑定关系（ADD PROTBINDFLOWF）

- [命令功能](#ZH-CN_CONCEPT_0182837370__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837370__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837370__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837370__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837370__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837370)

**适用NF：PGW-U、UPF**

该命令用于向流过滤器中新增协议与流过滤器绑定关系，使用该protocol的业务会在流过滤器协议层级的匹配流程时可以匹配成功。

#### [注意事项](#ZH-CN_CONCEPT_0182837370)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837370)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837370)
