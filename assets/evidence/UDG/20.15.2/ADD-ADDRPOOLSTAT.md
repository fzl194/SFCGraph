# 增加地址池统计配置（ADD ADDRPOOLSTAT）

- [命令功能](#ZH-CN_CONCEPT_0000201415209021__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201415209021__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201415209021__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201415209021__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201415209021__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201415209021)

**适用NF：PGW-U、UPF**

该命令用于增加地址池性能统计对象，主要用于基于网络切片粒度的UE地址相关性能统计。

#### [注意事项](#ZH-CN_CONCEPT_0000201415209021)

- 该命令执行后立即生效。
- 该命令最大记录数为500。

#### [操作用户权限](#ZH-CN_CONCEPT_0000201415209021)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201415209021)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201415209021)
