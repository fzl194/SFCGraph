# 查询安全策略ACL规则（LST SECPOLICYACL）

- [命令功能](#ZH-CN_CONCEPT_0000001600441405__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441405__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441405__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441405__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441405__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600441405__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441405)

该命令用来查询一个安全策略规则。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441405)

- 该命令执行后立即生效。
- 该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441405)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441405)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441405)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600441405)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 安全策略类型 | 该参数表示安全策略类型。 |
| 安全ACL规则编号 | 该参数表安全ACL规则的编号，取值范围为2000～3999。 |
| 安全策略类型编号 | 该参数表示安全策略类型的编号。 |
| 安全策略编号 | 该参数表示安全策略编号，取值范围为1～30。 |
