# 删除接口下ICMP安全配置（RMV IFICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001549802334__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802334__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802334__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802334__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802334__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802334)

该命令用于删除接口下ICMP安全配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001549802334)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802334)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802334)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802334)

删除接口LoopBack0上对于接收方向echo报文的安全配置：

```
RMV IFICMPSECURITY: IFNAME="LoopBack0", ACTION=rcvPkt, CONFIGTYPE=PKTTYPE, PKTTYPE=echo;
```
