# 显示资源池列表的资源占用情况（DSP FEI_FRM_CST_POOL）

- [命令功能](#ZH-CN_CONCEPT_0000001600441333__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441333__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441333__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441333__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441333__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600441333__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441333)

该命令用于显示资源池列表的资源占用情况。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441333)

该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441333)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441333)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441333)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600441333)
...
| 存储池名称 | 该参数为存储池名称。 |
| 算法类型 | 该参数为算法类型。 |
| 资源池可以存储的总数 | 该参数为资源池可以存储的总数。 |
| 当前存储的资源数 | 该参数为当前存储的资源数。 |
| 老化池是否存在 | 该参数为老化池是否存在。 |
| 老化池计数 | 该参数为老化池计数。 |
| 当前有多少个遍历句柄在遍历该资源池 | 该参数为当前有多少个遍历句柄在遍历该资源池。 |
| RU名称 | 该参数为资源单元名称。 |
