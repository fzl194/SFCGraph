# 设置PCC QoS相关控制参数（SET PCCRULECTRL）

- [命令功能](#ZH-CN_CONCEPT_0208342473__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0208342473__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0208342473__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0208342473__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0208342473__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0208342473)

**适用NF：PGW-U、UPF**

此命令用于控制PCC动态Rule生成的QoS Rule优先级是否按照PCF下发的优先级进行控制。

#### [注意事项](#ZH-CN_CONCEPT_0208342473)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0208342473)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0208342473)
