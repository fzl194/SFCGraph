...
- [命令功能](#ZH-CN_CONCEPT_0000204455603814__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000204455603814__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000204455603814__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000204455603814__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000204455603814__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000204455603814)

**适用NF：PGW-U、UPF**

该命令用于在L2TP组中添加LNS信息。如果LNS信息超过6个时， 可以使用该命令添加LNS信息。

#### [注意事项](#ZH-CN_CONCEPT_0000204455603814)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000204455603814)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000204455603814)
...
#### [使用实例](#ZH-CN_CONCEPT_0000204455603814)
