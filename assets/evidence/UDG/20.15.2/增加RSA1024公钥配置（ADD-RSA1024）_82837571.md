# 增加RSA1024公钥配置（ADD RSA1024）

- [命令功能](#ZH-CN_CONCEPT_0182837571__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837571__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837571__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837571__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837571__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837571)

**适用NF：PGW-U、UPF**

该命令用于指定RSA1024加密使用的公钥文件及相关参数配置。

#### [注意事项](#ZH-CN_CONCEPT_0182837571)

- 该命令执行后立即生效。
- 该命令最大记录数为20。
- 当前命令中 RSAPSWDTYPE 中的 CERTIFICATE_FILE 项功能不支持。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837571)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837571)
