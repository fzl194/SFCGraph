# 5G LAN业务Ping功能（NGSRVPING）

- [命令功能](#ZH-CN_CONCEPT_0000206744528556__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206744528556__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206744528556__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206744528556__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206744528556__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206744528556)

**适用NF：UPF**

该命令通过在用户面业务处理单元发起层二5G LAN终端到对端网元的PING，获取路由可达性以及通信来回旅程的时延以及报文的丢失情况。

#### [注意事项](#ZH-CN_CONCEPT_0000206744528556)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000206744528556)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206744528556)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206744528556)
