# 修改基于位置区+PLMN分配地址的开关（MOD IPALLOCBYPLMNLOCSW）

- [命令功能](#ZH-CN_CONCEPT_0000202737284281__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202737284281__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202737284281__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202737284281__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202737284281__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202737284281)

**适用NF：PGW-U、UPF**

该命令用于修改基于位置区+PLMN分配地址开关配置。

#### [注意事项](#ZH-CN_CONCEPT_0000202737284281)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000202737284281)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202737284281)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202737284281)
