# 增加指定某个APN下选择少量会话做本地存储CHR表单的策略（ADD CHRRPTAPN）

- [命令功能](#ZH-CN_CONCEPT_0000206952040851__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206952040851__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206952040851__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206952040851__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206952040851__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206952040851)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于增加指定某个APN下选择少量会话做本地存储CHR表单。

#### [注意事项](#ZH-CN_CONCEPT_0000206952040851)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000206952040851)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206952040851)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206952040851)
