# 删除5G LAN组绑定PA口UE互访白名单（RMV NGBINDUEMUTWL）

- [命令功能](#ZH-CN_CONCEPT_0000206348922723__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206348922723__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206348922723__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206348922723__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206348922723__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206348922723)

**适用NF：UPF**

该命令用于删除5G LAN组与PA口UE互访白名单的绑定关系。

#### [注意事项](#ZH-CN_CONCEPT_0000206348922723)

该命令执行后，对新激活的用户生效；对于已在线的用户，需要N9承载的对端IP地址发生变更时才会生效，该修改通过承载更新消息下发。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206348922723)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206348922723)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206348922723)
