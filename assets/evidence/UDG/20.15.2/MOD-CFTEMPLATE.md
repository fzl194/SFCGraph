# 修改内容过滤模板（MOD CFTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0000203373790545__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203373790545__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203373790545__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203373790545__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203373790545__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203373790545)

**适用NF：PGW-U、UPF**

该命令用于修改一个内容过滤模板实例。

#### [注意事项](#ZH-CN_CONCEPT_0000203373790545)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000203373790545)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203373790545)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203373790545)
