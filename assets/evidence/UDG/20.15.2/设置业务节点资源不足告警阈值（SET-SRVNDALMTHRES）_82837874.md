...
- [命令功能](#ZH-CN_CONCEPT_0182837874__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837874__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837874__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837874__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837874__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837874)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于配置业务节点告警阈值和恢复告警阈值。当业务节点资源使用率超过配置的告警门限时产生告警。当使用率低于配置的恢复门限时恢复告警。

#### [注意事项](#ZH-CN_CONCEPT_0182837874)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837874)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837874)
