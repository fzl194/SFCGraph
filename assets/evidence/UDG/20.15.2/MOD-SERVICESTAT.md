# 修改业务统计配置（MOD SERVICESTAT）

- [命令功能](#ZH-CN_CONCEPT_0182837844__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837844__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837844__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837844__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837844__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837844)

**适用NF：PGW-U、UPF**

该命令用于修改基于业务的性能统计对象组合，配置是否统计HTTP协议和DNS协议的请求次数、成功/错误响应次数和响应时延等。

#### [注意事项](#ZH-CN_CONCEPT_0182837844)

该命令执行后对新数据流生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837844)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837844)
