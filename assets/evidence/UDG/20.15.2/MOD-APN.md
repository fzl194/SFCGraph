...
- [命令功能](#ZH-CN_CONCEPT_0186526458__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0186526458__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0186526458__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0186526458__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0186526458__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0186526458)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于修改APN实例的信息。在割接或者启动某些业务修改APN配置时需要使用该命令配置。

#### [注意事项](#ZH-CN_CONCEPT_0186526458)

- 该命令执行后立即生效。
- 当前版本不支持此命令的PseudoActSwitch参数。
- APN下存在用户时，不允许修改APN下的VPN。

#### [操作用户权限](#ZH-CN_CONCEPT_0186526458)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0186526458)
