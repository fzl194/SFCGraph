# 设置MOS计算值的补偿因子（SET VONRMOSFACTOR）

- [命令功能](#ZH-CN_CONCEPT_0000203091775308__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203091775308__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203091775308__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203091775308__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203091775308__1.3.5.1)
- [参考信息](#ZH-CN_CONCEPT_0000203091775308__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203091775308)

**适用NF：UPF**

该命令用于设置MOS计算值的补偿因子。

#### [注意事项](#ZH-CN_CONCEPT_0000203091775308)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000203091775308)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203091775308)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203091775308)
...
#### [参考信息](#ZH-CN_CONCEPT_0000203091775308)

针对不同编解码类型在不同丢包率下对语音质量检测的MOS计算值进行补偿。
