# 增加IGMP Snooping组播源配置（ADD MULTICASTSOURCE）

- [命令功能](#ZH-CN_CONCEPT_0000206855843916__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206855843916__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206855843916__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206855843916__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206855843916__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206855843916)

**适用NF：UPF**

该命令用于增加IGMP Snooping组播源配置。

#### [注意事项](#ZH-CN_CONCEPT_0000206855843916)

- 该命令执行后立即生效。
- 如果此IMSI配置成了结对成员，那么此IMSI就只能以结对方式配置为组播源。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206855843916)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206855843916)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206855843916)
