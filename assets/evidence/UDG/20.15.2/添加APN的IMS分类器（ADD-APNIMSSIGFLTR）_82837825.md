# 添加APN的IMS分类器（ADD APNIMSSIGFLTR）

- [命令功能](#ZH-CN_CONCEPT_0182837825__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837825__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837825__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837825__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837825__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837825)
...
#### [注意事项](#ZH-CN_CONCEPT_0182837825)

- 该命令执行后只对新激活用户生效。
- 该命令最大记录数为64000。
- 执行该命令时，APN参数只能配置为做IMS业务的APN，且配置的规则保证所有合法IMS业务能够命中。如果配置不当，将会影响IMS语音信令的转发，造成语音不通。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837825)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837825)
