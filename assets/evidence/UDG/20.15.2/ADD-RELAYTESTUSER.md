# 增加媒体中继拨测用户（ADD RELAYTESTUSER）

- [命令功能](#ZH-CN_CONCEPT_0000207244232400__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207244232400__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207244232400__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207244232400__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207244232400__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207244232400)

**适用NF：UPF、PGW-U**

该命令用于增加媒体中继拨测用户。

#### [注意事项](#ZH-CN_CONCEPT_0000207244232400)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000207244232400)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207244232400)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207244232400)
