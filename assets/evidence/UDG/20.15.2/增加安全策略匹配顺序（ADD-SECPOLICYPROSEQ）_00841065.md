# 增加安全策略匹配顺序（ADD SECPOLICYPROSEQ）

- [命令功能](#ZH-CN_CONCEPT_0000001600841065__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841065__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841065__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841065__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841065__1.3.5.1)
- [参考信息](#ZH-CN_CONCEPT_0000001600841065__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841065)

该命令用来增加安全策略匹配顺序。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841065)

- 该命令执行后立即生效。
- 该命令最大记录数为30。
- 该命令仅适用于非NP卡场景和NP卡非加速模式场景

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841065)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841065)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841065)
...
#### [参考信息](#ZH-CN_CONCEPT_0000001600841065)
