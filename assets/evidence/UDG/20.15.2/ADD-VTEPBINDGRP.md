# 增加VXLAN隧道端点绑定隧道组（ADD VTEPBINDGRP）

- [命令功能](#ZH-CN_CONCEPT_0000201468354107__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201468354107__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201468354107__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201468354107__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201468354107__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201468354107)

**适用NF：PGW-U、UPF**

该命令用于添加VXLAN隧道端点与VXLAN隧道组的绑定关系。

#### [注意事项](#ZH-CN_CONCEPT_0000201468354107)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000201468354107)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201468354107)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201468354107)
