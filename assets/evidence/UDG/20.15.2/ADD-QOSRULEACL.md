# 流分类下增加ACL规则组（ADD QOSRULEACL）

- [命令功能](#ZH-CN_CONCEPT_0000001600600841__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600600841__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600600841__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600600841__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600600841__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600600841)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001600600841)

- 该命令执行后立即生效。
- 该命令最大记录数为65536。
- 该命令虽然引用了ACL规则，但在ACL规则匹配计数中不统计。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600600841)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600600841)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600600841)
