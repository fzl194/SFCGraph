# 增加5G LAN组的配置（ADD NGVNINSTANCE）

- [命令功能](#ZH-CN_CONCEPT_0000201724704442__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201724704442__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201724704442__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201724704442__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201724704442__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201724704442)

**适用NF：UPF**

该命令用于添加1个新的5G LAN会话实例。

#### [注意事项](#ZH-CN_CONCEPT_0000201724704442)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000201724704442)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201724704442)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201724704442)
