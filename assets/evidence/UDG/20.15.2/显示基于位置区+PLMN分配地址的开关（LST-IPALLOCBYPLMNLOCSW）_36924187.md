# 显示基于位置区+PLMN分配地址的开关（LST IPALLOCBYPLMNLOCSW）

- [命令功能](#ZH-CN_CONCEPT_0000202736924187__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202736924187__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202736924187__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202736924187__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202736924187__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000202736924187__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202736924187)

**适用NF：PGW-U、UPF**

该命令显示指定位置区组或PLMN或所有的基于位置区+PLMN分配地址的开关信息。

#### [注意事项](#ZH-CN_CONCEPT_0000202736924187)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000202736924187)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202736924187)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202736924187)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000202736924187)

参见ADD IPALLOCBYPLMNLOCSW的参数说明。
