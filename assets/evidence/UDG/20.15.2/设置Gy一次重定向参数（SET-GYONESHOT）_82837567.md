# 设置Gy一次重定向参数（SET GYONESHOT）

- [命令功能](#ZH-CN_CONCEPT_0182837567__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837567__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837567__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837567__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837567__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837567)

**适用NF：PGW-U、UPF**

该命令用于配置Gy接口一次重定向的URL白名单列表，并配置是否包含重定向携带信息。匹配上该白名单的报文将被重定向到OCS下发的URL。

#### [注意事项](#ZH-CN_CONCEPT_0182837567)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837567)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837567)
