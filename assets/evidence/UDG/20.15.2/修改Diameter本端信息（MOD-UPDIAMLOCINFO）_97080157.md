# 修改Diameter本端信息（MOD UPDIAMLOCINFO）

- [命令功能](#ZH-CN_CONCEPT_0000206297080157__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206297080157__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206297080157__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206297080157__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206297080157__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206297080157)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206297080157)

- 该命令执行后立即生效。
- 修改后，将导致所有使用该LocalInfo的所有链路断开并重建。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206297080157)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206297080157)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206297080157)
