# 修改防火墙策略（MOD FWPOLICY）

- [命令功能](#ZH-CN_CONCEPT_0000202770762244__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202770762244__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202770762244__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202770762244__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202770762244__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202770762244)

**适用NF：PGW-U、UPF**

该命令用于修改防火墙策略。通过该命令可以修改防火墙策略对上下行发起业务流的上下行报文控制策略。

#### [注意事项](#ZH-CN_CONCEPT_0000202770762244)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000202770762244)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202770762244)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202770762244)
