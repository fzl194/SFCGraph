# 显示媒体中继告警详情（DSP RELAYALMDETAIL）

- [命令功能](#ZH-CN_CONCEPT_0000207306110386__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207306110386__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207306110386__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207306110386__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207306110386__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000207306110386__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207306110386)

**适用NF：PGW-U、UPF**

该命令用于显示媒体中继告警详情。

#### [注意事项](#ZH-CN_CONCEPT_0000207306110386)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000207306110386)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207306110386)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207306110386)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000207306110386)
...
| 告警类型 | 用于指定告警类型。 |
| 子告警类型 | 用来指定子告警类型。 |
| 媒体中继域名配置名称 | 用于设置媒体中继域名配置名称。 |
| 媒体中继模板名称 | 用来显示媒体中继模板名称。 |
| DNS服务名称 | 用来指定DNS服务名称。 |
| 告警详情 | 用于显示告警详情。 |
