# 添加单一Gi重定向信息（ADD GIREDIRECTPARA）

- [命令功能](#ZH-CN_CONCEPT_0182837767__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837767__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837767__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837767__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837767__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837767)

**适用NF：SGW-U、PGW-U、UPF**

该命令用来配置指定VPN下的IPv4或IPv6报文Gi重定向参数，在需要控制UE之间互访的恶意攻击报文和需要通过网关将报文重定向来保证网络的安全的场景下使用此命令。

#### [注意事项](#ZH-CN_CONCEPT_0182837767)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837767)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837767)
