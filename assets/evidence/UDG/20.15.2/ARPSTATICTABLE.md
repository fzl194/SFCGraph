# 配置静态ARP表项（ADD ARPSTATICTABLE）

- [命令功能](#ZH-CN_CONCEPT_0000001600441273__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441273__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441273__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441273__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441273__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441273)

该命令用于配置ARP静态表项，出于安全或管理方面的考虑，用户有时需要指定IP地址和MAC地址的映射关系。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441273)

- 该命令执行后立即生效。
- 该命令最大记录数为16384。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441273)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441273)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441273)
