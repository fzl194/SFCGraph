# 显示死循环信息（DSP RESDEADLOOPINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001104802650__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001104802650__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001104802650__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001104802650__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001104802650__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001104802650__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001104802650)

该命令用于显示当前系统中存在的死循环信息。

当等待业务处理时间过长时，可执行该命令查看当前系统中是否存在死循环。

#### [注意事项](#ZH-CN_CONCEPT_0000001104802650)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001104802650)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001104802650)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001104802650)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001104802650)
