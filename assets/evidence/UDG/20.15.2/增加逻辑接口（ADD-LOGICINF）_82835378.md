...
- [命令功能](#ZH-CN_CONCEPT_0182835378__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182835378__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182835378__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182835378__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182835378__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182835378)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于创建指定的逻辑接口。逻辑接口指的是物理上不存在，需要通过配置建立的接口，能够实现数据交换功能。

#### [注意事项](#ZH-CN_CONCEPT_0182835378)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182835378)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182835378)
