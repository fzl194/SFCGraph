# 设置头增强RAT类型定义（SET HEADENRATTYPE）

- [命令功能](#ZH-CN_CONCEPT_0182837509__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837509__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837509__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837509__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837509__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837509)

**适用NF：PGW-U、UPF**

该命令用于配置头增强功能插入的RAT TYPE值对应的字段名称。可以使用本命令实现灵活定义头增强功能的RAT表达方式的目的。

#### [注意事项](#ZH-CN_CONCEPT_0182837509)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837509)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837509)
