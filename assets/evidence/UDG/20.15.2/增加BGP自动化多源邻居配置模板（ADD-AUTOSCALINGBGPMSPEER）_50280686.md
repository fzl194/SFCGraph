# 增加BGP自动化多源邻居配置模板（ADD AUTOSCALINGBGPMSPEER）

- [命令功能](#ZH-CN_CONCEPT_0000001550280686__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280686__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280686__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280686__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280686__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280686)

该命令用于添加BGP多源peer自动化配置模板，在扩容场景下使用BGP多源peer自动化配置模板可以自动化产生BGP多源peer的配置，可以减少人工手动配置，提升配置效率。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280686)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280686)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280686)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280686)
