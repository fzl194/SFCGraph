# 查询对象反向绑定关系（DSP OBJVERBOSEQRY）

- [命令功能](#ZH-CN_CONCEPT_0186526194__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0186526194__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0186526194__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0186526194__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0186526194__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0186526194__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0186526194)

**适用NF：PGW-U、UPF**

此命令用于提供对象反向绑定关系查询的功能。根据运营商指定的配置信息反向查询出引用了该配置数据的配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0186526194)

IMSI/MSISDN号段反向查询只支持在UEG网元内执行。

#### [操作用户权限](#ZH-CN_CONCEPT_0186526194)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0186526194)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0186526194)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 过滤器名字 | 用于指定过滤器名字。 |
| 绑定的ACL节点名称 | 用于指定绑定的ACL节点名称。 |
| 绑定的流过滤器名称 | 用于指定绑定的流过滤器名称。 |
| 绑定的自定义协议名称 | 用于指定绑定的自定义协议名称。 |
| 绑定的用户模板名称 | 用于指定绑定的用户模板名称。 |
| 绑定的规则名称 | 用于指定绑定的规则名称。 |
| URR组名称 | 用于指定URR组名称。 |
| 绑定的上下文激活初始特定计费属性对象名称 | 用于指定绑定的上下文激活初始特定计费属性对象名称。 |
| 绑定的PCC策略组名称 | 用于指定绑定的PCC策略组名称。 |
| ACL节点名称 | 用于指定ACL节点名称。 |
| 绑定的ACL名称 | 用于指定绑定的ACL名称。 |
| ACL名称 | 用于指定ACL名称。 |
| 绑定的APN名称 | 用于指定绑定的APN名称。 |
| 分类属性名称 | 用于指定分类属性名称。 |
| 是否被防欺诈策略绑定 | 用于表示是否被防欺诈策略绑定。 |
| 扩展属性名称 | 用于指定扩展属性名称。 |
| 流过滤器名称 | 用于指定流过滤器名称。 |
| 绑定的流过滤器组名称 | 用于指定绑定的流过滤器组名称。 |
| 流过滤器组名称 | 用于指定流过滤器组名称。 |
| Host配置名称 | 用于指定Host配置名称。 |
| 绑定的过滤器名字 | 用于指定绑定的过滤器名字。 |
| 绑定的特征库规则协议名称 | 用于指定绑定的特征库规则名称。 |
| IP列表名称 | 用于指定IP列表名称。 |
| 七层过滤器名字 | 用于指定七层过滤器名字。 |
| PCC动作属性名称 | 用于指定PCC动作属性名称。 |
| PCC策略组名称 | 用于指定PCC策略组名称。 |
| Qos属性名称 | 用于指定QoS属性名称。 |
| 规则名称 | 用于指定规则名称。 |
| 绑定的业务统计名称 | 用于指定绑定的业务统计名称。 |
| 业务属性名称 | 用于指定业务属性名称。 |
| URR名称 | 用于指定URR名称。 |
| 绑定的URR组名称 | 用于指定绑定的URR组名称。 |
| 用户模板名称 | 用于指定用户模板名称。 |
| 绑定的用户组名称 | 用于指定绑定的用户组名称。 |
| 位置名称 | 用于指定位置名称。 |
| 绑定的热点小区名称 | 用于指定绑定的热点小区名称。 |
| 绑定的位置组名称 | 用于指定绑定的位置组名称。 |
| 位置组名称 | 用于指定位置组名称。 |
| 绑定的用户模板组名称 | 用于指定绑定的用户模板组名称。 |
| IMSI/MSISDN号段名称 | 用于指定IMSI/MSISDN号段名称。 |
| 绑定的IMSI/MSISDN号段组名称 | 用于指定绑定的IMSI/MSISDN号段组名称。 |
