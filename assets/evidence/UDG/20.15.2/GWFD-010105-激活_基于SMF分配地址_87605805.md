...
- [操作场景](#ZH-CN_OPI_0187605805__1.3.1)
- [必备事项](#ZH-CN_OPI_0187605805__1.3.2)
- [操作步骤](#ZH-CN_OPI_0187605805__1.3.3)
- [任务示例](#ZH-CN_OPI_0187605805__1.3.4)

## [操作场景](#ZH-CN_OPI_0187605805)
...
UE接入核心网， UDG 采用本地地址池为UE动态分配IPv4地址。其中第一优先级按照从SMF映射的地址范围内分配地址，如果第一优先级的规则匹配不上，则分配地址失败。指定地址池中的10.1.1.1地址为冲突地址。
