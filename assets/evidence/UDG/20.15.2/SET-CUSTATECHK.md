# 设置SMF和UPF的时间一致性校验（SET CUSTATECHK）

- [命令功能](#ZH-CN_CONCEPT_0279440356__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0279440356__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0279440356__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0279440356__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0279440356__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0279440356)

**适用NF：UPF**

设置SMF和UPF时间不一致告警的参数。

#### [注意事项](#ZH-CN_CONCEPT_0279440356)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0279440356)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0279440356)
