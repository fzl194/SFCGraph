# 删除BGP对等体BFD检测（RMV BGPPEERBFD）

- [命令功能](#ZH-CN_CONCEPT_0000001600841533__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841533__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841533__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841533__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841533__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841533)

该命令用于删除IPv4或IPv6对等体的BFD检测。

#### [注意事项](#ZH-CN_CONCEPT_0000001600841533)

- 该命令执行后立即生效。
- 当命令参数仅指定VPN实例名称和对等体地址时，仅去使能对等体上的BFD功能。当指定其他参数时，此时恢复对应参数为默认值。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841533)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841533)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841533)
