# 修改PCC动作属性（MOD PCCACTIONPROP）

- [命令功能](#ZH-CN_CONCEPT_0182837602__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837602__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837602__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837602__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837602__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837602)

**适用NF：PGW-U、UPF**

此命令用于修改PCC动作属性，只有已经添加成功的PccActionProp才能够修改。可以通过命令，修改PCC策略相关的动作属性，包括Gate、URL Redirect动作。支持配置不同业务发起端定义不同的上下行报文处理动作。

#### [注意事项](#ZH-CN_CONCEPT_0182837602)

- 该命令执行后立即生效。
- 如果上行或下行发起业务的相应策略没有配置，则按照默认Pass处理。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837602)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837602)
