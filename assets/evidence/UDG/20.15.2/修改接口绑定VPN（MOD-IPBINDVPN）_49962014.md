# 修改接口绑定VPN（MOD IPBINDVPN）

- [命令功能](#ZH-CN_CONCEPT_0000001549962014__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549962014__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549962014__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549962014__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549962014__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549962014)

该命令用于修改接口已绑定的VPN。

#### [注意事项](#ZH-CN_CONCEPT_0000001549962014)

- 该命令执行后立即生效。
- 当参数IFIPADDR不指定时，会清空该接口下原来的IP地址；当参数IFIPADDR指定时，会使用被指定的地址替代原来的地址。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549962014)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549962014)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549962014)
