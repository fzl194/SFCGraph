# 查询指定L2TP组（LST L2TPGROUP）

- [命令功能](#ZH-CN_CONCEPT_0235373527__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0235373527__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0235373527__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0235373527__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0235373527__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0235373527__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0235373527)

**适用NF：PGW-U、UPF**

该命令用于查询本地配置的L2TP信息。

#### [注意事项](#ZH-CN_CONCEPT_0235373527)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0235373527)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0235373527)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| GROUPID | L2TP组号 | 可选必选说明：可选参数<br>参数含义：指定L2TP组号。<br>数据来源：本端规划<br>取值范围：整数类型，取值范围为1～1500。<br>默认值：无<br>配置原则：无 |

#### [使用实例](#ZH-CN_CONCEPT_0235373527)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0235373527)

参见ADD L2TPGROUP的参数说明。
