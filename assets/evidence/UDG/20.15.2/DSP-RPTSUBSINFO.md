# 显示报表订阅信息（DSP RPTSUBSINFO）

- [命令功能](#ZH-CN_CONCEPT_0000201961399540__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201961399540__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201961399540__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201961399540__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201961399540__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000201961399540__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201961399540)

**适用NF：PGW-U、UPF**

该命令用于显示报表订阅信息。

#### [注意事项](#ZH-CN_CONCEPT_0000201961399540)

- 该命令执行后立即生效。
- 该命令每次查询结果可能显示不全，多次查询显示结果从上一次查询到的最后一条记录的下一条记录开始。查询不同类型、或者5分钟不执行该命令，再次查询从第一条记录开始。

#### [操作用户权限](#ZH-CN_CONCEPT_0000201961399540)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201961399540)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201961399540)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000201961399540)
