# 增加多DNN条件（ADD MULTIDNNCOND）

- [命令功能](#ZH-CN_CONCEPT_0000206449801657__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206449801657__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206449801657__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206449801657__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206449801657__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206449801657)

**适用NF：UPF**

该命令用于设置多DNN的名称条件，命中此条件的DNN，其业务进行domain学习时基于园区隔离。

#### [注意事项](#ZH-CN_CONCEPT_0000206449801657)

- 该命令执行后对新数据流生效。
- 该命令最大记录数为10。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206449801657)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206449801657)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206449801657)
