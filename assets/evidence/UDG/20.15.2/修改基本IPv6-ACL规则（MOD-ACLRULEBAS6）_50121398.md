# 修改基本IPv6 ACL规则（MOD ACLRULEBAS6）

- [命令功能](#ZH-CN_CONCEPT_0000001550121398__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121398__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121398__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121398__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121398__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121398)

该命令用于修改基本IPv6 ACL规则的配置，可以修改规则中的IP地址等匹配项。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121398)

- 该命令执行后立即生效。
- 执行该命令前，需要提前配置ADD ACLRULEBAS6命令添加ACL规则。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121398)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121398)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121398)
