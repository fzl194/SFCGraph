# 查询CSDB进程信息(DSP PROCESSCSDB)

- [命令功能](#ZH-CN_CONCEPT_0185002950__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0185002950__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0185002950__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0185002950__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0185002950__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0185002950__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0185002950)

该命令用于请求系统显示进程的状态信息和静态配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0185002950)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0185002950)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0185002950)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0185002950)
