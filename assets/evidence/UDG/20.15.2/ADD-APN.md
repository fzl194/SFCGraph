...
- [命令功能](#ZH-CN_CONCEPT_0182837014__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837014__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837014__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837014__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837014__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837014)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于添加一个新的APN实例。在运营商需要接入数据网络，配置APN和绑定VPN时使用此命令进行配置。GPRS/UMTS/EPC/5GC核心网中采用APN来标识系统，同时APN定义了系统可以接入的数据网络。

#### [注意事项](#ZH-CN_CONCEPT_0182837014)

- 该命令执行后立即生效。
- 系统最多支持配置10000条APN。
- 当前版本不支持此命令的PseudoActSwitch参数。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837014)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837014)
