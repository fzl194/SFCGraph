# 查询BGP对等体地址族（LST BGPPEERAF）

- [命令功能](#ZH-CN_CONCEPT_0000001600840717__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600840717__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600840717__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600840717__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600840717__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600840717__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600840717)

该命令用于查询相应BGP IPv4或IPv6对等体地址族配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001600840717)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600840717)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600840717)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600840717)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600840717)

参见ADD BGPPEERAF的参数说明。
