# 设置基础软件参数配置（SET BASESOFTPARA）

- [命令功能](#ZH-CN_CONCEPT_0259103695__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103695__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103695__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103695__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103695__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103695)

该命令用于设置基础软件参数配置，基础软件参数配置主要用于在日常的数据配置与调试过程中，由于周边互通网元的特殊要求、标准协议实现方式不同或运营商网络参数特殊要求等而引起的需要专门配置参数的场景，参数设置直接影响到系统的业务处理方式。

#### [注意事项](#ZH-CN_CONCEPT_0259103695)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0259103695)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103695)
