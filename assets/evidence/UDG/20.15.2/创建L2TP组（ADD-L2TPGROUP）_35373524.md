# 创建L2TP组（ADD L2TPGROUP）

- [命令功能](#ZH-CN_CONCEPT_0235373524__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0235373524__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0235373524__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0235373524__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0235373524__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0235373524)

**适用NF：PGW-U、UPF**

该命令用于配置L2TP组，当需要使用本地配置的L2TP信息接入L2TP用户时，使用此命令。

#### [注意事项](#ZH-CN_CONCEPT_0235373524)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0235373524)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0235373524)
