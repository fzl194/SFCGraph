...
- [命令功能](#ZH-CN_CONCEPT_0182837650__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837650__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837650__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837650__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837650__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837650)

**适用NF：PGW-U、UPF**

该命令是用来修改PCC预定义规则的QoS参数。

#### [注意事项](#ZH-CN_CONCEPT_0182837650)

- 该命令执行后立即生效。
- 修改QoS属性，执行MOD QOSPROP命令前，需要确定修改记录是否存在，存在才能修改记录，否则修改失败。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837650)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837650)
