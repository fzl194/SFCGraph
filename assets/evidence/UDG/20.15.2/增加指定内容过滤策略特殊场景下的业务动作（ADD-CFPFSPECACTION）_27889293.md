# 增加指定内容过滤策略特殊场景下的业务动作（ADD CFPFSPECACTION）

- [命令功能](#ZH-CN_CONCEPT_0000203927889293__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203927889293__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203927889293__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203927889293__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203927889293__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203927889293)

**适用NF：PGW-U、UPF**

该命令用于配置指定内容过滤策略特殊场景下的业务动作，指定内容过滤策略特殊场景下的业务动作包括默认策略动作，错误策略动作和未知策略动作。

#### [注意事项](#ZH-CN_CONCEPT_0000203927889293)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000203927889293)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203927889293)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203927889293)
