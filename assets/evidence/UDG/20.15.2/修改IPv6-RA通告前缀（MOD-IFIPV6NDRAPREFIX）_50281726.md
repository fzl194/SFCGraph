# 修改IPv6 RA通告前缀（MOD IFIPV6NDRAPREFIX）

- [命令功能](#ZH-CN_CONCEPT_0000001550281726__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281726__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281726__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281726__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281726__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281726)

该命令用于修改接口IPv6 RA通告前缀。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281726)

- 该命令执行后立即生效。
- 指定的前缀不能为链路本地地址（fe80::）、组播地址（ff00::）以及其他接口已经使用的前缀（包括接口地址前缀和RA消息携带的前缀）。
- 该命令可以在VNRS_VNFC的Ethernet接口，Ethernet子接口以及Tunnel口上配置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281726)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281726)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281726)
