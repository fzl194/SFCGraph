# 修改DNS资源记录（MOD RESREC）

- [命令功能](#ZH-CN_CONCEPT_0000207231214254__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207231214254__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207231214254__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207231214254__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207231214254__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207231214254)

**适用NF：CloudEPSN**

本命令实现修改A、AAAA、NS、SRV、NAPTR记录的功能。

#### [注意事项](#ZH-CN_CONCEPT_0000207231214254)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000207231214254)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207231214254)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207231214254)
