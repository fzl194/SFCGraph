# 删除业务报表承载协议映射配置（RMV RPTPROTOCOLMAP）

- [命令功能](#ZH-CN_CONCEPT_0000203927889297__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203927889297__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203927889297__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203927889297__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203927889297__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203927889297)

**适用NF：PGW-U、UPF**

该命令用于删除业务报表承载协议映射配置。当运营商希望删除业务报表承载协议映射配置，则配置该命令。

#### [注意事项](#ZH-CN_CONCEPT_0000203927889297)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000203927889297)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203927889297)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203927889297)
