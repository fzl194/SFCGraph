# 删除BGP对等体组条件路由匹配前缀（RMV BGPPEERGROUPAFPRE）

- [命令功能](#ZH-CN_CONCEPT_0000001549802398__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802398__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802398__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802398__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802398__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802398)

该命令用于删除BGP对等体组条件路由匹配前缀。

#### [注意事项](#ZH-CN_CONCEPT_0000001549802398)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802398)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802398)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802398)
