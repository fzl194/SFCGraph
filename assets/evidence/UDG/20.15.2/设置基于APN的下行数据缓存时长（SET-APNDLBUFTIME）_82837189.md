...
- [命令功能](#ZH-CN_CONCEPT_0182837189__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837189__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837189__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837189__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837189__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837189)

**适用NF：UPF**

此命令用来配置APN下的普通用户下行报文缓存时长。

#### [注意事项](#ZH-CN_CONCEPT_0182837189)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837189)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837189)
