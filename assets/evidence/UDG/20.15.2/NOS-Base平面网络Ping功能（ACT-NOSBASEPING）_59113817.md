# NOS Base平面网络Ping功能（ACT NOSBASEPING）

- [命令功能](#ZH-CN_TOPIC_0000001359113817__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001359113817__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000001359113817__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000001359113817__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000001359113817__1.3.5.1)

#### [命令功能](#ZH-CN_TOPIC_0000001359113817)
...
#### [注意事项](#ZH-CN_TOPIC_0000001359113817)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_TOPIC_0000001359113817)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001359113817)
...
#### [使用实例](#ZH-CN_TOPIC_0000001359113817)
