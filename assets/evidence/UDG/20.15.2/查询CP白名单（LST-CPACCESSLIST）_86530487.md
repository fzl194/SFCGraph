# 查询CP白名单（LST CPACCESSLIST）

- [命令功能](#ZH-CN_CONCEPT_0186530487__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0186530487__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0186530487__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0186530487__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0186530487__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0186530487__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0186530487)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于查询符合条件的CP白名单配置。

#### [注意事项](#ZH-CN_CONCEPT_0186530487)

- 该命令执行后立即生效。
- 如果没有指定WHITELISTTYPE，则显示所有的CP白名单记录。

#### [操作用户权限](#ZH-CN_CONCEPT_0186530487)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0186530487)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0186530487)

参见ADD CPACCESSLIST的参数说明。
