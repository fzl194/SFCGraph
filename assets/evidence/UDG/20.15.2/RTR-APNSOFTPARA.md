# 恢复APN软参记录（RTR APNSOFTPARA）

- [命令功能](#ZH-CN_CONCEPT_0182837029__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837029__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837029__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837029__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837029__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837029)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于恢复APN下软件参数信息。

#### [注意事项](#ZH-CN_CONCEPT_0182837029)

- 该命令执行后立即生效。
- BIT与BYTE类型软参执行该命令后将恢复成零，STRING类型软参执行该命令后将恢复成NULL。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837029)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837029)
