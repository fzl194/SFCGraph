# 设置维测信息统计开关（SET MSSDEBUGSWITCHM）

- [命令功能](#ZH-CN_CONCEPT_0193243682__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0193243682__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0193243682__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0193243682__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0193243682__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0193243682)
...
#### [注意事项](#ZH-CN_CONCEPT_0193243682)

- 该命令执行后立即生效。
- 本功能使能会消耗内存、降低性能且在用户指定的时间之后会自动去使能，去使能之后内存释放、性能恢复。默认时间是30分钟。
- 当前版本DEBUGTYPE参数只支持schedule-work、energy-conservation开关配置生效，其余开关配置不生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0193243682)

G_1，管理员级别命令组；G_2，操作员级别命令组;

#### [参数说明](#ZH-CN_CONCEPT_0193243682)
