# 修改地址池绑定地址池组中的地址池优先级（MOD POOLBINDGROUP）

- [命令功能](#ZH-CN_CONCEPT_0182837144__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837144__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837144__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837144__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837144__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837144)

**适用NF：PGW-U、UPF**

该命令用于修改指定地址池组中指定地址池的优先级。

#### [注意事项](#ZH-CN_CONCEPT_0182837144)

该命令执行后只对新激活用户生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837144)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837144)
