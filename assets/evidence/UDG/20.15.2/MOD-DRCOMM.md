...
- [命令功能](#ZH-CN_CONCEPT_0251012927__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0251012927__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0251012927__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0251012927__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0251012927__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0251012927)

该命令用于修改本端或对端容灾实例地址信息。

#### [注意事项](#ZH-CN_CONCEPT_0251012927)

修改容灾实例地址后需要去激活再激活license才能进入实备。

#### [操作用户权限](#ZH-CN_CONCEPT_0251012927)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0251012927)
