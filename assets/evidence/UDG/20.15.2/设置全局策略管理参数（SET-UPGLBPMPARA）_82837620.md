...
- [命令功能](#ZH-CN_CONCEPT_0182837620__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837620__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837620__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837620__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837620__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837620)

**适用NF：PGW-U、UPF**

该命令用于配置计费策略相关控制参数，参数包括QOSURRAGETIME，显示当内部异常导致承载资源无法回收时，运营商可以通过此命令查看回收删除承载的时间。

#### [注意事项](#ZH-CN_CONCEPT_0182837620)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837620)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837620)
