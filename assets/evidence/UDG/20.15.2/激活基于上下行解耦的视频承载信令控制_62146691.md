...
- [操作场景](#ZH-CN_OPI_0000001262146691__1.3.1)
- [必备事项](#ZH-CN_OPI_0000001262146691__1.3.2)
- [操作步骤](#ZH-CN_OPI_0000001262146691__1.3.3)
- [任务示例](#ZH-CN_OPI_0000001262146691__1.3.4)

## [操作场景](#ZH-CN_OPI_0000001262146691)

当运营商规划部署基于上下行解耦的视频承载信令控制功能时，需执行本操作。

> **说明**
> 适用于PGW-U、UPF。

## [必备事项](#ZH-CN_OPI_0000001262146691)
...
| [**ADD PROTBINDFLOWF**](../../../../../OM参考/命令/UDG MML命令/用户面服务管理/业务匹配策略/业务过滤器管理/流过滤器管理/流过滤器的协议绑定/增加流过滤器协议绑定关系（ADD PROTBINDFLOWF）_82837370.md) | 协议名称（PROTOCOLNAME） | example_video | 本端规划 | 绑定的七层协议。 |
...
| [**ADD URR**](../../../../../OM参考/命令/UDG MML命令/用户面服务管理/业务控制策略/计费控制/使用率上报规则/增加URR（ADD URR）_82837629.md) | URR标识（URRID） | 1 | 本端规划 | 增加用于QoS事件上报的规则。 |
...
## [操作步骤](#ZH-CN_OPI_0000001262146691)
...
## [任务示例](#ZH-CN_OPI_0000001262146691)

任务描述

配置七层业务触发的基于下行链路的专有承载/QoS Flow创建，并使能example_video协议触发基于上下行解耦的视频承载信令控制功能。
...
```
ADD PCCPOLICYGRP:PCCPOLICYGRPNM="ppg1",QOSPROPNAME="qos-property1",
URRGROUPNAME
="urrgp_test";
```
