...
- [命令功能](#ZH-CN_CONCEPT_0182837361__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837361__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837361__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837361__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837361__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837361)

**适用NF：PGW-U、UPF**

该命令用于增加流过滤器。通过FlowFilter下定义L34层Filter、L7层协议、L7层过滤条件等过滤条件组合来实现规则中业务流过滤条件的定义，匹配L34层过滤条件、L7层协议、L7层过滤条件均成功的业务可以命中该流过滤器。

#### [注意事项](#ZH-CN_CONCEPT_0182837361)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837361)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837361)
