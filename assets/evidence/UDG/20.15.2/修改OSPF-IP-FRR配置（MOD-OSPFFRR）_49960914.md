# 修改OSPF IP FRR配置（MOD OSPFFRR）

- [命令功能](#ZH-CN_CONCEPT_0000001549960914__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549960914__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549960914__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549960914__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549960914__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549960914)

该命令用来修改OSPF IP FRR（快速重路由）配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001549960914)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549960914)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549960914)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549960914)
