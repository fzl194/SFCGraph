# 显示SSH客户端的消息数据（DSP SSHCMSGDATA）

- [命令功能](#ZH-CN_CONCEPT_0259104067__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259104067__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259104067__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259104067__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259104067__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259104067__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259104067)

该命令用于查询SSH客户端与其他组件交互的消息数据。

#### [注意事项](#ZH-CN_CONCEPT_0259104067)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0259104067)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259104067)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259104067)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 消息数据 | SSH客户端与其他组件的消息交互数据。 |
