# 删除服务化接口链路集（DEL SBILINKSET）

- [命令功能](#ZH-CN_MMLREF_0000001183653654__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001183653654__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001183653654__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001183653654__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001183653654)

![](删除服务化接口链路集（DEL SBILINKSET）_83653654.assets/notice_3.0-zh-cn.png)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001183653654)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001183653654)
...
## [使用实例](#ZH-CN_MMLREF_0000001183653654)
