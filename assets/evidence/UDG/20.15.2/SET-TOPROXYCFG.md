# 设置TCP代理配置（SET TOPROXYCFG）

- [命令功能](#ZH-CN_CONCEPT_0000201531379105__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201531379105__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201531379105__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201531379105__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201531379105__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201531379105)

**适用NF：UPF**

该命令用于设置TCP代理配置。

#### [注意事项](#ZH-CN_CONCEPT_0000201531379105)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000201531379105)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201531379105)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201531379105)
