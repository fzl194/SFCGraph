...
- [命令功能](#ZH-CN_CONCEPT_0301905960__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0301905960__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0301905960__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0301905960__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0301905960__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0301905960)

**适用NF：PGW-U、UPF**

该命令用于配置应用的流信息上报开关。流信息的上报功能是指对于需要进行检测上报的应用，在上报应用开始/结束上报时，同时上报当前业务的流信息，便于PCRF/PCF能够获取到应用与流的对应关系，从而可以下发更精确地策略对业务进行控制。

#### [注意事项](#ZH-CN_CONCEPT_0301905960)

- 该命令执行后立即生效。
- 该命令最大记录数为8000。

#### [操作用户权限](#ZH-CN_CONCEPT_0301905960)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0301905960)
