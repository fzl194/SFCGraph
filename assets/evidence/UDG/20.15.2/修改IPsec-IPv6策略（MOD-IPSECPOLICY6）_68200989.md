# 修改IPsec IPv6策略（MOD IPSECPOLICY6）

- [命令功能](#ZH-CN_MMLREF_0000001168200989__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001168200989__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001168200989__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001168200989__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001168200989)

![](修改IPsec IPv6策略（MOD IPSECPOLICY6）_68200989.assets/notice_3.0-zh-cn.png)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001168200989)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001168200989)
...
## [使用实例](#ZH-CN_MMLREF_0000001168200989)
