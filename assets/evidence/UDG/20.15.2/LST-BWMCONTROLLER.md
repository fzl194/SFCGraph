# 查询带宽管理控制器（LST BWMCONTROLLER）

- [命令功能](#ZH-CN_CONCEPT_0182837463__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837463__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837463__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837463__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837463__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837463__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837463)

**适用NF：PGW-U、UPF**

该命令用于查询指定bwm控制器的带宽控制信息。

#### [注意事项](#ZH-CN_CONCEPT_0182837463)

该命令显示BwmController的信息，如果不指定可选参数，该命令将显示所有BwmController的信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837463)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837463)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837463)

参见ADD BWMCONTROLLER的参数说明。
