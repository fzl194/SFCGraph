# 设置ApnQosAttr配置（SET APNQOSATTR）

- [命令功能](#ZH-CN_CONCEPT_0182837665__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837665__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837665__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837665__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837665__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837665)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于设置指定APN的带宽控制功能开关。

#### [注意事项](#ZH-CN_CONCEPT_0182837665)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837665)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837665)
