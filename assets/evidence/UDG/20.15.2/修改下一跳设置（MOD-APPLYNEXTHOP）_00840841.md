# 修改下一跳设置（MOD APPLYNEXTHOP）

- [命令功能](#ZH-CN_CONCEPT_0000001600840841__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600840841__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600840841__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600840841__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600840841__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600840841)

该命令用于修改配置路由下一跳。

#### [注意事项](#ZH-CN_CONCEPT_0000001600840841)

- 该命令执行后立即生效。
- 配置该命令前，必须已经配置了指定路由策略的名字以及该策略下的节点。
- 当参数ISPEERADDRESS配置为TRUE时，不能配置参数NEXTHOP、NEXTHOPTYPE和IFNAME。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600840841)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600840841)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600840841)
