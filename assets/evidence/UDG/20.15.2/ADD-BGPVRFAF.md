# 增加BGP VPN地址族（ADD BGPVRFAF）

- [命令功能](#ZH-CN_CONCEPT_0000001600865685__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600865685__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600865685__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600865685__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600865685__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600865685)

该命令用于添加BGP公网地址族以及BGP VPN实例地址族。BGP VPN实例下可以有多个地址族。

BGP VPN实例创建的时候会默认创建IPv4的地址族。

#### [注意事项](#ZH-CN_CONCEPT_0000001600865685)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600865685)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600865685)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600865685)
