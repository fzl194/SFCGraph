...
- [命令功能](#ZH-CN_CONCEPT_0283909784__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0283909784__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0283909784__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0283909784__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0283909784__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0283909784)

**适用NF：PGW-U、UPF**

该命令用于添加EDNS的相关配置。配置EDNS功能，可以将用户相关信息插入DNS协议内部，传递给Web服务器。Web服务器获取到这些信息以后可以用于支持更多的DNS请求业务。

#### [注意事项](#ZH-CN_CONCEPT_0283909784)

- 该命令执行后立即生效。
- 该命令最大记录数为100。
- 只支持UDP的DNS，不支持TCP的DNS。
- 整机最多支持100个不同名称的EDNS的实例配置。
- 当前只有MSISDN、IMSI和IMEI数据类型支持加密算法配置为RSA2048、RSA3072。
- 本命令属于高危命令，操作不当会导致性能下降明显，执行命令前请评估对性能的影响，如果无法评估请联系华为技术支持。

#### [操作用户权限](#ZH-CN_CONCEPT_0283909784)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0283909784)
...
#### [使用实例](#ZH-CN_CONCEPT_0283909784)

假如运营商希望在DNS报文中插入值为“test”的字符串, OptionCode为10：

```
ADD EDNS: EDNSNAME="edns1", DATATYPE=USERDEF1, OPTIONCODE=10, USERDEFINEVAL="test";
```
