# 清除资源单元复位信息（CLR RESETINFO）

- [命令功能](#ZH-CN_CONCEPT_0259103830__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103830__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103830__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103830__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103830__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103830)

该命令用于清除资源单元复位信息。当不需要查看资源单元的历史复位信息时，执行该命令可以用来清除资源单元复位信息。

#### [注意事项](#ZH-CN_CONCEPT_0259103830)

- 该命令执行后立即生效。
- 执行该命令后，用户将无法查到该命令生效时间点之前的资源单元复位信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103830)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103830)
