# 显示动态Diameter AAA服务器（DSP UPDYNDIAMAAA）

- [命令功能](#ZH-CN_CONCEPT_0000206297080183__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206297080183__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206297080183__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206297080183__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206297080183__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000206297080183__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206297080183)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206297080183)

- 该命令相关的功能20.13版本暂不支持。
- 相同的动态Diameter AAA主机列表如果在多个Pod上都有，只会显示一条记录。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206297080183)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206297080183)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206297080183)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000206297080183)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 主机名 | 用于指定动态Diameter AAA的主机名。 |
| 域名 | 用于指定Diameter服务器的realm名。 |
| POD名称 | 用于指定POD名称。 |
