# 设置外联口报文调测规则（OPR FEIEXTPORTPKTDEBUGRULE）

- [命令功能](#ZH-CN_CONCEPT_0000001600600837__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600600837__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600600837__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600600837__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600600837__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600600837)

在报文调测的场景中，该命令用于设置外联口报文调测规则。

#### [注意事项](#ZH-CN_CONCEPT_0000001600600837)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600600837)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600600837)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600600837)
