# 修改扩展策略配置（MOD EXTENDPOLICY）

- [命令功能](#ZH-CN_CONCEPT_0235373569__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0235373569__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0235373569__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0235373569__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0235373569__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0235373569)

**适用NF：PGW-U、UPF**

该命令用于修改基于规则的扩展策略，其中包含扩展策略类型、业务属性、策略类型、Tethering策略类型和对应的策略。经过运营商的报文根据其匹配结果执行对应策略。

#### [注意事项](#ZH-CN_CONCEPT_0235373569)

- 该命令执行后对新数据流生效。
- 修改或删除扩展策略配置时，如果不输入SRVPROPNAME参数，表示修改或删除SRVPROPNAME为空的EXTENDPOLICY记录。

#### [操作用户权限](#ZH-CN_CONCEPT_0235373569)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0235373569)
