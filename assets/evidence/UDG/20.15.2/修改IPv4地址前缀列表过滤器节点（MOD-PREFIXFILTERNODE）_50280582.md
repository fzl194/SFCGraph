# 修改IPv4地址前缀列表过滤器节点（MOD PREFIXFILTERNODE）

- [命令功能](#ZH-CN_CONCEPT_0000001550280582__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280582__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280582__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280582__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280582__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280582)

该命令用于修改前缀过滤器相关属性。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280582)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280582)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280582)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280582)
