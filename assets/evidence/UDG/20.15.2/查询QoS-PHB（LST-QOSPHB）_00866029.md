# 查询QoS PHB（LST QOSPHB）

- [命令功能](#ZH-CN_CONCEPT_0000001600866029__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600866029__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600866029__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600866029__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600866029__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001600866029__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600866029)

该命令用来查看当前域的下行IP报文在路由器内部的服务等级，还有相应的报文着色如何映射成对应的外部优先标识。

#### [注意事项](#ZH-CN_CONCEPT_0000001600866029)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600866029)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600866029)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600866029)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001600866029)
