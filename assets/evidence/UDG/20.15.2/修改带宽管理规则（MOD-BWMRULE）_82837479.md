# 修改带宽管理规则（MOD BWMRULE）

- [命令功能](#ZH-CN_CONCEPT_0182837479__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837479__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837479__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837479__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837479__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837479)

**适用NF：PGW-U、UPF**

该命令用于修改一条默认用户组、或具体用户组的业务带宽控制规则。当运营商希望修改控制规则的用户业务类型、用户属性、控制器和优先级时，则执行该命令。

#### [注意事项](#ZH-CN_CONCEPT_0182837479)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837479)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837479)
