# 增加BGP多源对等体（ADD BGPMULTIPEER）

- [命令功能](#ZH-CN_CONCEPT_0000001550120886__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550120886__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550120886__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550120886__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550120886__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550120886)

该命令用于创建BGP多源对等体。当需要支持多个接口处理单元上的同网段IP地址与远端的同一个IP地址建立多个对等体关系时，可以执行此命令。

#### [注意事项](#ZH-CN_CONCEPT_0000001550120886)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550120886)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550120886)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550120886)
