# 显示APN和地址池组映射关系（LST APNREFPOOLGRP）

- [命令功能](#ZH-CN_CONCEPT_0206054821__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0206054821__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0206054821__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0206054821__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0206054821__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0206054821__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0206054821)

**适用NF：PGW-U、UPF**

该命令用于显示指定地址池组，若干APN通过地址池组映射关系映射到该地址池组。

#### [注意事项](#ZH-CN_CONCEPT_0206054821)

通过LST POOLGRPMAP可以查看地址池组映射关系，如果地址池组映射关系没有APN参数，则LST APNREFPOOLGRP命令会显示所有映射到该地址组受影响的APN信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0206054821)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0206054821)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0206054821)
