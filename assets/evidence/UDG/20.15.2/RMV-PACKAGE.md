...
- [命令功能](#ZH-CN_CONCEPT_0259103573__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103573__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103573__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103573__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103573__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103573)

该命令用于删除指定版本的基础包、风险排查包、补丁包以及DB翻译包等软件包。

#### [注意事项](#ZH-CN_CONCEPT_0259103573)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0259103573)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103573)
...
#### [使用实例](#ZH-CN_CONCEPT_0259103573)

- 删除风险排查包：
  ```
  RMV PACKAGE:PACKAGETYPE=RiskCheckPackage,VERSIONTYPE=BaseSoftware,VERSIONID="ck0820S4",APPTYPE="BaseApp"
  ,SERVICEINSTANCE="vnfc"
  ;
  ```
- 只删除补丁池：
  ```
  RMV PACKAGE:PACKAGETYPE=Version,VERSIONTYPE=HotPatch,APPTYPE="BaseApp",VERSIONID="FENIXSPH255H",CPUARCHTYPE=Any,ISFORCE=FALSE,ONLYREMOVEPOOL=TRUE
  ,SERVICEINSTANCE="vnfc"
  ;
  ```
- 删除异构CPU类型的软件包：
  ```
  RMV PACKAGE:PACKAGETYPE=Version,VERSIONTYPE=BaseSoftware,APPTYPE="BaseApp",VERSIONID="V100R020C20SPC200B010",CPUARCHTYPE=ARM,ISFORCE=TRUE
  ,SERVICEINSTANCE="vnfc"
  ;
  ```
