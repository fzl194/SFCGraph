# 添加CP白名单（ADD CPACCESSLIST）

- [命令功能](#ZH-CN_CONCEPT_0186530485__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0186530485__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0186530485__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0186530485__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0186530485__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0186530485)

**适用NF：SGW-U、PGW-U、UPF**

该命令用来配置CP的白名单列表。白名单可以是CP的NodeID也可以为CP发送消息的源IP地址。

#### [注意事项](#ZH-CN_CONCEPT_0186530485)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0186530485)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0186530485)
