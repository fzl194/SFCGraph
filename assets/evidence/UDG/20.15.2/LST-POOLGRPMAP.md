# 显示地址池组映射关系（LST POOLGRPMAP）

- [命令功能](#ZH-CN_CONCEPT_0182837150__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837150__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837150__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837150__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837150__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837150__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837150)

**适用NF：PGW-U、UPF**

该命令用于显示指定映射规则名称或所有的地址池组与TAC-Group/LAC-Group、APN、SMF之间的映射关系。

#### [注意事项](#ZH-CN_CONCEPT_0182837150)

- 该命令执行后只对新激活用户生效。
- 该命令指定映射规则名称时，表示查询指定地址池组与TAC-Group/LAC-Group、APN、SMF之间的映射关系。该命令不指定映射规则名称时，表示查询所有地址池组与TAC-Group/LAC-Group、APN、SMF之间的映射关系。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837150)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837150)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837150)

参见ADD POOLGRPMAP的参数说明。
