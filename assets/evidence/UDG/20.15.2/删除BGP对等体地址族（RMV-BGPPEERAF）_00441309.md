# 删除BGP对等体地址族（RMV BGPPEERAF）

- [命令功能](#ZH-CN_CONCEPT_0000001600441309__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600441309__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600441309__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600441309__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600441309__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600441309)

该命令用于删除BGP IPv4或IPv6对等体地址族。

![](删除BGP对等体地址族（RMV BGPPEERAF）_00441309.assets/notice_3.0-zh-cn.png)

本命令属于高危命令，该操作会导致对等体重新连接。

#### [注意事项](#ZH-CN_CONCEPT_0000001600441309)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600441309)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600441309)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600441309)
