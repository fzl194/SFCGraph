# 修改指定L2TP组（MOD L2TPGROUP）

- [命令功能](#ZH-CN_CONCEPT_0235373525__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0235373525__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0235373525__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0235373525__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0235373525__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0235373525)

**适用NF：PGW-U、UPF**

该命令用于修改本地配置的L2TP组的信息，当需要修改本地配置的L2TP组的相关信息时，使用此命令。

#### [注意事项](#ZH-CN_CONCEPT_0235373525)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0235373525)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0235373525)
