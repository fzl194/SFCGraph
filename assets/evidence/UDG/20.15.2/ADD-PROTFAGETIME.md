# 增加协议五元组老化时间（ADD PROTFAGETIME）

- [命令功能](#ZH-CN_CONCEPT_0182837295__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837295__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837295__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837295__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837295__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837295)

**适用NF：PGW-U、UPF**

该命令用于配置不同的协议组、协议相关的五元组老化时间。目的是在不影响系统正常业务的前提下，充分利用系统的五元组资源。

#### [注意事项](#ZH-CN_CONCEPT_0182837295)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837295)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837295)
