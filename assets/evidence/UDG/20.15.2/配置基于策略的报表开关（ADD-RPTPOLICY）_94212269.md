# 配置基于策略的报表开关（ADD RPTPOLICY）

- [命令功能](#ZH-CN_CONCEPT_0000201294212269__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201294212269__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201294212269__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201294212269__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201294212269__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201294212269)

**适用NF：PGW-U、UPF**

此命令用于配置指定策略的业务报表功能开关。

#### [注意事项](#ZH-CN_CONCEPT_0000201294212269)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000201294212269)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201294212269)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201294212269)
