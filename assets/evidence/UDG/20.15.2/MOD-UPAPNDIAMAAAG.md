# 修改APN的Diameter AAA服务器组（MOD UPAPNDIAMAAAG）

- [命令功能](#ZH-CN_CONCEPT_0000206145432718__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206145432718__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206145432718__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206145432718__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206145432718__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206145432718)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206145432718)

- 该命令执行后对新接入的会话生效。
- 当修改Diameter AAA组和APN的绑定关系时，已经建立的会话不受影响，但新建立的会话将按更新后的绑定关系进行关联Diameter AAA的选取。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206145432718)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206145432718)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206145432718)
