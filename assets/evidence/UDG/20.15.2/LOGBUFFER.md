# 显示Logbuffer中的数据（DSP LOGBUFFER）

- [命令功能](#ZH-CN_CONCEPT_0259103460__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103460__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103460__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103460__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103460__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259103460__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103460)

该命令用于显示日志缓冲区内容，包括操作日志、事件日志、告警日志和安全日志。

#### [注意事项](#ZH-CN_CONCEPT_0259103460)

若日志记录的命令中含有“+++”和“--- END”等MML输出信息开始和结束标志，可能导致此命令查询的日志信息不全。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103460)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103460)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259103460)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 日志级别 | 日志级别。 |
| 日志内容 | 日志的内容，包含日志的产生时间、所属特性、名称、类型等。 |
