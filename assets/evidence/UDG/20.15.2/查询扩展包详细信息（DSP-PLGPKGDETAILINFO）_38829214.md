# 查询扩展包详细信息（DSP PLGPKGDETAILINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001238829214__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001238829214__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001238829214__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001238829214__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001238829214__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001238829214__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001238829214)

该命令用于显示扩展包详细信息，包括扩展包单元文件名、类型及生效时间等。

扩展包的激活、删除会触发扩展包单元状态的变化，使用该命令显示系统当前的扩展包单元状态信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001238829214)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001238829214)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001238829214)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001238829214)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001238829214)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 扩展包名称 | 表示扩展包单元所属的扩展包名称。 |
| RU名称 | 表示扩展包单元所属的RU名称。 |
| 进程ID | 表示扩展包单元所属进程ID。 |
| 类型 | 表示扩展包单元类型。 |
| 生效时间 | 表示扩展包单元生效时间。 |
