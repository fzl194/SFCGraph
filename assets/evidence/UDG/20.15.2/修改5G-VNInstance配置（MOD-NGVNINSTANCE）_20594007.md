# 修改5G VNInstance配置（MOD NGVNINSTANCE）

- [命令功能](#ZH-CN_CONCEPT_0000202020594007__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202020594007__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202020594007__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202020594007__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202020594007__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202020594007)

**适用NF：UPF**

该命令用于更新一个5G LAN会话实例下的配置参数。

#### [注意事项](#ZH-CN_CONCEPT_0000202020594007)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000202020594007)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202020594007)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202020594007)
