# 修改扩展的多级重定向密码（MOD MULTREDIRECTEX）

- [命令功能](#ZH-CN_CONCEPT_0000204119543972__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000204119543972__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000204119543972__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000204119543972__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000204119543972__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000204119543972)

**适用NF：PGW-U、UPF**

该命令用于修改多级重定向字段加密的密码。

#### [注意事项](#ZH-CN_CONCEPT_0000204119543972)

- 该命令执行后立即生效。
- 该命令与软参BIT_1704配合使用。

#### [操作用户权限](#ZH-CN_CONCEPT_0000204119543972)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000204119543972)
...
#### [使用实例](#ZH-CN_CONCEPT_0000204119543972)
