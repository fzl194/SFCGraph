# 设置SCTP全局参数（SET UPGLBSCTPPARA）

- [命令功能](#ZH-CN_CONCEPT_0000206297314591__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206297314591__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206297314591__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206297314591__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206297314591__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206297314591)

**适用NF：UPF**

此命令用于设置SCTP全局参数。

#### [注意事项](#ZH-CN_CONCEPT_0000206297314591)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000206297314591)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206297314591)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206297314591)
