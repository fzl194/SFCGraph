# 添加BGP对等体分组（ADD UPDBGPPEERGROUP）

- [命令功能](#ZH-CN_TOPIC_0000001699341632__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001699341632__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000001699341632__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000001699341632__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000001699341632__1.3.5.1)

#### [命令功能](#ZH-CN_TOPIC_0000001699341632)

该命令用于增加IPv4或IPv6对等体分组。

#### [注意事项](#ZH-CN_TOPIC_0000001699341632)
...
#### [操作用户权限](#ZH-CN_TOPIC_0000001699341632)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000001699341632)
...
#### [使用实例](#ZH-CN_TOPIC_0000001699341632)
