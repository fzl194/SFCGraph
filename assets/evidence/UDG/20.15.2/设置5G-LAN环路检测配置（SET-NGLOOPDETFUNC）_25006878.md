# 设置5G LAN环路检测配置（SET NGLOOPDETFUNC）

- [命令功能](#ZH-CN_CONCEPT_0000206725006878__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206725006878__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206725006878__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206725006878__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206725006878__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206725006878)

**适用NF：UPF**

该命令用于设置指定5G LAN组的环路检测功能开关。

#### [注意事项](#ZH-CN_CONCEPT_0000206725006878)

- 该命令执行后立即生效。
- 该命令最大记录数为512。
- 5G LAN组实例存在。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206725006878)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206725006878)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206725006878)
