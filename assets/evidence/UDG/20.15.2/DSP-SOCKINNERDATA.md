# 查询SOCK诊断信息（DSP SOCKINNERDATA）

- [命令功能](#ZH-CN_CONCEPT_0000001550121446__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121446__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121446__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121446__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121446__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001550121446__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121446)

该命令用于查询SOCK诊断信息。

指定查询类型为APP_BLACK_BOX时，CID为必选参数。指定查询类型为INSTANCE_TRACE时，CID为可选参数。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121446)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121446)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121446)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121446)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001550121446)
