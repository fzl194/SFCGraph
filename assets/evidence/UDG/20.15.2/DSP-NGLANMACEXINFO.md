# 显示5G LAN MAC地址超规格信息（DSP NGLANMACEXINFO）

- [命令功能](#ZH-CN_CONCEPT_0000205923157708__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000205923157708__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000205923157708__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000205923157708__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000205923157708__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000205923157708__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000205923157708)

**适用NF：UPF**

该命令用于显示5G LAN MAC地址超规格信息。

#### [注意事项](#ZH-CN_CONCEPT_0000205923157708)

此命令每次最多显示10个MAC地址超限的用户信息。清除无效的MAC地址后，如果告警依然存在，请重新执行该命令。

#### [操作用户权限](#ZH-CN_CONCEPT_0000205923157708)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000205923157708)
...
#### [使用实例](#ZH-CN_CONCEPT_0000205923157708)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000205923157708)

| 输出项名称 | 输出项解释 |
| --- | --- |
| Result | 结果信息，显示超过规格的用户、双发选收结对信息。 |
