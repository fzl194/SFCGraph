# 查询CSLB进程信息(DSP PROCESSCSLB)

- [命令功能](#ZH-CN_CONCEPT_0185585647__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0185585647__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0185585647__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0185585647__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0185585647__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0185585647__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0185585647)

该命令用于请求系统显示进程的状态信息和静态配置信息。

#### [注意事项](#ZH-CN_CONCEPT_0185585647)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0185585647)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0185585647)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0185585647)
...
| 进程状态 | 查询的进程可用状态<br>- 正常表示进程状态可用<br>- 异常表示进程状态不可用 |
