# 查询带宽管理用户组（LST BWMUSERGROUP）

- [命令功能](#ZH-CN_CONCEPT_0182837471__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837471__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837471__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837471__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837471__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837471__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837471)

**适用NF：PGW-U、UPF**

该命令用于查询带宽管理用户组。当运营商希望查询某用户组或所有用户组的名称、优先级、业务类型等参数时，执行该命令。

#### [注意事项](#ZH-CN_CONCEPT_0182837471)

如果不指定用户组名称，则查询所有已配置的用户组信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837471)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837471)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837471)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 用户组类型 | 用于配置带宽管理用户组的类型。 |

其余输出项请参见ADD BWMUSERGROUP的参数说明。
