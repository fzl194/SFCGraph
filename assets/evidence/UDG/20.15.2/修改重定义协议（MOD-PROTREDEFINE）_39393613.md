# 修改重定义协议（MOD PROTREDEFINE）

- [命令功能](#ZH-CN_CONCEPT_0000201539393613__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201539393613__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201539393613__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201539393613__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201539393613__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201539393613)

**适用NF：PGW-U、UPF**

该命令用来修改重定义协议类型，可以配置源和目的协议名称以及对应的filter，系统能够将符合filter条件的源协议重定义为目的协议。

#### [注意事项](#ZH-CN_CONCEPT_0000201539393613)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000201539393613)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201539393613)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201539393613)
