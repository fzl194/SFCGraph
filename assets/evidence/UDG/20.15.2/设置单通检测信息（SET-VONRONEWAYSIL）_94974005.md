# 设置单通检测信息（SET VONRONEWAYSIL）

- [命令功能](#ZH-CN_CONCEPT_0000203294974005__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203294974005__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203294974005__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203294974005__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203294974005__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203294974005)

**适用NF：UPF**

该命令用于设置单通检测的开关、丢包率和MOS周期。

#### [注意事项](#ZH-CN_CONCEPT_0000203294974005)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000203294974005)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203294974005)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203294974005)
