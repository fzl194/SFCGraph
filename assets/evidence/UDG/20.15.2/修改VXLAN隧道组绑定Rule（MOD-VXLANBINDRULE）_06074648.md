# 修改VXLAN隧道组绑定Rule（MOD VXLANBINDRULE）

- [命令功能](#ZH-CN_CONCEPT_0000202006074648__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202006074648__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202006074648__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202006074648__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202006074648__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202006074648)

**适用NF：PGW-U、UPF**

该命令用于修改VXLAN隧道组与Rule的绑定关系。

#### [注意事项](#ZH-CN_CONCEPT_0000202006074648)

- 该命令执行后立即生效。
- 执行该命令时，修改Rule绑定的Vxlan组会改变业务流的转发流程,匹配到该rule的数据报文会转发到新的MEP。

#### [操作用户权限](#ZH-CN_CONCEPT_0000202006074648)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202006074648)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202006074648)
