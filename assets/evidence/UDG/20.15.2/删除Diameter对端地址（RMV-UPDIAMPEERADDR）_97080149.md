# 删除Diameter对端地址（RMV UPDIAMPEERADDR）

- [命令功能](#ZH-CN_CONCEPT_0000206297080149__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206297080149__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206297080149__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206297080149__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206297080149__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206297080149)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206297080149)

- 该命令执行后立即生效。
- 删除Diameter链路的对端地址信息时，必须输入地址所属的主机名称，并且该主机在UPF上已经配置。
- 删除Diameter链路的对端地址时，对应的Diameter链路也会同时删除。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206297080149)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206297080149)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206297080149)
