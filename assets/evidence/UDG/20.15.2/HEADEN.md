...
- [命令功能](#ZH-CN_CONCEPT_0186527861__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0186527861__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0186527861__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0186527861__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0186527861__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0186527861__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0186527861)

**适用NF：PGW-U、UPF**

该命令用于查询头增强全部配置信息，或根据输入名称显示指定头增强的配置信息，查询已加入的头增强功能。

#### [注意事项](#ZH-CN_CONCEPT_0186527861)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0186527861)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0186527861)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0186527861)
