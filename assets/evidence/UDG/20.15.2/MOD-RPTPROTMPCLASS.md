# 修改业务报表映射承载协议分类配置（MOD RPTPROTMPCLASS）

- [命令功能](#ZH-CN_CONCEPT_0000203719172446__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203719172446__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203719172446__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203719172446__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203719172446__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203719172446)

**适用NF：PGW-U、UPF**

该命令用于修改业务报表映射承载协议分类配置。

#### [注意事项](#ZH-CN_CONCEPT_0000203719172446)

- 该命令执行后立即生效。
- 如果引用了该业务报表映射承载协议分类配置的映射记录存在，则仅允许修改映射承载协议分类索引参数，修改后的承载协议分类索引与其他映射承载协议分类配置中的承载协议分类索引不冲突。

#### [操作用户权限](#ZH-CN_CONCEPT_0000203719172446)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203719172446)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203719172446)
