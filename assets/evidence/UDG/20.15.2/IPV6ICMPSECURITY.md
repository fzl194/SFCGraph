# 添加IPv6安全配置（ADD IPV6ICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001600840585__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600840585__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600840585__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600840585__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600840585__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600840585)

该命令用于添加IPv6安全配置。在需要对ICMPv6报文控制的场景使用。

#### [注意事项](#ZH-CN_CONCEPT_0000001600840585)

- 该命令执行后立即生效。
- 该命令最大记录数为131070。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600840585)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600840585)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600840585)
