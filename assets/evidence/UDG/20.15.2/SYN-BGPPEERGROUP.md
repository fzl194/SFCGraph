# 刷新对等体组（SYN BGPPEERGROUP）

- [命令功能](#ZH-CN_CONCEPT_0000001550121346__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121346__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121346__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121346__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121346__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121346)

该命令用于刷新BGP对等体组的路由信息。

当BGP对等体组的配置发生变化后，如果需要使新的配置立即生效，可以执行SYN BGPPEERGROUP命令。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121346)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121346)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121346)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121346)
