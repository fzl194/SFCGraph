# 查询PIM接口无效报文统计（DSP PIMINVPKTCNTIF）

- [命令功能](#ZH-CN_CONCEPT_0000001549802070__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802070__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802070__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802070__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802070__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001549802070__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802070)

该命令用于显示PIM接口无效报文统计。

#### [注意事项](#ZH-CN_CONCEPT_0000001549802070)

该命令仅适用于非NP卡场景和NP卡非加速模式场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802070)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802070)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802070)

显示PIM接口无效报文统计：

```
DSP PIMINVPKTCNTIF:VRFNAME="_public_",ADDRESSFAMILY=ipv4unicast,IFNAME="Ethernet64/0/3";
```
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001549802070)
...
| 无效报文源地址的PIM Hello报文计数 | 用来表示无效报文源地址的PIM Hello报文计数。 |
