# 修改自定义协议（MOD PROTOCOLDEFINE）

- [命令功能](#ZH-CN_CONCEPT_0182837328__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837328__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837328__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837328__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837328__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837328)

**适用NF：PGW-U、UPF**

该命令用来修改自定义协议类型，可以配置自定义协议所属协议大类，带服务器IP地址、端口范围、或HOST值的过滤器，以及协议识别匹配时的优先级，通过该命令的设置，系统可以根据设置的IP地址、端口或HOST值识别出7层协议类型。

#### [注意事项](#ZH-CN_CONCEPT_0182837328)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837328)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837328)
