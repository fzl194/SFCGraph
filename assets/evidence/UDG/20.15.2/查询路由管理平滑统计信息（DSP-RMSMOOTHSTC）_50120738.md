# 查询路由管理平滑统计信息（DSP RMSMOOTHSTC）

- [命令功能](#ZH-CN_CONCEPT_0000001550120738__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550120738__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550120738__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550120738__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550120738__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001550120738__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550120738)

该命令用来查询路由管理平滑统计信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001550120738)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550120738)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550120738)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550120738)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001550120738)
...
| 总的平滑次数 | 用于表示总的平滑次数。 |
| 拒绝的平滑次数 | 用于表示拒绝的平滑次数。 |
| 最后一次平滑开始的时间 | 用于表示最后一次平滑开始的时间。 |
| 最后一次平滑结束的时间 | 用于表示最后一次平滑结束的时间。 |
