# 修改SCTP模板（MOD UPSCTPTEMPLATE）

- [命令功能](#ZH-CN_CONCEPT_0000206145195210__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206145195210__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206145195210__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206145195210__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206145195210__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206145195210)

**适用NF：UPF**

此命令用于修改SCTP模板，根据现网规划，当UPF使用SCTP承载逻辑接口信令时，可以使用此命令修改SCTP协议参数。

#### [注意事项](#ZH-CN_CONCEPT_0000206145195210)

命令执行后对新建立的SCTP链路生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206145195210)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206145195210)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206145195210)
