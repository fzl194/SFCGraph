# 添加用户策略选择（ADD USERSELPLCY）

- [命令功能](#ZH-CN_CONCEPT_0283909788__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0283909788__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0283909788__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0283909788__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0283909788__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0283909788)

**适用NF：UPF**

该命令用来添加用户选择策略，应用于该策略选定用户的性能统计。

#### [注意事项](#ZH-CN_CONCEPT_0283909788)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0283909788)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0283909788)
