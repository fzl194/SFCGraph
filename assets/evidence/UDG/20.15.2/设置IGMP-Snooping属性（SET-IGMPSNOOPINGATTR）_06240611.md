# 设置IGMP Snooping属性（SET IGMPSNOOPINGATTR）

- [命令功能](#ZH-CN_CONCEPT_0000207006240611__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207006240611__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207006240611__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207006240611__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207006240611__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207006240611)

**适用NF：UPF**

该命令用于设置指定5G LAN组的IGMP Snooping功能相关属性。

#### [注意事项](#ZH-CN_CONCEPT_0000207006240611)

- 该命令执行后立即生效。
- 该命令最大记录数为512。

#### [操作用户权限](#ZH-CN_CONCEPT_0000207006240611)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207006240611)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207006240611)
