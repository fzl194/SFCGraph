# 删除软件仓软件（RMV SOFTWARE）

- [命令功能](#ZH-CN_CONCEPT_0259036626__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259036626__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259036626__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259036626__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259036626__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259036626)

![](删除软件仓软件（RMV SOFTWARE）_59036626.assets/notice_3.0-zh-cn.png)

本命令属于高危命令，该命令会删除VNFP管理的软件包，操作不当可能导致VNFC无法创建或者运行异常，请谨慎使用并联系华为支持协助操作。

该命令用来删除软件仓软件。

#### [注意事项](#ZH-CN_CONCEPT_0259036626)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0259036626)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259036626)
