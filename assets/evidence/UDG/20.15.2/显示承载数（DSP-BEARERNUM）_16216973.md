...
- [命令功能](#ZH-CN_CONCEPT_0216216973__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0216216973__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0216216973__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0216216973__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0216216973__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0216216973__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0216216973)

**适用NF：SGW-U、PGW-U、UPF**

该命令用来查看当前在线承载个数。如果不输入参数表示显示整机的所有承载个数。

#### [注意事项](#ZH-CN_CONCEPT_0216216973)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0216216973)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0216216973)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0216216973)
