# 修改SA指纹识别配置（MOD FINGERIDENT）

- [命令功能](#ZH-CN_CONCEPT_0000202386288981__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202386288981__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202386288981__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202386288981__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202386288981__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202386288981)

**适用NF：PGW-U、UPF**

该命令用来修改SA指纹识别功能配置。

#### [注意事项](#ZH-CN_CONCEPT_0000202386288981)

- 该命令执行后立即生效。
- 该命令仅用于修改参数FingerIdentCtrl或CfgDomainName。

#### [操作用户权限](#ZH-CN_CONCEPT_0000202386288981)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202386288981)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202386288981)
