# 删除网关对IMSI/MSISDN指定的用户的运行信息进行收集配置（RMV USERRUNINFO）

- [命令功能](#ZH-CN_CONCEPT_0182837072__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837072__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837072__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837072__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837072__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837072)
...
#### [注意事项](#ZH-CN_CONCEPT_0182837072)

- 该命令执行后立即生效。
- 对IMSI/MSISDN指定的用户生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837072)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837072)
