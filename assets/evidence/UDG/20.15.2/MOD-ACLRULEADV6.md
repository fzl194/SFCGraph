# 修改高级IPv6 ACL规则（MOD ACLRULEADV6）

- [命令功能](#ZH-CN_CONCEPT_0000001550121542__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121542__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121542__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121542__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121542__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121542)

该命令用于修改高级IPv6 ACL规则的配置，可以修改源目的IP，端口号等信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121542)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121542)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121542)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121542)
