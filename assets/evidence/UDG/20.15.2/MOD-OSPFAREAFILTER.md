# 修改区域过滤策略配置（MOD OSPFAREAFILTER）

- [命令功能](#ZH-CN_CONCEPT_0000001550120818__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550120818__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550120818__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550120818__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550120818__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550120818)

该命令用于修改对区域内的Type 3 LSA进行过滤配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001550120818)

- 该命令执行后立即生效。
- 只有配置了OSPF进程和OSPF区域后才能使用此命令。
- 此命令仅在ABR上配置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550120818)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550120818)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550120818)
