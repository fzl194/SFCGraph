# 绑定TAC号段到TAI组（ADD TAIGROUPBINDING）

- [命令功能](#ZH-CN_CONCEPT_0000204419929304__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000204419929304__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000204419929304__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000204419929304__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000204419929304__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000204419929304)

**适用NF：SGW-U、PGW-U、UPF**

该命令用来在TAI组内增加一个TAC号段。

#### [注意事项](#ZH-CN_CONCEPT_0000204419929304)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000204419929304)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000204419929304)
...
#### [使用实例](#ZH-CN_CONCEPT_0000204419929304)
