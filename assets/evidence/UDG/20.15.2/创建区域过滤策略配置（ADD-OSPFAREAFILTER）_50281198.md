# 创建区域过滤策略配置（ADD OSPFAREAFILTER）

- [命令功能](#ZH-CN_CONCEPT_0000001550281198__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281198__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281198__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281198__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281198__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281198)

该命令用于配置对区域内的Type 3 LSA进行过滤。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281198)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281198)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281198)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281198)
