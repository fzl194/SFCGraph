# 增加基础扩展团体属性过滤器节点（ADD EXTENDCOMMUNITYFILTERNODE）

- [命令功能](#ZH-CN_CONCEPT_0000001600440589__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440589__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440589__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440589__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440589__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440589)

该命令用于添加基础扩展团体属性过滤器节点。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440589)

- 该命令执行后立即生效。
- 该命令最大记录数为65535。
- 配置该命令前，必须已经通过ADD EXTENDCOMMUNITYFILTER配置了基本扩展团体过滤器的名字。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440589)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440589)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440589)
