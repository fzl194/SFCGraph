# 增加TWAMP客户端（ADD TWAMPCLIENT）

- [命令功能](#ZH-CN_MMLREF_0000001127102472__1.3.1)
- [注意事项](#ZH-CN_MMLREF_0000001127102472__1.3.2)
- [参数说明](#ZH-CN_MMLREF_0000001127102472__1.3.4)
- [使用实例](#ZH-CN_MMLREF_0000001127102472__1.3.5)

## [命令功能](#ZH-CN_MMLREF_0000001127102472)
...
#### [操作用户权限](#ZH-CN_MMLREF_0000001127102472)

G_1，管理员级别命令组；G_2，操作员级别命令组

## [参数说明](#ZH-CN_MMLREF_0000001127102472)

| 参数标识 | 参数名称 | 参数说明 |
| --- | --- | --- |
| CLIENTID | 客户端ID | 可选必选说明：必选参数<br>参数含义：该参数用于配置客户端ID。<br>数据来源：全网规划<br>取值范围：整数类型，取值范围是1~12000。<br>默认值：无<br>配置原则：无 |
| TWAMPARCH | TWAMP架构 | 可选必选说明：必选参数<br>参数含义：该参数用于指定TWAMP架构。<br>数据来源：全网规划<br>取值范围：<br>- LIGHT（LIGHT）<br>默认值：无<br>配置原则：无 |
...
## [使用实例](#ZH-CN_MMLREF_0000001127102472)

增加客户端ID为1的实例：

```
ADD TWAMPCLIENT: CLIENTID=1, TWAMPARCH=LIGHT, AFTYPE=IPV4, LOCALIPV4="10.0.0.0", PEERIPV4="192.168.0.0", LLOCALUDPPORT=65450, LPEERUDPPORT=1, VRFNAME="ck", DESCRIPTION="1";
```
