# 修改七层过滤器（MOD L7FILTER）

- [命令功能](#ZH-CN_CONCEPT_0186527044__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0186527044__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0186527044__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0186527044__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0186527044__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0186527044)

**适用NF：PGW-U、UPF**

此命令用于修改七层过滤条件相关内容，只有已经添加成功的L7Filter才能够修改。条件有URL/host、User-Agent，method等。URL可以包含*，不允许包含“http://”、“rtsp://”、“ftp://”等头部。

#### [注意事项](#ZH-CN_CONCEPT_0186527044)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0186527044)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0186527044)
