# 设置证书更新拆链配置（SET SRVCERTUPDCFG）

- [命令功能](#ZH-CN_CONCEPT_0000207394632059__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207394632059__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207394632059__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207394632059__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207394632059__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207394632059)

**适用NF：UPF、PGW-U**

该命令用于设置证书更新拆链配置参数。

#### [注意事项](#ZH-CN_CONCEPT_0000207394632059)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000207394632059)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207394632059)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207394632059)
