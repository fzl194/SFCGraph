# 设置接口带宽利用率告警阈值（SET IFFLOWALMTHD）

- [命令功能](#ZH-CN_CONCEPT_0000001600440541__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440541__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440541__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440541__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440541__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440541)

该命令用于设置接口带宽利用率告警阈值。

带宽利用率=（接口流量速率/接口带宽）*100，若超过阈值，则产生告警。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440541)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440541)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440541)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440541)
