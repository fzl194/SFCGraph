# 查询APN绑定的L2TP接口（LST L2TPRDSCLIENT）

- [命令功能](#ZH-CN_CONCEPT_0235373542__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0235373542__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0235373542__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0235373542__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0235373542__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0235373542__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0235373542)
...
#### [注意事项](#ZH-CN_CONCEPT_0235373542)

- 该命令执行后立即生效。
- 该命令不指定源端接口名称场景，只删除没有客户存在的绑定关系，可以使用LST L2TPRDSCLIENT命令查询删除结果。

#### [操作用户权限](#ZH-CN_CONCEPT_0235373542)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0235373542)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0235373542)

参见ADD L2TPRDSCLIENT的参数说明。
