# 显示SSH服务器的错误日志（DSP SSHSERRORLOG）

- [命令功能](#ZH-CN_CONCEPT_0259103912__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103912__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103912__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103912__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103912__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259103912__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103912)

该命令用于查询SSH服务器的错误日志。

#### [注意事项](#ZH-CN_CONCEPT_0259103912)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103912)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103912)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259103912)
