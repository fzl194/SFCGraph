# 显示进程信息（DSP RESPROCESSINFO）

- [命令功能](#ZH-CN_CONCEPT_0000001104641826__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001104641826__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001104641826__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001104641826__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001104641826__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0000001104641826__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001104641826)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001104641826)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001104641826)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001104641826)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001104641826)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0000001104641826)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 进程ID | 用于说明进程的编号。 |
| 进程类型 | 用于说明进程的类型。 |
| 资源名称 | 用于说明此进程所在的资源名称或容器名称。通过<br>[**DSP RES**](../../../系统管理/资源管理/资源实例管理/显示资源信息（DSP RES）_59036939.md)<br>命令可以查询资源信息。 |
| 进程组号 | 用于说明此进程所属的进程组号。 |
