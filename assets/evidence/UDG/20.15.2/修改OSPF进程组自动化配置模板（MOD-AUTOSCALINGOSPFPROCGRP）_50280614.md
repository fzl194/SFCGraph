# 修改OSPF进程组自动化配置模板（MOD AUTOSCALINGOSPFPROCGRP）

- [命令功能](#ZH-CN_CONCEPT_0000001550280614__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550280614__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550280614__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550280614__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550280614__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550280614)

该命令用于修改OSPF进程组自动化配置模板。

#### [注意事项](#ZH-CN_CONCEPT_0000001550280614)

- 该命令执行后立即生效。
- 修改该模板时，要保证该模板添加过。
- 该命令在自动化配置开关为关闭的状态下才能执行，请先使用SET AUTOCONFIG命令关闭自动配置开关；生效配置，需要再次使用SET AUTOCONFIG命令开启自动配置开关。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550280614)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550280614)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550280614)
