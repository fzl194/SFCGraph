...
- [命令功能](#ZH-CN_CONCEPT_0182837637__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837637__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837637__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837637__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837637__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837637__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837637)

**适用NF：PGW-U、UPF**

该命令用于查询使用量上报规则组。当运营商希望查询使用量上报规则组时，则执行该命令。

#### [注意事项](#ZH-CN_CONCEPT_0182837637)

如果不输入使用量上报规则组名称，表示查询系统中所有计费属性。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837637)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837637)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837637)
