...
- [命令功能](#ZH-CN_CONCEPT_0182837352__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837352__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837352__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837352__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837352__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837352)

**适用NF：PGW-U、UPF**

该命令用于删除过滤器。当运营商希望删除过滤器时，则配置该命令。

#### [注意事项](#ZH-CN_CONCEPT_0182837352)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837352)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837352)
