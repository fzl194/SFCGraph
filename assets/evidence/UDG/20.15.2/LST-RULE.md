...
- [命令功能](#ZH-CN_CONCEPT_0182837270__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837270__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837270__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837270__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837270__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837270__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837270)

**适用NF：PGW-U、UPF**

该命令用于查询规则。

#### [注意事项](#ZH-CN_CONCEPT_0182837270)

支持批量查询。如果不输入策略名称，则查询系统中所有的规则。如果输入了策略类型，则查询系统中配置为本策略类型的所有规则。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837270)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837270)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837270)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 黑名单规则标识 | 用于显示黑名单规则标识。 |
| PCC策略组名称 | 用于显示PCC策略组名称。 |
| 分类属性名称 | 用于显示分类属性名称。 |
| 头增强名称 | 用于显示头增强名称。 |
| Web Proxy IP-Farm名称 | 用于显示Web Proxy IP-Farm名称。 |
| Captive Portal IP-Farm名称 | 用于显示Captive Portal IP-Farm名称。 |
| 业务链名称 | 用于显示业务链名称。 |
| 防火墙策略名称 | 用于显示防火墙策略名称。 |
| Qos属性名称 | 用于显示QoS属性名称。 |
| URL重定向名称 | 用于设置URL重定向名称。 |
| DNS重写动作名字 | 用于指定DNS重写动作名字。 |
| 智能重定向名称 | 用于显示Http智能重定向名称。 |

其余输出项请参见ADD BLACKLISTRULE、ADD RULE的参数说明。
