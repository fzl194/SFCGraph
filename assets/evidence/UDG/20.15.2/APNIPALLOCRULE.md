# 显示基于APN分配地址的规则（LST APNIPALLOCRULE）

- [命令功能](#ZH-CN_CONCEPT_0182837166__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837166__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837166__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837166__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837166__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837166__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837166)

**适用NF：PGW-U、UPF**

该命令用于显示指定APN或全部的基于APN分配地址的规则。

#### [注意事项](#ZH-CN_CONCEPT_0182837166)

- 该命令执行后立即生效。
- 该命令指定APN实例名时，表示查询指定APN实例的基于APN的地址分配规则。不指定APN实例名时，表示查询所有基于APN的地址分配规则。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837166)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837166)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837166)

参见SET APNIPALLOCRULE的参数说明。
