# 显示设备当前已加载的NETCONF数据模型（DSP NCSDATAMODEL）

- [命令功能](#ZH-CN_CONCEPT_0259104259__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259104259__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259104259__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259104259__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259104259__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259104259__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259104259)

该命令用于显示设备当前已加载的NETCONF数据模型。

#### [注意事项](#ZH-CN_CONCEPT_0259104259)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0259104259)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259104259)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259104259)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 数据模型XML字符串 | NETCONF加载的数据模型XML。 |
