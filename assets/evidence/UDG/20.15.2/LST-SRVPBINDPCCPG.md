...
- [命令功能](#ZH-CN_CONCEPT_0182837614__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837614__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837614__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837614__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837614__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837614__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837614)

**适用NF：PGW-U、UPF**

此命令用于查询PCC策略组业务属性绑定组合。

#### [注意事项](#ZH-CN_CONCEPT_0182837614)

- 不输入查询条件，表示查询已经配置的所有PCC策略组业务属性绑定组合。
- 只输入PCCPOLICYGRPNM，表示查询指定名称的PCC策略组业务属性绑定组合。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837614)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837614)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837614)
