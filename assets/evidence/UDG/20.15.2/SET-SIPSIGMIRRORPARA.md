# 设置镜像SIP信令功能（SET SIPSIGMIRRORPARA）

- [命令功能](#ZH-CN_CONCEPT_0000205833682697__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000205833682697__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000205833682697__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000205833682697__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000205833682697__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000205833682697)

**适用NF：SGW-U、UPF**

该命令用于设置镜像SIP信令功能。

#### [注意事项](#ZH-CN_CONCEPT_0000205833682697)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000205833682697)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000205833682697)
...
#### [使用实例](#ZH-CN_CONCEPT_0000205833682697)
