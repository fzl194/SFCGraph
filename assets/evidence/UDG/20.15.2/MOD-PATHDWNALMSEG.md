# 修改单条路径断告警抑制参数的分段配置（MOD PATHDWNALMSEG）

- [命令功能](#ZH-CN_CONCEPT_0182837868__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837868__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837868__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837868__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837868__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837868)
...
#### [注意事项](#ZH-CN_CONCEPT_0182837868)

- 该命令执行后立即生效。
- 四个告警相关参数至少需要输入一个，否则命令执行失败。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837868)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837868)
