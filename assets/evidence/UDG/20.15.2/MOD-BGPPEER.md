# 修改BGP对等体（MOD BGPPEER）

- [命令功能](#ZH-CN_CONCEPT_0000001600440489__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440489__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440489__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440489__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440489__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440489)

该命令用于更新IPv4或IPv6地址类型的对等体参数。

![](修改BGP对等体（MOD BGPPEER）_00440489.assets/notice_3.0-zh-cn.png)

本命令属于高危命令，如果修改常规路由器，本地接口地址，本地接口名称，存活时间，保持时间会导致该对等体断连。对等体认证推荐使用Keychain，并且配置满足复杂度的密码，否则有安全隐患。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440489)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440489)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440489)
...
| ADDRESSTYPE | 地址类型 | 可选必选说明：可选参数<br>参数含义：该参数用于指定对等体的地址类型。<br>数据来源：本端规划<br>取值范围：枚举类型。<br>- noaf：不指定地址族。<br>- ipv4：IPv4。<br>- ipv6：IPv6。<br>默认值：无<br>配置原则：当该参数配置为noaf时，VRFNAME不能为_public_。 |
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440489)
