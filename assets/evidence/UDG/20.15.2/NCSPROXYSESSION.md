# 显示所有NETCONF代理VNFC会话信息（DSP NCSPROXYSESSION）

- [命令功能](#ZH-CN_CONCEPT_0259037222__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259037222__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259037222__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259037222__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259037222__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0259037222__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0259037222)

该命令用于显示NETCONF代理VNFC会话信息。

#### [注意事项](#ZH-CN_CONCEPT_0259037222)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0259037222)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259037222)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0259037222)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 网管会话ID | 网管与网元的NETCONF会话标识。 |
| 目标 | 代理转发的目的地。 |
| VNFC标识 | VNFC的标识。 |
| VNFC类型 | VNFC的类型。 |
| VNFC会话标识 | 代理与VNFC的NETCONF会话标识。 |
| VNFC会话状态 | 代理与VNFC的会话状态。 |
| 会话终止时间 | 网管与网元的会话终止时间。 |
| VNFC名称 | VNFC的名称。 |
| VNFC通道标识 | 代理与VNFC的通道标识。 |
| 用户名 | VNFC认证的用户名。 |
| 会话统计信息 | NETCONF代理会话统计信息。 |
| 会话超时消息 | 会话超时消息。 |
