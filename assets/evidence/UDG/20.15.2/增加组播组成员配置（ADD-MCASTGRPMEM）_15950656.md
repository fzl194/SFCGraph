# 增加组播组成员配置（ADD MCASTGRPMEM）

- [命令功能](#ZH-CN_CONCEPT_0000202615950656__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000202615950656__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000202615950656__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000202615950656__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000202615950656__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000202615950656)

**适用NF：UPF**

该命令用于增加静态组播组内成员。

#### [注意事项](#ZH-CN_CONCEPT_0000202615950656)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000202615950656)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000202615950656)
...
#### [使用实例](#ZH-CN_CONCEPT_0000202615950656)
