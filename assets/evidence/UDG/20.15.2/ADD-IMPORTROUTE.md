# 增加指定协议中的入口路由配置（ADD IMPORTROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001549801554__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801554__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801554__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801554__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801554__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801554)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001549801554)

- 该命令执行后立即生效。
- 该命令最大记录数为100000。
- 需要确保指定的BGP VPN实例在设备上已创建。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801554)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801554)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801554)
