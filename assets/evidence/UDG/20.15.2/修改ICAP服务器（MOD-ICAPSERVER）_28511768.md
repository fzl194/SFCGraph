# 修改ICAP服务器（MOD ICAPSERVER）

- [命令功能](#ZH-CN_CONCEPT_0000203228511768__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000203228511768__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000203228511768__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000203228511768__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000203228511768__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000203228511768)

**适用NF：PGW-U、UPF**

该命令用于修改一个ICAP Server相关的配置，包括ICAP Server的主机IP地址、PORT、TCP尝试建链间隔、OPTIONS消息重发间隔等。

#### [注意事项](#ZH-CN_CONCEPT_0000203228511768)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000203228511768)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000203228511768)
...
#### [使用实例](#ZH-CN_CONCEPT_0000203228511768)
