# 恢复MOS补偿因子（RTR VOLTEMOSFACTOR）

- [命令功能](#ZH-CN_CONCEPT_0000201275753662__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201275753662__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201275753662__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201275753662__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201275753662__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201275753662)

**适用NF：PGW-U、UPF**

该命令用于恢复MOS补偿因子为系统初始设置值。

#### [注意事项](#ZH-CN_CONCEPT_0000201275753662)

- 该命令执行后立即生效。
- 如果MOSCODEC设置为SM_MOS_CODEC_ALL，则表示对所有MOSCODEC进行设置。
- EVS NB/EVS WB/EVS SWB/EVS FB/EVS AMR-WB IO在未配置时不能进行设置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000201275753662)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201275753662)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201275753662)
