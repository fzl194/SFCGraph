# 显示补丁信息（DSP ACSPATCHDETAILINFO）

- [命令功能](#ZH-CN_CONCEPT_0205338962__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0205338962__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0205338962__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0205338962__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0205338962__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0205338962__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0205338962)
...
#### [注意事项](#ZH-CN_CONCEPT_0205338962)

不指定查询条件时，该命令只支持返回最多30000个补丁记录；超过30000个补丁记录查询时该命令会报错，此时请指定RU名称或进程ID进行查询操作。

#### [操作用户权限](#ZH-CN_CONCEPT_0205338962)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0205338962)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0205338962)

| 输出项名称 | 输出项解释 |
| --- | --- |
| RU名称 | 表示补丁单元所属的RU名称。 |
| 进程ID | 表示补丁单元所属进程ID。 |
| 状态 | 表示补丁单元状态，包括空闲、去激活、激活和运行四种状态。 |
| 类型 | 表示补丁单元类型。 |
| 是否生效 | 表示补丁单元是否生效。 |
| 生效时间 | 表示补丁单元生效时间。 |
| 文件名 | 表示补丁单元文件名。 |
