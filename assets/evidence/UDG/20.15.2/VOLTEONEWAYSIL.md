# 设置单通检测信息（SET VOLTEONEWAYSIL）

- [命令功能](#ZH-CN_CONCEPT_0000201457738485__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201457738485__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201457738485__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201457738485__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201457738485__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201457738485)

**适用NF：PGW-U**

该命令用于设置单通检测的开关、丢包率和MOS周期。

#### [注意事项](#ZH-CN_CONCEPT_0000201457738485)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000201457738485)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201457738485)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201457738485)
