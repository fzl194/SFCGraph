# 业务Tracert功能（SRVTRACERT）

- [命令功能](#ZH-CN_CONCEPT_0000201996093080__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000201996093080__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000201996093080__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000201996093080__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000201996093080__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000201996093080)

**适用NF：SGW-U、PGW-U、UPF**

该命令通过在用户面业务处理单元发起本端逻辑接口IP到对端网元的测试数据包，或者发起本地地址池中某个IP到网络侧的测试数据包，探测所经过的路径节点。

#### [注意事项](#ZH-CN_CONCEPT_0000201996093080)

- 该命令执行后立即生效。
- 该命令同一时刻只能执行一次。
- 源地址必须为逻辑接口地址或地址池中的地址。

#### [操作用户权限](#ZH-CN_CONCEPT_0000201996093080)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000201996093080)
...
#### [使用实例](#ZH-CN_CONCEPT_0000201996093080)
