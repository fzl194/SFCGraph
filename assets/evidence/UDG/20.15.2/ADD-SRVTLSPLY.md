# 增加TLS认证策略（ADD SRVTLSPLY）

- [命令功能](#ZH-CN_CONCEPT_0000207394632041__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207394632041__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207394632041__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207394632041__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207394632041__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207394632041)

**适用NF：UPF、PGW-U**

该命令用于增加TLS认证策略。

#### [注意事项](#ZH-CN_CONCEPT_0000207394632041)

- 该命令执行后对新数据流生效。
- 该命令最大记录数为256。
- 当VERIFYPEER配置为Yes时，必须配置CASCENE，否则会报错。

#### [操作用户权限](#ZH-CN_CONCEPT_0000207394632041)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207394632041)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207394632041)
