# 更新CPU能力基线(UPD CPUCAPABILITY)

- [命令功能](#ZH-CN_CONCEPT_0225484937__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0225484937__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0225484937__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0225484937__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0225484937__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0225484937)

该命令用于更新指定CPU信息所对应的能力基线值，指定CPU信息包含CPU类型、CPU代数以及CPU主频率。

#### [注意事项](#ZH-CN_CONCEPT_0225484937)

CPU类型、CPU代数以及CPU主频这三者的值会确定记录的唯一性，因此执行该命令前确保已存在指定的CPU信息记录，否则更新会失败。

#### [操作用户权限](#ZH-CN_CONCEPT_0225484937)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0225484937)
