# 增加匹配IPv6地址ACL（ADD MATCHDESTACL6）

- [命令功能](#ZH-CN_CONCEPT_0000001549801606__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549801606__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549801606__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549801606__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549801606__1.3.5.1)
- [参考信息](#ZH-CN_CONCEPT_0000001549801606__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549801606)

该命令用于添加ACL匹配IPv6目的地址。

#### [注意事项](#ZH-CN_CONCEPT_0000001549801606)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549801606)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549801606)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549801606)
...
#### [参考信息](#ZH-CN_CONCEPT_0000001549801606)
