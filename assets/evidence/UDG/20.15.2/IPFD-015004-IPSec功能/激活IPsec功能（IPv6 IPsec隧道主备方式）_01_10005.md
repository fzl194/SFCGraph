...
![](激活IPsec功能（IPv6 IPsec隧道主备方式）_01_10005.assets/zh-cn_image_0000002074226452.png)
...
| [**ADD ACLRULEADV6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/高级IPv6 ACL规则/增加高级IPv6 ACL规则（ADD ACLRULEADV6IPSEC）_68200943.md) | 高级ACL规则组名称（ACLNAME） | 3027 | 本端规划 | 通过ACL规则定义需要保护的数据流。 |
...
| [**ADD IKEPEER6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IKE对等体IPv6/增加IPv6 IKE对等体（ADD IKEPEER6）_21361306.md) | 对等体名称（PEERNAME） | - Device A: b、c<br>- Device B: a<br>- Device C: a | 对端规划 | 配置IKE对等体。<br>Device A侧增加两个IKE对等体，分别用于主备隧道。 |
| [**ADD IKEPEER6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IKE对等体IPv6/增加IPv6 IKE对等体（ADD IKEPEER6）_21361306.md) | 预共享密钥（PRESHAREDKEY） | abcde | 对端协商 | 配置IKE对等体。<br>Device A侧增加两个IKE对等体，分别用于主备隧道。 |
| [**ADD IKEPEER6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IKE对等体IPv6/增加IPv6 IKE对等体（ADD IKEPEER6）_21361306.md) | 安全提议（PROPOSAL） | 10 | 本端规划 | 配置IKE对等体。<br>Device A侧增加两个IKE对等体，分别用于主备隧道。 |
| [**ADD IKEPEER6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IKE对等体IPv6/增加IPv6 IKE对等体（ADD IKEPEER6）_21361306.md) | 远端地址（LOWREMOTEADDR） | - Device A:- 到Device B：2001:db8:2::1:0:1<br>- 到Device C：2001:db8:3::1:0:1<br>- Device B：2001:db8:1::1:0:1<br>- Device C：2001:db8:1::1:0:1 | 全网规划 | 配置IKE对等体。<br>Device A侧增加两个IKE对等体，分别用于主备隧道。 |
| [**ADD IKEPEER6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IKE对等体IPv6/增加IPv6 IKE对等体（ADD IKEPEER6）_21361306.md) | SA绑定VPN名称（INVRFNAME） | vrf1 | 本端规划 | 配置IKE对等体。<br>Device A侧增加两个IKE对等体，分别用于主备隧道。 |
| [**ADD IKEPEER6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IKE对等体IPv6/增加IPv6 IKE对等体（ADD IKEPEER6）_21361306.md) | 远端地址VPN名称（OUTVRFNAME） | vrf1 | 全网规划 | 配置IKE对等体。<br>Device A侧增加两个IKE对等体，分别用于主备隧道。 |
| [**ADD IPSECPOLICY6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IPsec策略IPv6/增加IPsec Ipv6策略（ADD IPSECPOLICY6）_68320981.md) | 策略名称（POLICYNAME） | map1 | 本端规划 | 配置IPsec安全策略。<br>Device A侧配置主备隧道，<br>“工作模式”<br>设置为<br>“Master_standby”<br>，并关闭主用隧道故障恢复后自动切回主用隧道功能。<br>如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组编号，则IPsec策略中使用<br>“ACL编号-IPV6（ACL6NUMBER）”<br>；如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组名称，则IPsec策略中使用<br>“ACL名称-ipv6（ACL6NAME）”<br>。此处以ACL规则组编号为例。 |
| [**ADD IPSECPOLICY6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IPsec策略IPv6/增加IPsec Ipv6策略（ADD IPSECPOLICY6）_68320981.md) | 序列号（SEQUENCENUMBER） | 10 | 对端协商 | 配置IPsec安全策略。<br>Device A侧配置主备隧道，<br>“工作模式”<br>设置为<br>“Master_standby”<br>，并关闭主用隧道故障恢复后自动切回主用隧道功能。<br>如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组编号，则IPsec策略中使用<br>“ACL编号-IPV6（ACL6NUMBER）”<br>；如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组名称，则IPsec策略中使用<br>“ACL名称-ipv6（ACL6NAME）”<br>。此处以ACL规则组编号为例。 |
| [**ADD IPSECPOLICY6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IPsec策略IPv6/增加IPsec Ipv6策略（ADD IPSECPOLICY6）_68320981.md) | 策略模式（POLICYMODE） | Isakmp | 对端协商 | 配置IPsec安全策略。<br>Device A侧配置主备隧道，<br>“工作模式”<br>设置为<br>“Master_standby”<br>，并关闭主用隧道故障恢复后自动切回主用隧道功能。<br>如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组编号，则IPsec策略中使用<br>“ACL编号-IPV6（ACL6NUMBER）”<br>；如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组名称，则IPsec策略中使用<br>“ACL名称-ipv6（ACL6NAME）”<br>。此处以ACL规则组编号为例。 |
| [**ADD IPSECPOLICY6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IPsec策略IPv6/增加IPsec Ipv6策略（ADD IPSECPOLICY6）_68320981.md) | 模板模式（TEMPLATEMODE） | None | 对端协商 | 配置IPsec安全策略。<br>Device A侧配置主备隧道，<br>“工作模式”<br>设置为<br>“Master_standby”<br>，并关闭主用隧道故障恢复后自动切回主用隧道功能。<br>如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组编号，则IPsec策略中使用<br>“ACL编号-IPV6（ACL6NUMBER）”<br>；如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组名称，则IPsec策略中使用<br>“ACL名称-ipv6（ACL6NAME）”<br>。此处以ACL规则组编号为例。 |
| [**ADD IPSECPOLICY6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IPsec策略IPv6/增加IPsec Ipv6策略（ADD IPSECPOLICY6）_68320981.md) | ACL编号-IPV6（ACL6NUMBER） | 3027 | 本端规划 | 配置IPsec安全策略。<br>Device A侧配置主备隧道，<br>“工作模式”<br>设置为<br>“Master_standby”<br>，并关闭主用隧道故障恢复后自动切回主用隧道功能。<br>如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组编号，则IPsec策略中使用<br>“ACL编号-IPV6（ACL6NUMBER）”<br>；如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组名称，则IPsec策略中使用<br>“ACL名称-ipv6（ACL6NAME）”<br>。此处以ACL规则组编号为例。 |
| [**ADD IPSECPOLICY6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IPsec策略IPv6/增加IPsec Ipv6策略（ADD IPSECPOLICY6）_68320981.md) | 工作模式（WORKMODE） | Master_standby | 本端规划 | 配置IPsec安全策略。<br>Device A侧配置主备隧道，<br>“工作模式”<br>设置为<br>“Master_standby”<br>，并关闭主用隧道故障恢复后自动切回主用隧道功能。<br>如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组编号，则IPsec策略中使用<br>“ACL编号-IPV6（ACL6NUMBER）”<br>；如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组名称，则IPsec策略中使用<br>“ACL名称-ipv6（ACL6NAME）”<br>。此处以ACL规则组编号为例。 |
| [**ADD IPSECPOLICY6**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/IPsec策略IPv6/增加IPsec Ipv6策略（ADD IPSECPOLICY6）_68320981.md) | 自动切回开关（AUTOSWITCHBACK） | Disable | 本端规划 | 配置IPsec安全策略。<br>Device A侧配置主备隧道，<br>“工作模式”<br>设置为<br>“Master_standby”<br>，并关闭主用隧道故障恢复后自动切回主用隧道功能。<br>如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组编号，则IPsec策略中使用<br>“ACL编号-IPV6（ACL6NUMBER）”<br>；如果<br>[**ADD ACLGROUP6IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/IPv6 ACL规则组/增加IPv6 ACL规则组（ADD ACLGROUP6IPSEC）_21521202.md)<br>中的<br>“规则组标识（ACLNAME）”<br>配置为规则组名称，则IPsec策略中使用<br>“ACL名称-ipv6（ACL6NAME）”<br>。此处以ACL规则组编号为例。 |
...
![](激活IPsec功能（IPv6 IPsec隧道主备方式）_01_10005.assets/zh-cn_image_0161317317.png)
