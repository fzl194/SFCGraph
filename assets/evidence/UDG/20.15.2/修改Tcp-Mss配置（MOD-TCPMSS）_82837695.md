# 修改Tcp Mss配置（MOD TCPMSS）

- [命令功能](#ZH-CN_CONCEPT_0182837695__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837695__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837695__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837695__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837695__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837695)
...
#### [注意事项](#ZH-CN_CONCEPT_0182837695)

- 该命令执行后立即生效。
- 执行该命令修改V4TCPMSSVALUE/V6TCPMSSVALUE时，请参考参数配置建议。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837695)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837695)
