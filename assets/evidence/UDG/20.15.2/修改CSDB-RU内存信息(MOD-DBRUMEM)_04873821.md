# 修改CSDB RU内存信息(MOD DBRUMEM)

- [命令功能](#ZH-CN_TOPIC_0000001904873821__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000001904873821__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000001904873821__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000001904873821__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000001904873821__1.3.5.1)

#### [命令功能](#ZH-CN_TOPIC_0000001904873821)
...
#### [注意事项](#ZH-CN_TOPIC_0000001904873821)

- 执行该命令之前，请先确保存在RU内存信息。

#### [操作用户权限](#ZH-CN_TOPIC_0000001904873821)

G_1，管理员级别命令组；G_2，操作员级别命令组；

#### [参数说明](#ZH-CN_TOPIC_0000001904873821)
...
#### [使用实例](#ZH-CN_TOPIC_0000001904873821)
