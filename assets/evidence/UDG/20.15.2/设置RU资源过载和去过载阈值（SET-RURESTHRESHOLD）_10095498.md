# 设置RU资源过载和去过载阈值（SET RURESTHRESHOLD）

- [命令功能](#ZH-CN_CONCEPT_0000001110095498__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001110095498__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001110095498__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001110095498__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001110095498__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001110095498)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001110095498)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001110095498)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001110095498)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001110095498)
