# 修改OSPF默认宣告路由配置（MOD OSPFDEFAULTROUTE）

- [命令功能](#ZH-CN_CONCEPT_0000001550121834__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550121834__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550121834__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550121834__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550121834__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550121834)

该命令用于修改普通OSPF区域的缺省路由。

#### [注意事项](#ZH-CN_CONCEPT_0000001550121834)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001550121834)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550121834)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550121834)
