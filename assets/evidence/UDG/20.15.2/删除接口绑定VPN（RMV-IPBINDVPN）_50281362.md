# 删除接口绑定VPN（RMV IPBINDVPN）

- [命令功能](#ZH-CN_CONCEPT_0000001550281362__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281362__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281362__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281362__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281362__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281362)

该命令用于配置接口去绑定VPN。如果接口不再与VPN网络连接，需要去绑定VPN。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281362)

- 该命令执行后立即生效。
- 执行该命令将清除该接口下所有的IP配置。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281362)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281362)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281362)
