# 设置调测日志开关（SET FEILOGSWITCH）

- [命令功能](#ZH-CN_TOPIC_0244651703__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0244651703__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0244651703__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0244651703__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0244651703__1.3.5.1)

#### [命令功能](#ZH-CN_TOPIC_0244651703)
...
#### [注意事项](#ZH-CN_TOPIC_0244651703)

- 该命令执行后立即生效。
- 该命令不支持配置导出。
- 该命令仅适用于NP卡加速模式场景。

#### [操作用户权限](#ZH-CN_TOPIC_0244651703)

G_1，管理员级别命令组；G_2，操作员级别命令组；

#### [参数说明](#ZH-CN_TOPIC_0244651703)
