# 修改Acl绑定关系（MOD ACLBINDAPN）

- [命令功能](#ZH-CN_CONCEPT_0182837725__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837725__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837725__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837725__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837725__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837725)

**适用NF：SGW-U、PGW-U、UPF**

该命令用于修改APN下配置的ACL绑定。当需要改变APN下数据流的某个方向上绑定的ACL规则、或者改变改APN下ACL规则的生效时间时，可以使用此命令。

#### [注意事项](#ZH-CN_CONCEPT_0182837725)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837725)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837725)
