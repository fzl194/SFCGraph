# 修改UPF向PDN服务器发送探测消息的探测路径配置（MOD PDNROUTETSTPATH）

- [命令功能](#ZH-CN_CONCEPT_0000206464073333__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206464073333__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206464073333__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206464073333__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206464073333__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206464073333)

**适用NF：PGW-U、UPF**

该命令用来修改UPF向PDN服务器自动发送探测消息的路径配置。

#### [注意事项](#ZH-CN_CONCEPT_0000206464073333)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000206464073333)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206464073333)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206464073333)
