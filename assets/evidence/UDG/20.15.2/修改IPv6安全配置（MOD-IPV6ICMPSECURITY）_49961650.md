# 修改IPv6安全配置（MOD IPV6ICMPSECURITY）

- [命令功能](#ZH-CN_CONCEPT_0000001549961650__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549961650__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549961650__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549961650__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549961650__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549961650)

该命令用于修改IPv6安全配置。

#### [注意事项](#ZH-CN_CONCEPT_0000001549961650)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001549961650)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549961650)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549961650)

修改IPv6安全配置：

```
MOD IPV6ICMPSECURITY:SWITCHOP=enable,ACTION=sndPkt,CONFIGTYPE=USER,ICMPTYPE=0,ICMPCODE=0;
```
