# 修改媒体中继白名单URL列表（MOD RELAYWURLLIST）

- [命令功能](#ZH-CN_CONCEPT_0000207243992614__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207243992614__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207243992614__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207243992614__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207243992614__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207243992614)

**适用NF：UPF、PGW-U**

该命令用于修改媒体中继URL白名单列表。

#### [注意事项](#ZH-CN_CONCEPT_0000207243992614)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000207243992614)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207243992614)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207243992614)
