# 增加IPFarmServer（ADD IPFARMSERVER）

- [命令功能](#ZH-CN_CONCEPT_0182837056__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837056__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837056__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837056__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837056__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837056)

**适用NF：PGW-U、UPF**

该命令用于配置IP farm中的IP farm服务器地址，作为重定向Server的目标地址和心跳检测地址。

#### [注意事项](#ZH-CN_CONCEPT_0182837056)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837056)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837056)
