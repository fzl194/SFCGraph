# 删除产品内部需要调整规格比例的项目（RMV SPECCFGITEM）

- [命令功能](#ZH-CN_CONCEPT_0000206407854139__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206407854139__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206407854139__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206407854139__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206407854139__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206407854139)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206407854139)

- 该命令执行后需要复位相应的微服务才能生效。
- 该命令配置前必须通过华为工程师根据产品承载的业务范围和场景进行评估，确认删除配置后默认规格是否满足当前的业务场景。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206407854139)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206407854139)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206407854139)
