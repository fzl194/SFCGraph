# 修改OSPF的NBMA网络邻居路由器配置（MOD OSPFPEER）

- [命令功能](#ZH-CN_CONCEPT_0000001550281610__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550281610__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550281610__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550281610__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550281610__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550281610)

该命令用于修改NBMA网络上指定相邻路由器的IP地址及DR选举权。

#### [注意事项](#ZH-CN_CONCEPT_0000001550281610)

- 该命令执行后立即生效。
- 只有配置了OSPF进程后才能使用该命令。
- 通过此命令设置对端设备的DR选举的优先级，必须与本端设备的DR的优先级一致。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550281610)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550281610)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550281610)
