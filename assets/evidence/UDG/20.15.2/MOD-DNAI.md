...
- [命令功能](#ZH-CN_CONCEPT_0253878563__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0253878563__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0253878563__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0253878563__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0253878563__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0253878563)

**适用NF：PGW-U、UPF**

该命令用于修改DNAI实例的信息。

#### [注意事项](#ZH-CN_CONCEPT_0253878563)

- 该命令执行后立即生效。
- HASVPN和HASVPNIPV6至少有一个为使能。

#### [操作用户权限](#ZH-CN_CONCEPT_0253878563)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0253878563)
