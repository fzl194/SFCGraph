# 修改IPv6 ACL规则组（MOD ACLGROUP6）

- [命令功能](#ZH-CN_CONCEPT_0000001550120866__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001550120866__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001550120866__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001550120866__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001550120866__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001550120866)

该命令用于修改IPv6 ACL规则组的配置，可以修改规则组的步长，以及规则组描述信息。

#### [注意事项](#ZH-CN_CONCEPT_0000001550120866)

- 该命令执行后立即生效。
- IPv6 ACL创建之后，ACLTYPE不可修改，修改的话会报错。
- 执行该命令前，需要提前配置ADD ACLGROUP命令添加ACL规则组。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001550120866)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001550120866)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001550120866)
