# 增加下一跳设置（ADD APPLYNEXTHOP）

- [命令功能](#ZH-CN_CONCEPT_0000001549802430__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001549802430__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001549802430__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001549802430__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001549802430__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001549802430)

该命令用于添加设置路由下一跳。

#### [注意事项](#ZH-CN_CONCEPT_0000001549802430)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001549802430)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001549802430)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001549802430)
