# 设置RU磁盘过载配置（SET RUDISKPARTITION）

- [命令功能](#ZH-CN_CONCEPT_0259103406__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103406__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103406__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103406__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103406__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103406)

该命令用来设置不同RU类型的磁盘分区过载阈值。

当RU磁盘分区使用率超过阈值时，会触发磁盘分区使用率超限告警。

#### [注意事项](#ZH-CN_CONCEPT_0259103406)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0259103406)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103406)
