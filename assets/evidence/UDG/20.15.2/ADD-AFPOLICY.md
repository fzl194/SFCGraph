# 增加防欺诈策略配置（ADD AFPOLICY）

- [命令功能](#ZH-CN_CONCEPT_0182837795__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837795__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837795__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837795__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837795__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837795)

**适用NF：PGW-U、UPF**

该命令用于增加判断出欺诈行为后的处理策略。如果AFPolicy没有配置参数，无法匹配选择到欺诈策略，则欺诈业务流会使用正常配置的处理策略，不会做策略切换。

#### [注意事项](#ZH-CN_CONCEPT_0182837795)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837795)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837795)
