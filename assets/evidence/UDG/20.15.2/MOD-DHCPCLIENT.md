# 修改DHCPv4客户端（MOD DHCPCLIENT）

- [命令功能](#ZH-CN_CONCEPT_0000001600600529__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600600529__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600600529__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600600529__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600600529__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600600529)

该命令用于修改DHCPv4客户端属性。如：期望租期、上报MTU使能。

#### [注意事项](#ZH-CN_CONCEPT_0000001600600529)

- 该命令执行后立即生效。
- 该命令在Ethernet接口上配置执行。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600600529)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600600529)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600600529)
