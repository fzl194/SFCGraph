# 设置APN HTTP2.0协议回落开关（SET APNHTTP2DGRD）

- [命令功能](#ZH-CN_CONCEPT_0182837306__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837306__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837306__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837306__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837306__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837306)

**适用NF：PGW-U、UPF**

该命令用来设置指定APN下的HTTP2.0协议回落功能。当运营商部署的网关设备不具备HTTP2.0处理能力或者网关设备需要与不具备HTTP2.0处理能力的周边网元配合共同完成业务部署时，需要开启HTTP2.0协议回落。

#### [注意事项](#ZH-CN_CONCEPT_0182837306)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837306)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837306)
