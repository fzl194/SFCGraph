# 设置指定本地POOL占用率告警阈值（SET POOLALMTHD）

- [命令功能](#ZH-CN_CONCEPT_0000206637455140__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206637455140__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206637455140__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206637455140__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206637455140__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206637455140)

**适用NF：PGW-U、UPF**

此命令用于设置本地地址池使用率的告警阈值和告警恢复阈值。

#### [注意事项](#ZH-CN_CONCEPT_0000206637455140)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000206637455140)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206637455140)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206637455140)
