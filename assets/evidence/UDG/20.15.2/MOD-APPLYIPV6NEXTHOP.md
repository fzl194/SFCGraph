# 修改IPv6下一跳设置（MOD APPLYIPV6NEXTHOP）

- [命令功能](#ZH-CN_CONCEPT_0000001600440733__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440733__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440733__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440733__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440733__1.3.5.1)
- [参考信息](#ZH-CN_CONCEPT_0000001600440733__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440733)

该命令用于修改基于IPv6信息的路由下一跳。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440733)

- 该命令执行后立即生效。

- 当参数ISPEERADDRESS配置为TRUE时，不能配置参数IPV6NEXTHOP、NEXTHOPTYPE和IFNAME。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440733)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440733)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440733)
...
#### [参考信息](#ZH-CN_CONCEPT_0000001600440733)
