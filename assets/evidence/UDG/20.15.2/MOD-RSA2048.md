# 修改RSA2048公钥参数（MOD RSA2048）

- [命令功能](#ZH-CN_CONCEPT_0182837577__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837577__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837577__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837577__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837577__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837577)

**适用NF：PGW-U、UPF**

该命令用于修改一个RSA2048的相关配置。

#### [注意事项](#ZH-CN_CONCEPT_0182837577)

- 该命令执行后立即生效。
- 当前命令中 RSAPSWDTYPE 中的 CERTIFICATE_FILE 项功能不支持。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837577)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837577)
