# 增加APN与Diameter Realm关联关系（ADD UPREALMBINDAPN）

- [命令功能](#ZH-CN_CONCEPT_0000206145195188__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206145195188__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206145195188__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206145195188__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206145195188__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206145195188)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206145195188)

- 该命令执行后只对新激活用户生效。
- 该命令最大记录数为10000。
- 每个APN针对特定应用类型仅能配置唯一的Diameter域信息。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206145195188)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206145195188)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206145195188)
