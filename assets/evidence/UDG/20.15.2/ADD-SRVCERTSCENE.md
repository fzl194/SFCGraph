# 增加配置证书场景（ADD SRVCERTSCENE）

- [命令功能](#ZH-CN_CONCEPT_0000207394632037__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000207394632037__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000207394632037__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000207394632037__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000207394632037__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000207394632037)

**适用NF：UPF、PGW-U**

该命令用于增加配置证书场景。

#### [注意事项](#ZH-CN_CONCEPT_0000207394632037)

- 该命令执行后立即生效。
- 该命令最大记录数为512。
- 当用户不输入CNDESC、 ENDESC时，会将SCENE的值赋给未输入的CNDESC、ENDESC。

#### [操作用户权限](#ZH-CN_CONCEPT_0000207394632037)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000207394632037)
...
#### [使用实例](#ZH-CN_CONCEPT_0000207394632037)
