# 修改VoLTE话路环回功能（MOD VOLTELOOP）

- [命令功能](#ZH-CN_CONCEPT_0207016806__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0207016806__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0207016806__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0207016806__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0207016806__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0207016806)

**适用NF：SGW-U、PGW-U、UPF**

此命令用于对VoLTE话路环回功能的配置进行修改。当逐段界定语音质量问题所在的环节时，可以通过该命令来修改话路环回点。

#### [注意事项](#ZH-CN_CONCEPT_0207016806)

- 该命令执行后立即生效。
- 如果修改后的IMSI/MSISDN指示同一个用户，采用后修改优先原则。

#### [操作用户权限](#ZH-CN_CONCEPT_0207016806)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0207016806)
