# 设置Log过滤或非抑制开关（SET MSSLOGRULE）

- [命令功能](#ZH-CN_CONCEPT_0000001600841605__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600841605__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600841605__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600841605__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600841605__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600841605)
...
#### [注意事项](#ZH-CN_CONCEPT_0000001600841605)

- 该命令执行后立即生效。
- 本命令用于使能日志过滤或日志非抑制开关，日志非抑制开启会降低性能，关闭后会恢复性能。开关状态将在2小时后自动恢复。

#### [操作用户权限](#ZH-CN_CONCEPT_0000001600841605)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600841605)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600841605)
