...
- [命令功能](#ZH-CN_CONCEPT_0182837135__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837135__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837135__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837135__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837135__1.3.5.1)
- [输出结果说明](#ZH-CN_CONCEPT_0182837135__1.3.6.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837135)

**适用NF：PGW-U、UPF**

该命令用于显示所有地址池或指定地址池的信息。

#### [注意事项](#ZH-CN_CONCEPT_0182837135)

无。

#### [操作用户权限](#ZH-CN_CONCEPT_0182837135)

G_1，管理员级别命令组；G_2，操作员级别命令组；G_3，用户级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837135)
...
#### [输出结果说明](#ZH-CN_CONCEPT_0182837135)

| 输出项名称 | 输出项解释 |
| --- | --- |
| 地址池锁定标志 | 地址池锁定标志。 |

其余输出项请参见ADD POOL的参数说明。
