# 增加带宽管理业务（ADD BWMSERVICE）

- [命令功能](#ZH-CN_CONCEPT_0182837473__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837473__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837473__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837473__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837473__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837473)

**适用NF：PGW-U、UPF**

该命令用于增加一条带宽管理的业务范围，实现业务区分。该命令支持TOS类型业务，用报文的TOS区分业务，也支持非TOS类型业务，为带宽管理业务绑定一个分类属性、或者指定7层协议、或者绑定一个协议组来区分业务。

#### [注意事项](#ZH-CN_CONCEPT_0182837473)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837473)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837473)
