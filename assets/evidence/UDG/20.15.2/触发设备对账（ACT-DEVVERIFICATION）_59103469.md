# 触发设备对账（ACT DEVVERIFICATION）

- [命令功能](#ZH-CN_CONCEPT_0259103469__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0259103469__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0259103469__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0259103469__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0259103469__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0259103469)

该命令用于触发设备对账。当设备订阅信息或者属性信息发生异常时，可以使用该命令触发设备对账进行恢复。

#### [注意事项](#ZH-CN_CONCEPT_0259103469)

该命令执行后立即生效。

#### [操作用户权限](#ZH-CN_CONCEPT_0259103469)

G_1，管理员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0259103469)
