# 增加匹配IPv6下一跳前缀列表（ADD MATCHNEXTHOPPREFIX6FILTER）

- [命令功能](#ZH-CN_CONCEPT_0000001600440797__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000001600440797__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000001600440797__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000001600440797__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000001600440797__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000001600440797)

该命令用来增加基于路由信息的下一跳IPv6信息的匹配规则。

#### [注意事项](#ZH-CN_CONCEPT_0000001600440797)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0000001600440797)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000001600440797)
...
#### [使用实例](#ZH-CN_CONCEPT_0000001600440797)
