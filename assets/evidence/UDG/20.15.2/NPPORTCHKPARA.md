# 设置NP端口检测的参数（SET NPPORTCHKPARA）

- [命令功能](#ZH-CN_TOPIC_0000002144275545__1.3.1.1)
- [注意事项](#ZH-CN_TOPIC_0000002144275545__1.3.2.1)
- [操作用户权限](#ZH-CN_TOPIC_0000002144275545__1.3.3.1)
- [参数说明](#ZH-CN_TOPIC_0000002144275545__1.3.4.1)
- [使用实例](#ZH-CN_TOPIC_0000002144275545__1.3.5.1)

#### [命令功能](#ZH-CN_TOPIC_0000002144275545)

该命令用来设置NP端口检测的参数。

#### [注意事项](#ZH-CN_TOPIC_0000002144275545)
...
#### [操作用户权限](#ZH-CN_TOPIC_0000002144275545)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_TOPIC_0000002144275545)
...
#### [使用实例](#ZH-CN_TOPIC_0000002144275545)
