# 增加扩展过滤器（ADD EXTENDEDFILTER）

- [命令功能](#ZH-CN_CONCEPT_0182837379__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0182837379__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0182837379__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0182837379__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0182837379__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0182837379)

**适用NF：PGW-U、UPF**

该命令用于配置扩展过滤器及其属性，并支持生成过滤条件，可以应用于URL重定向、Captive-portal等特殊场景的七层过滤条件。

#### [注意事项](#ZH-CN_CONCEPT_0182837379)
...
#### [操作用户权限](#ZH-CN_CONCEPT_0182837379)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0182837379)
