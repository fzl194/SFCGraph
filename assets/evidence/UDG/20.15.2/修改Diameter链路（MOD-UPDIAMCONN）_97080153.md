# 修改Diameter链路（MOD UPDIAMCONN）

- [命令功能](#ZH-CN_CONCEPT_0000206297080153__1.3.1.1)
- [注意事项](#ZH-CN_CONCEPT_0000206297080153__1.3.2.1)
- [操作用户权限](#ZH-CN_CONCEPT_0000206297080153__1.3.3.1)
- [参数说明](#ZH-CN_CONCEPT_0000206297080153__1.3.4.1)
- [使用实例](#ZH-CN_CONCEPT_0000206297080153__1.3.5.1)

#### [命令功能](#ZH-CN_CONCEPT_0000206297080153)
...
#### [注意事项](#ZH-CN_CONCEPT_0000206297080153)

- 该命令执行后立即生效。
- 不指定LocalPort参数或指定LocalPort参数为0，都表示修改未配置本端端口号的connection。指定LocalPort参数为非0的有效值时，表示修改配置了此端口号的connection。

#### [操作用户权限](#ZH-CN_CONCEPT_0000206297080153)

G_1，管理员级别命令组；G_2，操作员级别命令组

#### [参数说明](#ZH-CN_CONCEPT_0000206297080153)
...
#### [使用实例](#ZH-CN_CONCEPT_0000206297080153)
