# 激活国密IPsec支持IKEv1功能（多Sequence的IPsec策略）

- [操作场景](#ZH-CN_OPI_0000001503408185__1.3.1)
- [对系统的影响](#ZH-CN_OPI_0000001503408185__1.3.2)
- [必备事项](#ZH-CN_OPI_0000001503408185__1.3.3)
- [操作流程](#ZH-CN_OPI_0000001503408185__1.3.4)
- [操作步骤](#ZH-CN_OPI_0000001503408185__1.3.5)
- [任务示例](#ZH-CN_OPI_0000001503408185__1.3.6)

## [操作场景](#ZH-CN_OPI_0000001503408185)

为了节省隧道接口和IP地址，本端在IPsec策略下配置多sequence，每个sequence下可以配置不同的peer，实现单个隧道接口对接多个IKE peer的功能，即一个隧道口下可以协商多个IKE SA。

如 [图1](#ZH-CN_OPI_0000001503408185__fac7cee1c5d1146ffa950a1470209ec64) 所示，网络A和网络B/网络C之间采用网关对网关组网模式进行资源传输。网络A和网络B/网络C分别通过Device A和Device B/Device C连接到Internet。要求通过配置IPsec隧道，实现PCA与PCB/PCC之间可以安全地互访。

**图1** 采用安全策略方式建立IPsec隧道组网图

<br>

![](激活国密IPsec支持IKEv1功能（多Sequence的IPsec策略）_03408185.assets/zh-cn_image_0000001454088104.png "点击放大")
...
## [对系统的影响](#ZH-CN_OPI_0000001503408185)

本特性对系统无影响。

## [必备事项](#ZH-CN_OPI_0000001503408185)
...
需要准备的数据如 [表2](#ZH-CN_OPI_0000001503408185__tab_1) 所示。
...
| [**ADD ACLRULEADV4IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/高级ACL规则/增加高级ACL规则（ADD ACLRULEADV4IPSEC）_80751058.md) | ACL规则组标识（ACLNAME） | - Device A: 3000、3001<br>- Device B: 3000<br>- Device C: 3001 | 本端规划 | 通过ACL规则定义需要保护的数据流。 |
...
| [**ADD ACLRULEADV4IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/高级ACL规则/增加高级ACL规则（ADD ACLRULEADV4IPSEC）_80751058.md) | 规则ID（ACLRULEID） | 1 | 本端规划 | 通过ACL规则定义需要保护的数据流。 |
...
| [**ADD ACLRULEADV4IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/高级ACL规则/增加高级ACL规则（ADD ACLRULEADV4IPSEC）_80751058.md) | 源IP地址（ACLSOURCEIP） | - Device A: 10.1.1.2<br>- Device B: 10.1.2.2<br>- Device C: 10.1.3.2 | 全网规划 | 通过ACL规则定义需要保护的数据流。 |
...
| [**ADD ACLRULEADV4IPSEC**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/ACL管理/高级ACL规则/增加高级ACL规则（ADD ACLRULEADV4IPSEC）_80751058.md) | 目的IP地址（ACLDESTIP） | - Device A（3000）: 10.1.2.2<br>- Device A（3001）: 10.1.3.2<br>- Device B: 10.1.1.2<br>- Device C: 10.1.1.2 | 全网规划 | 通过ACL规则定义需要保护的数据流。 |
...
| [**ADD PROPATTACHIPSECPROPOSAL**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/绑定的IPsec安全提议/增加IPsec策略绑定提议（ADD PROPATTACHIPSECPROPOSAL）_80592500.md) | 序列号（SEQUENCENUMBER） | - Device A: 10、20<br>- Device B: 10<br>- Device C: 20 | 对端协商 | 在安全策略中引用安全提议。 |
...
| [**ADD ATTACHIKEPEER**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/绑定的IKE对等体/增加绑定IKE对等体（ADD ATTACHIKEPEER）_80910984.md) | 序列号（SEQUENCENUMBER） | - Device A: 10、20<br>- Device B: 10<br>- Device C: 20 | 对端协商 | 绑定安全策略和IKE对等体。 |
...
| [**ADD ATTACHIKEPEER**](../../../../../../OM参考/命令/UDG MML命令/平台服务管理/IPSEC功能管理/IP服务/IP安全管理/互联网密钥交换/绑定的IKE对等体/增加绑定IKE对等体（ADD ATTACHIKEPEER）_80910984.md) | IKE对等体名称<br>（IKEPEERNAME） | - Device A:- 10: b<br>- 20: c<br>- Device B: a<br>- Device C: a | 本端规划 | 绑定安全策略和IKE对等体。 |
...
## [操作流程](#ZH-CN_OPI_0000001503408185)
...
IPsec功能配置流程如 [图2](#ZH-CN_OPI_0000001503408185__zh-cn_opi_0161317238_f7e7e6e513f4542b59be08973af61493a) 所示。

**图2** IPsec功能配置流程

<br>

![](激活国密IPsec支持IKEv1功能（多Sequence的IPsec策略）_03408185.assets/zh-cn_image_0161317317.png)

## [操作步骤](#ZH-CN_OPI_0000001503408185)
...
按照 [图1](#ZH-CN_OPI_0000001503408185__fac7cee1c5d1146ffa950a1470209ec64) 所示，配置IPsec隧道实现PCA与PCB/PCC之间可以安全地互访。
