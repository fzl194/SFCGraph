---
id: UDG@20.15.2@Feature@GWFD-010155
type: Feature
name: Untrusted Non-3GPP网络用户接入
nf: UDG
version: 20.15.2
feature_code: GWFD-010155
is_directory: false
...
- [GWFD-020501](feature/UDG/20.15.2/GWFD-020501.md)：ULCL分流只支持4G/5G接入，不支持其他接入方式。
- [GWFD-020531](feature/UDG/20.15.2/GWFD-020531.md)：通用DNN漫游分流只支持4G/5G接入，不支持其他接入方式。
- [GWFD-020531](feature/UDG/20.15.2/GWFD-020531.md)：通用DNN漫游分流只支持4G/5G接入，不支持其他接入方式。

## 证据

- 原始手册：`evidence/UDG/20.15.2/GWFD-010155-Untrusted-Non-3GPP网络用户接入特性概述_70759397.md`
- 原始手册：`evidence/UDG/20.15.2/GWFD-010155-Untrusted-Non-3GPP网络用户接入参考信息_70759401.md`
- 原始手册：`evidence/UDG/20.15.2/实现原理_70759398.md`
- 原始手册：`evidence/UDG/20.15.2/配置PGW-U到Untrusted-Non-3GPP-GW的数据（OSPFv3动态路由+IPv6-BF_4baebda6_72490128.md`
- 原始手册：`evidence/UDG/20.15.2/配置PGW-U到Untrusted-Non-3GPP-GW的数据（VPN+OSPF动态路由组网）（虚机容器）_72489252.md`
- 原始手册：`evidence/UDG/20.15.2/配置PGW-U到Untrusted-Non-3GPP-GW的数据（VPN缺省路由组网）_72489253.md`
- 原始手册：`evidence/UDG/20.15.2/配置PGW-U到Untrusted-Non-3GPP-GW的数据（静态路由+BFD组网）_72489255.md`
- 原始手册：`evidence/UDG/20.15.2/激活Untrusted-Non-3GPP网络用户接入功能_70759399.md`
- 原始手册：`evidence/UDG/20.15.2/调测到Untrusted-Non-3GPP-GW的数据_70759400.md`
