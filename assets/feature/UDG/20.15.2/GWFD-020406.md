---
id: UDG@20.15.2@Feature@GWFD-020406
type: Feature
name: IPv6 Prefix Delegation
nf: UDG
version: 20.15.2
feature_code: GWFD-020406
is_directory: false
...
- [LKV3G5P6PD01](license/UDG/20.15.2/LKV3G5P6PD01.md)  — 控制项 82200CKF

## 特性关系

**互斥（conflicts_with）**

- [GWFD-010108](feature/UDG/20.15.2/GWFD-010108.md)：手机后路由用户不能做用户面地址自动检测。
- [GWFD-010108](feature/UDG/20.15.2/GWFD-010108.md)：该特性不支持与IPv6 Prefix Delegation同时应用。
- [GWFD-020412](feature/UDG/20.15.2/GWFD-020412.md)：L2TP VPN通过LNS设备实现了手机后路由功能，所以在同一APN下，L2TP VPN和手机后路由功能无需同时部署。
- [GWFD-020482](feature/UDG/20.15.2/GWFD-020482.md)：手机后路由用户不支持入不转板功能。
- [GWFD-020482](feature/UDG/20.15.2/GWFD-020482.md)：手机后路由用户的IPv6业务报文，不支持入不转板。
- [GWFD-020501](feature/UDG/20.15.2/GWFD-020501.md)：IPv6 Prefix Delegation用户不支持ULCL分流功能。
- [GWFD-020531](feature/UDG/20.15.2/GWFD-020531.md)：手机后路由用户不支持通用DNN漫游分流功能。
- [GWFD-020531](feature/UDG/20.15.2/GWFD-020531.md)：IPv6 Prefix Delegation用户不支持通用DNN漫游分流功能。
...
- 原始手册：`evidence/UDG/20.15.2/GWFD-020406-IPv6-Prefix-Delegation特性概述_79370029.md`
- 原始手册：`evidence/UDG/20.15.2/GWFD-020406-IPv6-Prefix-Delegation参考信息_79370035.md`
- 原始手册：`evidence/UDG/20.15.2/5GC业务流程_79707829.md`
- 原始手册：`evidence/UDG/20.15.2/EPC业务流程_79707828.md`
- 原始手册：`evidence/UDG/20.15.2/GPRS_UMTS业务流程_79707827.md`
- 原始手册：`evidence/UDG/20.15.2/激活外部网元地址分配的IPv6-Prefix-Delegation功能_80269177.md`
- 原始手册：`evidence/UDG/20.15.2/基于APN_DNN分配地址_80250128.md`
- 原始手册：`evidence/UDG/20.15.2/基于SMF+APN_DNN分配地址_80250130.md`
- 原始手册：`evidence/UDG/20.15.2/基于SMF分配地址_80250129.md`
- 原始手册：`evidence/UDG/20.15.2/基于位置分配地址_52579205.md`
- 原始手册：`evidence/UDG/20.15.2/调测IPv6-Prefix-Delegation_79370030.md`
- 原始手册：`evidence/UDG/20.15.2/GWFD-020406-IPv6-Prefix-Delegation_79370033.md`
