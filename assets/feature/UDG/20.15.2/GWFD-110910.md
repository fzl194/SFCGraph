---
id: UDG@20.15.2@Feature@GWFD-110910
type: Feature
name: 支持Routing Behind MS
nf: UDG
version: 20.15.2
feature_code: GWFD-110910
is_directory: false
catalog_section: 年费增值包-组网演进解决方案增值包
parent_feature_code: GWFD-110900
applicable_nf:
- PGW-U
- UPF
...
`GWFD-110910` · enhanced · required

## 所属目录

- [GWFD-110900](feature/UDG/20.15.2/GWFD-110900.md)
...
- [LKV3G5RBMS01](license/UDG/20.15.2/LKV3G5RBMS01.md)  — 控制项 82200CKP
...
- [GWFD-010108](feature/UDG/20.15.2/GWFD-010108.md)：该特性不支持与Routing Behind MS同时应用。
- [GWFD-020412](feature/UDG/20.15.2/GWFD-020412.md)：L2TP VPN通过LNS设备实现了Routing Behind MS功能，所以在同一APN下，L2TP VPN和Routing Behind MS无需同时部署。
- [GWFD-020482](feature/UDG/20.15.2/GWFD-020482.md)：手机后路由用户的IPv4业务报文，不支持入不转板。
- [GWFD-020482](feature/UDG/20.15.2/GWFD-020482.md)：手机后路由用户不支持入不转板功能。
- [GWFD-020501](feature/UDG/20.15.2/GWFD-020501.md)：IPv4手机后路由用户不支持ULCL分流功能。
- [GWFD-020531](feature/UDG/20.15.2/GWFD-020531.md)：手机后路由用户不支持通用DNN漫游分流功能。
- [GWFD-020531](feature/UDG/20.15.2/GWFD-020531.md)：IPv4手机后路由用户不支持通用DNN漫游分流功能。

## 证据

- 原始手册：`evidence/UDG/20.15.2/GWFD-110910-支持Routing-Behind-MS特性概述_74264899.md`
- 原始手册：`evidence/UDG/20.15.2/GWFD-110910-支持Routing-Behind-MS参考信息_74264906.md`
- 原始手册：`evidence/UDG/20.15.2/5GC业务流程_74264903.md`
- 原始手册：`evidence/UDG/20.15.2/EPC业务流程_74264902.md`
- 原始手册：`evidence/UDG/20.15.2/GPRS_UMTS业务流程_74264901.md`
- 原始手册：`evidence/UDG/20.15.2/激活支持Routing-Behind-MS_74264904.md`
- 原始手册：`evidence/UDG/20.15.2/调测支持Routing-Behind-MS_74264905.md`
