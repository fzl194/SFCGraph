---
id: UDG@20.15.2@MMLCommand@RMV MULTICASTSOURCE
type: MMLCommand
name: RMV MULTICASTSOURCE（删除IGMP Snooping组播源配置）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV MULTICASTSOURCE（删除IGMP Snooping组播源配置）
...
- [IGMP Snooping组播源配置（MULTICASTSOURCE）](configobject/UDG/20.15.2/MULTICASTSOURCE.md)
