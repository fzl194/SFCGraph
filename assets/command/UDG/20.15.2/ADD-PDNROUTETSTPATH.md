---
id: UDG@20.15.2@MMLCommand@ADD PDNROUTETSTPATH
type: MMLCommand
name: ADD PDNROUTETSTPATH（增加UPF向PDN服务器发送探测消息的探测路径）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD PDNROUTETSTPATH（增加UPF向PDN服务器发送探测消息的探测路径）
...
- [UPF向PDN服务器发送探测消息的探测路径配置（PDNROUTETSTPATH）](configobject/UDG/20.15.2/PDNROUTETSTPATH.md)
