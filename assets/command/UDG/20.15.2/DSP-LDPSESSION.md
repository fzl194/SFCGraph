---
id: UDG@20.15.2@MMLCommand@DSP LDPSESSION
type: MMLCommand
...
- [LDP会话（LDPSESSION）](configobject/UDG/20.15.2/LDPSESSION.md)
...
- 原始手册：`evidence/UDG/20.15.2/显示LDP会话（DSP-LDPSESSION）_50281462.md`
