---
id: UDG@20.15.2@MMLCommand@SET BMBYPASSSTATUS
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@BMBYPASSSTATUS]] · 裸机BYPASS状态（BMBYPASSSTATUS）
...
- 原始手册：`evidence/UDG/20.15.2/SET-BMBYPASSSTATUS.md`
