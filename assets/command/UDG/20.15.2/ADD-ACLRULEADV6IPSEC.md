---
id: UDG@20.15.2@MMLCommand@ADD ACLRULEADV6IPSEC
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@ACLRULEADV6IPSEC]] · 高级IPv6 ACL规则（ACLRULEADV6IPSEC）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-ACLRULEADV6IPSEC.md`
