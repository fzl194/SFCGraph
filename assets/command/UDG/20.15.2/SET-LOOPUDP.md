---
id: UDG@20.15.2@MMLCommand@SET LOOPUDP
type: MMLCommand
name: SET LOOPUDP（配置UDP环回功能）
nf: UDG
version: 20.15.2
verb: SET
...
- [[UDG@20.15.2@ConfigObject@LOOPUDP]] · UDP环回配置（LOOPUDP）
...
- 原始手册：`evidence/UDG/20.15.2/SET-LOOPUDP.md`
