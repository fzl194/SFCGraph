---
id: UDG@20.15.2@MMLCommand@ADD ATTACHIKEPEER
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@ATTACHIKEPEER]] · 绑定IKE对等体（ATTACHIKEPEER）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-ATTACHIKEPEER.md`
