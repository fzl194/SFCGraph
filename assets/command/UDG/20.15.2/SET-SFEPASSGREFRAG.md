---
id: UDG@20.15.2@MMLCommand@SET SFEPASSGREFRAG
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@SFEPASSGREFRAG]] · SFE透传GRE分片报文使能配置（SFEPASSGREFRAG）
...
- 原始手册：`evidence/UDG/20.15.2/SET-SFEPASSGREFRAG.md`
