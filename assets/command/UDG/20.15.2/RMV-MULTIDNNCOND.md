---
id: UDG@20.15.2@MMLCommand@RMV MULTIDNNCOND
type: MMLCommand
name: RMV MULTIDNNCOND（删除多DNN条件）
nf: UDG
version: 20.15.2
verb: RMV
...
- [[UDG@20.15.2@ConfigObject@MULTIDNNCOND]] · 多DNN条件（MULTIDNNCOND）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-MULTIDNNCOND.md`
