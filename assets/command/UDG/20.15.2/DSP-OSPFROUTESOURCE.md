---
id: UDG@20.15.2@MMLCommand@DSP OSPFROUTESOURCE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@OSPFROUTESOURCE]] · OSPF路由源信息（OSPFROUTESOURCE）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-OSPFROUTESOURCE.md`
