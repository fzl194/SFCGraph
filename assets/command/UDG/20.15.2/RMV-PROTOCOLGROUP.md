---
id: UDG@20.15.2@MMLCommand@RMV PROTOCOLGROUP
type: MMLCommand
name: RMV PROTOCOLGROUP（删除自定义协议组）
nf: UDG
version: 20.15.2
verb: RMV
...
- [自定义协议组（PROTOCOLGROUP）](configobject/UDG/20.15.2/PROTOCOLGROUP.md)
