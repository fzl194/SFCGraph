---
id: UDG@20.15.2@MMLCommand@SET ELECTSERVICE
type: MMLCommand
name: SET ELECTSERVICE（设置仲裁服务配置）
nf: UDG
version: 20.15.2
verb: SET
...
- [[configobject/UDG/20.15.2/ELECTSERVICE]] · 仲裁服务状态（ELECTSERVICE）
