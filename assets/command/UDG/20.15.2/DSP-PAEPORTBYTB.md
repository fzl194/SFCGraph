---
id: UDG@20.15.2@MMLCommand@DSP PAEPORTBYTB
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@PAEPORTBYTB]] · PAE Fabric端口的TB统计信息（PAEPORTBYTB）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-PAEPORTBYTB.md`
