---
id: UDG@20.15.2@MMLCommand@DSP MSSACLERRINFO
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@MSSACLERRINFO]] · 软转发支撑访问控制列表模块错误信息（MSSACLERRINFO）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-MSSACLERRINFO.md`
