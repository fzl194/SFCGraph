---
id: UDG@20.15.2@MMLCommand@SYN ACSPEERCFG
type: MMLCommand
...
![](启动或停止ACS与远端设备的配置同步(SYN ACSPEERCFG)_87242094.assets/notice_3.0-zh-cn.png)
...
- [或停止ACS与远端设备的配置同步（ACSPEERCFG）](configobject/UDG/20.15.2/ACSPEERCFG.md)
