---
id: UDG@20.15.2@MMLCommand@ADD IPSECPOLICY6
type: MMLCommand
...
- [[configobject/UDG/20.15.2/IPSECPOLICY6]] · IPsec IPv6策略（IPSECPOLICY6）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-IPSECPOLICY6.md`
