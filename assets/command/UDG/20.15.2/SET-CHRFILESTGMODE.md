---
id: UDG@20.15.2@MMLCommand@SET CHRFILESTGMODE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@CHRFILESTGMODE]] · 上传至文件服务器的CHR文件转储方式（CHRFILESTGMODE）
...
- 原始手册：`evidence/UDG/20.15.2/SET-CHRFILESTGMODE.md`
