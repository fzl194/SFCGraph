---
id: UDG@20.15.2@MMLCommand@ADD ECHOIPLIST
type: MMLCommand
name: ADD ECHOIPLIST（配置GTP路径管理IP地址）
nf: UDG
version: 20.15.2
verb: ADD
...
- [[UDG@20.15.2@ConfigObject@ECHOIPLIST]] · GTP路径管理IP地址（ECHOIPLIST）

## 关联任务

- [[UDG@20.15.2@Task@0-00054]]
...
- 原始手册：`evidence/UDG/20.15.2/ADD-ECHOIPLIST.md`
