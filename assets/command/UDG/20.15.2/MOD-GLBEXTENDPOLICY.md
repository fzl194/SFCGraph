---
id: UDG@20.15.2@MMLCommand@MOD GLBEXTENDPOLICY
type: MMLCommand
name: MOD GLBEXTENDPOLICY（修改全局扩展策略）
nf: UDG
version: 20.15.2
verb: MOD
...
- [[UDG@20.15.2@ConfigObject@GLBEXTENDPOLICY]] · 全局扩展策略（GLBEXTENDPOLICY）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-GLBEXTENDPOLICY.md`
