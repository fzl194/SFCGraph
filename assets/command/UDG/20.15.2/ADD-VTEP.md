---
id: UDG@20.15.2@MMLCommand@ADD VTEP
type: MMLCommand
name: ADD VTEP（增加VXLAN隧道端点配置）
nf: UDG
version: 20.15.2
verb: ADD
object_keyword: VTEP
...
- [[UDG@20.15.2@ConfigObject@VTEP]] · VXLAN隧道端点（VTEP）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-VTEP.md`
