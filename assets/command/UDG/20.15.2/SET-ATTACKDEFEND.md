---
id: UDG@20.15.2@MMLCommand@SET ATTACKDEFEND
type: MMLCommand
name: SET ATTACKDEFEND（设置攻击防范参数）
nf: UDG
version: 20.15.2
verb: SET
...
- [[UDG@20.15.2@ConfigObject@ATTACKDEFEND]] · 攻击防范参数（ATTACKDEFEND）
...
- 原始手册：`evidence/UDG/20.15.2/SET-ATTACKDEFEND.md`
