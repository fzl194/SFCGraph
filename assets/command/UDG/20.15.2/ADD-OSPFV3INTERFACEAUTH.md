---
id: UDG@20.15.2@MMLCommand@ADD OSPFV3INTERFACEAUTH
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@OSPFV3INTERFACEAUTH]] · OSPFv3接口认证配置（OSPFV3INTERFACEAUTH）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-OSPFV3INTERFACEAUTH.md`
