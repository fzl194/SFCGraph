---
id: UDG@20.15.2@MMLCommand@LST TCPBPCFG
type: MMLCommand
...
- [TCP过载反压HTTP流控配置（TCPBPCFG）](configobject/UDG/20.15.2/TCPBPCFG.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询TCP过载反压HTTP流控配置（LST-TCPBPCFG）_30355637.md`
