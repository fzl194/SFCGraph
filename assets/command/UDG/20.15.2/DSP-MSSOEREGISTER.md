---
id: UDG@20.15.2@MMLCommand@DSP MSSOEREGISTER
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@MSSOEREGISTER]] · 用户注册的保序信息（MSSOEREGISTER）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-MSSOEREGISTER.md`
