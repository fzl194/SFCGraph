---
id: UDG@20.15.2@MMLCommand@RMV PROTGBINDFLOWF
type: MMLCommand
name: RMV PROTGBINDFLOWF（删除流过滤器协议组绑定关系）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV PROTGBINDFLOWF（删除流过滤器协议组绑定关系）
...
- [[UDG@20.15.2@ConfigObject@PROTGBINDFLOWF]] · 流过滤器协议组绑定关系（PROTGBINDFLOWF）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-PROTGBINDFLOWF.md`
