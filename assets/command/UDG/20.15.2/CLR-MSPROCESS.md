---
id: UDG@20.15.2@MMLCommand@CLR MSPROCESS
type: MMLCommand
...
![](清除进程（CLR MSPROCESS）_00520125.assets/notice_3.0-zh-cn.png)
...
- [复位微服务进程（MSPROCESS）](configobject/UDG/20.15.2/MSPROCESS.md)
