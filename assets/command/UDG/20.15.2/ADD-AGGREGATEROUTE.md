---
id: UDG@20.15.2@MMLCommand@ADD AGGREGATEROUTE
type: MMLCommand
name: ADD AGGREGATEROUTE（增加BGP聚合路由）
nf: UDG
version: 20.15.2
verb: ADD
...
- [BGP聚合路由（AGGREGATEROUTE）](configobject/UDG/20.15.2/AGGREGATEROUTE.md)
