---
id: UDG@20.15.2@MMLCommand@ADD IPSECINTFCFGIPSEC
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@IPSECINTFCFGIPSEC]] · IPsec隧道接口（IPSECINTFCFGIPSEC）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-IPSECINTFCFGIPSEC.md`
