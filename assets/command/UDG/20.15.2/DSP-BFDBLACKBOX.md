---
id: UDG@20.15.2@MMLCommand@DSP BFDBLACKBOX
type: MMLCommand
name: DSP BFDBLACKBOX（查询BFD黑匣子信息）
nf: UDG
version: 20.15.2
verb: DSP
object_keyword: BFDBLACKBOX
...
- [BFD黑匣子信息（BFDBLACKBOX）](configobject/UDG/20.15.2/BFDBLACKBOX.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询BFD黑匣子信息（DSP-BFDBLACKBOX）_00601513.md`
