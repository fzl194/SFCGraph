---
id: UDG@20.15.2@MMLCommand@ACT UFPLATENCYSTAT
type: MMLCommand
...
![](激活UFP逐包转发时延度量开关（ACT UFPLATENCYSTAT）_04560596.assets/notice_3.0-zh-cn.png)
...
- [[configobject/UDG/20.15.2/UFPLATENCYSTAT]] · UFP逐包转发时延度量开关（UFPLATENCYSTAT）
