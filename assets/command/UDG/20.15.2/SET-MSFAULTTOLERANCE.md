---
id: UDG@20.15.2@MMLCommand@SET MSFAULTTOLERANCE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@MSFAULTTOLERANCE]] · 故障检测参数（MSFAULTTOLERANCE）
...
- 原始手册：`evidence/UDG/20.15.2/SET-MSFAULTTOLERANCE.md`
