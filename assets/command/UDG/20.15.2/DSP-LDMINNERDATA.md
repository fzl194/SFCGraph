---
id: UDG@20.15.2@MMLCommand@DSP LDMINNERDATA
type: MMLCommand
...
- [LDM诊断信息（LDMINNERDATA）](configobject/UDG/20.15.2/LDMINNERDATA.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询LDM诊断信息（DSP-LDMINNERDATA）_50281178.md`
