---
id: UDG@20.15.2@MMLCommand@RMV MATCHRDFILTER
type: MMLCommand
name: RMV MATCHRDFILTER（删除匹配RD过滤器）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV MATCHRDFILTER（删除匹配RD过滤器）

## 功能

该命令用来删除基于RD属性过滤器的匹配规则。
...
- [匹配RD过滤器（MATCHRDFILTER）](configobject/UDG/20.15.2/MATCHRDFILTER.md)
...
```
RMV MATCHRDFILTER:POLICYNAME="a",NODESEQUENCE=10,RDINDEX=20;
```
