---
id: UDG@20.15.2@MMLCommand@LST QOSIFPHB
type: MMLCommand
...
- [[configobject/UDG/20.15.2/QOSIFPHB]] · 禁止QoS优先级映射的类型（QOSIFPHB）
...
- 原始手册：`evidence/UDG/20.15.2/查询禁止QoS优先级映射的类型（LST-QOSIFPHB）_00841321.md`
