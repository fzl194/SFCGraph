---
id: UDG@20.15.2@MMLCommand@ADD NGBINDUEMUTWL
type: MMLCommand
name: ADD NGBINDUEMUTWL（增加5G LAN组绑定PA口UE互访白名单）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD NGBINDUEMUTWL（增加5G LAN组绑定PA口UE互访白名单）
...
- [[UDG@20.15.2@ConfigObject@NGBINDUEMUTWL]] · 5G LAN组绑定PA口UE互访白名单（NGBINDUEMUTWL）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-NGBINDUEMUTWL.md`
