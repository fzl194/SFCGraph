---
id: UDG@20.15.2@MMLCommand@DSP FEI_FRM_CST_POOL
type: MMLCommand
...
- [[configobject/UDG/20.15.2/FEI_FRM_CST_POOL]] · 资源池列表的资源占用情况（FEI_FRM_CST_POOL）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-FEI_FRM_CST_POOL.md`
