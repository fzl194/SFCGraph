---
id: UDG@20.15.2@MMLCommand@LST AUTORP
type: MMLCommand
name: LST AUTORP（查询Auto-RP配置）
nf: UDG
version: 20.15.2
verb: LST
...
- [[configobject/UDG/20.15.2/AUTORP]] · Auto-RP配置（AUTORP）
...
```
LST AUTORP:VRFNAME="_public_",ADDRESSFAMILY=ipv4unicast;
```
...
- 原始手册：`evidence/UDG/20.15.2/LST-AUTORP.md`
