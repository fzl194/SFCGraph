---
id: UDG@20.15.2@MMLCommand@MOD APPLYPREFVALUE
type: MMLCommand
name: MOD APPLYPREFVALUE（修改BGP路由首选值设置）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD APPLYPREFVALUE（修改BGP路由首选值设置）
...
- [BGP路由首选值设置（APPLYPREFVALUE）](configobject/UDG/20.15.2/APPLYPREFVALUE.md)

## 使用实例

修改abc路由策略1节点下，首选值设置为2：

```
MOD APPLYPREFVALUE:POLICYNAME="abc",NODESEQUENCE=1,PREFERREDVALUE=2;
```
