---
id: UDG@20.15.2@MMLCommand@SET UPLINKCONGCTRL
type: MMLCommand
name: SET UPLINKCONGCTRL（设置Diameter链路拥塞控制）
nf: UDG
version: 20.15.2
verb: SET
...
# SET UPLINKCONGCTRL（设置Diameter链路拥塞控制）
...
- [Diameter链路拥塞控制（UPLINKCONGCTRL）](configobject/UDG/20.15.2/UPLINKCONGCTRL.md)
