---
id: UDG@20.15.2@MMLCommand@ACT IMSIBLOCKWKPOD
type: MMLCommand
name: ACT IMSIBLOCKWKPOD（阻塞IMSI在特定的Worker Pod上激活配置）
nf: UDG
version: 20.15.2
verb: ACT
...
# ACT IMSIBLOCKWKPOD（阻塞IMSI在特定的Worker Pod上激活配置）
...
- [[UDG@20.15.2@ConfigObject@IMSIBLOCKWKPOD]] · 阻塞IMSI在特定的Worker Pod上激活信息（IMSIBLOCKWKPOD）
...
- 原始手册：`evidence/UDG/20.15.2/ACT-IMSIBLOCKWKPOD.md`
