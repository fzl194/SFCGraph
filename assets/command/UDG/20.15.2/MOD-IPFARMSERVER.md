---
id: UDG@20.15.2@MMLCommand@MOD IPFARMSERVER
type: MMLCommand
name: MOD IPFARMSERVER（修改IPFarmServer）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD IPFARMSERVER（修改IPFarmServer）
...
- [[UDG@20.15.2@ConfigObject@IPFARMSERVER]] · IPFarmServer（IPFARMSERVER）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-IPFARMSERVER.md`
