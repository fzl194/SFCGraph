---
id: UDG@20.15.2@MMLCommand@ADD UPDIAMLOCINFO
type: MMLCommand
name: ADD UPDIAMLOCINFO（增加Diameter本端信息）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD UPDIAMLOCINFO（增加Diameter本端信息）
...
- [Diameter本端信息（UPDIAMLOCINFO）](configobject/UDG/20.15.2/UPDIAMLOCINFO.md)
