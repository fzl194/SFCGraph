---
id: UDG@20.15.2@MMLCommand@LST VPNINSTAFIPSEC
type: MMLCommand
...
- [[configobject/UDG/20.15.2/VPNINSTAFIPSEC]] · L3VPN实例地址族（VPNINSTAFIPSEC）
...
- 原始手册：`evidence/UDG/20.15.2/LST-VPNINSTAFIPSEC.md`
