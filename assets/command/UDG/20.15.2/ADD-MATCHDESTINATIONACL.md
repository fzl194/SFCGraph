---
id: UDG@20.15.2@MMLCommand@ADD MATCHDESTINATIONACL
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@MATCHDESTINATIONACL]] · 目的IP地址基础ACL匹配路由策略（MATCHDESTINATIONACL）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-MATCHDESTINATIONACL.md`
