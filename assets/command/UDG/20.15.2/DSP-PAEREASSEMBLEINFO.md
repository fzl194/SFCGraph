---
id: UDG@20.15.2@MMLCommand@DSP PAEREASSEMBLEINFO
type: MMLCommand
...
- [[configobject/UDG/20.15.2/PAEREASSEMBLEINFO]] · PAE分片重组统计信息（PAEREASSEMBLEINFO）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-PAEREASSEMBLEINFO.md`
