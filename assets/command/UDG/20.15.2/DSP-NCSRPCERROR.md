---
id: UDG@20.15.2@MMLCommand@DSP NCSRPCERROR
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@NCSRPCERROR]] · 最近的RPC和错误RPC响应报文信息（NCSRPCERROR）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-NCSRPCERROR.md`
