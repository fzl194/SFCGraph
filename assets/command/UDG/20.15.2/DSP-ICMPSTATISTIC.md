---
id: UDG@20.15.2@MMLCommand@DSP ICMPSTATISTIC
type: MMLCommand
...
- [ICMP报文统计（ICMPSTATISTIC）](configobject/UDG/20.15.2/ICMPSTATISTIC.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询ICMP报文统计（DSP-ICMPSTATISTIC）_00840689.md`
