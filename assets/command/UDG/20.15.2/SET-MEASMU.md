---
id: UDG@20.15.2@MMLCommand@SET MEASMU
type: MMLCommand
...
| DEFMEAS | 默认测量 | 可选必选说明：当<br>**类型**<br>选择<br>“DEF_MEAS(默认测量)”<br>时，为必选参数。参数含义：任务是否默认测量。<br>取值范围：枚举<br>- DEFAULT(默认配置)<br>- YES(是)<br>- NO(否)<br>默认值：无。<br>配置原则：无。 |

## 操作的配置对象

- [[UDG@20.15.2@ConfigObject@MEASMU]] · 话统测量单元模型（MEASMU）
...
- 原始手册：`evidence/UDG/20.15.2/SET-MEASMU.md`
