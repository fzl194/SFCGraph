---
id: UDG@20.15.2@MMLCommand@ADD TWAMPCLIENT
type: MMLCommand
name: ADD TWAMPCLIENT（增加TWAMP客户端）
nf: UDG
version: 20.15.2
verb: ADD
...
- [TWAMP客户端（TWAMPCLIENT）](configobject/UDG/20.15.2/TWAMPCLIENT.md)

## 关联任务

- [0-00227](task/UDG/20.15.2/0-00227.md)
