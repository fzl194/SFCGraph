---
id: UDG@20.15.2@MMLCommand@MOD IFIPV4UNNUMIPSEC
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@IFIPV4UNNUMIPSEC]] · 接口IPv4借用地址（IFIPV4UNNUMIPSEC）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-IFIPV4UNNUMIPSEC.md`
