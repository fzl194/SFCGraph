---
id: UDG@20.15.2@MMLCommand@SET DISKPARTITION
type: MMLCommand
name: SET DISKPARTITION（设置资源磁盘分区过载配置）
nf: UDG
version: 20.15.2
verb: SET
...
# SET DISKPARTITION（设置资源磁盘分区过载配置）
...
- [资源磁盘分区过载配置（DISKPARTITION）](configobject/UDG/20.15.2/DISKPARTITION.md)
...
- 原始手册：`evidence/UDG/20.15.2/设置资源磁盘分区过载配置（SET-DISKPARTITION）_59036385.md`
