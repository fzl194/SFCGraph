---
id: UDG@20.15.2@MMLCommand@CLB ACSPATCH
type: MMLCommand
...
![](校正补丁包（CLB ACSPATCH）_31115871.assets/notice_3.0-zh-cn.png)
...
- [[UDG@20.15.2@ConfigObject@ACSPATCH]] · 补丁（ACSPATCH）
...
- 原始手册：`evidence/UDG/20.15.2/CLB-ACSPATCH.md`
