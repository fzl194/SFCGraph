---
id: UDG@20.15.2@MMLCommand@ADD MATCHNEXTHOPACL
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@MATCHNEXTHOPACL]] · 下一跳基础ACL匹配路由策略（MATCHNEXTHOPACL）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-MATCHNEXTHOPACL.md`
