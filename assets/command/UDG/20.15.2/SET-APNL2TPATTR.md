---
id: UDG@20.15.2@MMLCommand@SET APNL2TPATTR
type: MMLCommand
name: SET APNL2TPATTR（设置APN L2TP配置）
nf: UDG
version: 20.15.2
verb: SET
...
- [APN L2TP配置（APNL2TPATTR）](configobject/UDG/20.15.2/APNL2TPATTR.md)

## 关联任务

- [0-00132](task/UDG/20.15.2/0-00132.md)
