---
id: UDG@20.15.2@MMLCommand@RMV PROPATTACHIPSECPROPOSAL
type: MMLCommand
...
![](删除IPsec策略绑定提议（RMV PROPATTACHIPSECPROPOSAL）_80911000.assets/notice_3.0-zh-cn.png)
...
- [[UDG@20.15.2@ConfigObject@PROPATTACHIPSECPROPOSAL]] · IPsec策略绑定提议（PROPATTACHIPSECPROPOSAL）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-PROPATTACHIPSECPROPOSAL.md`
