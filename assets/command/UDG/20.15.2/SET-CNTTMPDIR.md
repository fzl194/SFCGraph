---
id: UDG@20.15.2@MMLCommand@SET CNTTMPDIR
type: MMLCommand
...
- [[configobject/UDG/20.15.2/CNTTMPDIR]] · 容器引擎临时目录（CNTTMPDIR）
...
- 原始手册：`evidence/UDG/20.15.2/设置容器引擎临时目录（SET-CNTTMPDIR）_89151642.md`
