---
id: UDG@20.15.2@MMLCommand@DSP RESPROCMSGAREA
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@RESPROCMSGAREA]] · 进程消息分区信息（RESPROCMSGAREA）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-RESPROCMSGAREA.md`
