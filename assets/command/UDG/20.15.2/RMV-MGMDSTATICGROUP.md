---
id: UDG@20.15.2@MMLCommand@RMV MGMDSTATICGROUP
type: MMLCommand
name: RMV MGMDSTATICGROUP（删除IGMP静态组配置）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV MGMDSTATICGROUP（删除IGMP静态组配置）
...
- [IGMP静态组配置（MGMDSTATICGROUP）](configobject/UDG/20.15.2/MGMDSTATICGROUP.md)

## 使用实例

删除源为10.0.10.1，组地址为239.0.0.1的IGMP静态组：

```
RMV MGMDSTATICGROUP: VRFNAME="_public_", ADDRESSFAMILY=ipv4unicast, IFNAME="Ethernet64/0/5", STATICGRP="239.0.0.1", ISSOURCEADDR=TRUE, SRCADDR="10.0.10.1", ISSTEPGRPVALUE=FALSE;
```
