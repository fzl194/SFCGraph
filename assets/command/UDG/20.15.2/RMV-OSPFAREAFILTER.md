---
id: UDG@20.15.2@MMLCommand@RMV OSPFAREAFILTER
type: MMLCommand
...
- [[configobject/UDG/20.15.2/OSPFAREAFILTER]] · 区域过滤策略配置（OSPFAREAFILTER）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-OSPFAREAFILTER.md`
