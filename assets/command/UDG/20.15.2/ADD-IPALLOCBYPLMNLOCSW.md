---
id: UDG@20.15.2@MMLCommand@ADD IPALLOCBYPLMNLOCSW
type: MMLCommand
name: ADD IPALLOCBYPLMNLOCSW（添加基于位置区+PLMN分配地址的开关）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD IPALLOCBYPLMNLOCSW（添加基于位置区+PLMN分配地址的开关）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-IPALLOCBYPLMNLOCSW.md`
