---
id: UDG@20.15.2@MMLCommand@MOD LDPINSTANCE
type: MMLCommand
...
- [[configobject/UDG/20.15.2/LDPINSTANCE]] · LDP实例（LDPINSTANCE）
...
- 原始手册：`evidence/UDG/20.15.2/修改LDP实例（MOD-LDPINSTANCE）_50280902.md`
