---
id: UDG@20.15.2@MMLCommand@MOD MATCHRTSRCACL6
type: MMLCommand
name: MOD MATCHRTSRCACL6（修改匹配IPv6源路由地址ACL）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD MATCHRTSRCACL6（修改匹配IPv6源路由地址ACL）

## 功能

该命令用于修改基于IPv6信息的ACL匹配源路由。
...
```
MOD MATCHRTSRCACL6:NODESEQUENCE=10,ACLNAMEORNUM="abc", POLICYNAME="a";
```
