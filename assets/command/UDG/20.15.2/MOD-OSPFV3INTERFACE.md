---
id: UDG@20.15.2@MMLCommand@MOD OSPFV3INTERFACE
type: MMLCommand
...
- [[configobject/UDG/20.15.2/OSPFV3INTERFACE]] · OSPFv3接口配置（OSPFV3INTERFACE）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-OSPFV3INTERFACE.md`
