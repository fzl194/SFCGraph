---
id: UDG@20.15.2@MMLCommand@MOD APNIMSSIGFLTR
type: MMLCommand
name: MOD APNIMSSIGFLTR（修改APN的IMS分类器）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD APNIMSSIGFLTR（修改APN的IMS分类器）
...
- [APN的IMS分类器（APNIMSSIGFLTR）](configobject/UDG/20.15.2/APNIMSSIGFLTR.md)
