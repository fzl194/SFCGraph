---
id: UDG@20.15.2@MMLCommand@ADD IPBINDVPNIPSEC
type: MMLCommand
...
- [[configobject/UDG/20.15.2/IPBINDVPNIPSEC]] · 接口绑定VPN（IPBINDVPNIPSEC）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-IPBINDVPNIPSEC.md`
