---
id: UDG@20.15.2@MMLCommand@LST MULTICASTSOURCE
type: MMLCommand
name: LST MULTICASTSOURCE（查询IGMP Snooping组播源配置。）
nf: UDG
version: 20.15.2
verb: LST
...
# LST MULTICASTSOURCE（查询IGMP Snooping组播源配置。）
...
- [[configobject/UDG/20.15.2/MULTICASTSOURCE]] · IGMP Snooping组播源配置（MULTICASTSOURCE）
...
- 原始手册：`evidence/UDG/20.15.2/LST-MULTICASTSOURCE.md`
