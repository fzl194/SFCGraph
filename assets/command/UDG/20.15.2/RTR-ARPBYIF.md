---
id: UDG@20.15.2@MMLCommand@RTR ARPBYIF
type: MMLCommand
...
![](根据接口清除ARP动态表项（RTR ARPBYIF）_00840969.assets/notice_3.0-zh-cn.png)
...
- [根据接口清除ARP动态表项（ARPBYIF）](configobject/UDG/20.15.2/ARPBYIF.md)
...
- 原始手册：`evidence/UDG/20.15.2/根据接口清除ARP动态表项（RTR-ARPBYIF）_00840969.md`
