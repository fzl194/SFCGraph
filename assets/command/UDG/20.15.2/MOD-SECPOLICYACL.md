---
id: UDG@20.15.2@MMLCommand@MOD SECPOLICYACL
type: MMLCommand
name: MOD SECPOLICYACL（修改安全策略ACL规则）
nf: UDG
version: 20.15.2
verb: MOD
...
- [[UDG@20.15.2@ConfigObject@SECPOLICYACL]] · 安全策略ACL规则（SECPOLICYACL）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-SECPOLICYACL.md`
