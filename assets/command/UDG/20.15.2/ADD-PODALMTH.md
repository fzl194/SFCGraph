---
id: UDG@20.15.2@MMLCommand@ADD PODALMTH
type: MMLCommand
name: ADD PODALMTH（增加POD资源告警阈值）
nf: UDG
version: 20.15.2
verb: ADD
...
- [[UDG@20.15.2@ConfigObject@PODALMTH]] · POD资源告警阈值（PODALMTH）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-PODALMTH.md`
