---
id: UDG@20.15.2@MMLCommand@LST SADEDICBEARER
type: MMLCommand
name: LST SADEDICBEARER（查询业务感知专有承载配置）
nf: UDG
version: 20.15.2
verb: LST
...
# LST SADEDICBEARER（查询业务感知专有承载配置）
...
- 原始手册：`evidence/UDG/20.15.2/LST-SADEDICBEARER.md`
