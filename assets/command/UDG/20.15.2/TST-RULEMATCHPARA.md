---
id: UDG@20.15.2@MMLCommand@TST RULEMATCHPARA
type: MMLCommand
name: TST RULEMATCHPARA（构造规则匹配需要的报文信息）
nf: UDG
version: 20.15.2
verb: TST
...
# TST RULEMATCHPARA（构造规则匹配需要的报文信息）
...
- [[UDG@20.15.2@ConfigObject@RULEMATCHPARA]] · 规则匹配报文信息构造状态（RULEMATCHPARA）
...
- 原始手册：`evidence/UDG/20.15.2/TST-RULEMATCHPARA.md`
