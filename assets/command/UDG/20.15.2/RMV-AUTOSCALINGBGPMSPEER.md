---
id: UDG@20.15.2@MMLCommand@RMV AUTOSCALINGBGPMSPEER
type: MMLCommand
name: RMV AUTOSCALINGBGPMSPEER（删除BGP自动化多源邻居配置模板）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV AUTOSCALINGBGPMSPEER（删除BGP自动化多源邻居配置模板）
...
- [BGP自动化多源邻居配置模板（AUTOSCALINGBGPMSPEER）](configobject/UDG/20.15.2/AUTOSCALINGBGPMSPEER.md)
