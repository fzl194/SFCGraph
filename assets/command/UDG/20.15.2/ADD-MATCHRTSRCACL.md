---
id: UDG@20.15.2@MMLCommand@ADD MATCHRTSRCACL
type: MMLCommand
name: ADD MATCHRTSRCACL（增加源路由基础ACL匹配路由策略）
nf: UDG
version: 20.15.2
verb: ADD
object_keyword: MATCHRTSRCACL
...
# ADD MATCHRTSRCACL（增加源路由基础ACL匹配路由策略）
...
- [源路由基础ACL匹配路由策略（MATCHRTSRCACL）](configobject/UDG/20.15.2/MATCHRTSRCACL.md)
...
```
ADD MATCHRTSRCACL:NODESEQUENCE=10,ACLNAMEORNUM="abc", POLICYNAME="a";
```
