---
id: UDG@20.15.2@MMLCommand@DSP COMPSTATTRACE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@COMPSTATTRACE]] · 当前组件的状态记录信息（COMPSTATTRACE）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-COMPSTATTRACE.md`
