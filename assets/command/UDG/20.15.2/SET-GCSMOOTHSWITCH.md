---
id: UDG@20.15.2@MMLCommand@SET GCSMOOTHSWITCH
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@GCSMOOTHSWITCH]] · GC平滑开关（GCSMOOTHSWITCH）
...
- 原始手册：`evidence/UDG/20.15.2/SET-GCSMOOTHSWITCH.md`
