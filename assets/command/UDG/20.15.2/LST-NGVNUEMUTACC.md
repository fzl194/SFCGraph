---
id: UDG@20.15.2@MMLCommand@LST NGVNUEMUTACC
type: MMLCommand
name: LST NGVNUEMUTACC（查询5G LAN组下用户互访控制配置）
nf: UDG
version: 20.15.2
verb: LST
...
# LST NGVNUEMUTACC（查询5G LAN组下用户互访控制配置）
...
- [[configobject/UDG/20.15.2/NGVNUEMUTACC]] · 5G LAN组下用户互访控制配置（NGVNUEMUTACC）
