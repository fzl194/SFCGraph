---
id: UDG@20.15.2@MMLCommand@DSP WLRIFFLOWRULE
type: MMLCommand
...
- [[configobject/UDG/20.15.2/WLRIFFLOWRULE]] · 无线路由IPv4接口引流表信息（WLRIFFLOWRULE）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-WLRIFFLOWRULE.md`
