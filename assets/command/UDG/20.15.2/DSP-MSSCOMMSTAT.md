---
id: UDG@20.15.2@MMLCommand@DSP MSSCOMMSTAT
type: MMLCommand
...
- [通信模块规则匹配统计信息（MSSCOMMSTAT）](configobject/UDG/20.15.2/MSSCOMMSTAT.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询通信模块规则匹配统计信息（DSP-MSSCOMMSTAT）_50120646.md`
