---
id: UDG@20.15.2@MMLCommand@ADD BFDSESSION
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@BFDSESSION]] · BFD会话参数（BFDSESSION）

## 关联任务

- [[UDG@20.15.2@Task@0-00082]]
...
- 原始手册：`evidence/UDG/20.15.2/ADD-BFDSESSION.md`
