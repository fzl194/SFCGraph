---
id: UDG@20.15.2@MMLCommand@ADD AFPROXYSERVER
type: MMLCommand
name: ADD AFPROXYSERVER（增加防欺诈可信代理服务器）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD AFPROXYSERVER（增加防欺诈可信代理服务器）
...
- [[UDG@20.15.2@ConfigObject@AFPROXYSERVER]] · 防欺诈可信代理服务器（AFPROXYSERVER）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-AFPROXYSERVER.md`
