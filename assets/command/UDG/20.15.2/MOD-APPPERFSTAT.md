---
id: UDG@20.15.2@MMLCommand@MOD APPPERFSTAT
type: MMLCommand
name: MOD APPPERFSTAT（修改应用性能统计）
nf: UDG
version: 20.15.2
verb: MOD
...
- [应用性能统计（APPPERFSTAT）](configobject/UDG/20.15.2/APPPERFSTAT.md)
