---
id: UDG@20.15.2@MMLCommand@DSP OSPFSOCKETINFO
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@OSPFSOCKETINFO]] · OSPF与Socket的交互信息（OSPFSOCKETINFO）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-OSPFSOCKETINFO.md`
