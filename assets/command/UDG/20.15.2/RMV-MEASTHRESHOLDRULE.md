---
id: UDG@20.15.2@MMLCommand@RMV MEASTHRESHOLDRULE
type: MMLCommand
...
| TRN | 阈值规则名称 | 可选必选说明：必选参数。<br>参数含义：阈值规则名称。<br>取值范围：字符串类型，长度不超过80个字符。<br>默认值：无。<br>配置原则：仅支持“A-Z”、“a-z”、“0-9”、“-_”、“\u4e00-\u9fa5”中文字符组合。 |

## 操作的配置对象

- [[UDG@20.15.2@ConfigObject@MEASTHRESHOLDRULE]] · 话统阈值规则（MEASTHRESHOLDRULE）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-MEASTHRESHOLDRULE.md`
