---
id: UDG@20.15.2@MMLCommand@LST CFPROFBINDCFT
type: MMLCommand
name: LST CFPROFBINDCFT（查询内容过滤策略绑定关系）
nf: UDG
version: 20.15.2
verb: LST
...
# LST CFPROFBINDCFT（查询内容过滤策略绑定关系）
...
- [[UDG@20.15.2@ConfigObject@CFPROFBINDCFT]] · 内容过滤策略绑定关系（CFPROFBINDCFT）
...
- 原始手册：`evidence/UDG/20.15.2/LST-CFPROFBINDCFT.md`
