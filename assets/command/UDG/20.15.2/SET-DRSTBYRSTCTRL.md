---
id: UDG@20.15.2@MMLCommand@SET DRSTBYRSTCTRL
type: MMLCommand
...
- [[configobject/UDG/20.15.2/DRSTBYRSTCTRL]] · 运行备整系统复位开关（DRSTBYRSTCTRL）
...
- 原始手册：`evidence/UDG/20.15.2/SET-DRSTBYRSTCTRL.md`
