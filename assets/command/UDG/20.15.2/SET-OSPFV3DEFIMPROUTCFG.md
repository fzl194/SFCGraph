---
id: UDG@20.15.2@MMLCommand@SET OSPFV3DEFIMPROUTCFG
type: MMLCommand
...
- [[configobject/UDG/20.15.2/OSPFV3DEFIMPROUTCFG]] · OSPFv3引入路由默认配置（OSPFV3DEFIMPROUTCFG）
...
- 原始手册：`evidence/UDG/20.15.2/设置OSPFv3引入路由默认配置（SET-OSPFV3DEFIMPROUTCFG）_49960946.md`
