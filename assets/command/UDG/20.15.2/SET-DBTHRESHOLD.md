---
id: UDG@20.15.2@MMLCommand@SET DBTHRESHOLD
type: MMLCommand
name: SET DBTHRESHOLD（设置CSDB配置过载门限）
nf: UDG
version: 20.15.2
verb: SET
...
# SET DBTHRESHOLD（设置CSDB配置过载门限）

## 功能

![](设置CSDB配置过载门限(SET DBTHRESHOLD)_78080690.assets/notice_3.0-zh-cn.png)
...
- [[configobject/UDG/20.15.2/DBTHRESHOLD]] · CSDB配置过载门限（DBTHRESHOLD）
...
- 原始手册：`evidence/UDG/20.15.2/设置CSDB配置过载门限(SET-DBTHRESHOLD)_78080690.md`
