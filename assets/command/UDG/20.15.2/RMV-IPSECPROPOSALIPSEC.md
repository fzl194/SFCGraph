---
id: UDG@20.15.2@MMLCommand@RMV IPSECPROPOSALIPSEC
type: MMLCommand
...
![](删除IPsec提议（RMV IPSECPROPOSALIPSEC）_26150763.assets/notice_3.0-zh-cn.png)
...
- 原始手册：`evidence/UDG/20.15.2/RMV-IPSECPROPOSALIPSEC.md`
