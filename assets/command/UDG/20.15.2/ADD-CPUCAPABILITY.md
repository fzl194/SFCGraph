---
id: UDG@20.15.2@MMLCommand@ADD CPUCAPABILITY
type: MMLCommand
name: ADD CPUCAPABILITY（增加CPU能力基线）
nf: UDG
version: 20.15.2
verb: ADD
...
- [CPU能力基线（CPUCAPABILITY）](configobject/UDG/20.15.2/CPUCAPABILITY.md)
