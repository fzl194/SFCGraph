---
id: UDG@20.15.2@MMLCommand@RMV PODISOBLKLIST
type: MMLCommand
...
- [[configobject/UDG/20.15.2/PODISOBLKLIST]] · Pod隔离黑名单（PODISOBLKLIST）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-PODISOBLKLIST.md`
