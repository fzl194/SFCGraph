---
id: UDG@20.15.2@MMLCommand@DSP COMPONENT
type: MMLCommand
...
- [组件信息（COMPONENT）](configobject/UDG/20.15.2/COMPONENT.md)
...
- 原始手册：`evidence/UDG/20.15.2/显示组件信息（DSP-COMPONENT）_59103689.md`
