---
id: UDG@20.15.2@MMLCommand@SET SECPOLICYAPPLNK
type: MMLCommand
...
- [[configobject/UDG/20.15.2/SECPOLICYAPPLNK]] · 应用联动默认动作（SECPOLICYAPPLNK）
...
- 原始手册：`evidence/UDG/20.15.2/SET-SECPOLICYAPPLNK.md`
