---
id: UDG@20.15.2@MMLCommand@DSP NOSBASESOCKET
type: MMLCommand
...
- [[configobject/UDG/20.15.2/NOSBASESOCKET]] · NOS Base平面网络的Socket信息（NOSBASESOCKET）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-NOSBASESOCKET.md`
