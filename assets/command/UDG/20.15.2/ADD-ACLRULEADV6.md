---
id: UDG@20.15.2@MMLCommand@ADD ACLRULEADV6
type: MMLCommand
name: ADD ACLRULEADV6（增加高级IPv6 ACL规则）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD ACLRULEADV6（增加高级IPv6 ACL规则）
...
- [[UDG@20.15.2@ConfigObject@ACLRULEADV6]] · 高级IPv6 ACL规则（ACLRULEADV6）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-ACLRULEADV6.md`
