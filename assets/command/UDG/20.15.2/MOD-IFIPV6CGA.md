---
id: UDG@20.15.2@MMLCommand@MOD IFIPV6CGA
type: MMLCommand
name: MOD IFIPV6CGA（修改IPv6 CGA地址信息）
nf: UDG
version: 20.15.2
verb: MOD
...
```
MOD IFIPV6CGA:IFNAME="ethernet64/0/3",KEYPAIRLABEL="aa",SECLEVEL=low,MODIFIER="2001:db8::1";
```
