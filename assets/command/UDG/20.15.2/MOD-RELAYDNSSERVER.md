---
id: UDG@20.15.2@MMLCommand@MOD RELAYDNSSERVER
type: MMLCommand
name: MOD RELAYDNSSERVER（修改媒体中继的DNS属性）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD RELAYDNSSERVER（修改媒体中继的DNS属性）
...
- [[configobject/UDG/20.15.2/RELAYDNSSERVER]] · 媒体中继的DNS属性（RELAYDNSSERVER）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-RELAYDNSSERVER.md`
