---
id: UDG@20.15.2@MMLCommand@LST DRRESETLMTCOUNT
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@DRRESETLMTCOUNT]] · 复位限制的次数（DRRESETLMTCOUNT）
...
- 原始手册：`evidence/UDG/20.15.2/LST-DRRESETLMTCOUNT.md`
