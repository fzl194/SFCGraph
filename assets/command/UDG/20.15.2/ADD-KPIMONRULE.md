---
id: UDG@20.15.2@MMLCommand@ADD KPIMONRULE
type: MMLCommand
name: ADD KPIMONRULE（增加KPI异常检测规则）
nf: UDG
version: 20.15.2
verb: ADD
...
- [[UDG@20.15.2@ConfigObject@KPIMONRULE]] · KPI异常检测规则（KPIMONRULE）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-KPIMONRULE.md`
