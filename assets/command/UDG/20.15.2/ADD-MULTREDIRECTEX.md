---
id: UDG@20.15.2@MMLCommand@ADD MULTREDIRECTEX
type: MMLCommand
name: ADD MULTREDIRECTEX（增加扩展的多级重定向密码）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD MULTREDIRECTEX（增加扩展的多级重定向密码）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-MULTREDIRECTEX.md`
