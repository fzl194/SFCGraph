---
id: UDG@20.15.2@MMLCommand@LST CPUECOPOLICY
type: MMLCommand
...
- [全局的CPU调频和休眠策略（CPUECOPOLICY）](configobject/UDG/20.15.2/CPUECOPOLICY.md)

## 使用实例

查询网元ID为222的网元的CPU节能策略。
...
- 原始手册：`evidence/UDG/20.15.2/查询全局的CPU调频和休眠策略（LST-CPUECOPOLICY）_53585048.md`
