---
id: UDG@20.15.2@MMLCommand@RMV BGPVRFAF
type: MMLCommand
...
- [BGP VPN地址族（BGPVRFAF）](configobject/UDG/20.15.2/BGPVRFAF.md)
...
- 原始手册：`evidence/UDG/20.15.2/删除BGP-VPN地址族（RMV-BGPVRFAF）_49961802.md`
