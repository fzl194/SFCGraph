---
id: UDG@20.15.2@MMLCommand@ADD IPV6PREFIXFILTERNODE
type: MMLCommand
name: ADD IPV6PREFIXFILTERNODE（增加IPv6前缀过滤器节点）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD IPV6PREFIXFILTERNODE（增加IPv6前缀过滤器节点）
...
- [IPv6前缀过滤器节点（IPV6PREFIXFILTERNODE）](configobject/UDG/20.15.2/IPV6PREFIXFILTERNODE.md)
