---
id: UDG@20.15.2@MMLCommand@MOD EXTENDEDFILTER
type: MMLCommand
name: MOD EXTENDEDFILTER（修改扩展过滤器）
nf: UDG
version: 20.15.2
verb: MOD
...
- [[UDG@20.15.2@ConfigObject@EXTENDEDFILTER]] · 扩展过滤器（EXTENDEDFILTER）
