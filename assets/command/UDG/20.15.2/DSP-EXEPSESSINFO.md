---
id: UDG@20.15.2@MMLCommand@DSP EXEPSESSINFO
type: MMLCommand
name: DSP EXEPSESSINFO（显示异常用户）
nf: UDG
version: 20.15.2
verb: DSP
object_keyword: EXEPSESSINFO
...
- [[UDG@20.15.2@ConfigObject@EXEPSESSINFO]] · 异常用户（EXEPSESSINFO）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-EXEPSESSINFO.md`
