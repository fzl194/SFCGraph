---
id: UDG@20.15.2@MMLCommand@SET SFEPKTRCVMODE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@SFEPKTRCVMODE]] · SFE当前收包模式（SFEPKTRCVMODE）
...
- 原始手册：`evidence/UDG/20.15.2/SET-SFEPKTRCVMODE.md`
