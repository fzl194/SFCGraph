---
id: UDG@20.15.2@MMLCommand@SET DRAUTOACTIVE
type: MMLCommand
...
- [[configobject/UDG/20.15.2/DRAUTOACTIVE]] · 冷备容灾自动升主功能参数（DRAUTOACTIVE）
...
- 原始手册：`evidence/UDG/20.15.2/SET-DRAUTOACTIVE.md`
