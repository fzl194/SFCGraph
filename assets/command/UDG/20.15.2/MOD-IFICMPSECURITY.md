---
id: UDG@20.15.2@MMLCommand@MOD IFICMPSECURITY
type: MMLCommand
name: MOD IFICMPSECURITY（修改接口下ICMP安全配置）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD IFICMPSECURITY（修改接口下ICMP安全配置）
...
- [接口下ICMP安全配置（IFICMPSECURITY）](configobject/UDG/20.15.2/IFICMPSECURITY.md)
