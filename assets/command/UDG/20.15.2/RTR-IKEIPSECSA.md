---
id: UDG@20.15.2@MMLCommand@RTR IKEIPSECSA
type: MMLCommand
name: RTR IKEIPSECSA（恢复IPSEC安全联盟）
nf: UDG
version: 20.15.2
verb: RTR
...
- [IPSEC安全联盟（IKEIPSECSA）](configobject/UDG/20.15.2/IKEIPSECSA.md)
