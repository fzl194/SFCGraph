---
id: UDG@20.15.2@MMLCommand@LST NGVNVLANMAP
type: MMLCommand
name: LST NGVNVLANMAP（查询基于5G LAN组的VLAN映射信息）
nf: UDG
version: 20.15.2
verb: LST
...
# LST NGVNVLANMAP（查询基于5G LAN组的VLAN映射信息）

## 功能

**适用NF：UPF**

该命令用于查询基于5GLAN组的VLAN映射配置。
...
```
%%LST NGVNVLANMAP: VNINSTANCE="a0000001-460-003-01";
```
