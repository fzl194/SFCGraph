---
id: UDG@20.15.2@MMLCommand@MOD BGPPEERBFD
type: MMLCommand
name: MOD BGPPEERBFD（修改BGP对等体BFD检测）
nf: UDG
version: 20.15.2
verb: MOD
...
- [BGP对等体BFD检测（BGPPEERBFD）](configobject/UDG/20.15.2/BGPPEERBFD.md)
...
- 原始手册：`evidence/UDG/20.15.2/修改BGP对等体BFD检测（MOD-BGPPEERBFD）_00865705.md`
