---
id: UDG@20.15.2@MMLCommand@DSP PROCFILEHDLSTAT
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@PROCFILEHDLSTAT]] · 进程文件句柄使用信息（PROCFILEHDLSTAT）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-PROCFILEHDLSTAT.md`
