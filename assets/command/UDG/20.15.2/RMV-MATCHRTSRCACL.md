---
id: UDG@20.15.2@MMLCommand@RMV MATCHRTSRCACL
type: MMLCommand
name: RMV MATCHRTSRCACL（删除源路由基础ACL匹配路由策略）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV MATCHRTSRCACL（删除源路由基础ACL匹配路由策略）
...
取消路由策略a，节点10的匹配条件，匹配源路由ACL：

```
RMV MATCHRTSRCACL:NODESEQUENCE=10,POLICYNAME="a",ACLNAMEORNUM="abc";
```
