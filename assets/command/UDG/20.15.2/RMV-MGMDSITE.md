---
id: UDG@20.15.2@MMLCommand@RMV MGMDSITE
type: MMLCommand
name: RMV MGMDSITE（删除IGMP全局配置）
nf: UDG
version: 20.15.2
verb: RMV
...
- [IGMP全局配置（MGMDSITE）](configobject/UDG/20.15.2/MGMDSITE.md)
...
```
RMV MGMDSITE:VRFNAME="_public_",ADDRESSFAMILY=ipv4unicast,ROBUSTNESS=3;
```
