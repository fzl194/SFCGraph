---
id: UDG@20.15.2@MMLCommand@RMV MATCHASPATHFILTER
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@MATCHASPATHFILTER]] · 匹配AS路径过滤器（MATCHASPATHFILTER）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-MATCHASPATHFILTER.md`
