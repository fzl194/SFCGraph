---
id: UDG@20.15.2@MMLCommand@LST PAEBATCHRECVNUM
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@PAEBATCHRECVNUM]] · PAE批量接收报文数（PAEBATCHRECVNUM）
...
- 原始手册：`evidence/UDG/20.15.2/LST-PAEBATCHRECVNUM.md`
