---
id: UDG@20.15.2@MMLCommand@RMV GIREDIRECTPARA
type: MMLCommand
name: RMV GIREDIRECTPARA（删除单一Gi重定向信息）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV GIREDIRECTPARA（删除单一Gi重定向信息）
...
- [[UDG@20.15.2@ConfigObject@GIREDIRECTPARA]] · 单一Gi重定向信息（GIREDIRECTPARA）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-GIREDIRECTPARA.md`
