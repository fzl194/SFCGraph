---
id: UDG@20.15.2@MMLCommand@MOD HTTPFCMSG
type: MMLCommand
name: MOD HTTPFCMSG（修改HTTP流控消息类型）
nf: UDG
version: 20.15.2
verb: MOD
...
- [HTTP流控消息类型（HTTPFCMSG）](configobject/UDG/20.15.2/HTTPFCMSG.md)
...
- 原始手册：`evidence/UDG/20.15.2/修改HTTP流控消息类型（MOD-HTTPFCMSG）_01704018.md`
