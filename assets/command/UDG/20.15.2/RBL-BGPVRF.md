---
id: UDG@20.15.2@MMLCommand@RBL BGPVRF
type: MMLCommand
...
![](复位BGP VPN实例（RBL BGPVRF）_00840661.assets/notice_3.0-zh-cn.png)
...
- [[configobject/UDG/20.15.2/BGPVRF]] · BGP VPN实例（BGPVRF）
...
- 原始手册：`evidence/UDG/20.15.2/RBL-BGPVRF.md`
