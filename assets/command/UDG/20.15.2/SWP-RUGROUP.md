---
id: UDG@20.15.2@MMLCommand@SWP RUGROUP
type: MMLCommand
...
![](资源单元组主备倒换（SWP RUGROUP）_59104272.assets/notice_3.0-zh-cn.png)

本命令为高危命令，操作不当会引起资源单元组承载的业务受影响，请谨慎使用并联系华为技术支持协助操作。
...
- [资源单元组成员信息（RUGROUP）](configobject/UDG/20.15.2/RUGROUP.md)
