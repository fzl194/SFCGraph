---
id: UDG@20.15.2@MMLCommand@SET FWSOFTPARABITS
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@FWSOFTPARABITS]] · ServiceFabric软参比特位（FWSOFTPARABITS）
...
- 原始手册：`evidence/UDG/20.15.2/SET-FWSOFTPARABITS.md`
