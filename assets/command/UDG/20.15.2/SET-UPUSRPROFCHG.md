---
id: UDG@20.15.2@MMLCommand@SET UPUSRPROFCHG
type: MMLCommand
name: SET UPUSRPROFCHG（设置User Profile的计费配置）
nf: UDG
version: 20.15.2
verb: SET
...
# SET UPUSRPROFCHG（设置User Profile的计费配置）
...
- [User Profile的计费配置（UPUSRPROFCHG）](configobject/UDG/20.15.2/UPUSRPROFCHG.md)
