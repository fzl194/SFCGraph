---
id: UDG@20.15.2@MMLCommand@DSP DNSAGENTIPHOST
type: MMLCommand
...
- [[configobject/UDG/20.15.2/DNSAGENTIPHOST]] · DNS代理服务器域名（DNSAGENTIPHOST）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-DNSAGENTIPHOST.md`
