---
id: UDG@20.15.2@MMLCommand@DSP OSPFUPDATELSA
type: MMLCommand
...
- [[configobject/UDG/20.15.2/OSPFUPDATELSA]] · OSPF接收的LSA的更新信息（OSPFUPDATELSA）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-OSPFUPDATELSA.md`
