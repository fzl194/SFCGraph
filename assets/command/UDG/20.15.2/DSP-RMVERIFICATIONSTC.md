---
id: UDG@20.15.2@MMLCommand@DSP RMVERIFICATIONSTC
type: MMLCommand
...
- [路由管理对账统计信息（RMVERIFICATIONSTC）](configobject/UDG/20.15.2/RMVERIFICATIONSTC.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询路由管理对账统计信息（DSP-RMVERIFICATIONSTC）_00600577.md`
