---
id: UDG@20.15.2@MMLCommand@ADD ASPATHFILTERNODE
type: MMLCommand
...
- [[configobject/UDG/20.15.2/ASPATHFILTERNODE]] · AS路径过滤节点（ASPATHFILTERNODE）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-ASPATHFILTERNODE.md`
