---
id: UDG@20.15.2@MMLCommand@LST PLCYCKTIMERINR
type: MMLCommand
...
- [[configobject/UDG/20.15.2/PLCYCKTIMERINR]] · 策略类型和核查间隔（PLCYCKTIMERINR）
...
- 原始手册：`evidence/UDG/20.15.2/LST-PLCYCKTIMERINR.md`
