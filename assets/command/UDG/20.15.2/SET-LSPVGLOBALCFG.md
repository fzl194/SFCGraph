---
id: UDG@20.15.2@MMLCommand@SET LSPVGLOBALCFG
type: MMLCommand
...
- [[configobject/UDG/20.15.2/LSPVGLOBALCFG]] · LSPV全局属性（LSPVGLOBALCFG）
...
- 原始手册：`evidence/UDG/20.15.2/SET-LSPVGLOBALCFG.md`
