---
id: UDG@20.15.2@MMLCommand@ADD AFDNSSERVER
type: MMLCommand
name: ADD AFDNSSERVER（增加防欺诈可信DNS服务器）
nf: UDG
version: 20.15.2
verb: ADD
...
- [[UDG@20.15.2@ConfigObject@AFDNSSERVER]] · 防欺诈可信DNS服务器（AFDNSSERVER）
