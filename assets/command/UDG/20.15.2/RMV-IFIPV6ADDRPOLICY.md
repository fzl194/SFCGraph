---
id: UDG@20.15.2@MMLCommand@RMV IFIPV6ADDRPOLICY
type: MMLCommand
name: RMV IFIPV6ADDRPOLICY（删除IPv6地址策略）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV IFIPV6ADDRPOLICY（删除IPv6地址策略）
...
- [IPv6地址策略（IFIPV6ADDRPOLICY）](configobject/UDG/20.15.2/IFIPV6ADDRPOLICY.md)
...
```
RMV IFIPV6ADDRPOLICY:VPNNAME="vrf1",IPV6ADDRPREFIX="2001:db8::2",PRIFIXLEN=64;
```
