---
id: UDG@20.15.2@MMLCommand@ADD AUTOSCALINGSRBFD
type: MMLCommand
...
- [[configobject/UDG/20.15.2/AUTOSCALINGSRBFD]] · 静态路由的动态BFD自动化配置模板（AUTOSCALINGSRBFD）

## 关联任务

- [[UDG@20.15.2@Task@0-00144]]
...
- 原始手册：`evidence/UDG/20.15.2/ADD-AUTOSCALINGSRBFD.md`
