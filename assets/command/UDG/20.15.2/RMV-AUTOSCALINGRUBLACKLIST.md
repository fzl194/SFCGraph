---
id: UDG@20.15.2@MMLCommand@RMV AUTOSCALINGRUBLACKLIST
type: MMLCommand
...
- [自动部署RU黑名单（AUTOSCALINGRUBLACKLIST）](configobject/UDG/20.15.2/AUTOSCALINGRUBLACKLIST.md)
...
- 原始手册：`evidence/UDG/20.15.2/删除自动部署RU黑名单（RMV-AUTOSCALINGRUBLACKLIST）_00441325.md`
