---
id: UDG@20.15.2@MMLCommand@STR VERIFICATION
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@VERIFICATION]] · 一次FEI与FES之间的对账操作（VERIFICATION）
...
- 原始手册：`evidence/UDG/20.15.2/STR-VERIFICATION.md`
