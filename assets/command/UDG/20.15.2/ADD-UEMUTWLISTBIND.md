---
id: UDG@20.15.2@MMLCommand@ADD UEMUTWLISTBIND
type: MMLCommand
name: ADD UEMUTWLISTBIND（增加APN绑定PA口UE互访白名单）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD UEMUTWLISTBIND（增加APN绑定PA口UE互访白名单）
...
- [[UDG@20.15.2@ConfigObject@UEMUTWLISTBIND]] · APN绑定PA口UE互访白名单（UEMUTWLISTBIND）
