---
id: UDG@20.15.2@MMLCommand@MOD SADEDICBEARER
type: MMLCommand
name: MOD SADEDICBEARER（修改业务感知专有承载配置）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD SADEDICBEARER（修改业务感知专有承载配置）
...
- [[UDG@20.15.2@ConfigObject@SADEDICBEARER]] · 业务感知专有承载配置（SADEDICBEARER）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-SADEDICBEARER.md`
