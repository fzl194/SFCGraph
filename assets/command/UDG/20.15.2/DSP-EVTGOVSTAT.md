---
id: UDG@20.15.2@MMLCommand@DSP EVTGOVSTAT
type: MMLCommand
...
- [事件诊断失败状态（EVTGOVSTAT）](configobject/UDG/20.15.2/EVTGOVSTAT.md)
...
- 原始手册：`evidence/UDG/20.15.2/显示事件诊断失败状态（DSP-EVTGOVSTAT）_94913407.md`
