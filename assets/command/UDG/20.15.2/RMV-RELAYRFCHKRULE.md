---
id: UDG@20.15.2@MMLCommand@RMV RELAYRFCHKRULE
type: MMLCommand
name: RMV RELAYRFCHKRULE（删除媒体中继引用检查规则）
nf: UDG
version: 20.15.2
verb: RMV
...
# RMV RELAYRFCHKRULE（删除媒体中继引用检查规则）
...
假如需要删除一组媒体中继引用检查规则，则命令如下：

```
RMV RELAYRFCHKRULE: RELAYRFCHKNAME="test";
```
