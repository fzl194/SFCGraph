---
id: UDG@20.15.2@MMLCommand@LST IPSECINTFCFGIPSEC
type: MMLCommand
...
- [[configobject/UDG/20.15.2/IPSECINTFCFGIPSEC]] · IPsec隧道接口（IPSECINTFCFGIPSEC）
...
- 原始手册：`evidence/UDG/20.15.2/LST-IPSECINTFCFGIPSEC.md`
