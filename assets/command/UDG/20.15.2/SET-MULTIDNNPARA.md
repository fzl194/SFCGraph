---
id: UDG@20.15.2@MMLCommand@SET MULTIDNNPARA
type: MMLCommand
name: SET MULTIDNNPARA（设置MultiDNN参数）
nf: UDG
version: 20.15.2
verb: SET
...
- [[UDG@20.15.2@ConfigObject@MULTIDNNPARA]] · MultiDNN参数（MULTIDNNPARA）
...
- 原始手册：`evidence/UDG/20.15.2/SET-MULTIDNNPARA.md`
