---
id: UDG@20.15.2@MMLCommand@ACT TRANSCOMTASK
type: MMLCommand
...
- [[configobject/UDG/20.15.2/TRANSCOMTASK]] · SDR进程间透明通信检测任务（TRANSCOMTASK）
...
- 原始手册：`evidence/UDG/20.15.2/ACT-TRANSCOMTASK.md`
