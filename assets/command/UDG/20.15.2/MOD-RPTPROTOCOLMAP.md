---
id: UDG@20.15.2@MMLCommand@MOD RPTPROTOCOLMAP
type: MMLCommand
name: MOD RPTPROTOCOLMAP（修改业务报表映射承载协议分类配置）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD RPTPROTOCOLMAP（修改业务报表映射承载协议分类配置）
...
- 原始手册：`evidence/UDG/20.15.2/修改业务报表映射承载协议分类配置（MOD-RPTPROTOCOLMAP）_28361125.md`
