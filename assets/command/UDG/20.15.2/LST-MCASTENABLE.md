---
id: UDG@20.15.2@MMLCommand@LST MCASTENABLE
type: MMLCommand
name: LST MCASTENABLE（查询组播使能开关配置）
nf: UDG
version: 20.15.2
verb: LST
...
- [[UDG@20.15.2@ConfigObject@MCASTENABLE]] · 组播使能配置（MCASTENABLE）
...
```
LST MCASTENABLE:VRFNAME="_public_",ADDRESSFAMILY=ipv4unicast;
```
...
- 原始手册：`evidence/UDG/20.15.2/LST-MCASTENABLE.md`
