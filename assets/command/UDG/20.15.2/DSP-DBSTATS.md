---
id: UDG@20.15.2@MMLCommand@DSP DBSTATS
type: MMLCommand
name: DSP DBSTATS（查询CSDB的统计信息）
nf: UDG
version: 20.15.2
verb: DSP
object_keyword: DBSTATS
...
- [CSDB的统计信息（DBSTATS）](configobject/UDG/20.15.2/DBSTATS.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询CSDB的统计信息（DSP-DBSTATS）_29626998.md`
