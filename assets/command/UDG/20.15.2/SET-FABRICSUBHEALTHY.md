---
id: UDG@20.15.2@MMLCommand@SET FABRICSUBHEALTHY
type: MMLCommand
name: SET FABRICSUBHEALTHY（设置Fabric亚健康全局配置）
nf: UDG
version: 20.15.2
verb: SET
...
# SET FABRICSUBHEALTHY（设置Fabric亚健康全局配置）
...
- [FABRIC内联口亚健康信息（FABRICSUBHEALTHY）](configobject/UDG/20.15.2/FABRICSUBHEALTHY.md)
