---
id: UDG@20.15.2@MMLCommand@RMV APPLYNEXTHOP
type: MMLCommand
name: RMV APPLYNEXTHOP（删除下一跳设置）
nf: UDG
version: 20.15.2
verb: RMV
...
```
RMV APPLYNEXTHOP:NODESEQUENCE=10,POLICYNAME="a";
```

## 证据

- 原始手册：`evidence/UDG/20.15.2/RMV-APPLYNEXTHOP.md`
