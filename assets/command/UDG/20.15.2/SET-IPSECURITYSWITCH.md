---
id: UDG@20.15.2@MMLCommand@SET IPSECURITYSWITCH
type: MMLCommand
...
- [[configobject/UDG/20.15.2/IPSECURITYSWITCH]] · IP选项安全开关（IPSECURITYSWITCH）
...
- 原始手册：`evidence/UDG/20.15.2/SET-IPSECURITYSWITCH.md`
