---
id: UDG@20.15.2@MMLCommand@MOD NDNEIGHBOR
type: MMLCommand
name: MOD NDNEIGHBOR（修改静态ND邻居表项）
nf: UDG
version: 20.15.2
verb: MOD
...
- [静态ND邻居表项（NDNEIGHBOR）](configobject/UDG/20.15.2/NDNEIGHBOR.md)
...
```
MOD NDNEIGHBOR:IFNAME="Ethernet65/0/8",IPV6ADDRESS="2001:db8::11",MACADDRESS="00e0-fc01-0001";
```
