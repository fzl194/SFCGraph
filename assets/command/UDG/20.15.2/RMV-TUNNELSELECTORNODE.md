---
id: UDG@20.15.2@MMLCommand@RMV TUNNELSELECTORNODE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@TUNNELSELECTORNODE]] · 隧道选择器节点（TUNNELSELECTORNODE）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-TUNNELSELECTORNODE.md`
