---
id: UDG@20.15.2@MMLCommand@DSP PIMCTLMSGCNTIF
type: MMLCommand
name: DSP PIMCTLMSGCNTIF（查询PIM接口报文统计计数）
nf: UDG
version: 20.15.2
verb: DSP
object_keyword: PIMCTLMSGCNTIF
...
# DSP PIMCTLMSGCNTIF（查询PIM接口报文统计计数）
...
- [PIM接口报文统计计数（PIMCTLMSGCNTIF）](configobject/UDG/20.15.2/PIMCTLMSGCNTIF.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询PIM接口报文统计计数（DSP-PIMCTLMSGCNTIF）_49961470.md`
