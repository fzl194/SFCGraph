---
id: UDG@20.15.2@MMLCommand@SET DBSTARTPARAS
type: MMLCommand
name: SET DBSTARTPARAS（设置DB启动参数值）
nf: UDG
version: 20.15.2
verb: SET
...
- [[UDG@20.15.2@ConfigObject@DBSTARTPARAS]] · DB启动参数值（DBSTARTPARAS）
...
- 原始手册：`evidence/UDG/20.15.2/SET-DBSTARTPARAS.md`
