---
id: UDG@20.15.2@MMLCommand@DSP MSSADAPTDETAILPHYSICAL
type: MMLCommand
...
- [[configobject/UDG/20.15.2/MSSADAPTDETAILPHYSICAL]] · 适配层物理表详细信息（MSSADAPTDETAILPHYSICAL）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-MSSADAPTDETAILPHYSICAL.md`
