---
id: UDG@20.15.2@MMLCommand@ADD L3VPNINSTIPSEC
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@L3VPNINSTIPSEC]] · L3VPN实例（L3VPNINSTIPSEC）

## 关联任务

- [[UDG@20.15.2@Task@0-00210]]
...
- 原始手册：`evidence/UDG/20.15.2/ADD-L3VPNINSTIPSEC.md`
