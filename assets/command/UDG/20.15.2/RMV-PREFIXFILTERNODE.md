---
id: UDG@20.15.2@MMLCommand@RMV PREFIXFILTERNODE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@PREFIXFILTERNODE]] · IPv4地址前缀列表过滤器节点（PREFIXFILTERNODE）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-PREFIXFILTERNODE.md`
