---
id: UDG@20.15.2@MMLCommand@MOD HTTPFIXEDFCINF
type: MMLCommand
...
- [[configobject/UDG/20.15.2/HTTPFIXEDFCINF]] · HTTP接口类型固定速率流控信息（HTTPFIXEDFCINF）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-HTTPFIXEDFCINF.md`
