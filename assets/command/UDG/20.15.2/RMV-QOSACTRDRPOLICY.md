---
id: UDG@20.15.2@MMLCommand@RMV QOSACTRDRPOLICY
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@QOSACTRDRPOLICY]] · 流行为下级联流策略（QOSACTRDRPOLICY）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-QOSACTRDRPOLICY.md`
