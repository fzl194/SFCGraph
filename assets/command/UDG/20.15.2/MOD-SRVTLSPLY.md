---
id: UDG@20.15.2@MMLCommand@MOD SRVTLSPLY
type: MMLCommand
name: MOD SRVTLSPLY（修改TLS认证策略）
nf: UDG
version: 20.15.2
verb: MOD
...
- [[UDG@20.15.2@ConfigObject@SRVTLSPLY]] · TLS认证策略（SRVTLSPLY）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-SRVTLSPLY.md`
