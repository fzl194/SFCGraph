---
id: UDG@20.15.2@MMLCommand@DSP TRCSMSGTOTALSTC
type: MMLCommand
...
- [[configobject/UDG/20.15.2/TRCSMSGTOTALSTC]] · 跟踪中心消息统计信息（TRCSMSGTOTALSTC）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-TRCSMSGTOTALSTC.md`
