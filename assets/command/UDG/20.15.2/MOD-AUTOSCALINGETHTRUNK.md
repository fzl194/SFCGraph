---
id: UDG@20.15.2@MMLCommand@MOD AUTOSCALINGETHTRUNK
type: MMLCommand
name: MOD AUTOSCALINGETHTRUNK（修改以太网隧道自动化多虚拟网卡配置模板）
nf: UDG
version: 20.15.2
verb: MOD
...
# MOD AUTOSCALINGETHTRUNK（修改以太网隧道自动化多虚拟网卡配置模板）

## 功能

该命令用于修改以太网隧道多虚拟网卡自动化配置模板。
...
- [以太网隧道自动化多虚拟网卡配置模板（AUTOSCALINGETHTRUNK）](configobject/UDG/20.15.2/AUTOSCALINGETHTRUNK.md)
...
```
MOD AUTOSCALINGETHTRUNK: ETHTRUNKTMPID=1,VNICLIST="3 4 5";
```
