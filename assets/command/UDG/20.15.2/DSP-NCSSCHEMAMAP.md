---
id: UDG@20.15.2@MMLCommand@DSP NCSSCHEMAMAP
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@NCSSCHEMAMAP]] · 应用模型间模型映射关联关系（NCSSCHEMAMAP）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-NCSSCHEMAMAP.md`
