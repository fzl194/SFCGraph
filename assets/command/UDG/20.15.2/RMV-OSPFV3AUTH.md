---
id: UDG@20.15.2@MMLCommand@RMV OSPFV3AUTH
type: MMLCommand
...
![](删除OSPFv3认证配置（RMV OSPFV3AUTH）_00841553.assets/notice_3.0-zh-cn.png)
...
- [[UDG@20.15.2@ConfigObject@OSPFV3AUTH]] · OSPFv3认证配置（OSPFV3AUTH）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-OSPFV3AUTH.md`
