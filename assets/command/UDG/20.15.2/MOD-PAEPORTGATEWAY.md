---
id: UDG@20.15.2@MMLCommand@MOD PAEPORTGATEWAY
type: MMLCommand
...
![](修改网关转发地址（MOD PAEPORTGATEWAY）_98683661.assets/notice_3.0-zh-cn.png)
...
- [[UDG@20.15.2@ConfigObject@PAEPORTGATEWAY]] · PAE端口网关信息（PAEPORTGATEWAY）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-PAEPORTGATEWAY.md`
