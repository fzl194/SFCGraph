---
id: UDG@20.15.2@MMLCommand@RMV FWRULE
type: MMLCommand
...
![](删除转发规则（RMV FWRULE）_01844648.assets/notice_3.0-zh-cn.png)
...
- [[UDG@20.15.2@ConfigObject@FWRULE]] · 转发规则（FWRULE）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-FWRULE.md`
