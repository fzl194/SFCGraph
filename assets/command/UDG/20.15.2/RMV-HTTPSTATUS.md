---
id: UDG@20.15.2@MMLCommand@RMV HTTPSTATUS
type: MMLCommand
...
![](删除HTTP状态码判定配置（RMV HTTPSTATUS）_04250405.assets/notice_3.0-zh-cn.png)
...
- [[UDG@20.15.2@ConfigObject@HTTPSTATUS]] · HTTP状态码判定配置（HTTPSTATUS）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-HTTPSTATUS.md`
