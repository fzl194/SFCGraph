---
id: UDG@20.15.2@MMLCommand@SET CPACCESSLISTFUNC
type: MMLCommand
name: SET CPACCESSLISTFUNC（配置CP白名单开关）
nf: UDG
version: 20.15.2
verb: SET
...
# SET CPACCESSLISTFUNC（配置CP白名单开关）
...
- [[UDG@20.15.2@ConfigObject@CPACCESSLISTFUNC]] · CP白名单开关（CPACCESSLISTFUNC）
...
- 原始手册：`evidence/UDG/20.15.2/SET-CPACCESSLISTFUNC.md`
