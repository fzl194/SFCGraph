---
id: UDG@20.15.2@MMLCommand@DSP RESNOSBASESOCKET
type: MMLCommand
name: DSP RESNOSBASESOCKET（查询NOS Base平面网络的Socket信息）
nf: UDG
version: 20.15.2
verb: DSP
object_keyword: RESNOSBASESOCKET
...
# DSP RESNOSBASESOCKET（查询NOS Base平面网络的Socket信息）
...
- [NOS Base平面网络的Socket信息（RESNOSBASESOCKET）](configobject/UDG/20.15.2/RESNOSBASESOCKET.md)
...
- 原始手册：`evidence/UDG/20.15.2/查询NOS-Base平面网络的Socket信息（DSP-RESNOSBASESOCKET）_57592517.md`
