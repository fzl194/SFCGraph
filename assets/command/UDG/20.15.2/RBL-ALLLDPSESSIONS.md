---
id: UDG@20.15.2@MMLCommand@RBL ALLLDPSESSIONS
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@ALLLDPSESSIONS]] · 重启所有LDP会话（ALLLDPSESSIONS）
...
- 原始手册：`evidence/UDG/20.15.2/RBL-ALLLDPSESSIONS.md`
