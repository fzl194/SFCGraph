---
id: UDG@20.15.2@MMLCommand@SET NODEHEALCTRL
type: MMLCommand
...
- [[configobject/UDG/20.15.2/NODEHEALCTRL]] · Node自愈策略控制参数（NODEHEALCTRL）
...
- 原始手册：`evidence/UDG/20.15.2/SET-NODEHEALCTRL.md`
