---
id: UDG@20.15.2@MMLCommand@MOD HTTPHTRMS
type: MMLCommand
name: MOD HTTPHTRMS（修改HTR流控安全边界配置）
nf: UDG
version: 20.15.2
verb: MOD
...
- [[configobject/UDG/20.15.2/HTTPHTRMS]] · HTR流控安全边界配置（HTTPHTRMS）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-HTTPHTRMS.md`
