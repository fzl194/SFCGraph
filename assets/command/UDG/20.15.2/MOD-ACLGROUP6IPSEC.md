---
id: UDG@20.15.2@MMLCommand@MOD ACLGROUP6IPSEC
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@ACLGROUP6IPSEC]] · IPv6 ACL规则组（ACLGROUP6IPSEC）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-ACLGROUP6IPSEC.md`
