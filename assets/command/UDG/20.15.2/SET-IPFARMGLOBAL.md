---
id: UDG@20.15.2@MMLCommand@SET IPFARMGLOBAL
type: MMLCommand
name: SET IPFARMGLOBAL（设置IPFarm全局参数）
nf: UDG
version: 20.15.2
verb: SET
...
- [[UDG@20.15.2@ConfigObject@IPFARMGLOBAL]] · IPFarm全局参数（IPFARMGLOBAL）
...
- 原始手册：`evidence/UDG/20.15.2/SET-IPFARMGLOBAL.md`
