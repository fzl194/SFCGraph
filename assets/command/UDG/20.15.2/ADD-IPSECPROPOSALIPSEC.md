---
id: UDG@20.15.2@MMLCommand@ADD IPSECPROPOSALIPSEC
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@IPSECPROPOSALIPSEC]] · IPsec提议（IPSECPROPOSALIPSEC）

## 关联任务

- [[UDG@20.15.2@Task@0-00212]]
...
- 原始手册：`evidence/UDG/20.15.2/ADD-IPSECPROPOSALIPSEC.md`
