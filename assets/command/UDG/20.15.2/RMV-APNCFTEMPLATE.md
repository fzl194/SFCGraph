---
id: UDG@20.15.2@MMLCommand@RMV APNCFTEMPLATE
type: MMLCommand
name: RMV APNCFTEMPLATE（删除APN内容过滤模板）
nf: UDG
version: 20.15.2
verb: RMV
...
- [APN内容过滤模板（APNCFTEMPLATE）](configobject/UDG/20.15.2/APNCFTEMPLATE.md)
...
```
RMV APNCFTEMPLATE: APNNAME="huawei.com", CFTEMPLATENAME="testcftemplate";
```
