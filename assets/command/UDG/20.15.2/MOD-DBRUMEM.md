---
id: UDG@20.15.2@MMLCommand@MOD DBRUMEM
type: MMLCommand
...
![](修改CSDB RU内存信息(MOD DBRUMEM)_04873821.assets/notice_3.0-zh-cn.png)
...
- [CSDB RU内存信息（DBRUMEM）](configobject/UDG/20.15.2/DBRUMEM.md)
