---
id: UDG@20.15.2@MMLCommand@DSP NCSFAILOPER
type: MMLCommand
...
- [操作失败信息（NCSFAILOPER）](configobject/UDG/20.15.2/NCSFAILOPER.md)
...
- 原始手册：`evidence/UDG/20.15.2/显示操作失败信息（DSP-NCSFAILOPER）_59104227.md`
