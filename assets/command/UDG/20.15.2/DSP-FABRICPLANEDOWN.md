---
id: UDG@20.15.2@MMLCommand@DSP FABRICPLANEDOWN
type: MMLCommand
name: DSP FABRICPLANEDOWN（显示Fabric平面Down信息）
nf: UDG
version: 20.15.2
verb: DSP
object_keyword: FABRICPLANEDOWN
...
# DSP FABRICPLANEDOWN（显示Fabric平面Down信息）
...
- [Fabric平面Down信息（FABRICPLANEDOWN）](configobject/UDG/20.15.2/FABRICPLANEDOWN.md)
...
- 原始手册：`evidence/UDG/20.15.2/显示Fabric平面Down信息（DSP-FABRICPLANEDOWN）_22009680.md`
