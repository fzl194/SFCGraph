---
id: UDG@20.15.2@MMLCommand@ADD OSPFV3ABRSUMMARY
type: MMLCommand
name: ADD OSPFV3ABRSUMMARY（创建OSPFv3区域内路由聚合配置）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD OSPFV3ABRSUMMARY（创建OSPFv3区域内路由聚合配置）
...
- [OSPFv3区域内路由聚合配置（OSPFV3ABRSUMMARY）](configobject/UDG/20.15.2/OSPFV3ABRSUMMARY.md)
...
- 原始手册：`evidence/UDG/20.15.2/创建OSPFv3区域内路由聚合配置（ADD-OSPFV3ABRSUMMARY）_00841781.md`
