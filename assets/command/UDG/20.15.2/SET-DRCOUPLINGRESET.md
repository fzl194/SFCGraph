---
id: UDG@20.15.2@MMLCommand@SET DRCOUPLINGRESET
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@DRCOUPLINGRESET]] · 负荷分担容灾功能开启信息（DRCOUPLINGRESET）
...
- 原始手册：`evidence/UDG/20.15.2/SET-DRCOUPLINGRESET.md`
