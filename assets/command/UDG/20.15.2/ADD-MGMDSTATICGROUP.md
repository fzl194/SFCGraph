---
id: UDG@20.15.2@MMLCommand@ADD MGMDSTATICGROUP
type: MMLCommand
name: ADD MGMDSTATICGROUP（添加IGMP静态组配置）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD MGMDSTATICGROUP（添加IGMP静态组配置）
...
创建源为10.0.10.1，组地址为239.0.0.1的IGMP静态组：

```
ADD MGMDSTATICGROUP: VRFNAME="_public_", ADDRESSFAMILY=ipv4unicast, IFNAME="Ethernet64/0/5", STATICGRP="239.0.0.1", ISSOURCEADDR=TRUE, SRCADDR="10.0.10.1", ISSTEPGRPVALUE=FALSE;
```
