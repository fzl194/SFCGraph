---
id: UDG@20.15.2@MMLCommand@MOD MATCHDESTPREFIXFILTER
type: MMLCommand
...
- [[configobject/UDG/20.15.2/MATCHDESTPREFIXFILTER]] · 匹配IPv4地址前缀列表（MATCHDESTPREFIXFILTER）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-MATCHDESTPREFIXFILTER.md`
