---
id: UDG@20.15.2@MMLCommand@SET VONRMOSFACTOR
type: MMLCommand
name: SET VONRMOSFACTOR（设置MOS计算值的补偿因子）
nf: UDG
version: 20.15.2
verb: SET
...
# SET VONRMOSFACTOR（设置MOS计算值的补偿因子）
...
| 初始值 | MOS_CODEC_EVS_NB | 0 | 0 | 0 | 0 | 0 |
| 初始值 | MOS_CODEC_EVS_WB | 0 | 0 | 0 | 0 | 0 |
| 初始值 | MOS_CODEC_EVS_SWB | 0 | 0 | 0 | 0 | 0 |
| 初始值 | MOS_CODEC_EVS_FB | 0 | 0 | 0 | 0 | 0 |
| 初始值 | MOS_CODEC_EVS_AMR | 0 | 0 | 0 | 0 | 0 |
...
- [[configobject/UDG/20.15.2/VONRMOSFACTOR]] · MOS补偿因子（VONRMOSFACTOR）

## 使用实例

- 设置AMR WB编解码语音的MOS计算值的补偿因子：
  ```
  SET VONRMOSFACTOR: MOSCODEC=MOS_CODEC_AMR_WB, FACTOR1TO2="1", FACTOR2TO3="-1";
  ```
- 设置所有编解码语音的MOS计算值的补偿因子：
  ```
  SET VONRMOSFACTOR: MOSCODEC=MOS_CODEC_ALL, FACTOR1TO2="1", FACTOR2TO3="-1";
  ```
