---
id: UDG@20.15.2@MMLCommand@RMV APPLYROUTETYPE
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@APPLYROUTETYPE]] · 路由类型设置（APPLYROUTETYPE）
...
- 原始手册：`evidence/UDG/20.15.2/RMV-APPLYROUTETYPE.md`
