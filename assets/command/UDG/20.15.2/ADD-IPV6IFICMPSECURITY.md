---
id: UDG@20.15.2@MMLCommand@ADD IPV6IFICMPSECURITY
type: MMLCommand
name: ADD IPV6IFICMPSECURITY（添加接口下安全配置）
nf: UDG
version: 20.15.2
verb: ADD
...
# ADD IPV6IFICMPSECURITY（添加接口下安全配置）
...
- [接口下安全配置（IPV6IFICMPSECURITY）](configobject/UDG/20.15.2/IPV6IFICMPSECURITY.md)
