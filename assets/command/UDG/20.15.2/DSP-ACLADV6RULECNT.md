---
id: UDG@20.15.2@MMLCommand@DSP ACLADV6RULECNT
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@ACLADV6RULECNT]] · 高级IPv6 ACL规则匹配计数（ACLADV6RULECNT）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-ACLADV6RULECNT.md`
