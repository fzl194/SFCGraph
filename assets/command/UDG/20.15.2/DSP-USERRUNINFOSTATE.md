---
id: UDG@20.15.2@MMLCommand@DSP USERRUNINFOSTATE
type: MMLCommand
name: DSP USERRUNINFOSTATE（查询指定用户的运行信息）
nf: UDG
version: 20.15.2
verb: DSP
...
# DSP USERRUNINFOSTATE（查询指定用户的运行信息）
...
- [[UDG@20.15.2@ConfigObject@USERRUNINFOSTATE]] · 指定用户的运行信息（USERRUNINFOSTATE）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-USERRUNINFOSTATE.md`
