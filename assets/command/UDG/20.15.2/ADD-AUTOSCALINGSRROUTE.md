---
id: UDG@20.15.2@MMLCommand@ADD AUTOSCALINGSRROUTE
type: MMLCommand
...
- [静态路由自动化配置模板（AUTOSCALINGSRROUTE）](configobject/UDG/20.15.2/AUTOSCALINGSRROUTE.md)

## 关联任务

- [0-00142](task/UDG/20.15.2/0-00142.md)
