---
id: UDG@20.15.2@MMLCommand@MOD OSPFV3FILTERPOLICY
type: MMLCommand
...
- [[configobject/UDG/20.15.2/OSPFV3FILTERPOLICY]] · OSPFv3过滤策略配置（OSPFV3FILTERPOLICY）
...
- 原始手册：`evidence/UDG/20.15.2/MOD-OSPFV3FILTERPOLICY.md`
