---
id: UDG@20.15.2@MMLCommand@DSP AUTOSCALINGIPPOOL
type: MMLCommand
...
- [[UDG@20.15.2@ConfigObject@AUTOSCALINGIPPOOL]] · 自动化配置地址池信息（AUTOSCALINGIPPOOL）
...
- 原始手册：`evidence/UDG/20.15.2/DSP-AUTOSCALINGIPPOOL.md`
