---
id: UDG@20.15.2@MMLCommand@MOD IFIPV4UNNUM
type: MMLCommand
name: MOD IFIPV4UNNUM（修改接口IPv4借用地址）
nf: UDG
version: 20.15.2
verb: MOD
...
- [接口IPv4借用地址（IFIPV4UNNUM）](configobject/UDG/20.15.2/IFIPV4UNNUM.md)
...
```
MOD IFIPV4UNNUM:IFNAME="tunnel1",UNNUMIFNAME="loopback1";
```
