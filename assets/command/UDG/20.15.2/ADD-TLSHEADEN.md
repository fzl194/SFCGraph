---
id: UDG@20.15.2@MMLCommand@ADD TLSHEADEN
type: MMLCommand
name: ADD TLSHEADEN（增加HTTPS头增强）
nf: UDG
version: 20.15.2
verb: ADD
...
- [[UDG@20.15.2@ConfigObject@TLSHEADEN]] · HTTPS头增强（TLSHEADEN）
...
- 原始手册：`evidence/UDG/20.15.2/ADD-TLSHEADEN.md`
