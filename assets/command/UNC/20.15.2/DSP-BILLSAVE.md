---
id: UNC@20.15.2@MMLCommand@DSP BILLSAVE
type: MMLCommand
name: DSP BILLSAVE（显示最终话单处理和保存速度）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: BILLSAVE
...
- [[configobject/UNC/20.15.2/BILLSAVE]] · 最终话单处理和保存速度（BILLSAVE）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-BILLSAVE.md`
