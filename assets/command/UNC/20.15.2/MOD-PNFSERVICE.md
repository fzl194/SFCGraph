---
id: UNC@20.15.2@MMLCommand@MOD PNFSERVICE
type: MMLCommand
name: MOD PNFSERVICE（修改对端NF服务实例信息）
nf: UNC
version: 20.15.2
verb: MOD
...
- [对端NF服务实例信息（PNFSERVICE）](configobject/UNC/20.15.2/PNFSERVICE.md)
