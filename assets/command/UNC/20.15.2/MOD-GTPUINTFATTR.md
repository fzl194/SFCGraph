---
id: UNC@20.15.2@MMLCommand@MOD GTPUINTFATTR
type: MMLCommand
name: MOD GTPUINTFATTR（修改GTP-U IP地址接口属性）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD GTPUINTFATTR（修改GTP-U IP地址接口属性）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-GTPUINTFATTR.md`
