---
id: UNC@20.15.2@MMLCommand@ADD APNEDRXATTR
type: MMLCommand
name: ADD APNEDRXATTR（增加APN的终端接入eDRX模式属性）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNEDRXATTR（增加APN的终端接入eDRX模式属性）
...
- 原始手册：`evidence/UNC/20.15.2/增加APN的终端接入eDRX模式属性（ADD-APNEDRXATTR）_32381428.md`
