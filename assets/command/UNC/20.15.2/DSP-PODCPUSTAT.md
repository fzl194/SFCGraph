---
id: UNC@20.15.2@MMLCommand@DSP PODCPUSTAT
type: MMLCommand
name: DSP PODCPUSTAT（查询pod CPU信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: PODCPUSTAT
...
- [pod CPU信息（PODCPUSTAT）](configobject/UNC/20.15.2/PODCPUSTAT.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询pod-CPU信息（DSP-PODCPUSTAT）_94730422.md`
