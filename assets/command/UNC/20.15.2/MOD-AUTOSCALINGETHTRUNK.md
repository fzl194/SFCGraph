---
id: UNC@20.15.2@MMLCommand@MOD AUTOSCALINGETHTRUNK
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@AUTOSCALINGETHTRUNK]] · 以太网隧道自动化多虚拟网卡配置模板（AUTOSCALINGETHTRUNK）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-AUTOSCALINGETHTRUNK.md`
