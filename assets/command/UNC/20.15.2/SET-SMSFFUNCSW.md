---
id: UNC@20.15.2@MMLCommand@SET SMSFFUNCSW
type: MMLCommand
name: SET SMSFFUNCSW（设置SMSF功能开关）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@SMSFFUNCSW]] · SMSF功能开关（SMSFFUNCSW）
...
- 原始手册：`evidence/UNC/20.15.2/SET-SMSFFUNCSW.md`
