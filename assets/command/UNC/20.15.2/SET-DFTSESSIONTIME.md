---
id: UNC@20.15.2@MMLCommand@SET DFTSESSIONTIME
type: MMLCommand
name: SET DFTSESSIONTIME（设置默认会话上下文定时器）
nf: UNC
version: 20.15.2
verb: SET
...
# SET DFTSESSIONTIME（设置默认会话上下文定时器）
...
- [[UNC@20.15.2@ConfigObject@DFTSESSIONTIME]] · 默认会话上下文定时器（DFTSESSIONTIME）
...
- 原始手册：`evidence/UNC/20.15.2/SET-DFTSESSIONTIME.md`
