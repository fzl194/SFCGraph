---
id: UNC@20.15.2@MMLCommand@MOD SELECTCCTBYCC
type: MMLCommand
name: MOD SELECTCCTBYCC（修改基于CC配置融合计费模板处理）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD SELECTCCTBYCC（修改基于CC配置融合计费模板处理）
...
- [基于CC配置融合计费模板处理（SELECTCCTBYCC）](configobject/UNC/20.15.2/SELECTCCTBYCC.md)
