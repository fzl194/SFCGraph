---
id: UNC@20.15.2@MMLCommand@RMV DISCADAPTFC
type: MMLCommand
name: RMV DISCADAPTFC（删除服务发现自适应流控NF级配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DISCADAPTFC（删除服务发现自适应流控NF级配置）
...
- [[UNC@20.15.2@ConfigObject@DISCADAPTFC]] · 服务发现自适应流控NF级配置（DISCADAPTFC）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-DISCADAPTFC.md`
