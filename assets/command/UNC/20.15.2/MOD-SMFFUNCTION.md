---
id: UNC@20.15.2@MMLCommand@MOD SMFFUNCTION
type: MMLCommand
name: MOD SMFFUNCTION（修改SMF功能实例信息）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[UNC@20.15.2@ConfigObject@SMFFUNCTION]] · SMF功能实例信息（SMFFUNCTION）
