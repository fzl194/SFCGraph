---
id: UNC@20.15.2@MMLCommand@ADD MATCHRTSRCPREFIXFILTER
type: MMLCommand
name: ADD MATCHRTSRCPREFIXFILTER（增加匹配路由源IP前缀）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD MATCHRTSRCPREFIXFILTER（增加匹配路由源IP前缀）
...
增加基于发布路由的源地址IP信息的匹配规则：

```
ADD MATCHRTSRCPREFIXFILTER:POLICYNAME="a",NODESEQUENCE=10,PREFIXNAME="a";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/ADD-MATCHRTSRCPREFIXFILTER.md`
