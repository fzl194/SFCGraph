---
id: UNC@20.15.2@MMLCommand@RMV AUTORP
type: MMLCommand
name: RMV AUTORP（删除Auto-RP配置）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@AUTORP]] · Auto-RP配置（AUTORP）
...
```
RMV AUTORP:VRFNAME="_public_",ADDRESSFAMILY=ipv4unicast;
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-AUTORP.md`
