---
id: UNC@20.15.2@MMLCommand@MOD NONIPSUBCTRL
type: MMLCommand
name: MOD NONIPSUBCTRL（修改Non-IP APNNI配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NONIPSUBCTRL（修改Non-IP APNNI配置）
...
- 原始手册：`evidence/UNC/20.15.2/修改Non-IP-APNNI配置(MOD-NONIPSUBCTRL)_72345373.md`
