---
id: UNC@20.15.2@MMLCommand@RMV NGTAIGRPMEM
type: MMLCommand
name: RMV NGTAIGRPMEM（删除5G TAI组性能统计对象成员）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NGTAIGRPMEM（删除5G TAI组性能统计对象成员）

## 功能

**适用NF：AMF**

该命令用于为基于5G TAI组的性能统计对象删除TAI成员。
...
- [[UNC@20.15.2@ConfigObject@NGTAIGRPMEM]] · 5G TAI组性能统计对象成员（NGTAIGRPMEM）

## 使用实例

将跟踪区区间“46000112233”-“46000112255”，从命名为“Hangzhou”的TAI组性能统计对象中删除，执行如下命令：

```
RMV NGTAIGRPMEM: NGTAIGPN="Hangzhou", BGNTAI="46000112233", ENDTAI="46000112255";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-NGTAIGRPMEM.md`
