---
id: UNC@20.15.2@MMLCommand@STR OFFLOADUDM
type: MMLCommand
name: STR OFFLOADUDM（启动UDM注册上下文的迁移）
nf: UNC
version: 20.15.2
verb: STR
object_keyword: OFFLOADUDM
...
- [[configobject/UNC/20.15.2/OFFLOADUDM]] · UDM注册上下文的迁移（OFFLOADUDM）
...
- 原始手册：`evidence/UNC/20.15.2/STR-OFFLOADUDM.md`
