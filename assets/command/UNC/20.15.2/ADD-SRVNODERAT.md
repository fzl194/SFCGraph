---
id: UNC@20.15.2@MMLCommand@ADD SRVNODERAT
type: MMLCommand
name: ADD SRVNODERAT（增加SGSN/SGW IP与RAT类型间的映射关系）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD SRVNODERAT（增加SGSN/SGW IP与RAT类型间的映射关系）
...
- [[UNC@20.15.2@ConfigObject@SRVNODERAT]] · SGSN/SGW IP与RAT类型间的映射关系（SRVNODERAT）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SRVNODERAT.md`
