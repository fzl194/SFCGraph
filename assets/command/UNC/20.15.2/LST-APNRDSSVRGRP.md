---
id: UNC@20.15.2@MMLCommand@LST APNRDSSVRGRP
type: MMLCommand
name: LST APNRDSSVRGRP（查询APN Radius服务器组）
nf: UNC
version: 20.15.2
verb: LST
...
# LST APNRDSSVRGRP（查询APN Radius服务器组）
...
- [APN Radius服务器组（APNRDSSVRGRP）](configobject/UNC/20.15.2/APNRDSSVRGRP.md)
