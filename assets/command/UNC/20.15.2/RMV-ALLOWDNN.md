---
id: UNC@20.15.2@MMLCommand@RMV ALLOWDNN
type: MMLCommand
name: RMV ALLOWDNN（删除允许本地专网分流的DNN）
nf: UNC
version: 20.15.2
verb: RMV
...
- [允许本地专网分流的DNN（ALLOWDNN）](configobject/UNC/20.15.2/ALLOWDNN.md)
