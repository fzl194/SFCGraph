---
id: UNC@20.15.2@MMLCommand@DSP SOFTWARE
type: MMLCommand
...
- [下载软件仓软件（SOFTWARE）](configobject/UNC/20.15.2/SOFTWARE.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示软件仓软件（DSP-SOFTWARE）_59036808.md`
