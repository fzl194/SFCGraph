---
id: UNC@20.15.2@MMLCommand@RMV PNFALLOWDOMAIN
type: MMLCommand
name: RMV PNFALLOWDOMAIN（删除对端NF允许的域名信息）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PNFALLOWDOMAIN（删除对端NF允许的域名信息）
...
- [[configobject/UNC/20.15.2/PNFALLOWDOMAIN]] · 对端NF允许的域名信息（PNFALLOWDOMAIN）
