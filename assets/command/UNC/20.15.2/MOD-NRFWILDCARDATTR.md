---
id: UNC@20.15.2@MMLCommand@MOD NRFWILDCARDATTR
type: MMLCommand
name: MOD NRFWILDCARDATTR（修改分层互联通配属性）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NRFWILDCARDATTR（修改分层互联通配属性）
...
- [[UNC@20.15.2@ConfigObject@NRFWILDCARDATTR]] · 分层互联通配属性（NRFWILDCARDATTR）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-NRFWILDCARDATTR.md`
