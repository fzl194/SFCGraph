---
id: UNC@20.15.2@MMLCommand@MOD QUOTAEXHAUSTACT
type: MMLCommand
name: MOD QUOTAEXHAUSTACT（修改配额耗尽后的动作）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD QUOTAEXHAUSTACT（修改配额耗尽后的动作）
...
- [[configobject/UNC/20.15.2/QUOTAEXHAUSTACT]] · 配额耗尽后的动作（QUOTAEXHAUSTACT）
