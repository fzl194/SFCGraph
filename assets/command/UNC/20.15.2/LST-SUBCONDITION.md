---
id: UNC@20.15.2@MMLCommand@LST SUBCONDITION
type: MMLCommand
name: LST SUBCONDITION（查询NF订阅条件）
nf: UNC
version: 20.15.2
verb: LST
...
- [[configobject/UNC/20.15.2/SUBCONDITION]] · NF订阅条件（SUBCONDITION）
...
- 原始手册：`evidence/UNC/20.15.2/LST-SUBCONDITION.md`
