---
id: UNC@20.15.2@MMLCommand@MOD RESTRICTSNSSAI
type: MMLCommand
name: MOD RESTRICTSNSSAI（修改受限的S-NSSAI）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD RESTRICTSNSSAI（修改受限的S-NSSAI）
...
假如运营商希望修改一条INDEX为1、MCC为"460"、MNC为"03"、TAC为"0101"、SST为1、SD为"010101"的记录，执行下列命令。

```
MOD RESTRICTSNSSAI: INDEX=1, MCC="460", MNC="03", TAC="0101", SST=1, SD="010101";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-RESTRICTSNSSAI.md`
