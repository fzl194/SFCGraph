---
id: UNC@20.15.2@MMLCommand@DSP NCSSCHEMAMAP
type: MMLCommand
name: DSP NCSSCHEMAMAP（显示应用模型间模型映射关联关系）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: NCSSCHEMAMAP
...
# DSP NCSSCHEMAMAP（显示应用模型间模型映射关联关系）
...
- [[configobject/UNC/20.15.2/NCSSCHEMAMAP]] · 应用模型间模型映射关联关系（NCSSCHEMAMAP）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-NCSSCHEMAMAP.md`
