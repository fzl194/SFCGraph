---
id: UNC@20.15.2@MMLCommand@DSP PROCESSCG
type: MMLCommand
name: DSP PROCESSCG（查询CG进程信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: PROCESSCG
...
- [CG进程信息（PROCESSCG）](configobject/UNC/20.15.2/PROCESSCG.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询CG进程信息（DSP-PROCESSCG）_52418146.md`
