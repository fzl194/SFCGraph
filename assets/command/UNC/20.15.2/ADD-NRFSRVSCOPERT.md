---
id: UNC@20.15.2@MMLCommand@ADD NRFSRVSCOPERT
type: MMLCommand
name: ADD NRFSRVSCOPERT（增加ServingScope路由）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD NRFSRVSCOPERT（增加ServingScope路由）
...
- [[UNC@20.15.2@ConfigObject@NRFSRVSCOPERT]] · ServingScope路由（NRFSRVSCOPERT）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NRFSRVSCOPERT.md`
