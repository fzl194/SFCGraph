---
id: UNC@20.15.2@MMLCommand@RMV PERFOBJ
type: MMLCommand
name: RMV PERFOBJ（删除性能对象信息）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@PERFOBJ]] · 性能对象信息（PERFOBJ）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-PERFOBJ.md`
