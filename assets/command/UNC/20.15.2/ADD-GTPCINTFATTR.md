---
id: UNC@20.15.2@MMLCommand@ADD GTPCINTFATTR
type: MMLCommand
name: ADD GTPCINTFATTR（增加GTP-C IP地址接口属性）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD GTPCINTFATTR（增加GTP-C IP地址接口属性）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-GTPCINTFATTR.md`
