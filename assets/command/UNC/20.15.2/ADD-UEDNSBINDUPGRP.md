---
id: UNC@20.15.2@MMLCommand@ADD UEDNSBINDUPGRP
type: MMLCommand
name: ADD UEDNSBINDUPGRP（增加UPF组的DNS属性）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD UEDNSBINDUPGRP（增加UPF组的DNS属性）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-UEDNSBINDUPGRP.md`
