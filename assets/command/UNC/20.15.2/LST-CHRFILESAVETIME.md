---
id: UNC@20.15.2@MMLCommand@LST CHRFILESAVETIME
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@CHRFILESAVETIME]] · 文件存留期设置（CHRFILESAVETIME）
...
- 原始手册：`evidence/UNC/20.15.2/LST-CHRFILESAVETIME.md`
