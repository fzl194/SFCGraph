---
id: UNC@20.15.2@MMLCommand@ADD MATCHCOST
type: MMLCommand
name: ADD MATCHCOST（增加Cost匹配路由策略）
nf: UNC
version: 20.15.2
verb: ADD
...
- [Cost匹配路由策略（MATCHCOST）](configobject/UNC/20.15.2/MATCHCOST.md)

## 使用实例

添加路由策略a节点10的匹配条件，匹配路由开销值10：

```
ADD MATCHCOST:NODESEQUENCE=10,COSTVALUE=10,POLICYNAME="a";
```
