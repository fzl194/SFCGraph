---
id: UNC@20.15.2@MMLCommand@ADD MATCHNEXTHOPPREFIXFILTER
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@MATCHNEXTHOPPREFIXFILTER]] · 下一跳前缀匹配路由策略（MATCHNEXTHOPPREFIXFILTER）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-MATCHNEXTHOPPREFIXFILTER.md`
