---
id: UNC@20.15.2@MMLCommand@DSP WLRMSGSTC
type: MMLCommand
...
- [WLR与各Partner的消息统计（WLRMSGSTC）](configobject/UNC/20.15.2/WLRMSGSTC.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示WLR与各Partner的消息统计（DSP-WLRMSGSTC）_00841049.md`
