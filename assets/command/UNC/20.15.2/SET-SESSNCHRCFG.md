---
id: UNC@20.15.2@MMLCommand@SET SESSNCHRCFG
type: MMLCommand
name: SET SESSNCHRCFG（设置会话CHR上报策略）
nf: UNC
version: 20.15.2
verb: SET
...
- [会话CHR上报策略（SESSNCHRCFG）](configobject/UNC/20.15.2/SESSNCHRCFG.md)
