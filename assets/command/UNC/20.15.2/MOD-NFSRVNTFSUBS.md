---
id: UNC@20.15.2@MMLCommand@MOD NFSRVNTFSUBS
type: MMLCommand
name: MOD NFSRVNTFSUBS（修改服务回调信息）
nf: UNC
version: 20.15.2
verb: MOD
...
- [服务回调信息（NFSRVNTFSUBS）](configobject/UNC/20.15.2/NFSRVNTFSUBS.md)
