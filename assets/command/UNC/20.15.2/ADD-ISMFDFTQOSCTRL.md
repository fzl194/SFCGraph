---
id: UNC@20.15.2@MMLCommand@ADD ISMFDFTQOSCTRL
type: MMLCommand
name: ADD ISMFDFTQOSCTRL（增加I-SMF的Default QoS Flow配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD ISMFDFTQOSCTRL（增加I-SMF的Default QoS Flow配置）
...
- [[UNC@20.15.2@ConfigObject@ISMFDFTQOSCTRL]] · I-SMF的Default QoS Flow配置（ISMFDFTQOSCTRL）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ISMFDFTQOSCTRL.md`
