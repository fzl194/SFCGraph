---
id: UNC@20.15.2@MMLCommand@SET GLBSCTPPARA
type: MMLCommand
name: SET GLBSCTPPARA（设置SCTP全局参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [SCTP全局参数（GLBSCTPPARA）](configobject/UNC/20.15.2/GLBSCTPPARA.md)
