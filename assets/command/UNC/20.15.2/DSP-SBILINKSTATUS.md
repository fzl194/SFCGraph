---
id: UNC@20.15.2@MMLCommand@DSP SBILINKSTATUS
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@SBILINKSTATUS]] · 服务化接口链路状态（SBILINKSTATUS）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SBILINKSTATUS.md`
