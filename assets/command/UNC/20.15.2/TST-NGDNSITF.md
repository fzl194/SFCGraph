---
id: UNC@20.15.2@MMLCommand@TST NGDNSITF
type: MMLCommand
name: TST NGDNSITF（DNS客户端查询接口）
nf: UNC
version: 20.15.2
verb: TST
object_keyword: NGDNSITF
...
- [DNS客户端查询接口（NGDNSITF）](configobject/UNC/20.15.2/NGDNSITF.md)
