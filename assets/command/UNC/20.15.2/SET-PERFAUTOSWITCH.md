---
id: UNC@20.15.2@MMLCommand@SET PERFAUTOSWITCH
type: MMLCommand
name: SET PERFAUTOSWITCH（设置话统对象自动生成开关）
nf: UNC
version: 20.15.2
verb: SET
...
# SET PERFAUTOSWITCH（设置话统对象自动生成开关）
...
- [话统对象自动生成开关（PERFAUTOSWITCH）](configobject/UNC/20.15.2/PERFAUTOSWITCH.md)
