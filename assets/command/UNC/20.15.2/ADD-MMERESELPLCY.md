---
id: UNC@20.15.2@MMLCommand@ADD MMERESELPLCY
type: MMLCommand
name: ADD MMERESELPLCY（增加MME重选策略）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/MMERESELPLCY]] · MME重选策略（MMERESELPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-MMERESELPLCY.md`
