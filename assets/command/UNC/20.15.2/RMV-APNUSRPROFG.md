---
id: UNC@20.15.2@MMLCommand@RMV APNUSRPROFG
type: MMLCommand
name: RMV APNUSRPROFG（删除APN用户模板组绑定关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV APNUSRPROFG（删除APN用户模板组绑定关系）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-APNUSRPROFG.md`
