---
id: UNC@20.15.2@MMLCommand@ADD NRFGUAMIRT
type: MMLCommand
name: ADD NRFGUAMIRT（增加GUAMI路由）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NRFGUAMIRT]] · GUAMI路由（NRFGUAMIRT）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NRFGUAMIRT.md`
