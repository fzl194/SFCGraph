---
id: UNC@20.15.2@MMLCommand@ADD PCCBYPASSCODE
type: MMLCommand
name: ADD PCCBYPASSCODE（增加PCC故障场景维持BYPASS状态码配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PCCBYPASSCODE（增加PCC故障场景维持BYPASS状态码配置）
...
- [[UNC@20.15.2@ConfigObject@PCCBYPASSCODE]] · PCC故障场景维持BYPASS状态码配置（PCCBYPASSCODE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PCCBYPASSCODE.md`
