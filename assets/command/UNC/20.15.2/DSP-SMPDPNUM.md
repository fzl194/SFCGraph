---
id: UNC@20.15.2@MMLCommand@DSP SMPDPNUM
type: MMLCommand
name: DSP SMPDPNUM（查询会话管理的PDP上下文数）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: SMPDPNUM
...
- [会话管理的PDP上下文数（SMPDPNUM）](configobject/UNC/20.15.2/SMPDPNUM.md)
