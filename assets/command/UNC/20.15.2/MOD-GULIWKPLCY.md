---
id: UNC@20.15.2@MMLCommand@MOD GULIWKPLCY
type: MMLCommand
name: MOD GULIWKPLCY（修改GUL互操作本地策略）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[UNC@20.15.2@ConfigObject@GULIWKPLCY]] · GUL互操作本地策略（GULIWKPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-GULIWKPLCY.md`
