---
id: UNC@20.15.2@MMLCommand@ADD CHGPLMNCG
type: MMLCommand
name: ADD CHGPLMNCG（增加PLMN-CG配置参数）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@CHGPLMNCG]] · PLMN-CG配置参数（CHGPLMNCG）
