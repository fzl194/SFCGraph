---
id: UNC@20.15.2@MMLCommand@SET INNERSTAT
type: MMLCommand
name: SET INNERSTAT（设置内统配置参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@INNERSTAT]] · 内统配置参数（INNERSTAT）
...
- 原始手册：`evidence/UNC/20.15.2/SET-INNERSTAT.md`
