---
id: UNC@20.15.2@MMLCommand@DSP MSSTBMLINEAR
type: MMLCommand
...
- [[configobject/UNC/20.15.2/MSSTBMLINEAR]] · 通过关键字查询线性表的结果（MSSTBMLINEAR）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-MSSTBMLINEAR.md`
