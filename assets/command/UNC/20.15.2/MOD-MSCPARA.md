---
id: UNC@20.15.2@MMLCommand@MOD MSCPARA
type: MMLCommand
name: MOD MSCPARA（修改MSC参数）
nf: UNC
version: 20.15.2
verb: MOD
...
此命令用于修改MSC IP地址和MSC-Number之间的映射关系。
...
| MSCNUM | MSC-Number | 可选必选说明：可选参数<br>参数含义：该参数用于指定MSC-Number。<br>数据来源：全网规划<br>取值范围：字符串类型，长度为1～15位的数字。<br>默认值：无 |
| DESC | 描述 | 可选必选说明：可选参数<br>参数含义：该参数用于增加配置命令的描述信息。<br>数据来源：全网规划<br>取值范围：字符串类型，输入长度范围为0～32。<br>默认值：无 |
...
修改 “MSC IPv4地址” 为 “10.141.149.100” 的MSC的 “MSC-Number” 为 “987654321” 。

MOD MSCPARA: IPTYPE=IPV4, IPV4="10.141.149.100", MSCNUM="987654321";
