---
id: UNC@20.15.2@MMLCommand@MOD MATCHNEXTHOPACL
type: MMLCommand
name: MOD MATCHNEXTHOPACL（修改下一跳基础ACL匹配路由策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD MATCHNEXTHOPACL（修改下一跳基础ACL匹配路由策略）
...
```
MOD MATCHNEXTHOPACL:POLICYNAME="a",NODESEQUENCE=10,ACLNAMEORNUM="abc";
```
