---
id: UNC@20.15.2@MMLCommand@ADD PODHEALCPUTHR
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@PODHEALCPUTHR]] · 对应PODTYPE下的阈值配置（PODHEALCPUTHR）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PODHEALCPUTHR.md`
