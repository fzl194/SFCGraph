---
id: UNC@20.15.2@MMLCommand@MOD 5GCREMARK
type: MMLCommand
name: MOD 5GCREMARK（修改5GC QoS到TOS/DSCP的映射规则）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD 5GCREMARK（修改5GC QoS到TOS/DSCP的映射规则）
...
- [5GC QoS到TOS/DSCP的映射规则（5GCREMARK）](configobject/UNC/20.15.2/5GCREMARK.md)
