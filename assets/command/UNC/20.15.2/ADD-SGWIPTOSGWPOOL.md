---
id: UNC@20.15.2@MMLCommand@ADD SGWIPTOSGWPOOL
type: MMLCommand
name: ADD SGWIPTOSGWPOOL（增加SGW IP）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/SGWIPTOSGWPOOL]] · SGW IP（SGWIPTOSGWPOOL）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SGWIPTOSGWPOOL.md`
