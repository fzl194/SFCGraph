---
id: UNC@20.15.2@MMLCommand@LST AUTOSCALINGSRBFD
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@AUTOSCALINGSRBFD]] · 静态路由的动态BFD自动化配置模板（AUTOSCALINGSRBFD）
...
- 原始手册：`evidence/UNC/20.15.2/LST-AUTOSCALINGSRBFD.md`
