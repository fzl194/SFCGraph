---
id: UNC@20.15.2@MMLCommand@RMV SBIAPLE
type: MMLCommand
...
![](删除服务化接口本端实体（RMV SBIAPLE）_84132108.assets/notice_3.0-zh-cn_2.png)
...
- [[UNC@20.15.2@ConfigObject@SBIAPLE]] · 服务化接口本端实体（SBIAPLE）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-SBIAPLE.md`
