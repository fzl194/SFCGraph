---
id: UNC@20.15.2@MMLCommand@RMV OSPFNEXTHOP
type: MMLCommand
name: RMV OSPFNEXTHOP（删除OSPF等价路由优先级配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV OSPFNEXTHOP（删除OSPF等价路由优先级配置）
...
- [OSPF等价路由优先级配置（OSPFNEXTHOP）](configobject/UNC/20.15.2/OSPFNEXTHOP.md)
