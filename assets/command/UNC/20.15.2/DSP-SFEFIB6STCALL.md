---
id: UNC@20.15.2@MMLCommand@DSP SFEFIB6STCALL
type: MMLCommand
...
- [[configobject/UNC/20.15.2/SFEFIB6STCALL]] · IPv6所有的路由表项的统计（SFEFIB6STCALL）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SFEFIB6STCALL.md`
