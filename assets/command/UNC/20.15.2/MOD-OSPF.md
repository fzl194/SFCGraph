---
id: UNC@20.15.2@MMLCommand@MOD OSPF
type: MMLCommand
...
![](修改OSPF进程配置（MOD OSPF）_50121158.assets/notice_3.0-zh-cn_2.png)
...
- 原始手册：`evidence/UNC/20.15.2/修改OSPF进程配置（MOD-OSPF）_50121158.md`
