---
id: UNC@20.15.2@MMLCommand@ADD UPFADDRATTR
type: MMLCommand
name: ADD UPFADDRATTR（增加UPF地址属性）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@UPFADDRATTR]] · UPF地址属性（UPFADDRATTR）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-UPFADDRATTR.md`
