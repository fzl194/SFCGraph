---
id: UNC@20.15.2@MMLCommand@RMV APNACTNUM
type: MMLCommand
name: RMV APNACTNUM（删除APN激活数目限制）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV APNACTNUM（删除APN激活数目限制）

## 功能

**适用网元：MME**

该命令用于删除一条APN激活数目限制配置记录。
...
删除 “APN网络标识” 为HUAWEI的APN激活数目限制的配置记录：

RMV APNACTNUM: APNNI="HUAWEI";

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-APNACTNUM.md`
