---
id: UNC@20.15.2@MMLCommand@RMV HOMESMFINSTID
type: MMLCommand
name: RMV HOMESMFINSTID（删除指定归属地SMF实例标识）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV HOMESMFINSTID（删除指定归属地SMF实例标识）
...
- [[UNC@20.15.2@ConfigObject@HOMESMFINSTID]] · 指定归属地SMF实例标识（HOMESMFINSTID）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-HOMESMFINSTID.md`
