---
id: UNC@20.15.2@MMLCommand@RMV SQOSVPNGROUPMEM
type: MMLCommand
...
- [[configobject/UNC/20.15.2/SQOSVPNGROUPMEM]] · VPN组成员（SQOSVPNGROUPMEM）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-SQOSVPNGROUPMEM.md`
