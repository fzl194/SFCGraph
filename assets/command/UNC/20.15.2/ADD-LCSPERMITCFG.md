---
id: UNC@20.15.2@MMLCommand@ADD LCSPERMITCFG
type: MMLCommand
name: ADD LCSPERMITCFG（增加定位服务权限配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [定位服务权限配置（LCSPERMITCFG）](configobject/UNC/20.15.2/LCSPERMITCFG.md)
