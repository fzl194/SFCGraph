---
id: UNC@20.15.2@MMLCommand@ADD ACLRULEADV6IPSEC
type: MMLCommand
name: ADD ACLRULEADV6IPSEC（增加高级IPv6 ACL规则）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD ACLRULEADV6IPSEC（增加高级IPv6 ACL规则）
...
- [高级IPv6 ACL规则（ACLRULEADV6IPSEC）](configobject/UNC/20.15.2/ACLRULEADV6IPSEC.md)
...
- 原始手册：`evidence/UNC/20.15.2/增加高级IPv6-ACL规则（ADD-ACLRULEADV6IPSEC）_68200943.md`
