---
id: UNC@20.15.2@MMLCommand@ADD OSPFV3IMPORTROUTE
type: MMLCommand
name: ADD OSPFV3IMPORTROUTE（创建OSPFv3引入路由配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD OSPFV3IMPORTROUTE（创建OSPFv3引入路由配置）
...
- [OSPFv3引入路由配置（OSPFV3IMPORTROUTE）](configobject/UNC/20.15.2/OSPFV3IMPORTROUTE.md)
...
- 原始手册：`evidence/UNC/20.15.2/创建OSPFv3引入路由配置（ADD-OSPFV3IMPORTROUTE）_00840849.md`
