---
id: UNC@20.15.2@MMLCommand@MOD APPLYPREFVALUE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@APPLYPREFVALUE]] · BGP路由首选值设置（APPLYPREFVALUE）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-APPLYPREFVALUE.md`
