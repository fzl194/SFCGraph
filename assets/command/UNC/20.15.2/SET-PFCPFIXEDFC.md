---
id: UNC@20.15.2@MMLCommand@SET PFCPFIXEDFC
type: MMLCommand
name: SET PFCPFIXEDFC（设置指定PFCP消息类型固定速率流控信息）
nf: UNC
version: 20.15.2
verb: SET
...
# SET PFCPFIXEDFC（设置指定PFCP消息类型固定速率流控信息）
...
- [[UNC@20.15.2@ConfigObject@PFCPFIXEDFC]] · 指定PFCP消息类型固定速率流控信息（PFCPFIXEDFC）
...
- 原始手册：`evidence/UNC/20.15.2/SET-PFCPFIXEDFC.md`
