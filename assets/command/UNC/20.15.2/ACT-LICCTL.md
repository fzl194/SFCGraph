---
id: UNC@20.15.2@MMLCommand@ACT LICCTL
type: MMLCommand
...
![](启动紧急License(ACT LICCTL)_46781803.assets/notice_3.0-zh-cn_2.png)
...
- [[UNC@20.15.2@ConfigObject@LICCTL]] · 紧急License（LICCTL）
...
- 原始手册：`evidence/UNC/20.15.2/ACT-LICCTL.md`
