---
id: UNC@20.15.2@MMLCommand@ADD BGPPEERAFPRE
type: MMLCommand
name: ADD BGPPEERAFPRE（增加BGP对等体条件路由匹配前缀）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD BGPPEERAFPRE（增加BGP对等体条件路由匹配前缀）
...
- [[configobject/UNC/20.15.2/BGPPEERAFPRE]] · BGP对等体条件路由匹配前缀（BGPPEERAFPRE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-BGPPEERAFPRE.md`
