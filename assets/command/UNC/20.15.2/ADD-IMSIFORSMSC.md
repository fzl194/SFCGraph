---
id: UNC@20.15.2@MMLCommand@ADD IMSIFORSMSC
type: MMLCommand
name: ADD IMSIFORSMSC（增加融合短消息功能共部署SMSC支持的IMSI号段）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD IMSIFORSMSC（增加融合短消息功能共部署SMSC支持的IMSI号段）
...
- [融合短消息功能共部署SMSC支持的IMSI号段配置（IMSIFORSMSC）](configobject/UNC/20.15.2/IMSIFORSMSC.md)

## 使用实例

运营商希望增加“IMSI号段起始号码”为“460023500100001”，“IMSI号段结束号码”为“460023500100009”的融合短消息功能共部署SMSC支持的IMSI号段配置，执行如下命令：

```
ADD IMSIFORSMSC: SEGSTART="460023500100001", SEGEND="460023500100009";
```
