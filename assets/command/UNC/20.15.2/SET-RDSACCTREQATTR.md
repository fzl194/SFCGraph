---
id: UNC@20.15.2@MMLCommand@SET RDSACCTREQATTR
type: MMLCommand
name: SET RDSACCTREQATTR（设置RADIUS计费服务器可选消息属性）
nf: UNC
version: 20.15.2
verb: SET
...
# SET RDSACCTREQATTR（设置RADIUS计费服务器可选消息属性）
...
- [RADIUS计费服务器可选消息属性（RDSACCTREQATTR）](configobject/UNC/20.15.2/RDSACCTREQATTR.md)
