---
id: UNC@20.15.2@MMLCommand@MOD QOS5QI2QCIMAP
type: MMLCommand
name: MOD QOS5QI2QCIMAP（修改5QI到QCI的映射）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD QOS5QI2QCIMAP（修改5QI到QCI的映射）

## 功能

**适用NF：PGW-C、SMF、GGSN**

该命令用来修改5QI到标准QCI的映射关系。
...
如果想修改一条QOS5QI2QCIMAP配置，执行如下命令：

```
MOD QOS5QI2QCIMAP:CTRLTYPE=APN_LEVEL,APN="huawei.com",QOS5QISTART=1,QOS5QIEND=3,QCI=2;
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-QOS5QI2QCIMAP.md`
