---
id: UNC@20.15.2@MMLCommand@RMV PNFSLCTSSCOPE
type: MMLCommand
name: RMV PNFSLCTSSCOPE（删除已配置的选择对端NF时使用的业务服务区）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PNFSLCTSSCOPE（删除已配置的选择对端NF时使用的业务服务区）

## 功能

**适用NF：SMF**

该命令用于删除已配置的选择对端NF时使用的业务服务区。
...
- [[UNC@20.15.2@ConfigObject@PNFSLCTSSCOPE]] · 选择对端NF时使用的业务服务区（PNFSLCTSSCOPE）
...
```
RMV PNFSLCTSSCOPE: PEERNFTYPE=DEFAULT, SRVSCOPENAME="CityA";
```
