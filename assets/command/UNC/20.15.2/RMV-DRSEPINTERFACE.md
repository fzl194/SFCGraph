---
id: UNC@20.15.2@MMLCommand@RMV DRSEPINTERFACE
type: MMLCommand
name: RMV DRSEPINTERFACE（删除故障隔离接口）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@DRSEPINTERFACE]] · 故障隔离接口（DRSEPINTERFACE）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-DRSEPINTERFACE.md`
