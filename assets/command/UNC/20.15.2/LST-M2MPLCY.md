---
id: UNC@20.15.2@MMLCommand@LST M2MPLCY
type: MMLCommand
name: LST M2MPLCY（查询M2M策略参数）
nf: UNC
version: 20.15.2
verb: LST
...
- [[UNC@20.15.2@ConfigObject@M2MPLCY]] · M2M策略参数（M2MPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/LST-M2MPLCY.md`
