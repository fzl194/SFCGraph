---
id: UNC@20.15.2@MMLCommand@RMV MATCHNEXTHOPACL
type: MMLCommand
name: RMV MATCHNEXTHOPACL（删除下一跳基础ACL匹配路由策略）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV MATCHNEXTHOPACL（删除下一跳基础ACL匹配路由策略）
...
取消路由策略a，节点10的匹配条件，匹配下一跳ACL：

```
RMV MATCHNEXTHOPACL:POLICYNAME="a",NODESEQUENCE=10,ACLNAMEORNUM="abc";
```
