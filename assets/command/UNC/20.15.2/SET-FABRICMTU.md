---
id: UNC@20.15.2@MMLCommand@SET FABRICMTU
type: MMLCommand
...
- [PAE内联口MTU值（FABRICMTU）](configobject/UNC/20.15.2/FABRICMTU.md)
...
- 原始手册：`evidence/UNC/20.15.2/设置PAE内联口的MTU值（SET-FABRICMTU）_85240592.md`
