---
id: UNC@20.15.2@MMLCommand@SET SMPDUCTRL
type: MMLCommand
name: SET SMPDUCTRL（设置PDU会话控制参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [PDU会话控制参数（SMPDUCTRL）](configobject/UNC/20.15.2/SMPDUCTRL.md)
