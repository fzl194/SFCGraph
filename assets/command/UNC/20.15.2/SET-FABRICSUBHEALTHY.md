---
id: UNC@20.15.2@MMLCommand@SET FABRICSUBHEALTHY
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@FABRICSUBHEALTHY]] · FABRIC内联口亚健康信息（FABRICSUBHEALTHY）
...
- 原始手册：`evidence/UNC/20.15.2/SET-FABRICSUBHEALTHY.md`
