---
id: UNC@20.15.2@MMLCommand@MOD QOSCAPBY5QI
type: MMLCommand
name: MOD QOSCAPBY5QI（修改基于5QI的QosFlow QoS限制配置。）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD QOSCAPBY5QI（修改基于5QI的QosFlow QoS限制配置。）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-QOSCAPBY5QI.md`
