---
id: UNC@20.15.2@MMLCommand@LST UERCAPUNCSEL
type: MMLCommand
name: LST UERCAPUNCSEL（查询UE无线能力选择UNC参数）
nf: UNC
version: 20.15.2
verb: LST
...
# LST UERCAPUNCSEL（查询UE无线能力选择UNC参数）
...
- 原始手册：`evidence/UNC/20.15.2/LST-UERCAPUNCSEL.md`
