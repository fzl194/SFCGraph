---
id: UNC@20.15.2@MMLCommand@SET SFEBFDPKTIPID
type: MMLCommand
...
- [BFD报文IPID的使能标记（SFEBFDPKTIPID）](configobject/UNC/20.15.2/SFEBFDPKTIPID.md)
...
- 原始手册：`evidence/UNC/20.15.2/设置BFD报文IPID的使能标记（SET-SFEBFDPKTIPID）_00601345.md`
