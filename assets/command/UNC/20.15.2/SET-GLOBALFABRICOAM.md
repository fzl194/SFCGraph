---
id: UNC@20.15.2@MMLCommand@SET GLOBALFABRICOAM
type: MMLCommand
...
- [[configobject/UNC/20.15.2/GLOBALFABRICOAM]] · OAM全局配置（GLOBALFABRICOAM）
...
- 原始手册：`evidence/UNC/20.15.2/SET-GLOBALFABRICOAM.md`
