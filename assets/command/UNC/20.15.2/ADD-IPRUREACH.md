---
id: UNC@20.15.2@MMLCommand@ADD IPRUREACH
type: MMLCommand
name: ADD IPRUREACH（增加RU到网关的可达性检测配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/IPRUREACH]] · RU到网关的可达性检测配置（IPRUREACH）
...
- 原始手册：`evidence/UNC/20.15.2/增加RU到网关的可达性检测配置（ADD-IPRUREACH）_49802266.md`
