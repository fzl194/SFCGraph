---
id: UNC@20.15.2@MMLCommand@ADD MATCHROUTETYPE
type: MMLCommand
name: ADD MATCHROUTETYPE（增加路由类型匹配路由策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD MATCHROUTETYPE（增加路由类型匹配路由策略）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-MATCHROUTETYPE.md`
