---
id: UNC@20.15.2@MMLCommand@ADD BSSIDFORNSEI
type: MMLCommand
name: ADD BSSIDFORNSEI（增加NSEI和BSSID值的对应关系）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD BSSIDFORNSEI（增加NSEI和BSSID值的对应关系）
...
- [NSEI和BSSID值的对应关系（BSSIDFORNSEI）](configobject/UNC/20.15.2/BSSIDFORNSEI.md)
