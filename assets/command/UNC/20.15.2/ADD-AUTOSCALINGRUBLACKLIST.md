---
id: UNC@20.15.2@MMLCommand@ADD AUTOSCALINGRUBLACKLIST
type: MMLCommand
...
- [[configobject/UNC/20.15.2/AUTOSCALINGRUBLACKLIST]] · 自动部署RU黑名单（AUTOSCALINGRUBLACKLIST）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-AUTOSCALINGRUBLACKLIST.md`
