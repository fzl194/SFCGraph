---
id: UNC@20.15.2@MMLCommand@RTR IPSECSTATISTIC
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@IPSECSTATISTIC]] · IPsec统计信息（IPSECSTATISTIC）
...
- 原始手册：`evidence/UNC/20.15.2/RTR-IPSECSTATISTIC.md`
