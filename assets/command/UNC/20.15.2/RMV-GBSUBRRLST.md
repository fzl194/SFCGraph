---
id: UNC@20.15.2@MMLCommand@RMV GBSUBRRLST
type: MMLCommand
name: RMV GBSUBRRLST（删除Gb模式用户漫游限制列表）
nf: UNC
version: 20.15.2
verb: RMV
...
Gb模式删除IMSI前缀为123456的区域漫游限制配置记录：

RMV GBSUBRRLST: SUBRANGE=IMSI_PREFIX, IMSIPRE="123456";
