---
id: UNC@20.15.2@MMLCommand@SET OSPFV3DEFIMPROUTCFG
type: MMLCommand
name: SET OSPFV3DEFIMPROUTCFG（设置OSPFv3引入路由默认配置）
nf: UNC
version: 20.15.2
verb: SET
...
# SET OSPFV3DEFIMPROUTCFG（设置OSPFv3引入路由默认配置）
...
- [OSPFv3引入路由默认配置（OSPFV3DEFIMPROUTCFG）](configobject/UNC/20.15.2/OSPFV3DEFIMPROUTCFG.md)
...
- 原始手册：`evidence/UNC/20.15.2/设置OSPFv3引入路由默认配置（SET-OSPFV3DEFIMPROUTCFG）_49960946.md`
