---
id: UNC@20.15.2@MMLCommand@DSP SECIPURPFSTAT
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@SECIPURPFSTAT]] · URPF丢弃报文计数信息（SECIPURPFSTAT）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SECIPURPFSTAT.md`
