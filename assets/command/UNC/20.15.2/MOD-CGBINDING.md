---
id: UNC@20.15.2@MMLCommand@MOD CGBINDING
type: MMLCommand
name: MOD CGBINDING（修改CG绑定关系）
nf: UNC
version: 20.15.2
verb: MOD
...
修改CG绑定关系，CG组ID为1，CG的IP地址为192.168.0.2，CG的端口号为25009，CG优先级修改为2：

```
MOD CGBINDING: CGGRPID=1, CGIPVERSION=IPV4, CGIPV4ADDR="192.168.0.2", CGPORT=25009, PRIORITY=2;
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/修改CG绑定关系（MOD-CGBINDING）_09896875.md`
