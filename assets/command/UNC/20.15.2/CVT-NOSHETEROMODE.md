---
id: UNC@20.15.2@MMLCommand@CVT NOSHETEROMODE
type: MMLCommand
...
![](转换NOS异构模式(CVT NOSHETEROMODE)_77109417.assets/notice_3.0-zh-cn_2.png)
...
- [NOS异构模式（NOSHETEROMODE）](configobject/UNC/20.15.2/NOSHETEROMODE.md)
