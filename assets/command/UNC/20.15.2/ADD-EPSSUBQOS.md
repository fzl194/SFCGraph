---
id: UNC@20.15.2@MMLCommand@ADD EPSSUBQOS
type: MMLCommand
name: ADD EPSSUBQOS（增加EPS签约QoS配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/EPSSUBQOS]] · EPS签约QoS配置（EPSSUBQOS）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-EPSSUBQOS.md`
