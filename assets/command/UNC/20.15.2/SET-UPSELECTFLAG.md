---
id: UNC@20.15.2@MMLCommand@SET UPSELECTFLAG
type: MMLCommand
name: SET UPSELECTFLAG（设置UPF选择条件开关）
nf: UNC
version: 20.15.2
verb: SET
...
- [[configobject/UNC/20.15.2/UPSELECTFLAG]] · UPF选择条件开关（UPSELECTFLAG）
...
- 原始手册：`evidence/UNC/20.15.2/SET-UPSELECTFLAG.md`
