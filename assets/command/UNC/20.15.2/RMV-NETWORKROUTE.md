---
id: UNC@20.15.2@MMLCommand@RMV NETWORKROUTE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@NETWORKROUTE]] · 引入路由指定前缀和掩码长度（NETWORKROUTE）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-NETWORKROUTE.md`
