---
id: UNC@20.15.2@MMLCommand@ADD APNDEACTQFPLCY
type: MMLCommand
name: ADD APNDEACTQFPLCY（增加基于APN去活用户面专有QoS Flow策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNDEACTQFPLCY（增加基于APN去活用户面专有QoS Flow策略）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-APNDEACTQFPLCY.md`
