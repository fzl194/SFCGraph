---
id: UNC@20.15.2@MMLCommand@ADD PROXYSGWACCLIST
type: MMLCommand
name: ADD PROXYSGWACCLIST（增加Proxy SGW-C接入控制列表）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PROXYSGWACCLIST（增加Proxy SGW-C接入控制列表）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PROXYSGWACCLIST.md`
