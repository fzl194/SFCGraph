---
id: UNC@20.15.2@MMLCommand@LST AUTOSCALINGRUBLACKLIST
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@AUTOSCALINGRUBLACKLIST]] · 自动部署RU黑名单（AUTOSCALINGRUBLACKLIST）
...
- 原始手册：`evidence/UNC/20.15.2/LST-AUTOSCALINGRUBLACKLIST.md`
