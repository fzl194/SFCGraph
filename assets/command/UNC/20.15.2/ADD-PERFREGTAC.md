---
id: UNC@20.15.2@MMLCommand@ADD PERFREGTAC
type: MMLCommand
name: ADD PERFREGTAC（增加区域性能统计对象和TAC段的绑定关系）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PERFREGTAC（增加区域性能统计对象和TAC段的绑定关系）
...
- [[UNC@20.15.2@ConfigObject@PERFREGTAC]] · 区域性能统计对象和TAC段的绑定关系（PERFREGTAC）
