---
id: UNC@20.15.2@MMLCommand@DSP BYPASSSWITCH
type: MMLCommand
...
![](查询节点自动进入BYPASS开关（DSP BYPASSSWITCH）_97531593.assets/notice_3.0-zh-cn_2.png)
...
- [节点自动进入BYPASS开关（BYPASSSWITCH）](configobject/UNC/20.15.2/BYPASSSWITCH.md)
