---
id: UNC@20.15.2@MMLCommand@RMV OSPFAREAFILTER
type: MMLCommand
name: RMV OSPFAREAFILTER（删除区域过滤策略配置）
nf: UNC
version: 20.15.2
verb: RMV
...
- [区域过滤策略配置（OSPFAREAFILTER）](configobject/UNC/20.15.2/OSPFAREAFILTER.md)
...
- 原始手册：`evidence/UNC/20.15.2/删除区域过滤策略配置（RMV-OSPFAREAFILTER）_00866413.md`
