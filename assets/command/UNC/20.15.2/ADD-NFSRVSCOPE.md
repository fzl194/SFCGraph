---
id: UNC@20.15.2@MMLCommand@ADD NFSRVSCOPE
type: MMLCommand
name: ADD NFSRVSCOPE（增加NF支持服务区信息）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NFSRVSCOPE]] · NF支持服务区信息（NFSRVSCOPE）
