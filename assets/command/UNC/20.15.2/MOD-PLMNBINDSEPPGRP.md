---
id: UNC@20.15.2@MMLCommand@MOD PLMNBINDSEPPGRP
type: MMLCommand
name: MOD PLMNBINDSEPPGRP（修改PLMN与SEPP组的绑定关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD PLMNBINDSEPPGRP（修改PLMN与SEPP组的绑定关系）
...
- [[UNC@20.15.2@ConfigObject@PLMNBINDSEPPGRP]] · PLMN与SEPP组的绑定关系（PLMNBINDSEPPGRP）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-PLMNBINDSEPPGRP.md`
