---
id: UNC@20.15.2@MMLCommand@MOD CDFTOKENWEIGHT
type: MMLCommand
name: MOD CDFTOKENWEIGHT（修改cdf token权重）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD CDFTOKENWEIGHT（修改cdf token权重）
...
- [[UNC@20.15.2@ConfigObject@CDFTOKENWEIGHT]] · cdf token权重（CDFTOKENWEIGHT）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-CDFTOKENWEIGHT.md`
