---
id: UNC@20.15.2@MMLCommand@SET PAEDEBUGSWITCH
type: MMLCommand
...
![](使能或去使能PAE转发日志（SET PAEDEBUGSWITCH）_92520051.assets/notice_3.0-zh-cn_2.png)
...
- [使能或去使能PAE转发日志（PAEDEBUGSWITCH）](configobject/UNC/20.15.2/PAEDEBUGSWITCH.md)
...
- 原始手册：`evidence/UNC/20.15.2/使能或去使能PAE转发日志（SET-PAEDEBUGSWITCH）_92520051.md`
