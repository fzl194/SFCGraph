---
id: UNC@20.15.2@MMLCommand@DSP BGPPEERALLVERBOSE
type: MMLCommand
name: DSP BGPPEERALLVERBOSE（查询BGP所有VPN对等体详细信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: BGPPEERALLVERBOSE
...
# DSP BGPPEERALLVERBOSE（查询BGP所有VPN对等体详细信息）
...
- [[configobject/UNC/20.15.2/BGPPEERALLVERBOSE]] · BGP所有VPN对等体详细信息（BGPPEERALLVERBOSE）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-BGPPEERALLVERBOSE.md`
