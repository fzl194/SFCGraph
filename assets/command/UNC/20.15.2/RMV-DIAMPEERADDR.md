---
id: UNC@20.15.2@MMLCommand@RMV DIAMPEERADDR
type: MMLCommand
name: RMV DIAMPEERADDR（删除Diameter对端地址）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DIAMPEERADDR（删除Diameter对端地址）
...
- [[UNC@20.15.2@ConfigObject@DIAMPEERADDR]] · Diameter对端地址（DIAMPEERADDR）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-DIAMPEERADDR.md`
