---
id: UNC@20.15.2@MMLCommand@ADD ULCLDNAIDPMODE
type: MMLCommand
name: ADD ULCLDNAIDPMODE（增加指定DNAI的ULCL部署模式）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD ULCLDNAIDPMODE（增加指定DNAI的ULCL部署模式）
...
- [[UNC@20.15.2@ConfigObject@ULCLDNAIDPMODE]] · 指定DNAI的ULCL部署模式（ULCLDNAIDPMODE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ULCLDNAIDPMODE.md`
