---
id: UNC@20.15.2@MMLCommand@RMV NRFIPDOMAINREL
type: MMLCommand
name: RMV NRFIPDOMAINREL（删除BSF索引和IP Domain的关联关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NRFIPDOMAINREL（删除BSF索引和IP Domain的关联关系）
...
- [BSF索引和IP Domain的关联关系（NRFIPDOMAINREL）](configobject/UNC/20.15.2/NRFIPDOMAINREL.md)
