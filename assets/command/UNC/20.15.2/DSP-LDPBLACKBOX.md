---
id: UNC@20.15.2@MMLCommand@DSP LDPBLACKBOX
type: MMLCommand
...
- [LDP记录的黑匣子信息（LDPBLACKBOX）](configobject/UNC/20.15.2/LDPBLACKBOX.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示LDP记录的黑匣子信息（DSP-LDPBLACKBOX）_00441025.md`
