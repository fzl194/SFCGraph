---
id: UNC@20.15.2@MMLCommand@RMV OCSGRPBINDING
type: MMLCommand
name: RMV OCSGRPBINDING（删除OCS组绑定关系）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@OCSGRPBINDING]] · OCS组绑定关系（OCSGRPBINDING）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-OCSGRPBINDING.md`
