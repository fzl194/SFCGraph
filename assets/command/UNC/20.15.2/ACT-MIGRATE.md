---
id: UNC@20.15.2@MMLCommand@ACT MIGRATE
type: MMLCommand
...
![](异构迁移（ACT MIGRATE）_35833852.assets/notice_3.0-zh-cn_2.png)
...
- [异构迁移查询（MIGRATE）](configobject/UNC/20.15.2/MIGRATE.md)
...
- 原始手册：`evidence/UNC/20.15.2/异构迁移（ACT-MIGRATE）_35833852.md`
