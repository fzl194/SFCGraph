---
id: UNC@20.15.2@MMLCommand@SET SBCFUNC
type: MMLCommand
name: SET SBCFUNC（设置小区广播功能）
nf: UNC
version: 20.15.2
verb: SET
...
- [[configobject/UNC/20.15.2/SBCFUNC]] · 小区广播功能（SBCFUNC）
...
- 原始手册：`evidence/UNC/20.15.2/SET-SBCFUNC.md`
