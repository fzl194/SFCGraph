---
id: UNC@20.15.2@MMLCommand@ADD NFSERVICE
type: MMLCommand
name: ADD NFSERVICE（增加NF服务实例）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NFSERVICE]] · NF服务实例（NFSERVICE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NFSERVICE.md`
