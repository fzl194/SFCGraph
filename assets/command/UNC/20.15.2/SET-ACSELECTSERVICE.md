---
id: UNC@20.15.2@MMLCommand@SET ACSELECTSERVICE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@ACSELECTSERVICE]] · 仲裁服务状态（ACSELECTSERVICE）
...
- 原始手册：`evidence/UNC/20.15.2/SET-ACSELECTSERVICE.md`
