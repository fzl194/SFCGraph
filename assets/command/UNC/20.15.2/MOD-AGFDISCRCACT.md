---
id: UNC@20.15.2@MMLCommand@MOD AGFDISCRCACT
type: MMLCommand
name: MOD AGFDISCRCACT（修改AGF基于TOPO异常响应处理动作）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD AGFDISCRCACT（修改AGF基于TOPO异常响应处理动作）

## 功能

**适用NF：NCG**

该命令用于修改AGF基于TOPO异常响应处理动作。
...
修改指定异常返回码类型为“900”的结果码处理动作，设置Failover模板标识为“ccpfot2”：

```
MOD AGFDISCRCACT: RCTYPE=VALUE, CODETYPE=900, FOTNM="ccpfot2";
```
