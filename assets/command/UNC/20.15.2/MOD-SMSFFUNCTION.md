---
id: UNC@20.15.2@MMLCommand@MOD SMSFFUNCTION
type: MMLCommand
name: MOD SMSFFUNCTION（修改SMSF功能实例信息）
nf: UNC
version: 20.15.2
verb: MOD
...
- [SMSF功能实例信息（SMSFFUNCTION）](configobject/UNC/20.15.2/SMSFFUNCTION.md)

## 使用实例

修改InstanceID为“b7b621d82dfb4a009d492491bd9d72a4”的SMSFFUNCTION的最大用户数MAXUSER为600000。

```
MOD SMSFFUNCTION: INSTANCEID="b7b621d82dfb4a009d492491bd9d72a4", SERVICENAME="nsmsf-sms", MAXUSER=600000;
```
