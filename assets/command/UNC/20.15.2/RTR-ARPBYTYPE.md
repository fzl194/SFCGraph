---
id: UNC@20.15.2@MMLCommand@RTR ARPBYTYPE
type: MMLCommand
...
![](根据ARP表项类型清除ARP表项（RTR ARPBYTYPE）_50280966.assets/notice_3.0-zh-cn_2.png)
...
- [[UNC@20.15.2@ConfigObject@ARPBYTYPE]] · 根据ARP表项类型清除ARP表项（ARPBYTYPE）
...
- 原始手册：`evidence/UNC/20.15.2/RTR-ARPBYTYPE.md`
