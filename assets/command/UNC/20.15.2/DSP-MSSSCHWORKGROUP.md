---
id: UNC@20.15.2@MMLCommand@DSP MSSSCHWORKGROUP
type: MMLCommand
...
- [[configobject/UNC/20.15.2/MSSSCHWORKGROUP]] · 调度组工作类型信息（MSSSCHWORKGROUP）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-MSSSCHWORKGROUP.md`
