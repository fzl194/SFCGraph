---
id: UNC@20.15.2@MMLCommand@MOD SRVNODEPLMN
type: MMLCommand
name: MOD SRVNODEPLMN（修改SGSN/SGW/PGW地址段和PLMN标识之间的映射关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD SRVNODEPLMN（修改SGSN/SGW/PGW地址段和PLMN标识之间的映射关系）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-SRVNODEPLMN.md`
