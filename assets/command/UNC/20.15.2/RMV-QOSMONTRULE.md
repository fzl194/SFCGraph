---
id: UNC@20.15.2@MMLCommand@RMV QOSMONTRULE
type: MMLCommand
name: RMV QOSMONTRULE（删除QoS监测规则）
nf: UNC
version: 20.15.2
verb: RMV
...
删除IMSI为"460030123456789"的QoS监测：

```
RMV QOSMONTRULE:MATCHMODE=IMSI,IMSI="460030123456789";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-QOSMONTRULE.md`
