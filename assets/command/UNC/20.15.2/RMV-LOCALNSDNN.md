---
id: UNC@20.15.2@MMLCommand@RMV LOCALNSDNN
type: MMLCommand
name: RMV LOCALNSDNN（删除网络切片或DNN纠正配置）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@LOCALNSDNN]] · 网络切片或DNN纠正配置（LOCALNSDNN）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-LOCALNSDNN.md`
