---
id: UNC@20.15.2@MMLCommand@MOD SMSUBDATA
type: MMLCommand
name: MOD SMSUBDATA（修改签约数据纠正参数）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[configobject/UNC/20.15.2/SMSUBDATA]] · 签约数据纠正参数（SMSUBDATA）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-SMSUBDATA.md`
