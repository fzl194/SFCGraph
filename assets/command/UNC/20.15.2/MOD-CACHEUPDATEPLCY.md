---
id: UNC@20.15.2@MMLCommand@MOD CACHEUPDATEPLCY
type: MMLCommand
name: MOD CACHEUPDATEPLCY（修改缓存更新策略）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[configobject/UNC/20.15.2/CACHEUPDATEPLCY]] · 缓存更新策略（CACHEUPDATEPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-CACHEUPDATEPLCY.md`
