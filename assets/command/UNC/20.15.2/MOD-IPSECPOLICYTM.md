---
id: UNC@20.15.2@MMLCommand@MOD IPSECPOLICYTM
type: MMLCommand
name: MOD IPSECPOLICYTM（修改IPsec策略模板）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[UNC@20.15.2@ConfigObject@IPSECPOLICYTM]] · IPsec策略模板（IPSECPOLICYTM）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-IPSECPOLICYTM.md`
