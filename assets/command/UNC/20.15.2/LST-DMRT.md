---
id: UNC@20.15.2@MMLCommand@LST DMRT
type: MMLCommand
name: LST DMRT（查询Diameter域路由配置）
nf: UNC
version: 20.15.2
verb: LST
object_keyword: DMRT
...
- [[UNC@20.15.2@ConfigObject@DMRT]] · Diameter域路由配置（DMRT）
...
- 原始手册：`evidence/UNC/20.15.2/LST-DMRT.md`
