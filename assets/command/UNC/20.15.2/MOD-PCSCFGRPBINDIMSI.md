---
id: UNC@20.15.2@MMLCommand@MOD PCSCFGRPBINDIMSI
type: MMLCommand
name: MOD PCSCFGRPBINDIMSI（修改P-CSCF组和IMSI/MSISDN号段的绑定关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD PCSCFGRPBINDIMSI（修改P-CSCF组和IMSI/MSISDN号段的绑定关系）
...
- [[UNC@20.15.2@ConfigObject@PCSCFGRPBINDIMSI]] · P-CSCF组和IMSI/MSISDN号段的绑定关系（PCSCFGRPBINDIMSI）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-PCSCFGRPBINDIMSI.md`
