---
id: UNC@20.15.2@MMLCommand@MOD ROAMCHGMODE
type: MMLCommand
name: MOD ROAMCHGMODE（修改基于漫游属性的计费接口选择方式）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD ROAMCHGMODE（修改基于漫游属性的计费接口选择方式）
...
- [基于漫游属性的计费接口选择方式（ROAMCHGMODE）](configobject/UNC/20.15.2/ROAMCHGMODE.md)
