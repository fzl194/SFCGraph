---
id: UNC@20.15.2@MMLCommand@DSP SRVVNFCMSGSTAT
type: MMLCommand
...
- [[configobject/UNC/20.15.2/SRVVNFCMSGSTAT]] · 服务VNFC消息统计（SRVVNFCMSGSTAT）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SRVVNFCMSGSTAT.md`
