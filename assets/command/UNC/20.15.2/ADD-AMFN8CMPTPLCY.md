---
id: UNC@20.15.2@MMLCommand@ADD AMFN8CMPTPLCY
type: MMLCommand
name: ADD AMFN8CMPTPLCY（增加AMF N8接口兼容性策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD AMFN8CMPTPLCY（增加AMF N8接口兼容性策略）
...
- [AMF N8接口兼容性策略（AMFN8CMPTPLCY）](configobject/UNC/20.15.2/AMFN8CMPTPLCY.md)
