---
id: UNC@20.15.2@MMLCommand@MOD DEACTQFPLCY
type: MMLCommand
name: MOD DEACTQFPLCY（修改去活用户面专有QoS Flow策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD DEACTQFPLCY（修改去活用户面专有QoS Flow策略）
...
- [[UNC@20.15.2@ConfigObject@DEACTQFPLCY]] · 去活用户面专有QoS Flow策略（DEACTQFPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-DEACTQFPLCY.md`
