---
id: UNC@20.15.2@MMLCommand@RMV GRPNGLANFUNC
type: MMLCommand
name: RMV GRPNGLANFUNC（删除指定群组的5G LAN会话扩展参数）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV GRPNGLANFUNC（删除指定群组的5G LAN会话扩展参数）
...
- [指定群组的5G LAN会话扩展参数（GRPNGLANFUNC）](configobject/UNC/20.15.2/GRPNGLANFUNC.md)
