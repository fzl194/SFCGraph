---
id: UNC@20.15.2@MMLCommand@RMV DIAMAAAGRP
type: MMLCommand
name: RMV DIAMAAAGRP（删除Diameter AAA服务器组）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DIAMAAAGRP（删除Diameter AAA服务器组）
...
- [Diameter AAA服务器组（DIAMAAAGRP）](configobject/UNC/20.15.2/DIAMAAAGRP.md)
