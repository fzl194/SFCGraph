---
id: UNC@20.15.2@MMLCommand@ADD IPSECPOLICY6
type: MMLCommand
name: ADD IPSECPOLICY6（增加IPsec Ipv6策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD IPSECPOLICY6（增加IPsec Ipv6策略）
...
- [IPsec IPv6策略（IPSECPOLICY6）](configobject/UNC/20.15.2/IPSECPOLICY6.md)
...
- 原始手册：`evidence/UNC/20.15.2/增加IPsec-Ipv6策略（ADD-IPSECPOLICY6）_68320981.md`
