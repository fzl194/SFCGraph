---
id: UNC@20.15.2@MMLCommand@ADD NGAPPARA
type: MMLCommand
name: ADD NGAPPARA（增加NGAP协议参数）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NGAPPARA]] · NGAP协议参数（NGAPPARA）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NGAPPARA.md`
