---
id: UNC@20.15.2@MMLCommand@MOD OSPFV3HOSTNAME
type: MMLCommand
name: MOD OSPFV3HOSTNAME（修改OSPFv3主机名配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD OSPFV3HOSTNAME（修改OSPFv3主机名配置）
...
- [OSPFv3主机名配置（OSPFV3HOSTNAME）](configobject/UNC/20.15.2/OSPFV3HOSTNAME.md)
...
- 原始手册：`evidence/UNC/20.15.2/修改OSPFv3主机名配置（MOD-OSPFV3HOSTNAME）_00441445.md`
