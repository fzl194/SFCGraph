---
id: UNC@20.15.2@MMLCommand@SET PODCPUTHD
type: MMLCommand
name: SET PODCPUTHD（设置POD CPU告警阈值）
nf: UNC
version: 20.15.2
verb: SET
...
- [POD CPU阈值（PODCPUTHD）](configobject/UNC/20.15.2/PODCPUTHD.md)
