---
id: UNC@20.15.2@MMLCommand@DSP MSSSCHTHREADFIX
type: MMLCommand
...
- [[configobject/UNC/20.15.2/MSSSCHTHREADFIX]] · 调度工作线程信息（MSSSCHTHREADFIX）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-MSSSCHTHREADFIX.md`
