---
id: UNC@20.15.2@MMLCommand@MOD N26IWKPLCY
type: MMLCommand
name: MOD N26IWKPLCY（修改EPS与5GS互操作本地策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD N26IWKPLCY（修改EPS与5GS互操作本地策略）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-N26IWKPLCY.md`
