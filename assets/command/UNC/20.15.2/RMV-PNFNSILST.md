---
id: UNC@20.15.2@MMLCommand@RMV PNFNSILST
type: MMLCommand
name: RMV PNFNSILST（删除对端NF实例网络切片标识）
nf: UNC
version: 20.15.2
verb: RMV
...
- [对端NF实例网络切片标识（PNFNSILST）](configobject/UNC/20.15.2/PNFNSILST.md)
