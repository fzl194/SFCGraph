---
id: UNC@20.15.2@MMLCommand@MOD CHGGNCCCFG
type: MMLCommand
name: MOD CHGGNCCCFG（修改Gn接口计费属性选择策略）
nf: UNC
version: 20.15.2
verb: MOD
...
- [Gn接口计费属性选择策略（CHGGNCCCFG）](configobject/UNC/20.15.2/CHGGNCCCFG.md)
