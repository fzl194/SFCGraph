---
id: UNC@20.15.2@MMLCommand@ADD PERFEPRPDYNIP
type: MMLCommand
name: ADD PERFEPRPDYNIP（增加EpRpDyn对象的IP地址）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PERFEPRPDYNIP（增加EpRpDyn对象的IP地址）
...
- [[UNC@20.15.2@ConfigObject@PERFEPRPDYNIP]] · EpRpDyn对象的IP地址（PERFEPRPDYNIP）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PERFEPRPDYNIP.md`
