---
id: UNC@20.15.2@MMLCommand@RMV AMFRSTRNSSAI
type: MMLCommand
name: RMV AMFRSTRNSSAI（删除TA级限制切片）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[configobject/UNC/20.15.2/AMFRSTRNSSAI]] · TA级限制切片（AMFRSTRNSSAI）

## 使用实例

删除在所有区域中，限制指定外网的用户使用eMBB切片，执行如下命令：

```
RMV AMFRSTRNSSAI:RSTRAREARANGE=ALL_AREA,SUBRANGE=FOREIGN_USER;
```
