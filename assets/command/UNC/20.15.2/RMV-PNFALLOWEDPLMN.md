---
id: UNC@20.15.2@MMLCommand@RMV PNFALLOWEDPLMN
type: MMLCommand
name: RMV PNFALLOWEDPLMN（删除对端NF允许的PLMN信息）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PNFALLOWEDPLMN（删除对端NF允许的PLMN信息）
...
- [对端NF允许的PLMN信息（PNFALLOWEDPLMN）](configobject/UNC/20.15.2/PNFALLOWEDPLMN.md)
