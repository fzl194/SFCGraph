---
id: UNC@20.15.2@MMLCommand@ADD SGWSELPLCY
type: MMLCommand
name: ADD SGWSELPLCY（增加S-GW选择策略）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/SGWSELPLCY]] · S-GW选择策略（SGWSELPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SGWSELPLCY.md`
