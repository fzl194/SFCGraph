---
id: UNC@20.15.2@MMLCommand@ADD S11INTFSUBNET
type: MMLCommand
name: ADD S11INTFSUBNET（增加S11接口子网配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [S11接口子网配置（S11INTFSUBNET）](configobject/UNC/20.15.2/S11INTFSUBNET.md)
