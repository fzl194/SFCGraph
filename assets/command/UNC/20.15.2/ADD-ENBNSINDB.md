---
id: UNC@20.15.2@MMLCommand@ADD ENBNSINDB
type: MMLCommand
name: ADD ENBNSINDB（增加eNodeB邻接关系）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@ENBNSINDB]] · 配置的eNodeB邻接关系（ENBNSINDB）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ENBNSINDB.md`
