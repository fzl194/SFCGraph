---
id: UNC@20.15.2@MMLCommand@SET FAILHANDLING
type: MMLCommand
name: SET FAILHANDLING（设置融合计费模板故障处理动作）
nf: UNC
version: 20.15.2
verb: SET
object_keyword: FAILHANDLING
...
# SET FAILHANDLING（设置融合计费模板故障处理动作）
...
- [融合计费模板故障处理动作（FAILHANDLING）](configobject/UNC/20.15.2/FAILHANDLING.md)
