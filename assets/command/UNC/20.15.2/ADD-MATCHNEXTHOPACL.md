---
id: UNC@20.15.2@MMLCommand@ADD MATCHNEXTHOPACL
type: MMLCommand
name: ADD MATCHNEXTHOPACL（增加下一跳基础ACL匹配路由策略）
nf: UNC
version: 20.15.2
verb: ADD
object_keyword: MATCHNEXTHOPACL
...
# ADD MATCHNEXTHOPACL（增加下一跳基础ACL匹配路由策略）
...
- [下一跳基础ACL匹配路由策略（MATCHNEXTHOPACL）](configobject/UNC/20.15.2/MATCHNEXTHOPACL.md)

## 使用实例

添加路由策略a节点10的匹配条件， ACL过滤器abc匹配下一跳：

```
ADD MATCHNEXTHOPACL:POLICYNAME="a",NODESEQUENCE=10,ACLNAMEORNUM="abc";
```
