---
id: UNC@20.15.2@MMLCommand@ADD APPLYNEXTHOP
type: MMLCommand
name: ADD APPLYNEXTHOP（增加下一跳设置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [下一跳设置（APPLYNEXTHOP）](configobject/UNC/20.15.2/APPLYNEXTHOP.md)

## 使用实例

路由策略a节点10，添加设置下一跳为10.1.1.1：

```
ADD APPLYNEXTHOP:NODESEQUENCE=10, NEXTHOP="10.1.1.1",POLICYNAME="a",ISPEERADDRESS=FALSE;
```
