---
id: UNC@20.15.2@MMLCommand@LST SERVICEIPMCR
type: MMLCommand
name: LST SERVICEIPMCR（查询业务IP）
nf: UNC
version: 20.15.2
verb: LST
...
- [[UNC@20.15.2@ConfigObject@SERVICEIPMCR]] · 业务IP（SERVICEIPMCR）
...
- 原始手册：`evidence/UNC/20.15.2/LST-SERVICEIPMCR.md`
