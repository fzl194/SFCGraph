---
id: UNC@20.15.2@MMLCommand@TST NFPROFILECHECK
type: MMLCommand
name: TST NFPROFILECHECK（测试NF和NRF上的网元信息是否一致）
nf: UNC
version: 20.15.2
verb: TST
object_keyword: NFPROFILECHECK
...
# TST NFPROFILECHECK（测试NF和NRF上的网元信息是否一致）
...
- [测试NF和NRF上的网元信息是否一致（NFPROFILECHECK）](configobject/UNC/20.15.2/NFPROFILECHECK.md)
