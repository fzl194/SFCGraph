---
id: UNC@20.15.2@MMLCommand@LST RSCBOXHEALCTRL
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@RSCBOXHEALCTRL]] · ResourceBox自愈策略控制参数（RSCBOXHEALCTRL）
...
- 原始手册：`evidence/UNC/20.15.2/LST-RSCBOXHEALCTRL.md`
