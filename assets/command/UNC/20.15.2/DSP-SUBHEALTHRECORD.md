---
id: UNC@20.15.2@MMLCommand@DSP SUBHEALTHRECORD
type: MMLCommand
...
- [[configobject/UNC/20.15.2/SUBHEALTHRECORD]] · base平面亚健康链路历史信息（SUBHEALTHRECORD）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SUBHEALTHRECORD.md`
