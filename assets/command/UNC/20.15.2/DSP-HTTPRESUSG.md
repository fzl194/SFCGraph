---
id: UNC@20.15.2@MMLCommand@DSP HTTPRESUSG
type: MMLCommand
...
- [HTTP资源使用信息（HTTPRESUSG）](configobject/UNC/20.15.2/HTTPRESUSG.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示HTTP资源使用信息（DSP-HTTPRESUSG）_54343961.md`
