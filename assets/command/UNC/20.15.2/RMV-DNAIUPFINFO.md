---
id: UNC@20.15.2@MMLCommand@RMV DNAIUPFINFO
type: MMLCommand
name: RMV DNAIUPFINFO（删除指定DNAI的UPF节点信息）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DNAIUPFINFO（删除指定DNAI的UPF节点信息）

## 功能

**适用NF：SMF、PGW-C**

该命令用于删除指定DNAI的UPF节点信息。
...
删除指定DNAI的UPF节点信息，DNAI名称为huawei.com，UPF实例标识为upf1。

```
RMV DNAIUPFINFO:DNAI="huawei.com",UPFINSTANCEID="upf1";
```
