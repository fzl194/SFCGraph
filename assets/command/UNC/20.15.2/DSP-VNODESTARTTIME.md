---
id: UNC@20.15.2@MMLCommand@DSP VNODESTARTTIME
type: MMLCommand
...
- [[configobject/UNC/20.15.2/VNODESTARTTIME]] · 虚拟节点启动时间信息（VNODESTARTTIME）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-VNODESTARTTIME.md`
