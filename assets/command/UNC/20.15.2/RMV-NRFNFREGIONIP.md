---
id: UNC@20.15.2@MMLCommand@RMV NRFNFREGIONIP
type: MMLCommand
name: RMV NRFNFREGIONIP（删除IP与NF区域映射关系配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NRFNFREGIONIP（删除IP与NF区域映射关系配置）
...
删除IP类型为IPV4，IPV4值为"10.10.10.10"的IP与NF区域的映射关系。

```
RMV NRFNFREGIONIP: IPTYPE=IPV4, IPV4="10.10.10.10";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-NRFNFREGIONIP.md`
