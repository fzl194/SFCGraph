---
id: UNC@20.15.2@MMLCommand@DSP EXCEPTIONINFO
type: MMLCommand
name: DSP EXCEPTIONINFO（显示RU异常信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: EXCEPTIONINFO
...
- [RU异常信息（EXCEPTIONINFO）](configobject/UNC/20.15.2/EXCEPTIONINFO.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示RU异常信息（DSP-EXCEPTIONINFO）_59104276.md`
