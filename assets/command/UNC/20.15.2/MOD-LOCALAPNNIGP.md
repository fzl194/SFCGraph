---
id: UNC@20.15.2@MMLCommand@MOD LOCALAPNNIGP
type: MMLCommand
name: MOD LOCALAPNNIGP（修改本地APNNI组）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD LOCALAPNNIGP（修改本地APNNI组）

## 功能

**适用网元：SGSN**

该命令用于修改本地APNNI组信息。定制APN纠正功能会引用该配置参数APNNIGRPID，可参考 **[ADD SMACTCTRL](../激活过程管理/增加激活过程控制参数（ADD SMACTCTRL）_26305472.md)** 命令的APNNIGRPID参数说明。
...
修改"本地APNNI组号"为1，"APNNI"为"HUAWEI1.COM"的"APNNI优先级"为1：

MOD LOCALAPNNIGP: APNNIGRPID=1, APNNI="HUAWEI1.COM", PRI=1;

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-LOCALAPNNIGP.md`
