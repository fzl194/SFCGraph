---
id: UNC@20.15.2@MMLCommand@SET IUPFSELFAIL
type: MMLCommand
name: SET IUPFSELFAIL（设置I-UPF选择失败处理方式）
nf: UNC
version: 20.15.2
verb: SET
...
# SET IUPFSELFAIL（设置I-UPF选择失败处理方式）
...
- [[configobject/UNC/20.15.2/IUPFSELFAIL]] · I-UPF选择失败处理方式（IUPFSELFAIL）
...
- 原始手册：`evidence/UNC/20.15.2/SET-IUPFSELFAIL.md`
