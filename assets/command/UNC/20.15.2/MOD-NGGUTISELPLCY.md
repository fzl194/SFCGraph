---
id: UNC@20.15.2@MMLCommand@MOD NGGUTISELPLCY
type: MMLCommand
name: MOD NGGUTISELPLCY（修改AMF区域GUTI选网控制策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NGGUTISELPLCY（修改AMF区域GUTI选网控制策略）

## 功能

**适用NF：AMF**

该命令用于修改AMF区域GUTI选网功能控制策略。
...
- [[UNC@20.15.2@ConfigObject@NGGUTISELPLCY]] · AMF区域GUTI选网控制策略（NGGUTISELPLCY）

## 使用实例

区域“GUTISelZone”下，用户（从属的用户组ID为“1”）的AMF区域GUTI选网功能控制策略，目标AMF集合标识修改为“222”，目标AMF标识符修改为“22”。

```
MOD NGGUTISELPLCY: AREARANGE=AREA_CODE, GUTISELAREACODE="GUTISelZone",  CTRLOBJECT=USER_GROUP, SUBGRPID=1, TGTAMFSETID="222", TGTAMFPOINTER="22";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-NGGUTISELPLCY.md`
