---
id: UNC@20.15.2@MMLCommand@ADD DIAMLOCINFO
type: MMLCommand
name: ADD DIAMLOCINFO（增加Diameter本端信息）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD DIAMLOCINFO（增加Diameter本端信息）
...
- [Diameter本端信息（DIAMLOCINFO）](configobject/UNC/20.15.2/DIAMLOCINFO.md)
