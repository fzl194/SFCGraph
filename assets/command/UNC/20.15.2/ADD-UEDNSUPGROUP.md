---
id: UNC@20.15.2@MMLCommand@ADD UEDNSUPGROUP
type: MMLCommand
name: ADD UEDNSUPGROUP（增加DNS关联的UPF组）
nf: UNC
version: 20.15.2
verb: ADD
...
- [DNS关联的UPF组（UEDNSUPGROUP）](configobject/UNC/20.15.2/UEDNSUPGROUP.md)
