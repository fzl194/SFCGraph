---
id: UNC@20.15.2@MMLCommand@ADD PCSCFIMSISDNSEG
type: MMLCommand
name: ADD PCSCFIMSISDNSEG（增加IMSI和MSISDN号段）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PCSCFIMSISDNSEG（增加IMSI和MSISDN号段）
...
- [[configobject/UNC/20.15.2/PCSCFIMSISDNSEG]] · IMSI和MSISDN号段（PCSCFIMSISDNSEG）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PCSCFIMSISDNSEG.md`
