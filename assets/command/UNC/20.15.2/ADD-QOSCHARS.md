---
id: UNC@20.15.2@MMLCommand@ADD QOSCHARS
type: MMLCommand
name: ADD QOSCHARS（增加QoS特征）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@QOSCHARS]] · QoS特征（QOSCHARS）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-QOSCHARS.md`
