---
id: UNC@20.15.2@MMLCommand@MOD UPBINDGNGP
type: MMLCommand
name: MOD UPBINDGNGP（修改GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD UPBINDGNGP（修改GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-UPBINDGNGP.md`
