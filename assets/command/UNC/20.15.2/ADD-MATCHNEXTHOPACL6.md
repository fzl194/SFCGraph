---
id: UNC@20.15.2@MMLCommand@ADD MATCHNEXTHOPACL6
type: MMLCommand
name: ADD MATCHNEXTHOPACL6（增加匹配IPv6下一跳地址ACL）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD MATCHNEXTHOPACL6（增加匹配IPv6下一跳地址ACL）
...
```
ADD MATCHNEXTHOPACL6:NODESEQUENCE=10,ACLNAMEORNUM="abc", POLICYNAME="a";
```
