---
id: UNC@20.15.2@MMLCommand@RMV DEACTQFPLCY
type: MMLCommand
name: RMV DEACTQFPLCY（删除去活用户面专有QoS Flow策略）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DEACTQFPLCY（删除去活用户面专有QoS Flow策略）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-DEACTQFPLCY.md`
