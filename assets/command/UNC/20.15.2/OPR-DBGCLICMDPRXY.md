---
id: UNC@20.15.2@MMLCommand@OPR DBGCLICMDPRXY
type: MMLCommand
...
- [[configobject/UNC/20.15.2/DBGCLICMDPRXY]] · 通过命令代理执行命令行调试命令（DBGCLICMDPRXY）
...
- 原始手册：`evidence/UNC/20.15.2/OPR-DBGCLICMDPRXY.md`
