---
id: UNC@20.15.2@MMLCommand@ADD DIAMCONNECTION
type: MMLCommand
name: ADD DIAMCONNECTION（增加Diameter链路）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD DIAMCONNECTION（增加Diameter链路）
...
- [[UNC@20.15.2@ConfigObject@DIAMCONNECTION]] · Diameter链路（DIAMCONNECTION）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-DIAMCONNECTION.md`
