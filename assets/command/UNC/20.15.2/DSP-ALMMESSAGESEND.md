---
id: UNC@20.15.2@MMLCommand@DSP ALMMESSAGESEND
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@ALMMESSAGESEND]] · 告警发送的信息（ALMMESSAGESEND）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-ALMMESSAGESEND.md`
