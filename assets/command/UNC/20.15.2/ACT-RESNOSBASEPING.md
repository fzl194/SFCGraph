---
id: UNC@20.15.2@MMLCommand@ACT RESNOSBASEPING
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@RESNOSBASEPING]] · NOS Base平面网络Ping功能（RESNOSBASEPING）
...
- 原始手册：`evidence/UNC/20.15.2/ACT-RESNOSBASEPING.md`
