---
id: UNC@20.15.2@MMLCommand@ADD SELECTCHFGBYCC
type: MMLCommand
name: ADD SELECTCHFGBYCC（增加基于CC选择CHF处理）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD SELECTCHFGBYCC（增加基于CC选择CHF处理）
...
- [[UNC@20.15.2@ConfigObject@SELECTCHFGBYCC]] · 基于CC选择CHF处理（SELECTCHFGBYCC）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SELECTCHFGBYCC.md`
