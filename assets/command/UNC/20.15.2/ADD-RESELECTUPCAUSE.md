---
id: UNC@20.15.2@MMLCommand@ADD RESELECTUPCAUSE
type: MMLCommand
name: ADD RESELECTUPCAUSE（增加重选UPF的故障原因值）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD RESELECTUPCAUSE（增加重选UPF的故障原因值）
...
- [重选UPF故障原因值（RESELECTUPCAUSE）](configobject/UNC/20.15.2/RESELECTUPCAUSE.md)
