---
id: UNC@20.15.2@MMLCommand@DSP CCL
type: MMLCommand
name: DSP CCL（显示原始话单采集和保存速度）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: CCL
...
- [[configobject/UNC/20.15.2/CCL]] · 原始话单采集和保存速度（CCL）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-CCL.md`
