---
id: UNC@20.15.2@MMLCommand@RMV PDPFILTERAPN
type: MMLCommand
name: RMV PDPFILTERAPN（删除APN优先级配置）
nf: UNC
version: 20.15.2
verb: RMV
...
- [APN优先级配置（PDPFILTERAPN）](configobject/UNC/20.15.2/PDPFILTERAPN.md)
