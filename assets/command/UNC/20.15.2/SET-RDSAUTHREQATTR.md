---
id: UNC@20.15.2@MMLCommand@SET RDSAUTHREQATTR
type: MMLCommand
name: SET RDSAUTHREQATTR（设置Radius鉴权请求消息携带的属性）
nf: UNC
version: 20.15.2
verb: SET
...
# SET RDSAUTHREQATTR（设置Radius鉴权请求消息携带的属性）
...
- [Radius鉴权请求消息携带的属性（RDSAUTHREQATTR）](configobject/UNC/20.15.2/RDSAUTHREQATTR.md)
