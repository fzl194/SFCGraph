---
id: UNC@20.15.2@MMLCommand@ADD SECPOLICYALARM
type: MMLCommand
name: ADD SECPOLICYALARM（增加安全策略告警配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [安全策略告警配置（SECPOLICYALARM）](configobject/UNC/20.15.2/SECPOLICYALARM.md)
