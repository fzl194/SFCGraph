---
id: UNC@20.15.2@MMLCommand@SET SMSFUDMBYPASS
type: MMLCommand
name: SET SMSFUDMBYPASS（设置SMSF的UDM全故障Bypass功能开关）
nf: UNC
version: 20.15.2
verb: SET
...
# SET SMSFUDMBYPASS（设置SMSF的UDM全故障Bypass功能开关）
...
- [SMSF的UDM全故障Bypass功能开关（SMSFUDMBYPASS）](configobject/UNC/20.15.2/SMSFUDMBYPASS.md)
