---
id: UNC@20.15.2@MMLCommand@RMV NRFCLIENTADDR
type: MMLCommand
name: RMV NRFCLIENTADDR（删除NRF实例客户端地址信息）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NRFCLIENTADDR（删除NRF实例客户端地址信息）
...
- [[configobject/UNC/20.15.2/NRFCLIENTADDR]] · NRF实例客户端地址信息（NRFCLIENTADDR）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-NRFCLIENTADDR.md`
