---
id: UNC@20.15.2@MMLCommand@SET NRFPKGRATIO
type: MMLCommand
name: SET NRFPKGRATIO（设置NRF内外包长比例）
nf: UNC
version: 20.15.2
verb: SET
...
- [NRF内外包长比例（NRFPKGRATIO）](configobject/UNC/20.15.2/NRFPKGRATIO.md)
