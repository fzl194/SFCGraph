---
id: UNC@20.15.2@MMLCommand@ADD UPBINDGNGP
type: MMLCommand
name: ADD UPBINDGNGP（增加GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD UPBINDGNGP（增加GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-UPBINDGNGP.md`
