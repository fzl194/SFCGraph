---
id: UNC@20.15.2@MMLCommand@ADD RESTRICTSNSSAI
type: MMLCommand
name: ADD RESTRICTSNSSAI（增加受限的S-NSSAI）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD RESTRICTSNSSAI（增加受限的S-NSSAI）
...
- [[UNC@20.15.2@ConfigObject@RESTRICTSNSSAI]] · 受限的S-NSSAI（RESTRICTSNSSAI）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-RESTRICTSNSSAI.md`
