---
id: UNC@20.15.2@MMLCommand@ADD NFUUID
type: MMLCommand
name: ADD NFUUID（增加NF UUID信息）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NFUUID]] · NF UUID信息（NFUUID）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NFUUID.md`
