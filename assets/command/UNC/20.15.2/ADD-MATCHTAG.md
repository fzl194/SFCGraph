---
id: UNC@20.15.2@MMLCommand@ADD MATCHTAG
type: MMLCommand
name: ADD MATCHTAG（增加Tag匹配路由策略）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@MATCHTAG]] · Tag匹配路由策略（MATCHTAG）

## 使用实例

添加路由策略a节点10的匹配条件，匹配路由标签值10：

```
ADD MATCHTAG:NODESEQUENCE=10, TAGVALUE=10,POLICYNAME="a";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/ADD-MATCHTAG.md`
