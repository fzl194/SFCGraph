---
id: UNC@20.15.2@MMLCommand@MOD USNRSVCMD5
type: MMLCommand
name: MOD USNRSVCMD5（修改预埋命令5）
nf: UNC
version: 20.15.2
verb: MOD
...
- [预埋命令5（USNRSVCMD5）](configobject/UNC/20.15.2/USNRSVCMD5.md)

## 使用实例

修改通过命令名称为MOD GLOBALVARIABLE来修改某个全局变量的值的功能，则可以执行以下命令：

MOD USNRSVCMD5: FUNNAME="MOD GLOBALVARIABLE", FUNKEY="TESTKEY", STRPARA1="asddas123", STRPARA2="asdA", STRPARA3="ASDFAS", INTPARA1=1231, INTPARA2=12312, INTPARA3=1231;
