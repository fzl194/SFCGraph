---
id: UNC@20.15.2@MMLCommand@MOD SELECTRULEINFO
type: MMLCommand
name: MOD SELECTRULEINFO（修改UPF选择规则信息）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD SELECTRULEINFO（修改UPF选择规则信息）
...
- 修改高通量业务规则时，其优先级需低于重点业务保障和用户体验规则的优先级。
- 当前版本不支持RULERANGE配置为“ALL”。
- 修改媒体中继业务规则时，其优先级低于高通量业务。
...
修改UPF选择规则信息，规则名称为"rulename1"，规则功能为用户体验：

```
MOD SELECTRULEINFO: RULENAME="rulename1", RULEFUNC=QOSANA-0&QOSEXP-1&QOSCCC-0&RELAY-0;
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-SELECTRULEINFO.md`
