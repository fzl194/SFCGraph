---
id: UNC@20.15.2@MMLCommand@ADD HOMEGROUP
type: MMLCommand
name: ADD HOMEGROUP（增加Home Group）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@HOMEGROUP]] · Home Group（HOMEGROUP）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-HOMEGROUP.md`
