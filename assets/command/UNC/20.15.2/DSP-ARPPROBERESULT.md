---
id: UNC@20.15.2@MMLCommand@DSP ARPPROBERESULT
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@ARPPROBERESULT]] · ARP探测结果（ARPPROBERESULT）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-ARPPROBERESULT.md`
