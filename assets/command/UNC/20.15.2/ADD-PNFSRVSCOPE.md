---
id: UNC@20.15.2@MMLCommand@ADD PNFSRVSCOPE
type: MMLCommand
name: ADD PNFSRVSCOPE（增加对端NF的服务区信息）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PNFSRVSCOPE（增加对端NF的服务区信息）

## 功能

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于增加本地配置的对端NF实例支持的服务区名称。
...
增加对端NF所支持的Serving Scope信息，NF实例标识为SMF_Instance_0，服务区名称为CityA。

```
ADD PNFSRVSCOPE: NFINSTANCEID="SMF_Instance_0", SCOPENAME="CityA";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/ADD-PNFSRVSCOPE.md`
