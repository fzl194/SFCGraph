---
id: UNC@20.15.2@MMLCommand@ADD PNFSERVICEVER
type: MMLCommand
name: ADD PNFSERVICEVER（增加对端NF的服务实例的版本信息）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PNFSERVICEVER（增加对端NF的服务实例的版本信息）
...
- [对端NF的服务实例的版本信息（PNFSERVICEVER）](configobject/UNC/20.15.2/PNFSERVICEVER.md)
