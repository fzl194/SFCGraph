---
id: UNC@20.15.2@MMLCommand@DSP IPINFO
type: MMLCommand
name: DSP IPINFO（显示IP相关信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: IPINFO
...
- [IP相关信息（IPINFO）](configobject/UNC/20.15.2/IPINFO.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示IP相关信息(DSP-IPINFO)_26305680.md`
