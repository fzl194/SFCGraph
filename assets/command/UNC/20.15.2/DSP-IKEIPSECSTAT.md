---
id: UNC@20.15.2@MMLCommand@DSP IKEIPSECSTAT
type: MMLCommand
...
- [[configobject/UNC/20.15.2/IKEIPSECSTAT]] · IKE IPsec统计信息（IKEIPSECSTAT）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-IKEIPSECSTAT.md`
