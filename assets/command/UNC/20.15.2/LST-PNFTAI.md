---
id: UNC@20.15.2@MMLCommand@LST PNFTAI
type: MMLCommand
name: LST PNFTAI（查询对端NF的TAI信息）
nf: UNC
version: 20.15.2
verb: LST
...
- [[configobject/UNC/20.15.2/PNFTAI]] · 对端NF的TAI信息（PNFTAI）
...
- 原始手册：`evidence/UNC/20.15.2/查询对端NF的TAI信息（LST-PNFTAI）_09653612.md`
