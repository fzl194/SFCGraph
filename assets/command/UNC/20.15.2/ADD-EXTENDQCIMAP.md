---
id: UNC@20.15.2@MMLCommand@ADD EXTENDQCIMAP
type: MMLCommand
name: ADD EXTENDQCIMAP（增加扩展QCI和标准QCI的映射关系）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD EXTENDQCIMAP（增加扩展QCI和标准QCI的映射关系）
...
- [[UNC@20.15.2@ConfigObject@EXTENDQCIMAP]] · 扩展QCI和标准QCI的映射关系（EXTENDQCIMAP）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-EXTENDQCIMAP.md`
