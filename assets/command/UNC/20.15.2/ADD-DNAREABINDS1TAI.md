---
id: UNC@20.15.2@MMLCommand@ADD DNAREABINDS1TAI
type: MMLCommand
name: ADD DNAREABINDS1TAI（增加DNAI服务区名称绑定的4G TAI范围）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD DNAREABINDS1TAI（增加DNAI服务区名称绑定的4G TAI范围）
...
- [DNAI服务区名称绑定的4G TAI范围（DNAREABINDS1TAI）](configobject/UNC/20.15.2/DNAREABINDS1TAI.md)
