---
id: UNC@20.15.2@MMLCommand@SET TCPBPCFG
type: MMLCommand
...
![](设置TCP过载反压HTTP流控配置（SET TCPBPCFG）_94795792.assets/notice_3.0-zh-cn_2.png)
...
- [TCP过载反压HTTP流控配置（TCPBPCFG）](configobject/UNC/20.15.2/TCPBPCFG.md)
