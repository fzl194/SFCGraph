---
id: UNC@20.15.2@MMLCommand@MOD APNAMBRCTRL
type: MMLCommand
name: MOD APNAMBRCTRL（修改APN-AMBR控制的配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD APNAMBRCTRL（修改APN-AMBR控制的配置）
...
- [[UNC@20.15.2@ConfigObject@APNAMBRCTRL]] · APN-AMBR控制的配置（APNAMBRCTRL）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-APNAMBRCTRL.md`
