---
id: UNC@20.15.2@MMLCommand@SET BMBYPASSSWITCH
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@BMBYPASSSWITCH]] · 裸机节点自动进入BYPASS开关（BMBYPASSSWITCH）
...
- 原始手册：`evidence/UNC/20.15.2/SET-BMBYPASSSWITCH.md`
