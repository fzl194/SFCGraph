---
id: UNC@20.15.2@MMLCommand@DSP CNTRESSTAT
type: MMLCommand
...
- [容器资源信息（CNTRESSTAT）](configobject/UNC/20.15.2/CNTRESSTAT.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询容器资源信息（DSP-CNTRESSTAT）_60785913.md`
