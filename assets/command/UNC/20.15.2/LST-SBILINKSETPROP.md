---
id: UNC@20.15.2@MMLCommand@LST SBILINKSETPROP
type: MMLCommand
...
- [[configobject/UNC/20.15.2/SBILINKSETPROP]] · SBI链路集策略（SBILINKSETPROP）
...
- 原始手册：`evidence/UNC/20.15.2/LST-SBILINKSETPROP.md`
