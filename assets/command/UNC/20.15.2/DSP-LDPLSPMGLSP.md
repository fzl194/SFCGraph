---
id: UNC@20.15.2@MMLCommand@DSP LDPLSPMGLSP
type: MMLCommand
name: DSP LDPLSPMGLSP（显示LDP的LSP信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: LDPLSPMGLSP
...
- [LDP的LSP信息（LDPLSPMGLSP）](configobject/UNC/20.15.2/LDPLSPMGLSP.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示LDP的LSP信息（DSP-LDPLSPMGLSP）_50281794.md`
