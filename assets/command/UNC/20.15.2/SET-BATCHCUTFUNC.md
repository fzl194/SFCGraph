---
id: UNC@20.15.2@MMLCommand@SET BATCHCUTFUNC
type: MMLCommand
name: SET BATCHCUTFUNC（设置分批割接功能）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@BATCHCUTFUNC]] · 分批割接功能（BATCHCUTFUNC）
...
- 原始手册：`evidence/UNC/20.15.2/SET-BATCHCUTFUNC.md`
