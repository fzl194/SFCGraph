---
id: UNC@20.15.2@MMLCommand@DSP LBPLUGIN
type: MMLCommand
...
- [CSLB的插件信息（LBPLUGIN）](configobject/UNC/20.15.2/LBPLUGIN.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询CSLB的插件信息（DSP-LBPLUGIN）_29627105.md`
