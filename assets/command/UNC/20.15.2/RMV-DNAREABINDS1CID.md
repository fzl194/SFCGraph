---
id: UNC@20.15.2@MMLCommand@RMV DNAREABINDS1CID
type: MMLCommand
name: RMV DNAREABINDS1CID（删除DNAI服务区名称绑定的4G Cell ID范围）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DNAREABINDS1CID（删除DNAI服务区名称绑定的4G Cell ID范围）

## 功能

**适用NF：SGW-C、PGW-C、SMF、GGSN**

该命令用于删除DNAI服务区名称绑定的4G Cell ID范围。
...
删除UPF服务区名称为“DNAREA1”的CID绑定范围460010001234~460010005678。

```
RMV DNAREABINDS1CID: AREANAME="DNAREA1", EPCBEGINCID="460010001234", EPCENDCID="460010005678";
```
