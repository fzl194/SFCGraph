---
id: UNC@20.15.2@MMLCommand@DSP UPGPODINFO
type: MMLCommand
...
- [已部署的Pod的版本号（UPGPODINFO）](configobject/UNC/20.15.2/UPGPODINFO.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示已部署的Pod的版本号（DSP-UPGPODINFO）_34181851.md`
