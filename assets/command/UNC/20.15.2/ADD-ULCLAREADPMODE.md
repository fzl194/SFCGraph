---
id: UNC@20.15.2@MMLCommand@ADD ULCLAREADPMODE
type: MMLCommand
name: ADD ULCLAREADPMODE（增加指定DNAI服务区域的ULCL部署模式）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD ULCLAREADPMODE（增加指定DNAI服务区域的ULCL部署模式）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ULCLAREADPMODE.md`
