---
id: UNC@20.15.2@MMLCommand@ADD APNCHGMODE
type: MMLCommand
name: ADD APNCHGMODE（增加基于APN的计费接口选择方式）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNCHGMODE（增加基于APN的计费接口选择方式）
...
- [[configobject/UNC/20.15.2/APNCHGMODE]] · 基于APN的计费接口选择方式（APNCHGMODE）

## 关联任务

- [[UNC@20.15.2@Task@0-00005]]
