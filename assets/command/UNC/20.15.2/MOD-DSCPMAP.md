---
id: UNC@20.15.2@MMLCommand@MOD DSCPMAP
type: MMLCommand
name: MOD DSCPMAP（修改DSCP值到VLAN优先级的映射）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD DSCPMAP（修改DSCP值到VLAN优先级的映射）
...
- [DSCP值到VLAN优先级的映射（DSCPMAP）](configobject/UNC/20.15.2/DSCPMAP.md)
