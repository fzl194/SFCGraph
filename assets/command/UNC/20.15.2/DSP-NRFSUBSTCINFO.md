---
id: UNC@20.15.2@MMLCommand@DSP NRFSUBSTCINFO
type: MMLCommand
name: DSP NRFSUBSTCINFO（显示NF订阅统计信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: NRFSUBSTCINFO
...
- [[configobject/UNC/20.15.2/NRFSUBSTCINFO]] · NF订阅统计信息（NRFSUBSTCINFO）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-NRFSUBSTCINFO.md`
