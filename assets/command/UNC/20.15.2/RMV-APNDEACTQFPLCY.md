---
id: UNC@20.15.2@MMLCommand@RMV APNDEACTQFPLCY
type: MMLCommand
name: RMV APNDEACTQFPLCY（删除基于APN去活用户面专有QoS Flow策略）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV APNDEACTQFPLCY（删除基于APN去活用户面专有QoS Flow策略）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-APNDEACTQFPLCY.md`
