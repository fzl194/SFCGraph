---
id: UNC@20.15.2@MMLCommand@DSP XSMINNERDATA
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@XSMINNERDATA]] · XSM模块与其他模块的组件间交互消息（XSMINNERDATA）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-XSMINNERDATA.md`
