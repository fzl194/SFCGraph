---
id: UNC@20.15.2@MMLCommand@RST VNODE
type: MMLCommand
...
![](重启虚拟节点（RST VNODE）_59037037.assets/notice_3.0-zh-cn_2.png)

本命令为高危命令，会重启资源，可能有业务中断风险，请谨慎使用并联系华为技术支持协助操作。
...
- [虚拟节点信息（VNODE）](configobject/UNC/20.15.2/VNODE.md)
...
- 原始手册：`evidence/UNC/20.15.2/重启虚拟节点（RST-VNODE）_59037037.md`
