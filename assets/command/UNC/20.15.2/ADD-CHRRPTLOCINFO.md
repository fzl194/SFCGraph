---
id: UNC@20.15.2@MMLCommand@ADD CHRRPTLOCINFO
type: MMLCommand
name: ADD CHRRPTLOCINFO（增加CHR本地存盘位置配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD CHRRPTLOCINFO（增加CHR本地存盘位置配置）
...
- [CHR本地存盘位置配置（CHRRPTLOCINFO）](configobject/UNC/20.15.2/CHRRPTLOCINFO.md)
