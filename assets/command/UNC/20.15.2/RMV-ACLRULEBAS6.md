---
id: UNC@20.15.2@MMLCommand@RMV ACLRULEBAS6
type: MMLCommand
name: RMV ACLRULEBAS6（删除基本IPv6 ACL规则）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV ACLRULEBAS6（删除基本IPv6 ACL规则）
...
删除基本ACL6规则组2000下的规则名称为"rule_5"的规则：

```
RMV ACLRULEBAS6:ACLNAME="2000",ACLRULENAME="rule_5";
```
