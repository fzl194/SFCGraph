---
id: UNC@20.15.2@MMLCommand@MOD IPV6IFICMPSECURITY
type: MMLCommand
name: MOD IPV6IFICMPSECURITY（修改接口下安全配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD IPV6IFICMPSECURITY（修改接口下安全配置）
...
- [接口下安全配置（IPV6IFICMPSECURITY）](configobject/UNC/20.15.2/IPV6IFICMPSECURITY.md)
