---
id: UNC@20.15.2@MMLCommand@DSP IPBLACKBOX
type: MMLCommand
...
- [PP4黑匣子信息（IPBLACKBOX）](configobject/UNC/20.15.2/IPBLACKBOX.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询PP4黑匣子信息（DSP-IPBLACKBOX）_00600877.md`
