---
id: UNC@20.15.2@MMLCommand@DSP SDRPLYSUBSTATUS
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@SDRPLYSUBSTATUS]] · SDRC中保存的策略订阅关系（SDRPLYSUBSTATUS）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SDRPLYSUBSTATUS.md`
