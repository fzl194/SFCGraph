---
id: UNC@20.15.2@MMLCommand@RMV APNCHRFUNC
type: MMLCommand
name: RMV APNCHRFUNC（删除APN CHR功能配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV APNCHRFUNC（删除APN CHR功能配置）

## 功能

**适用NF：GGSN、SGW-C、PGW-C、SMF**

该命令用于删除基于APN的CHR功能配置。
...
删除“APN”为“HUAWEI.COM”的CHR功能配置：

```
RMV APNCHRFUNC: APN="HUAWEI.COM"
```
