---
id: UNC@20.15.2@MMLCommand@RMV PGWRNSI
type: MMLCommand
name: RMV PGWRNSI（删除PGW重定向配置）
nf: UNC
version: 20.15.2
verb: RMV
...
- [PGW重定向配置（PGWRNSI）](configobject/UNC/20.15.2/PGWRNSI.md)

## 使用实例

删除SUBRANGE为ALL_USER，APNNI为HUAWEI.COM的PGW重定向配置记录：

```
RMV PGWRNSI: SUBRANGE=ALL_USER, APNNI="HUAWEI.COM";
```
