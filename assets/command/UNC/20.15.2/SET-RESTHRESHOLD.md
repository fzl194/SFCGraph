---
id: UNC@20.15.2@MMLCommand@SET RESTHRESHOLD
type: MMLCommand
name: SET RESTHRESHOLD（设置资源过载和过载恢复阈值）
nf: UNC
version: 20.15.2
verb: SET
...
# SET RESTHRESHOLD（设置资源过载和过载恢复阈值）
...
- [资源过载和过载恢复阈值（RESTHRESHOLD）](configobject/UNC/20.15.2/RESTHRESHOLD.md)
