---
id: UNC@20.15.2@MMLCommand@RMV NRFNFTYPERT
type: MMLCommand
name: RMV NRFNFTYPERT（删除NF类型路由）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@NRFNFTYPERT]] · NF类型路由（NRFNFTYPERT）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-NRFNFTYPERT.md`
