---
id: UNC@20.15.2@MMLCommand@ADD HOMEIP
type: MMLCommand
name: ADD HOMEIP（增加Home IP地址）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@HOMEIP]] · Home IP地址（HOMEIP）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-HOMEIP.md`
