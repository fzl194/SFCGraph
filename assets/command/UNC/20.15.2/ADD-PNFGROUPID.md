---
id: UNC@20.15.2@MMLCommand@ADD PNFGROUPID
type: MMLCommand
name: ADD PNFGROUPID（增加对端NF的群组信息）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/PNFGROUPID]] · 对端NF的群组信息（PNFGROUPID）

## 使用实例

对端NF实例标识为UDM_Instance_0，规划该NF支持的群组标识为GROUP01。

```
ADD PNFGROUPID: NFINSTANCEID="UDM_Instance_0", GROUPID="GROUP01";
```
