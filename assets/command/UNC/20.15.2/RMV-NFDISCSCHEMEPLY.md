---
id: UNC@20.15.2@MMLCommand@RMV NFDISCSCHEMEPLY
type: MMLCommand
name: RMV NFDISCSCHEMEPLY（删除服务发现Scheme优选策略）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NFDISCSCHEMEPLY（删除服务发现Scheme优选策略）
...
- [[configobject/UNC/20.15.2/NFDISCSCHEMEPLY]] · 服务发现Scheme优选策略（NFDISCSCHEMEPLY）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-NFDISCSCHEMEPLY.md`
