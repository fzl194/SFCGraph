---
id: UNC@20.15.2@MMLCommand@MOD OSPFV3AREAFILTER
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@OSPFV3AREAFILTER]] · OSPFv3区域过滤LSA配置（OSPFV3AREAFILTER）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-OSPFV3AREAFILTER.md`
