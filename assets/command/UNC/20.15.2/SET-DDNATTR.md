---
id: UNC@20.15.2@MMLCommand@SET DDNATTR
type: MMLCommand
name: SET DDNATTR（设置DDN消息参数以及Delay信元处理开关）
nf: UNC
version: 20.15.2
verb: SET
...
# SET DDNATTR（设置DDN消息参数以及Delay信元处理开关）
...
- [DDN消息参数以及Delay信元处理开关（DDNATTR）](configobject/UNC/20.15.2/DDNATTR.md)
