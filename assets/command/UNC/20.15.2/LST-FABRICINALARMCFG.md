---
id: UNC@20.15.2@MMLCommand@LST FABRICINALARMCFG
type: MMLCommand
...
- [[configobject/UNC/20.15.2/FABRICINALARMCFG]] · PAE告警配置（FABRICINALARMCFG）
...
- 原始手册：`evidence/UNC/20.15.2/LST-FABRICINALARMCFG.md`
