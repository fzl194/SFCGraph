---
id: UNC@20.15.2@MMLCommand@ADD IPV6PREFIXFILTERNODE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@IPV6PREFIXFILTERNODE]] · IPv6前缀过滤器节点（IPV6PREFIXFILTERNODE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-IPV6PREFIXFILTERNODE.md`
