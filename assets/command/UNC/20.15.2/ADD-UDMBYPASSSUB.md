---
id: UNC@20.15.2@MMLCommand@ADD UDMBYPASSSUB
type: MMLCommand
name: ADD UDMBYPASSSUB（增加UDM Bypass最小签约数据配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD UDMBYPASSSUB（增加UDM Bypass最小签约数据配置）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-UDMBYPASSSUB.md`
