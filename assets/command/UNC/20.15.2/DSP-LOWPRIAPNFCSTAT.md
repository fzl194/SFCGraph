---
id: UNC@20.15.2@MMLCommand@DSP LOWPRIAPNFCSTAT
type: MMLCommand
name: DSP LOWPRIAPNFCSTAT（显示低优先级APN流控状态统计）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: LOWPRIAPNFCSTAT
...
# DSP LOWPRIAPNFCSTAT（显示低优先级APN流控状态统计）
...
- [[UNC@20.15.2@ConfigObject@LOWPRIAPNFCSTAT]] · 低优先级APN流控状态统计（LOWPRIAPNFCSTAT）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-LOWPRIAPNFCSTAT.md`
