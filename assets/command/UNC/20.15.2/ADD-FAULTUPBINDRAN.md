---
id: UNC@20.15.2@MMLCommand@ADD FAULTUPBINDRAN
type: MMLCommand
name: ADD FAULTUPBINDRAN（增加N3接口故障网元组绑定）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD FAULTUPBINDRAN（增加N3接口故障网元组绑定）
...
- [N3接口故障网元组绑定（FAULTUPBINDRAN）](configobject/UNC/20.15.2/FAULTUPBINDRAN.md)

## 使用实例

添加故障RAN组“group1”与故障UPF组"group2"的N3接口故障网元组绑定：

```
ADD FAULTUPBINDRAN: RANGRPNAME="group1", UPFGRPNAME="group2";
```
