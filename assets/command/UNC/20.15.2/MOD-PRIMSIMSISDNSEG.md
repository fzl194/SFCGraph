---
id: UNC@20.15.2@MMLCommand@MOD PRIMSIMSISDNSEG
type: MMLCommand
name: MOD PRIMSIMSISDNSEG（修改代理IMSI/MSISDN号段）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD PRIMSIMSISDNSEG（修改代理IMSI/MSISDN号段）
...
- [[UNC@20.15.2@ConfigObject@PRIMSIMSISDNSEG]] · 代理IMSI/MSISDN号段（PRIMSIMSISDNSEG）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-PRIMSIMSISDNSEG.md`
