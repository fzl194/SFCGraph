---
id: UNC@20.15.2@MMLCommand@ACT NOSBASEPING
type: MMLCommand
...
- [[configobject/UNC/20.15.2/NOSBASEPING]] · NOS Base平面网络Ping功能（NOSBASEPING）
...
- 原始手册：`evidence/UNC/20.15.2/ACT-NOSBASEPING.md`
