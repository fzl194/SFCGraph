---
id: UNC@20.15.2@MMLCommand@ADD UEOVERLDCTRL
type: MMLCommand
name: ADD UEOVERLDCTRL（增加UE重载控制策略）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/UEOVERLDCTRL]] · UE重载控制策略（UEOVERLDCTRL）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-UEOVERLDCTRL.md`
