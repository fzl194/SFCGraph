---
id: UNC@20.15.2@MMLCommand@SET APNRADIUSATTR
type: MMLCommand
name: SET APNRADIUSATTR（设置APN RADIUS配置）
nf: UNC
version: 20.15.2
verb: SET
...
# SET APNRADIUSATTR（设置APN RADIUS配置）
...
- [[UNC@20.15.2@ConfigObject@APNRADIUSATTR]] · APN RADIUS配置（APNRADIUSATTR）
...
- 原始手册：`evidence/UNC/20.15.2/SET-APNRADIUSATTR.md`
