---
id: UNC@20.15.2@MMLCommand@ADD IPBINDVPNIPSEC
type: MMLCommand
name: ADD IPBINDVPNIPSEC（增加接口绑定VPN）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/IPBINDVPNIPSEC]] · 接口绑定VPN（IPBINDVPNIPSEC）
