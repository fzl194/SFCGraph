---
id: UNC@20.15.2@MMLCommand@RMV MDTPLMN
type: MMLCommand
name: RMV MDTPLMN（删除基于管理的最小化路测的PLMN）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@MDTPLMN]] · 基于管理的最小化路测的PLMN（MDTPLMN）
