---
id: UNC@20.15.2@MMLCommand@SET APNATSSSFUNC
type: MMLCommand
name: SET APNATSSSFUNC（设置APN ATSSS功能）
nf: UNC
version: 20.15.2
verb: SET
...
# SET APNATSSSFUNC（设置APN ATSSS功能）
...
- [[configobject/UNC/20.15.2/APNATSSSFUNC]] · APN ATSSS功能（APNATSSSFUNC）
...
- 原始手册：`evidence/UNC/20.15.2/SET-APNATSSSFUNC.md`
