---
id: UNC@20.15.2@MMLCommand@SET PMM
type: MMLCommand
name: SET PMM（设置Iu模式MM协议参数）
nf: UNC
version: 20.15.2
verb: SET
object_keyword: PMM
...
- [[UNC@20.15.2@ConfigObject@PMM]] · Iu模式MM协议参数（PMM）
...
- 原始手册：`evidence/UNC/20.15.2/SET-PMM.md`
