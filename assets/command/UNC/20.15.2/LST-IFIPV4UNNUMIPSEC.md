---
id: UNC@20.15.2@MMLCommand@LST IFIPV4UNNUMIPSEC
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@IFIPV4UNNUMIPSEC]] · 接口IPv4借用地址（IFIPV4UNNUMIPSEC）
...
- 原始手册：`evidence/UNC/20.15.2/LST-IFIPV4UNNUMIPSEC.md`
