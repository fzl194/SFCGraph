---
id: UNC@20.15.2@MMLCommand@ADD ALLOWEDNFTYPES
type: MMLCommand
name: ADD ALLOWEDNFTYPES（增加允许访问的NF类型）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD ALLOWEDNFTYPES（增加允许访问的NF类型）
...
- [[UNC@20.15.2@ConfigObject@ALLOWEDNFTYPES]] · 允许访问的NF类型（ALLOWEDNFTYPES）
