---
id: UNC@20.15.2@MMLCommand@SET PDPFILTERCTL
type: MMLCommand
name: SET PDPFILTERCTL（设置PDP过滤功能参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@PDPFILTERCTL]] · PDP过滤功能参数（PDPFILTERCTL）
...
- 原始手册：`evidence/UNC/20.15.2/SET-PDPFILTERCTL.md`
