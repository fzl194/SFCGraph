---
id: UNC@20.15.2@MMLCommand@SET RABPARA
type: MMLCommand
name: SET RABPARA（设置RAB参数协商配置）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@RABPARA]] · RAB参数协商配置（RABPARA）
...
- 原始手册：`evidence/UNC/20.15.2/SET-RABPARA.md`
