---
id: UNC@20.15.2@MMLCommand@SET OFFLOADINF
type: MMLCommand
name: SET OFFLOADINF（设置迁移配置表）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@OFFLOADINF]] · 迁移配置信息（OFFLOADINF）
...
- 原始手册：`evidence/UNC/20.15.2/SET-OFFLOADINF.md`
