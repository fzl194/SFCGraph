---
id: UNC@20.15.2@MMLCommand@RMV NGIPV6DNSH
type: MMLCommand
name: RMV NGIPV6DNSH（删除IPv6 DNS Hostfile记录）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NGIPV6DNSH（删除IPv6 DNS Hostfile记录）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-NGIPV6DNSH.md`
