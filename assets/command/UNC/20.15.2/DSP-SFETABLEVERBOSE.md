---
id: UNC@20.15.2@MMLCommand@DSP SFETABLEVERBOSE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@SFETABLEVERBOSE]] · 按摘要和详情两种方式显示SFE表项信息（SFETABLEVERBOSE）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SFETABLEVERBOSE.md`
