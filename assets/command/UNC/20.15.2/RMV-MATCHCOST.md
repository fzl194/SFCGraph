---
id: UNC@20.15.2@MMLCommand@RMV MATCHCOST
type: MMLCommand
name: RMV MATCHCOST（删除Cost匹配路由策略）
nf: UNC
version: 20.15.2
verb: RMV
...
取消路由策略a节点10的匹配条件，取消匹配路由开销：

```
RMV MATCHCOST:NODESEQUENCE=10,COSTVALUE=10,POLICYNAME="a";
```
