---
id: UNC@20.15.2@MMLCommand@MOD RUCONVERGENCE
type: MMLCommand
name: MOD RUCONVERGENCE（修改汇聚RU信息）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[UNC@20.15.2@ConfigObject@RUCONVERGENCE]] · 汇聚RU信息（RUCONVERGENCE）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-RUCONVERGENCE.md`
