---
id: UNC@20.15.2@MMLCommand@DSP PIMINVPKTCNTIF
type: MMLCommand
name: DSP PIMINVPKTCNTIF（查询PIM接口无效报文统计）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: PIMINVPKTCNTIF
...
# DSP PIMINVPKTCNTIF（查询PIM接口无效报文统计）
...
- [[configobject/UNC/20.15.2/PIMINVPKTCNTIF]] · PIM接口无效报文统计（PIMINVPKTCNTIF）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-PIMINVPKTCNTIF.md`
