---
id: UNC@20.15.2@MMLCommand@MOD UPBINDS11
type: MMLCommand
name: MOD UPBINDS11（修改SGW-U与SGW-C侧S11接口的绑定关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD UPBINDS11（修改SGW-U与SGW-C侧S11接口的绑定关系）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-UPBINDS11.md`
