---
id: UNC@20.15.2@MMLCommand@MOD GTPCLEGRPMEM
type: MMLCommand
name: MOD GTPCLEGRPMEM（修改GTP-C本地实体组成员）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD GTPCLEGRPMEM（修改GTP-C本地实体组成员）
...
- [[UNC@20.15.2@ConfigObject@GTPCLEGRPMEM]] · GTP-C本地实体组成员（GTPCLEGRPMEM）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-GTPCLEGRPMEM.md`
