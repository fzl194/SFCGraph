---
id: UNC@20.15.2@MMLCommand@DSP DEVNETCONFREQ
type: MMLCommand
...
- [[configobject/UNC/20.15.2/DEVNETCONFREQ]] · NETCONF请求信息（DEVNETCONFREQ）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-DEVNETCONFREQ.md`
