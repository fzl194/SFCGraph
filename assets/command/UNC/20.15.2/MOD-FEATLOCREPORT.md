---
id: UNC@20.15.2@MMLCommand@MOD FEATLOCREPORT
type: MMLCommand
name: MOD FEATLOCREPORT（修改基于特性的位置上报配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD FEATLOCREPORT（修改基于特性的位置上报配置）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-FEATLOCREPORT.md`
