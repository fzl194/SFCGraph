---
id: UNC@20.15.2@MMLCommand@ADD ALLOWEDNSSAIS
type: MMLCommand
name: ADD ALLOWEDNSSAIS（增加允许访问的切片）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@ALLOWEDNSSAIS]] · 允许访问的切片（ALLOWEDNSSAIS）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ALLOWEDNSSAIS.md`
