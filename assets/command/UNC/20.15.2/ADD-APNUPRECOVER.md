---
id: UNC@20.15.2@MMLCommand@ADD APNUPRECOVER
type: MMLCommand
name: ADD APNUPRECOVER（增加指定UPF的APN级别链路故障恢复处理）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNUPRECOVER（增加指定UPF的APN级别链路故障恢复处理）
...
- [指定UPF的APN级别链路故障恢复处理（APNUPRECOVER）](configobject/UNC/20.15.2/APNUPRECOVER.md)
