---
id: UNC@20.15.2@MMLCommand@RMV AUTOSCALINGBGPMSPEER
type: MMLCommand
...
- [[configobject/UNC/20.15.2/AUTOSCALINGBGPMSPEER]] · BGP自动化多源邻居配置模板（AUTOSCALINGBGPMSPEER）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-AUTOSCALINGBGPMSPEER.md`
