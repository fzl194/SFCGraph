---
id: UNC@20.15.2@MMLCommand@RMV DHCPBINDPOOLGRP
type: MMLCommand
name: RMV DHCPBINDPOOLGRP（删除DHCP服务器组与地址池组绑定关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DHCPBINDPOOLGRP（删除DHCP服务器组与地址池组绑定关系）
...
- [DHCP服务器组与地址池组绑定关系（DHCPBINDPOOLGRP）](configobject/UNC/20.15.2/DHCPBINDPOOLGRP.md)
