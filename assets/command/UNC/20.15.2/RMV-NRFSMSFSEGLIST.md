---
id: UNC@20.15.2@MMLCommand@RMV NRFSMSFSEGLIST
type: MMLCommand
name: RMV NRFSMSFSEGLIST（删除SMSF号段白名单）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NRFSMSFSEGLIST（删除SMSF号段白名单）
...
- [SMSF号段白名单（NRFSMSFSEGLIST）](configobject/UNC/20.15.2/NRFSMSFSEGLIST.md)
