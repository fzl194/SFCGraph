---
id: UNC@20.15.2@MMLCommand@ADD SGSNDNS
type: MMLCommand
name: ADD SGSNDNS（增加SGSN DNS域名策略）
nf: UNC
version: 20.15.2
verb: ADD
...
- [SGSN DNS域名策略（SGSNDNS）](configobject/UNC/20.15.2/SGSNDNS.md)
