---
id: UNC@20.15.2@MMLCommand@DSP OSPFCUMULATIVE
type: MMLCommand
...
- [OSPF统计信息（OSPFCUMULATIVE）](configobject/UNC/20.15.2/OSPFCUMULATIVE.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询OSPF统计信息（DSP-OSPFCUMULATIVE）_49960926.md`
