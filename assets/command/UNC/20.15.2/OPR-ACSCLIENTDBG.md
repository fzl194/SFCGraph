---
id: UNC@20.15.2@MMLCommand@OPR ACSCLIENTDBG
type: MMLCommand
...
- [ACS客户端调试操作（ACSCLIENTDBG）](configobject/UNC/20.15.2/ACSCLIENTDBG.md)
...
- 原始手册：`evidence/UNC/20.15.2/ACS客户端调试操作(OPR-ACSCLIENTDBG)_13590372.md`
