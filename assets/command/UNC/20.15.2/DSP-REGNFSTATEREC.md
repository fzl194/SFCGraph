---
id: UNC@20.15.2@MMLCommand@DSP REGNFSTATEREC
type: MMLCommand
name: DSP REGNFSTATEREC（显示NF的状态变更记录）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: REGNFSTATEREC
...
- [NF的状态变更记录（REGNFSTATEREC）](configobject/UNC/20.15.2/REGNFSTATEREC.md)
