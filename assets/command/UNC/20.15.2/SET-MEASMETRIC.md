---
id: UNC@20.15.2@MMLCommand@SET MEASMETRIC
type: MMLCommand
...
![](设置话统测量指标参数(SET MEASMETRIC)_46417865.assets/notice_3.0-zh-cn_2.png)
...
- [话统测量指标参数（MEASMETRIC）](configobject/UNC/20.15.2/MEASMETRIC.md)
