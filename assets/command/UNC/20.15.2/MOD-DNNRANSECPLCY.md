---
id: UNC@20.15.2@MMLCommand@MOD DNNRANSECPLCY
type: MMLCommand
name: MOD DNNRANSECPLCY（修改DNN RAN侧安全策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD DNNRANSECPLCY（修改DNN RAN侧安全策略）
...
- [[UNC@20.15.2@ConfigObject@DNNRANSECPLCY]] · DNN RAN侧安全策略（DNNRANSECPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-DNNRANSECPLCY.md`
