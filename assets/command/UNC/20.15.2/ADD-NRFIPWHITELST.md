---
id: UNC@20.15.2@MMLCommand@ADD NRFIPWHITELST
type: MMLCommand
name: ADD NRFIPWHITELST（增加NF IP白名单）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NRFIPWHITELST]] · NF IP白名单（NRFIPWHITELST）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NRFIPWHITELST.md`
