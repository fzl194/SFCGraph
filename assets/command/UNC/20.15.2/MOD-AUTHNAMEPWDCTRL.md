---
id: UNC@20.15.2@MMLCommand@MOD AUTHNAMEPWDCTRL
type: MMLCommand
name: MOD AUTHNAMEPWDCTRL（修改对鉴权信元用户名和密码的控制）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD AUTHNAMEPWDCTRL（修改对鉴权信元用户名和密码的控制）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-AUTHNAMEPWDCTRL.md`
