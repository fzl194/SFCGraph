---
id: UNC@20.15.2@MMLCommand@ADD HOMEPGWIP
type: MMLCommand
name: ADD HOMEPGWIP（增加归属地PGW-C IP地址）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@HOMEPGWIP]] · 归属地PGW-C IP地址（HOMEPGWIP）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-HOMEPGWIP.md`
