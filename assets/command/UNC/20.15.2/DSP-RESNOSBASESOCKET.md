---
id: UNC@20.15.2@MMLCommand@DSP RESNOSBASESOCKET
type: MMLCommand
...
- [NOS Base平面网络的Socket信息（RESNOSBASESOCKET）](configobject/UNC/20.15.2/RESNOSBASESOCKET.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询NOS-Base平面网络的Socket信息（DSP-RESNOSBASESOCKET）_57592517.md`
