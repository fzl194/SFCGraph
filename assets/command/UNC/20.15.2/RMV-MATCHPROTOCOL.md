---
id: UNC@20.15.2@MMLCommand@RMV MATCHPROTOCOL
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@MATCHPROTOCOL]] · 路由协议匹配路由策略（MATCHPROTOCOL）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-MATCHPROTOCOL.md`
