---
id: UNC@20.15.2@MMLCommand@MOD APNGWPROXYFUNC
type: MMLCommand
name: MOD APNGWPROXYFUNC（修改APN网关Proxy功能配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD APNGWPROXYFUNC（修改APN网关Proxy功能配置）

## 功能

**适用NF：PGW-C、GGSN**

该命令用于修改基于APN的网关Proxy功能配置。
...
| PROXYSW | Proxy功能开关 | 可选必选说明：可选参数<br>参数含义：该参数用于基于APN控制是否打开网关Proxy功能。<br>数据来源：本端规划<br>取值范围：<br>- DISABLE（不使能）<br>- ENABLE（使能）<br>默认值：无<br>配置原则：无 |
...
- [[configobject/UNC/20.15.2/APNGWPROXYFUNC]] · APN网关Proxy功能配置（APNGWPROXYFUNC）

## 使用实例

修改“APN”为“huawei.com”的APN网关Proxy功能配置的“Proxy功能开关”为“不使能”：

```
MOD APNGWPROXYFUNC: APN="huawei.com", PROXYSW=DISABLE;
```
