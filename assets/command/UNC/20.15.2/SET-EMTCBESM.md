---
id: UNC@20.15.2@MMLCommand@SET EMTCBESM
type: MMLCommand
name: SET EMTCBESM（设置S1模式eMTC SM协议参数）
nf: UNC
version: 20.15.2
verb: SET
...
# SET EMTCBESM（设置S1模式eMTC SM协议参数）
...
- [S1模式eMTC SM协议参数（EMTCBESM）](configobject/UNC/20.15.2/EMTCBESM.md)
