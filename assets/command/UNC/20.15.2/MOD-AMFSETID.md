---
id: UNC@20.15.2@MMLCommand@MOD AMFSETID
type: MMLCommand
name: MOD AMFSETID（修改AMF集与切片的关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD AMFSETID（修改AMF集与切片的关系）

## 功能

**适用NF：NSSF**

该命令用于修改指定AMF集所支持的S-NSSAI。
...
假如运营商希望将已有的INDEX为1的记录，修改为SST为1、SD为"010101"、MCC为"460"、MNC为"03"、REGIONID为"01"、AMFSETID为"001"、TACGROUPNAME为"TACGROUP01"，TAIMCC为"460"、TAIMNC为"03"，执行下列命令。

```
MOD AMFSETID: INDEX=1, SST=1, SD="010101", MCC="460", MNC="03", REGIONID="01", AMFSETID="001", TACGROUPNAME="TACGROUP01", TAIMCC="460", TAIMNC="03";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-AMFSETID.md`
