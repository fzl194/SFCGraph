---
id: UNC@20.15.2@MMLCommand@ADD APNUPFINFO
type: MMLCommand
name: ADD APNUPFINFO（增加指定APN的UPF节点信息）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNUPFINFO（增加指定APN的UPF节点信息）
...
- [[configobject/UNC/20.15.2/APNUPFINFO]] · 指定APN的UPF节点信息（APNUPFINFO）
