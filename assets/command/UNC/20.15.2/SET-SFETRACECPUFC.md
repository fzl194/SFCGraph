---
id: UNC@20.15.2@MMLCommand@SET SFETRACECPUFC
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@SFETRACECPUFC]] · VNRS IP消息跟踪的CPU流控阈值（SFETRACECPUFC）
...
- 原始手册：`evidence/UNC/20.15.2/SET-SFETRACECPUFC.md`
