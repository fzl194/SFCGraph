---
id: UNC@20.15.2@MMLCommand@DSP CACHE
type: MMLCommand
name: DSP CACHE（显示缓冲区话单数量）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: CACHE
...
- [[UNC@20.15.2@ConfigObject@CACHE]] · 缓冲区话单数量（CACHE）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-CACHE.md`
