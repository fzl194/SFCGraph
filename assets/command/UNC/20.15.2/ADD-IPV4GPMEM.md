---
id: UNC@20.15.2@MMLCommand@ADD IPV4GPMEM
type: MMLCommand
name: ADD IPV4GPMEM（增加IPv4群组成员）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@IPV4GPMEM]] · IPv4群组成员（IPV4GPMEM）

## 使用实例

增加IPv4群组成员，IP群组标识为1，IP地址为172.22.5.50，IPV4地址掩码为 255.255.255.0 ：

ADD IPV4GPMEM: IPGPID=1, IPV4="172.22.5.50", IPV4MSK="255.255.255.0";
