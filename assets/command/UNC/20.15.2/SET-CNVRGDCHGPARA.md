---
id: UNC@20.15.2@MMLCommand@SET CNVRGDCHGPARA
type: MMLCommand
name: SET CNVRGDCHGPARA（设置融合计费全局参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@CNVRGDCHGPARA]] · 融合计费全局参数（CNVRGDCHGPARA）
...
- 原始手册：`evidence/UNC/20.15.2/SET-CNVRGDCHGPARA.md`
