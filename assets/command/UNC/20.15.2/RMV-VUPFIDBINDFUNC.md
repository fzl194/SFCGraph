---
id: UNC@20.15.2@MMLCommand@RMV VUPFIDBINDFUNC
type: MMLCommand
name: RMV VUPFIDBINDFUNC（删除虚拟UPF实例标识的绑定功能）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV VUPFIDBINDFUNC（删除虚拟UPF实例标识的绑定功能）
...
- [[UNC@20.15.2@ConfigObject@VUPFIDBINDFUNC]] · 虚拟UPF实例标识的绑定功能（VUPFIDBINDFUNC）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-VUPFIDBINDFUNC.md`
