---
id: UNC@20.15.2@MMLCommand@DSP MSSSCHTHRDLOAD
type: MMLCommand
...
- [[configobject/UNC/20.15.2/MSSSCHTHRDLOAD]] · 调度线程负载信息（MSSSCHTHRDLOAD）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-MSSSCHTHRDLOAD.md`
