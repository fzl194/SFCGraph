---
id: UNC@20.15.2@MMLCommand@MOD PERFRPTRANGE
type: MMLCommand
name: MOD PERFRPTRANGE（修改性能指标上报范围）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[UNC@20.15.2@ConfigObject@PERFRPTRANGE]] · 性能指标上报范围（PERFRPTRANGE）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-PERFRPTRANGE.md`
