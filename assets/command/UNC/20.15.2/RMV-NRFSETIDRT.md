---
id: UNC@20.15.2@MMLCommand@RMV NRFSETIDRT
type: MMLCommand
name: RMV NRFSETIDRT（删除NF Set ID最长匹配后缀转发路由）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NRFSETIDRT（删除NF Set ID最长匹配后缀转发路由）
...
- [[UNC@20.15.2@ConfigObject@NRFSETIDRT]] · NF Set ID最长匹配后缀转发路由（NRFSETIDRT）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-NRFSETIDRT.md`
