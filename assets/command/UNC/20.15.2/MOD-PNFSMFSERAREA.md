---
id: UNC@20.15.2@MMLCommand@MOD PNFSMFSERAREA
type: MMLCommand
name: MOD PNFSMFSERAREA（修改对端NF的SMF服务区域信息）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD PNFSMFSERAREA（修改对端NF的SMF服务区域信息）
...
- [对端NF的SMF服务区域信息（PNFSMFSERAREA）](configobject/UNC/20.15.2/PNFSMFSERAREA.md)
