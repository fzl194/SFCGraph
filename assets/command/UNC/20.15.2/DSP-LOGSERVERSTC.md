---
id: UNC@20.15.2@MMLCommand@DSP LOGSERVERSTC
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@LOGSERVERSTC]] · 日志中心5分钟内消息统计信息（LOGSERVERSTC）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-LOGSERVERSTC.md`
