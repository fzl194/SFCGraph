---
id: UNC@20.15.2@MMLCommand@RMV APNPGWCHGPAUSE
type: MMLCommand
name: RMV APNPGWCHGPAUSE（删除基于APN的计费暂停功能配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV APNPGWCHGPAUSE（删除基于APN的计费暂停功能配置）
...
删除“APN名称”为"HUAWEI.COM"的PGW计费暂停功能配置：

```
RMV APNPGWCHGPAUSE: APN="HUAWEI.COM";
```
