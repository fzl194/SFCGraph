---
id: UNC@20.15.2@MMLCommand@MOD NGTALISTPAGINGCFG
type: MMLCommand
name: MOD NGTALISTPAGINGCFG（修改N2模式TALIST寻呼不重发TAC区间）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NGTALISTPAGINGCFG（修改N2模式TALIST寻呼不重发TAC区间）
...
- [N2模式TALIST寻呼不重发TAC区间（NGTALISTPAGINGCFG）](configobject/UNC/20.15.2/NGTALISTPAGINGCFG.md)
