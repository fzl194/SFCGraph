---
id: UNC@20.15.2@MMLCommand@SET APNACCESSCTRL
type: MMLCommand
name: SET APNACCESSCTRL（设置APN访问控制参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [APN访问控制参数（APNACCESSCTRL）](configobject/UNC/20.15.2/APNACCESSCTRL.md)
