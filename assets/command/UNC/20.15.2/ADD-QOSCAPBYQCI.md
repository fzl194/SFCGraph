---
id: UNC@20.15.2@MMLCommand@ADD QOSCAPBYQCI
type: MMLCommand
name: ADD QOSCAPBYQCI（增加基于QCI的Non-GBR承载QoS限制配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD QOSCAPBYQCI（增加基于QCI的Non-GBR承载QoS限制配置）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-QOSCAPBYQCI.md`
