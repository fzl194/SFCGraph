---
id: UNC@20.15.2@MMLCommand@RMV SMFQOSCAP
type: MMLCommand
name: RMV SMFQOSCAP（删除QosFlow QoS限制的配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV SMFQOSCAP（删除QosFlow QoS限制的配置）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-SMFQOSCAP.md`
