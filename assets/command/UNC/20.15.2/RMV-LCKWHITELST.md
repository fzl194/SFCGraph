---
id: UNC@20.15.2@MMLCommand@RMV LCKWHITELST
type: MMLCommand
name: RMV LCKWHITELST（删除锁定白名单记录）
nf: UNC
version: 20.15.2
verb: RMV
...
- [锁定白名单记录（LCKWHITELST）](configobject/UNC/20.15.2/LCKWHITELST.md)
