---
id: UNC@20.15.2@MMLCommand@MOD PCRFBINDGRP
type: MMLCommand
name: MOD PCRFBINDGRP（修改PCRF与PCRF Group的关联关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD PCRFBINDGRP（修改PCRF与PCRF Group的关联关系）
...
- [PCRF与PCRF Group的关联关系（PCRFBINDGRP）](configobject/UNC/20.15.2/PCRFBINDGRP.md)
