---
id: UNC@20.15.2@MMLCommand@MOD RESULTCODESCP
type: MMLCommand
name: MOD RESULTCODESCP（修改配置MODELC/D组网的SCP原因码控制）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD RESULTCODESCP（修改配置MODELC/D组网的SCP原因码控制）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-RESULTCODESCP.md`
