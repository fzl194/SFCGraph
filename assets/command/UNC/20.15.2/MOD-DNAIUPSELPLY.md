---
id: UNC@20.15.2@MMLCommand@MOD DNAIUPSELPLY
type: MMLCommand
name: MOD DNAIUPSELPLY（修改DNAI粒度的UPF选择策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD DNAIUPSELPLY（修改DNAI粒度的UPF选择策略）
...
- [DNAI粒度的UPF选择策略（DNAIUPSELPLY）](configobject/UNC/20.15.2/DNAIUPSELPLY.md)
