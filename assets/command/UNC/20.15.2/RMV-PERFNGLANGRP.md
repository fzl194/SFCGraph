---
id: UNC@20.15.2@MMLCommand@RMV PERFNGLANGRP
type: MMLCommand
name: RMV PERFNGLANGRP（删除用于性能统计的5G LAN群组）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PERFNGLANGRP（删除用于性能统计的5G LAN群组）
...
- [[configobject/UNC/20.15.2/PERFNGLANGRP]] · 用于性能统计的5G LAN群组（PERFNGLANGRP）
