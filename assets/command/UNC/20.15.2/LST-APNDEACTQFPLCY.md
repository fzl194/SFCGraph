---
id: UNC@20.15.2@MMLCommand@LST APNDEACTQFPLCY
type: MMLCommand
name: LST APNDEACTQFPLCY（查询基于APN去活用户面专有QoS Flow策略）
nf: UNC
version: 20.15.2
verb: LST
...
# LST APNDEACTQFPLCY（查询基于APN去活用户面专有QoS Flow策略）
...
- [[configobject/UNC/20.15.2/APNDEACTQFPLCY]] · 基于APN去活用户面专有QoS Flow策略（APNDEACTQFPLCY）
