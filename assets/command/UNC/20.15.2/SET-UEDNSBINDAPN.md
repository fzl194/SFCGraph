---
id: UNC@20.15.2@MMLCommand@SET UEDNSBINDAPN
type: MMLCommand
name: SET UEDNSBINDAPN（设置APN的DNS属性）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@UEDNSBINDAPN]] · APN的DNS属性（UEDNSBINDAPN）
