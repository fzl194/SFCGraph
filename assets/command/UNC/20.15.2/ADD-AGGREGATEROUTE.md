---
id: UNC@20.15.2@MMLCommand@ADD AGGREGATEROUTE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@AGGREGATEROUTE]] · BGP聚合路由（AGGREGATEROUTE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-AGGREGATEROUTE.md`
