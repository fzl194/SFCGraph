---
id: UNC@20.15.2@MMLCommand@RMV FWAMATCHRULE
type: MMLCommand
name: RMV FWAMATCHRULE（删除FWA用户匹配规则）
nf: UNC
version: 20.15.2
verb: RMV
...
- [FWA用户匹配规则（FWAMATCHRULE）](configobject/UNC/20.15.2/FWAMATCHRULE.md)
