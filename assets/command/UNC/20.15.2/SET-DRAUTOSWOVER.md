---
id: UNC@20.15.2@MMLCommand@SET DRAUTOSWOVER
type: MMLCommand
...
- [[configobject/UNC/20.15.2/DRAUTOSWOVER]] · 热备模式下是否开启自动倒换功能（DRAUTOSWOVER）
...
- 原始手册：`evidence/UNC/20.15.2/SET-DRAUTOSWOVER.md`
