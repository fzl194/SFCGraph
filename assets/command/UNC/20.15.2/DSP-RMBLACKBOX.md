---
id: UNC@20.15.2@MMLCommand@DSP RMBLACKBOX
type: MMLCommand
...
- [路由管理黑匣子信息（RMBLACKBOX）](configobject/UNC/20.15.2/RMBLACKBOX.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询路由管理黑匣子信息（DSP-RMBLACKBOX）_00865833.md`
