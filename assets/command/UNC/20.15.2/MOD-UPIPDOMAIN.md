---
id: UNC@20.15.2@MMLCommand@MOD UPIPDOMAIN
type: MMLCommand
name: MOD UPIPDOMAIN（修改当前UPF绑定的IP域）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[UNC@20.15.2@ConfigObject@UPIPDOMAIN]] · 当前UPF绑定的IP域（UPIPDOMAIN）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-UPIPDOMAIN.md`
