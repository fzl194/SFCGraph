---
id: UNC@20.15.2@MMLCommand@DSP SOCKINNERDATA
type: MMLCommand
...
- [[configobject/UNC/20.15.2/SOCKINNERDATA]] · SOCK诊断信息（SOCKINNERDATA）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-SOCKINNERDATA.md`
