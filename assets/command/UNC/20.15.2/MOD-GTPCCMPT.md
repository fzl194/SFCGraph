---
id: UNC@20.15.2@MMLCommand@MOD GTPCCMPT
type: MMLCommand
name: MOD GTPCCMPT（修改GTP-C V0/V1协议兼容性配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD GTPCCMPT（修改GTP-C V0/V1协议兼容性配置）
...
- [[UNC@20.15.2@ConfigObject@GTPCCMPT]] · GTP-C V0/V1协议兼容性配置（GTPCCMPT）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-GTPCCMPT.md`
