---
id: UNC@20.15.2@MMLCommand@SET MSSPBUFTRACE
type: MMLCommand
...
![](设置PBUF轨迹设置的开关（SET MSSPBUFTRACE）_85410312.assets/notice_3.0-zh-cn_2.png)
...
- [[UNC@20.15.2@ConfigObject@MSSPBUFTRACE]] · PBUF轨迹设置的开关（MSSPBUFTRACE）
...
- 原始手册：`evidence/UNC/20.15.2/SET-MSSPBUFTRACE.md`
