---
id: UNC@20.15.2@MMLCommand@ADD RESULTCODEDRA
type: MMLCommand
name: ADD RESULTCODEDRA（增加DRA返回码控制）
nf: UNC
version: 20.15.2
verb: ADD
...
- [DRA返回码控制（RESULTCODEDRA）](configobject/UNC/20.15.2/RESULTCODEDRA.md)
