---
id: UNC@20.15.2@MMLCommand@LST GBIMEICFG
type: MMLCommand
name: LST GBIMEICFG（查询Gb模式IMEI配置）
nf: UNC
version: 20.15.2
verb: LST
...
# LST GBIMEICFG（查询Gb模式IMEI配置）

## 功能

**适用网元：SGSN**

该命令用于查询GERAN用户获取和检查IMEI的策略。
...
- 原始手册：`evidence/UNC/20.15.2/LST-GBIMEICFG.md`
