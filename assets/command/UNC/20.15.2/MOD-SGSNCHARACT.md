---
id: UNC@20.15.2@MMLCommand@MOD SGSNCHARACT
type: MMLCommand
name: MOD SGSNCHARACT（修改GnGp SGSN属性配置信息）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD SGSNCHARACT（修改GnGp SGSN属性配置信息）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-SGSNCHARACT.md`
