---
id: UNC@20.15.2@MMLCommand@SET DDNFLOWCTRL
type: MMLCommand
name: SET DDNFLOWCTRL（设置DDN流控参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@DDNFLOWCTRL]] · DDN流控参数（DDNFLOWCTRL）
