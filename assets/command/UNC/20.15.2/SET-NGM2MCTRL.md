---
id: UNC@20.15.2@MMLCommand@SET NGM2MCTRL
type: MMLCommand
name: SET NGM2MCTRL（设置5G M2M控制参数）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@NGM2MCTRL]] · 5G M2M控制参数（NGM2MCTRL）
...
- 原始手册：`evidence/UNC/20.15.2/SET-NGM2MCTRL.md`
