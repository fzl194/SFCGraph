---
id: UNC@20.15.2@MMLCommand@ADD NRFROUTINGINDRT
type: MMLCommand
name: ADD NRFROUTINGINDRT（增加选路指示器路由）
nf: UNC
version: 20.15.2
verb: ADD
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NRFROUTINGINDRT.md`
