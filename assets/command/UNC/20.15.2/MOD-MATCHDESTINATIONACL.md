---
id: UNC@20.15.2@MMLCommand@MOD MATCHDESTINATIONACL
type: MMLCommand
name: MOD MATCHDESTINATIONACL（修改目的IP地址基础ACL匹配路由策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD MATCHDESTINATIONACL（修改目的IP地址基础ACL匹配路由策略）

## 功能

该命令用于修改目的IP地址基础ACL匹配路由策略。
...
修改路由策略a节点10的匹配条件，ACL过滤器abc匹配IPv4目的地址：

```
MOD MATCHDESTINATIONACL:POLICYNAME="a",NODESEQUENCE=10,ACLNAMEORNUM="abc";
```
