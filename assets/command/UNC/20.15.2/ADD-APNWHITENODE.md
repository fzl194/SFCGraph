---
id: UNC@20.15.2@MMLCommand@ADD APNWHITENODE
type: MMLCommand
name: ADD APNWHITENODE（增加APN设备白名单）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@APNWHITENODE]] · APN设备白名单（APNWHITENODE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-APNWHITENODE.md`
