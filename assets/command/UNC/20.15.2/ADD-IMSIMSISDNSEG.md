---
id: UNC@20.15.2@MMLCommand@ADD IMSIMSISDNSEG
type: MMLCommand
name: ADD IMSIMSISDNSEG（增加IMSI和MSISDN号段）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD IMSIMSISDNSEG（增加IMSI和MSISDN号段）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-IMSIMSISDNSEG.md`
