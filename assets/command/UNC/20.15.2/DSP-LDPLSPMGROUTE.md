---
id: UNC@20.15.2@MMLCommand@DSP LDPLSPMGROUTE
type: MMLCommand
...
- [[configobject/UNC/20.15.2/LDPLSPMGROUTE]] · LDP LSP管理组件的路由信息（LDPLSPMGROUTE）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-LDPLSPMGROUTE.md`
