---
id: UNC@20.15.2@MMLCommand@SET IPALLOCRULE
type: MMLCommand
name: SET IPALLOCRULE（设置全局地址分配规则）
nf: UNC
version: 20.15.2
verb: SET
...
- [[configobject/UNC/20.15.2/IPALLOCRULE]] · 全局地址分配规则（IPALLOCRULE）
...
- 原始手册：`evidence/UNC/20.15.2/SET-IPALLOCRULE.md`
