---
id: UNC@20.15.2@MMLCommand@ACT DEVVERIFICATION
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@DEVVERIFICATION]] · 触发设备对账（DEVVERIFICATION）
...
- 原始手册：`evidence/UNC/20.15.2/ACT-DEVVERIFICATION.md`
