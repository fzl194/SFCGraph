---
id: UNC@20.15.2@MMLCommand@RMV PAEPORTGATEWAY
type: MMLCommand
...
![](删除网关转发地址（RMV PAEPORTGATEWAY）_98164009.assets/notice_3.0-zh-cn_2.png)
...
- [PAE端口网关信息（PAEPORTGATEWAY）](configobject/UNC/20.15.2/PAEPORTGATEWAY.md)
