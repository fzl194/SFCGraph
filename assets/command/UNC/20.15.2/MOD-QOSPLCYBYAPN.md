---
id: UNC@20.15.2@MMLCommand@MOD QOSPLCYBYAPN
type: MMLCommand
name: MOD QOSPLCYBYAPN（修改基于APN的QoS策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD QOSPLCYBYAPN（修改基于APN的QoS策略）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-QOSPLCYBYAPN.md`
