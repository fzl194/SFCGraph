---
id: UNC@20.15.2@MMLCommand@MOD OPMMETRIC
type: MMLCommand
name: MOD OPMMETRIC（修改话统指标优化公式）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD OPMMETRIC（修改话统指标优化公式）

## 功能

![](修改话统指标优化公式(MOD OPMMETRIC)_50429666.assets/notice_3.0-zh-cn_2.png)
...
- [话统指标优化公式（OPMMETRIC）](configobject/UNC/20.15.2/OPMMETRIC.md)
