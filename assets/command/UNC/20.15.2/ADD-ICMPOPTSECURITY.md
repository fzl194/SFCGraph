---
id: UNC@20.15.2@MMLCommand@ADD ICMPOPTSECURITY
type: MMLCommand
...
- [[configobject/UNC/20.15.2/ICMPOPTSECURITY]] · ICMP选项安全配置（ICMPOPTSECURITY）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ICMPOPTSECURITY.md`
