---
id: UNC@20.15.2@MMLCommand@RMV SBILINKCFG
type: MMLCommand
...
![](删除SBI接口链路属性配置（RMV SBILINKCFG）_29213291.assets/notice_3.0-zh-cn_2.png)
...
- [[UNC@20.15.2@ConfigObject@SBILINKCFG]] · SBI接口链路属性配置（SBILINKCFG）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-SBILINKCFG.md`
