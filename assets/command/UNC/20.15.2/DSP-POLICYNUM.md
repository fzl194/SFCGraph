---
id: UNC@20.15.2@MMLCommand@DSP POLICYNUM
type: MMLCommand
...
- [策略数量（POLICYNUM）](configobject/UNC/20.15.2/POLICYNUM.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询策略数量（DSP-POLICYNUM）_29627053.md`
