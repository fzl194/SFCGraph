---
id: UNC@20.15.2@MMLCommand@RMV PNFPLMN
type: MMLCommand
name: RMV PNFPLMN（删除对端NF的PLMN信息）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PNFPLMN（删除对端NF的PLMN信息）

## 功能

**适用NF：AMF、SMF、NSSF、SMSF、NCG**

该命令用于删除本地配置的对端NF实例支持的PLMN的信息。
...
删除对端NF的PLMN信息，NF实例标识为SMF_Instance_0，MCC为460，MNC为03。

```
RMV PNFPLMN: NFINSTANCEID="SMF_Instance_0", MCC="460",MNC="03";
```
