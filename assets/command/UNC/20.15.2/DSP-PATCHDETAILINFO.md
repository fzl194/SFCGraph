---
id: UNC@20.15.2@MMLCommand@DSP PATCHDETAILINFO
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@PATCHDETAILINFO]] · 补丁信息（PATCHDETAILINFO）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-PATCHDETAILINFO.md`
