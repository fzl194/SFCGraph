---
id: UNC@20.15.2@MMLCommand@ADD HOMESMFINSTID
type: MMLCommand
name: ADD HOMESMFINSTID（增加指定归属地SMF实例标识）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD HOMESMFINSTID（增加指定归属地SMF实例标识）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-HOMESMFINSTID.md`
