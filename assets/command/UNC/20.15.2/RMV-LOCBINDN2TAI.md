---
id: UNC@20.15.2@MMLCommand@RMV LOCBINDN2TAI
type: MMLCommand
name: RMV LOCBINDN2TAI（删除UPF位置信息与UPF优先支持的5G TAI范围的绑定关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV LOCBINDN2TAI（删除UPF位置信息与UPF优先支持的5G TAI范围的绑定关系）
...
- [[UNC@20.15.2@ConfigObject@LOCBINDN2TAI]] · UPF位置信息与UPF优先支持的5G TAI范围的绑定关系（LOCBINDN2TAI）

## 使用实例

删除UPF位置区与UPF优先支持的TAI范围的绑定关系，其中UPF位置区为“locality1”，MCC为460, MNC为03，N2 TAC起始号段为130101，N2 TAC终止号段为130102。

```
RMV LOCBINDN2TAI: LOCALITY="locality1",MCC="460",MNC="03",N2TACSTART="130101",N2TACEND="130102";
```
