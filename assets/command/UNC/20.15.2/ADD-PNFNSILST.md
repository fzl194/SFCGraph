---
id: UNC@20.15.2@MMLCommand@ADD PNFNSILST
type: MMLCommand
name: ADD PNFNSILST（增加对端NF实例网络切片标识）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@PNFNSILST]] · 对端NF实例网络切片标识（PNFNSILST）

## 使用实例

添加对端NF的NSI信息，NF实例标识为SMF_Instance_0，NSI为10001。

```
ADD PNFNSILST:NFINSTANCEID="SMF_Instance_0",NSI="10001";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/ADD-PNFNSILST.md`
