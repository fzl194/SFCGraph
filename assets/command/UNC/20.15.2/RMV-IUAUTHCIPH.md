---
id: UNC@20.15.2@MMLCommand@RMV IUAUTHCIPH
type: MMLCommand
name: RMV IUAUTHCIPH（删除Iu模式用户安全参数）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@IUAUTHCIPH]] · Iu模式用户安全参数（IUAUTHCIPH）

## 使用实例

删除IMSI前缀为“012544”的指定用户的3G鉴权加密配置：

RMV IUAUTHCIPH:IMSIPRE="012544";
