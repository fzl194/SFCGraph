---
id: UNC@20.15.2@MMLCommand@ADD HSSBPAPNSUB
type: MMLCommand
name: ADD HSSBPAPNSUB（增加HSS BYPASS最小APN签约数据配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD HSSBPAPNSUB（增加HSS BYPASS最小APN签约数据配置）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-HSSBPAPNSUB.md`
