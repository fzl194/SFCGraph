---
id: UNC@20.15.2@MMLCommand@ADD HTTPSTATUS
type: MMLCommand
...
![](增加HTTP状态码判定配置（ADD HTTPSTATUS）_67769736.assets/notice_3.0-zh-cn_2.png)
...
| SCENE | 场景 | 可选必选说明：必选参数<br>参数含义：该参数用于表示当前状态码所对应的场景类型。<br>数据来源：本端规划<br>取值范围：<br>- ERRNEXTHOP（故障下一跳）<br>默认值：无<br>配置原则：无 |
...
- [[UNC@20.15.2@ConfigObject@HTTPSTATUS]] · HTTP状态码判定配置（HTTPSTATUS）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-HTTPSTATUS.md`
