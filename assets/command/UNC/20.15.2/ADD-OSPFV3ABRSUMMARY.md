---
id: UNC@20.15.2@MMLCommand@ADD OSPFV3ABRSUMMARY
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@OSPFV3ABRSUMMARY]] · OSPFv3区域内路由聚合配置（OSPFV3ABRSUMMARY）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-OSPFV3ABRSUMMARY.md`
