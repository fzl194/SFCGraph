---
id: UNC@20.15.2@MMLCommand@ADD NGVOICEDEPLOY
type: MMLCommand
name: ADD NGVOICEDEPLOY（增加5G语音部署配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [5G语音部署配置（NGVOICEDEPLOY）](configobject/UNC/20.15.2/NGVOICEDEPLOY.md)
...
- 原始手册：`evidence/UNC/20.15.2/增加5G语音部署配置（ADD-NGVOICEDEPLOY）_86340330.md`
