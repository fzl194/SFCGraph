---
id: UNC@20.15.2@MMLCommand@ADD ULCLAPNDPMODE
type: MMLCommand
name: ADD ULCLAPNDPMODE（增加指定APN的ULCL部署模式）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD ULCLAPNDPMODE（增加指定APN的ULCL部署模式）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ULCLAPNDPMODE.md`
