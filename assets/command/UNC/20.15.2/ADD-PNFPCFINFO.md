---
id: UNC@20.15.2@MMLCommand@ADD PNFPCFINFO
type: MMLCommand
name: ADD PNFPCFINFO（增加对端PCF信息）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@PNFPCFINFO]] · 对端PCF信息（PNFPCFINFO）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PNFPCFINFO.md`
