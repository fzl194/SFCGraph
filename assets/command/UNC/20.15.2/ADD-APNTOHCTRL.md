---
id: UNC@20.15.2@MMLCommand@ADD APNTOHCTRL
type: MMLCommand
name: ADD APNTOHCTRL（增加APN粒度的智家随行会话控制）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNTOHCTRL（增加APN粒度的智家随行会话控制）
...
- [[UNC@20.15.2@ConfigObject@APNTOHCTRL]] · APN粒度的智家随行会话控制（APNTOHCTRL）
