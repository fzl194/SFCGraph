---
id: UNC@20.15.2@MMLCommand@RMV PROXYSGWACCLIST
type: MMLCommand
name: RMV PROXYSGWACCLIST（删除Proxy SGW-C接入控制列表）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PROXYSGWACCLIST（删除Proxy SGW-C接入控制列表）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-PROXYSGWACCLIST.md`
