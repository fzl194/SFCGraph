---
id: UNC@20.15.2@MMLCommand@ADD SMFCAUSECTRL
type: MMLCommand
name: ADD SMFCAUSECTRL（增加SMF流程控制参数）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@SMFCAUSECTRL]] · SMF流程控制参数（SMFCAUSECTRL）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SMFCAUSECTRL.md`
