---
id: UNC@20.15.2@MMLCommand@MOD APNPOLICYMODE
type: MMLCommand
name: MOD APNPOLICYMODE（修改基于APN的策略接口的选择方式）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD APNPOLICYMODE（修改基于APN的策略接口的选择方式）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-APNPOLICYMODE.md`
