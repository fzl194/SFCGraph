---
id: UNC@20.15.2@MMLCommand@RMV NGSRCHRCFG
type: MMLCommand
name: RMV NGSRCHRCFG（删除AMF小范围CHR上报规则配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NGSRCHRCFG（删除AMF小范围CHR上报规则配置）

## 功能

**适用NF：AMF**

该命令用于删除AMF小范围CHR上报规则配置。
...
删除IMSI前缀为12303000100的小范围CHR上报规则配置，执行如下命令：

```
RMV NGSRCHRCFG: SUBRANGE=SPECIFIC_IMSI, IMSIPRE="12303000100";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-NGSRCHRCFG.md`
