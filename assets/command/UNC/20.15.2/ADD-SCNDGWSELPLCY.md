---
id: UNC@20.15.2@MMLCommand@ADD SCNDGWSELPLCY
type: MMLCommand
name: ADD SCNDGWSELPLCY（增加相同APN建立多个PDP/PDN连接的网关选择策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD SCNDGWSELPLCY（增加相同APN建立多个PDP/PDN连接的网关选择策略）
...
- [相同APN建立多个PDP/PDN连接的网关选择策略（SCNDGWSELPLCY）](configobject/UNC/20.15.2/SCNDGWSELPLCY.md)
