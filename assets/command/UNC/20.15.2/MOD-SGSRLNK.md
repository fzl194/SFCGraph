---
id: UNC@20.15.2@MMLCommand@MOD SGSRLNK
type: MMLCommand
name: MOD SGSRLNK（修改SGS服务端链路）
nf: UNC
version: 20.15.2
verb: MOD
...
| LNKNM | 链路名称 | 可选必选说明：可选参数<br>参数含义：该参数用于指定链路的名称。<br>数据来源：本端规划<br>取值范围：字符串类型，输入长度范围为0~63<br>默认值：无 |
...
1.将链路索引为1的SGS服务端链路名修改为test，交叉路径是否可用改为是：

MOD SGSRLNK: LNK=1, LNKNM="test", CROSSIPFLAG=Yes;
