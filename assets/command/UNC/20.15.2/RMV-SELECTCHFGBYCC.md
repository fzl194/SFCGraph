---
id: UNC@20.15.2@MMLCommand@RMV SELECTCHFGBYCC
type: MMLCommand
name: RMV SELECTCHFGBYCC（删除基于CC选择CHF处理）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV SELECTCHFGBYCC（删除基于CC选择CHF处理）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-SELECTCHFGBYCC.md`
