---
id: UNC@20.15.2@MMLCommand@MOD MATCHDESTPREFIXFILTER
type: MMLCommand
name: MOD MATCHDESTPREFIXFILTER（修改匹配IPv4地址前缀列表）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD MATCHDESTPREFIXFILTER（修改匹配IPv4地址前缀列表）

## 功能

该命令用于修改目的地址前缀过滤器匹配路由策略。
...
- [匹配IPv4地址前缀列表（MATCHDESTPREFIXFILTER）](configobject/UNC/20.15.2/MATCHDESTPREFIXFILTER.md)
...
```
MOD MATCHDESTPREFIXFILTER: NODESEQUENCE=10,PREFIXNAME="a",POLICYNAME="a";
```
