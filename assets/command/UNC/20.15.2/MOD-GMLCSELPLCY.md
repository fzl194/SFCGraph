---
id: UNC@20.15.2@MMLCommand@MOD GMLCSELPLCY
type: MMLCommand
name: MOD GMLCSELPLCY（修改GMLC选择策略）
nf: UNC
version: 20.15.2
verb: MOD
...
- [GMLC选择策略（GMLCSELPLCY）](configobject/UNC/20.15.2/GMLCSELPLCY.md)
...
- 原始手册：`evidence/UNC/20.15.2/修改GMLC选择策略(MOD-GMLCSELPLCY)_72345413.md`
