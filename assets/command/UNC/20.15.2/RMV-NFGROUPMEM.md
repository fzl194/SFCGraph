---
id: UNC@20.15.2@MMLCommand@RMV NFGROUPMEM
type: MMLCommand
name: RMV NFGROUPMEM（删除NF组成员）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NFGROUPMEM（删除NF组成员）

## 功能

**适用NF：NRF**

该命令用于在NRF上删除NF实例组成员信息。
...
- [[UNC@20.15.2@ConfigObject@NFGROUPMEM]] · NF组成员（NFGROUPMEM）

## 使用实例

在NRF上删除组标识为nfgroup001，实例标识为Instanceid01，实例名称为superom11-v6的NF实例组成员：

```
RMV NFGROUPMEM:NFGROUPID="nfgroup001",NFINSTANCEID="Instanceid01", NFNAME="superom11-v6";
```
