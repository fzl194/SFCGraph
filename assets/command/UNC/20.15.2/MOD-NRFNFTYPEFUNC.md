---
id: UNC@20.15.2@MMLCommand@MOD NRFNFTYPEFUNC
type: MMLCommand
name: MOD NRFNFTYPEFUNC（修改基于NFType设置NRF的各类功能开关）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NRFNFTYPEFUNC（修改基于NFType设置NRF的各类功能开关）
...
- [[configobject/UNC/20.15.2/NRFNFTYPEFUNC]] · 基于NFType设置NRF的各类功能开关（NRFNFTYPEFUNC）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-NRFNFTYPEFUNC.md`
