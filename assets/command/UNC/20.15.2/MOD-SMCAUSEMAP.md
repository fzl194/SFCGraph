---
id: UNC@20.15.2@MMLCommand@MOD SMCAUSEMAP
type: MMLCommand
name: MOD SMCAUSEMAP（修改SM原因值映射配置）
nf: UNC
version: 20.15.2
verb: MOD
...
- [[configobject/UNC/20.15.2/SMCAUSEMAP]] · SM原因值映射配置（SMCAUSEMAP）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-SMCAUSEMAP.md`
