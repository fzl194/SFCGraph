---
id: UNC@20.15.2@MMLCommand@ADD QOSCAPWHITEAPNS
type: MMLCommand
name: ADD QOSCAPWHITEAPNS（增加不受SMFQOSCAP配置控制的APN白名单列表。）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD QOSCAPWHITEAPNS（增加不受SMFQOSCAP配置控制的APN白名单列表。）

## 功能

**适用NF：SMF**

该命令用于增加不受SMFQOSCAP配置控制的APN白名单列表。
...
增加不受QOSCAP配置控制的APN白名单列表，APN为“huawei.com”，用户范围为“IMSI_PREFIX”，IMSI前缀为“3080107000”：

```
ADD QOSCAPWHITEAPNS:APN="huawei.com",SUBRANGE=IMSI_PREFIX, IMSIPRE="3080107000"
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/ADD-QOSCAPWHITEAPNS.md`
