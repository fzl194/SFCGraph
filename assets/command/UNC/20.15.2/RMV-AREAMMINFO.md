---
id: UNC@20.15.2@MMLCommand@RMV AREAMMINFO
type: MMLCommand
name: RMV AREAMMINFO（删除基于区域的网络名称）
nf: UNC
version: 20.15.2
verb: RMV
...
删除BGNTAI为1111111111，SUBRANGE为HOME_USER，NOID为1的基于区域的网络名称：

```
RMV AREAMMINFO: BGNTAI="1111111111", SUBRANGE=HOME_USER, NOID=1;
```
