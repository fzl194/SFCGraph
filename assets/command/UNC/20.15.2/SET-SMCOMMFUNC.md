---
id: UNC@20.15.2@MMLCommand@SET SMCOMMFUNC
type: MMLCommand
name: SET SMCOMMFUNC（设置通用会话拓展功能）
nf: UNC
version: 20.15.2
verb: SET
...
- [通用会话拓展功能（SMCOMMFUNC）](configobject/UNC/20.15.2/SMCOMMFUNC.md)
