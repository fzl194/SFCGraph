---
id: UNC@20.15.2@MMLCommand@RMV PERFTAIGROUPMEM
type: MMLCommand
name: RMV PERFTAIGROUPMEM（删除TAI组性能统计对象成员）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PERFTAIGROUPMEM（删除TAI组性能统计对象成员）
...
- 原始手册：`evidence/UNC/20.15.2/删除TAI组性能统计对象成员（RMV-PERFTAIGROUPMEM）_17625958.md`
