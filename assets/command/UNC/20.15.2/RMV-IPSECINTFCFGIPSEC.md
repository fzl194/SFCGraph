---
id: UNC@20.15.2@MMLCommand@RMV IPSECINTFCFGIPSEC
type: MMLCommand
...
- [[configobject/UNC/20.15.2/IPSECINTFCFGIPSEC]] · IPsec隧道接口（IPSECINTFCFGIPSEC）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-IPSECINTFCFGIPSEC.md`
