---
id: UNC@20.15.2@MMLCommand@RMV VPNINSTAF
type: MMLCommand
...
![](删除L3VPN实例地址族（RMV VPNINSTAF）_00440685.assets/notice_3.0-zh-cn_2.png)
...
- [L3VPN实例地址族（VPNINSTAF）](configobject/UNC/20.15.2/VPNINSTAF.md)
