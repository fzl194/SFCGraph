---
id: UNC@20.15.2@MMLCommand@MOD CCPDNNACT
type: MMLCommand
name: MOD CCPDNNACT（修改融合计费Proxy基于DNN处理动作）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD CCPDNNACT（修改融合计费Proxy基于DNN处理动作）
...
- [[configobject/UNC/20.15.2/CCPDNNACT]] · 融合计费Proxy基于DNN处理动作（CCPDNNACT）
