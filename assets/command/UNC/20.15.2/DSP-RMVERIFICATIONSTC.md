---
id: UNC@20.15.2@MMLCommand@DSP RMVERIFICATIONSTC
type: MMLCommand
name: DSP RMVERIFICATIONSTC（查询路由管理对账统计信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: RMVERIFICATIONSTC
...
# DSP RMVERIFICATIONSTC（查询路由管理对账统计信息）
...
- [路由管理对账统计信息（RMVERIFICATIONSTC）](configobject/UNC/20.15.2/RMVERIFICATIONSTC.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询路由管理对账统计信息（DSP-RMVERIFICATIONSTC）_00600577.md`
