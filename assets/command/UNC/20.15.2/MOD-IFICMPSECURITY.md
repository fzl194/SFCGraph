---
id: UNC@20.15.2@MMLCommand@MOD IFICMPSECURITY
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@IFICMPSECURITY]] · 接口下ICMP安全配置（IFICMPSECURITY）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-IFICMPSECURITY.md`
