---
id: UNC@20.15.2@MMLCommand@DSP LOGFILESTORAGE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@LOGFILESTORAGE]] · 日志存储信息（LOGFILESTORAGE）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-LOGFILESTORAGE.md`
