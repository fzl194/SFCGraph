---
id: UNC@20.15.2@MMLCommand@RMV EXTENDCOMMUNITYFILTERNODE
type: MMLCommand
...
- [基础扩展团体属性过滤器节点（EXTENDCOMMUNITYFILTERNODE）](configobject/UNC/20.15.2/EXTENDCOMMUNITYFILTERNODE.md)
...
- 原始手册：`evidence/UNC/20.15.2/删除基础扩展团体属性过滤器节点（RMV-EXTENDCOMMUNITYFILTERNODE）_49801654.md`
