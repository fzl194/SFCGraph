---
id: UNC@20.15.2@MMLCommand@SET HOSTSTCGLB
type: MMLCommand
...
- [全局协议报文统计配置（HOSTSTCGLB）](configobject/UNC/20.15.2/HOSTSTCGLB.md)
...
- 原始手册：`evidence/UNC/20.15.2/设置全局协议报文统计配置（SET-HOSTSTCGLB）_00441557.md`
