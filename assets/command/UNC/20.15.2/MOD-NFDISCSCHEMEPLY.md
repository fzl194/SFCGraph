---
id: UNC@20.15.2@MMLCommand@MOD NFDISCSCHEMEPLY
type: MMLCommand
name: MOD NFDISCSCHEMEPLY（修改服务发现Scheme优选策略）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NFDISCSCHEMEPLY（修改服务发现Scheme优选策略）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-NFDISCSCHEMEPLY.md`
