---
id: UNC@20.15.2@MMLCommand@RMV DRA
type: MMLCommand
name: RMV DRA（删除DRA）
nf: UNC
version: 20.15.2
...
![](删除DRA（RMV DRA）_09897293.assets/notice_3.0-zh-cn_2.png)
...
- 15分钟内删除DRA再执行ADD DRA后，可能导致对应HOSTNAME的局向指标无法上报，需要在网管上去订阅后再重新订阅相关指标。
...
- [[UNC@20.15.2@ConfigObject@DRA]] · DRA（DRA）
...
```
RMV DRA:HOSTNAME="dra1";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-DRA.md`
