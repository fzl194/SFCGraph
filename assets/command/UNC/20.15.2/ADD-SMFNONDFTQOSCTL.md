---
id: UNC@20.15.2@MMLCommand@ADD SMFNONDFTQOSCTL
type: MMLCommand
name: ADD SMFNONDFTQOSCTL（增加SMF的非Default QoS Flow配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD SMFNONDFTQOSCTL（增加SMF的非Default QoS Flow配置）
...
- [[UNC@20.15.2@ConfigObject@SMFNONDFTQOSCTL]] · SMF的非Default QoS Flow配置（SMFNONDFTQOSCTL）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SMFNONDFTQOSCTL.md`
