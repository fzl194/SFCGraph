---
id: UNC@20.15.2@MMLCommand@STR NGALMCHECK
type: MMLCommand
name: STR NGALMCHECK（启动5G告警核查）
nf: UNC
version: 20.15.2
verb: STR
...
- [5G告警核查（NGALMCHECK）](configobject/UNC/20.15.2/NGALMCHECK.md)
...
- 原始手册：`evidence/UNC/20.15.2/启动5G告警核查（STR-NGALMCHECK）_00692006.md`
