---
id: UNC@20.15.2@MMLCommand@ADD QOSMONTRULE
type: MMLCommand
name: ADD QOSMONTRULE（增加QoS监测规则）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@QOSMONTRULE]] · QoS监测规则（QOSMONTRULE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-QOSMONTRULE.md`
