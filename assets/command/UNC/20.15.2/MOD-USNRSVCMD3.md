---
id: UNC@20.15.2@MMLCommand@MOD USNRSVCMD3
type: MMLCommand
name: MOD USNRSVCMD3（修改预埋命令3）
nf: UNC
version: 20.15.2
verb: MOD
object_keyword: USNRSVCMD3
...
# MOD USNRSVCMD3（修改预埋命令3）

## 功能

**适用网元：MME**

该命令用于修改实现指定的功能所需要的命令名称以及对应的参数信息。
...
- [预埋命令3（USNRSVCMD3）](configobject/UNC/20.15.2/USNRSVCMD3.md)

## 使用实例

修改通过命令名称为MOD GLOBALVARIABLE来修改某个全局变量的值的功能，则可以执行以下命令：

MOD USNRSVCMD3: FUNNAME="MOD GLOBALVARIABLE", FUNKEY="TESTKEY", STRPARA1="asddas123", STRPARA2="asdA", STRPARA3="ASDFAS", INTPARA1=1231, INTPARA2=12312, INTPARA3=1231;
