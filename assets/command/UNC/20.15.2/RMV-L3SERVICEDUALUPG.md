---
id: UNC@20.15.2@MMLCommand@RMV L3SERVICEDUALUPG
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@L3SERVICEDUALUPG]] · 一个微服务迁移流程（L3SERVICEDUALUPG）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-L3SERVICEDUALUPG.md`
