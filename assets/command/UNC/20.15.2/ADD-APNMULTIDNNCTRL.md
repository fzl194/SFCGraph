---
id: UNC@20.15.2@MMLCommand@ADD APNMULTIDNNCTRL
type: MMLCommand
name: ADD APNMULTIDNNCTRL（增加2B2C漫游双DNN特性APN级的相关功能控制）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNMULTIDNNCTRL（增加2B2C漫游双DNN特性APN级的相关功能控制）
...
- [2B2C漫游双DNN特性APN级的相关功能控制（APNMULTIDNNCTRL）](configobject/UNC/20.15.2/APNMULTIDNNCTRL.md)
