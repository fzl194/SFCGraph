---
id: UNC@20.15.2@MMLCommand@RMV PORTGROUPMEMBER
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@PORTGROUPMEMBER]] · 端口组成员（PORTGROUPMEMBER）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-PORTGROUPMEMBER.md`
