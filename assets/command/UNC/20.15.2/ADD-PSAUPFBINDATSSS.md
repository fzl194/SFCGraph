---
id: UNC@20.15.2@MMLCommand@ADD PSAUPFBINDATSSS
type: MMLCommand
name: ADD PSAUPFBINDATSSS（增加PSA UPF和ATSSS UPF的绑定关系配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PSAUPFBINDATSSS（增加PSA UPF和ATSSS UPF的绑定关系配置）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PSAUPFBINDATSSS.md`
