---
id: UNC@20.15.2@MMLCommand@SET SCPFUNCSW
type: MMLCommand
name: SET SCPFUNCSW（设置间接路由功能）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@SCPFUNCSW]] · 间接路由功能（SCPFUNCSW）
...
- 原始手册：`evidence/UNC/20.15.2/SET-SCPFUNCSW.md`
