---
id: UNC@20.15.2@MMLCommand@MOD NRFPMNINTERFUNC
type: MMLCommand
name: MOD NRFPMNINTERFUNC（修改基于对端PLMN国际漫游功能参数）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NRFPMNINTERFUNC（修改基于对端PLMN国际漫游功能参数）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-NRFPMNINTERFUNC.md`
