---
id: UNC@20.15.2@MMLCommand@MOD USNRSVCMD4
type: MMLCommand
name: MOD USNRSVCMD4（修改预埋命令4）
nf: UNC
version: 20.15.2
verb: MOD
...
- [预埋命令4（USNRSVCMD4）](configobject/UNC/20.15.2/USNRSVCMD4.md)

## 使用实例

修改通过命令名称为MOD GLOBALVARIABLE来修改某个全局变量的值的功能，则可以执行以下命令：

MOD USNRSVCMD4: FUNNAME="MOD GLOBALVARIABLE", FUNKEY="TESTKEY", STRPARA1="asddas123", STRPARA2="asdA", STRPARA3="ASDFAS", INTPARA1=1231, INTPARA2=12312, INTPARA3=1231;
