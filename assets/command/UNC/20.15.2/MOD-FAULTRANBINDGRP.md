---
id: UNC@20.15.2@MMLCommand@MOD FAULTRANBINDGRP
type: MMLCommand
name: MOD FAULTRANBINDGRP（修改N3接口故障RAN与RAN组的绑定关系）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD FAULTRANBINDGRP（修改N3接口故障RAN与RAN组的绑定关系）
...
- [[UNC@20.15.2@ConfigObject@FAULTRANBINDGRP]] · N3接口故障RAN与RAN组的绑定关系（FAULTRANBINDGRP）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-FAULTRANBINDGRP.md`
