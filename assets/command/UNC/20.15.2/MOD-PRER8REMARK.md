---
id: UNC@20.15.2@MMLCommand@MOD PRER8REMARK
type: MMLCommand
name: MOD PRER8REMARK（修改Pre-R8 QoS到TOS/DSCP的映射规则）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD PRER8REMARK（修改Pre-R8 QoS到TOS/DSCP的映射规则）
...
- [Pre-R8 QoS到TOS/DSCP的映射规则（PRER8REMARK）](configobject/UNC/20.15.2/PRER8REMARK.md)
