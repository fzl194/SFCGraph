---
id: UNC@20.15.2@MMLCommand@ADD IMSIAPNBINDUP
type: MMLCommand
name: ADD IMSIAPNBINDUP（增加APN下用户和UPF的绑定关系配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD IMSIAPNBINDUP（增加APN下用户和UPF的绑定关系配置）
...
- [APN下用户和UPF的绑定关系配置（IMSIAPNBINDUP）](configobject/UNC/20.15.2/IMSIAPNBINDUP.md)
