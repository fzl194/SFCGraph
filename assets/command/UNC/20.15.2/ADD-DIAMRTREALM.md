---
id: UNC@20.15.2@MMLCommand@ADD DIAMRTREALM
type: MMLCommand
name: ADD DIAMRTREALM（增加Diameter路由域名信息）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD DIAMRTREALM（增加Diameter路由域名信息）
...
- [Diameter路由域名信息（DIAMRTREALM）](configobject/UNC/20.15.2/DIAMRTREALM.md)
