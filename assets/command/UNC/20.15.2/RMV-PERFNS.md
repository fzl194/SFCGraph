---
id: UNC@20.15.2@MMLCommand@RMV PERFNS
type: MMLCommand
name: RMV PERFNS（删除切片性能统计对象）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PERFNS（删除切片性能统计对象）

## 功能

**适用NF：AMF、SMF**

该命令用于手工删除切片性能统计对象的配置。

## 注意事项

- 该命令执行后立即生效。

- 只能删除人工配置的切片性能统计对象，不能删除系统同步产生的切片性能统计对象。
...
- [切片性能统计对象（PERFNS）](configobject/UNC/20.15.2/PERFNS.md)

## 使用实例

当运营商不需要切片“1-010101”作为性能统计对象时，执行如下命令：

```
RMV PERFNS:SNSSAI="1-010101";
```
