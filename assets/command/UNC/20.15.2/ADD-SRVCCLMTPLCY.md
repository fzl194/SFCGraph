---
id: UNC@20.15.2@MMLCommand@ADD SRVCCLMTPLCY
type: MMLCommand
name: ADD SRVCCLMTPLCY（增加SRVCC流程限制策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD SRVCCLMTPLCY（增加SRVCC流程限制策略）
...
- [[UNC@20.15.2@ConfigObject@SRVCCLMTPLCY]] · SRVCC流程限制策略（SRVCCLMTPLCY）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SRVCCLMTPLCY.md`
