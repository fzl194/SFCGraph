---
id: UNC@20.15.2@MMLCommand@ADD SECPOLICYCAR
type: MMLCommand
name: ADD SECPOLICYCAR（增加安全防攻击CAR规则）
nf: UNC
version: 20.15.2
verb: ADD
...
- [安全防攻击CAR规则（SECPOLICYCAR）](configobject/UNC/20.15.2/SECPOLICYCAR.md)
...
- 原始手册：`evidence/UNC/20.15.2/增加安全防攻击CAR规则（ADD-SECPOLICYCAR）_00601201.md`
