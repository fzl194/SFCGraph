---
id: UNC@20.15.2@MMLCommand@LST AUTOSCALINGMPLS
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@AUTOSCALINGMPLS]] · MPLS自动化配置模板（AUTOSCALINGMPLS）
...
- 原始手册：`evidence/UNC/20.15.2/LST-AUTOSCALINGMPLS.md`
