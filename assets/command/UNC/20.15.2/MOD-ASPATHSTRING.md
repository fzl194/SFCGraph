---
id: UNC@20.15.2@MMLCommand@MOD ASPATHSTRING
type: MMLCommand
name: MOD ASPATHSTRING（修改替换AS路径值）
nf: UNC
version: 20.15.2
verb: MOD
...
- [替换AS路径值（ASPATHSTRING）](configobject/UNC/20.15.2/ASPATHSTRING.md)
