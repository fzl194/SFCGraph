---
id: UNC@20.15.2@MMLCommand@RMV IUSUBRRLST
type: MMLCommand
name: RMV IUSUBRRLST（删除Iu模式用户漫游限制列表）
nf: UNC
version: 20.15.2
verb: RMV
...
Iu模式删除IMSI前缀为123456的区域漫游限制配置记录：

RMV IUSUBRRLST: SUBRANGE=IMSI_PREFIX, IMSIPRE="123456";

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-IUSUBRRLST.md`
