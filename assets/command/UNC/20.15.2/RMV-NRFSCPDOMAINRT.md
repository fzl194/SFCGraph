---
id: UNC@20.15.2@MMLCommand@RMV NRFSCPDOMAINRT
type: MMLCommand
name: RMV NRFSCPDOMAINRT（删除SCP Domain最长匹配后缀转发路由）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV NRFSCPDOMAINRT（删除SCP Domain最长匹配后缀转发路由）
...
- [[configobject/UNC/20.15.2/NRFSCPDOMAINRT]] · SCP Domain最长匹配后缀转发路由（NRFSCPDOMAINRT）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-NRFSCPDOMAINRT.md`
