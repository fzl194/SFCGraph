---
id: UNC@20.15.2@MMLCommand@ADD PNFSRVNTFSUBS
type: MMLCommand
name: ADD PNFSRVNTFSUBS（增加对端NF服务实例的回调信息）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD PNFSRVNTFSUBS（增加对端NF服务实例的回调信息）
...
- [对端NF服务实例的回调信息（PNFSRVNTFSUBS）](configobject/UNC/20.15.2/PNFSRVNTFSUBS.md)
