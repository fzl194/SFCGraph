---
id: UNC@20.15.2@MMLCommand@RMV SMFAPNGRPMEM
type: MMLCommand
name: RMV SMFAPNGRPMEM（删除APN和DNS关联的APN组的绑定关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV SMFAPNGRPMEM（删除APN和DNS关联的APN组的绑定关系）
...
- [APN和DNS关联的APN组的绑定关系（SMFAPNGRPMEM）](configobject/UNC/20.15.2/SMFAPNGRPMEM.md)
