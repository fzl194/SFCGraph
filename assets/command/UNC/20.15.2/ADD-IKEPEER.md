---
id: UNC@20.15.2@MMLCommand@ADD IKEPEER
type: MMLCommand
name: ADD IKEPEER（增加IKE对等体）
nf: UNC
version: 20.15.2
verb: ADD
...
- [IKE对等体（IKEPEER）](configobject/UNC/20.15.2/IKEPEER.md)
...
- 原始手册：`evidence/UNC/20.15.2/增加IKE对等体（ADD-IKEPEER）_80592498.md`
