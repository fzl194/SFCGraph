---
id: UNC@20.15.2@MMLCommand@DSP UFPLATENCYSTAT
type: MMLCommand
...
- [[configobject/UNC/20.15.2/UFPLATENCYSTAT]] · UFP逐包转发时延度量开关（UFPLATENCYSTAT）
...
- 原始手册：`evidence/UNC/20.15.2/显示UFP逐包转发时延度量开关（DSP-UFPLATENCYSTAT）_88226712.md`
