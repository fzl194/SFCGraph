---
id: UNC@20.15.2@MMLCommand@DSP DBDATAFEATURE
type: MMLCommand
...
- [[configobject/UNC/20.15.2/DBDATAFEATURE]] · CSDB数据特征（DBDATAFEATURE）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-DBDATAFEATURE.md`
