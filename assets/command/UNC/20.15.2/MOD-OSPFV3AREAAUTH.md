---
id: UNC@20.15.2@MMLCommand@MOD OSPFV3AREAAUTH
type: MMLCommand
name: MOD OSPFV3AREAAUTH（修改OSPFv3区域认证配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD OSPFV3AREAAUTH（修改OSPFv3区域认证配置）

## 功能

该命令用于修改OSPFv3区域所使用的认证模式及验证口令。

![](修改OSPFv3区域认证配置（MOD OSPFV3AREAAUTH）_00840949.assets/notice_3.0-zh-cn_2.png)
...
- [[configobject/UNC/20.15.2/OSPFV3AREAAUTH]] · OSPFv3区域认证配置（OSPFV3AREAAUTH）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-OSPFV3AREAAUTH.md`
