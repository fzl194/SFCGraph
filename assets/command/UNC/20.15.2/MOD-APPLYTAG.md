---
id: UNC@20.15.2@MMLCommand@MOD APPLYTAG
type: MMLCommand
name: MOD APPLYTAG（修改路由标签值设置）
nf: UNC
version: 20.15.2
verb: MOD
...
路由策略a节点10，修改路由标签值为10：

```
MOD APPLYTAG:POLICYNAME="a",NODESEQUENCE=10,TAGVALUE=20;
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-APPLYTAG.md`
