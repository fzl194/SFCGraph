---
id: UNC@20.15.2@MMLCommand@MOD IUPFAPNDPMODE
type: MMLCommand
name: MOD IUPFAPNDPMODE（修改I-UPF在特定园区专用APN下的部署模式配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD IUPFAPNDPMODE（修改I-UPF在特定园区专用APN下的部署模式配置）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-IUPFAPNDPMODE.md`
