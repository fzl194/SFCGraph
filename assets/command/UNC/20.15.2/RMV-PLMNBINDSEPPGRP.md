---
id: UNC@20.15.2@MMLCommand@RMV PLMNBINDSEPPGRP
type: MMLCommand
name: RMV PLMNBINDSEPPGRP（删除PLMN与SEPP组的绑定关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PLMNBINDSEPPGRP（删除PLMN与SEPP组的绑定关系）

## 功能

**适用NF：AMF、SMF**

该命令用于删除PLMN与SEPP组的绑定关系。
...
删除目标PLMN为12303与SEPP组的绑定关系。

```
RMV PLMNBINDSEPPGRP: MCC="123", MNC="03";
```
