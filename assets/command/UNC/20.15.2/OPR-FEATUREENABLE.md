---
id: UNC@20.15.2@MMLCommand@OPR FEATUREENABLE
type: MMLCommand
...
- [特性使能（FEATUREENABLE）](configobject/UNC/20.15.2/FEATUREENABLE.md)
...
- 原始手册：`evidence/UNC/20.15.2/特性使能（OPR-FEATUREENABLE）_14567234.md`
