---
id: UNC@20.15.2@MMLCommand@ADD NGMMSUBDATA
type: MMLCommand
name: ADD NGMMSUBDATA（增加用户移动性管理参数）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NGMMSUBDATA]] · 用户移动性管理参数（NGMMSUBDATA）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NGMMSUBDATA.md`
