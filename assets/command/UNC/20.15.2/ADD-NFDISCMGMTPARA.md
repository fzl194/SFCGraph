---
id: UNC@20.15.2@MMLCommand@ADD NFDISCMGMTPARA
type: MMLCommand
name: ADD NFDISCMGMTPARA（增加网元服务发现功能管理参数）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD NFDISCMGMTPARA（增加网元服务发现功能管理参数）
...
- [[configobject/UNC/20.15.2/NFDISCMGMTPARA]] · 网元服务发现功能管理参数（NFDISCMGMTPARA）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NFDISCMGMTPARA.md`
