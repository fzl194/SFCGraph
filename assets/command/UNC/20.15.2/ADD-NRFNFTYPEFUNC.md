---
id: UNC@20.15.2@MMLCommand@ADD NRFNFTYPEFUNC
type: MMLCommand
name: ADD NRFNFTYPEFUNC（增加基于NFType设置NRF的各类功能开关）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD NRFNFTYPEFUNC（增加基于NFType设置NRF的各类功能开关）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NRFNFTYPEFUNC.md`
