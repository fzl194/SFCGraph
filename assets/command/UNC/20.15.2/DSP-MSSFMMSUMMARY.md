---
id: UNC@20.15.2@MMLCommand@DSP MSSFMMSUMMARY
type: MMLCommand
...
- [FMM的PBUF概要信息（MSSFMMSUMMARY）](configobject/UNC/20.15.2/MSSFMMSUMMARY.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示FMM的PBUF概要信息（DSP-MSSFMMSUMMARY）_92520028.md`
