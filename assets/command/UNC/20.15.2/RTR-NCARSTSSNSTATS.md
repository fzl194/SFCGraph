---
id: UNC@20.15.2@MMLCommand@RTR NCARSTSSNSTATS
type: MMLCommand
...
- [[configobject/UNC/20.15.2/NCARSTSSNSTATS]] · NETCONF会话统计信息（NCARSTSSNSTATS）
...
- 原始手册：`evidence/UNC/20.15.2/RTR-NCARSTSSNSTATS.md`
