---
id: UNC@20.15.2@MMLCommand@SND MMECFG
type: MMLCommand
name: SND MMECFG（发送MME配置信息）
nf: UNC
version: 20.15.2
verb: SND
object_keyword: MMECFG
...
- [[UNC@20.15.2@ConfigObject@MMECFG]] · 发送MME配置信息（MMECFG）
...
- 原始手册：`evidence/UNC/20.15.2/SND-MMECFG.md`
