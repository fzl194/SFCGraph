---
id: UNC@20.15.2@MMLCommand@DSP ECOVMSINFO
type: MMLCommand
...
- [VM的CPU节能策略（ECOVMSINFO）](configobject/UNC/20.15.2/ECOVMSINFO.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示VM的CPU节能策略（DSP-ECOVMSINFO）_96831057.md`
