---
id: UNC@20.15.2@MMLCommand@RMV H2SRVPLMN
type: MMLCommand
name: RMV H2SRVPLMN（删除Home PLMN到Serving PLMN的对应关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV H2SRVPLMN（删除Home PLMN到Serving PLMN的对应关系）
...
- [Home PLMN到Serving PLMN的对应关系（H2SRVPLMN）](configobject/UNC/20.15.2/H2SRVPLMN.md)
