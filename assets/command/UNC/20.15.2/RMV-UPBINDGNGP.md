---
id: UNC@20.15.2@MMLCommand@RMV UPBINDGNGP
type: MMLCommand
name: RMV UPBINDGNGP（删除GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV UPBINDGNGP（删除GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系）
...
- [[UNC@20.15.2@ConfigObject@UPBINDGNGP]] · GGSN与Gn/Gp接口或PGW-U与S5/S8接口的绑定关系（UPBINDGNGP）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-UPBINDGNGP.md`
