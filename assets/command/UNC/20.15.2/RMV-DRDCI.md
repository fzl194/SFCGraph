---
id: UNC@20.15.2@MMLCommand@RMV DRDCI
type: MMLCommand
name: RMV DRDCI（删除DC间通信通道信息）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV DRDCI（删除DC间通信通道信息）

## 功能

![](删除DC间通信通道信息（RMV DRDCI）_23394830.assets/notice_3.0-zh-cn_2.png)

该命令为删除容灾控制通道信息，可能导致业务中断，需要按照对应产品文档的容灾方案介绍专题进行操作，请勿自行执行该命令。
...
```
%%RMV DRDCI: DRGROUPID=1, IPVERSION=IPV4, LDCIP="172.16.3.4", PDCIP="172.16.5.6", VPNINSTANCE="12345";%%
RETCODE = 0  操作成功
...
- 原始手册：`evidence/UNC/20.15.2/删除DC间通信通道信息（RMV-DRDCI）_23394830.md`
