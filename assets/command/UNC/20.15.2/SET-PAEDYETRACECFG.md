---
id: UNC@20.15.2@MMLCommand@SET PAEDYETRACECFG
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@PAEDYETRACECFG]] · PAE染色流控开关及阈值参数（PAEDYETRACECFG）
...
- 原始手册：`evidence/UNC/20.15.2/SET-PAEDYETRACECFG.md`
