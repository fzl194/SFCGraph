---
id: UNC@20.15.2@MMLCommand@ADD IPEN7SUFFIX
type: MMLCommand
name: ADD IPEN7SUFFIX（增加智能业务后缀）
nf: UNC
version: 20.15.2
verb: ADD
...
- [智能业务后缀（IPEN7SUFFIX）](configobject/UNC/20.15.2/IPEN7SUFFIX.md)

## 使用实例

增加智能业务后缀为“intelligent”，智能业务名称为“video”的配置：

```
ADD IPEN7SUFFIX: INTELLISUFFIX="intelligent", INTELLINAME="video";
```
