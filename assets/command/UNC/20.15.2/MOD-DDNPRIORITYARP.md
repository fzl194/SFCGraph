---
id: UNC@20.15.2@MMLCommand@MOD DDNPRIORITYARP
type: MMLCommand
name: MOD DDNPRIORITYARP（修改基于ARP的DDN消息优先级配置）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD DDNPRIORITYARP（修改基于ARP的DDN消息优先级配置）
...
- [[UNC@20.15.2@ConfigObject@DDNPRIORITYARP]] · 基于ARP的DDN消息优先级配置（DDNPRIORITYARP）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-DDNPRIORITYARP.md`
