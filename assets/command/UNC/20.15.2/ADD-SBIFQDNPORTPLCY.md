---
id: UNC@20.15.2@MMLCommand@ADD SBIFQDNPORTPLCY
type: MMLCommand
name: ADD SBIFQDNPORTPLCY（增加FQDN端口策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD SBIFQDNPORTPLCY（增加FQDN端口策略）
...
- [FQDN端口策略（SBIFQDNPORTPLCY）](configobject/UNC/20.15.2/SBIFQDNPORTPLCY.md)
