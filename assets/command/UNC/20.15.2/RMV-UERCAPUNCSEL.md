---
id: UNC@20.15.2@MMLCommand@RMV UERCAPUNCSEL
type: MMLCommand
name: RMV UERCAPUNCSEL（删除UE无线能力选择UNC参数）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV UERCAPUNCSEL（删除UE无线能力选择UNC参数）

## 功能

**适用网元：MME**

该命令用于删除指定用户范围用户UE无线能力选择UNC的参数。
...
```
RMV UERCAPUNCSEL: SUBRANGE=ALL_USER;
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-UERCAPUNCSEL.md`
