---
id: UNC@20.15.2@MMLCommand@ADD PCSCFIP
type: MMLCommand
name: ADD PCSCFIP（增加P-CSCF地址配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@PCSCFIP]] · P-CSCF地址配置（PCSCFIP）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PCSCFIP.md`
