---
id: UNC@20.15.2@MMLCommand@RMV UNCVNFINFO
type: MMLCommand
name: RMV UNCVNFINFO（删除北向NF实例信息）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[configobject/UNC/20.15.2/UNCVNFINFO]] · 北向NF实例信息（UNCVNFINFO）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-UNCVNFINFO.md`
