---
id: UNC@20.15.2@MMLCommand@RMV KEYPAIRLABEL
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@KEYPAIRLABEL]] · 创建DSA/ECC密钥对标签（KEYPAIRLABEL）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-KEYPAIRLABEL.md`
