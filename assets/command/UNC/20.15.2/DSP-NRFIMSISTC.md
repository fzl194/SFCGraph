---
id: UNC@20.15.2@MMLCommand@DSP NRFIMSISTC
type: MMLCommand
name: DSP NRFIMSISTC（显示IMSI号段统计信息）
nf: UNC
version: 20.15.2
verb: DSP
object_keyword: NRFIMSISTC
...
- [IMSI号段统计信息（NRFIMSISTC）](configobject/UNC/20.15.2/NRFIMSISTC.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示IMSI号段统计信息（DSP-NRFIMSISTC）_45364617.md`
