---
id: UNC@20.15.2@MMLCommand@ADD SQOSVPNGROUPMEM
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@SQOSVPNGROUPMEM]] · VPN组成员（SQOSVPNGROUPMEM）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SQOSVPNGROUPMEM.md`
