---
id: UNC@20.15.2@MMLCommand@RTR PAEPORT
type: MMLCommand
name: RTR PAEPORT（清除PAE端口统计信息）
nf: UNC
version: 20.15.2
verb: RTR
...
- [PAE端口统计信息（PAEPORT）](configobject/UNC/20.15.2/PAEPORT.md)
...
- 原始手册：`evidence/UNC/20.15.2/清除PAE端口统计信息（RTR-PAEPORT）_92520050.md`
