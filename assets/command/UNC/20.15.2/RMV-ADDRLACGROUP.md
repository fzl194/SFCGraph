---
id: UNC@20.15.2@MMLCommand@RMV ADDRLACGROUP
type: MMLCommand
name: RMV ADDRLACGROUP（删除LAC组）
nf: UNC
version: 20.15.2
verb: RMV
...
- [LAC组（ADDRLACGROUP）](configobject/UNC/20.15.2/ADDRLACGROUP.md)

## 使用实例

删除一个本地已经配置的LAC组“beijing”：

```
RMV ADDRLACGROUP:LACGROUPNAME="beijing";
```
