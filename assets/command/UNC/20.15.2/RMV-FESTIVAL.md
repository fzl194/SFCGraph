---
id: UNC@20.15.2@MMLCommand@RMV FESTIVAL
type: MMLCommand
name: RMV FESTIVAL（删除计费节假日表）
nf: UNC
version: 20.15.2
verb: RMV
...
- [[UNC@20.15.2@ConfigObject@FESTIVAL]] · 计费节假日表（FESTIVAL）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-FESTIVAL.md`
