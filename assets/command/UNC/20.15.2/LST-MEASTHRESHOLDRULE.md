---
id: UNC@20.15.2@MMLCommand@LST MEASTHRESHOLDRULE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@MEASTHRESHOLDRULE]] · 话统阈值规则（MEASTHRESHOLDRULE）
...
- 原始手册：`evidence/UNC/20.15.2/LST-MEASTHRESHOLDRULE.md`
