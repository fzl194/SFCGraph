---
id: UNC@20.15.2@MMLCommand@DSP LDPSSMGDSCB
type: MMLCommand
...
- [LDP会话管理模块的下游信息（LDPSSMGDSCB）](configobject/UNC/20.15.2/LDPSSMGDSCB.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示LDP会话管理模块的下游信息（DSP-LDPSSMGDSCB）_50281606.md`
