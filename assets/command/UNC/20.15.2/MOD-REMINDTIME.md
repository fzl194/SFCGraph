---
id: UNC@20.15.2@MMLCommand@MOD REMINDTIME
type: MMLCommand
...
- [证书到期提醒时间（REMINDTIME）](configobject/UNC/20.15.2/REMINDTIME.md)
...
- 原始手册：`evidence/UNC/20.15.2/修改证书到期提醒时间（MOD-REMINDTIME）_92045220.md`
