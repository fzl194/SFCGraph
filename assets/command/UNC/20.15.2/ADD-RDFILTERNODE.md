---
id: UNC@20.15.2@MMLCommand@ADD RDFILTERNODE
type: MMLCommand
name: ADD RDFILTERNODE（增加RD路由过滤节点）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[configobject/UNC/20.15.2/RDFILTERNODE]] · RD路由过滤节点（RDFILTERNODE）
...
```
ADD RDFILTERNODE:INDEX=55,NODESEQUENCE=10,MATCHMODE=permit;
```
