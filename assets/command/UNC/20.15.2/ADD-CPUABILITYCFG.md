---
id: UNC@20.15.2@MMLCommand@ADD CPUABILITYCFG
type: MMLCommand
name: ADD CPUABILITYCFG（增加不同CPU类型的能力系数和基础消耗。）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD CPUABILITYCFG（增加不同CPU类型的能力系数和基础消耗。）
...
- [不同CPU类型的能力系数和基础消耗。（CPUABILITYCFG）](configobject/UNC/20.15.2/CPUABILITYCFG.md)
