---
id: UNC@20.15.2@MMLCommand@RMV CCPRCACT
type: MMLCommand
name: RMV CCPRCACT（删除融合计费Proxy结果码处理动作）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV CCPRCACT（删除融合计费Proxy结果码处理动作）
...
- [[UNC@20.15.2@ConfigObject@CCPRCACT]] · 融合计费Proxy结果码处理动作（CCPRCACT）
