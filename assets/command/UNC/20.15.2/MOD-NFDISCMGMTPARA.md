---
id: UNC@20.15.2@MMLCommand@MOD NFDISCMGMTPARA
type: MMLCommand
name: MOD NFDISCMGMTPARA（修改网元服务发现功能管理参数）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD NFDISCMGMTPARA（修改网元服务发现功能管理参数）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-NFDISCMGMTPARA.md`
