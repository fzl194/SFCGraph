---
id: UNC@20.15.2@MMLCommand@RMV PCSCFRESTOPLCY
type: MMLCommand
name: RMV PCSCFRESTOPLCY（删除P-CSCF故障恢复策略）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV PCSCFRESTOPLCY（删除P-CSCF故障恢复策略）

## 功能

**适用网元：MME**

该命令用于删除P-CSCF故障恢复策略配置。
...
- [[configobject/UNC/20.15.2/PCSCFRESTOPLCY]] · P-CSCF故障恢复策略（PCSCFRESTOPLCY）
...
```
RMV PCSCFRESTOPLCY: SUBRANGE=ALL_USER;
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/RMV-PCSCFRESTOPLCY.md`
