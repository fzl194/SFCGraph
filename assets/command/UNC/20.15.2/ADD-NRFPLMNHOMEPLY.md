---
id: UNC@20.15.2@MMLCommand@ADD NRFPLMNHOMEPLY
type: MMLCommand
name: ADD NRFPLMNHOMEPLY（增加指定拜访地PLMN的归属地策略）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD NRFPLMNHOMEPLY（增加指定拜访地PLMN的归属地策略）
...
- [指定拜访地PLMN的归属地策略（NRFPLMNHOMEPLY）](configobject/UNC/20.15.2/NRFPLMNHOMEPLY.md)
