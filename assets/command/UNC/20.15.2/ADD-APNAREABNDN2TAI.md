---
id: UNC@20.15.2@MMLCommand@ADD APNAREABNDN2TAI
type: MMLCommand
name: ADD APNAREABNDN2TAI（增加APN相关服务区域绑定的5G TAI范围）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APNAREABNDN2TAI（增加APN相关服务区域绑定的5G TAI范围）
...
增加APN相关服务区域“dnnarea1”的TAI绑定范围46001000001~46001123456。

```
ADD APNAREABNDN2TAI: AREANAME="dnnarea1", N2BEGINTAI="46001000001", N2ENDTAI="46001123456";
```

## 证据

- 原始手册：`evidence/UNC/20.15.2/ADD-APNAREABNDN2TAI.md`
