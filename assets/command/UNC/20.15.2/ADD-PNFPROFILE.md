---
id: UNC@20.15.2@MMLCommand@ADD PNFPROFILE
type: MMLCommand
name: ADD PNFPROFILE（增加对端NF实例概述信息）
nf: UNC
version: 20.15.2
verb: ADD
...
- [对端NF实例概述信息（PNFPROFILE）](configobject/UNC/20.15.2/PNFPROFILE.md)
