---
id: UNC@20.15.2@MMLCommand@ADD NRFNSRT
type: MMLCommand
name: ADD NRFNSRT（增加网络切片的路由）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@NRFNSRT]] · 网络切片的路由（NRFNSRT）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-NRFNSRT.md`
