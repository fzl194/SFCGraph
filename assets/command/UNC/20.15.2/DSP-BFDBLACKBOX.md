---
id: UNC@20.15.2@MMLCommand@DSP BFDBLACKBOX
type: MMLCommand
...
- [BFD黑匣子信息（BFDBLACKBOX）](configobject/UNC/20.15.2/BFDBLACKBOX.md)
...
- 原始手册：`evidence/UNC/20.15.2/查询BFD黑匣子信息（DSP-BFDBLACKBOX）_00601513.md`
