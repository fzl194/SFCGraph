---
id: UNC@20.15.2@MMLCommand@MOD RDSUPFCTRL
type: MMLCommand
name: MOD RDSUPFCTRL（修改RADIUS服务器的UP列表中指定UP的功能属性）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD RDSUPFCTRL（修改RADIUS服务器的UP列表中指定UP的功能属性）
...
- [[UNC@20.15.2@ConfigObject@RDSUPFCTRL]] · RADIUS服务器的UP列表中指定UP的功能属性（RDSUPFCTRL）
...
- 原始手册：`evidence/UNC/20.15.2/MOD-RDSUPFCTRL.md`
