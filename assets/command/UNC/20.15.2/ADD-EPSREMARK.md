---
id: UNC@20.15.2@MMLCommand@ADD EPSREMARK
type: MMLCommand
name: ADD EPSREMARK（增加EPS QoS到TOS/DSCP的映射规则）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD EPSREMARK（增加EPS QoS到TOS/DSCP的映射规则）
...
- [EPS QoS到TOS/DSCP的映射规则（EPSREMARK）](configobject/UNC/20.15.2/EPSREMARK.md)
