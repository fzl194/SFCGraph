---
id: UNC@20.15.2@MMLCommand@RMV NGLANGRPCTX
type: MMLCommand
name: RMV NGLANGRPCTX（删除5G LAN组会话）
nf: UNC
version: 20.15.2
verb: RMV
object_keyword: NGLANGRPCTX
...
- [5G LAN组会话（NGLANGRPCTX）](configobject/UNC/20.15.2/NGLANGRPCTX.md)
