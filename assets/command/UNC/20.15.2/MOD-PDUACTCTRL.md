---
id: UNC@20.15.2@MMLCommand@MOD PDUACTCTRL
type: MMLCommand
name: MOD PDUACTCTRL（修改PDU会话激活控制参数）
nf: UNC
version: 20.15.2
verb: MOD
...
- [PDU会话激活控制参数（PDUACTCTRL）](configobject/UNC/20.15.2/PDUACTCTRL.md)
