---
id: UNC@20.15.2@MMLCommand@ADD PORTGROUPMEMBER
type: MMLCommand
...
- [[configobject/UNC/20.15.2/PORTGROUPMEMBER]] · 端口组成员（PORTGROUPMEMBER）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PORTGROUPMEMBER.md`
