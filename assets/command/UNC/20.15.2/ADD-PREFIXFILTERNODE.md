---
id: UNC@20.15.2@MMLCommand@ADD PREFIXFILTERNODE
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@PREFIXFILTERNODE]] · IPv4地址前缀列表过滤器节点（PREFIXFILTERNODE）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-PREFIXFILTERNODE.md`
