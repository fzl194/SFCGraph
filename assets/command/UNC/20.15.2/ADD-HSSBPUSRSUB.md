---
id: UNC@20.15.2@MMLCommand@ADD HSSBPUSRSUB
type: MMLCommand
name: ADD HSSBPUSRSUB（增加HSS BYPASS最小用户签约数据配置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD HSSBPUSRSUB（增加HSS BYPASS最小用户签约数据配置）
...
- [[UNC@20.15.2@ConfigObject@HSSBPUSRSUB]] · HSS BYPASS最小用户签约数据配置（HSSBPUSRSUB）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-HSSBPUSRSUB.md`
