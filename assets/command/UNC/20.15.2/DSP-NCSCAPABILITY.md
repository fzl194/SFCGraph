---
id: UNC@20.15.2@MMLCommand@DSP NCSCAPABILITY
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@NCSCAPABILITY]] · 设备所支持的NETCONF协议能力集（NCSCAPABILITY）
...
- 原始手册：`evidence/UNC/20.15.2/DSP-NCSCAPABILITY.md`
