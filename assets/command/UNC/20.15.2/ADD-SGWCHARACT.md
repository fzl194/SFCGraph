---
id: UNC@20.15.2@MMLCommand@ADD SGWCHARACT
type: MMLCommand
name: ADD SGWCHARACT（增加S-GW特性对接配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@SGWCHARACT]] · S-GW特性对接配置（SGWCHARACT）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-SGWCHARACT.md`
