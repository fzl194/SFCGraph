---
id: UNC@20.15.2@MMLCommand@ADD ICMPSECURITY
type: MMLCommand
name: ADD ICMPSECURITY（新增ICMP安全配置）
nf: UNC
version: 20.15.2
verb: ADD
...
- [[UNC@20.15.2@ConfigObject@ICMPSECURITY]] · ICMP安全配置（ICMPSECURITY）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-ICMPSECURITY.md`
