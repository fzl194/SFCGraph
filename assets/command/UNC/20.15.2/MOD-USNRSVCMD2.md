---
id: UNC@20.15.2@MMLCommand@MOD USNRSVCMD2
type: MMLCommand
name: MOD USNRSVCMD2（修改预埋命令2）
nf: UNC
version: 20.15.2
verb: MOD
object_keyword: USNRSVCMD2
...
- [[configobject/UNC/20.15.2/USNRSVCMD2]] · 预埋命令2（USNRSVCMD2）

## 使用实例

修改通过命令名称为MOD GLOBALVARIABLE来修改某个全局变量的值的功能，则可以执行以下命令：

MOD USNRSVCMD2: FUNNAME="MOD GLOBALVARIABLE", FUNKEY="TESTKEY", STRPARA1="asddas123", STRPARA2="asdA", STRPARA3="ASDFAS", INTPARA1=1231, INTPARA2=12312, INTPARA3=1231;

## 证据

- 原始手册：`evidence/UNC/20.15.2/MOD-USNRSVCMD2.md`
