---
id: UNC@20.15.2@MMLCommand@SET HTTPFIXEDFCMSG
type: MMLCommand
...
- [[UNC@20.15.2@ConfigObject@HTTPFIXEDFCMSG]] · HTTP指定消息类型固定速率流控信息（HTTPFIXEDFCMSG）
...
- 原始手册：`evidence/UNC/20.15.2/SET-HTTPFIXEDFCMSG.md`
