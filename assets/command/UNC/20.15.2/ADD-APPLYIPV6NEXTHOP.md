---
id: UNC@20.15.2@MMLCommand@ADD APPLYIPV6NEXTHOP
type: MMLCommand
name: ADD APPLYIPV6NEXTHOP（增加IPv6下一跳设置）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD APPLYIPV6NEXTHOP（增加IPv6下一跳设置）
...
路由策略a节点10，添加设置下一跳为2001:DB8::：

```
ADD APPLYIPV6NEXTHOP:POLICYNAME="a",NODESEQUENCE=10,ISPEERADDRESS=FALSE,IPV6NEXTHOP="2001:DB8::";
```
