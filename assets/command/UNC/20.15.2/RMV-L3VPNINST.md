---
id: UNC@20.15.2@MMLCommand@RMV L3VPNINST
type: MMLCommand
...
![](删除L3VPN实例（RMV L3VPNINST）_50120962.assets/notice_3.0-zh-cn_2.png)
...
- [L3VPN实例（L3VPNINST）](configobject/UNC/20.15.2/L3VPNINST.md)
