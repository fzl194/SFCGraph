---
id: UNC@20.15.2@MMLCommand@SET IMSVOPS
type: MMLCommand
name: SET IMSVOPS（设置VoPS配置）
nf: UNC
version: 20.15.2
verb: SET
...
- [[UNC@20.15.2@ConfigObject@IMSVOPS]] · VoPS配置（IMSVOPS）
...
- 原始手册：`evidence/UNC/20.15.2/SET-IMSVOPS.md`
