---
id: UNC@20.15.2@MMLCommand@ADD EPSQOS4DEFBER
type: MMLCommand
name: ADD EPSQOS4DEFBER（增加Qos Profile缺省承载QoS属性）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD EPSQOS4DEFBER（增加Qos Profile缺省承载QoS属性）
...
- 原始手册：`evidence/UNC/20.15.2/ADD-EPSQOS4DEFBER.md`
