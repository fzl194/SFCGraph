---
id: UNC@20.15.2@MMLCommand@ADD NRFDNNDNAIRT
type: MMLCommand
name: ADD NRFDNNDNAIRT（增加DNN中数据网络访问标识最长后缀匹配转发路由）
nf: UNC
version: 20.15.2
verb: ADD
...
# ADD NRFDNNDNAIRT（增加DNN中数据网络访问标识最长后缀匹配转发路由）
...
- [[configobject/UNC/20.15.2/NRFDNNDNAIRT]] · DNN中数据网络访问标识最长后缀匹配转发路由（NRFDNNDNAIRT）
