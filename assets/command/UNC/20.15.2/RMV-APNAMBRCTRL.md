---
id: UNC@20.15.2@MMLCommand@RMV APNAMBRCTRL
type: MMLCommand
name: RMV APNAMBRCTRL（删除APN-AMBR控制的配置）
nf: UNC
version: 20.15.2
verb: RMV
...
# RMV APNAMBRCTRL（删除APN-AMBR控制的配置）
...
- 原始手册：`evidence/UNC/20.15.2/RMV-APNAMBRCTRL.md`
