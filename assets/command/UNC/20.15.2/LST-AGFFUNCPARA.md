---
id: UNC@20.15.2@MMLCommand@LST AGFFUNCPARA
type: MMLCommand
name: LST AGFFUNCPARA（查询AGF的功能参数）
nf: UNC
version: 20.15.2
verb: LST
...
- [[configobject/UNC/20.15.2/AGFFUNCPARA]] · AGF的功能参数（AGFFUNCPARA）
