---
id: UNC@20.15.2@MMLCommand@DSP CELLFAULTINFO
type: MMLCommand
...
- [故障进程历史记录（CELLFAULTINFO）](configobject/UNC/20.15.2/CELLFAULTINFO.md)
...
- 原始手册：`evidence/UNC/20.15.2/显示故障进程历史记录（DSP-CELLFAULTINFO）_94730394.md`
