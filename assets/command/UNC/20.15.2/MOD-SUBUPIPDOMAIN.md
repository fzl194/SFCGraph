---
id: UNC@20.15.2@MMLCommand@MOD SUBUPIPDOMAIN
type: MMLCommand
name: MOD SUBUPIPDOMAIN（修改当前UPF扩展类型绑定的IP域）
nf: UNC
version: 20.15.2
verb: MOD
...
# MOD SUBUPIPDOMAIN（修改当前UPF扩展类型绑定的IP域）
...
- [当前UPF扩展类型绑定的IP域（SUBUPIPDOMAIN）](configobject/UNC/20.15.2/SUBUPIPDOMAIN.md)
