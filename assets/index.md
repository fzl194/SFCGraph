...
- 命令级 task · UNC/20.15.2 → [局部 index](task/UNC/20.15.2/index.md)（209 篇，pre-build 证据包驱动；编号 0-00001~0-00027 沿用 atom yaml，0-00028~0-00209 接续）

_步骤级（compound）/特性级（feature）task 后续建（task↔task 双向届时同步）。_
