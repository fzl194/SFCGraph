...
计费场景三层图谱的证据源共分五类，合计 **31份知识资产**：

| 证据类型 | ID前缀 | 数量 | 路径根目录 |
|---------|--------|------|-----------|
| 特性知识文档 | `EV-FK-*` | 15 | `feature-knowledge/` |
| 统一知识库 | `EV-KB-*` | 3 | `计费场景统一知识库.md`、`knowledge-fused-part*.md` |
| 业务图谱 | `EV-BS-*` | 2 | `01计费场景业务图谱.md`、`SKILL/knowledge/计费场景业务图谱.md` |
| 协议知识 | `EV-PK-*` | 2 | `SKILL/knowledge/协议知识-*.md` |
| SKILL知识 | `EV-SK-*` | 5 | `SKILL/knowledge/*.md` |
| 跨特性分析 | `EV-CFA` | 1 | `feature-knowledge/cross-feature-analysis.md` |
| 特性文档清单 | `EV-FDL` | 1 | `charging-feature-doc-list.md` |
| 设计文档 | `EV-DES` | 1 | `design-mvp-closure.md` |
| 业务感知全景 | `EV-BSA-全景` | 1 | `SKILL/knowledge/业务感知业务图谱.md` |
| **合计** | — | **31** | — |

> 所有证据路径相对 `business-graph/计费场景/`。
...
|------------|------|---------|------|
| `EV-KB-001` | 计费场景统一知识库 | `计费场景统一知识库.md` | 3232行，K001-K261 |
| `EV-KB-002` | 知识融合A（业务方案+配置全景） | `knowledge-fused-partA.md` | 融合知识上半 |
| `EV-KB-003` | 知识融合B（命令+协议） | `knowledge-fused-partB.md` | 融合知识下半 |
...
> 在01-business-graph.md中引用为 `EV-01-业务图谱`，对应本表 `EV-BS-001`/`EV-BS-002`。
...
| `EV-SK-KB` | 计费知识库（精简版） | `SKILL/knowledge/计费知识库.md` | 686行精简知识 |
...
- [x] 1份设计文档登记
- [x] 1份业务感知全景登记
- [x] 所有路径相对 `business-graph/计费场景/` 准确
