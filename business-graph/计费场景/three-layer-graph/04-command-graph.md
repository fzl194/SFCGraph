...
| `CR-CH-09` | offline/online互斥 | `restriction_rule` | offline和online不能同时为true（PCC规则），可同时为false（不计费）；PCF下发优先级高于SMF本地配置 | warning | ADD RULE |
...
| CommandRule | 12 | CR-CH-01~CR-CH-12 |
